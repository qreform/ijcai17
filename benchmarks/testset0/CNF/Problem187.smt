;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (p3 | (p4 | p0)))) & ((~p1 | (~p2 | (~p0 | (p4 | ~p5)))) & ((~p2 | (~p4 | (~p7 | (~p8 | p6)))) & ((~p1 | (~p0 | (~p4 | (~p10 | p9)))) & (p0 | (~p10 | (~p2 | (p3 | p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f22 | p3 | p11
(assert (or (not l_f22) l_p3 l_p11))
...
(assert (or (not r_f22) r_p3 r_p11))
