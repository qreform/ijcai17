;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (p2 | (~p3 | (p4 | ~p0)))) & ((p2 | (p6 | (p7 | (~p8 | ~p5)))) & ((~p10 | (~p11 | (~p5 | (p1 | p9)))) & ((~p10 | (~p11 | (~p10 | (~p0 | p12)))) & ((p11 | (p12 | (~p8 | (p6 | ~p13)))) & (~p3 | (~p2 | (p4 | (~p6 | ~p14))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f11 | p11 | f12
(assert (or (not l_f11) l_p11 l_f12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p11 | f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p11 | f11_p
(assert (or (not l_p11) l_f11_p))
...
;%~f18 | p0 | p12
(assert (or (not l_f18) l_p0 l_p12))
...
;%~f23 | p6 | p13
(assert (or (not l_f23) l_p6 l_p13))
...
;%~f27 | p6 | p14
(assert (or (not l_f27) l_p6 l_p14))
...
(assert (or (not r_f11) r_p11 r_f12))


;%~r_p11 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p11) r_f11_p))
...
(assert (or (not r_f18) r_p0 r_p12))
...
(assert (or (not r_f23) r_p6 r_p13))
...
(assert (or (not r_f27) r_p6 r_p14))
