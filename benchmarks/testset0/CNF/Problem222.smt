;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p5 | (p3 | (p0 | p4))) & ((p0 | (p2 | (p4 | p6))) & ((p8 | (p1 | (p4 | p7))) & ((p4 | (p3 | (p4 | p9))) & (p4 | (p8 | (p6 | p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f21 | p6 | p10
(assert (or (not l_f21) l_p6 l_p10))
...
(assert (or (not r_f21) r_p6 r_p10))
