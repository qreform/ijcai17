;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (~p3 | (p4 | (~p5 | p0))))) & ((~p1 | (~p4 | (~p5 | (~p5 | (p1 | ~p6))))) & ((p8 | (~p0 | (~p6 | (~p4 | (~p9 | ~p7))))) & ((~p4 | (~p1 | (~p0 | (~p9 | (~p2 | ~p10))))) & (~p0 | (p12 | (p13 | (~p5 | (~p2 | ~p11))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f22 | p2 | p10
(assert (or (not l_f22) l_p2 l_p10))
...
;%~f27 | p2 | p11
(assert (or (not l_f27) l_p2 l_p11))
...
;%~f24 | p12 | f25
(assert (or (not l_f24) l_p12 l_f25))
...
(assert (or (not r_f22) r_p2 r_p10))
...
(assert (or (not r_f27) r_p2 r_p11))
...
(assert (or (not r_f24) r_p12 r_f25))


;%~r_p12 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p12) r_f24_p))
