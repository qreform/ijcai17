;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p5 | (p1 | (p0 | p4))) & ((p7 | (p8 | (p0 | p6))) & ((p4 | (p7 | (p10 | p9))) & ((p4 | (p12 | (p3 | p11))) & (p9 | (p14 | (p0 | p13)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f14 | p10 | p9
(assert (or (not l_f14) l_p10 l_p9))
...
;%~f18 | p3 | p11
(assert (or (not l_f18) l_p3 l_p11))
...
;%~f21 | p0 | p13
(assert (or (not l_f21) l_p0 l_p13))
...
;%~f20 | p14 | f21
(assert (or (not l_f20) l_p14 l_f21))
...
(assert (or (not r_f14) r_p10 r_p9))
...
(assert (or (not r_f18) r_p3 r_p11))
...
(assert (or (not r_f21) r_p0 r_p13))
...
(assert (or (not r_f20) r_p14 r_f21))


;%~r_p14 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p14) r_f20_p))
