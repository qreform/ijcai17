;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (~p3 | p0))) & ((~p2 | (~p5 | (p3 | ~p4))) & ((p0 | (~p2 | (~p2 | p6))) & ((p0 | (~p8 | (~p2 | p7))) & ((p10 | (~p8 | (~p2 | p9))) & (~p12 | (~p6 | (p13 | ~p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f21 | p13 | p11
(assert (or (not l_f21) l_p13 l_p11))
...
(assert (or (not r_f21) r_p13 r_p11))
