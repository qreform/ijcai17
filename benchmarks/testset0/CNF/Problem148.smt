;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | (~p4 | (p5 | ~p0))))) & ((~p1 | (p1 | (~p3 | (p7 | (~p8 | ~p6))))) & ((p10 | (p3 | (p11 | (~p4 | (p12 | p9))))) & (~p10 | (p8 | (~p11 | (~p6 | (~p14 | ~p13)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f21 | p14 | p13
(assert (or (not l_f21) l_p14 l_p13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p14 | ~p13) --> f21_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f21) r_p14 r_p13))
