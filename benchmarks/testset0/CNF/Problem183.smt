;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p2 | (p1 | (p2 | (p0 | p5)))) & ((p3 | (p0 | (p7 | (p8 | p6)))) & ((p1 | (p4 | (p3 | (p10 | p9)))) & (p1 | (p7 | (p12 | (p13 | p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f18 | p10 | p9
(assert (or (not l_f18) l_p10 l_p9))
...
;%~f22 | p13 | p11
(assert (or (not l_f22) l_p13 l_p11))
...
(assert (or (not r_f18) r_p10 r_p9))
...
(assert (or (not r_f22) r_p13 r_p11))
