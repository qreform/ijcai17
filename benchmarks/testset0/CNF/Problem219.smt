;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | ~p0)) & ((p0 | (~p0 | ~p3)) & ((~p0 | (p2 | ~p4)) & ((~p3 | (~p6 | p5)) & ((~p8 | (p9 | ~p7)) & (~p11 | (p12 | ~p10))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f15 | p12 | p10
(assert (or (not l_f15) l_p12 l_p10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p12 | ~p10) --> f15_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f15) r_p12 r_p10))
