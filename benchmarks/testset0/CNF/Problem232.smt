;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p6 | (p3 | (p0 | (p1 | p5)))) & ((p6 | (p3 | (p6 | (p8 | p7)))) & ((p6 | (p10 | (p4 | (p11 | p9)))) & ((p7 | (p13 | (p10 | (p14 | p12)))) & (p6 | (p0 | (p4 | (p16 | p15))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f23 | p14 | p12
(assert (or (not l_f23) l_p14 l_p12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | p12) --> f23_p))
;%------------------------Clausification start------------------------%
...
;%~f27 | p16 | p15
(assert (or (not l_f27) l_p16 l_p15))
...
(assert (or (not r_f23) r_p14 r_p12))
...
(assert (or (not r_f27) r_p16 r_p15))
