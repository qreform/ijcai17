...
;%~f10 | p11 | p9
(assert (or (not l_f10) l_p11 l_p9))
...
;%~f15 | p17 | p15
(assert (or (not l_f15) l_p17 l_p15))
...
;%~f14 | p16 | f15
(assert (or (not l_f14) l_p16 l_f15))
...
(assert (or (not r_f10) r_p11 r_p9))
...
(assert (or (not r_f15) r_p17 r_p15))
...
(assert (or (not r_f14) r_p16 r_f15))


;%~r_p16 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p16) r_f14_p))
