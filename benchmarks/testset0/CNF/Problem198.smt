;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (~p3 | (p4 | (p5 | ~p0))))) & ((~p3 | (~p3 | (~p1 | (~p1 | (~p3 | ~p6))))) & ((~p0 | (~p3 | (p0 | (p8 | (~p4 | ~p7))))) & ((p0 | (~p10 | (~p4 | (~p8 | (p7 | ~p9))))) & (p5 | (p9 | (p10 | (p5 | (~p6 | ~p11))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f27 | p6 | p11
(assert (or (not l_f27) l_p6 l_p11))
...
;%~f23 | p5 | f24
(assert (or (not l_f23) l_p5 l_f24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p5 | f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f27) r_p6 r_p11))
...
(assert (or (not r_f23) r_p5 r_f24))
