;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | p0)) & ((p2 | (p0 | p3)) & ((p5 | (p2 | p4)) & ((p7 | (p4 | p6)) & (p9 | (p6 | p8)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~zcl_0 | f9
(assert (or (not l_zcl_0) l_f9))

;%~zcl_0 | f11
(assert (or (not l_zcl_0) l_f11))

;%~f9 | ~f11 | zcl_0
(assert (or (not l_f9) (not l_f11) l_zcl_0))
...
;%~f6 | ~f8 | zcl_1
(assert (or (not l_f6) (not l_f8) l_zcl_1))
...
;%~f0 | ~f2 | zcl_3
(assert (or (not l_f0) (not l_f2) l_zcl_3))
...
;%~r_f9 | ~r_f11 | r_zcl_0
(assert (or (not r_f9) (not r_f11) r_zcl_0))
...
;%~r_f6 | ~r_f8 | r_zcl_1
(assert (or (not r_f6) (not r_f8) r_zcl_1))
...
;%~r_f0 | ~r_f2 | r_zcl_3
(assert (or (not r_f0) (not r_f2) r_zcl_3))
