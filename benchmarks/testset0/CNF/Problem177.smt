;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p5 | (~p6 | (p7 | ~p4))) & ((p5 | (p5 | (~p4 | ~p8))) & ((~p10 | (p6 | (~p1 | p9))) & (p1 | (~p4 | (~p12 | ~p11))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f17 | p12 | p11
(assert (or (not l_f17) l_p12 l_p11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p12 | ~p11) --> f17_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f17) r_p12 r_p11))
