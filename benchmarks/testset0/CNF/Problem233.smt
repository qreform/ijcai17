;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p6 | (p4 | (p7 | (p8 | p5)))) & ((p2 | (p3 | (p7 | (p10 | p9)))) & ((p12 | (p13 | (p14 | (p15 | p11)))) & ((p4 | (p1 | (p17 | (p6 | p16)))) & (p19 | (p15 | (p7 | (p9 | p18))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f13 | p10 | p9
(assert (or (not l_f13) l_p10 l_p9))
...
;%~f18 | p15 | p11
(assert (or (not l_f18) l_p15 l_p11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p15 | p11) --> f18_p))
;%------------------------Clausification start------------------------%
...
;%~f17 | p14 | f18
(assert (or (not l_f17) l_p14 l_f18))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | f18_p) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p14 | f17_p
(assert (or (not l_p14) l_f17_p))
...
;%~f16 | p13 | f17
(assert (or (not l_f16) l_p13 l_f17))
...
;%~f23 | p6 | p16
(assert (or (not l_f23) l_p6 l_p16))
...
;%~f22 | p17 | f23
(assert (or (not l_f22) l_p17 l_f23))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p17 | f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
...
;%~f27 | p9 | p18
(assert (or (not l_f27) l_p9 l_p18))
...
;%~f26 | p7 | f27
(assert (or (not l_f26) l_p7 l_f27))
...
;%~f25 | p15 | f26
(assert (or (not l_f25) l_p15 l_f26))
...
;%~f24 | p19 | f25
(assert (or (not l_f24) l_p19 l_f25))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p19 | f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p19 | f24_p
(assert (or (not l_p19) l_f24_p))
...
(assert (or (not r_f13) r_p10 r_p9))
...
(assert (or (not r_f18) r_p15 r_p11))
...
(assert (or (not r_f17) r_p14 r_f18))


;%~r_p14 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p14) r_f17_p))
...
(assert (or (not r_f16) r_p13 r_f17))
...
(assert (or (not r_f23) r_p6 r_p16))
...
(assert (or (not r_f22) r_p17 r_f23))
...
(assert (or (not r_f27) r_p9 r_p18))
...
;%~r_p18 | r_f27_p
(assert (or (not r_p18) r_f27_p))


;%~r_f26 | r_p7 | r_f27
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_p7 r_f27))


;%~r_p7 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p7) r_f26_p))
...
(assert (or (not r_f25) r_p15 r_f26))


;%~r_p15 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p15) r_f25_p))
...
(assert (or (not r_f24) r_p19 r_f25))


;%~r_p19 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p19) r_f24_p))
