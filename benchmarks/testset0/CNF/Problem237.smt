;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | (~p4 | ~p0)))) & ((~p4 | (~p3 | (p0 | (~p1 | p5)))) & ((~p0 | (p0 | (~p5 | (p0 | p6)))) & ((~p4 | (p3 | (p6 | (~p0 | ~p7)))) & ((p1 | (p9 | (~p1 | (p4 | p8)))) & (p11 | (~p8 | (~p1 | (~p8 | ~p10))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f26 | p1 | f27
(assert (or (not l_f26) l_p1 l_f27))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p1 | f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p1 | f26_p
(assert (or (not l_p1) l_f26_p))
...
;%~f25 | p8 | f26
(assert (or (not l_f25) l_p8 l_f26))
...
(assert (or (not r_f26) r_p1 r_f27))


;%~r_p1 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p1) r_f26_p))
...
(assert (or (not r_f25) r_p8 r_f26))


;%~r_p8 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p8) r_f25_p))
