;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p1 | (p0 | (p5 | p4))) & ((p7 | (p4 | (p2 | p6))) & ((p9 | (p10 | (p2 | p8))) & ((p4 | (p12 | (p8 | p11))) & (p14 | (p9 | (p9 | p13)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f18 | p8 | p11
(assert (or (not l_f18) l_p8 l_p11))
...
;%~f17 | p12 | f18
(assert (or (not l_f17) l_p12 l_f18))
...
;%~f21 | p9 | p13
(assert (or (not l_f21) l_p9 l_p13))
...
(assert (or (not r_f18) r_p8 r_p11))
...
(assert (or (not r_f17) r_p12 r_f18))
...
(assert (or (not r_f21) r_p9 r_p13))
