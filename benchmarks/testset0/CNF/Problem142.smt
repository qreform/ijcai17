;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | (p5 | p0))))) & ((p2 | (p5 | (p7 | (p8 | (p0 | p6))))) & ((p7 | (p8 | (p5 | (p3 | (p8 | p9))))) & (p11 | (p12 | (p3 | (p13 | (p2 | p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f21 | p2 | p10
(assert (or (not l_f21) l_p2 l_p10))
...
(assert (or (not r_f21) r_p2 r_p10))
