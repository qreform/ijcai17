;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | (p5 | p0))))) & ((p2 | (p7 | (p0 | (p5 | (p3 | p6))))) & ((p9 | (p5 | (p7 | (p6 | (p10 | p8))))) & ((p4 | (p12 | (p10 | (p6 | (p4 | p11))))) & (p3 | (p8 | (p14 | (p4 | (p15 | p13))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f16 | p10 | p8
(assert (or (not l_f16) l_p10 l_p8))
...
;%~f22 | p4 | p11
(assert (or (not l_f22) l_p4 l_p11))
...
;%~f27 | p15 | p13
(assert (or (not l_f27) l_p15 l_p13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p15 | p13) --> f27_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f16) r_p10 r_p8))
...
(assert (or (not r_f22) r_p4 r_p11))
...
(assert (or (not r_f27) r_p15 r_p13))
