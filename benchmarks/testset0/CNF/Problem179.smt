;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (p3 | ~p0))) & ((~p3 | (~p3 | (~p5 | p4))) & ((~p4 | (~p7 | (p0 | p6))) & ((p0 | (~p1 | (~p1 | p8))) & (~p1 | (p10 | (~p6 | ~p9))))))) %%%%%%%%%%%%%%%%%%%%%
