...
;%~f23 | p24 | p20
(assert (or (not l_f23) l_p24 l_p20))
...
;%~p24 | f23_p
(assert (or (not l_p24) l_f23_p))

;%~p20 | f23_p
(assert (or (not l_p20) l_f23_p))
...
;%~f22 | p23 | f23
(assert (or (not l_f22) l_p23 l_f23))
...
;%~f27 | p29 | p25
(assert (or (not l_f27) l_p29 l_p25))
...
(assert (or (not r_f23) r_p24 r_p20))


;%~r_p24 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p24) r_f23_p))


;%~r_p20 | r_f23_p
(assert (or (not r_p20) r_f23_p))


;%~r_f22 | r_p23 | r_f23
(declare-fun r_f22 () Bool)
(assert (or (not r_f22) r_p23 r_f23))
...
(assert (or (not r_f27) r_p29 r_p25))
