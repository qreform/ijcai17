;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p5 | (p3 | (p1 | p4))) & (p2 | (p7 | (p3 | p6))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~zcl_0 | f7
(assert (or (not l_zcl_0) l_f7))

;%~f4 | ~f7 | zcl_0
(assert (or (not l_f4) (not l_f7) l_zcl_0))
...
;%~f0 | ~f3 | zcl_1
(assert (or (not l_f0) (not l_f3) l_zcl_1))
...
;%~r_zcl_0 | r_f7
(assert (or (not r_zcl_0) r_f7))


;%~r_f4 | ~r_f7 | r_zcl_0
(assert (or (not r_f4) (not r_f7) r_zcl_0))
...
;%~r_f0 | ~r_f3 | r_zcl_1
(assert (or (not r_f0) (not r_f3) r_zcl_1))
