;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (~p3 | ~p0))) & ((~p3 | (~p1 | (~p3 | p4))) & ((p3 | (p0 | (p0 | ~p5))) & ((p7 | (~p0 | (~p5 | ~p6))) & (p1 | (~p9 | (~p10 | p8))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f17 | p10 | p8
(assert (or (not l_f17) l_p10 l_p8))
...
(assert (or (not r_f17) r_p10 r_p8))
