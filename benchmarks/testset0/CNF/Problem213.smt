;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | p0)) & ((p4 | (p0 | p3)) & ((p6 | (p7 | p5)) & ((p6 | (p9 | p8)) & ((p4 | (p11 | p10)) & (p0 | (p2 | p12))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f13 | p11 | p10
(assert (or (not l_f13) l_p11 l_p10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p11 | p10) --> f13_p))
;%------------------------Clausification start------------------------%
...
;%~f15 | p2 | p12
(assert (or (not l_f15) l_p2 l_p12))
...
(assert (or (not r_f13) r_p11 r_p10))
...
(assert (or (not r_f15) r_p2 r_p12))
