;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | p0))) & ((p0 | (~p5 | (p3 | ~p4))) & ((p0 | (p7 | (~p8 | p6))) & ((p2 | (~p5 | (~p6 | ~p9))) & ((~p8 | (p11 | (p0 | ~p10))) & (p13 | (~p2 | (p11 | p12)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f18 | p0 | p10
(assert (or (not l_f18) l_p0 l_p10))
...
;%~f21 | p11 | p12
(assert (or (not l_f21) l_p11 l_p12))
...
;%~f19 | p13 | f20
(assert (or (not l_f19) l_p13 l_f20))
...
(assert (or (not r_f18) r_p0 r_p10))
...
(assert (or (not r_f21) r_p11 r_p12))
...
(assert (or (not r_f19) r_p13 r_f20))


;%~r_p13 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p13) r_f19_p))
