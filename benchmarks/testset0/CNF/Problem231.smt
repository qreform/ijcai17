;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p1 | (p6 | (p0 | (p7 | p5)))) & ((p9 | (p7 | (p6 | (p10 | p8)))) & ((p12 | (p7 | (p13 | (p5 | p11)))) & ((p15 | (p0 | (p0 | (p13 | p14)))) & (p13 | (p17 | (p13 | (p8 | p16))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f13 | p10 | p8
(assert (or (not l_f13) l_p10 l_p8))
...
;%~f18 | p5 | p11
(assert (or (not l_f18) l_p5 l_p11))
...
;%~f15 | p12 | f16
(assert (or (not l_f15) l_p12 l_f16))
...
;%~f23 | p13 | p14
(assert (or (not l_f23) l_p13 l_p14))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p13 | p14) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p13 | f23_p
(assert (or (not l_p13) l_f23_p))
...
;%~f27 | p8 | p16
(assert (or (not l_f27) l_p8 l_p16))
...
;%~f26 | p13 | f27
(assert (or (not l_f26) l_p13 l_f27))
...
;%~f25 | p17 | f26
(assert (or (not l_f25) l_p17 l_f26))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p17 | f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p17 | f25_p
(assert (or (not l_p17) l_f25_p))
...
(assert (or (not r_f13) r_p10 r_p8))
...
(assert (or (not r_f18) r_p5 r_p11))
...
(assert (or (not r_f15) r_p12 r_f16))


;%~r_p12 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p12) r_f15_p))
...
(assert (or (not r_f23) r_p13 r_p14))


;%~r_p13 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p13) r_f23_p))
...
(assert (or (not r_f27) r_p8 r_p16))


;%~r_p8 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p8) r_f27_p))
...
(assert (or (not r_f26) r_p13 r_f27))


;%~r_p13 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p13) r_f26_p))
...
(assert (or (not r_f25) r_p17 r_f26))


;%~r_p17 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p17) r_f25_p))
