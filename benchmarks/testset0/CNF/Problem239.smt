;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (p3 | (p4 | ~p0)))) & ((p4 | (p6 | (~p3 | (~p2 | p5)))) & ((~p6 | (p5 | (~p6 | (~p2 | ~p7)))) & ((~p1 | (p9 | (~p10 | (~p4 | ~p8)))) & ((~p10 | (~p0 | (p1 | (~p9 | ~p11)))) & (~p1 | (p4 | (~p7 | (p13 | p12))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f23 | p9 | p11
(assert (or (not l_f23) l_p9 l_p11))
...
;%~f22 | p1 | f23
(assert (or (not l_f22) l_p1 l_f23))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p1 | f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
...
;%~f27 | p13 | p12
(assert (or (not l_f27) l_p13 l_p12))
...
;%~f25 | p4 | f26
(assert (or (not l_f25) l_p4 l_f26))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p4 | f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p4 | f25_p
(assert (or (not l_p4) l_f25_p))
...
(assert (or (not r_f23) r_p9 r_p11))
...
(assert (or (not r_f22) r_p1 r_f23))
...
(assert (or (not r_f27) r_p13 r_p12))
...
(assert (or (not r_f25) r_p4 r_f26))


;%~r_p4 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p4) r_f25_p))
