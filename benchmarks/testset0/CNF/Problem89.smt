;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | (~p4 | ~p0)))) & ((~p3 | (~p1 | (~p2 | (~p0 | p5)))) & (~p5 | (p0 | (p5 | (p2 | ~p6)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f5 | ~f9 | zcl_0
(assert (or (not l_f5) (not l_f9) l_zcl_0))
...
;%~f0 | ~f4 | zcl_1
(assert (or (not l_f0) (not l_f4) l_zcl_1))
...
;%~r_f5 | ~r_f9 | r_zcl_0
(assert (or (not r_f5) (not r_f9) r_zcl_0))
...
;%~r_f0 | ~r_f4 | r_zcl_1
(assert (or (not r_f0) (not r_f4) r_zcl_1))
