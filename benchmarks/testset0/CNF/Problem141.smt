;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | (p5 | p0))))) & ((p7 | (p0 | (p3 | (p4 | (p4 | p6))))) & ((p4 | (p5 | (p3 | (p9 | (p2 | p8))))) & (p0 | (p0 | (p3 | (p11 | (p1 | p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f21 | p1 | p10
(assert (or (not l_f21) l_p1 l_p10))
...
(assert (or (not r_f21) r_p1 r_p10))
