;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | p0) & ((p1 | p2) & ((p4 | p3) & ((p1 | p5) & ((p0 | p6) & (p0 | p7)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f8 | ~f9 | zcl_0
(assert (or (not l_f8) (not l_f9) l_zcl_0))
...
;%~f6 | ~f7 | zcl_1
(assert (or (not l_f6) (not l_f7) l_zcl_1))
...
;%~f4 | ~f5 | zcl_2
(assert (or (not l_f4) (not l_f5) l_zcl_2))
...
;%~r_f8 | ~r_f9 | r_zcl_0
(assert (or (not r_f8) (not r_f9) r_zcl_0))
...
;%~r_f6 | ~r_f7 | r_zcl_1
(assert (or (not r_f6) (not r_f7) r_zcl_1))
...
;%~r_f4 | ~r_f5 | r_zcl_2
(assert (or (not r_f4) (not r_f5) r_zcl_2))
