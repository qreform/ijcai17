;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | p0)) & ((p4 | (p5 | p3)) & ((p7 | (p8 | p6)) & ((p10 | (p2 | p9)) & (p1 | (p2 | p11)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f12 | p2 | p11
(assert (or (not l_f12) l_p2 l_p11))
...
(assert (or (not r_f12) r_p2 r_p11))
