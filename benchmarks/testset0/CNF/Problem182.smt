;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p3 | (p3 | (p6 | (p7 | p5)))) & ((p9 | (p6 | (p10 | (p11 | p8)))) & ((p0 | (p11 | (p3 | (p6 | p12)))) & (p7 | (p9 | (p10 | (p14 | p13)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f13 | p11 | p8
(assert (or (not l_f13) l_p11 l_p8))
...
;%~f18 | p6 | p12
(assert (or (not l_f18) l_p6 l_p12))
...
(assert (or (not r_f13) r_p11 r_p8))
...
(assert (or (not r_f18) r_p6 r_p12))
