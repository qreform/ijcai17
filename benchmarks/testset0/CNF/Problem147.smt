;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (p2 | (~p3 | (~p4 | (~p5 | p0))))) & ((~p2 | (p1 | (p1 | (~p5 | (~p2 | ~p6))))) & ((~p6 | (p1 | (~p0 | (p1 | (p8 | p7))))) & (~p4 | (~p10 | (p11 | (p4 | (~p12 | ~p9)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f21 | p12 | p9
(assert (or (not l_f21) l_p12 l_p9))
...
(assert (or (not r_f21) r_p12 r_p9))
