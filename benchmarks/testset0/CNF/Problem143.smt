;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | (p5 | p0))))) & ((p0 | (p0 | (p4 | (p4 | (p7 | p6))))) & ((p9 | (p7 | (p6 | (p4 | (p10 | p8))))) & (p12 | (p13 | (p10 | (p4 | (p0 | p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f21 | p0 | p11
(assert (or (not l_f21) l_p0 l_p11))
...
(assert (or (not r_f21) r_p0 r_p11))
