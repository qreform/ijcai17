;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (~p3 | (~p4 | (p5 | ~p0))))) & ((~p4 | (~p7 | (~p8 | (~p0 | (~p0 | ~p6))))) & ((~p10 | (~p7 | (~p7 | (~p7 | (~p7 | ~p9))))) & ((p12 | (p7 | (p13 | (~p2 | (~p2 | ~p11))))) & (~p3 | (p10 | (~p15 | (~p5 | (p2 | ~p14))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f22 | p2 | p11
(assert (or (not l_f22) l_p2 l_p11))
...
;%~f21 | p2 | f22
(assert (or (not l_f21) l_p2 l_f22))
...
;%~f20 | p13 | f21
(assert (or (not l_f20) l_p13 l_f21))
...
;%~f18 | p12 | f19
(assert (or (not l_f18) l_p12 l_f19))
...
;%~f27 | p2 | p14
(assert (or (not l_f27) l_p2 l_p14))
...
;%~f26 | p5 | f27
(assert (or (not l_f26) l_p5 l_f27))
...
;%~f23 | p3 | f24
(assert (or (not l_f23) l_p3 l_f24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p3 | f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p3 | f23_p
(assert (or (not l_p3) l_f23_p))
...
(assert (or (not r_f22) r_p2 r_p11))
...
(assert (or (not r_f21) r_p2 r_f22))


;%~r_p2 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p2) r_f21_p))
...
(assert (or (not r_f20) r_p13 r_f21))


;%~r_p13 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p13) r_f20_p))
...
(assert (or (not r_f18) r_p12 r_f19))


;%~r_p12 | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p12) r_f18_p))
...
(assert (or (not r_f27) r_p2 r_p14))


;%~r_p2 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p2) r_f27_p))
...
(assert (or (not r_f26) r_p5 r_f27))


;%~r_p5 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p5) r_f26_p))
...
(assert (or (not r_f23) r_p3 r_f24))


;%~r_p3 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p3) r_f23_p))
