;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (p2 | (~p3 | (p4 | (p5 | p0))))) & ((p0 | (~p7 | (p4 | (p0 | (p5 | p6))))) & ((~p2 | (p7 | (~p2 | (~p0 | (~p0 | ~p8))))) & (~p7 | (p3 | (~p0 | (p3 | (~p3 | ~p9)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f18 | p3 | f19
(assert (or (not l_f18) l_p3 l_f19))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p3 | f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f18) r_p3 r_f19))
