;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | (p5 | p0))))) & ((p4 | (p3 | (p2 | (p7 | (p5 | p6))))) & ((p1 | (p9 | (p3 | (p10 | (p11 | p8))))) & ((p5 | (p7 | (p9 | (p13 | (p14 | p12))))) & (p16 | (p14 | (p5 | (p0 | (p4 | p15))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f16 | p11 | p8
(assert (or (not l_f16) l_p11 l_p8))
...
;%~f14 | p3 | f15
(assert (or (not l_f14) l_p3 l_f15))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p3 | f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
...
;%~f22 | p14 | p12
(assert (or (not l_f22) l_p14 l_p12))
...
;%~f21 | p13 | f22
(assert (or (not l_f21) l_p13 l_f22))
...
;%~f19 | p7 | f20
(assert (or (not l_f19) l_p7 l_f20))
...
;%~f27 | p4 | p15
(assert (or (not l_f27) l_p4 l_p15))
...
;%~f25 | p5 | f26
(assert (or (not l_f25) l_p5 l_f26))
...
;%~f24 | p14 | f25
(assert (or (not l_f24) l_p14 l_f25))
...
;%~f23 | p16 | f24
(assert (or (not l_f23) l_p16 l_f24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p16 | f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p16 | f23_p
(assert (or (not l_p16) l_f23_p))
...
(assert (or (not r_f16) r_p11 r_p8))
...
(assert (or (not r_f14) r_p3 r_f15))
...
(assert (or (not r_f22) r_p14 r_p12))


;%~r_p14 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p14) r_f22_p))
...
(assert (or (not r_f21) r_p13 r_f22))


;%~r_p13 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p13) r_f21_p))
...
(assert (or (not r_f19) r_p7 r_f20))


;%~r_p7 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p7) r_f19_p))
...
(assert (or (not r_f27) r_p4 r_p15))
...
(assert (or (not r_f25) r_p5 r_f26))


;%~r_p5 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p5) r_f25_p))
...
(assert (or (not r_f24) r_p14 r_f25))


;%~r_p14 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p14) r_f24_p))
...
(assert (or (not r_f23) r_p16 r_f24))


;%~r_p16 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p16) r_f23_p))
