;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (p2 | (~p3 | (p4 | (p5 | p0))))) & ((~p7 | (~p8 | (p9 | (p3 | (~p10 | p6))))) & (p12 | (~p8 | (~p4 | (~p13 | (~p14 | p11))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f10 | p10 | p6
(assert (or (not l_f10) l_p10 l_p6))
...
;%~f15 | p14 | p11
(assert (or (not l_f15) l_p14 l_p11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p14 | p11) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p14 | f15_p
(assert (or (not l_p14) l_f15_p))
...
;%~f14 | p13 | f15
(assert (or (not l_f14) l_p13 l_f15))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p13 | f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p13 | f14_p
(assert (or (not l_p13) l_f14_p))
...
(assert (or (not r_f10) r_p10 r_p6))
...
(assert (or (not r_f15) r_p14 r_p11))


;%~r_p14 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p14) r_f15_p))
...
(assert (or (not r_f14) r_p13 r_f15))


;%~r_p13 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p13) r_f14_p))
