...
;%~f27 | p29 | p24
(assert (or (not l_f27) l_p29 l_p24))
...
;%~p29 | f27_p
(assert (or (not l_p29) l_f27_p))

;%~p24 | f27_p
(assert (or (not l_p24) l_f27_p))
...
;%~f26 | p28 | f27
(assert (or (not l_f26) l_p28 l_f27))
...
;%~f25 | p27 | f26
(assert (or (not l_f25) l_p27 l_f26))
...
;%~f24 | p26 | f25
(assert (or (not l_f24) l_p26 l_f25))
...
;%~f23 | p25 | f24
(assert (or (not l_f23) l_p25 l_f24))
...
(assert (or (not r_f27) r_p29 r_p24))


;%~r_p29 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p29) r_f27_p))


;%~r_p24 | r_f27_p
(assert (or (not r_p24) r_f27_p))


;%~r_f26 | r_p28 | r_f27
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_p28 r_f27))


;%~r_p28 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p28) r_f26_p))
...
(assert (or (not r_f25) r_p27 r_f26))


;%~r_p27 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p27) r_f25_p))
...
(assert (or (not r_f24) r_p26 r_f25))


;%~r_p26 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p26) r_f24_p))
...
(assert (or (not r_f23) r_p25 r_f24))


;%~r_p25 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p25) r_f23_p))
