;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p0 & (~p0 & (p5 & (~p9 & ~p8)))) | ((~p5 | (~p0 | (p0 | (~p0 | ~p7)))) & ((~p0 & (~p0 & (~p0 & (~p6 & ~p5)))) | (~p1 & (~p2 & (p3 & (~p4 & ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~p8 | f3_p
(assert (or (not l_p9) (not l_p8) l_f3_p))
...
;%~p6 | ~p5 | zcl_4
(assert (or (not l_p6) (not l_p5) l_zcl_4))
...
;%~p6 | ~p5 | f13_p
(assert (or (not l_p6) (not l_p5) l_f13_p))
...
(assert (or (not r_p9) (not r_p8) r_f3_p))
...
;%~r_p6 | ~r_p5 | r_zcl_4
(assert (or (not r_p6) (not r_p5) r_zcl_4))
...
(assert (or (not r_p6) (not r_p5) r_f13_p))
