;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p3 & (p3 & (p3 & p8))) | ((p3 | (p2 | (p2 | p7))) & ((p3 & (p2 & (p6 & p5))) | ((p1 | (p1 | (p0 | p4))) & (p1 | (p2 | (p3 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p3 | ~p8 | zcl_0
(assert (or (not l_p3) (not l_p8) l_zcl_0))
...
;%~p3 | ~p8 | f2_p
(assert (or (not l_p3) (not l_p8) l_f2_p))
...
;%~p3 | ~f2 | zcl_1
(assert (or (not l_p3) (not l_f2) l_zcl_1))
...
;%~p6 | ~p5 | f10_p
(assert (or (not l_p6) (not l_p5) l_f10_p))
...
;%~r_p3 | ~r_p8 | r_zcl_0
(assert (or (not r_p3) (not r_p8) r_zcl_0))
...
(assert (or (not r_p3) (not r_p8) r_f2_p))
...
;%~r_p3 | ~r_f2 | r_zcl_1
(assert (or (not r_p3) (not r_f2) r_zcl_1))
...
(assert (or (not r_p6) (not r_p5) r_f10_p))
