;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p10 & (p4 & (p1 & p9))) | ((p2 | (p5 | (p1 | p8))) & ((p1 & (p6 & (p7 & p5))) | ((p2 | (p2 | (p2 | p4))) & (p1 | (p2 | (p3 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p9 | zcl_0
(assert (or (not l_p1) (not l_p9) l_zcl_0))
...
;%~p1 | ~p9 | f2_p
(assert (or (not l_p1) (not l_p9) l_f2_p))
...
;%~p4 | ~f2 | zcl_1
(assert (or (not l_p4) (not l_f2) l_zcl_1))
...
;%~p10 | ~f1 | zcl_2
(assert (or (not l_p10) (not l_f1) l_zcl_2))
...
;%~p6 | ~f10 | zcl_4
(assert (or (not l_p6) (not l_f10) l_zcl_4))
...
;%~r_p1 | ~r_p9 | r_zcl_0
(assert (or (not r_p1) (not r_p9) r_zcl_0))
...
(assert (or (not r_p1) (not r_p9) r_f2_p))
...
;%~r_p4 | ~r_f2 | r_zcl_1
(assert (or (not r_p4) (not r_f2) r_zcl_1))
...
;%~r_p10 | ~r_f1 | r_zcl_2
(assert (or (not r_p10) (not r_f1) r_zcl_2))
...
;%~r_p6 | ~r_f10 | r_zcl_4
(assert (or (not r_p6) (not r_f10) r_zcl_4))
