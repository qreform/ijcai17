;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p7 & (p1 & p9)) | ((p5 | (p8 | p7)) & ((p1 & (p2 & p6)) | ((p4 | (p5 | p3)) & (p1 | (p2 | p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p9 | f1_p
(assert (or (not l_p1) (not l_p9) l_f1_p))
...
;%~p2 | ~p6 | f7_p
(assert (or (not l_p2) (not l_p6) l_f7_p))
...
;%~p1 | ~f7 | zcl_3
(assert (or (not l_p1) (not l_f7) l_zcl_3))
...
(assert (or (not r_p1) (not r_p9) r_f1_p))
...
(assert (or (not r_p2) (not r_p6) r_f7_p))
...
;%~r_p1 | ~r_f7 | r_zcl_3
(assert (or (not r_p1) (not r_f7) r_zcl_3))
