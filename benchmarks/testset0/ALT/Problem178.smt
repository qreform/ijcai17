;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p5 | (~p4 | ~p8)) & ((~p6 & (~p7 & ~p5)) | ((p1 | (~p4 | p3)) & (~p1 | (~p2 | ~p0))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~p5 | zcl_0
(assert (or (not l_p7) (not l_p5) l_zcl_0))
...
;%~p7 | ~p5 | f4_p
(assert (or (not l_p7) (not l_p5) l_f4_p))
...
;%~r_p7 | ~r_p5 | r_zcl_0
(assert (or (not r_p7) (not r_p5) r_zcl_0))
...
(assert (or (not r_p7) (not r_p5) r_f4_p))
