;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p5 | (~p8 | (p12 | (~p13 | ~p11)))) & ((~p0 & (~p0 & (p0 & (p10 & p9)))) | ((~p0 | (~p5 | (p0 | (p8 | ~p7)))) & ((p0 & (~p6 & (~p0 & (~p0 & ~p5)))) | (~p1 & (p2 & (p3 & (p4 & ~p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f3 | p13 | p11
(assert (or (not l_f3) l_p13 l_p11))
...
;%~p10 | ~p9 | f8_p
(assert (or (not l_p10) (not l_p9) l_f8_p))
...
(assert (or (not r_f3) r_p13 r_p11))
...
(assert (or (not r_p10) (not r_p9) r_f8_p))
