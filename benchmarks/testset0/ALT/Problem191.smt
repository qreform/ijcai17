;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p10 | (p4 | (p11 | (p12 | p9)))) & ((p5 & (p4 & (p0 & (p8 & p7)))) | ((p1 | (p3 | (p1 | (p6 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p7 | f8_p
(assert (or (not l_p8) (not l_p7) l_f8_p))
...
;%~p4 | ~f7 | zcl_2
(assert (or (not l_p4) (not l_f7) l_zcl_2))
...
;%~p4 | ~f7_p | f6_p
(assert (or (not l_p4) (not l_f7_p) l_f6_p))
...
;%~p5 | ~f6 | zcl_3
(assert (or (not l_p5) (not l_f6) l_zcl_3))
...
;%~p5 | ~f6_p | f5_p
(assert (or (not l_p5) (not l_f6_p) l_f5_p))
...
;%~f11 | p3 | f12
(assert (or (not l_f11) l_p3 l_f12))
...
;%~f10 | p1 | f11
(assert (or (not l_f10) l_p1 l_f11))
...
;%~f14 | p1 | f15
(assert (or (not l_f14) l_p1 l_f15))
...
;%~f10 | ~f14 | zcl_4
(assert (or (not l_f10) (not l_f14) l_zcl_4))
...
;%~zcl_5 | f0
(assert (or (not l_zcl_5) l_f0))

;%~zcl_5 | f4
(assert (or (not l_zcl_5) l_f4))

;%~f0 | ~f4 | zcl_5
(assert (or (not l_f0) (not l_f4) l_zcl_5))

;%~Q | zcl_5
(assert (or (not l_q) l_zcl_5))
...
(assert (or (not r_p8) (not r_p7) r_f8_p))
...
;%~r_p4 | ~r_f7 | r_zcl_2
(assert (or (not r_p4) (not r_f7) r_zcl_2))
...
(assert (or (not r_p4) (not r_f7_p) r_f6_p))
...
;%~r_p5 | ~r_f6 | r_zcl_3
(assert (or (not r_p5) (not r_f6) r_zcl_3))
...
(assert (or (not r_p5) (not r_f6_p) r_f5_p))


;%~r_f13 | r_p6 | r_p5
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_p6 r_p5))
...
(assert (or (not r_f11) r_p3 r_f12))


;%~r_p3 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p3) r_f11_p))
...
(assert (or (not r_f10) r_p1 r_f11))
...
(assert (or (not r_f14) r_p1 r_f15))
...
;%~r_f10 | ~r_f14 | r_zcl_4
(assert (or (not r_f10) (not r_f14) r_zcl_4))
...
(assert (or (not r_zcl_5) r_f0))


;%~r_zcl_5 | r_f4
(assert (or (not r_zcl_5) r_f4))


;%~r_f0 | ~r_f4 | r_zcl_5
(assert (or (not r_f0) (not r_f4) r_zcl_5))


;%~r_Q | r_zcl_5
(declare-fun r_q () Bool)
(assert (or (not r_q) r_zcl_5))
