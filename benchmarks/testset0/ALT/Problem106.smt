...
;%~f2 | p19 | p16
(assert (or (not l_f2) l_p19 l_p16))
...
;%~p15 | ~p12 | f6_p
(assert (or (not l_p15) (not l_p12) l_f6_p))
...
(assert (or (not r_f2) r_p19 r_p16))


;%~r_p19 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p19) r_f2_p))
...
(assert (or (not r_f0) r_p17 r_f1))


;%~r_p17 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p17) r_f0_p))
...
(assert (or (not r_p15) (not r_p12) r_f6_p))
