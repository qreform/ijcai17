;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p5 | ~p6) & ((~p4 & p5) | ((p0 | ~p4) & ((p3 & p2) | (~p1 & p0))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p3 | ~p2 | f6_p
(assert (or (not l_p3) (not l_p2) l_f6_p))
...
(assert (or (not r_p3) (not r_p2) r_f6_p))
