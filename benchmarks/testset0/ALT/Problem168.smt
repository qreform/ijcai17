;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | p5) & ((~p4 & p3) | ((~p1 | ~p2) & (~p1 | ~p0)))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p3 | zcl_0
(assert (or (not l_p4) (not l_p3) l_zcl_0))
...
;%~p4 | ~p3 | f2_p
(assert (or (not l_p4) (not l_p3) l_f2_p))
...
;%~r_p4 | ~r_p3 | r_zcl_0
(assert (or (not r_p4) (not r_p3) r_zcl_0))
...
(assert (or (not r_p4) (not r_p3) r_f2_p))
