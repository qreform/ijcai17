;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p11 & (~p4 & ~p10)) | ((p6 | (~p9 | ~p8)) & ((~p2 & (p7 & ~p6)) | ((p4 | (p5 | ~p3)) & (~p1 | (~p2 | ~p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p11 | ~f1 | zcl_1
(assert (or (not l_p11) (not l_f1) l_zcl_1))
...
;%~p7 | ~p6 | zcl_2
(assert (or (not l_p7) (not l_p6) l_zcl_2))
...
;%~r_p11 | ~r_f1 | r_zcl_1
(assert (or (not r_p11) (not r_f1) r_zcl_1))
...
;%~r_p7 | ~r_p6 | r_zcl_2
(assert (or (not r_p7) (not r_p6) r_zcl_2))
