;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p8 | (~p3 | ~p10)) & ((~p3 & (~p9 & ~p8)) | ((p7 | (p0 | ~p6)) & ((p4 & (~p5 & ~p3)) | (~p1 & (p2 & p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~p8 | f4_p
(assert (or (not l_p9) (not l_p8) l_f4_p))
...
;%~p5 | ~p3 | f10_p
(assert (or (not l_p5) (not l_p3) l_f10_p))
...
(assert (or (not r_p9) (not r_p8) r_f4_p))
...
(assert (or (not r_p5) (not r_p3) r_f10_p))
