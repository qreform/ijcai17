;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p2 & (~p5 & (~p3 & (~p5 & ~p11)))) | ((p2 | (p3 | (~p3 | (p10 | p9)))) & ((~p5 & (p8 & (p2 & (p2 & ~p7)))) | ((~p6 | (p4 | (~p4 | (~p3 | p5)))) & (~p1 | (~p2 | (~p3 | (p4 | p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~f12 | zcl_6
(assert (or (not l_p8) (not l_f12) l_zcl_6))
...
;%~r_p8 | ~r_f12 | r_zcl_6
(assert (or (not r_p8) (not r_f12) r_zcl_6))
