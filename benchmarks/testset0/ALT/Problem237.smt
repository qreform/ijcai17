;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p0 & (~p13 & (~p5 & (p14 & ~p12)))) | ((~p6 | (~p11 | (~p3 | (~p3 | ~p10)))) & ((~p4 & (p5 & (~p0 & (p9 & p8)))) | ((~p1 | (~p6 | (~p7 | (p2 | ~p5)))) & (~p1 | (p2 | (~p3 | (p4 | ~p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p14 | ~p12 | zcl_0
(assert (or (not l_p14) (not l_p12) l_zcl_0))
...
;%~p14 | ~p12 | f3_p
(assert (or (not l_p14) (not l_p12) l_f3_p))
...
;%~p9 | ~p8 | f13_p
(assert (or (not l_p9) (not l_p8) l_f13_p))
...
;%~f17 | p7 | f18
(assert (or (not l_f17) l_p7 l_f18))
...
;%~r_p14 | ~r_p12 | r_zcl_0
(assert (or (not r_p14) (not r_p12) r_zcl_0))
...
(assert (or (not r_p14) (not r_p12) r_f3_p))
...
(assert (or (not r_p9) (not r_p8) r_f13_p))
...
(assert (or (not r_f17) r_p7 r_f18))


;%~r_p7 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p7) r_f17_p))
