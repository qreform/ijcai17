;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (p6 & (p10 & (~p3 & p9)))) | ((~p6 | (p6 | (p4 | (p0 | p8)))) & ((~p6 & (~p3 & (~p1 & (~p4 & ~p7)))) | ((p1 | (p6 | (~p0 | (p0 | ~p5)))) & (~p1 | (~p2 | (p3 | (~p4 | ~p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p10 | ~f3 | zcl_1
(assert (or (not l_p10) (not l_f3) l_zcl_1))
...
;%~p10 | ~f3_p | f2_p
(assert (or (not l_p10) (not l_f3_p) l_f2_p))
...
;%~r_p10 | ~r_f3 | r_zcl_1
(assert (or (not r_p10) (not r_f3) r_zcl_1))
...
(assert (or (not r_p10) (not r_f3_p) r_f2_p))
