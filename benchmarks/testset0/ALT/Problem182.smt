;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p8 | (p9 | (p0 | p7))) & ((p4 & (p5 & (p5 & p6))) | ((p3 | (p2 | (p5 | p4))) & (p1 | (p2 | (p3 | p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p6 | f6_p
(assert (or (not l_p5) (not l_p6) l_f6_p))
...
(assert (or (not r_p5) (not r_p6) r_f6_p))
