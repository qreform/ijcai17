;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p3 & (p4 & (p0 & (p12 & p11)))) | ((p9 | (p10 | (p4 | (p5 | p8)))) & ((p0 & (p0 & (p0 & (p4 & p7)))) | ((p2 | (p4 | (p6 | (p1 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p7 | zcl_4
(assert (or (not l_p4) (not l_p7) l_zcl_4))
...
;%~p4 | ~p7 | f13_p
(assert (or (not l_p4) (not l_p7) l_f13_p))
...
;%~r_p4 | ~r_p7 | r_zcl_4
(assert (or (not r_p4) (not r_p7) r_zcl_4))
...
(assert (or (not r_p4) (not r_p7) r_f13_p))
