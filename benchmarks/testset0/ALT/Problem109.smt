;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p0 | (~p0 | (p0 | ~p12))) & ((p10 & (p11 & (p4 & ~p9))) | ((p4 | (~p7 | (p8 | p6))) & ((~p0 & (~p5 & (~p0 & ~p4))) | (p1 & (~p2 & (p3 & p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p9 | zcl_0
(assert (or (not l_p4) (not l_p9) l_zcl_0))
...
;%~p4 | ~p9 | f6_p
(assert (or (not l_p4) (not l_p9) l_f6_p))
...
;%~p11 | ~f6 | zcl_1
(assert (or (not l_p11) (not l_f6) l_zcl_1))
...
;%~p10 | ~f5 | zcl_2
(assert (or (not l_p10) (not l_f5) l_zcl_2))
...
;%~r_p4 | ~r_p9 | r_zcl_0
(assert (or (not r_p4) (not r_p9) r_zcl_0))
...
(assert (or (not r_p4) (not r_p9) r_f6_p))
...
;%~r_p11 | ~r_f6 | r_zcl_1
(assert (or (not r_p11) (not r_f6) r_zcl_1))
...
;%~r_p10 | ~r_f5 | r_zcl_2
(assert (or (not r_p10) (not r_f5) r_zcl_2))
