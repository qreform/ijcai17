;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p7 | (p6 | p8)) & ((p3 & (p3 & p7)) | ((p6 | (p0 | p5)) & ((p0 & (p4 & p3)) | (p1 & (p2 & p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p3 | f10_p
(assert (or (not l_p4) (not l_p3) l_f10_p))
...
(assert (or (not r_p4) (not r_p3) r_f10_p))
