...
;%~p19 | ~p15 | zcl_0
(assert (or (not l_p19) (not l_p15) l_zcl_0))
...
;%~p19 | ~p15 | f3_p
(assert (or (not l_p19) (not l_p15) l_f3_p))
...
;%~p17 | ~f2 | zcl_2
(assert (or (not l_p17) (not l_f2) l_zcl_2))
...
;%~zcl_3 | p16
(assert (or (not l_zcl_3) l_p16))

;%~zcl_3 | f1
(assert (or (not l_zcl_3) l_f1))

;%~p16 | ~f1 | zcl_3
(assert (or (not l_p16) (not l_f1) l_zcl_3))
...
;%~f8 | p14 | p10
(assert (or (not l_f8) l_p14 l_p10))
...
;%~p9 | ~p5 | f13_p
(assert (or (not l_p9) (not l_p5) l_f13_p))
...
;%~p8 | ~f13 | zcl_5
(assert (or (not l_p8) (not l_f13) l_zcl_5))
...
;%~p7 | ~f12 | zcl_6
(assert (or (not l_p7) (not l_f12) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((~p7 & f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p7 | ~f12_p | f11_p
(assert (or (not l_p7) (not l_f12_p) l_f11_p))
...
;%~p4 | ~p0 | f17_p
(assert (or (not l_p4) (not l_p0) l_f17_p))
...
;%~p3 | ~f17 | zcl_9
(assert (or (not l_p3) (not l_f17) l_zcl_9))
...
;%~p3 | ~f17_p | f16_p
(assert (or (not l_p3) (not l_f17_p) l_f16_p))
...
;%~p2 | ~f16 | zcl_10
(assert (or (not l_p2) (not l_f16) l_zcl_10))
...
;%~p2 | ~f16_p | f15_p
(assert (or (not l_p2) (not l_f16_p) l_f15_p))
...
;%~p1 | ~f15 | zcl_11
(assert (or (not l_p1) (not l_f15) l_zcl_11))
...
;%~p1 | ~f15_p | f14_p
(assert (or (not l_p1) (not l_f15_p) l_f14_p))
...
;%~zcl_12 | f5
(assert (or (not l_zcl_12) l_f5))

;%~zcl_12 | f9
(assert (or (not l_zcl_12) l_f9))

;%~f5 | ~f9 | zcl_12
(assert (or (not l_f5) (not l_f9) l_zcl_12))

(declare-fun l_f4 () Bool)
;%~f4 | zcl_12
(assert (or (not l_f4) l_zcl_12))
...
;%~r_p19 | ~r_p15 | r_zcl_0
(assert (or (not r_p19) (not r_p15) r_zcl_0))
...
(assert (or (not r_p19) (not r_p15) r_f3_p))
...
;%~r_p17 | ~r_f2 | r_zcl_2
(assert (or (not r_p17) (not r_f2) r_zcl_2))
...
;%~r_p16 | ~r_f1 | r_zcl_3
(assert (or (not r_p16) (not r_f1) r_zcl_3))
...
(assert (or (not r_f8) r_p14 r_p10))
...
(assert (or (not r_f7) r_p13 r_f8))


;%~r_p13 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p13) r_f7_p))
...
(assert (or (not r_f6) r_p12 r_f7))


;%~r_p12 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p12) r_f6_p))
...
(assert (or (not r_f5) r_p11 r_f6))


;%~r_p11 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p11) r_f5_p))
...
(assert (or (not r_p9) (not r_p5) r_f13_p))
...
;%~r_p8 | ~r_f13 | r_zcl_5
(assert (or (not r_p8) (not r_f13) r_zcl_5))
...
;%~r_p7 | ~r_f12 | r_zcl_6
(assert (or (not r_p7) (not r_f12) r_zcl_6))
...
;%~r_p7 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p7) (not r_f12_p) r_f11_p))
...
(assert (or (not r_p4) (not r_p0) r_f17_p))
...
;%~r_p3 | ~r_f17 | r_zcl_9
(assert (or (not r_p3) (not r_f17) r_zcl_9))
...
;%~r_p3 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p3) (not r_f17_p) r_f16_p))
...
;%~r_p2 | ~r_f16 | r_zcl_10
(assert (or (not r_p2) (not r_f16) r_zcl_10))
...
;%~r_p2 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p2) (not r_f16_p) r_f15_p))
...
;%~r_p1 | ~r_f15 | r_zcl_11
(assert (or (not r_p1) (not r_f15) r_zcl_11))
...
;%~r_p1 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p1) (not r_f15_p) r_f14_p))
...
(assert (or (not r_zcl_12) r_f5))


;%~r_zcl_12 | r_f9
(assert (or (not r_zcl_12) r_f9))


;%~r_f5 | ~r_f9 | r_zcl_12
(assert (or (not r_f5) (not r_f9) r_zcl_12))


;%~r_f4 | r_zcl_12
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_zcl_12))
