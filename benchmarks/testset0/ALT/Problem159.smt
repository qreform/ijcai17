;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p9 & (~p0 & (~p10 & (p11 & ~p8)))) | ((p6 | (p2 | (~p3 | (~p7 | p5)))) & (~p1 | (~p2 | (p3 | (~p4 | p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p11 | ~p8 | zcl_0
(assert (or (not l_p11) (not l_p8) l_zcl_0))
...
;%~p11 | ~p8 | f3_p
(assert (or (not l_p11) (not l_p8) l_f3_p))
...
;%~p9 | ~f1 | zcl_3
(assert (or (not l_p9) (not l_f1) l_zcl_3))
...
;%~r_p11 | ~r_p8 | r_zcl_0
(assert (or (not r_p11) (not r_p8) r_zcl_0))
...
(assert (or (not r_p11) (not r_p8) r_f3_p))
...
;%~r_p9 | ~r_f1 | r_zcl_3
(assert (or (not r_p9) (not r_f1) r_zcl_3))
