...
;%~p11 | ~p9 | zcl_0
(assert (or (not l_p11) (not l_p9) l_zcl_0))
...
;%~p11 | ~p9 | f1_p
(assert (or (not l_p11) (not l_p9) l_f1_p))
...
;%~p10 | ~f1 | zcl_1
(assert (or (not l_p10) (not l_f1) l_zcl_1))
...
;%~p5 | ~p3 | f7_p
(assert (or (not l_p5) (not l_p3) l_f7_p))
...
;%~p2 | ~p0 | f9_p
(assert (or (not l_p2) (not l_p0) l_f9_p))
...
;%~f3 | ~f5 | zcl_6
(assert (or (not l_f3) (not l_f5) l_zcl_6))

(declare-fun l_f2 () Bool)
;%~f2 | zcl_6
(assert (or (not l_f2) l_zcl_6))
...
;%~r_p11 | ~r_p9 | r_zcl_0
(assert (or (not r_p11) (not r_p9) r_zcl_0))
...
(assert (or (not r_p11) (not r_p9) r_f1_p))
...
;%~r_p10 | ~r_f1 | r_zcl_1
(assert (or (not r_p10) (not r_f1) r_zcl_1))
...
(assert (or (not r_p5) (not r_p3) r_f7_p))
...
(assert (or (not r_p2) (not r_p0) r_f9_p))
...
;%~r_f3 | ~r_f5 | r_zcl_6
(assert (or (not r_f3) (not r_f5) r_zcl_6))


;%~r_f2 | r_zcl_6
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_zcl_6))
