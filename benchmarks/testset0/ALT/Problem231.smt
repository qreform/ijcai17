;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p2 & (p0 & (p12 & (p2 & p11)))) | ((p0 | (p1 | (p7 | (p4 | p10)))) & ((p8 & (p0 & (p2 & (p9 & p7)))) | ((p2 | (p1 | (p0 | (p6 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p2 | ~p11 | zcl_0
(assert (or (not l_p2) (not l_p11) l_zcl_0))
...
;%~p2 | ~p11 | f3_p
(assert (or (not l_p2) (not l_p11) l_f3_p))
...
;%~p12 | ~f3 | zcl_1
(assert (or (not l_p12) (not l_f3) l_zcl_1))
...
;%~p2 | ~f1 | zcl_3
(assert (or (not l_p2) (not l_f1) l_zcl_3))
...
;%~p2 | ~f1_p | f0_p
(assert (or (not l_p2) (not l_f1_p) l_f0_p))
...
;%~p9 | ~p7 | zcl_4
(assert (or (not l_p9) (not l_p7) l_zcl_4))
...
;%~p9 | ~p7 | f13_p
(assert (or (not l_p9) (not l_p7) l_f13_p))
...
;%~p8 | ~f11 | zcl_7
(assert (or (not l_p8) (not l_f11) l_zcl_7))
...
;%~f16 | p1 | f17
(assert (or (not l_f16) l_p1 l_f17))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p1 | f17_p) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p1 | f16_p
(assert (or (not l_p1) l_f16_p))
...
;%~f15 | p2 | f16
(assert (or (not l_f15) l_p2 l_f16))
...
;%~r_p2 | ~r_p11 | r_zcl_0
(assert (or (not r_p2) (not r_p11) r_zcl_0))
...
(assert (or (not r_p2) (not r_p11) r_f3_p))
...
;%~r_p12 | ~r_f3 | r_zcl_1
(assert (or (not r_p12) (not r_f3) r_zcl_1))
...
;%~r_p2 | ~r_f1 | r_zcl_3
(assert (or (not r_p2) (not r_f1) r_zcl_3))
...
(assert (or (not r_p2) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p4 | r_p10
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p4 r_p10))
...
(assert (or (not r_f7) r_p7 r_f8))


;%~r_p7 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p7) r_f7_p))
...
(assert (or (not r_f6) r_p1 r_f7))


;%~r_p1 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p1) r_f6_p))
...
;%~r_p9 | ~r_p7 | r_zcl_4
(assert (or (not r_p9) (not r_p7) r_zcl_4))
...
(assert (or (not r_p9) (not r_p7) r_f13_p))
...
;%~r_p8 | ~r_f11 | r_zcl_7
(assert (or (not r_p8) (not r_f11) r_zcl_7))
...
(assert (or (not r_f16) r_p1 r_f17))


;%~r_p1 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p1) r_f16_p))
...
(assert (or (not r_f15) r_p2 r_f16))


;%~r_p2 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p2) r_f15_p))
