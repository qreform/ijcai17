;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p5 & (p6 & (~p8 & ~p9))) | ((p8 | (~p3 | (p5 | ~p7))) & ((p3 & (~p5 & (~p2 & ~p6))) | ((~p3 | (~p5 | (~p1 | ~p4))) & (~p1 | (~p2 | (~p3 | ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p9 | zcl_0
(assert (or (not l_p8) (not l_p9) l_zcl_0))
...
;%~p8 | ~p9 | f2_p
(assert (or (not l_p8) (not l_p9) l_f2_p))
...
;%~p6 | ~f2 | zcl_1
(assert (or (not l_p6) (not l_f2) l_zcl_1))
...
;%~p5 | ~f1 | zcl_2
(assert (or (not l_p5) (not l_f1) l_zcl_2))
...
;%~p2 | ~p6 | zcl_3
(assert (or (not l_p2) (not l_p6) l_zcl_3))
...
;%~p2 | ~p6 | f10_p
(assert (or (not l_p2) (not l_p6) l_f10_p))
...
;%~p5 | ~f10 | zcl_4
(assert (or (not l_p5) (not l_f10) l_zcl_4))
...
;%~p5 | ~f10_p | f9_p
(assert (or (not l_p5) (not l_f10_p) l_f9_p))
...
;%~p3 | ~f9 | zcl_5
(assert (or (not l_p3) (not l_f9) l_zcl_5))
...
;%~p3 | ~f9_p | f8_p
(assert (or (not l_p3) (not l_f9_p) l_f8_p))
...
;%~f13 | p5 | f14
(assert (or (not l_f13) l_p5 l_f14))
...
;%~r_p8 | ~r_p9 | r_zcl_0
(assert (or (not r_p8) (not r_p9) r_zcl_0))
...
(assert (or (not r_p8) (not r_p9) r_f2_p))
...
;%~r_p6 | ~r_f2 | r_zcl_1
(assert (or (not r_p6) (not r_f2) r_zcl_1))
...
;%~r_p5 | ~r_f1 | r_zcl_2
(assert (or (not r_p5) (not r_f1) r_zcl_2))
...
(assert (or (not r_f4) r_p8 r_f5))


;%~r_p8 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p8) r_f4_p))
...
;%~r_p2 | ~r_p6 | r_zcl_3
(assert (or (not r_p2) (not r_p6) r_zcl_3))
...
(assert (or (not r_p2) (not r_p6) r_f10_p))
...
;%~r_p5 | ~r_f10 | r_zcl_4
(assert (or (not r_p5) (not r_f10) r_zcl_4))
...
(assert (or (not r_p5) (not r_f10_p) r_f9_p))
...
;%~r_p3 | ~r_f9 | r_zcl_5
(assert (or (not r_p3) (not r_f9) r_zcl_5))
...
(assert (or (not r_p3) (not r_f9_p) r_f8_p))


;%~r_f14 | r_p1 | r_p4
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_p1 r_p4))


;%~r_p1 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p1) r_f14_p))
...
(assert (or (not r_f13) r_p5 r_f14))


;%~r_p5 | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p5) r_f13_p))
