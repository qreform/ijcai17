...
;%~p24 | ~p20 | f3_p
(assert (or (not l_p24) (not l_p20) l_f3_p))
...
;%~p23 | ~f3 | zcl_1
(assert (or (not l_p23) (not l_f3) l_zcl_1))
...
;%~p23 | ~f3_p | f2_p
(assert (or (not l_p23) (not l_f3_p) l_f2_p))
...
;%~p22 | ~f2 | zcl_2
(assert (or (not l_p22) (not l_f2) l_zcl_2))
...
;%~p21 | ~f1 | zcl_3
(assert (or (not l_p21) (not l_f1) l_zcl_3))
...
;%~f8 | p19 | p15
(assert (or (not l_f8) l_p19 l_p15))
...
;%~p12 | ~f12 | zcl_6
(assert (or (not l_p12) (not l_f12) l_zcl_6))
...
;%~p11 | ~f11 | zcl_7
(assert (or (not l_p11) (not l_f11) l_zcl_7))
...
(assert (or (not r_p24) (not r_p20) r_f3_p))
...
;%~r_p23 | ~r_f3 | r_zcl_1
(assert (or (not r_p23) (not r_f3) r_zcl_1))
...
(assert (or (not r_p23) (not r_f3_p) r_f2_p))
...
;%~r_p22 | ~r_f2 | r_zcl_2
(assert (or (not r_p22) (not r_f2) r_zcl_2))
...
;%~r_p21 | ~r_f1 | r_zcl_3
(assert (or (not r_p21) (not r_f1) r_zcl_3))
...
(assert (or (not r_f8) r_p19 r_p15))
...
(assert (or (not r_f7) r_p18 r_f8))


;%~r_p18 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p18) r_f7_p))
...
(assert (or (not r_f6) r_p17 r_f7))


;%~r_p17 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p17) r_f6_p))
...
;%~r_p12 | ~r_f12 | r_zcl_6
(assert (or (not r_p12) (not r_f12) r_zcl_6))
...
;%~r_p11 | ~r_f11 | r_zcl_7
(assert (or (not r_p11) (not r_f11) r_zcl_7))
