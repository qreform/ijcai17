;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p7 | (p11 | (p12 | (p5 | p10)))) & ((p8 & (p6 & (p9 & (p2 & p7)))) | ((p1 | (p4 | (p1 | (p6 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p2 | ~p7 | zcl_0
(assert (or (not l_p2) (not l_p7) l_zcl_0))
...
;%~p2 | ~p7 | f8_p
(assert (or (not l_p2) (not l_p7) l_f8_p))
...
;%~p9 | ~f8 | zcl_1
(assert (or (not l_p9) (not l_f8) l_zcl_1))
...
;%~p8 | ~f6 | zcl_3
(assert (or (not l_p8) (not l_f6) l_zcl_3))
...
;%~f11 | p4 | f12
(assert (or (not l_f11) l_p4 l_f12))
...
;%~r_p2 | ~r_p7 | r_zcl_0
(assert (or (not r_p2) (not r_p7) r_zcl_0))
...
(assert (or (not r_p2) (not r_p7) r_f8_p))
...
;%~r_p9 | ~r_f8 | r_zcl_1
(assert (or (not r_p9) (not r_f8) r_zcl_1))
...
;%~r_p8 | ~r_f6 | r_zcl_3
(assert (or (not r_p8) (not r_f6) r_zcl_3))
...
(assert (or (not r_f11) r_p4 r_f12))


;%~r_p4 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p4) r_f11_p))
