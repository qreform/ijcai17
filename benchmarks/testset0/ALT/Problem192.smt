;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p3 | (p11 | (p3 | (p12 | p10)))) & ((p3 & (p3 & (p2 & (p9 & p8)))) | ((p6 | (p3 | (p0 | (p7 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f3 | p12 | p10
(assert (or (not l_f3) l_p12 l_p10))
...
;%~p3 | ~f6 | zcl_3
(assert (or (not l_p3) (not l_f6) l_zcl_3))
...
(assert (or (not r_f3) r_p12 r_p10))
...
;%~r_p3 | ~r_f6 | r_zcl_3
(assert (or (not r_p3) (not r_f6) r_zcl_3))
