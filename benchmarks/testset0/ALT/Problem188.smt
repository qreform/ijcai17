;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p0 | (~p9 | (~p3 | ~p8))) & ((p3 & (~p7 & (~p0 & p6))) | ((p5 | (~p2 | (~p1 | ~p4))) & (p1 | (p2 | (p3 | p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p6 | f6_p
(assert (or (not l_p0) (not l_p6) l_f6_p))
...
(assert (or (not r_p0) (not r_p6) r_f6_p))
