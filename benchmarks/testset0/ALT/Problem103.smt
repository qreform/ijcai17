;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p8 | (p7 | (p8 | p11))) & ((p9 & (p0 & (p10 & p8))) | ((p4 | (p0 | (p4 | p7))) & ((p5 & (p6 & (p0 & p4))) | (p1 & (p2 & (p3 & p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p10 | ~p8 | f6_p
(assert (or (not l_p10) (not l_p8) l_f6_p))
...
(assert (or (not r_p10) (not r_p8) r_f6_p))
