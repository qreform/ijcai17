;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & p5) | ((p0 | p4) & ((p1 & p3) | ((p1 | p2) & (p1 | p0))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p5 | f0_p
(assert (or (not l_p1) (not l_p5) l_f0_p))
...
(assert (or (not r_p1) (not r_p5) r_f0_p))


;%~r_f2 | r_p0 | r_p4
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p0 r_p4))
