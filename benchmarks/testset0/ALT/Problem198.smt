;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p9 | (~p1 | (p1 | ~p8)))) & ((~p7 & (~p2 & (p2 & (p1 & p6)))) | ((~p0 | (p3 | (~p4 | (p2 | ~p5)))) & (~p1 | (~p2 | (~p3 | (p4 | ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p6 | zcl_0
(assert (or (not l_p1) (not l_p6) l_zcl_0))
...
;%~p1 | ~p6 | f8_p
(assert (or (not l_p1) (not l_p6) l_f8_p))
...
;%~p2 | ~f8 | zcl_1
(assert (or (not l_p2) (not l_f8) l_zcl_1))
...
;%~p2 | ~f8_p | f7_p
(assert (or (not l_p2) (not l_f8_p) l_f7_p))
...
;%~p2 | ~f7 | zcl_2
(assert (or (not l_p2) (not l_f7) l_zcl_2))
...
;%~p2 | ~f7_p | f6_p
(assert (or (not l_p2) (not l_f7_p) l_f6_p))
...
;%~p7 | ~f6 | zcl_3
(assert (or (not l_p7) (not l_f6) l_zcl_3))
...
;%~f12 | p4 | f13
(assert (or (not l_f12) l_p4 l_f13))
...
;%~r_p1 | ~r_p6 | r_zcl_0
(assert (or (not r_p1) (not r_p6) r_zcl_0))
...
(assert (or (not r_p1) (not r_p6) r_f8_p))
...
;%~r_p2 | ~r_f8 | r_zcl_1
(assert (or (not r_p2) (not r_f8) r_zcl_1))
...
(assert (or (not r_p2) (not r_f8_p) r_f7_p))
...
;%~r_p2 | ~r_f7 | r_zcl_2
(assert (or (not r_p2) (not r_f7) r_zcl_2))
...
(assert (or (not r_p2) (not r_f7_p) r_f6_p))
...
;%~r_p7 | ~r_f6 | r_zcl_3
(assert (or (not r_p7) (not r_f6) r_zcl_3))
...
(assert (or (not r_f12) r_p4 r_f13))


;%~r_p4 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p4) r_f12_p))
