;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p2 | (p6 | p5)) & ((p3 & (p1 & p4)) | ((p0 | (p2 | p3)) & (p1 | (p2 | p0))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p4 | zcl_0
(assert (or (not l_p1) (not l_p4) l_zcl_0))
...
;%~p1 | ~p4 | f4_p
(assert (or (not l_p1) (not l_p4) l_f4_p))
...
;%~r_p1 | ~r_p4 | r_zcl_0
(assert (or (not r_p1) (not r_p4) r_zcl_0))
...
(assert (or (not r_p1) (not r_p4) r_f4_p))
