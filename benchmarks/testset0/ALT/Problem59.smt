;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p7 & (p0 & ~p6)) | ((~p0 | (p5 | p4)) & ((~p0 & (p0 & ~p3)) | (p1 & (p2 & p0))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p6 | f1_p
(assert (or (not l_p0) (not l_p6) l_f1_p))
...
;%~p0 | ~p3 | f7_p
(assert (or (not l_p0) (not l_p3) l_f7_p))
...
(assert (or (not r_p0) (not r_p6) r_f1_p))
...
(assert (or (not r_p0) (not r_p3) r_f7_p))
