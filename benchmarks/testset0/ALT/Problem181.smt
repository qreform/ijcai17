;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p3 | (p2 | (p3 | p6))) & ((p3 & (p2 & (p2 & p5))) | ((p2 | (p1 | (p0 | p4))) & (p1 | (p2 | (p3 | p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p2 | ~p5 | zcl_0
(assert (or (not l_p2) (not l_p5) l_zcl_0))
...
;%~r_p2 | ~r_p5 | r_zcl_0
(assert (or (not r_p2) (not r_p5) r_zcl_0))
