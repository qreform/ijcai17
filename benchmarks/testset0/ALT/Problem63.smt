;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p9 & (p7 & (p4 & p8))) | ((p0 | (p0 | (p4 | p7))) & ((p0 & (p5 & (p6 & p4))) | (p1 & (p2 & (p3 & p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p8 | f2_p
(assert (or (not l_p4) (not l_p8) l_f2_p))
...
;%~p6 | ~p4 | zcl_3
(assert (or (not l_p6) (not l_p4) l_zcl_3))
...
;%~p6 | ~p4 | f10_p
(assert (or (not l_p6) (not l_p4) l_f10_p))
...
(assert (or (not r_p4) (not r_p8) r_f2_p))
...
;%~r_p6 | ~r_p4 | r_zcl_3
(assert (or (not r_p6) (not r_p4) r_zcl_3))
...
(assert (or (not r_p6) (not r_p4) r_f10_p))
