;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p8 & (p1 & (p5 & (p5 & p7)))) | ((p4 | (p1 | (p2 | (p6 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p7 | f3_p
(assert (or (not l_p5) (not l_p7) l_f3_p))
...
;%~f5 | ~f9 | zcl_4
(assert (or (not l_f5) (not l_f9) l_zcl_4))

(declare-fun l_f4 () Bool)
;%~f4 | zcl_4
(assert (or (not l_f4) l_zcl_4))
...
(assert (or (not r_p5) (not r_p7) r_f3_p))
...
;%~r_f5 | ~r_f9 | r_zcl_4
(assert (or (not r_f5) (not r_f9) r_zcl_4))


;%~r_f4 | r_zcl_4
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_zcl_4))
