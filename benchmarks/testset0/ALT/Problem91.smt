;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p5 | (p5 | p6)) & ((p0 & (p3 & p5)) | ((p3 | (p0 | p4)) & ((p0 & (p0 & p3)) | (p1 & (p2 & p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p3 | ~p5 | zcl_0
(assert (or (not l_p3) (not l_p5) l_zcl_0))
...
;%~p3 | ~p5 | f4_p
(assert (or (not l_p3) (not l_p5) l_f4_p))
...
;%~r_p3 | ~r_p5 | r_zcl_0
(assert (or (not r_p3) (not r_p5) r_zcl_0))
...
(assert (or (not r_p3) (not r_p5) r_f4_p))
