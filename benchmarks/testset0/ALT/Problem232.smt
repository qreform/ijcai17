;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p10 & (p11 & (p12 & (p13 & p9)))) | ((p3 | (p2 | (p5 | (p1 | p8)))) & ((p2 & (p1 & (p7 & (p2 & p6)))) | ((p2 | (p0 | (p1 | (p4 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p13 | ~p9 | zcl_0
(assert (or (not l_p13) (not l_p9) l_zcl_0))
...
;%~p13 | ~p9 | f3_p
(assert (or (not l_p13) (not l_p9) l_f3_p))
...
;%~p11 | ~f2 | zcl_2
(assert (or (not l_p11) (not l_f2) l_zcl_2))
...
;%~p2 | ~p6 | zcl_4
(assert (or (not l_p2) (not l_p6) l_zcl_4))
...
;%~p2 | ~p6 | f13_p
(assert (or (not l_p2) (not l_p6) l_f13_p))
...
;%~r_p13 | ~r_p9 | r_zcl_0
(assert (or (not r_p13) (not r_p9) r_zcl_0))
...
(assert (or (not r_p13) (not r_p9) r_f3_p))
...
;%~r_p11 | ~r_f2 | r_zcl_2
(assert (or (not r_p11) (not r_f2) r_zcl_2))
...
;%~r_p2 | ~r_p6 | r_zcl_4
(assert (or (not r_p2) (not r_p6) r_zcl_4))
...
(assert (or (not r_p2) (not r_p6) r_f13_p))
