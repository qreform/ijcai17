;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p0 & (p0 & (p5 & p7))) | ((p0 | (p6 | (p0 | p5))) & ((p0 & (p0 & (p0 & p4))) | (p1 & (p2 & (p3 & p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p7 | zcl_0
(assert (or (not l_p5) (not l_p7) l_zcl_0))
...
;%~p5 | ~p7 | f2_p
(assert (or (not l_p5) (not l_p7) l_f2_p))
...
;%~r_p5 | ~r_p7 | r_zcl_0
(assert (or (not r_p5) (not r_p7) r_zcl_0))
...
(assert (or (not r_p5) (not r_p7) r_f2_p))
