;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p3 | (~p9 | (~p2 | (~p2 | ~p8)))) & ((p0 & (~p3 & (~p2 & (p7 & p6)))) | ((~p4 | (p4 | (~p3 | (~p1 | p5)))) & (~p1 | (~p2 | (~p3 | (p4 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~p6 | f8_p
(assert (or (not l_p7) (not l_p6) l_f8_p))
...
(assert (or (not r_p7) (not r_p6) r_f8_p))
