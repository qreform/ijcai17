;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p14 & (p15 & (p9 & (p10 & p13)))) | ((p10 | (p5 | (p11 | (p12 | p9)))) & ((p6 & (p7 & (p8 & (p0 & p5)))) | (p1 & (p2 & (p3 & (p4 & p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~f3 | zcl_1
(assert (or (not l_p9) (not l_f3) l_zcl_1))
...
;%~p15 | ~f2 | zcl_2
(assert (or (not l_p15) (not l_f2) l_zcl_2))
...
;%~p14 | ~f1 | zcl_3
(assert (or (not l_p14) (not l_f1) l_zcl_3))
...
;%~p0 | ~p5 | f13_p
(assert (or (not l_p0) (not l_p5) l_f13_p))
...
;%~r_p9 | ~r_f3 | r_zcl_1
(assert (or (not r_p9) (not r_f3) r_zcl_1))
...
;%~r_p15 | ~r_f2 | r_zcl_2
(assert (or (not r_p15) (not r_f2) r_zcl_2))
...
;%~r_p14 | ~r_f1 | r_zcl_3
(assert (or (not r_p14) (not r_f1) r_zcl_3))
...
(assert (or (not r_p0) (not r_p5) r_f13_p))
