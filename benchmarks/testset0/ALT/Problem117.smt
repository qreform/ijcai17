;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p7 | (p13 | (~p0 | (p5 | ~p12)))) & ((~p6 & (~p9 & (p10 & (p11 & ~p8)))) | ((p0 | (p0 | (~p7 | (~p0 | ~p6)))) & ((~p0 & (~p0 & (~p0 & (p0 & p5)))) | (p1 & (p2 & (~p3 & (~p4 & p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p11 | ~p8 | f8_p
(assert (or (not l_p11) (not l_p8) l_f8_p))
...
(assert (or (not r_p11) (not r_p8) r_f8_p))
