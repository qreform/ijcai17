;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p0 & (p7 & (~p8 & p6))) | ((~p4 | (p0 | (~p0 | ~p5))) & ((p0 & (~p0 & (~p0 & ~p4))) | (p1 & (p2 & (~p3 & ~p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p6 | zcl_0
(assert (or (not l_p8) (not l_p6) l_zcl_0))
...
;%~p8 | ~p6 | f2_p
(assert (or (not l_p8) (not l_p6) l_f2_p))
...
;%~r_p8 | ~r_p6 | r_zcl_0
(assert (or (not r_p8) (not r_p6) r_zcl_0))
...
(assert (or (not r_p8) (not r_p6) r_f2_p))
