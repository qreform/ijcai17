;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p3 | (p1 | (p4 | ~p6))) & ((~p3 & (~p2 & (p4 & ~p5))) | ((p2 | (~p0 | (~p1 | ~p4))) & (~p1 | (~p2 | (p3 | ~p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p3 | ~f5 | zcl_2
(assert (or (not l_p3) (not l_f5) l_zcl_2))
...
;%~p3 | ~f5_p | f4_p
(assert (or (not l_p3) (not l_f5_p) l_f4_p))
...
;%~f8 | ~f11 | zcl_3
(assert (or (not l_f8) (not l_f11) l_zcl_3))
...
;%~r_p3 | ~r_f5 | r_zcl_2
(assert (or (not r_p3) (not r_f5) r_zcl_2))
...
(assert (or (not r_p3) (not r_f5_p) r_f4_p))


;%~r_f10 | r_p1 | r_p4
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p1 r_p4))
...
;%~r_f8 | ~r_f11 | r_zcl_3
(assert (or (not r_f8) (not r_f11) r_zcl_3))
