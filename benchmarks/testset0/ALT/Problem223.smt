;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p5 & (p4 & (p2 & p8))) | ((p4 | (p0 | (p0 | p7))) & ((p2 & (p0 & (p0 & p6))) | ((p5 | (p1 | (p2 | p4))) & (p1 | (p2 | (p3 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p2 | ~f9 | zcl_5
(assert (or (not l_p2) (not l_f9) l_zcl_5))
...
;%~r_p2 | ~r_f9 | r_zcl_5
(assert (or (not r_p2) (not r_f9) r_zcl_5))
