;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p4 & (~p1 & ~p7)) | ((p0 | (~p0 | ~p6)) & ((~p4 & (~p4 & ~p5)) | ((p4 | (~p0 | p3)) & (~p1 | (~p2 | p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p7 | zcl_0
(assert (or (not l_p1) (not l_p7) l_zcl_0))
...
;%~p1 | ~p7 | f1_p
(assert (or (not l_p1) (not l_p7) l_f1_p))
...
;%~p4 | ~p5 | f7_p
(assert (or (not l_p4) (not l_p5) l_f7_p))
...
;%~r_p1 | ~r_p7 | r_zcl_0
(assert (or (not r_p1) (not r_p7) r_zcl_0))
...
(assert (or (not r_p1) (not r_p7) r_f1_p))
...
(assert (or (not r_p4) (not r_p5) r_f7_p))
