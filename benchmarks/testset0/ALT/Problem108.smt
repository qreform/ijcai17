;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p0 | (p10 | (~p10 | ~p11))) & ((~p4 & (p8 & (p0 & ~p10))) | ((~p0 | (p9 | (~p0 | p8))) & ((p5 & (~p6 & (~p7 & ~p4))) | (p1 & (~p2 & (~p3 & ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f2 | p10 | p11
(assert (or (not l_f2) l_p10 l_p11))
...
;%~p0 | ~p10 | f6_p
(assert (or (not l_p0) (not l_p10) l_f6_p))
...
(assert (or (not r_f2) r_p10 r_p11))
...
(assert (or (not r_p0) (not r_p10) r_f6_p))
