;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p5 | p4) & ((p2 & p3) | ((p1 | p2) & (p1 | p0)))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p2 | ~p3 | zcl_0
(assert (or (not l_p2) (not l_p3) l_zcl_0))
...
;%~p2 | ~p3 | f2_p
(assert (or (not l_p2) (not l_p3) l_f2_p))
...
;%~r_p2 | ~r_p3 | r_zcl_0
(assert (or (not r_p2) (not r_p3) r_zcl_0))
...
(assert (or (not r_p2) (not r_p3) r_f2_p))


;%~r_f4 | r_p1 | r_p2
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_p1 r_p2))
