;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p4 & (~p1 & (p1 & p5))) | ((p1 | (~p1 | (~p3 | p4))) & (~p1 | (~p2 | (p3 | p0))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p5 | zcl_0
(assert (or (not l_p1) (not l_p5) l_zcl_0))
...
;%~p1 | ~p5 | f2_p
(assert (or (not l_p1) (not l_p5) l_f2_p))
...
;%~r_p1 | ~r_p5 | r_zcl_0
(assert (or (not r_p1) (not r_p5) r_zcl_0))
...
(assert (or (not r_p1) (not r_p5) r_f2_p))
