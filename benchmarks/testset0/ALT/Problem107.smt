;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p7 | (~p11 | (~p12 | p10))) & ((p9 & (~p7 & (p6 & p8))) | ((p6 | (~p0 | (~p7 | ~p5))) & ((~p0 & (p0 & (p0 & ~p4))) | (p1 & (p2 & (~p3 & ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~p8 | f6_p
(assert (or (not l_p6) (not l_p8) l_f6_p))
...
(assert (or (not r_p6) (not r_p8) r_f6_p))
