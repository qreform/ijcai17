;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p9 & (p7 & (p0 & p8))) | ((~p7 | (~p4 | (~p0 | ~p6))) & ((~p0 & (~p0 & (~p5 & p4))) | (p1 & (p2 & (p3 & ~p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p8 | f2_p
(assert (or (not l_p0) (not l_p8) l_f2_p))
...
;%~p5 | ~p4 | f10_p
(assert (or (not l_p5) (not l_p4) l_f10_p))
...
(assert (or (not r_p0) (not r_p8) r_f2_p))
...
(assert (or (not r_p5) (not r_p4) r_f10_p))
