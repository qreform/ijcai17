;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p7 | (p0 | (p0 | (p11 | p10)))) & ((p7 & (p9 & (p0 & (p0 & p8)))) | ((p0 | (p0 | (p0 | (p0 | p7)))) & ((p0 & (p0 & (p6 & (p0 & p5)))) | (p1 & (p2 & (p3 & (p4 & p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p8 | f8_p
(assert (or (not l_p0) (not l_p8) l_f8_p))
...
;%~p6 | ~f18 | zcl_5
(assert (or (not l_p6) (not l_f18) l_zcl_5))
...
(assert (or (not r_p0) (not r_p8) r_f8_p))
...
;%~r_p6 | ~r_f18 | r_zcl_5
(assert (or (not r_p6) (not r_f18) r_zcl_5))
