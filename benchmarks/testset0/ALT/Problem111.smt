;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p7 | (p0 | (p0 | (p0 | p9)))) & ((p0 & (p0 & (p8 & (p6 & p7)))) | ((p0 | (p0 | (p5 | (p5 | p6)))) & ((p0 & (p0 & (p0 & (p0 & p5)))) | (p1 & (p2 & (p3 & (p4 & p0)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~p7 | f8_p
(assert (or (not l_p6) (not l_p7) l_f8_p))
...
;%~p8 | ~f8 | zcl_1
(assert (or (not l_p8) (not l_f8) l_zcl_1))
...
(assert (or (not r_p6) (not r_p7) r_f8_p))
...
;%~r_p8 | ~r_f8 | r_zcl_1
(assert (or (not r_p8) (not r_f8) r_zcl_1))
