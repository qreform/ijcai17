;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p8 & (p9 & p7)) | ((p1 | (~p4 | ~p6)) & ((~p2 & (~p3 & ~p5)) | ((p1 | (p4 | ~p3)) & (~p1 | (p2 | ~p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~p7 | f1_p
(assert (or (not l_p9) (not l_p7) l_f1_p))
...
;%~p8 | ~f1 | zcl_1
(assert (or (not l_p8) (not l_f1) l_zcl_1))
...
;%~p2 | ~f7 | zcl_3
(assert (or (not l_p2) (not l_f7) l_zcl_3))
...
(assert (or (not r_p9) (not r_p7) r_f1_p))
...
;%~r_p8 | ~r_f1 | r_zcl_1
(assert (or (not r_p8) (not r_f1) r_zcl_1))
...
;%~r_p2 | ~r_f7 | r_zcl_3
(assert (or (not r_p2) (not r_f7) r_zcl_3))
