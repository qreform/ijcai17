;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p0 | ~p4) & ((p0 & p3) | ((p1 | p2) & (~p1 | ~p0)))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p3 | f2_p
(assert (or (not l_p0) (not l_p3) l_f2_p))
...
(assert (or (not r_p0) (not r_p3) r_f2_p))
