;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & p0) | ((p0 & p2) | ((p2 & p3) | ((p5 & p4) | ((p2 & p6) | ((p2 & p7) | (p2 & p8))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p2 | ~p3 | zcl_2
(assert (or (not l_p2) (not l_p3) l_zcl_2))
...
;%~p2 | ~p3 | f4_p
(assert (or (not l_p2) (not l_p3) l_f4_p))
...
;%~p2 | ~p7 | zcl_5
(assert (or (not l_p2) (not l_p7) l_zcl_5))
...
;%~p2 | ~p7 | f10_p
(assert (or (not l_p2) (not l_p7) l_f10_p))
...
;%~r_p2 | ~r_p3 | r_zcl_2
(assert (or (not r_p2) (not r_p3) r_zcl_2))
...
(assert (or (not r_p2) (not r_p3) r_f4_p))
...
;%~r_p2 | ~r_p7 | r_zcl_5
(assert (or (not r_p2) (not r_p7) r_zcl_5))
...
(assert (or (not r_p2) (not r_p7) r_f10_p))
