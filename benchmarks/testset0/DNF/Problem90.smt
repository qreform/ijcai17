...
;%Non-clausified dependency
;%(forall[]((p17 & p12) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p17 | ~p12 | f15_p
(assert (or (not l_p17) (not l_p12) l_f15_p))
...
;%~p16 | ~f15 | zcl_11
(assert (or (not l_p16) (not l_f15) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((p16 & f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p16 | ~f15_p | f14_p
(assert (or (not l_p16) (not l_f15_p) l_f14_p))
...
;%~p15 | ~f14 | zcl_12
(assert (or (not l_p15) (not l_f14) l_zcl_12))

(declare-fun l_f13 () Bool)
;%~f13 | zcl_12
(assert (or (not l_f13) l_zcl_12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p15 & f14_p) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p15 | ~f14_p | f13_p
(assert (or (not l_p15) (not l_f14_p) l_f13_p))
...
;%~zcl_13 | f13
(assert (or (not l_zcl_13) l_f13))

;%~p14 | ~f13 | zcl_13
(assert (or (not l_p14) (not l_f13) l_zcl_13))

(declare-fun l_f12 () Bool)
;%~f12 | zcl_13
(assert (or (not l_f12) l_zcl_13))
...
;%~zcl_14 | f12
(assert (or (not l_zcl_14) l_f12))

;%~p13 | ~f12 | zcl_14
(assert (or (not l_p13) (not l_f12) l_zcl_14))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_14
(assert (or (not l_f11) l_zcl_14))
...
(assert (or (not r_p17) (not r_p12) r_f15_p))
...
;%~r_p16 | ~r_f15 | r_zcl_11
(assert (or (not r_p16) (not r_f15) r_zcl_11))
...
;%~r_p16 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p16) (not r_f15_p) r_f14_p))
...
;%~r_p15 | ~r_f14 | r_zcl_12
(assert (or (not r_p15) (not r_f14) r_zcl_12))


;%~r_f13 | r_zcl_12
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_zcl_12))


;%~r_p15 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p15) (not r_f14_p) r_f13_p))
...
;%~r_zcl_13 | r_f13
(assert (or (not r_zcl_13) r_f13))


;%~r_p14 | ~r_f13 | r_zcl_13
(assert (or (not r_p14) (not r_f13) r_zcl_13))


;%~r_f12 | r_zcl_13
(declare-fun r_f12 () Bool)
(assert (or (not r_f12) r_zcl_13))
...
;%~r_zcl_14 | r_f12
(assert (or (not r_zcl_14) r_f12))


;%~r_p13 | ~r_f12 | r_zcl_14
(assert (or (not r_p13) (not r_f12) r_zcl_14))


;%~r_f11 | r_zcl_14
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_14))
