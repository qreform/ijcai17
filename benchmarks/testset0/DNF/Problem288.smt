;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & (~p4 & ~p0)))) | ((~p0 & (~p0 & (~p0 & (p0 & ~p5)))) | ((p0 & (~p0 & (p0 & (p7 & p6)))) | ((~p0 & (~p0 & (~p0 & (~p5 & p8)))) | ((~p10 & (~p11 & (~p0 & (p12 & ~p9)))) | ((~p9 & (p6 & (~p0 & (~p0 & p13)))) | (~p9 & (~p15 & (~p0 & (p0 & ~p14)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~p6 | zcl_8
(assert (or (not l_p7) (not l_p6) l_zcl_8))
...
;%~p7 | ~p6 | f13_p
(assert (or (not l_p7) (not l_p6) l_f13_p))
...
;%~p5 | ~p8 | zcl_12
(assert (or (not l_p5) (not l_p8) l_zcl_12))
...
;%~p5 | ~p8 | f18_p
(assert (or (not l_p5) (not l_p8) l_f18_p))
...
;%~p12 | ~p9 | zcl_16
(assert (or (not l_p12) (not l_p9) l_zcl_16))
...
;%~p12 | ~p9 | f23_p
(assert (or (not l_p12) (not l_p9) l_f23_p))
...
;%~p10 | ~f21 | zcl_19
(assert (or (not l_p10) (not l_f21) l_zcl_19))
...
;%~p0 | ~p14 | f32_p
(assert (or (not l_p0) (not l_p14) l_f32_p))
...
;%~p15 | ~f31 | zcl_26
(assert (or (not l_p15) (not l_f31) l_zcl_26))
...
;%~p9 | ~f30 | zcl_27
(assert (or (not l_p9) (not l_f30) l_zcl_27))
...
;%~r_p7 | ~r_p6 | r_zcl_8
(assert (or (not r_p7) (not r_p6) r_zcl_8))
...
(assert (or (not r_p7) (not r_p6) r_f13_p))
...
;%~r_p5 | ~r_p8 | r_zcl_12
(assert (or (not r_p5) (not r_p8) r_zcl_12))
...
(assert (or (not r_p5) (not r_p8) r_f18_p))
...
;%~r_p12 | ~r_p9 | r_zcl_16
(assert (or (not r_p12) (not r_p9) r_zcl_16))
...
(assert (or (not r_p12) (not r_p9) r_f23_p))
...
;%~r_p10 | ~r_f21 | r_zcl_19
(assert (or (not r_p10) (not r_f21) r_zcl_19))
...
(assert (or (not r_p0) (not r_p14) r_f32_p))
...
;%~r_p15 | ~r_f31 | r_zcl_26
(assert (or (not r_p15) (not r_f31) r_zcl_26))
...
;%~r_p9 | ~r_f30 | r_zcl_27
(assert (or (not r_p9) (not r_f30) r_zcl_27))
