;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p7 & (p0 & (p0 & (p0 & p6))))) | ((p0 & (p0 & (p0 & (p6 & (p0 & p8))))) | ((p0 & (p0 & (p8 & (p0 & (p0 & p9))))) | ((p0 & (p9 & (p0 & (p11 & (p0 & p10))))) | (p8 & (p0 & (p13 & (p0 & (p9 & p12)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p10 | zcl_20
(assert (or (not l_p0) (not l_p10) l_zcl_20))
...
;%~p0 | ~p10 | f28_p
(assert (or (not l_p0) (not l_p10) l_f28_p))
...
;%~zcl_21 | p11
(assert (or (not l_zcl_21) l_p11))

;%~zcl_21 | f28
(assert (or (not l_zcl_21) l_f28))

;%~p11 | ~f28 | zcl_21
(assert (or (not l_p11) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p11 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p11 | ~f28_p | f27_p
(assert (or (not l_p11) (not l_f28_p) l_f27_p))
...
;%~zcl_25 | p9
(assert (or (not l_zcl_25) l_p9))

(declare-fun l_p12 () Bool)
;%~zcl_25 | p12
(assert (or (not l_zcl_25) l_p12))

;%~p9 | ~p12 | zcl_25
(assert (or (not l_p9) (not l_p12) l_zcl_25))
...
;%~p9 | ~p12 | f33_p
(assert (or (not l_p9) (not l_p12) l_f33_p))
...
;%~zcl_27 | p13
(assert (or (not l_zcl_27) l_p13))

;%~zcl_27 | f32
(assert (or (not l_zcl_27) l_f32))

;%~p13 | ~f32 | zcl_27
(assert (or (not l_p13) (not l_f32) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p13 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p13 | ~f32_p | f31_p
(assert (or (not l_p13) (not l_f32_p) l_f31_p))
...
;%~p8 | ~f30 | zcl_29
(assert (or (not l_p8) (not l_f30) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p8 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p8 | ~f30_p | f29_p
(assert (or (not l_p8) (not l_f30_p) l_f29_p))
...
;%~r_p0 | ~r_p10 | r_zcl_20
(assert (or (not r_p0) (not r_p10) r_zcl_20))
...
(assert (or (not r_p0) (not r_p10) r_f28_p))


;%~r_zcl_21 | r_p11
(declare-fun r_zcl_21 () Bool)
(assert (or (not r_zcl_21) r_p11))
...
;%~r_p11 | ~r_f28 | r_zcl_21
(assert (or (not r_p11) (not r_f28) r_zcl_21))
...
;%~r_p11 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p11) (not r_f28_p) r_f27_p))
...
(assert (or (not r_zcl_25) r_p9))


;%~r_zcl_25 | r_p12
(assert (or (not r_zcl_25) r_p12))


;%~r_p9 | ~r_p12 | r_zcl_25
(assert (or (not r_p9) (not r_p12) r_zcl_25))
...
(assert (or (not r_p9) (not r_p12) r_f33_p))
...
;%~r_p13 | ~r_f32 | r_zcl_27
(assert (or (not r_p13) (not r_f32) r_zcl_27))
...
;%~r_p13 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p13) (not r_f32_p) r_f31_p))
...
;%~r_p8 | ~r_f30 | r_zcl_29
(assert (or (not r_p8) (not r_f30) r_zcl_29))
...
;%~r_p8 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p8) (not r_f30_p) r_f29_p))
