;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & p0)) | ((~p4 & (p5 & ~p3)) | (~p3 & (p3 & ~p6)))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p3 | ~p6 | f6_p
(assert (or (not l_p3) (not l_p6) l_f6_p))
...
;%~p3 | ~f6 | zcl_5
(assert (or (not l_p3) (not l_f6) l_zcl_5))
...
(assert (or (not r_p3) (not r_p6) r_f6_p))
...
;%~r_p3 | ~r_f6 | r_zcl_5
(assert (or (not r_p3) (not r_f6) r_zcl_5))
