;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (p2 & (p3 & ~p0))) | (p0 & (p0 & (~p5 & ~p4)))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p4 | f5_p
(assert (or (not l_p5) (not l_p4) l_f5_p))
...
;%~p0 | ~f4 | zcl_5
(assert (or (not l_p0) (not l_f4) l_zcl_5))
...
(assert (or (not r_p5) (not r_p4) r_f5_p))
...
;%~r_p0 | ~r_f4 | r_zcl_5
(assert (or (not r_p0) (not r_f4) r_zcl_5))
