;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p0 & (p0 & (p0 & (p0 & p6))))) | (p8 & (p6 & (p0 & (p9 & (p10 & p7))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p10 | ~p7 | zcl_10
(assert (or (not l_p10) (not l_p7) l_zcl_10))
...
;%~p10 | ~p7 | f15_p
(assert (or (not l_p10) (not l_p7) l_f15_p))
...
;%~p8 | ~f12 | zcl_14
(assert (or (not l_p8) (not l_f12) l_zcl_14))
...
;%~r_p10 | ~r_p7 | r_zcl_10
(assert (or (not r_p10) (not r_p7) r_zcl_10))
...
(assert (or (not r_p10) (not r_p7) r_f15_p))
...
;%~r_p8 | ~r_f12 | r_zcl_14
(assert (or (not r_p8) (not r_f12) r_zcl_14))
