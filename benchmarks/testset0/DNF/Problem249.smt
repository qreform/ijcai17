;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (p2 & (~p3 & (p4 & (~p5 & p0))))) | ((~p0 & (~p0 & (~p0 & (p0 & (~p0 & p6))))) | ((~p8 & (~p0 & (~p9 & (p0 & (p6 & p7))))) | ((p6 & (~p0 & (p0 & (~p6 & (~p0 & ~p10))))) | ((p10 & (~p6 & (~p12 & (~p13 & (~p7 & p11))))) | (~p0 & (p6 & (~p6 & (p15 & (p0 & ~p14)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~zcl_10 | p7
(assert (or (not l_zcl_10) l_p7))

;%~p6 | ~p7 | zcl_10
(assert (or (not l_p6) (not l_p7) l_zcl_10))
...
;%~p6 | ~p7 | f16_p
(assert (or (not l_p6) (not l_p7) l_f16_p))
...
;%~p9 | ~f15 | zcl_12
(assert (or (not l_p9) (not l_f15) l_zcl_12))
...
;%~p8 | ~f13 | zcl_14
(assert (or (not l_p8) (not l_f13) l_zcl_14))
...
;%~p7 | ~p11 | zcl_20
(assert (or (not l_p7) (not l_p11) l_zcl_20))
...
;%~p7 | ~p11 | f28_p
(assert (or (not l_p7) (not l_p11) l_f28_p))
...
;%~zcl_22 | p12
(assert (or (not l_zcl_22) l_p12))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p12 | ~f27 | zcl_22
(assert (or (not l_p12) (not l_f27) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((~p12 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p12 | ~f27_p | f26_p
(assert (or (not l_p12) (not l_f27_p) l_f26_p))
...
;%~p0 | ~p14 | f33_p
(assert (or (not l_p0) (not l_p14) l_f33_p))
...
;%~zcl_26 | p15
(assert (or (not l_zcl_26) l_p15))

;%~zcl_26 | f33
(assert (or (not l_zcl_26) l_f33))

;%~p15 | ~f33 | zcl_26
(assert (or (not l_p15) (not l_f33) l_zcl_26))
...
;%~zcl_27 | p6
(assert (or (not l_zcl_27) l_p6))

;%~zcl_27 | f32
(assert (or (not l_zcl_27) l_f32))

;%~p6 | ~f32 | zcl_27
(assert (or (not l_p6) (not l_f32) l_zcl_27))
...
;%~p6 | ~f31 | zcl_28
(assert (or (not l_p6) (not l_f31) l_zcl_28))
...
;%~r_zcl_10 | r_p7
(assert (or (not r_zcl_10) r_p7))


;%~r_p6 | ~r_p7 | r_zcl_10
(assert (or (not r_p6) (not r_p7) r_zcl_10))
...
(assert (or (not r_p6) (not r_p7) r_f16_p))
...
;%~r_p9 | ~r_f15 | r_zcl_12
(assert (or (not r_p9) (not r_f15) r_zcl_12))
...
;%~r_p8 | ~r_f13 | r_zcl_14
(assert (or (not r_p8) (not r_f13) r_zcl_14))
...
;%~r_p7 | ~r_p11 | r_zcl_20
(assert (or (not r_p7) (not r_p11) r_zcl_20))
...
(assert (or (not r_p7) (not r_p11) r_f28_p))
...
;%~r_p12 | ~r_f27 | r_zcl_22
(assert (or (not r_p12) (not r_f27) r_zcl_22))
...
;%~r_p12 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p12) (not r_f27_p) r_f26_p))
...
(assert (or (not r_p0) (not r_p14) r_f33_p))


;%~r_zcl_26 | r_p15
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p15))
...
;%~r_p15 | ~r_f33 | r_zcl_26
(assert (or (not r_p15) (not r_f33) r_zcl_26))
...
;%~r_p6 | ~r_f32 | r_zcl_27
(assert (or (not r_p6) (not r_f32) r_zcl_27))
...
;%~r_p6 | ~r_f31 | r_zcl_28
(assert (or (not r_p6) (not r_f31) r_zcl_28))
