;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p7 & (p0 & (p0 & (p8 & p6))))) | (p10 & (p0 & (p6 & (p0 & (p0 & p9))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p9 | f15_p
(assert (or (not l_p0) (not l_p9) l_f15_p))
...
;%~p6 | ~f14 | zcl_12
(assert (or (not l_p6) (not l_f14) l_zcl_12))
...
;%~p0 | ~f13 | zcl_13
(assert (or (not l_p0) (not l_f13) l_zcl_13))
...
;%~p10 | ~f12 | zcl_14
(assert (or (not l_p10) (not l_f12) l_zcl_14))
...
(assert (or (not r_p0) (not r_p9) r_f15_p))
...
;%~r_p6 | ~r_f14 | r_zcl_12
(assert (or (not r_p6) (not r_f14) r_zcl_12))
...
;%~r_p0 | ~r_f13 | r_zcl_13
(assert (or (not r_p0) (not r_f13) r_zcl_13))
...
;%~r_p10 | ~r_f12 | r_zcl_14
(assert (or (not r_p10) (not r_f12) r_zcl_14))
