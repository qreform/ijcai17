;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & ~p0)) | ((p4 & (~p0 & ~p3)) | ((~p3 & (~p6 & p5)) | (~p0 & (p3 & ~p7))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p3 | ~p7 | zcl_6
(assert (or (not l_p3) (not l_p7) l_zcl_6))
...
;%~p3 | ~p7 | f9_p
(assert (or (not l_p3) (not l_p7) l_f9_p))
...
;%~r_p3 | ~r_p7 | r_zcl_6
(assert (or (not r_p3) (not r_p7) r_zcl_6))
...
(assert (or (not r_p3) (not r_p7) r_f9_p))
