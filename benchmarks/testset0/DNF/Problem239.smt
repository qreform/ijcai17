;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (~p3 & (p4 & p0)))) | ((~p0 & (~p0 & (p0 & (~p0 & p5)))) | ((~p0 & (~p0 & (~p0 & (~p0 & ~p6)))) | ((~p0 & (~p0 & (p8 & (~p0 & ~p7)))) | ((~p0 & (p0 & (p0 & (~p0 & p9)))) | (~p7 & (~p11 & (~p6 & (p6 & p10))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p9 | f23_p
(assert (or (not l_p0) (not l_p9) l_f23_p))
...
;%~p7 | ~f25 | zcl_23
(assert (or (not l_p7) (not l_f25) l_zcl_23))
...
(assert (or (not r_p0) (not r_p9) r_f23_p))
...
;%~r_p7 | ~r_f25 | r_zcl_23
(assert (or (not r_p7) (not r_f25) r_zcl_23))
