;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (~p3 & (~p4 & (p5 & ~p0))))) | ((p0 & (~p7 & (~p0 & (p0 & (~p0 & ~p6))))) | ((~p0 & (p9 & (p0 & (~p0 & (p6 & ~p8))))) | (~p11 & (~p0 & (~p0 & (~p12 & (~p0 & ~p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p10 | f21_p
(assert (or (not l_p0) (not l_p10) l_f21_p))
...
;%~zcl_19 | p11
(assert (or (not l_zcl_19) l_p11))

;%~zcl_19 | f18
(assert (or (not l_zcl_19) l_f18))

;%~p11 | ~f18 | zcl_19
(assert (or (not l_p11) (not l_f18) l_zcl_19))
...
(assert (or (not r_p0) (not r_p10) r_f21_p))
...
;%~r_p11 | ~r_f18 | r_zcl_19
(assert (or (not r_p11) (not r_f18) r_zcl_19))
