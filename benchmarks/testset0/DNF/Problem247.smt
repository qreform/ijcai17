;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (~p4 & (~p5 & ~p0))))) | ((~p0 & (~p7 & (~p0 & (~p8 & (p0 & ~p6))))) | ((~p0 & (~p10 & (~p0 & (~p0 & (~p11 & ~p9))))) | ((p0 & (p6 & (~p13 & (~p0 & (p9 & ~p12))))) | ((~p12 & (p0 & (p0 & (~p0 & (~p0 & p14))))) | (~p0 & (p12 & (p0 & (~p0 & (~p16 & ~p15)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p11 | ~p9 | zcl_10
(assert (or (not l_p11) (not l_p9) l_zcl_10))
...
;%~p11 | ~p9 | f16_p
(assert (or (not l_p11) (not l_p9) l_f16_p))
...
;%~p10 | ~f14 | zcl_13
(assert (or (not l_p10) (not l_f14) l_zcl_13))
...
;%~p10 | ~f14_p | f13_p
(assert (or (not l_p10) (not l_f14_p) l_f13_p))
...
;%~p9 | ~p12 | zcl_15
(assert (or (not l_p9) (not l_p12) l_zcl_15))
...
;%~p9 | ~p12 | f22_p
(assert (or (not l_p9) (not l_p12) l_f22_p))
...
;%~zcl_24 | p12
(assert (or (not l_zcl_24) l_p12))

;%~zcl_24 | f25
(assert (or (not l_zcl_24) l_f25))

;%~p12 | ~f25 | zcl_24
(assert (or (not l_p12) (not l_f25) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p12 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p12 | ~f25_p | f24_p
(assert (or (not l_p12) (not l_f25_p) l_f24_p))
...
;%Non-clausified dependency
;%(forall[]((~p16 & ~p15) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p16 | ~p15 | f33_p
(assert (or (not l_p16) (not l_p15) l_f33_p))
...
;%~p12 | ~f31 | zcl_28
(assert (or (not l_p12) (not l_f31) l_zcl_28))
...
;%~r_p11 | ~r_p9 | r_zcl_10
(assert (or (not r_p11) (not r_p9) r_zcl_10))
...
(assert (or (not r_p11) (not r_p9) r_f16_p))
...
;%~r_p10 | ~r_f14 | r_zcl_13
(assert (or (not r_p10) (not r_f14) r_zcl_13))
...
;%~r_p10 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p10) (not r_f14_p) r_f13_p))
...
;%~r_p9 | ~r_p12 | r_zcl_15
(assert (or (not r_p9) (not r_p12) r_zcl_15))
...
(assert (or (not r_p9) (not r_p12) r_f22_p))
...
;%~r_p12 | ~r_f25 | r_zcl_24
(assert (or (not r_p12) (not r_f25) r_zcl_24))
...
;%~r_p12 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p12) (not r_f25_p) r_f24_p))
...
(assert (or (not r_p16) (not r_p15) r_f33_p))
...
;%~r_p12 | ~r_f31 | r_zcl_28
(assert (or (not r_p12) (not r_f31) r_zcl_28))
