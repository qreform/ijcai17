;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & ~p0))) | ((p0 & (p0 & (~p5 & p4))) | ((p0 & (p0 & (~p0 & p6))) | ((~p0 & (~p8 & (~p0 & p7))) | ((~p10 & (p11 & (p0 & ~p9))) | ((p0 & (~p13 & (~p9 & p12))) | (~p0 & (p0 & (p12 & ~p14))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p13 | ~f22 | zcl_16
(assert (or (not l_p13) (not l_f22) l_zcl_16))
...
;%~p12 | ~p14 | zcl_18
(assert (or (not l_p12) (not l_p14) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p12 & ~p14) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p12 | ~p14 | f25_p
(assert (or (not l_p12) (not l_p14) l_f25_p))
...
;%~r_p13 | ~r_f22 | r_zcl_16
(assert (or (not r_p13) (not r_f22) r_zcl_16))
...
;%~r_p12 | ~r_p14 | r_zcl_18
(assert (or (not r_p12) (not r_p14) r_zcl_18))
...
(assert (or (not r_p12) (not r_p14) r_f25_p))
