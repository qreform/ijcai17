;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & ~p0))) | ((p0 & (~p5 & (p0 & p4))) | ((~p7 & (~p8 & (p0 & p6))) | (~p6 & (p10 & (p4 & ~p9)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p9 | zcl_9
(assert (or (not l_p4) (not l_p9) l_zcl_9))
...
;%~p4 | ~p9 | f13_p
(assert (or (not l_p4) (not l_p9) l_f13_p))
...
;%~p10 | ~f13 | zcl_10
(assert (or (not l_p10) (not l_f13) l_zcl_10))
...
;%~p6 | ~f12 | zcl_11
(assert (or (not l_p6) (not l_f12) l_zcl_11))
...
;%~r_p4 | ~r_p9 | r_zcl_9
(assert (or (not r_p4) (not r_p9) r_zcl_9))
...
(assert (or (not r_p4) (not r_p9) r_f13_p))
...
;%~r_p10 | ~r_f13 | r_zcl_10
(assert (or (not r_p10) (not r_f13) r_zcl_10))
...
;%~r_p6 | ~r_f12 | r_zcl_11
(assert (or (not r_p6) (not r_f12) r_zcl_11))
