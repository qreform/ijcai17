;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & p0) | ((p3 & p2) | ((p0 & p4) | ((p0 & p5) | ((p7 & p6) | (p6 & p8)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~p8 | zcl_5
(assert (or (not l_p6) (not l_p8) l_zcl_5))
...
;%~p6 | ~p8 | f9_p
(assert (or (not l_p6) (not l_p8) l_f9_p))
...
;%~r_p6 | ~r_p8 | r_zcl_5
(assert (or (not r_p6) (not r_p8) r_zcl_5))
...
(assert (or (not r_p6) (not r_p8) r_f9_p))
