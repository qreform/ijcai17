;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (~p3 & (p4 & (~p5 & p0))))) | ((~p0 & (p0 & (~p0 & (~p7 & (~p0 & p6))))) | ((~p9 & (~p0 & (p0 & (~p10 & (~p0 & ~p8))))) | (~p0 & (p6 & (~p0 & (~p0 & (~p12 & p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p12 | ~p11 | zcl_15
(assert (or (not l_p12) (not l_p11) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((~p12 & p11) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p12 | ~p11 | f21_p
(assert (or (not l_p12) (not l_p11) l_f21_p))
...
;%~r_p12 | ~r_p11 | r_zcl_15
(assert (or (not r_p12) (not r_p11) r_zcl_15))
...
(assert (or (not r_p12) (not r_p11) r_f21_p))
