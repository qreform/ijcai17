;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (p3 & (~p4 & p0)))) | ((p0 & (~p0 & (~p0 & (~p0 & ~p5)))) | ((~p7 & (~p8 & (p0 & (~p0 & ~p6)))) | ((~p0 & (~p10 & (p0 & (p11 & ~p9)))) | ((~p0 & (p13 & (~p0 & (~p9 & ~p12)))) | ((p15 & (p0 & (p0 & (~p16 & p14)))) | (p0 & (~p18 & (~p19 & (~p20 & ~p17)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~f12 | zcl_10
(assert (or (not l_p8) (not l_f12) l_zcl_10))
...
;%~zcl_11 | p7
(assert (or (not l_zcl_11) l_p7))

;%~zcl_11 | f11
(assert (or (not l_zcl_11) l_f11))

;%~p7 | ~f11 | zcl_11
(assert (or (not l_p7) (not l_f11) l_zcl_11))
...
;%~p7 | ~f11_p | f10_p
(assert (or (not l_p7) (not l_f11_p) l_f10_p))
...
;%~p11 | ~p9 | zcl_12
(assert (or (not l_p11) (not l_p9) l_zcl_12))
...
;%~p11 | ~p9 | f18_p
(assert (or (not l_p11) (not l_p9) l_f18_p))
...
;%~p10 | ~f17 | zcl_14
(assert (or (not l_p10) (not l_f17) l_zcl_14))
...
;%~p9 | ~p12 | zcl_16
(assert (or (not l_p9) (not l_p12) l_zcl_16))
...
;%~p9 | ~p12 | f23_p
(assert (or (not l_p9) (not l_p12) l_f23_p))
...
;%~p13 | ~f22 | zcl_18
(assert (or (not l_p13) (not l_f22) l_zcl_18))
...
;%~p20 | ~p17 | zcl_24
(assert (or (not l_p20) (not l_p17) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p20 & ~p17) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p20 | ~p17 | f32_p
(assert (or (not l_p20) (not l_p17) l_f32_p))
...
;%~p19 | ~f32 | zcl_25
(assert (or (not l_p19) (not l_f32) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((~p19 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p19 | ~f32_p | f31_p
(assert (or (not l_p19) (not l_f32_p) l_f31_p))
...
;%~p18 | ~f31 | zcl_26
(assert (or (not l_p18) (not l_f31) l_zcl_26))
...
;%~r_p8 | ~r_f12 | r_zcl_10
(assert (or (not r_p8) (not r_f12) r_zcl_10))
...
;%~r_p7 | ~r_f11 | r_zcl_11
(assert (or (not r_p7) (not r_f11) r_zcl_11))
...
;%~r_p7 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p7) (not r_f11_p) r_f10_p))
...
;%~r_p11 | ~r_p9 | r_zcl_12
(assert (or (not r_p11) (not r_p9) r_zcl_12))
...
(assert (or (not r_p11) (not r_p9) r_f18_p))
...
;%~r_p10 | ~r_f17 | r_zcl_14
(assert (or (not r_p10) (not r_f17) r_zcl_14))
...
;%~r_p9 | ~r_p12 | r_zcl_16
(assert (or (not r_p9) (not r_p12) r_zcl_16))
...
(assert (or (not r_p9) (not r_p12) r_f23_p))
...
;%~r_p13 | ~r_f22 | r_zcl_18
(assert (or (not r_p13) (not r_f22) r_zcl_18))
...
;%~r_p20 | ~r_p17 | r_zcl_24
(assert (or (not r_p20) (not r_p17) r_zcl_24))
...
(assert (or (not r_p20) (not r_p17) r_f32_p))
...
;%~r_p19 | ~r_f32 | r_zcl_25
(assert (or (not r_p19) (not r_f32) r_zcl_25))
...
;%~r_p19 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p19) (not r_f32_p) r_f31_p))
...
;%~r_p18 | ~r_f31 | r_zcl_26
(assert (or (not r_p18) (not r_f31) r_zcl_26))
