;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & (~p4 & (~p5 & ~p0))))) | ((~p7 & (~p0 & (~p0 & (~p0 & (p8 & p6))))) | ((~p0 & (~p0 & (p10 & (p11 & (p12 & ~p9))))) | ((p0 & (~p14 & (p0 & (p0 & (~p0 & ~p13))))) | ((~p0 & (p0 & (~p16 & (~p13 & (~p17 & p15))))) | ((~p19 & (p0 & (~p20 & (~p0 & (p21 & ~p18))))) | (~p23 & (p0 & (p24 & (p0 & (p0 & ~p22))))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p6 | zcl_5
(assert (or (not l_p8) (not l_p6) l_zcl_5))
...
;%~p8 | ~p6 | f10_p
(assert (or (not l_p8) (not l_p6) l_f10_p))
...
;%~p12 | ~p9 | zcl_10
(assert (or (not l_p12) (not l_p9) l_zcl_10))
...
;%~p12 | ~p9 | f16_p
(assert (or (not l_p12) (not l_p9) l_f16_p))
...
;%~p11 | ~f16 | zcl_11
(assert (or (not l_p11) (not l_f16) l_zcl_11))
...
;%~zcl_15 | p13
(assert (or (not l_zcl_15) l_p13))

;%~p0 | ~p13 | zcl_15
(assert (or (not l_p0) (not l_p13) l_zcl_15))
...
;%~p0 | ~p13 | f22_p
(assert (or (not l_p0) (not l_p13) l_f22_p))
...
;%~zcl_18 | p14
(assert (or (not l_zcl_18) l_p14))

;%~zcl_18 | f20
(assert (or (not l_zcl_18) l_f20))

;%~p14 | ~f20 | zcl_18
(assert (or (not l_p14) (not l_f20) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p14 | ~f20_p | f19_p
(assert (or (not l_p14) (not l_f20_p) l_f19_p))
...
;%~p17 | ~p15 | zcl_20
(assert (or (not l_p17) (not l_p15) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((~p17 & p15) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p17 | ~p15 | f28_p
(assert (or (not l_p17) (not l_p15) l_f28_p))
...
;%~p13 | ~f28 | zcl_21
(assert (or (not l_p13) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((~p13 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p13 | ~f28_p | f27_p
(assert (or (not l_p13) (not l_f28_p) l_f27_p))
...
;%~zcl_22 | p16
(assert (or (not l_zcl_22) l_p16))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p16 | ~f27 | zcl_22
(assert (or (not l_p16) (not l_f27) l_zcl_22))
...
;%~zcl_25 | p21
(assert (or (not l_zcl_25) l_p21))

(declare-fun l_p18 () Bool)
;%~zcl_25 | p18
(assert (or (not l_zcl_25) l_p18))

;%~p21 | ~p18 | zcl_25
(assert (or (not l_p21) (not l_p18) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p21 & ~p18) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p21 | ~p18 | f34_p
(assert (or (not l_p21) (not l_p18) l_f34_p))
...
;%~zcl_27 | p20
(assert (or (not l_zcl_27) l_p20))

;%~zcl_27 | f33
(assert (or (not l_zcl_27) l_f33))

;%~p20 | ~f33 | zcl_27
(assert (or (not l_p20) (not l_f33) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((~p20 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p20 | ~f33_p | f32_p
(assert (or (not l_p20) (not l_f33_p) l_f32_p))
...
;%~zcl_29 | p19
(assert (or (not l_zcl_29) l_p19))

;%~zcl_29 | f31
(assert (or (not l_zcl_29) l_f31))

;%~p19 | ~f31 | zcl_29
(assert (or (not l_p19) (not l_f31) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((~p19 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p19 | ~f31_p | f30_p
(assert (or (not l_p19) (not l_f31_p) l_f30_p))
...
;%~zcl_30 | p22
(assert (or (not l_zcl_30) l_p22))

;%~p0 | ~p22 | zcl_30
(assert (or (not l_p0) (not l_p22) l_zcl_30))
...
;%~p0 | ~p22 | f39_p
(assert (or (not l_p0) (not l_p22) l_f39_p))
...
;%~zcl_32 | p24
(assert (or (not l_zcl_32) l_p24))

;%~zcl_32 | f38
(assert (or (not l_zcl_32) l_f38))

;%~p24 | ~f38 | zcl_32
(assert (or (not l_p24) (not l_f38) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p24 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p24 | ~f38_p | f37_p
(assert (or (not l_p24) (not l_f38_p) l_f37_p))
...
;%~zcl_34 | p23
(assert (or (not l_zcl_34) l_p23))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p23 | ~f36 | zcl_34
(assert (or (not l_p23) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((~p23 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p23 | ~f36_p | f35_p
(assert (or (not l_p23) (not l_f36_p) l_f35_p))
...
;%~r_p8 | ~r_p6 | r_zcl_5
(assert (or (not r_p8) (not r_p6) r_zcl_5))
...
(assert (or (not r_p8) (not r_p6) r_f10_p))
...
;%~r_p12 | ~r_p9 | r_zcl_10
(assert (or (not r_p12) (not r_p9) r_zcl_10))
...
(assert (or (not r_p12) (not r_p9) r_f16_p))
...
;%~r_p11 | ~r_f16 | r_zcl_11
(assert (or (not r_p11) (not r_f16) r_zcl_11))
...
;%~r_zcl_15 | r_p13
(assert (or (not r_zcl_15) r_p13))


;%~r_p0 | ~r_p13 | r_zcl_15
(assert (or (not r_p0) (not r_p13) r_zcl_15))
...
(assert (or (not r_p0) (not r_p13) r_f22_p))
...
;%~r_p14 | ~r_f20 | r_zcl_18
(assert (or (not r_p14) (not r_f20) r_zcl_18))
...
;%~r_p14 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p14) (not r_f20_p) r_f19_p))
...
;%~r_p17 | ~r_p15 | r_zcl_20
(assert (or (not r_p17) (not r_p15) r_zcl_20))
...
(assert (or (not r_p17) (not r_p15) r_f28_p))
...
;%~r_p13 | ~r_f28 | r_zcl_21
(assert (or (not r_p13) (not r_f28) r_zcl_21))
...
;%~r_p13 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p13) (not r_f28_p) r_f27_p))


;%~r_zcl_22 | r_p16
(declare-fun r_zcl_22 () Bool)
(assert (or (not r_zcl_22) r_p16))
...
;%~r_p16 | ~r_f27 | r_zcl_22
(assert (or (not r_p16) (not r_f27) r_zcl_22))
...
(assert (or (not r_zcl_25) r_p21))


;%~r_zcl_25 | r_p18
(assert (or (not r_zcl_25) r_p18))


;%~r_p21 | ~r_p18 | r_zcl_25
(assert (or (not r_p21) (not r_p18) r_zcl_25))
...
(assert (or (not r_p21) (not r_p18) r_f34_p))
...
;%~r_p20 | ~r_f33 | r_zcl_27
(assert (or (not r_p20) (not r_f33) r_zcl_27))
...
;%~r_p20 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p20) (not r_f33_p) r_f32_p))
...
;%~r_p19 | ~r_f31 | r_zcl_29
(assert (or (not r_p19) (not r_f31) r_zcl_29))
...
;%~r_p19 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p19) (not r_f31_p) r_f30_p))
...
;%~r_zcl_30 | r_p22
(assert (or (not r_zcl_30) r_p22))


;%~r_p0 | ~r_p22 | r_zcl_30
(assert (or (not r_p0) (not r_p22) r_zcl_30))
...
(assert (or (not r_p0) (not r_p22) r_f39_p))
...
;%~r_p24 | ~r_f38 | r_zcl_32
(assert (or (not r_p24) (not r_f38) r_zcl_32))
...
;%~r_p24 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p24) (not r_f38_p) r_f37_p))
...
;%~r_p23 | ~r_f36 | r_zcl_34
(assert (or (not r_p23) (not r_f36) r_zcl_34))
...
;%~r_p23 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p23) (not r_f36_p) r_f35_p))
