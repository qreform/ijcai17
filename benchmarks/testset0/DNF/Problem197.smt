;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (p3 & (p4 & (~p5 & ~p0))))) | ((~p7 & (~p8 & (~p0 & (~p0 & (~p0 & p6))))) | ((~p10 & (p6 & (~p6 & (~p0 & (p0 & ~p9))))) | ((p12 & (~p0 & (p0 & (~p6 & (p6 & ~p11))))) | (~p14 & (p15 & (~p11 & (p16 & (p9 & ~p13))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~zcl_19 | p12
(assert (or (not l_zcl_19) l_p12))

;%~zcl_19 | f19
(assert (or (not l_zcl_19) l_f19))

;%~p12 | ~f19 | zcl_19
(assert (or (not l_p12) (not l_f19) l_zcl_19))
...
;%~p9 | ~p13 | zcl_20
(assert (or (not l_p9) (not l_p13) l_zcl_20))
...
;%~p9 | ~p13 | f27_p
(assert (or (not l_p9) (not l_p13) l_f27_p))
...
;%~p11 | ~f26 | zcl_22
(assert (or (not l_p11) (not l_f26) l_zcl_22))
...
;%~p15 | ~f25 | zcl_23
(assert (or (not l_p15) (not l_f25) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((p15 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p15 | ~f25_p | f24_p
(assert (or (not l_p15) (not l_f25_p) l_f24_p))
...
;%~p14 | ~f24 | zcl_24
(assert (or (not l_p14) (not l_f24) l_zcl_24))
...
;%~r_p12 | ~r_f19 | r_zcl_19
(assert (or (not r_p12) (not r_f19) r_zcl_19))
...
;%~r_p9 | ~r_p13 | r_zcl_20
(assert (or (not r_p9) (not r_p13) r_zcl_20))
...
(assert (or (not r_p9) (not r_p13) r_f27_p))
...
;%~r_p11 | ~r_f26 | r_zcl_22
(assert (or (not r_p11) (not r_f26) r_zcl_22))
...
;%~r_p15 | ~r_f25 | r_zcl_23
(assert (or (not r_p15) (not r_f25) r_zcl_23))
...
;%~r_p15 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p15) (not r_f25_p) r_f24_p))
...
;%~r_p14 | ~r_f24 | r_zcl_24
(assert (or (not r_p14) (not r_f24) r_zcl_24))
