;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p0 & (p0 & (p0 & (p0 & p6))))) | ((p6 & (p0 & (p0 & (p0 & (p0 & p7))))) | ((p6 & (p0 & (p0 & (p9 & (p0 & p8))))) | ((p11 & (p0 & (p12 & (p13 & (p6 & p10))))) | (p0 & (p0 & (p15 & (p7 & (p0 & p14)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p7 | zcl_10
(assert (or (not l_p0) (not l_p7) l_zcl_10))
...
;%~p0 | ~p7 | f16_p
(assert (or (not l_p0) (not l_p7) l_f16_p))
...
;%~zcl_14 | p6
(assert (or (not l_zcl_14) l_p6))

;%~zcl_14 | f13
(assert (or (not l_zcl_14) l_f13))

;%~p6 | ~f13 | zcl_14
(assert (or (not l_p6) (not l_f13) l_zcl_14))
...
;%~p6 | ~f13_p | f12_p
(assert (or (not l_p6) (not l_f13_p) l_f12_p))
...
;%~p0 | ~p8 | zcl_15
(assert (or (not l_p0) (not l_p8) l_zcl_15))
...
;%~p0 | ~p8 | f22_p
(assert (or (not l_p0) (not l_p8) l_f22_p))
...
;%~zcl_20 | p10
(assert (or (not l_zcl_20) l_p10))

;%~p6 | ~p10 | zcl_20
(assert (or (not l_p6) (not l_p10) l_zcl_20))
...
;%~p6 | ~p10 | f28_p
(assert (or (not l_p6) (not l_p10) l_f28_p))
...
;%~zcl_24 | p11
(assert (or (not l_zcl_24) l_p11))

;%~zcl_24 | f25
(assert (or (not l_zcl_24) l_f25))

;%~p11 | ~f25 | zcl_24
(assert (or (not l_p11) (not l_f25) l_zcl_24))
...
;%~zcl_26 | p7
(assert (or (not l_zcl_26) l_p7))

;%~zcl_26 | f33
(assert (or (not l_zcl_26) l_f33))

;%~p7 | ~f33 | zcl_26
(assert (or (not l_p7) (not l_f33) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p7 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p7 | ~f33_p | f32_p
(assert (or (not l_p7) (not l_f33_p) l_f32_p))
...
;%~p15 | ~f32 | zcl_27
(assert (or (not l_p15) (not l_f32) l_zcl_27))
...
;%~r_p0 | ~r_p7 | r_zcl_10
(assert (or (not r_p0) (not r_p7) r_zcl_10))
...
(assert (or (not r_p0) (not r_p7) r_f16_p))
...
;%~r_p6 | ~r_f13 | r_zcl_14
(assert (or (not r_p6) (not r_f13) r_zcl_14))
...
;%~r_p6 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p6) (not r_f13_p) r_f12_p))
...
;%~r_p0 | ~r_p8 | r_zcl_15
(assert (or (not r_p0) (not r_p8) r_zcl_15))
...
(assert (or (not r_p0) (not r_p8) r_f22_p))
...
;%~r_zcl_20 | r_p10
(assert (or (not r_zcl_20) r_p10))


;%~r_p6 | ~r_p10 | r_zcl_20
(assert (or (not r_p6) (not r_p10) r_zcl_20))
...
(assert (or (not r_p6) (not r_p10) r_f28_p))
...
;%~r_p11 | ~r_f25 | r_zcl_24
(assert (or (not r_p11) (not r_f25) r_zcl_24))
...
;%~r_p7 | ~r_f33 | r_zcl_26
(assert (or (not r_p7) (not r_f33) r_zcl_26))
...
;%~r_p7 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p7) (not r_f33_p) r_f32_p))
...
;%~r_p15 | ~r_f32 | r_zcl_27
(assert (or (not r_p15) (not r_f32) r_zcl_27))
