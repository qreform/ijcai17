;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & (~p4 & (~p5 & ~p0))))) | ((~p7 & (~p8 & (~p0 & (~p0 & (~p0 & ~p6))))) | ((~p0 & (~p0 & (p0 & (~p0 & (p10 & ~p9))))) | ((p0 & (p0 & (p0 & (~p6 & (~p6 & ~p11))))) | ((p0 & (~p13 & (~p0 & (~p0 & (p0 & ~p12))))) | ((~p0 & (~p0 & (~p15 & (p0 & (~p0 & ~p14))))) | (~p11 & (p6 & (p0 & (~p0 & (p0 & ~p16))))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p10 | ~p9 | f16_p
(assert (or (not l_p10) (not l_p9) l_f16_p))
...
;%~p6 | ~p11 | zcl_15
(assert (or (not l_p6) (not l_p11) l_zcl_15))
...
;%~p6 | ~p11 | f22_p
(assert (or (not l_p6) (not l_p11) l_f22_p))
...
;%~zcl_27 | p15
(assert (or (not l_zcl_27) l_p15))

;%~zcl_27 | f33
(assert (or (not l_zcl_27) l_f33))

;%~p15 | ~f33 | zcl_27
(assert (or (not l_p15) (not l_f33) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((~p15 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p15 | ~f33_p | f32_p
(assert (or (not l_p15) (not l_f33_p) l_f32_p))
...
(assert (or (not r_p10) (not r_p9) r_f16_p))
...
;%~r_p6 | ~r_p11 | r_zcl_15
(assert (or (not r_p6) (not r_p11) r_zcl_15))
...
(assert (or (not r_p6) (not r_p11) r_f22_p))
...
;%~r_p15 | ~r_f33 | r_zcl_27
(assert (or (not r_p15) (not r_f33) r_zcl_27))
...
;%~r_p15 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p15) (not r_f33_p) r_f32_p))
