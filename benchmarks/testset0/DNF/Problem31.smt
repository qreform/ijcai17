;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | (p0 & (p0 & (p6 & (p7 & p5))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~p5 | f7_p
(assert (or (not l_p7) (not l_p5) l_f7_p))
...
;%~p0 | ~f6 | zcl_6
(assert (or (not l_p0) (not l_f6) l_zcl_6))
...
;%~p0 | ~f5 | zcl_7
(assert (or (not l_p0) (not l_f5) l_zcl_7))
...
(assert (or (not r_p7) (not r_p5) r_f7_p))
...
;%~r_p0 | ~r_f6 | r_zcl_6
(assert (or (not r_p0) (not r_f6) r_zcl_6))
...
;%~r_p0 | ~r_f5 | r_zcl_7
(assert (or (not r_p0) (not r_f5) r_zcl_7))
