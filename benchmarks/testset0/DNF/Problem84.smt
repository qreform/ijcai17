...
;%Non-clausified dependency
;%(forall[]((p14 & p10) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p14 | ~p10 | f12_p
(assert (or (not l_p14) (not l_p10) l_f12_p))
...
;%~p12 | ~f11 | zcl_10
(assert (or (not l_p12) (not l_f11) l_zcl_10))
...
;%Non-clausified dependency
;%(forall[]((p12 & f11_p) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p12 | ~f11_p | f10_p
(assert (or (not l_p12) (not l_f11_p) l_f10_p))
...
;%~p11 | ~f10 | zcl_11
(assert (or (not l_p11) (not l_f10) l_zcl_11))
...
(assert (or (not r_p14) (not r_p10) r_f12_p))
...
;%~r_p12 | ~r_f11 | r_zcl_10
(assert (or (not r_p12) (not r_f11) r_zcl_10))
...
;%~r_p12 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p12) (not r_f11_p) r_f10_p))
...
;%~r_p11 | ~r_f10 | r_zcl_11
(assert (or (not r_p11) (not r_f10) r_zcl_11))
