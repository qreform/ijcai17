;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p7 & (p0 & (p8 & (p0 & (p9 & p6))))) | ((p0 & (p0 & (p0 & (p0 & (p6 & p10))))) | (p0 & (p6 & (p12 & (p0 & (p13 & p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p13 | ~p11 | zcl_15
(assert (or (not l_p13) (not l_p11) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((p13 & p11) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p13 | ~p11 | f21_p
(assert (or (not l_p13) (not l_p11) l_f21_p))
...
;%~p12 | ~f20 | zcl_17
(assert (or (not l_p12) (not l_f20) l_zcl_17))
...
;%~p12 | ~f20_p | f19_p
(assert (or (not l_p12) (not l_f20_p) l_f19_p))
...
;%~p6 | ~f19 | zcl_18
(assert (or (not l_p6) (not l_f19) l_zcl_18))
...
;%~r_p13 | ~r_p11 | r_zcl_15
(assert (or (not r_p13) (not r_p11) r_zcl_15))
...
(assert (or (not r_p13) (not r_p11) r_f21_p))
...
;%~r_p12 | ~r_f20 | r_zcl_17
(assert (or (not r_p12) (not r_f20) r_zcl_17))
...
;%~r_p12 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p12) (not r_f20_p) r_f19_p))
...
;%~r_p6 | ~r_f19 | r_zcl_18
(assert (or (not r_p6) (not r_f19) r_zcl_18))
