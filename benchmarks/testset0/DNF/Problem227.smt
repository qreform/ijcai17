;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & p0))) | ((~p0 & (~p0 & (~p0 & ~p4))) | ((~p4 & (p0 & (p6 & ~p5))) | ((~p0 & (~p8 & (p0 & p7))) | ((~p5 & (p0 & (p7 & ~p9))) | (~p7 & (p11 & (~p0 & ~p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~f20 | zcl_17
(assert (or (not l_p7) (not l_f20) l_zcl_17))
...
;%~r_p7 | ~r_f20 | r_zcl_17
(assert (or (not r_p7) (not r_f20) r_zcl_17))
