;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & p0)) | ((p4 & (p0 & p3)) | ((p0 & (p3 & p5)) | ((p0 & (p3 & p6)) | ((p8 & (p6 & p7)) | ((p10 & (p3 & p9)) | (p12 & (p3 & p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~f7 | zcl_5
(assert (or (not l_p0) (not l_f7) l_zcl_5))
...
;%~p6 | ~p7 | zcl_8
(assert (or (not l_p6) (not l_p7) l_zcl_8))
...
;%~p3 | ~p9 | zcl_10
(assert (or (not l_p3) (not l_p9) l_zcl_10))
...
;%~p3 | ~p9 | f16_p
(assert (or (not l_p3) (not l_p9) l_f16_p))
...
;%~p3 | ~p11 | zcl_12
(assert (or (not l_p3) (not l_p11) l_zcl_12))
...
;%~p3 | ~p11 | f18_p
(assert (or (not l_p3) (not l_p11) l_f18_p))
...
;%~r_p0 | ~r_f7 | r_zcl_5
(assert (or (not r_p0) (not r_f7) r_zcl_5))
...
;%~r_p6 | ~r_p7 | r_zcl_8
(assert (or (not r_p6) (not r_p7) r_zcl_8))
...
;%~r_p3 | ~r_p9 | r_zcl_10
(assert (or (not r_p3) (not r_p9) r_zcl_10))
...
(assert (or (not r_p3) (not r_p9) r_f16_p))
...
;%~r_p3 | ~r_p11 | r_zcl_12
(assert (or (not r_p3) (not r_p11) r_zcl_12))
...
(assert (or (not r_p3) (not r_p11) r_f18_p))
