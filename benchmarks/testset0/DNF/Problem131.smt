;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p6 & (p7 & (p0 & p5)))) | ((p0 & (p0 & (p9 & (p0 & p8)))) | (p0 & (p5 & (p0 & (p0 & p10))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p10 | f17_p
(assert (or (not l_p0) (not l_p10) l_f17_p))
...
;%~p5 | ~f16 | zcl_14
(assert (or (not l_p5) (not l_f16) l_zcl_14))
...
(assert (or (not r_p0) (not r_p10) r_f17_p))
...
;%~r_p5 | ~r_f16 | r_zcl_14
(assert (or (not r_p5) (not r_f16) r_zcl_14))
