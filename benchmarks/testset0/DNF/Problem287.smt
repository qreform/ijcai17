;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (p3 & (~p4 & p0)))) | ((~p0 & (p0 & (~p0 & (~p0 & ~p5)))) | ((~p0 & (p0 & (~p5 & (p7 & ~p6)))) | ((~p6 & (p0 & (~p9 & (p0 & p8)))) | ((~p0 & (p0 & (~p8 & (~p0 & p10)))) | ((~p0 & (~p0 & (~p12 & (~p0 & p11)))) | (p14 & (~p15 & (p16 & (~p0 & ~p13)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p8 | f18_p
(assert (or (not l_p0) (not l_p8) l_f18_p))
...
;%~p6 | ~f16 | zcl_15
(assert (or (not l_p6) (not l_f16) l_zcl_15))
...
;%~p0 | ~p10 | zcl_16
(assert (or (not l_p0) (not l_p10) l_zcl_16))
...
;%~p0 | ~p10 | f23_p
(assert (or (not l_p0) (not l_p10) l_f23_p))
...
;%~p8 | ~f23 | zcl_17
(assert (or (not l_p8) (not l_f23) l_zcl_17))
...
;%~p12 | ~f28 | zcl_21
(assert (or (not l_p12) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((~p12 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p12 | ~f28_p | f27_p
(assert (or (not l_p12) (not l_f28_p) l_f27_p))
...
;%~p0 | ~p13 | zcl_24
(assert (or (not l_p0) (not l_p13) l_zcl_24))
...
;%~p0 | ~p13 | f32_p
(assert (or (not l_p0) (not l_p13) l_f32_p))
...
;%~p16 | ~f32 | zcl_25
(assert (or (not l_p16) (not l_f32) l_zcl_25))
...
;%~p14 | ~f30 | zcl_27
(assert (or (not l_p14) (not l_f30) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p14 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p14 | ~f30_p | f29_p
(assert (or (not l_p14) (not l_f30_p) l_f29_p))
...
(assert (or (not r_p0) (not r_p8) r_f18_p))
...
;%~r_p6 | ~r_f16 | r_zcl_15
(assert (or (not r_p6) (not r_f16) r_zcl_15))
...
;%~r_p0 | ~r_p10 | r_zcl_16
(assert (or (not r_p0) (not r_p10) r_zcl_16))
...
(assert (or (not r_p0) (not r_p10) r_f23_p))
...
;%~r_p8 | ~r_f23 | r_zcl_17
(assert (or (not r_p8) (not r_f23) r_zcl_17))
...
;%~r_p12 | ~r_f28 | r_zcl_21
(assert (or (not r_p12) (not r_f28) r_zcl_21))
...
;%~r_p12 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p12) (not r_f28_p) r_f27_p))
...
;%~r_p0 | ~r_p13 | r_zcl_24
(assert (or (not r_p0) (not r_p13) r_zcl_24))
...
(assert (or (not r_p0) (not r_p13) r_f32_p))
...
;%~r_p16 | ~r_f32 | r_zcl_25
(assert (or (not r_p16) (not r_f32) r_zcl_25))
...
;%~r_p14 | ~r_f30 | r_zcl_27
(assert (or (not r_p14) (not r_f30) r_zcl_27))
...
;%~r_p14 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p14) (not r_f30_p) r_f29_p))
