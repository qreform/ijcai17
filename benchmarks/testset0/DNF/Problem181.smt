;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p0 & (p6 & (p0 & p5)))) | ((p0 & (p0 & (p0 & (p8 & p7)))) | ((p10 & (p0 & (p0 & (p11 & p9)))) | (p5 & (p13 & (p14 & (p0 & p12)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p14 | ~f22 | zcl_17
(assert (or (not l_p14) (not l_f22) l_zcl_17))
...
;%~r_p14 | ~r_f22 | r_zcl_17
(assert (or (not r_p14) (not r_f22) r_zcl_17))
