...
;%Non-clausified dependency
;%(forall[]((~p24 & ~p20) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p24 | ~p20 | f23_p
(assert (or (not l_p24) (not l_p20) l_f23_p))
...
;%~p23 | ~f23 | zcl_17
(assert (or (not l_p23) (not l_f23) l_zcl_17))
...
;%~p22 | ~f22 | zcl_18
(assert (or (not l_p22) (not l_f22) l_zcl_18))
...
;%~p21 | ~f21 | zcl_19
(assert (or (not l_p21) (not l_f21) l_zcl_19))
...
;%~p29 | ~p25 | zcl_20
(assert (or (not l_p29) (not l_p25) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p29 & ~p25) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p29 | ~p25 | f28_p
(assert (or (not l_p29) (not l_p25) l_f28_p))
...
;%~zcl_24 | p30
(assert (or (not l_zcl_24) l_p30))

;%~p34 | ~p30 | zcl_24
(assert (or (not l_p34) (not l_p30) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p34 & p30) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p34 | ~p30 | f32_p
(assert (or (not l_p34) (not l_p30) l_f32_p))
...
(assert (or (not r_p24) (not r_p20) r_f23_p))
...
;%~r_p23 | ~r_f23 | r_zcl_17
(assert (or (not r_p23) (not r_f23) r_zcl_17))
...
;%~r_p22 | ~r_f22 | r_zcl_18
(assert (or (not r_p22) (not r_f22) r_zcl_18))
...
;%~r_p21 | ~r_f21 | r_zcl_19
(assert (or (not r_p21) (not r_f21) r_zcl_19))
...
;%~r_p29 | ~r_p25 | r_zcl_20
(assert (or (not r_p29) (not r_p25) r_zcl_20))
...
(assert (or (not r_p29) (not r_p25) r_f28_p))
...
;%~r_zcl_24 | r_p30
(assert (or (not r_zcl_24) r_p30))


;%~r_p34 | ~r_p30 | r_zcl_24
(assert (or (not r_p34) (not r_p30) r_zcl_24))
...
(assert (or (not r_p34) (not r_p30) r_f32_p))
