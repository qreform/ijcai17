;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (p3 & (p4 & p0)))) | ((~p0 & (p6 & (~p0 & (~p0 & p5)))) | ((p5 & (p8 & (~p0 & (~p9 & ~p7)))) | ((~p0 & (~p11 & (p5 & (~p7 & ~p10)))) | (~p13 & (~p7 & (~p0 & (~p7 & p12)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~p7 | zcl_8
(assert (or (not l_p9) (not l_p7) l_zcl_8))
...
;%~p7 | ~p10 | zcl_12
(assert (or (not l_p7) (not l_p10) l_zcl_12))
...
;%~p7 | ~p10 | f18_p
(assert (or (not l_p7) (not l_p10) l_f18_p))
...
;%~p7 | ~p12 | zcl_16
(assert (or (not l_p7) (not l_p12) l_zcl_16))
...
;%~p7 | ~p12 | f22_p
(assert (or (not l_p7) (not l_p12) l_f22_p))
...
;%~p0 | ~f22 | zcl_17
(assert (or (not l_p0) (not l_f22) l_zcl_17))
...
;%~p7 | ~f21 | zcl_18
(assert (or (not l_p7) (not l_f21) l_zcl_18))
...
;%~p13 | ~f20 | zcl_19
(assert (or (not l_p13) (not l_f20) l_zcl_19))
...
;%~r_p9 | ~r_p7 | r_zcl_8
(assert (or (not r_p9) (not r_p7) r_zcl_8))
...
;%~r_p7 | ~r_p10 | r_zcl_12
(assert (or (not r_p7) (not r_p10) r_zcl_12))
...
(assert (or (not r_p7) (not r_p10) r_f18_p))
...
;%~r_p7 | ~r_p12 | r_zcl_16
(assert (or (not r_p7) (not r_p12) r_zcl_16))
...
(assert (or (not r_p7) (not r_p12) r_f22_p))
...
;%~r_p0 | ~r_f22 | r_zcl_17
(assert (or (not r_p0) (not r_f22) r_zcl_17))
...
;%~r_p7 | ~r_f21 | r_zcl_18
(assert (or (not r_p7) (not r_f21) r_zcl_18))
...
;%~r_p13 | ~r_f20 | r_zcl_19
(assert (or (not r_p13) (not r_f20) r_zcl_19))
