;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p0 & (p0 & (p0 & (p0 & p6))))) | ((p0 & (p0 & (p8 & (p0 & (p0 & p7))))) | ((p0 & (p10 & (p11 & (p7 & (p0 & p9))))) | (p0 & (p0 & (p0 & (p13 & (p7 & p12))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~f15 | zcl_12
(assert (or (not l_p8) (not l_f15) l_zcl_12))
...
;%~p7 | ~f22 | zcl_16
(assert (or (not l_p7) (not l_f22) l_zcl_16))
...
;%~p7 | ~p12 | zcl_20
(assert (or (not l_p7) (not l_p12) l_zcl_20))
...
;%~p7 | ~p12 | f27_p
(assert (or (not l_p7) (not l_p12) l_f27_p))
...
;%~p13 | ~f27 | zcl_21
(assert (or (not l_p13) (not l_f27) l_zcl_21))
...
;%~r_p8 | ~r_f15 | r_zcl_12
(assert (or (not r_p8) (not r_f15) r_zcl_12))
...
;%~r_p7 | ~r_f22 | r_zcl_16
(assert (or (not r_p7) (not r_f22) r_zcl_16))
...
;%~r_p7 | ~r_p12 | r_zcl_20
(assert (or (not r_p7) (not r_p12) r_zcl_20))
...
(assert (or (not r_p7) (not r_p12) r_f27_p))
...
;%~r_p13 | ~r_f27 | r_zcl_21
(assert (or (not r_p13) (not r_f27) r_zcl_21))
