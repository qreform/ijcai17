;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & p0) | ((~p3 & p2) | ((~p0 & ~p4) | ((~p4 & p5) | ((p7 & ~p6) | ((~p4 & ~p8) | (p10 & p9))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p4 | f4_p
(assert (or (not l_p0) (not l_p4) l_f4_p))
...
;%~p4 | ~p5 | f6_p
(assert (or (not l_p4) (not l_p5) l_f6_p))
...
;%~p4 | ~p8 | zcl_5
(assert (or (not l_p4) (not l_p8) l_zcl_5))
...
;%~p4 | ~p8 | f10_p
(assert (or (not l_p4) (not l_p8) l_f10_p))
...
;%~p10 | ~p9 | zcl_6
(assert (or (not l_p10) (not l_p9) l_zcl_6))
...
;%~p10 | ~p9 | f11_p
(assert (or (not l_p10) (not l_p9) l_f11_p))
...
(assert (or (not r_p0) (not r_p4) r_f4_p))
...
(assert (or (not r_p4) (not r_p5) r_f6_p))
...
;%~r_p4 | ~r_p8 | r_zcl_5
(assert (or (not r_p4) (not r_p8) r_zcl_5))
...
(assert (or (not r_p4) (not r_p8) r_f10_p))
...
;%~r_p10 | ~r_p9 | r_zcl_6
(assert (or (not r_p10) (not r_p9) r_zcl_6))
...
(assert (or (not r_p10) (not r_p9) r_f11_p))
