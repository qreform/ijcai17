;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p0 & (p0 & p4))) | (p4 & (p6 & (p4 & p5))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p5 | f9_p
(assert (or (not l_p4) (not l_p5) l_f9_p))
...
;%~p6 | ~f9 | zcl_7
(assert (or (not l_p6) (not l_f9) l_zcl_7))
...
;%~p4 | ~f8 | zcl_8
(assert (or (not l_p4) (not l_f8) l_zcl_8))
...
(assert (or (not r_p4) (not r_p5) r_f9_p))
...
;%~r_p6 | ~r_f9 | r_zcl_7
(assert (or (not r_p6) (not r_f9) r_zcl_7))
...
;%~r_p4 | ~r_f8 | r_zcl_8
(assert (or (not r_p4) (not r_f8) r_zcl_8))
