;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p0 & (p0 & (p0 & p5)))) | ((p0 & (p0 & (p0 & (p5 & p6)))) | ((p0 & (p0 & (p0 & (p0 & p7)))) | ((p0 & (p0 & (p5 & (p9 & p8)))) | ((p5 & (p6 & (p6 & (p0 & p10)))) | (p10 & (p0 & (p0 & (p0 & p11)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p6 | zcl_8
(assert (or (not l_p5) (not l_p6) l_zcl_8))
...
;%~p5 | ~p6 | f13_p
(assert (or (not l_p5) (not l_p6) l_f13_p))
...
;%~p0 | ~p11 | f32_p
(assert (or (not l_p0) (not l_p11) l_f32_p))
...
;%~p10 | ~f30 | zcl_27
(assert (or (not l_p10) (not l_f30) l_zcl_27))
...
;%~r_p5 | ~r_p6 | r_zcl_8
(assert (or (not r_p5) (not r_p6) r_zcl_8))
...
(assert (or (not r_p5) (not r_p6) r_f13_p))
...
(assert (or (not r_p0) (not r_p11) r_f32_p))
...
;%~r_p10 | ~r_f30 | r_zcl_27
(assert (or (not r_p10) (not r_f30) r_zcl_27))
