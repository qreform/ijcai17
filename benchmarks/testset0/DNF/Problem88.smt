;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & ~p0)))) | ((~p0 & (~p0 & (p0 & (~p0 & ~p5)))) | (p7 & (~p8 & (p0 & (p9 & ~p6)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~p6 | f12_p
(assert (or (not l_p9) (not l_p6) l_f12_p))
...
;%~p8 | ~f11 | zcl_10
(assert (or (not l_p8) (not l_f11) l_zcl_10))
...
;%~p7 | ~f10 | zcl_11
(assert (or (not l_p7) (not l_f10) l_zcl_11))
...
(assert (or (not r_p9) (not r_p6) r_f12_p))
...
;%~r_p8 | ~r_f11 | r_zcl_10
(assert (or (not r_p8) (not r_f11) r_zcl_10))
...
;%~r_p7 | ~r_f10 | r_zcl_11
(assert (or (not r_p7) (not r_f10) r_zcl_11))
