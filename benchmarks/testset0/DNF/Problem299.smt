;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & (~p4 & (~p5 & ~p0))))) | ((~p7 & (p0 & (p0 & (~p0 & (p0 & ~p6))))) | ((~p0 & (p0 & (~p0 & (~p9 & (~p0 & ~p8))))) | ((~p6 & (p0 & (p0 & (~p11 & (~p0 & ~p10))))) | ((~p0 & (p6 & (~p6 & (p13 & (~p0 & p12))))) | ((~p6 & (~p15 & (~p0 & (~p0 & (~p6 & ~p14))))) | (~p0 & (p17 & (p0 & (~p0 & (~p0 & p16))))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~f16 | zcl_11
(assert (or (not l_p9) (not l_f16) l_zcl_11))
...
;%~p0 | ~p10 | zcl_15
(assert (or (not l_p0) (not l_p10) l_zcl_15))
...
;%~p0 | ~p10 | f22_p
(assert (or (not l_p0) (not l_p10) l_f22_p))
...
;%~p11 | ~f22 | zcl_16
(assert (or (not l_p11) (not l_f22) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p11 | ~f22_p | f21_p
(assert (or (not l_p11) (not l_f22_p) l_f21_p))
...
;%~zcl_19 | p6
(assert (or (not l_zcl_19) l_p6))

;%~zcl_19 | f19
(assert (or (not l_zcl_19) l_f19))

;%~p6 | ~f19 | zcl_19
(assert (or (not l_p6) (not l_f19) l_zcl_19))
...
;%Non-clausified dependency
;%(forall[]((~p6 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p6 | ~f19_p | f18_p
(assert (or (not l_p6) (not l_f19_p) l_f18_p))
...
;%~zcl_22 | p6
(assert (or (not l_zcl_22) l_p6))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p6 | ~f27 | zcl_22
(assert (or (not l_p6) (not l_f27) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((~p6 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p6 | ~f27_p | f26_p
(assert (or (not l_p6) (not l_f27_p) l_f26_p))
...
;%~zcl_23 | p6
(assert (or (not l_zcl_23) l_p6))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p6 | ~f26 | zcl_23
(assert (or (not l_p6) (not l_f26) l_zcl_23))
...
;%~p6 | ~f26_p | f25_p
(assert (or (not l_p6) (not l_f26_p) l_f25_p))
...
;%~p6 | ~p14 | zcl_25
(assert (or (not l_p6) (not l_p14) l_zcl_25))
...
;%~p6 | ~p14 | f34_p
(assert (or (not l_p6) (not l_p14) l_f34_p))
...
;%~zcl_29 | p6
(assert (or (not l_zcl_29) l_p6))

;%~zcl_29 | f31
(assert (or (not l_zcl_29) l_f31))

;%~p6 | ~f31 | zcl_29
(assert (or (not l_p6) (not l_f31) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((~p6 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p6 | ~f31_p | f30_p
(assert (or (not l_p6) (not l_f31_p) l_f30_p))
...
;%~p0 | ~p16 | f39_p
(assert (or (not l_p0) (not l_p16) l_f39_p))
...
;%~zcl_33 | p17
(assert (or (not l_zcl_33) l_p17))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p17 | ~f37 | zcl_33
(assert (or (not l_p17) (not l_f37) l_zcl_33))
...
;%~r_p9 | ~r_f16 | r_zcl_11
(assert (or (not r_p9) (not r_f16) r_zcl_11))
...
;%~r_p0 | ~r_p10 | r_zcl_15
(assert (or (not r_p0) (not r_p10) r_zcl_15))
...
(assert (or (not r_p0) (not r_p10) r_f22_p))
...
;%~r_p11 | ~r_f22 | r_zcl_16
(assert (or (not r_p11) (not r_f22) r_zcl_16))
...
;%~r_p11 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p11) (not r_f22_p) r_f21_p))
...
;%~r_p6 | ~r_f19 | r_zcl_19
(assert (or (not r_p6) (not r_f19) r_zcl_19))
...
;%~r_p6 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p6) (not r_f19_p) r_f18_p))
...
;%~r_p6 | ~r_f27 | r_zcl_22
(assert (or (not r_p6) (not r_f27) r_zcl_22))
...
;%~r_p6 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p6) (not r_f27_p) r_f26_p))


;%~r_zcl_23 | r_p6
(declare-fun r_zcl_23 () Bool)
(assert (or (not r_zcl_23) r_p6))
...
;%~r_p6 | ~r_f26 | r_zcl_23
(assert (or (not r_p6) (not r_f26) r_zcl_23))
...
;%~r_p6 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p6) (not r_f26_p) r_f25_p))
...
;%~r_p6 | ~r_p14 | r_zcl_25
(assert (or (not r_p6) (not r_p14) r_zcl_25))
...
(assert (or (not r_p6) (not r_p14) r_f34_p))
...
;%~r_p6 | ~r_f31 | r_zcl_29
(assert (or (not r_p6) (not r_f31) r_zcl_29))
...
;%~r_p6 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p6) (not r_f31_p) r_f30_p))
...
(assert (or (not r_p0) (not r_p16) r_f39_p))
...
;%~r_p17 | ~r_f37 | r_zcl_33
(assert (or (not r_p17) (not r_f37) r_zcl_33))
