...
;%Non-clausified dependency
;%(forall[]((~p29 & p24) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p29 | ~p24 | f27_p
(assert (or (not l_p29) (not l_p24) l_f27_p))
...
;%~p28 | ~f27 | zcl_21
(assert (or (not l_p28) (not l_f27) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((~p28 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p28 | ~f27_p | f26_p
(assert (or (not l_p28) (not l_f27_p) l_f26_p))
...
;%~p27 | ~f26 | zcl_22
(assert (or (not l_p27) (not l_f26) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((~p27 & f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p27 | ~f26_p | f25_p
(assert (or (not l_p27) (not l_f26_p) l_f25_p))
...
;%~p26 | ~f25 | zcl_23
(assert (or (not l_p26) (not l_f25) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((~p26 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p26 | ~f25_p | f24_p
(assert (or (not l_p26) (not l_f25_p) l_f24_p))
...
;%~zcl_24 | f24
(assert (or (not l_zcl_24) l_f24))

;%~p25 | ~f24 | zcl_24
(assert (or (not l_p25) (not l_f24) l_zcl_24))

(declare-fun l_f23 () Bool)
;%~f23 | zcl_24
(assert (or (not l_f23) l_zcl_24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p25 & f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p25 | ~f24_p | f23_p
(assert (or (not l_p25) (not l_f24_p) l_f23_p))
...
(assert (or (not r_p29) (not r_p24) r_f27_p))
...
;%~r_p28 | ~r_f27 | r_zcl_21
(assert (or (not r_p28) (not r_f27) r_zcl_21))
...
;%~r_p28 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p28) (not r_f27_p) r_f26_p))
...
;%~r_p27 | ~r_f26 | r_zcl_22
(assert (or (not r_p27) (not r_f26) r_zcl_22))
...
;%~r_p27 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p27) (not r_f26_p) r_f25_p))
...
;%~r_p26 | ~r_f25 | r_zcl_23
(assert (or (not r_p26) (not r_f25) r_zcl_23))
...
;%~r_p26 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p26) (not r_f25_p) r_f24_p))
...
;%~r_zcl_24 | r_f24
(assert (or (not r_zcl_24) r_f24))


;%~r_p25 | ~r_f24 | r_zcl_24
(assert (or (not r_p25) (not r_f24) r_zcl_24))


;%~r_f23 | r_zcl_24
(declare-fun r_f23 () Bool)
(assert (or (not r_f23) r_zcl_24))


;%~r_p25 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p25) (not r_f24_p) r_f23_p))
