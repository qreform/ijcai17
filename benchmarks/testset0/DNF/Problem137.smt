;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((~p0 & (p6 & (~p0 & (~p0 & ~p5)))) | ((~p0 & (p5 & (~p0 & (p5 & p7)))) | (~p0 & (~p9 & (p10 & (~p11 & p8))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p11 | ~p8 | zcl_12
(assert (or (not l_p11) (not l_p8) l_zcl_12))
...
;%~p11 | ~p8 | f17_p
(assert (or (not l_p11) (not l_p8) l_f17_p))
...
;%~r_p11 | ~r_p8 | r_zcl_12
(assert (or (not r_p11) (not r_p8) r_zcl_12))
...
(assert (or (not r_p11) (not r_p8) r_f17_p))
