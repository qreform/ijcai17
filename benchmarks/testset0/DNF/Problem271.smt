;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p5 & (p0 & p4))) | ((p0 & (p4 & (p0 & p6))) | ((p0 & (p0 & (p0 & p7))) | ((p4 & (p0 & (p9 & p8))) | ((p0 & (p0 & (p7 & p10))) | (p8 & (p0 & (p12 & p11))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p12 | ~p11 | zcl_18
(assert (or (not l_p12) (not l_p11) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p12 & p11) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p12 | ~p11 | f25_p
(assert (or (not l_p12) (not l_p11) l_f25_p))
...
;%~p8 | ~f24 | zcl_20
(assert (or (not l_p8) (not l_f24) l_zcl_20))
...
;%~r_p12 | ~r_p11 | r_zcl_18
(assert (or (not r_p12) (not r_p11) r_zcl_18))
...
(assert (or (not r_p12) (not r_p11) r_f25_p))
...
;%~r_p8 | ~r_f24 | r_zcl_20
(assert (or (not r_p8) (not r_f24) r_zcl_20))
