;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p7 & (p8 & (p0 & (p0 & p6))))) | ((p10 & (p11 & (p6 & (p0 & (p0 & p9))))) | ((p0 & (p0 & (p13 & (p0 & (p0 & p12))))) | ((p0 & (p0 & (p15 & (p0 & (p0 & p14))))) | ((p12 & (p0 & (p0 & (p9 & (p17 & p16))))) | (p19 & (p20 & (p0 & (p21 & (p16 & p18))))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~f9 | zcl_7
(assert (or (not l_p8) (not l_f9) l_zcl_7))
...
;%~p0 | ~p9 | zcl_10
(assert (or (not l_p0) (not l_p9) l_zcl_10))
...
;%~p0 | ~p9 | f16_p
(assert (or (not l_p0) (not l_p9) l_f16_p))
...
;%~zcl_13 | p11
(assert (or (not l_zcl_13) l_p11))

;%~zcl_13 | f14
(assert (or (not l_zcl_13) l_f14))

;%~p11 | ~f14 | zcl_13
(assert (or (not l_p11) (not l_f14) l_zcl_13))
...
;%~zcl_14 | p10
(assert (or (not l_zcl_14) l_p10))

;%~zcl_14 | f13
(assert (or (not l_zcl_14) l_f13))

;%~p10 | ~f13 | zcl_14
(assert (or (not l_p10) (not l_f13) l_zcl_14))
...
;%Non-clausified dependency
;%(forall[]((p10 & f13_p) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p10 | ~f13_p | f12_p
(assert (or (not l_p10) (not l_f13_p) l_f12_p))
...
;%~p13 | ~f21 | zcl_17
(assert (or (not l_p13) (not l_f21) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((p13 & f21_p) --> f20_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f20_p () Bool)
;%~p13 | ~f21_p | f20_p
(assert (or (not l_p13) (not l_f21_p) l_f20_p))
...
;%~p0 | ~p14 | zcl_20
(assert (or (not l_p0) (not l_p14) l_zcl_20))
...
;%~p0 | ~p14 | f28_p
(assert (or (not l_p0) (not l_p14) l_f28_p))
...
;%~zcl_22 | p15
(assert (or (not l_zcl_22) l_p15))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p15 | ~f27 | zcl_22
(assert (or (not l_p15) (not l_f27) l_zcl_22))
...
;%~p15 | ~f27_p | f26_p
(assert (or (not l_p15) (not l_f27_p) l_f26_p))
...
;%~p17 | ~p16 | zcl_25
(assert (or (not l_p17) (not l_p16) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p17 & p16) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p17 | ~p16 | f34_p
(assert (or (not l_p17) (not l_p16) l_f34_p))
...
;%~zcl_26 | p9
(assert (or (not l_zcl_26) l_p9))

;%~zcl_26 | f34
(assert (or (not l_zcl_26) l_f34))

;%~p9 | ~f34 | zcl_26
(assert (or (not l_p9) (not l_f34) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p9 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p9 | ~f34_p | f33_p
(assert (or (not l_p9) (not l_f34_p) l_f33_p))
...
;%~p0 | ~f33 | zcl_27
(assert (or (not l_p0) (not l_f33) l_zcl_27))
...
;%~zcl_29 | p12
(assert (or (not l_zcl_29) l_p12))

;%~zcl_29 | f31
(assert (or (not l_zcl_29) l_f31))

;%~p12 | ~f31 | zcl_29
(assert (or (not l_p12) (not l_f31) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p12 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p12 | ~f31_p | f30_p
(assert (or (not l_p12) (not l_f31_p) l_f30_p))
...
;%~p16 | ~p18 | zcl_30
(assert (or (not l_p16) (not l_p18) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p16 & p18) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p16 | ~p18 | f39_p
(assert (or (not l_p16) (not l_p18) l_f39_p))
...
;%~zcl_33 | p20
(assert (or (not l_zcl_33) l_p20))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p20 | ~f37 | zcl_33
(assert (or (not l_p20) (not l_f37) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((p20 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p20 | ~f37_p | f36_p
(assert (or (not l_p20) (not l_f37_p) l_f36_p))
...
;%~zcl_34 | p19
(assert (or (not l_zcl_34) l_p19))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p19 | ~f36 | zcl_34
(assert (or (not l_p19) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((p19 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p19 | ~f36_p | f35_p
(assert (or (not l_p19) (not l_f36_p) l_f35_p))
...
;%~r_p8 | ~r_f9 | r_zcl_7
(assert (or (not r_p8) (not r_f9) r_zcl_7))
...
;%~r_p0 | ~r_p9 | r_zcl_10
(assert (or (not r_p0) (not r_p9) r_zcl_10))
...
(assert (or (not r_p0) (not r_p9) r_f16_p))
...
;%~r_p11 | ~r_f14 | r_zcl_13
(assert (or (not r_p11) (not r_f14) r_zcl_13))
...
;%~r_p10 | ~r_f13 | r_zcl_14
(assert (or (not r_p10) (not r_f13) r_zcl_14))
...
;%~r_p10 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p10) (not r_f13_p) r_f12_p))
...
;%~r_p13 | ~r_f21 | r_zcl_17
(assert (or (not r_p13) (not r_f21) r_zcl_17))
...
;%~r_p13 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p13) (not r_f21_p) r_f20_p))
...
;%~r_p0 | ~r_p14 | r_zcl_20
(assert (or (not r_p0) (not r_p14) r_zcl_20))
...
(assert (or (not r_p0) (not r_p14) r_f28_p))
...
;%~r_p15 | ~r_f27 | r_zcl_22
(assert (or (not r_p15) (not r_f27) r_zcl_22))
...
;%~r_p15 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p15) (not r_f27_p) r_f26_p))
...
;%~r_p17 | ~r_p16 | r_zcl_25
(assert (or (not r_p17) (not r_p16) r_zcl_25))
...
(assert (or (not r_p17) (not r_p16) r_f34_p))


;%~r_zcl_26 | r_p9
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p9))
...
;%~r_p9 | ~r_f34 | r_zcl_26
(assert (or (not r_p9) (not r_f34) r_zcl_26))
...
;%~r_p9 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p9) (not r_f34_p) r_f33_p))
...
;%~r_p0 | ~r_f33 | r_zcl_27
(assert (or (not r_p0) (not r_f33) r_zcl_27))
...
;%~r_p12 | ~r_f31 | r_zcl_29
(assert (or (not r_p12) (not r_f31) r_zcl_29))
...
;%~r_p12 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p12) (not r_f31_p) r_f30_p))
...
;%~r_p16 | ~r_p18 | r_zcl_30
(assert (or (not r_p16) (not r_p18) r_zcl_30))
...
(assert (or (not r_p16) (not r_p18) r_f39_p))
...
;%~r_p20 | ~r_f37 | r_zcl_33
(assert (or (not r_p20) (not r_f37) r_zcl_33))
...
;%~r_p20 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p20) (not r_f37_p) r_f36_p))


;%~r_zcl_34 | r_p19
(declare-fun r_zcl_34 () Bool)
(assert (or (not r_zcl_34) r_p19))
...
;%~r_p19 | ~r_f36 | r_zcl_34
(assert (or (not r_p19) (not r_f36) r_zcl_34))
...
;%~r_p19 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p19) (not r_f36_p) r_f35_p))
