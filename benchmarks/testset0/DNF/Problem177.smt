;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (~p3 & ~p0))) | ((~p0 & (~p0 & (~p0 & p4))) | ((~p0 & (~p6 & (~p0 & ~p5))) | ((p8 & (p0 & (~p9 & p7))) | (~p0 & (~p11 & (p0 & p10))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~p7 | zcl_9
(assert (or (not l_p9) (not l_p7) l_zcl_9))
...
;%~r_p9 | ~r_p7 | r_zcl_9
(assert (or (not r_p9) (not r_p7) r_zcl_9))
