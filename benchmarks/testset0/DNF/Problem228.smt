;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (p3 & p0))) | ((~p0 & (p0 & (~p0 & ~p4))) | ((p0 & (~p0 & (~p0 & p5))) | ((~p5 & (~p0 & (~p7 & ~p6))) | ((~p0 & (~p9 & (~p0 & p8))) | (~p0 & (~p11 & (~p0 & ~p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~f13 | zcl_11
(assert (or (not l_p5) (not l_f13) l_zcl_11))
...
;%~p11 | ~f21 | zcl_16
(assert (or (not l_p11) (not l_f21) l_zcl_16))
...
;%~r_p5 | ~r_f13 | r_zcl_11
(assert (or (not r_p5) (not r_f13) r_zcl_11))
...
;%~r_p11 | ~r_f21 | r_zcl_16
(assert (or (not r_p11) (not r_f21) r_zcl_16))
