...
;%~p5 | ~p0 | zcl_0
(assert (or (not l_p5) (not l_p0) l_zcl_0))
...
;%~p5 | ~p0 | f4_p
(assert (or (not l_p5) (not l_p0) l_f4_p))
...
;%~p4 | ~f4 | zcl_1
(assert (or (not l_p4) (not l_f4) l_zcl_1))
...
;%~p3 | ~f3 | zcl_2
(assert (or (not l_p3) (not l_f3) l_zcl_2))
...
;%~zcl_3 | p2
(assert (or (not l_zcl_3) l_p2))

;%~zcl_3 | f2
(assert (or (not l_zcl_3) l_f2))

;%~p2 | ~f2 | zcl_3
(assert (or (not l_p2) (not l_f2) l_zcl_3))
...
;%~zcl_4 | p1
(assert (or (not l_zcl_4) l_p1))

;%~zcl_4 | f1
(assert (or (not l_zcl_4) l_f1))

;%~p1 | ~f1 | zcl_4
(assert (or (not l_p1) (not l_f1) l_zcl_4))
...
;%~zcl_6 | f10
(assert (or (not l_zcl_6) l_f10))

;%~p10 | ~f10 | zcl_6
(assert (or (not l_p10) (not l_f10) l_zcl_6))
...
;%~p9 | ~f9 | zcl_7
(assert (or (not l_p9) (not l_f9) l_zcl_7))
...
;%~zcl_8 | f8
(assert (or (not l_zcl_8) l_f8))

;%~p8 | ~f8 | zcl_8
(assert (or (not l_p8) (not l_f8) l_zcl_8))

(declare-fun l_f7 () Bool)
;%~f7 | zcl_8
(assert (or (not l_f7) l_zcl_8))
...
;%~zcl_9 | f7
(assert (or (not l_zcl_9) l_f7))

;%~p7 | ~f7 | zcl_9
(assert (or (not l_p7) (not l_f7) l_zcl_9))

(declare-fun l_f6 () Bool)
;%~f6 | zcl_9
(assert (or (not l_f6) l_zcl_9))
...
;%~p17 | ~p12 | zcl_10
(assert (or (not l_p17) (not l_p12) l_zcl_10))

(declare-fun l_f16 () Bool)
;%~f16 | zcl_10
(assert (or (not l_f16) l_zcl_10))
...
;%~p17 | ~p12 | f16_p
(assert (or (not l_p17) (not l_p12) l_f16_p))
...
;%~zcl_11 | p16
(assert (or (not l_zcl_11) l_p16))

;%~zcl_11 | f16
(assert (or (not l_zcl_11) l_f16))

;%~p16 | ~f16 | zcl_11
(assert (or (not l_p16) (not l_f16) l_zcl_11))

(declare-fun l_f15 () Bool)
;%~f15 | zcl_11
(assert (or (not l_f15) l_zcl_11))
...
;%~zcl_12 | f15
(assert (or (not l_zcl_12) l_f15))

;%~p15 | ~f15 | zcl_12
(assert (or (not l_p15) (not l_f15) l_zcl_12))

(declare-fun l_f14 () Bool)
;%~f14 | zcl_12
(assert (or (not l_f14) l_zcl_12))
...
;%~p15 | ~f15_p | f14_p
(assert (or (not l_p15) (not l_f15_p) l_f14_p))
...
;%~zcl_13 | p14
(assert (or (not l_zcl_13) l_p14))

;%~zcl_13 | f14
(assert (or (not l_zcl_13) l_f14))

;%~p14 | ~f14 | zcl_13
(assert (or (not l_p14) (not l_f14) l_zcl_13))

(declare-fun l_f13 () Bool)
;%~f13 | zcl_13
(assert (or (not l_f13) l_zcl_13))
...
;%~zcl_14 | p13
(assert (or (not l_zcl_14) l_p13))

;%~zcl_14 | f13
(assert (or (not l_zcl_14) l_f13))

;%~p13 | ~f13 | zcl_14
(assert (or (not l_p13) (not l_f13) l_zcl_14))

(declare-fun l_f12 () Bool)
;%~f12 | zcl_14
(assert (or (not l_f12) l_zcl_14))
...
;%~zcl_15 | p23
(assert (or (not l_zcl_15) l_p23))

(declare-fun l_p18 () Bool)
;%~zcl_15 | p18
(assert (or (not l_zcl_15) l_p18))

;%~p23 | ~p18 | zcl_15
(assert (or (not l_p23) (not l_p18) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((~p23 & ~p18) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p23 | ~p18 | f22_p
(assert (or (not l_p23) (not l_p18) l_f22_p))
...
;%~zcl_16 | p22
(assert (or (not l_zcl_16) l_p22))

;%~zcl_16 | f22
(assert (or (not l_zcl_16) l_f22))

;%~p22 | ~f22 | zcl_16
(assert (or (not l_p22) (not l_f22) l_zcl_16))
...
;%~zcl_17 | p21
(assert (or (not l_zcl_17) l_p21))

;%~zcl_17 | f21
(assert (or (not l_zcl_17) l_f21))

;%~p21 | ~f21 | zcl_17
(assert (or (not l_p21) (not l_f21) l_zcl_17))
...
;%~zcl_18 | p20
(assert (or (not l_zcl_18) l_p20))

;%~zcl_18 | f20
(assert (or (not l_zcl_18) l_f20))

;%~p20 | ~f20 | zcl_18
(assert (or (not l_p20) (not l_f20) l_zcl_18))

(declare-fun l_f19 () Bool)
;%~f19 | zcl_18
(assert (or (not l_f19) l_zcl_18))
...
;%~zcl_19 | p19
(assert (or (not l_zcl_19) l_p19))

;%~zcl_19 | f19
(assert (or (not l_zcl_19) l_f19))

;%~p19 | ~f19 | zcl_19
(assert (or (not l_p19) (not l_f19) l_zcl_19))

(declare-fun l_f18 () Bool)
;%~f18 | zcl_19
(assert (or (not l_f18) l_zcl_19))
...
;%~zcl_20 | p29
(assert (or (not l_zcl_20) l_p29))

(declare-fun l_p24 () Bool)
;%~zcl_20 | p24
(assert (or (not l_zcl_20) l_p24))

;%~p29 | ~p24 | zcl_20
(assert (or (not l_p29) (not l_p24) l_zcl_20))

(declare-fun l_f28 () Bool)
;%~f28 | zcl_20
(assert (or (not l_f28) l_zcl_20))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p29 & p24) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p29 | ~p24 | f28_p
(assert (or (not l_p29) (not l_p24) l_f28_p))
...
;%~zcl_21 | p28
(assert (or (not l_zcl_21) l_p28))

;%~zcl_21 | f28
(assert (or (not l_zcl_21) l_f28))

;%~p28 | ~f28 | zcl_21
(assert (or (not l_p28) (not l_f28) l_zcl_21))

(declare-fun l_f27 () Bool)
;%~f27 | zcl_21
(assert (or (not l_f27) l_zcl_21))
...
;%~zcl_22 | p27
(assert (or (not l_zcl_22) l_p27))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p27 | ~f27 | zcl_22
(assert (or (not l_p27) (not l_f27) l_zcl_22))

(declare-fun l_f26 () Bool)
;%~f26 | zcl_22
(assert (or (not l_f26) l_zcl_22))
...
;%~zcl_23 | p26
(assert (or (not l_zcl_23) l_p26))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p26 | ~f26 | zcl_23
(assert (or (not l_p26) (not l_f26) l_zcl_23))

(declare-fun l_f25 () Bool)
;%~f25 | zcl_23
(assert (or (not l_f25) l_zcl_23))
...
;%~zcl_24 | p25
(assert (or (not l_zcl_24) l_p25))

;%~zcl_24 | f25
(assert (or (not l_zcl_24) l_f25))

;%~p25 | ~f25 | zcl_24
(assert (or (not l_p25) (not l_f25) l_zcl_24))

(declare-fun l_f24 () Bool)
;%~f24 | zcl_24
(assert (or (not l_f24) l_zcl_24))
...
;%~zcl_25 | p35
(assert (or (not l_zcl_25) l_p35))

(declare-fun l_p30 () Bool)
;%~zcl_25 | p30
(assert (or (not l_zcl_25) l_p30))

;%~p35 | ~p30 | zcl_25
(assert (or (not l_p35) (not l_p30) l_zcl_25))

(declare-fun l_f34 () Bool)
;%~f34 | zcl_25
(assert (or (not l_f34) l_zcl_25))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p35 & ~p30) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p35 | ~p30 | f34_p
(assert (or (not l_p35) (not l_p30) l_f34_p))
...
;%~zcl_26 | p34
(assert (or (not l_zcl_26) l_p34))

;%~zcl_26 | f34
(assert (or (not l_zcl_26) l_f34))

;%~p34 | ~f34 | zcl_26
(assert (or (not l_p34) (not l_f34) l_zcl_26))

(declare-fun l_f33 () Bool)
;%~f33 | zcl_26
(assert (or (not l_f33) l_zcl_26))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p34 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p34 | ~f34_p | f33_p
(assert (or (not l_p34) (not l_f34_p) l_f33_p))
...
;%~zcl_27 | p33
(assert (or (not l_zcl_27) l_p33))

;%~zcl_27 | f33
(assert (or (not l_zcl_27) l_f33))

;%~p33 | ~f33 | zcl_27
(assert (or (not l_p33) (not l_f33) l_zcl_27))

(declare-fun l_f32 () Bool)
;%~f32 | zcl_27
(assert (or (not l_f32) l_zcl_27))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p33 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p33 | ~f33_p | f32_p
(assert (or (not l_p33) (not l_f33_p) l_f32_p))
...
;%~zcl_28 | f32
(assert (or (not l_zcl_28) l_f32))

;%~p32 | ~f32 | zcl_28
(assert (or (not l_p32) (not l_f32) l_zcl_28))

(declare-fun l_f31 () Bool)
;%~f31 | zcl_28
(assert (or (not l_f31) l_zcl_28))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p32 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p32 | ~f32_p | f31_p
(assert (or (not l_p32) (not l_f32_p) l_f31_p))
...
;%~zcl_29 | p31
(assert (or (not l_zcl_29) l_p31))

;%~zcl_29 | f31
(assert (or (not l_zcl_29) l_f31))

;%~p31 | ~f31 | zcl_29
(assert (or (not l_p31) (not l_f31) l_zcl_29))

(declare-fun l_f30 () Bool)
;%~f30 | zcl_29
(assert (or (not l_f30) l_zcl_29))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p31 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p31 | ~f31_p | f30_p
(assert (or (not l_p31) (not l_f31_p) l_f30_p))
...
(declare-fun l_p41 () Bool)
;%~zcl_30 | p41
(assert (or (not l_zcl_30) l_p41))

(declare-fun l_p36 () Bool)
;%~zcl_30 | p36
(assert (or (not l_zcl_30) l_p36))

;%~p41 | ~p36 | zcl_30
(assert (or (not l_p41) (not l_p36) l_zcl_30))

(declare-fun l_f39 () Bool)
;%~f39 | zcl_30
(assert (or (not l_f39) l_zcl_30))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p41 & ~p36) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p41 | ~p36 | f39_p
(assert (or (not l_p41) (not l_p36) l_f39_p))
...
(declare-fun l_p40 () Bool)
;%~zcl_31 | p40
(assert (or (not l_zcl_31) l_p40))

;%~zcl_31 | f39
(assert (or (not l_zcl_31) l_f39))

;%~p40 | ~f39 | zcl_31
(assert (or (not l_p40) (not l_f39) l_zcl_31))

(declare-fun l_f38 () Bool)
;%~f38 | zcl_31
(assert (or (not l_f38) l_zcl_31))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p40 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p40 | ~f39_p | f38_p
(assert (or (not l_p40) (not l_f39_p) l_f38_p))
...
;%~zcl_32 | p39
(assert (or (not l_zcl_32) l_p39))

;%~zcl_32 | f38
(assert (or (not l_zcl_32) l_f38))

;%~p39 | ~f38 | zcl_32
(assert (or (not l_p39) (not l_f38) l_zcl_32))

(declare-fun l_f37 () Bool)
;%~f37 | zcl_32
(assert (or (not l_f37) l_zcl_32))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p39 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p39 | ~f38_p | f37_p
(assert (or (not l_p39) (not l_f38_p) l_f37_p))
...
;%~zcl_33 | p38
(assert (or (not l_zcl_33) l_p38))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p38 | ~f37 | zcl_33
(assert (or (not l_p38) (not l_f37) l_zcl_33))

(declare-fun l_f36 () Bool)
;%~f36 | zcl_33
(assert (or (not l_f36) l_zcl_33))
...
;%~zcl_34 | p37
(assert (or (not l_zcl_34) l_p37))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p37 | ~f36 | zcl_34
(assert (or (not l_p37) (not l_f36) l_zcl_34))

(declare-fun l_f35 () Bool)
;%~f35 | zcl_34
(assert (or (not l_f35) l_zcl_34))
...
;%~f29 | f30 | f35
(assert (or (not l_f29) l_f30 l_f35))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((f30_p | f35_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~f30_p | f29_p
(assert (or (not l_f30_p) l_f29_p))

;%~f35_p | f29_p
(assert (or (not l_f35_p) l_f29_p))
...
;%~f17 | f18 | f23
(assert (or (not l_f17) l_f18 l_f23))
...
;%~l_p40 | r_p40
(declare-fun r_p40 () Bool)
(assert (or (not l_p40) r_p40))


;%~l_p41 | r_p41
(declare-fun r_p41 () Bool)
(assert (or (not l_p41) r_p41))
...
;%~r_p5 | ~r_p0 | r_zcl_0
(assert (or (not r_p5) (not r_p0) r_zcl_0))
...
(assert (or (not r_p5) (not r_p0) r_f4_p))
...
;%~r_p4 | ~r_f4 | r_zcl_1
(assert (or (not r_p4) (not r_f4) r_zcl_1))
...
;%~r_p3 | ~r_f3 | r_zcl_2
(assert (or (not r_p3) (not r_f3) r_zcl_2))
...
;%~r_p2 | ~r_f2 | r_zcl_3
(assert (or (not r_p2) (not r_f2) r_zcl_3))
...
;%~r_p1 | ~r_f1 | r_zcl_4
(assert (or (not r_p1) (not r_f1) r_zcl_4))
...
;%~r_zcl_6 | r_f10
(assert (or (not r_zcl_6) r_f10))


;%~r_p10 | ~r_f10 | r_zcl_6
(assert (or (not r_p10) (not r_f10) r_zcl_6))
...
;%~r_p9 | ~r_f9 | r_zcl_7
(assert (or (not r_p9) (not r_f9) r_zcl_7))
...
;%~r_zcl_8 | r_f8
(assert (or (not r_zcl_8) r_f8))


;%~r_p8 | ~r_f8 | r_zcl_8
(assert (or (not r_p8) (not r_f8) r_zcl_8))


;%~r_f7 | r_zcl_8
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_zcl_8))
...
;%~r_zcl_9 | r_f7
(assert (or (not r_zcl_9) r_f7))


;%~r_p7 | ~r_f7 | r_zcl_9
(assert (or (not r_p7) (not r_f7) r_zcl_9))


;%~r_f6 | r_zcl_9
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_zcl_9))
...
;%~r_p17 | ~r_p12 | r_zcl_10
(assert (or (not r_p17) (not r_p12) r_zcl_10))


;%~r_f16 | r_zcl_10
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_zcl_10))


;%~r_p17 | ~r_p12 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p17) (not r_p12) r_f16_p))


;%~r_zcl_11 | r_p16
(declare-fun r_zcl_11 () Bool)
(assert (or (not r_zcl_11) r_p16))


;%~r_zcl_11 | r_f16
(assert (or (not r_zcl_11) r_f16))


;%~r_p16 | ~r_f16 | r_zcl_11
(assert (or (not r_p16) (not r_f16) r_zcl_11))


;%~r_f15 | r_zcl_11
(declare-fun r_f15 () Bool)
(assert (or (not r_f15) r_zcl_11))
...
;%~r_zcl_12 | r_f15
(assert (or (not r_zcl_12) r_f15))


;%~r_p15 | ~r_f15 | r_zcl_12
(assert (or (not r_p15) (not r_f15) r_zcl_12))


;%~r_f14 | r_zcl_12
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_zcl_12))


;%~r_p15 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p15) (not r_f15_p) r_f14_p))


;%~r_zcl_13 | r_p14
(declare-fun r_zcl_13 () Bool)
(assert (or (not r_zcl_13) r_p14))


;%~r_zcl_13 | r_f14
(assert (or (not r_zcl_13) r_f14))


;%~r_p14 | ~r_f14 | r_zcl_13
(assert (or (not r_p14) (not r_f14) r_zcl_13))


;%~r_f13 | r_zcl_13
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_zcl_13))
...
(assert (or (not r_zcl_14) r_p13))


;%~r_zcl_14 | r_f13
(assert (or (not r_zcl_14) r_f13))


;%~r_p13 | ~r_f13 | r_zcl_14
(assert (or (not r_p13) (not r_f13) r_zcl_14))


;%~r_f12 | r_zcl_14
(declare-fun r_f12 () Bool)
(assert (or (not r_f12) r_zcl_14))
...
(assert (or (not r_zcl_15) r_p23))


;%~r_zcl_15 | r_p18
(assert (or (not r_zcl_15) r_p18))


;%~r_p23 | ~r_p18 | r_zcl_15
(assert (or (not r_p23) (not r_p18) r_zcl_15))
...
(assert (or (not r_p23) (not r_p18) r_f22_p))


;%~r_zcl_16 | r_p22
(declare-fun r_zcl_16 () Bool)
(assert (or (not r_zcl_16) r_p22))
...
;%~r_p22 | ~r_f22 | r_zcl_16
(assert (or (not r_p22) (not r_f22) r_zcl_16))
...
;%~r_p21 | ~r_f21 | r_zcl_17
(assert (or (not r_p21) (not r_f21) r_zcl_17))
...
;%~r_p20 | ~r_f20 | r_zcl_18
(assert (or (not r_p20) (not r_f20) r_zcl_18))


;%~r_f19 | r_zcl_18
(declare-fun r_f19 () Bool)
(assert (or (not r_f19) r_zcl_18))
...
(assert (or (not r_zcl_19) r_p19))


;%~r_zcl_19 | r_f19
(assert (or (not r_zcl_19) r_f19))


;%~r_p19 | ~r_f19 | r_zcl_19
(assert (or (not r_p19) (not r_f19) r_zcl_19))


;%~r_f18 | r_zcl_19
(declare-fun r_f18 () Bool)
(assert (or (not r_f18) r_zcl_19))
...
(assert (or (not r_zcl_20) r_p29))


;%~r_zcl_20 | r_p24
(assert (or (not r_zcl_20) r_p24))


;%~r_p29 | ~r_p24 | r_zcl_20
(assert (or (not r_p29) (not r_p24) r_zcl_20))


;%~r_f28 | r_zcl_20
(declare-fun r_f28 () Bool)
(assert (or (not r_f28) r_zcl_20))


;%~r_p29 | ~r_p24 | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p29) (not r_p24) r_f28_p))


;%~r_zcl_21 | r_p28
(declare-fun r_zcl_21 () Bool)
(assert (or (not r_zcl_21) r_p28))


;%~r_zcl_21 | r_f28
(assert (or (not r_zcl_21) r_f28))


;%~r_p28 | ~r_f28 | r_zcl_21
(assert (or (not r_p28) (not r_f28) r_zcl_21))


;%~r_f27 | r_zcl_21
(declare-fun r_f27 () Bool)
(assert (or (not r_f27) r_zcl_21))
...
(assert (or (not r_zcl_22) r_p27))


;%~r_zcl_22 | r_f27
(assert (or (not r_zcl_22) r_f27))


;%~r_p27 | ~r_f27 | r_zcl_22
(assert (or (not r_p27) (not r_f27) r_zcl_22))


;%~r_f26 | r_zcl_22
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_zcl_22))
...
(assert (or (not r_zcl_23) r_p26))


;%~r_zcl_23 | r_f26
(assert (or (not r_zcl_23) r_f26))


;%~r_p26 | ~r_f26 | r_zcl_23
(assert (or (not r_p26) (not r_f26) r_zcl_23))


;%~r_f25 | r_zcl_23
(declare-fun r_f25 () Bool)
(assert (or (not r_f25) r_zcl_23))
...
(assert (or (not r_zcl_24) r_p25))


;%~r_zcl_24 | r_f25
(assert (or (not r_zcl_24) r_f25))


;%~r_p25 | ~r_f25 | r_zcl_24
(assert (or (not r_p25) (not r_f25) r_zcl_24))


;%~r_f24 | r_zcl_24
(declare-fun r_f24 () Bool)
(assert (or (not r_f24) r_zcl_24))
...
(assert (or (not r_zcl_25) r_p35))


;%~r_zcl_25 | r_p30
(assert (or (not r_zcl_25) r_p30))


;%~r_p35 | ~r_p30 | r_zcl_25
(assert (or (not r_p35) (not r_p30) r_zcl_25))


;%~r_f34 | r_zcl_25
(declare-fun r_f34 () Bool)
(assert (or (not r_f34) r_zcl_25))


;%~r_p35 | ~r_p30 | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p35) (not r_p30) r_f34_p))


;%~r_zcl_26 | r_p34
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p34))


;%~r_zcl_26 | r_f34
(assert (or (not r_zcl_26) r_f34))


;%~r_p34 | ~r_f34 | r_zcl_26
(assert (or (not r_p34) (not r_f34) r_zcl_26))


;%~r_f33 | r_zcl_26
(declare-fun r_f33 () Bool)
(assert (or (not r_f33) r_zcl_26))


;%~r_p34 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p34) (not r_f34_p) r_f33_p))


;%~r_zcl_27 | r_p33
(declare-fun r_zcl_27 () Bool)
(assert (or (not r_zcl_27) r_p33))


;%~r_zcl_27 | r_f33
(assert (or (not r_zcl_27) r_f33))


;%~r_p33 | ~r_f33 | r_zcl_27
(assert (or (not r_p33) (not r_f33) r_zcl_27))


;%~r_f32 | r_zcl_27
(declare-fun r_f32 () Bool)
(assert (or (not r_f32) r_zcl_27))


;%~r_p33 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p33) (not r_f33_p) r_f32_p))
...
;%~r_zcl_28 | r_f32
(assert (or (not r_zcl_28) r_f32))


;%~r_p32 | ~r_f32 | r_zcl_28
(assert (or (not r_p32) (not r_f32) r_zcl_28))


;%~r_f31 | r_zcl_28
(declare-fun r_f31 () Bool)
(assert (or (not r_f31) r_zcl_28))


;%~r_p32 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p32) (not r_f32_p) r_f31_p))


;%~r_zcl_29 | r_p31
(declare-fun r_zcl_29 () Bool)
(assert (or (not r_zcl_29) r_p31))


;%~r_zcl_29 | r_f31
(assert (or (not r_zcl_29) r_f31))


;%~r_p31 | ~r_f31 | r_zcl_29
(assert (or (not r_p31) (not r_f31) r_zcl_29))


;%~r_f30 | r_zcl_29
(declare-fun r_f30 () Bool)
(assert (or (not r_f30) r_zcl_29))


;%~r_p31 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p31) (not r_f31_p) r_f30_p))


;%~r_zcl_30 | r_p41
(declare-fun r_zcl_30 () Bool)
(assert (or (not r_zcl_30) r_p41))


;%~r_zcl_30 | r_p36
(assert (or (not r_zcl_30) r_p36))


;%~r_p41 | ~r_p36 | r_zcl_30
(assert (or (not r_p41) (not r_p36) r_zcl_30))


;%~r_f39 | r_zcl_30
(declare-fun r_f39 () Bool)
(assert (or (not r_f39) r_zcl_30))


;%~r_p41 | ~r_p36 | r_f39_p
(declare-fun r_f39_p () Bool)
(assert (or (not r_p41) (not r_p36) r_f39_p))


;%~r_zcl_31 | r_p40
(declare-fun r_zcl_31 () Bool)
(assert (or (not r_zcl_31) r_p40))


;%~r_zcl_31 | r_f39
(assert (or (not r_zcl_31) r_f39))


;%~r_p40 | ~r_f39 | r_zcl_31
(assert (or (not r_p40) (not r_f39) r_zcl_31))


;%~r_f38 | r_zcl_31
(declare-fun r_f38 () Bool)
(assert (or (not r_f38) r_zcl_31))


;%~r_p40 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p40) (not r_f39_p) r_f38_p))


;%~r_zcl_32 | r_p39
(declare-fun r_zcl_32 () Bool)
(assert (or (not r_zcl_32) r_p39))


;%~r_zcl_32 | r_f38
(assert (or (not r_zcl_32) r_f38))


;%~r_p39 | ~r_f38 | r_zcl_32
(assert (or (not r_p39) (not r_f38) r_zcl_32))


;%~r_f37 | r_zcl_32
(declare-fun r_f37 () Bool)
(assert (or (not r_f37) r_zcl_32))


;%~r_p39 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p39) (not r_f38_p) r_f37_p))


;%~r_zcl_33 | r_p38
(declare-fun r_zcl_33 () Bool)
(assert (or (not r_zcl_33) r_p38))


;%~r_zcl_33 | r_f37
(assert (or (not r_zcl_33) r_f37))


;%~r_p38 | ~r_f37 | r_zcl_33
(assert (or (not r_p38) (not r_f37) r_zcl_33))


;%~r_f36 | r_zcl_33
(declare-fun r_f36 () Bool)
(assert (or (not r_f36) r_zcl_33))
...
(assert (or (not r_zcl_34) r_p37))


;%~r_zcl_34 | r_f36
(assert (or (not r_zcl_34) r_f36))


;%~r_p37 | ~r_f36 | r_zcl_34
(assert (or (not r_p37) (not r_f36) r_zcl_34))


;%~r_f35 | r_zcl_34
(declare-fun r_f35 () Bool)
(assert (or (not r_f35) r_zcl_34))
...
(assert (or (not r_f29) r_f30 r_f35))


;%~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_f30_p) r_f29_p))


;%~r_f35_p | r_f29_p
(assert (or (not r_f35_p) r_f29_p))
...
(assert (or (not r_f17) r_f18 r_f23))
