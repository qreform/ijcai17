;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & p0)) | ((~p4 & (p0 & p3)) | ((~p3 & (p0 & ~p5)) | ((~p0 & (p0 & p6)) | ((p8 & (~p0 & ~p7)) | ((~p10 & (~p11 & ~p9)) | (~p13 & (p5 & ~p12)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p12 | zcl_12
(assert (or (not l_p5) (not l_p12) l_zcl_12))
...
;%~p5 | ~p12 | f18_p
(assert (or (not l_p5) (not l_p12) l_f18_p))
...
;%~p13 | ~f18 | zcl_13
(assert (or (not l_p13) (not l_f18) l_zcl_13))
...
;%~r_p5 | ~r_p12 | r_zcl_12
(assert (or (not r_p5) (not r_p12) r_zcl_12))
...
(assert (or (not r_p5) (not r_p12) r_f18_p))
...
;%~r_p13 | ~r_f18 | r_zcl_13
(assert (or (not r_p13) (not r_f18) r_zcl_13))
