;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & p0)) | ((~p0 & (p0 & ~p3)) | ((~p3 & (~p5 & ~p4)) | ((p0 & (~p7 & ~p6)) | ((p3 & (p9 & ~p8)) | ((~p11 & (p12 & p10)) | (~p3 & (~p3 & p13)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p4 | zcl_4
(assert (or (not l_p5) (not l_p4) l_zcl_4))
...
;%~p5 | ~p4 | f7_p
(assert (or (not l_p5) (not l_p4) l_f7_p))
...
;%~p9 | ~p8 | zcl_8
(assert (or (not l_p9) (not l_p8) l_zcl_8))
...
;%~p12 | ~p10 | zcl_10
(assert (or (not l_p12) (not l_p10) l_zcl_10))
...
;%Non-clausified dependency
;%(forall[]((p12 & p10) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p12 | ~p10 | f16_p
(assert (or (not l_p12) (not l_p10) l_f16_p))
...
;%~p3 | ~p13 | zcl_12
(assert (or (not l_p3) (not l_p13) l_zcl_12))
...
;%~p3 | ~p13 | f18_p
(assert (or (not l_p3) (not l_p13) l_f18_p))
...
;%~r_p5 | ~r_p4 | r_zcl_4
(assert (or (not r_p5) (not r_p4) r_zcl_4))
...
(assert (or (not r_p5) (not r_p4) r_f7_p))
...
;%~r_p9 | ~r_p8 | r_zcl_8
(assert (or (not r_p9) (not r_p8) r_zcl_8))
...
;%~r_p12 | ~r_p10 | r_zcl_10
(assert (or (not r_p12) (not r_p10) r_zcl_10))
...
(assert (or (not r_p12) (not r_p10) r_f16_p))
...
;%~r_p3 | ~r_p13 | r_zcl_12
(assert (or (not r_p3) (not r_p13) r_zcl_12))
...
(assert (or (not r_p3) (not r_p13) r_f18_p))
