;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p0 & (p0 & p4))) | ((p0 & (p6 & (p7 & p5))) | ((p9 & (p0 & (p5 & p8))) | ((p5 & (p0 & (p0 & p10))) | (p12 & (p0 & (p8 & p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p8 | zcl_9
(assert (or (not l_p5) (not l_p8) l_zcl_9))
...
;%~p5 | ~p8 | f14_p
(assert (or (not l_p5) (not l_p8) l_f14_p))
...
;%~p8 | ~p11 | f21_p
(assert (or (not l_p8) (not l_p11) l_f21_p))
...
;%~r_p5 | ~r_p8 | r_zcl_9
(assert (or (not r_p5) (not r_p8) r_zcl_9))
...
(assert (or (not r_p5) (not r_p8) r_f14_p))
...
(assert (or (not r_p8) (not r_p11) r_f21_p))
