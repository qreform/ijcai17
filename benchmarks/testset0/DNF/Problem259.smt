;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & p0) | ((~p3 & p2) | ((p0 & ~p4) | ((~p6 & ~p5) | ((~p4 & p7) | ((~p5 & ~p8) | (~p7 & ~p9))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~p5 | f6_p
(assert (or (not l_p6) (not l_p5) l_f6_p))
...
;%~p5 | ~p8 | f10_p
(assert (or (not l_p5) (not l_p8) l_f10_p))
...
;%~p7 | ~p9 | zcl_6
(assert (or (not l_p7) (not l_p9) l_zcl_6))
...
;%~p7 | ~p9 | f11_p
(assert (or (not l_p7) (not l_p9) l_f11_p))
...
(assert (or (not r_p6) (not r_p5) r_f6_p))
...
(assert (or (not r_p5) (not r_p8) r_f10_p))
...
;%~r_p7 | ~r_p9 | r_zcl_6
(assert (or (not r_p7) (not r_p9) r_zcl_6))
...
(assert (or (not r_p7) (not r_p9) r_f11_p))
