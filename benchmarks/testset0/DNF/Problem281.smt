;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p0 & (p6 & (p0 & p5)))) | ((p0 & (p0 & (p8 & (p0 & p7)))) | ((p7 & (p0 & (p0 & (p10 & p9)))) | ((p0 & (p0 & (p12 & (p0 & p11)))) | ((p14 & (p15 & (p7 & (p16 & p13)))) | (p18 & (p13 & (p0 & (p19 & p17)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~f8 | zcl_5
(assert (or (not l_p6) (not l_f8) l_zcl_5))
...
;%~p0 | ~p7 | zcl_8
(assert (or (not l_p0) (not l_p7) l_zcl_8))
...
;%~p0 | ~p7 | f13_p
(assert (or (not l_p0) (not l_p7) l_f13_p))
...
;%~p10 | ~p9 | f18_p
(assert (or (not l_p10) (not l_p9) l_f18_p))
...
;%~p0 | ~f17 | zcl_14
(assert (or (not l_p0) (not l_f17) l_zcl_14))
...
;%~p7 | ~f16 | zcl_15
(assert (or (not l_p7) (not l_f16) l_zcl_15))
...
;%~p12 | ~f23 | zcl_17
(assert (or (not l_p12) (not l_f23) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((p12 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p12 | ~f23_p | f22_p
(assert (or (not l_p12) (not l_f23_p) l_f22_p))
...
;%~p16 | ~p13 | zcl_20
(assert (or (not l_p16) (not l_p13) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p16 & p13) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p16 | ~p13 | f28_p
(assert (or (not l_p16) (not l_p13) l_f28_p))
...
;%~p7 | ~f28 | zcl_21
(assert (or (not l_p7) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p7 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p7 | ~f28_p | f27_p
(assert (or (not l_p7) (not l_f28_p) l_f27_p))
...
;%~zcl_23 | p14
(assert (or (not l_zcl_23) l_p14))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p14 | ~f26 | zcl_23
(assert (or (not l_p14) (not l_f26) l_zcl_23))
...
;%~p19 | ~p17 | zcl_24
(assert (or (not l_p19) (not l_p17) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p19 & p17) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p19 | ~p17 | f32_p
(assert (or (not l_p19) (not l_p17) l_f32_p))
...
;%~p0 | ~f32 | zcl_25
(assert (or (not l_p0) (not l_f32) l_zcl_25))
...
;%~p13 | ~f31 | zcl_26
(assert (or (not l_p13) (not l_f31) l_zcl_26))
...
;%~zcl_27 | p18
(assert (or (not l_zcl_27) l_p18))

;%~zcl_27 | f30
(assert (or (not l_zcl_27) l_f30))

;%~p18 | ~f30 | zcl_27
(assert (or (not l_p18) (not l_f30) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p18 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p18 | ~f30_p | f29_p
(assert (or (not l_p18) (not l_f30_p) l_f29_p))
...
;%~r_p6 | ~r_f8 | r_zcl_5
(assert (or (not r_p6) (not r_f8) r_zcl_5))
...
;%~r_p0 | ~r_p7 | r_zcl_8
(assert (or (not r_p0) (not r_p7) r_zcl_8))
...
(assert (or (not r_p0) (not r_p7) r_f13_p))
...
(assert (or (not r_p10) (not r_p9) r_f18_p))
...
;%~r_p0 | ~r_f17 | r_zcl_14
(assert (or (not r_p0) (not r_f17) r_zcl_14))
...
;%~r_p7 | ~r_f16 | r_zcl_15
(assert (or (not r_p7) (not r_f16) r_zcl_15))
...
;%~r_p12 | ~r_f23 | r_zcl_17
(assert (or (not r_p12) (not r_f23) r_zcl_17))
...
;%~r_p12 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p12) (not r_f23_p) r_f22_p))
...
;%~r_p16 | ~r_p13 | r_zcl_20
(assert (or (not r_p16) (not r_p13) r_zcl_20))
...
(assert (or (not r_p16) (not r_p13) r_f28_p))
...
;%~r_p7 | ~r_f28 | r_zcl_21
(assert (or (not r_p7) (not r_f28) r_zcl_21))
...
;%~r_p7 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p7) (not r_f28_p) r_f27_p))
...
;%~r_p14 | ~r_f26 | r_zcl_23
(assert (or (not r_p14) (not r_f26) r_zcl_23))
...
;%~r_p19 | ~r_p17 | r_zcl_24
(assert (or (not r_p19) (not r_p17) r_zcl_24))
...
(assert (or (not r_p19) (not r_p17) r_f32_p))
...
;%~r_p0 | ~r_f32 | r_zcl_25
(assert (or (not r_p0) (not r_f32) r_zcl_25))
...
;%~r_p13 | ~r_f31 | r_zcl_26
(assert (or (not r_p13) (not r_f31) r_zcl_26))
...
;%~r_p18 | ~r_f30 | r_zcl_27
(assert (or (not r_p18) (not r_f30) r_zcl_27))
...
;%~r_p18 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p18) (not r_f30_p) r_f29_p))
