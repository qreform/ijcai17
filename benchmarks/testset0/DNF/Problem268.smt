;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & ~p0)) | ((p0 & (p0 & ~p3)) | ((p5 & (p6 & p4)) | ((~p3 & (p0 & ~p7)) | ((p9 & (~p10 & p8)) | ((~p0 & (~p3 & ~p11)) | (p11 & (~p7 & ~p12)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~p4 | zcl_4
(assert (or (not l_p6) (not l_p4) l_zcl_4))
...
;%~p6 | ~p4 | f7_p
(assert (or (not l_p6) (not l_p4) l_f7_p))
...
;%~p0 | ~p7 | f10_p
(assert (or (not l_p0) (not l_p7) l_f10_p))
...
;%~p10 | ~p8 | zcl_8
(assert (or (not l_p10) (not l_p8) l_zcl_8))
...
;%~p10 | ~p8 | f13_p
(assert (or (not l_p10) (not l_p8) l_f13_p))
...
;%~p3 | ~p11 | zcl_10
(assert (or (not l_p3) (not l_p11) l_zcl_10))
...
;%~p3 | ~p11 | f16_p
(assert (or (not l_p3) (not l_p11) l_f16_p))
...
;%~p7 | ~p12 | zcl_12
(assert (or (not l_p7) (not l_p12) l_zcl_12))
...
;%~p7 | ~p12 | f18_p
(assert (or (not l_p7) (not l_p12) l_f18_p))
...
;%~r_p6 | ~r_p4 | r_zcl_4
(assert (or (not r_p6) (not r_p4) r_zcl_4))
...
(assert (or (not r_p6) (not r_p4) r_f7_p))
...
(assert (or (not r_p0) (not r_p7) r_f10_p))
...
;%~r_p10 | ~r_p8 | r_zcl_8
(assert (or (not r_p10) (not r_p8) r_zcl_8))
...
(assert (or (not r_p10) (not r_p8) r_f13_p))
...
;%~r_p3 | ~r_p11 | r_zcl_10
(assert (or (not r_p3) (not r_p11) r_zcl_10))
...
(assert (or (not r_p3) (not r_p11) r_f16_p))
...
;%~r_p7 | ~r_p12 | r_zcl_12
(assert (or (not r_p7) (not r_p12) r_zcl_12))
...
(assert (or (not r_p7) (not r_p12) r_f18_p))
