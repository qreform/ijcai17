;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (p3 & (p4 & p0)))) | ((p0 & (p0 & (p6 & (~p0 & p5)))) | (p8 & (p0 & (~p9 & (~p10 & ~p7)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~f12 | zcl_9
(assert (or (not l_p9) (not l_f12) l_zcl_9))
...
;%~zcl_10 | f11
(assert (or (not l_zcl_10) l_f11))

;%~p0 | ~f11 | zcl_10
(assert (or (not l_p0) (not l_f11) l_zcl_10))

(declare-fun l_f10 () Bool)
;%~f10 | zcl_10
(assert (or (not l_f10) l_zcl_10))
...
;%~zcl_11 | f10
(assert (or (not l_zcl_11) l_f10))

;%~p8 | ~f10 | zcl_11
(assert (or (not l_p8) (not l_f10) l_zcl_11))

(declare-fun l_f9 () Bool)
;%~f9 | zcl_11
(assert (or (not l_f9) l_zcl_11))
...
;%~r_p9 | ~r_f12 | r_zcl_9
(assert (or (not r_p9) (not r_f12) r_zcl_9))
...
;%~r_zcl_10 | r_f11
(assert (or (not r_zcl_10) r_f11))


;%~r_p0 | ~r_f11 | r_zcl_10
(assert (or (not r_p0) (not r_f11) r_zcl_10))


;%~r_f10 | r_zcl_10
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_zcl_10))
...
;%~r_zcl_11 | r_f10
(assert (or (not r_zcl_11) r_f10))


;%~r_p8 | ~r_f10 | r_zcl_11
(assert (or (not r_p8) (not r_f10) r_zcl_11))


;%~r_f9 | r_zcl_11
(declare-fun r_f9 () Bool)
(assert (or (not r_f9) r_zcl_11))
