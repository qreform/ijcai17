...
;%~p9 | ~p5 | f7_p
(assert (or (not l_p9) (not l_p5) l_f7_p))
...
;%~p8 | ~f7 | zcl_5
(assert (or (not l_p8) (not l_f7) l_zcl_5))
...
;%~p7 | ~f6 | zcl_6
(assert (or (not l_p7) (not l_f6) l_zcl_6))
...
;%~zcl_7 | f5
(assert (or (not l_zcl_7) l_f5))

;%~p6 | ~f5 | zcl_7
(assert (or (not l_p6) (not l_f5) l_zcl_7))

(declare-fun l_f4 () Bool)
;%~f4 | zcl_7
(assert (or (not l_f4) l_zcl_7))
...
(assert (or (not r_p9) (not r_p5) r_f7_p))
...
;%~r_p8 | ~r_f7 | r_zcl_5
(assert (or (not r_p8) (not r_f7) r_zcl_5))
...
;%~r_p7 | ~r_f6 | r_zcl_6
(assert (or (not r_p7) (not r_f6) r_zcl_6))
...
;%~r_zcl_7 | r_f5
(assert (or (not r_zcl_7) r_f5))


;%~r_p6 | ~r_f5 | r_zcl_7
(assert (or (not r_p6) (not r_f5) r_zcl_7))


;%~r_f4 | r_zcl_7
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_zcl_7))
