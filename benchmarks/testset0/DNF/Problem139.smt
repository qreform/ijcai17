;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (p2 & (~p3 & (p4 & ~p0)))) | ((p0 & (p0 & (p0 & (~p0 & p5)))) | ((~p0 & (~p0 & (p0 & (p5 & p6)))) | (p0 & (p0 & (~p8 & (~p0 & p7))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p7 | f17_p
(assert (or (not l_p0) (not l_p7) l_f17_p))
...
;%~p8 | ~f17 | zcl_13
(assert (or (not l_p8) (not l_f17) l_zcl_13))
...
(assert (or (not r_p0) (not r_p7) r_f17_p))
...
;%~r_p8 | ~r_f17 | r_zcl_13
(assert (or (not r_p8) (not r_f17) r_zcl_13))
