;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (~p3 & p0))) | ((p0 & (p0 & (~p5 & ~p4))) | ((~p4 & (~p0 & (~p0 & ~p6))) | ((~p0 & (~p0 & (~p4 & ~p7))) | ((~p4 & (p0 & (p6 & ~p8))) | ((p7 & (~p0 & (~p8 & ~p9))) | (p7 & (~p4 & (~p4 & ~p10))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p4 | zcl_3
(assert (or (not l_p5) (not l_p4) l_zcl_3))
...
;%~p4 | ~f9 | zcl_8
(assert (or (not l_p4) (not l_f9) l_zcl_8))
...
;%~p4 | ~f9_p | f8_p
(assert (or (not l_p4) (not l_f9_p) l_f8_p))
...
;%~p4 | ~p7 | zcl_9
(assert (or (not l_p4) (not l_p7) l_zcl_9))
...
;%~p4 | ~p7 | f14_p
(assert (or (not l_p4) (not l_p7) l_f14_p))
...
;%~p6 | ~p8 | zcl_12
(assert (or (not l_p6) (not l_p8) l_zcl_12))
...
;%~p6 | ~p8 | f18_p
(assert (or (not l_p6) (not l_p8) l_f18_p))
...
;%~p8 | ~p9 | zcl_15
(assert (or (not l_p8) (not l_p9) l_zcl_15))
...
;%~p8 | ~p9 | f22_p
(assert (or (not l_p8) (not l_p9) l_f22_p))
...
;%~p4 | ~p10 | zcl_18
(assert (or (not l_p4) (not l_p10) l_zcl_18))
...
;%~p4 | ~p10 | f25_p
(assert (or (not l_p4) (not l_p10) l_f25_p))
...
;%~zcl_19 | p4
(assert (or (not l_zcl_19) l_p4))

;%~zcl_19 | f25
(assert (or (not l_zcl_19) l_f25))

;%~p4 | ~f25 | zcl_19
(assert (or (not l_p4) (not l_f25) l_zcl_19))
...
;%Non-clausified dependency
;%(forall[]((~p4 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p4 | ~f25_p | f24_p
(assert (or (not l_p4) (not l_f25_p) l_f24_p))
...
;%~p7 | ~f24 | zcl_20
(assert (or (not l_p7) (not l_f24) l_zcl_20))
...
;%~r_p5 | ~r_p4 | r_zcl_3
(assert (or (not r_p5) (not r_p4) r_zcl_3))
...
;%~r_p4 | ~r_f9 | r_zcl_8
(assert (or (not r_p4) (not r_f9) r_zcl_8))
...
(assert (or (not r_p4) (not r_f9_p) r_f8_p))


;%~r_zcl_9 | r_p4
(declare-fun r_zcl_9 () Bool)
(assert (or (not r_zcl_9) r_p4))
...
;%~r_p4 | ~r_p7 | r_zcl_9
(assert (or (not r_p4) (not r_p7) r_zcl_9))
...
(assert (or (not r_p4) (not r_p7) r_f14_p))
...
;%~r_p6 | ~r_p8 | r_zcl_12
(assert (or (not r_p6) (not r_p8) r_zcl_12))
...
(assert (or (not r_p6) (not r_p8) r_f18_p))
...
;%~r_p8 | ~r_p9 | r_zcl_15
(assert (or (not r_p8) (not r_p9) r_zcl_15))
...
(assert (or (not r_p8) (not r_p9) r_f22_p))
...
;%~r_p4 | ~r_p10 | r_zcl_18
(assert (or (not r_p4) (not r_p10) r_zcl_18))
...
(assert (or (not r_p4) (not r_p10) r_f25_p))


;%~r_zcl_19 | r_p4
(declare-fun r_zcl_19 () Bool)
(assert (or (not r_zcl_19) r_p4))
...
;%~r_p4 | ~r_f25 | r_zcl_19
(assert (or (not r_p4) (not r_f25) r_zcl_19))
...
;%~r_p4 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p4) (not r_f25_p) r_f24_p))
...
;%~r_p7 | ~r_f24 | r_zcl_20
(assert (or (not r_p7) (not r_f24) r_zcl_20))
