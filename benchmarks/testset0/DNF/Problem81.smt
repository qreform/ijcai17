;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p6 & (p0 & (p7 & p5)))) | (p5 & (p5 & (p0 & (p0 & p8)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p8 | f12_p
(assert (or (not l_p0) (not l_p8) l_f12_p))
...
;%~p0 | ~f12 | zcl_9
(assert (or (not l_p0) (not l_f12) l_zcl_9))
...
;%~p5 | ~f11 | zcl_10
(assert (or (not l_p5) (not l_f11) l_zcl_10))
...
;%~p5 | ~f10 | zcl_11
(assert (or (not l_p5) (not l_f10) l_zcl_11))
...
(assert (or (not r_p0) (not r_p8) r_f12_p))
...
;%~r_p0 | ~r_f12 | r_zcl_9
(assert (or (not r_p0) (not r_f12) r_zcl_9))
...
;%~r_p5 | ~r_f11 | r_zcl_10
(assert (or (not r_p5) (not r_f11) r_zcl_10))
...
;%~r_p5 | ~r_f10 | r_zcl_11
(assert (or (not r_p5) (not r_f10) r_zcl_11))
