;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p6 & (p0 & (p0 & p5)))) | ((p8 & (p0 & (p0 & (p0 & p7)))) | (p0 & (p7 & (p7 & (p10 & p9))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p10 | ~p9 | f17_p
(assert (or (not l_p10) (not l_p9) l_f17_p))
...
;%~p7 | ~f17 | zcl_13
(assert (or (not l_p7) (not l_f17) l_zcl_13))
...
;%~p7 | ~f16 | zcl_14
(assert (or (not l_p7) (not l_f16) l_zcl_14))
...
(assert (or (not r_p10) (not r_p9) r_f17_p))
...
;%~r_p7 | ~r_f17 | r_zcl_13
(assert (or (not r_p7) (not r_f17) r_zcl_13))
...
;%~r_p7 | ~r_f16 | r_zcl_14
(assert (or (not r_p7) (not r_f16) r_zcl_14))
