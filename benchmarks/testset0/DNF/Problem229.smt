;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (p3 & p0))) | ((p0 & (~p0 & (p0 & p4))) | ((p0 & (~p6 & (~p4 & ~p5))) | ((~p0 & (~p0 & (~p0 & p7))) | ((p4 & (p9 & (~p0 & p8))) | (p11 & (p0 & (p0 & p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p5 | zcl_6
(assert (or (not l_p4) (not l_p5) l_zcl_6))
...
;%~r_p4 | ~r_p5 | r_zcl_6
(assert (or (not r_p4) (not r_p5) r_zcl_6))
