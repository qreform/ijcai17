;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (~p3 & (p4 & ~p0)))) | ((p0 & (~p0 & (~p6 & (~p0 & p5)))) | ((~p0 & (~p8 & (p9 & (~p10 & ~p7)))) | ((~p0 & (p0 & (~p0 & (~p7 & ~p11)))) | ((~p13 & (p11 & (p0 & (p11 & ~p12)))) | (~p11 & (p0 & (~p5 & (p0 & ~p14))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p10 | ~p7 | zcl_8
(assert (or (not l_p10) (not l_p7) l_zcl_8))
...
;%~p10 | ~p7 | f13_p
(assert (or (not l_p10) (not l_p7) l_f13_p))
...
;%~p9 | ~f13 | zcl_9
(assert (or (not l_p9) (not l_f13) l_zcl_9))
...
;%~p7 | ~p11 | zcl_12
(assert (or (not l_p7) (not l_p11) l_zcl_12))
...
;%~p7 | ~p11 | f18_p
(assert (or (not l_p7) (not l_p11) l_f18_p))
...
;%~p11 | ~p12 | zcl_16
(assert (or (not l_p11) (not l_p12) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((p11 & ~p12) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p11 | ~p12 | f23_p
(assert (or (not l_p11) (not l_p12) l_f23_p))
...
;%~p13 | ~f21 | zcl_19
(assert (or (not l_p13) (not l_f21) l_zcl_19))
...
;%~p5 | ~f27 | zcl_21
(assert (or (not l_p5) (not l_f27) l_zcl_21))
...
;%~r_p10 | ~r_p7 | r_zcl_8
(assert (or (not r_p10) (not r_p7) r_zcl_8))
...
(assert (or (not r_p10) (not r_p7) r_f13_p))
...
;%~r_p9 | ~r_f13 | r_zcl_9
(assert (or (not r_p9) (not r_f13) r_zcl_9))
...
;%~r_p7 | ~r_p11 | r_zcl_12
(assert (or (not r_p7) (not r_p11) r_zcl_12))
...
(assert (or (not r_p7) (not r_p11) r_f18_p))
...
;%~r_p11 | ~r_p12 | r_zcl_16
(assert (or (not r_p11) (not r_p12) r_zcl_16))
...
(assert (or (not r_p11) (not r_p12) r_f23_p))
...
;%~r_p13 | ~r_f21 | r_zcl_19
(assert (or (not r_p13) (not r_f21) r_zcl_19))
...
;%~r_p5 | ~r_f27 | r_zcl_21
(assert (or (not r_p5) (not r_f27) r_zcl_21))
