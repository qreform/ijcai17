;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p0 & (p0 & p4))) | ((p0 & (p0 & (p0 & p5))) | (p7 & (p8 & (p9 & p6)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~p6 | zcl_9
(assert (or (not l_p9) (not l_p6) l_zcl_9))
...
;%~p8 | ~f13 | zcl_10
(assert (or (not l_p8) (not l_f13) l_zcl_10))
...
;%~p7 | ~f12 | zcl_11
(assert (or (not l_p7) (not l_f12) l_zcl_11))
...
;%~r_p9 | ~r_p6 | r_zcl_9
(assert (or (not r_p9) (not r_p6) r_zcl_9))
...
;%~r_p8 | ~r_f13 | r_zcl_10
(assert (or (not r_p8) (not r_f13) r_zcl_10))
...
;%~r_p7 | ~r_f12 | r_zcl_11
(assert (or (not r_p7) (not r_f12) r_zcl_11))
