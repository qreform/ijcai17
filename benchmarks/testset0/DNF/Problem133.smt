;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p0 & (p6 & (p0 & p5)))) | ((p0 & (p8 & (p0 & (p0 & p7)))) | (p7 & (p0 & (p0 & (p10 & p9))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~f15 | zcl_15
(assert (or (not l_p7) (not l_f15) l_zcl_15))
...
;%~r_p7 | ~r_f15 | r_zcl_15
(assert (or (not r_p7) (not r_f15) r_zcl_15))
