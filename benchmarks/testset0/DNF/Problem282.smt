;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p0 & (p0 & (p0 & p5)))) | ((p0 & (p5 & (p0 & (p0 & p6)))) | ((p6 & (p0 & (p5 & (p0 & p7)))) | ((p0 & (p5 & (p0 & (p9 & p8)))) | ((p6 & (p0 & (p11 & (p0 & p10)))) | (p13 & (p14 & (p0 & (p0 & p12)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~f12 | zcl_10
(assert (or (not l_p5) (not l_f12) l_zcl_10))
...
;%Non-clausified dependency
;%(forall[]((p5 & f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p5 | ~f12_p | f11_p
(assert (or (not l_p5) (not l_f12_p) l_f11_p))
...
;%~p0 | ~p7 | f18_p
(assert (or (not l_p0) (not l_p7) l_f18_p))
...
;%~p5 | ~f18 | zcl_13
(assert (or (not l_p5) (not l_f18) l_zcl_13))
...
;%~p9 | ~p8 | zcl_16
(assert (or (not l_p9) (not l_p8) l_zcl_16))
...
;%~p9 | ~p8 | f23_p
(assert (or (not l_p9) (not l_p8) l_f23_p))
...
;%~zcl_18 | p5
(assert (or (not l_zcl_18) l_p5))

;%~zcl_18 | f22
(assert (or (not l_zcl_18) l_f22))

;%~p5 | ~f22 | zcl_18
(assert (or (not l_p5) (not l_f22) l_zcl_18))
...
;%~zcl_26 | p14
(assert (or (not l_zcl_26) l_p14))

;%~zcl_26 | f31
(assert (or (not l_zcl_26) l_f31))

;%~p14 | ~f31 | zcl_26
(assert (or (not l_p14) (not l_f31) l_zcl_26))
...
;%~r_p5 | ~r_f12 | r_zcl_10
(assert (or (not r_p5) (not r_f12) r_zcl_10))
...
;%~r_p5 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p5) (not r_f12_p) r_f11_p))
...
(assert (or (not r_p0) (not r_p7) r_f18_p))
...
;%~r_p5 | ~r_f18 | r_zcl_13
(assert (or (not r_p5) (not r_f18) r_zcl_13))
...
;%~r_p9 | ~r_p8 | r_zcl_16
(assert (or (not r_p9) (not r_p8) r_zcl_16))
...
(assert (or (not r_p9) (not r_p8) r_f23_p))
...
;%~r_p5 | ~r_f22 | r_zcl_18
(assert (or (not r_p5) (not r_f22) r_zcl_18))
...
;%~r_p14 | ~r_f31 | r_zcl_26
(assert (or (not r_p14) (not r_f31) r_zcl_26))
