;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & (p4 & ~p0)))) | ((~p0 & (~p0 & (p6 & (p0 & ~p5)))) | ((~p8 & (~p9 & (~p0 & (~p0 & p7)))) | ((p11 & (p12 & (~p0 & (p5 & p10)))) | ((~p0 & (~p14 & (~p0 & (p5 & ~p13)))) | (p0 & (p0 & (~p5 & (~p16 & ~p15))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p10 | zcl_12
(assert (or (not l_p5) (not l_p10) l_zcl_12))
...
;%~p5 | ~p10 | f18_p
(assert (or (not l_p5) (not l_p10) l_f18_p))
...
;%~p12 | ~f17 | zcl_14
(assert (or (not l_p12) (not l_f17) l_zcl_14))
...
;%~p5 | ~p13 | zcl_16
(assert (or (not l_p5) (not l_p13) l_zcl_16))
...
;%~p5 | ~p13 | f23_p
(assert (or (not l_p5) (not l_p13) l_f23_p))
...
;%~p16 | ~p15 | zcl_20
(assert (or (not l_p16) (not l_p15) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((~p16 & ~p15) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p16 | ~p15 | f27_p
(assert (or (not l_p16) (not l_p15) l_f27_p))
...
;%~r_p5 | ~r_p10 | r_zcl_12
(assert (or (not r_p5) (not r_p10) r_zcl_12))
...
(assert (or (not r_p5) (not r_p10) r_f18_p))
...
;%~r_p12 | ~r_f17 | r_zcl_14
(assert (or (not r_p12) (not r_f17) r_zcl_14))
...
;%~r_p5 | ~r_p13 | r_zcl_16
(assert (or (not r_p5) (not r_p13) r_zcl_16))
...
(assert (or (not r_p5) (not r_p13) r_f23_p))
...
;%~r_p16 | ~r_p15 | r_zcl_20
(assert (or (not r_p16) (not r_p15) r_zcl_20))
...
(assert (or (not r_p16) (not r_p15) r_f27_p))
