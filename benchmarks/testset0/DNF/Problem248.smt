;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (p2 & (p3 & (~p4 & (~p5 & ~p0))))) | ((~p0 & (~p0 & (p7 & (p0 & (~p0 & ~p6))))) | ((~p0 & (~p0 & (~p6 & (p0 & (p0 & ~p8))))) | ((~p0 & (~p10 & (~p11 & (p6 & (~p0 & ~p9))))) | ((~p6 & (p6 & (~p8 & (~p0 & (p0 & ~p12))))) | (p0 & (~p0 & (~p14 & (~p0 & (~p0 & p13)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~zcl_18 | p10
(assert (or (not l_zcl_18) l_p10))

;%~zcl_18 | f20
(assert (or (not l_zcl_18) l_f20))

;%~p10 | ~f20 | zcl_18
(assert (or (not l_p10) (not l_f20) l_zcl_18))
...
;%~zcl_22 | p8
(assert (or (not l_zcl_22) l_p8))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p8 | ~f27 | zcl_22
(assert (or (not l_p8) (not l_f27) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((~p8 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p8 | ~f27_p | f26_p
(assert (or (not l_p8) (not l_f27_p) l_f26_p))
...
;%~zcl_25 | p13
(assert (or (not l_zcl_25) l_p13))

;%~p0 | ~p13 | zcl_25
(assert (or (not l_p0) (not l_p13) l_zcl_25))
...
;%~p0 | ~p13 | f33_p
(assert (or (not l_p0) (not l_p13) l_f33_p))
...
;%~zcl_27 | p14
(assert (or (not l_zcl_27) l_p14))

;%~zcl_27 | f32
(assert (or (not l_zcl_27) l_f32))

;%~p14 | ~f32 | zcl_27
(assert (or (not l_p14) (not l_f32) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p14 | ~f32_p | f31_p
(assert (or (not l_p14) (not l_f32_p) l_f31_p))
...
;%~r_p10 | ~r_f20 | r_zcl_18
(assert (or (not r_p10) (not r_f20) r_zcl_18))
...
;%~r_p8 | ~r_f27 | r_zcl_22
(assert (or (not r_p8) (not r_f27) r_zcl_22))
...
;%~r_p8 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p8) (not r_f27_p) r_f26_p))
...
;%~r_zcl_25 | r_p13
(assert (or (not r_zcl_25) r_p13))


;%~r_p0 | ~r_p13 | r_zcl_25
(assert (or (not r_p0) (not r_p13) r_zcl_25))
...
(assert (or (not r_p0) (not r_p13) r_f33_p))
...
;%~r_p14 | ~r_f32 | r_zcl_27
(assert (or (not r_p14) (not r_f32) r_zcl_27))
...
;%~r_p14 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p14) (not r_f32_p) r_f31_p))
