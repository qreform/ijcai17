;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & ~p0))) | ((p0 & (~p0 & (p0 & ~p4))) | ((~p6 & (p0 & (p0 & ~p5))) | ((p4 & (p0 & (~p4 & ~p7))) | (~p4 & (~p4 & (~p0 & ~p8))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p8 | f17_p
(assert (or (not l_p0) (not l_p8) l_f17_p))
...
;%~p4 | ~f17 | zcl_13
(assert (or (not l_p4) (not l_f17) l_zcl_13))
...
;%~p4 | ~f16 | zcl_14
(assert (or (not l_p4) (not l_f16) l_zcl_14))
...
(assert (or (not r_p0) (not r_p8) r_f17_p))
...
;%~r_p4 | ~r_f17 | r_zcl_13
(assert (or (not r_p4) (not r_f17) r_zcl_13))
...
;%~r_p4 | ~r_f16 | r_zcl_14
(assert (or (not r_p4) (not r_f16) r_zcl_14))
