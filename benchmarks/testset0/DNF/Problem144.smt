...
;%~p23 | ~p18 | f21_p
(assert (or (not l_p23) (not l_p18) l_f21_p))
...
;%~p22 | ~f21 | zcl_16
(assert (or (not l_p22) (not l_f21) l_zcl_16))
...
;%~p21 | ~f20 | zcl_17
(assert (or (not l_p21) (not l_f20) l_zcl_17))
...
;%~p20 | ~f19 | zcl_18
(assert (or (not l_p20) (not l_f19) l_zcl_18))
...
;%~p20 | ~f19_p | f18_p
(assert (or (not l_p20) (not l_f19_p) l_f18_p))
...
;%~p19 | ~f18 | zcl_19
(assert (or (not l_p19) (not l_f18) l_zcl_19))
...
;%~p19 | ~f18_p | f17_p
(assert (or (not l_p19) (not l_f18_p) l_f17_p))
...
(assert (or (not r_p23) (not r_p18) r_f21_p))
...
;%~r_p22 | ~r_f21 | r_zcl_16
(assert (or (not r_p22) (not r_f21) r_zcl_16))
...
;%~r_p21 | ~r_f20 | r_zcl_17
(assert (or (not r_p21) (not r_f20) r_zcl_17))
...
;%~r_p20 | ~r_f19 | r_zcl_18
(assert (or (not r_p20) (not r_f19) r_zcl_18))
...
;%~r_p20 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p20) (not r_f19_p) r_f18_p))
...
;%~r_p19 | ~r_f18 | r_zcl_19
(assert (or (not r_p19) (not r_f18) r_zcl_19))
...
;%~r_p19 | ~r_f18_p | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p19) (not r_f18_p) r_f17_p))
