;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p7 & (p0 & (p0 & (p0 & (p0 & p6))))) | ((p6 & (p0 & (p0 & (p0 & (p0 & p8))))) | ((p6 & (p6 & (p8 & (p0 & (p0 & p9))))) | (p0 & (p6 & (p6 & (p6 & (p6 & p10))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~p10 | f27_p
(assert (or (not l_p6) (not l_p10) l_f27_p))
...
;%~p6 | ~f27 | zcl_21
(assert (or (not l_p6) (not l_f27) l_zcl_21))
...
;%~p6 | ~f26 | zcl_22
(assert (or (not l_p6) (not l_f26) l_zcl_22))
...
;%~p0 | ~f24 | zcl_24
(assert (or (not l_p0) (not l_f24) l_zcl_24))
...
(assert (or (not r_p6) (not r_p10) r_f27_p))
...
;%~r_p6 | ~r_f27 | r_zcl_21
(assert (or (not r_p6) (not r_f27) r_zcl_21))
...
;%~r_p6 | ~r_f26 | r_zcl_22
(assert (or (not r_p6) (not r_f26) r_zcl_22))
...
;%~r_p0 | ~r_f24 | r_zcl_24
(assert (or (not r_p0) (not r_f24) r_zcl_24))
