;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p0 & (p5 & p4))) | ((p0 & (p7 & (p0 & p6))) | ((p0 & (p0 & (p0 & p8))) | (p0 & (p0 & (p8 & p9))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p9 | zcl_12
(assert (or (not l_p8) (not l_p9) l_zcl_12))
...
;%~p8 | ~p9 | f17_p
(assert (or (not l_p8) (not l_p9) l_f17_p))
...
;%~r_p8 | ~r_p9 | r_zcl_12
(assert (or (not r_p8) (not r_p9) r_zcl_12))
...
(assert (or (not r_p8) (not r_p9) r_f17_p))
