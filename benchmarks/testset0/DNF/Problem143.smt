;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p0 & (p0 & (p7 & (p0 & p6))))) | ((p9 & (p0 & (p6 & (p10 & (p0 & p8))))) | (p0 & (p12 & (p0 & (p0 & (p0 & p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p11 | f21_p
(assert (or (not l_p0) (not l_p11) l_f21_p))
...
;%~p12 | ~f19 | zcl_18
(assert (or (not l_p12) (not l_f19) l_zcl_18))
...
(assert (or (not r_p0) (not r_p11) r_f21_p))
...
;%~r_p12 | ~r_f19 | r_zcl_18
(assert (or (not r_p12) (not r_f19) r_zcl_18))
