;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (p3 & (~p4 & (~p5 & p0))))) | ((p0 & (p0 & (p0 & (~p0 & (p0 & ~p6))))) | ((~p6 & (~p8 & (~p0 & (~p9 & (~p0 & p7))))) | ((~p6 & (~p0 & (p7 & (p6 & (~p11 & p10))))) | (p13 & (~p0 & (~p7 & (p0 & (~p0 & ~p12))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p11 | ~p10 | zcl_15
(assert (or (not l_p11) (not l_p10) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((~p11 & p10) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p11 | ~p10 | f22_p
(assert (or (not l_p11) (not l_p10) l_f22_p))
...
;%~p7 | ~f21 | zcl_17
(assert (or (not l_p7) (not l_f21) l_zcl_17))
...
;%~p0 | ~p12 | f27_p
(assert (or (not l_p0) (not l_p12) l_f27_p))
...
;%~p7 | ~f26 | zcl_22
(assert (or (not l_p7) (not l_f26) l_zcl_22))
...
;%~p0 | ~f25 | zcl_23
(assert (or (not l_p0) (not l_f25) l_zcl_23))
...
;%~p13 | ~f24 | zcl_24
(assert (or (not l_p13) (not l_f24) l_zcl_24))
...
;%~r_p11 | ~r_p10 | r_zcl_15
(assert (or (not r_p11) (not r_p10) r_zcl_15))
...
(assert (or (not r_p11) (not r_p10) r_f22_p))
...
;%~r_p7 | ~r_f21 | r_zcl_17
(assert (or (not r_p7) (not r_f21) r_zcl_17))
...
(assert (or (not r_p0) (not r_p12) r_f27_p))
...
;%~r_p7 | ~r_f26 | r_zcl_22
(assert (or (not r_p7) (not r_f26) r_zcl_22))
...
;%~r_p0 | ~r_f25 | r_zcl_23
(assert (or (not r_p0) (not r_f25) r_zcl_23))
...
;%~r_p13 | ~r_f24 | r_zcl_24
(assert (or (not r_p13) (not r_f24) r_zcl_24))
