...
;%Non-clausified dependency
;%(forall[]((~p35 & ~p30) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p35 | ~p30 | f33_p
(assert (or (not l_p35) (not l_p30) l_f33_p))
...
;%~p34 | ~f33 | zcl_26
(assert (or (not l_p34) (not l_f33) l_zcl_26))
...
;%~p33 | ~f32 | zcl_27
(assert (or (not l_p33) (not l_f32) l_zcl_27))
...
;%~p32 | ~f31 | zcl_28
(assert (or (not l_p32) (not l_f31) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((~p32 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p32 | ~f31_p | f30_p
(assert (or (not l_p32) (not l_f31_p) l_f30_p))
...
;%~p31 | ~f30 | zcl_29
(assert (or (not l_p31) (not l_f30) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p31 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p31 | ~f30_p | f29_p
(assert (or (not l_p31) (not l_f30_p) l_f29_p))
...
(assert (or (not r_p35) (not r_p30) r_f33_p))
...
;%~r_p34 | ~r_f33 | r_zcl_26
(assert (or (not r_p34) (not r_f33) r_zcl_26))
...
;%~r_p33 | ~r_f32 | r_zcl_27
(assert (or (not r_p33) (not r_f32) r_zcl_27))
...
;%~r_p32 | ~r_f31 | r_zcl_28
(assert (or (not r_p32) (not r_f31) r_zcl_28))
...
;%~r_p32 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p32) (not r_f31_p) r_f30_p))
...
;%~r_p31 | ~r_f30 | r_zcl_29
(assert (or (not r_p31) (not r_f30) r_zcl_29))
...
;%~r_p31 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p31) (not r_f30_p) r_f29_p))
