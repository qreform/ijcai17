;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p0 & (p0 & (p0 & (p7 & p6))))) | ((p0 & (p0 & (p6 & (p0 & (p9 & p8))))) | (p0 & (p0 & (p11 & (p12 & (p0 & p10)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~p6 | f10_p
(assert (or (not l_p7) (not l_p6) l_f10_p))
...
;%~p9 | ~p8 | zcl_10
(assert (or (not l_p9) (not l_p8) l_zcl_10))
...
;%~p9 | ~p8 | f16_p
(assert (or (not l_p9) (not l_p8) l_f16_p))
...
;%~p11 | ~f20 | zcl_17
(assert (or (not l_p11) (not l_f20) l_zcl_17))
...
(assert (or (not r_p7) (not r_p6) r_f10_p))
...
;%~r_p9 | ~r_p8 | r_zcl_10
(assert (or (not r_p9) (not r_p8) r_zcl_10))
...
(assert (or (not r_p9) (not r_p8) r_f16_p))
...
;%~r_p11 | ~r_f20 | r_zcl_17
(assert (or (not r_p11) (not r_f20) r_zcl_17))
