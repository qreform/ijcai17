;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & ~p0))) | ((~p5 & (~p0 & (~p0 & p4))) | ((p7 & (p0 & (p0 & ~p6))) | ((p9 & (p0 & (~p0 & ~p8))) | (~p0 & (~p11 & (~p0 & ~p10))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p11 | ~f17 | zcl_13
(assert (or (not l_p11) (not l_f17) l_zcl_13))
...
;%~r_p11 | ~r_f17 | r_zcl_13
(assert (or (not r_p11) (not r_f17) r_zcl_13))
