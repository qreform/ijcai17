;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (p3 & (~p4 & (p5 & ~p0))))) | (~p7 & (~p8 & (p9 & (p10 & (~p0 & p6)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p6 | f9_p
(assert (or (not l_p0) (not l_p6) l_f9_p))
...
;%~zcl_6 | f9
(assert (or (not l_zcl_6) l_f9))

;%~p10 | ~f9 | zcl_6
(assert (or (not l_p10) (not l_f9) l_zcl_6))

(declare-fun l_f8 () Bool)
;%~f8 | zcl_6
(assert (or (not l_f8) l_zcl_6))
...
;%~p9 | ~f8 | zcl_7
(assert (or (not l_p9) (not l_f8) l_zcl_7))
...
;%~zcl_8 | f7
(assert (or (not l_zcl_8) l_f7))

;%~p8 | ~f7 | zcl_8
(assert (or (not l_p8) (not l_f7) l_zcl_8))

(declare-fun l_f6 () Bool)
;%~f6 | zcl_8
(assert (or (not l_f6) l_zcl_8))
...
;%~p7 | ~f6 | zcl_9
(assert (or (not l_p7) (not l_f6) l_zcl_9))
...
(assert (or (not r_p0) (not r_p6) r_f9_p))
...
;%~r_zcl_6 | r_f9
(assert (or (not r_zcl_6) r_f9))


;%~r_p10 | ~r_f9 | r_zcl_6
(assert (or (not r_p10) (not r_f9) r_zcl_6))


;%~r_f8 | r_zcl_6
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_zcl_6))
...
;%~r_p9 | ~r_f8 | r_zcl_7
(assert (or (not r_p9) (not r_f8) r_zcl_7))
...
;%~r_zcl_8 | r_f7
(assert (or (not r_zcl_8) r_f7))


;%~r_p8 | ~r_f7 | r_zcl_8
(assert (or (not r_p8) (not r_f7) r_zcl_8))


;%~r_f6 | r_zcl_8
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_zcl_8))
...
;%~r_p7 | ~r_f6 | r_zcl_9
(assert (or (not r_p7) (not r_f6) r_zcl_9))
