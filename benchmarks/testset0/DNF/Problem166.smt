...
;%Non-clausified dependency
;%(forall[]((~p14 & ~p12) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p14 | ~p12 | f12_p
(assert (or (not l_p14) (not l_p12) l_f12_p))
...
;%~p13 | ~f12 | zcl_9
(assert (or (not l_p13) (not l_f12) l_zcl_9))
...
(assert (or (not r_p14) (not r_p12) r_f12_p))
...
;%~r_p13 | ~r_f12 | r_zcl_9
(assert (or (not r_p13) (not r_f12) r_zcl_9))
