;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p5 & (p0 & p4))) | ((p7 & (p0 & (p8 & p6))) | ((p0 & (p0 & (p10 & p9))) | ((p12 & (p0 & (p13 & p11))) | (p4 & (p15 & (p0 & p14)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~f6 | zcl_4
(assert (or (not l_p5) (not l_f6) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p13 & p11) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p13 | ~p11 | f18_p
(assert (or (not l_p13) (not l_p11) l_f18_p))
...
;%~p0 | ~p14 | zcl_15
(assert (or (not l_p0) (not l_p14) l_zcl_15))
...
;%~p0 | ~p14 | f21_p
(assert (or (not l_p0) (not l_p14) l_f21_p))
...
;%~zcl_16 | p15
(assert (or (not l_zcl_16) l_p15))

;%~zcl_16 | f21
(assert (or (not l_zcl_16) l_f21))

;%~p15 | ~f21 | zcl_16
(assert (or (not l_p15) (not l_f21) l_zcl_16))
...
;%~p15 | ~f21_p | f20_p
(assert (or (not l_p15) (not l_f21_p) l_f20_p))
...
;%~zcl_17 | p4
(assert (or (not l_zcl_17) l_p4))

;%~zcl_17 | f20
(assert (or (not l_zcl_17) l_f20))

;%~p4 | ~f20 | zcl_17
(assert (or (not l_p4) (not l_f20) l_zcl_17))
...
;%~p4 | ~f20_p | f19_p
(assert (or (not l_p4) (not l_f20_p) l_f19_p))
...
;%~r_p5 | ~r_f6 | r_zcl_4
(assert (or (not r_p5) (not r_f6) r_zcl_4))
...
(assert (or (not r_p13) (not r_p11) r_f18_p))
...
;%~r_p0 | ~r_p14 | r_zcl_15
(assert (or (not r_p0) (not r_p14) r_zcl_15))
...
(assert (or (not r_p0) (not r_p14) r_f21_p))


;%~r_zcl_16 | r_p15
(declare-fun r_zcl_16 () Bool)
(assert (or (not r_zcl_16) r_p15))
...
;%~r_p15 | ~r_f21 | r_zcl_16
(assert (or (not r_p15) (not r_f21) r_zcl_16))
...
;%~r_p15 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p15) (not r_f21_p) r_f20_p))


;%~r_zcl_17 | r_p4
(declare-fun r_zcl_17 () Bool)
(assert (or (not r_zcl_17) r_p4))
...
;%~r_p4 | ~r_f20 | r_zcl_17
(assert (or (not r_p4) (not r_f20) r_zcl_17))
...
;%~r_p4 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p4) (not r_f20_p) r_f19_p))
