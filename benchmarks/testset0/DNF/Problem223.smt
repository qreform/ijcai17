;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p0 & (p5 & p4))) | ((p7 & (p4 & (p4 & p6))) | ((p0 & (p4 & (p4 & p8))) | ((p4 & (p10 & (p4 & p9))) | (p6 & (p12 & (p4 & p11)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p8 | zcl_9
(assert (or (not l_p4) (not l_p8) l_zcl_9))
...
;%~p4 | ~p8 | f14_p
(assert (or (not l_p4) (not l_p8) l_f14_p))
...
;%~p4 | ~p9 | zcl_12
(assert (or (not l_p4) (not l_p9) l_zcl_12))
...
;%~p4 | ~p9 | f18_p
(assert (or (not l_p4) (not l_p9) l_f18_p))
...
;%~p4 | ~p11 | zcl_15
(assert (or (not l_p4) (not l_p11) l_zcl_15))
...
;%~p4 | ~p11 | f21_p
(assert (or (not l_p4) (not l_p11) l_f21_p))
...
;%~p6 | ~f20 | zcl_17
(assert (or (not l_p6) (not l_f20) l_zcl_17))
...
;%~r_p4 | ~r_p8 | r_zcl_9
(assert (or (not r_p4) (not r_p8) r_zcl_9))
...
(assert (or (not r_p4) (not r_p8) r_f14_p))
...
;%~r_p4 | ~r_p9 | r_zcl_12
(assert (or (not r_p4) (not r_p9) r_zcl_12))
...
(assert (or (not r_p4) (not r_p9) r_f18_p))
...
;%~r_p4 | ~r_p11 | r_zcl_15
(assert (or (not r_p4) (not r_p11) r_zcl_15))
...
(assert (or (not r_p4) (not r_p11) r_f21_p))
...
;%~r_p6 | ~r_f20 | r_zcl_17
(assert (or (not r_p6) (not r_f20) r_zcl_17))
