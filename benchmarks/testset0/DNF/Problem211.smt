;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & p0)) | ((p0 & (p0 & p3)) | ((p0 & (p5 & p4)) | ((p4 & (p0 & p6)) | ((p0 & (p3 & p7)) | (p9 & (p4 & p8))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p8 | zcl_10
(assert (or (not l_p4) (not l_p8) l_zcl_10))
...
;%~p4 | ~p8 | f15_p
(assert (or (not l_p4) (not l_p8) l_f15_p))
...
;%~r_p4 | ~r_p8 | r_zcl_10
(assert (or (not r_p4) (not r_p8) r_zcl_10))
...
(assert (or (not r_p4) (not r_p8) r_f15_p))
