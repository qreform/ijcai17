;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p7 & (p8 & (p9 & (p0 & (p0 & p6))))) | ((p0 & (p0 & (p11 & (p6 & (p6 & p10))))) | ((p13 & (p6 & (p6 & (p0 & (p14 & p12))))) | ((p0 & (p0 & (p0 & (p0 & (p6 & p15))))) | ((p0 & (p12 & (p17 & (p18 & (p19 & p16))))) | (p0 & (p6 & (p15 & (p21 & (p6 & p20))))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~f10 | zcl_6
(assert (or (not l_p0) (not l_f10) l_zcl_6))
...
;%~p6 | ~p10 | zcl_10
(assert (or (not l_p6) (not l_p10) l_zcl_10))
...
;%~p6 | ~p10 | f16_p
(assert (or (not l_p6) (not l_p10) l_f16_p))
...
;%~zcl_11 | p6
(assert (or (not l_zcl_11) l_p6))

;%~zcl_11 | f16
(assert (or (not l_zcl_11) l_f16))

;%~p6 | ~f16 | zcl_11
(assert (or (not l_p6) (not l_f16) l_zcl_11))
...
;%~zcl_12 | p11
(assert (or (not l_zcl_12) l_p11))

;%~zcl_12 | f15
(assert (or (not l_zcl_12) l_f15))

;%~p11 | ~f15 | zcl_12
(assert (or (not l_p11) (not l_f15) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((p11 & f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p11 | ~f15_p | f14_p
(assert (or (not l_p11) (not l_f15_p) l_f14_p))
...
;%~p0 | ~f13 | zcl_14
(assert (or (not l_p0) (not l_f13) l_zcl_14))
...
;%~p14 | ~p12 | zcl_15
(assert (or (not l_p14) (not l_p12) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((p14 & p12) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p14 | ~p12 | f22_p
(assert (or (not l_p14) (not l_p12) l_f22_p))
...
;%~zcl_17 | p6
(assert (or (not l_zcl_17) l_p6))

;%~zcl_17 | f21
(assert (or (not l_zcl_17) l_f21))

;%~p6 | ~f21 | zcl_17
(assert (or (not l_p6) (not l_f21) l_zcl_17))
...
;%~p6 | ~f21_p | f20_p
(assert (or (not l_p6) (not l_f21_p) l_f20_p))
...
;%~p6 | ~f20 | zcl_18
(assert (or (not l_p6) (not l_f20) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p6 & f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p6 | ~f20_p | f19_p
(assert (or (not l_p6) (not l_f20_p) l_f19_p))
...
;%~zcl_19 | p13
(assert (or (not l_zcl_19) l_p13))

;%~zcl_19 | f19
(assert (or (not l_zcl_19) l_f19))

;%~p13 | ~f19 | zcl_19
(assert (or (not l_p13) (not l_f19) l_zcl_19))
...
;%Non-clausified dependency
;%(forall[]((p13 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p13 | ~f19_p | f18_p
(assert (or (not l_p13) (not l_f19_p) l_f18_p))
...
;%~zcl_20 | p6
(assert (or (not l_zcl_20) l_p6))

(declare-fun l_p15 () Bool)
;%~zcl_20 | p15
(assert (or (not l_zcl_20) l_p15))

;%~p6 | ~p15 | zcl_20
(assert (or (not l_p6) (not l_p15) l_zcl_20))
...
;%~p6 | ~p15 | f28_p
(assert (or (not l_p6) (not l_p15) l_f28_p))
...
;%~p0 | ~f26 | zcl_23
(assert (or (not l_p0) (not l_f26) l_zcl_23))
...
;%~p19 | ~p16 | zcl_25
(assert (or (not l_p19) (not l_p16) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p19 & p16) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p19 | ~p16 | f34_p
(assert (or (not l_p19) (not l_p16) l_f34_p))
...
;%~zcl_26 | p18
(assert (or (not l_zcl_26) l_p18))

;%~zcl_26 | f34
(assert (or (not l_zcl_26) l_f34))

;%~p18 | ~f34 | zcl_26
(assert (or (not l_p18) (not l_f34) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p18 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p18 | ~f34_p | f33_p
(assert (or (not l_p18) (not l_f34_p) l_f33_p))
...
;%~zcl_27 | p17
(assert (or (not l_zcl_27) l_p17))

;%~zcl_27 | f33
(assert (or (not l_zcl_27) l_f33))

;%~p17 | ~f33 | zcl_27
(assert (or (not l_p17) (not l_f33) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p17 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p17 | ~f33_p | f32_p
(assert (or (not l_p17) (not l_f33_p) l_f32_p))
...
;%~zcl_28 | p12
(assert (or (not l_zcl_28) l_p12))

;%~zcl_28 | f32
(assert (or (not l_zcl_28) l_f32))

;%~p12 | ~f32 | zcl_28
(assert (or (not l_p12) (not l_f32) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p12 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p12 | ~f32_p | f31_p
(assert (or (not l_p12) (not l_f32_p) l_f31_p))
...
;%~p0 | ~f31 | zcl_29
(assert (or (not l_p0) (not l_f31) l_zcl_29))
...
;%~zcl_30 | p6
(assert (or (not l_zcl_30) l_p6))

(declare-fun l_p20 () Bool)
;%~zcl_30 | p20
(assert (or (not l_zcl_30) l_p20))

;%~p6 | ~p20 | zcl_30
(assert (or (not l_p6) (not l_p20) l_zcl_30))
...
;%~p6 | ~p20 | f39_p
(assert (or (not l_p6) (not l_p20) l_f39_p))
...
;%~zcl_31 | p21
(assert (or (not l_zcl_31) l_p21))

;%~zcl_31 | f39
(assert (or (not l_zcl_31) l_f39))

;%~p21 | ~f39 | zcl_31
(assert (or (not l_p21) (not l_f39) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p21 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p21 | ~f39_p | f38_p
(assert (or (not l_p21) (not l_f39_p) l_f38_p))
...
;%~zcl_32 | p15
(assert (or (not l_zcl_32) l_p15))

;%~zcl_32 | f38
(assert (or (not l_zcl_32) l_f38))

;%~p15 | ~f38 | zcl_32
(assert (or (not l_p15) (not l_f38) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p15 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p15 | ~f38_p | f37_p
(assert (or (not l_p15) (not l_f38_p) l_f37_p))
...
;%~zcl_33 | p6
(assert (or (not l_zcl_33) l_p6))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p6 | ~f37 | zcl_33
(assert (or (not l_p6) (not l_f37) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((p6 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p6 | ~f37_p | f36_p
(assert (or (not l_p6) (not l_f37_p) l_f36_p))
...
;%~zcl_34 | p0
(assert (or (not l_zcl_34) l_p0))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p0 | ~f36 | zcl_34
(assert (or (not l_p0) (not l_f36) l_zcl_34))
...
;%~r_p0 | ~r_f10 | r_zcl_6
(assert (or (not r_p0) (not r_f10) r_zcl_6))
...
;%~r_p6 | ~r_p10 | r_zcl_10
(assert (or (not r_p6) (not r_p10) r_zcl_10))
...
(assert (or (not r_p6) (not r_p10) r_f16_p))


;%~r_zcl_11 | r_p6
(declare-fun r_zcl_11 () Bool)
(assert (or (not r_zcl_11) r_p6))
...
;%~r_p6 | ~r_f16 | r_zcl_11
(assert (or (not r_p6) (not r_f16) r_zcl_11))
...
;%~r_p11 | ~r_f15 | r_zcl_12
(assert (or (not r_p11) (not r_f15) r_zcl_12))
...
;%~r_p11 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p11) (not r_f15_p) r_f14_p))
...
;%~r_p0 | ~r_f13 | r_zcl_14
(assert (or (not r_p0) (not r_f13) r_zcl_14))
...
;%~r_p14 | ~r_p12 | r_zcl_15
(assert (or (not r_p14) (not r_p12) r_zcl_15))
...
(assert (or (not r_p14) (not r_p12) r_f22_p))
...
;%~r_p6 | ~r_f21 | r_zcl_17
(assert (or (not r_p6) (not r_f21) r_zcl_17))
...
;%~r_p6 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p6) (not r_f21_p) r_f20_p))
...
;%~r_p6 | ~r_f20 | r_zcl_18
(assert (or (not r_p6) (not r_f20) r_zcl_18))
...
;%~r_p6 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p6) (not r_f20_p) r_f19_p))


;%~r_zcl_19 | r_p13
(declare-fun r_zcl_19 () Bool)
(assert (or (not r_zcl_19) r_p13))
...
;%~r_p13 | ~r_f19 | r_zcl_19
(assert (or (not r_p13) (not r_f19) r_zcl_19))
...
;%~r_p13 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p13) (not r_f19_p) r_f18_p))


;%~r_zcl_20 | r_p6
(declare-fun r_zcl_20 () Bool)
(assert (or (not r_zcl_20) r_p6))


;%~r_zcl_20 | r_p15
(assert (or (not r_zcl_20) r_p15))


;%~r_p6 | ~r_p15 | r_zcl_20
(assert (or (not r_p6) (not r_p15) r_zcl_20))
...
(assert (or (not r_p6) (not r_p15) r_f28_p))
...
;%~r_p0 | ~r_f26 | r_zcl_23
(assert (or (not r_p0) (not r_f26) r_zcl_23))
...
;%~r_p19 | ~r_p16 | r_zcl_25
(assert (or (not r_p19) (not r_p16) r_zcl_25))
...
(assert (or (not r_p19) (not r_p16) r_f34_p))


;%~r_zcl_26 | r_p18
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p18))
...
;%~r_p18 | ~r_f34 | r_zcl_26
(assert (or (not r_p18) (not r_f34) r_zcl_26))
...
;%~r_p18 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p18) (not r_f34_p) r_f33_p))


;%~r_zcl_27 | r_p17
(declare-fun r_zcl_27 () Bool)
(assert (or (not r_zcl_27) r_p17))
...
;%~r_p17 | ~r_f33 | r_zcl_27
(assert (or (not r_p17) (not r_f33) r_zcl_27))
...
;%~r_p17 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p17) (not r_f33_p) r_f32_p))


;%~r_zcl_28 | r_p12
(declare-fun r_zcl_28 () Bool)
(assert (or (not r_zcl_28) r_p12))
...
;%~r_p12 | ~r_f32 | r_zcl_28
(assert (or (not r_p12) (not r_f32) r_zcl_28))
...
;%~r_p12 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p12) (not r_f32_p) r_f31_p))
...
;%~r_p0 | ~r_f31 | r_zcl_29
(assert (or (not r_p0) (not r_f31) r_zcl_29))
...
(assert (or (not r_zcl_30) r_p6))


;%~r_zcl_30 | r_p20
(assert (or (not r_zcl_30) r_p20))


;%~r_p6 | ~r_p20 | r_zcl_30
(assert (or (not r_p6) (not r_p20) r_zcl_30))
...
(assert (or (not r_p6) (not r_p20) r_f39_p))


;%~r_zcl_31 | r_p21
(declare-fun r_zcl_31 () Bool)
(assert (or (not r_zcl_31) r_p21))
...
;%~r_p21 | ~r_f39 | r_zcl_31
(assert (or (not r_p21) (not r_f39) r_zcl_31))
...
;%~r_p21 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p21) (not r_f39_p) r_f38_p))


;%~r_zcl_32 | r_p15
(declare-fun r_zcl_32 () Bool)
(assert (or (not r_zcl_32) r_p15))
...
;%~r_p15 | ~r_f38 | r_zcl_32
(assert (or (not r_p15) (not r_f38) r_zcl_32))
...
;%~r_p15 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p15) (not r_f38_p) r_f37_p))


;%~r_zcl_33 | r_p6
(declare-fun r_zcl_33 () Bool)
(assert (or (not r_zcl_33) r_p6))
...
;%~r_p6 | ~r_f37 | r_zcl_33
(assert (or (not r_p6) (not r_f37) r_zcl_33))
...
;%~r_p6 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p6) (not r_f37_p) r_f36_p))


;%~r_zcl_34 | r_p0
(declare-fun r_zcl_34 () Bool)
(assert (or (not r_zcl_34) r_p0))
...
;%~r_p0 | ~r_f36 | r_zcl_34
(assert (or (not r_p0) (not r_f36) r_zcl_34))
