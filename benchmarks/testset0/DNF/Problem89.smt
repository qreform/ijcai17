;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (~p3 & (~p4 & ~p0)))) | ((p0 & (~p6 & (~p0 & (p0 & ~p5)))) | (~p0 & (p0 & (~p8 & (~p9 & ~p7)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~f12 | zcl_9
(assert (or (not l_p8) (not l_f12) l_zcl_9))
...
;%~p0 | ~f10 | zcl_11
(assert (or (not l_p0) (not l_f10) l_zcl_11))
...
;%~r_p8 | ~r_f12 | r_zcl_9
(assert (or (not r_p8) (not r_f12) r_zcl_9))
...
;%~r_p0 | ~r_f10 | r_zcl_11
(assert (or (not r_p0) (not r_f10) r_zcl_11))
