;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & p0) | ((p0 & p2) | ((p2 & p3) | ((p0 & p4) | ((p0 & p5) | ((p7 & p6) | (p0 & p8))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p8 | zcl_6
(assert (or (not l_p0) (not l_p8) l_zcl_6))
...
;%~p0 | ~p8 | f11_p
(assert (or (not l_p0) (not l_p8) l_f11_p))
...
;%~r_p0 | ~r_p8 | r_zcl_6
(assert (or (not r_p0) (not r_p8) r_zcl_6))
...
(assert (or (not r_p0) (not r_p8) r_f11_p))
