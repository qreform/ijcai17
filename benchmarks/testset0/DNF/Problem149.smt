;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (~p4 & (~p5 & p0))))) | ((~p0 & (~p0 & (p0 & (p0 & (~p0 & ~p6))))) | ((~p0 & (~p0 & (~p0 & (~p0 & (p8 & ~p7))))) | (~p6 & (~p0 & (~p0 & (~p0 & (~p7 & ~p9)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~p9 | zcl_15
(assert (or (not l_p7) (not l_p9) l_zcl_15))
...
;%~p7 | ~p9 | f21_p
(assert (or (not l_p7) (not l_p9) l_f21_p))
...
;%~p6 | ~f18 | zcl_19
(assert (or (not l_p6) (not l_f18) l_zcl_19))
...
;%~r_p7 | ~r_p9 | r_zcl_15
(assert (or (not r_p7) (not r_p9) r_zcl_15))
...
(assert (or (not r_p7) (not r_p9) r_f21_p))
...
;%~r_p6 | ~r_f18 | r_zcl_19
(assert (or (not r_p6) (not r_f18) r_zcl_19))
