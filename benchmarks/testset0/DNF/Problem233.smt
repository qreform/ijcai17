;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & p0)))) | ((p0 & (p0 & (p0 & (p6 & p5)))) | ((p5 & (p0 & (p0 & (p0 & p7)))) | ((p0 & (p0 & (p0 & (p9 & p8)))) | ((p0 & (p11 & (p0 & (p12 & p10)))) | (p0 & (p0 & (p0 & (p0 & p13))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~p5 | f8_p
(assert (or (not l_p6) (not l_p5) l_f8_p))
...
;%~p12 | ~p10 | zcl_16
(assert (or (not l_p12) (not l_p10) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((p12 & p10) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p12 | ~p10 | f23_p
(assert (or (not l_p12) (not l_p10) l_f23_p))
...
(assert (or (not r_p6) (not r_p5) r_f8_p))
...
;%~r_p12 | ~r_p10 | r_zcl_16
(assert (or (not r_p12) (not r_p10) r_zcl_16))
...
(assert (or (not r_p12) (not r_p10) r_f23_p))
