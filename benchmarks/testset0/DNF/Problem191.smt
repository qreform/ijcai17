;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p0 & (p0 & (p0 & (p0 & p6))))) | ((p8 & (p0 & (p0 & (p0 & (p0 & p7))))) | ((p0 & (p0 & (p0 & (p0 & (p0 & p9))))) | (p11 & (p12 & (p13 & (p0 & (p0 & p10))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p13 | ~f26 | zcl_22
(assert (or (not l_p13) (not l_f26) l_zcl_22))
...
;%~p12 | ~f25 | zcl_23
(assert (or (not l_p12) (not l_f25) l_zcl_23))
...
;%~r_p13 | ~r_f26 | r_zcl_22
(assert (or (not r_p13) (not r_f26) r_zcl_22))
...
;%~r_p12 | ~r_f25 | r_zcl_23
(assert (or (not r_p12) (not r_f25) r_zcl_23))
