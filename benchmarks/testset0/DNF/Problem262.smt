;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & p0)) | ((p0 & (p0 & p3)) | ((p0 & (p0 & p4)) | ((p0 & (p0 & p5)) | ((p4 & (p0 & p6)) | ((p0 & (p5 & p7)) | (p6 & (p5 & p8)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~f13 | zcl_9
(assert (or (not l_p4) (not l_f13) l_zcl_9))
...
;%~p5 | ~p7 | zcl_10
(assert (or (not l_p5) (not l_p7) l_zcl_10))
...
;%~p5 | ~p7 | f16_p
(assert (or (not l_p5) (not l_p7) l_f16_p))
...
;%~r_p4 | ~r_f13 | r_zcl_9
(assert (or (not r_p4) (not r_f13) r_zcl_9))
...
;%~r_p5 | ~r_p7 | r_zcl_10
(assert (or (not r_p5) (not r_p7) r_zcl_10))
...
(assert (or (not r_p5) (not r_p7) r_f16_p))
