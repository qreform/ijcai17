;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p0 & (p0 & (p0 & (p0 & p6))))) | ((p0 & (p0 & (p0 & (p0 & (p0 & p7))))) | ((p0 & (p9 & (p6 & (p0 & (p0 & p8))))) | ((p6 & (p11 & (p0 & (p6 & (p0 & p10))))) | (p6 & (p0 & (p0 & (p0 & (p6 & p12)))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~zcl_18 | p9
(assert (or (not l_zcl_18) l_p9))

;%~zcl_18 | f20
(assert (or (not l_zcl_18) l_f20))

;%~p9 | ~f20 | zcl_18
(assert (or (not l_p9) (not l_f20) l_zcl_18))
...
;%~p9 | ~f20_p | f19_p
(assert (or (not l_p9) (not l_f20_p) l_f19_p))
...
;%~zcl_21 | p6
(assert (or (not l_zcl_21) l_p6))

;%~zcl_21 | f28
(assert (or (not l_zcl_21) l_f28))

;%~p6 | ~f28 | zcl_21
(assert (or (not l_p6) (not l_f28) l_zcl_21))
...
;%~p6 | ~f28_p | f27_p
(assert (or (not l_p6) (not l_f28_p) l_f27_p))
...
;%~zcl_23 | p11
(assert (or (not l_zcl_23) l_p11))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p11 | ~f26 | zcl_23
(assert (or (not l_p11) (not l_f26) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((p11 & f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p11 | ~f26_p | f25_p
(assert (or (not l_p11) (not l_f26_p) l_f25_p))
...
;%~p6 | ~p12 | zcl_25
(assert (or (not l_p6) (not l_p12) l_zcl_25))
...
;%~p6 | ~p12 | f33_p
(assert (or (not l_p6) (not l_p12) l_f33_p))
...
;%~r_p9 | ~r_f20 | r_zcl_18
(assert (or (not r_p9) (not r_f20) r_zcl_18))
...
;%~r_p9 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p9) (not r_f20_p) r_f19_p))
...
;%~r_p6 | ~r_f28 | r_zcl_21
(assert (or (not r_p6) (not r_f28) r_zcl_21))
...
;%~r_p6 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p6) (not r_f28_p) r_f27_p))
...
;%~r_p11 | ~r_f26 | r_zcl_23
(assert (or (not r_p11) (not r_f26) r_zcl_23))
...
;%~r_p11 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p11) (not r_f26_p) r_f25_p))
...
;%~r_p6 | ~r_p12 | r_zcl_25
(assert (or (not r_p6) (not r_p12) r_zcl_25))
...
(assert (or (not r_p6) (not r_p12) r_f33_p))
