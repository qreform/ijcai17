;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & (p4 & (p5 & p0))))) | ((p0 & (p7 & (p0 & (p0 & (p0 & p6))))) | ((p9 & (p0 & (p10 & (p0 & (p0 & p8))))) | ((p0 & (p0 & (p0 & (p0 & (p8 & p11))))) | ((p8 & (p0 & (p13 & (p14 & (p0 & p12))))) | ((p0 & (p0 & (p11 & (p0 & (p16 & p15))))) | (p0 & (p8 & (p0 & (p18 & (p11 & p17))))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~zcl_8 | p7
(assert (or (not l_zcl_8) l_p7))

;%~zcl_8 | f8
(assert (or (not l_zcl_8) l_f8))

;%~p7 | ~f8 | zcl_8
(assert (or (not l_p7) (not l_f8) l_zcl_8))
...
;%~p7 | ~f8_p | f7_p
(assert (or (not l_p7) (not l_f8_p) l_f7_p))
...
;%~zcl_15 | p8
(assert (or (not l_zcl_15) l_p8))

(declare-fun l_p11 () Bool)
;%~zcl_15 | p11
(assert (or (not l_zcl_15) l_p11))

;%~p8 | ~p11 | zcl_15
(assert (or (not l_p8) (not l_p11) l_zcl_15))
...
;%~p8 | ~p11 | f22_p
(assert (or (not l_p8) (not l_p11) l_f22_p))
...
;%~p0 | ~f20 | zcl_18
(assert (or (not l_p0) (not l_f20) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p0 & f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p0 | ~f20_p | f19_p
(assert (or (not l_p0) (not l_f20_p) l_f19_p))
...
;%~zcl_20 | p12
(assert (or (not l_zcl_20) l_p12))

;%~p0 | ~p12 | zcl_20
(assert (or (not l_p0) (not l_p12) l_zcl_20))
...
;%~p0 | ~p12 | f28_p
(assert (or (not l_p0) (not l_p12) l_f28_p))
...
;%~zcl_21 | p14
(assert (or (not l_zcl_21) l_p14))

;%~zcl_21 | f28
(assert (or (not l_zcl_21) l_f28))

;%~p14 | ~f28 | zcl_21
(assert (or (not l_p14) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p14 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p14 | ~f28_p | f27_p
(assert (or (not l_p14) (not l_f28_p) l_f27_p))
...
;%~zcl_22 | p13
(assert (or (not l_zcl_22) l_p13))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p13 | ~f27 | zcl_22
(assert (or (not l_p13) (not l_f27) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((p13 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p13 | ~f27_p | f26_p
(assert (or (not l_p13) (not l_f27_p) l_f26_p))
...
;%~zcl_24 | p8
(assert (or (not l_zcl_24) l_p8))

;%~zcl_24 | f25
(assert (or (not l_zcl_24) l_f25))

;%~p8 | ~f25 | zcl_24
(assert (or (not l_p8) (not l_f25) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p8 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p8 | ~f25_p | f24_p
(assert (or (not l_p8) (not l_f25_p) l_f24_p))
...
;%~zcl_25 | p15
(assert (or (not l_zcl_25) l_p15))

;%~p16 | ~p15 | zcl_25
(assert (or (not l_p16) (not l_p15) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p16 & p15) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p16 | ~p15 | f34_p
(assert (or (not l_p16) (not l_p15) l_f34_p))
...
;%~p0 | ~f34 | zcl_26
(assert (or (not l_p0) (not l_f34) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p0 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p0 | ~f34_p | f33_p
(assert (or (not l_p0) (not l_f34_p) l_f33_p))
...
;%~zcl_27 | p11
(assert (or (not l_zcl_27) l_p11))

;%~zcl_27 | f33
(assert (or (not l_zcl_27) l_f33))

;%~p11 | ~f33 | zcl_27
(assert (or (not l_p11) (not l_f33) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p11 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p11 | ~f33_p | f32_p
(assert (or (not l_p11) (not l_f33_p) l_f32_p))
...
;%~p0 | ~f32 | zcl_28
(assert (or (not l_p0) (not l_f32) l_zcl_28))
...
;%~zcl_30 | p11
(assert (or (not l_zcl_30) l_p11))

(declare-fun l_p17 () Bool)
;%~zcl_30 | p17
(assert (or (not l_zcl_30) l_p17))

;%~p11 | ~p17 | zcl_30
(assert (or (not l_p11) (not l_p17) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p11 & p17) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p11 | ~p17 | f39_p
(assert (or (not l_p11) (not l_p17) l_f39_p))
...
;%~zcl_31 | p18
(assert (or (not l_zcl_31) l_p18))

;%~zcl_31 | f39
(assert (or (not l_zcl_31) l_f39))

;%~p18 | ~f39 | zcl_31
(assert (or (not l_p18) (not l_f39) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p18 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p18 | ~f39_p | f38_p
(assert (or (not l_p18) (not l_f39_p) l_f38_p))
...
;%~p0 | ~f38 | zcl_32
(assert (or (not l_p0) (not l_f38) l_zcl_32))
...
;%~p8 | ~f37 | zcl_33
(assert (or (not l_p8) (not l_f37) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((p8 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p8 | ~f37_p | f36_p
(assert (or (not l_p8) (not l_f37_p) l_f36_p))
...
;%~r_p7 | ~r_f8 | r_zcl_8
(assert (or (not r_p7) (not r_f8) r_zcl_8))
...
(assert (or (not r_p7) (not r_f8_p) r_f7_p))
...
(assert (or (not r_zcl_15) r_p8))


;%~r_zcl_15 | r_p11
(assert (or (not r_zcl_15) r_p11))


;%~r_p8 | ~r_p11 | r_zcl_15
(assert (or (not r_p8) (not r_p11) r_zcl_15))
...
(assert (or (not r_p8) (not r_p11) r_f22_p))
...
;%~r_p0 | ~r_f20 | r_zcl_18
(assert (or (not r_p0) (not r_f20) r_zcl_18))
...
;%~r_p0 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p0) (not r_f20_p) r_f19_p))
...
;%~r_zcl_20 | r_p12
(assert (or (not r_zcl_20) r_p12))


;%~r_p0 | ~r_p12 | r_zcl_20
(assert (or (not r_p0) (not r_p12) r_zcl_20))
...
(assert (or (not r_p0) (not r_p12) r_f28_p))


;%~r_zcl_21 | r_p14
(declare-fun r_zcl_21 () Bool)
(assert (or (not r_zcl_21) r_p14))
...
;%~r_p14 | ~r_f28 | r_zcl_21
(assert (or (not r_p14) (not r_f28) r_zcl_21))
...
;%~r_p14 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p14) (not r_f28_p) r_f27_p))


;%~r_zcl_22 | r_p13
(declare-fun r_zcl_22 () Bool)
(assert (or (not r_zcl_22) r_p13))
...
;%~r_p13 | ~r_f27 | r_zcl_22
(assert (or (not r_p13) (not r_f27) r_zcl_22))
...
;%~r_p13 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p13) (not r_f27_p) r_f26_p))
...
;%~r_p8 | ~r_f25 | r_zcl_24
(assert (or (not r_p8) (not r_f25) r_zcl_24))
...
;%~r_p8 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p8) (not r_f25_p) r_f24_p))
...
;%~r_zcl_25 | r_p15
(assert (or (not r_zcl_25) r_p15))


;%~r_p16 | ~r_p15 | r_zcl_25
(assert (or (not r_p16) (not r_p15) r_zcl_25))
...
(assert (or (not r_p16) (not r_p15) r_f34_p))
...
;%~r_p0 | ~r_f34 | r_zcl_26
(assert (or (not r_p0) (not r_f34) r_zcl_26))
...
;%~r_p0 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p0) (not r_f34_p) r_f33_p))


;%~r_zcl_27 | r_p11
(declare-fun r_zcl_27 () Bool)
(assert (or (not r_zcl_27) r_p11))
...
;%~r_p11 | ~r_f33 | r_zcl_27
(assert (or (not r_p11) (not r_f33) r_zcl_27))
...
;%~r_p11 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p11) (not r_f33_p) r_f32_p))
...
;%~r_p0 | ~r_f32 | r_zcl_28
(assert (or (not r_p0) (not r_f32) r_zcl_28))
...
(assert (or (not r_zcl_30) r_p11))


;%~r_zcl_30 | r_p17
(assert (or (not r_zcl_30) r_p17))


;%~r_p11 | ~r_p17 | r_zcl_30
(assert (or (not r_p11) (not r_p17) r_zcl_30))
...
(assert (or (not r_p11) (not r_p17) r_f39_p))


;%~r_zcl_31 | r_p18
(declare-fun r_zcl_31 () Bool)
(assert (or (not r_zcl_31) r_p18))
...
;%~r_p18 | ~r_f39 | r_zcl_31
(assert (or (not r_p18) (not r_f39) r_zcl_31))
...
;%~r_p18 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p18) (not r_f39_p) r_f38_p))
...
;%~r_p0 | ~r_f38 | r_zcl_32
(assert (or (not r_p0) (not r_f38) r_zcl_32))
...
;%~r_p8 | ~r_f37 | r_zcl_33
(assert (or (not r_p8) (not r_f37) r_zcl_33))
...
;%~r_p8 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p8) (not r_f37_p) r_f36_p))
