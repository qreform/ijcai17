;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & p0)) | ((p0 & (p0 & p3)) | ((p0 & (p3 & p4)) | ((p0 & (p6 & p5)) | ((p3 & (p5 & p7)) | ((p0 & (p3 & p8)) | (p0 & (p10 & p9)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p3 | ~p4 | zcl_4
(assert (or (not l_p3) (not l_p4) l_zcl_4))
...
;%~p3 | ~p4 | f7_p
(assert (or (not l_p3) (not l_p4) l_f7_p))
...
;%~p3 | ~f13 | zcl_9
(assert (or (not l_p3) (not l_f13) l_zcl_9))
...
;%~r_p3 | ~r_p4 | r_zcl_4
(assert (or (not r_p3) (not r_p4) r_zcl_4))
...
(assert (or (not r_p3) (not r_p4) r_f7_p))
...
;%~r_p3 | ~r_f13 | r_zcl_9
(assert (or (not r_p3) (not r_f13) r_zcl_9))
