;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & ~p0)) | ((~p0 & (~p0 & p3)) | ((p3 & (~p5 & ~p4)) | ((p0 & (p4 & ~p6)) | (p8 & (~p4 & ~p7)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p7 | zcl_8
(assert (or (not l_p4) (not l_p7) l_zcl_8))
...
;%~p4 | ~p7 | f12_p
(assert (or (not l_p4) (not l_p7) l_f12_p))
...
;%~r_p4 | ~r_p7 | r_zcl_8
(assert (or (not r_p4) (not r_p7) r_zcl_8))
...
(assert (or (not r_p4) (not r_p7) r_f12_p))
