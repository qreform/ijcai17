;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & (~p3 & ~p0))) | ((~p0 & (~p0 & (p5 & ~p4))) | ((p0 & (p4 & (~p7 & ~p6))) | ((p0 & (p9 & (p0 & ~p8))) | ((~p0 & (p0 & (~p4 & ~p10))) | ((p4 & (p0 & (~p12 & ~p11))) | (~p14 & (p15 & (~p4 & ~p13))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p9 | ~f14 | zcl_10
(assert (or (not l_p9) (not l_f14) l_zcl_10))
...
;%~p4 | ~p10 | zcl_12
(assert (or (not l_p4) (not l_p10) l_zcl_12))
...
;%~p4 | ~p10 | f18_p
(assert (or (not l_p4) (not l_p10) l_f18_p))
...
;%~p4 | ~f21 | zcl_17
(assert (or (not l_p4) (not l_f21) l_zcl_17))
...
;%~zcl_19 | p15
(assert (or (not l_zcl_19) l_p15))

;%~zcl_19 | f25
(assert (or (not l_zcl_19) l_f25))

;%~p15 | ~f25 | zcl_19
(assert (or (not l_p15) (not l_f25) l_zcl_19))
...
;%~r_p9 | ~r_f14 | r_zcl_10
(assert (or (not r_p9) (not r_f14) r_zcl_10))
...
;%~r_p4 | ~r_p10 | r_zcl_12
(assert (or (not r_p4) (not r_p10) r_zcl_12))
...
(assert (or (not r_p4) (not r_p10) r_f18_p))
...
;%~r_p4 | ~r_f21 | r_zcl_17
(assert (or (not r_p4) (not r_f21) r_zcl_17))
...
;%~r_p15 | ~r_f25 | r_zcl_19
(assert (or (not r_p15) (not r_f25) r_zcl_19))
