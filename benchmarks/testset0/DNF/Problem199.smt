;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (p3 & (p4 & (~p5 & ~p0))))) | ((~p0 & (p0 & (p0 & (~p0 & (p0 & ~p6))))) | ((~p0 & (p0 & (~p0 & (~p0 & (p8 & p7))))) | ((p10 & (p11 & (p0 & (~p0 & (~p0 & ~p9))))) | (~p13 & (p0 & (~p0 & (~p14 & (p0 & ~p12))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p7 | zcl_10
(assert (or (not l_p8) (not l_p7) l_zcl_10))
...
;%~p8 | ~p7 | f16_p
(assert (or (not l_p8) (not l_p7) l_f16_p))
...
;%~p10 | ~f19 | zcl_19
(assert (or (not l_p10) (not l_f19) l_zcl_19))
...
;%Non-clausified dependency
;%(forall[]((p10 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p10 | ~f19_p | f18_p
(assert (or (not l_p10) (not l_f19_p) l_f18_p))
...
;%~p14 | ~f27 | zcl_21
(assert (or (not l_p14) (not l_f27) l_zcl_21))
...
;%~r_p8 | ~r_p7 | r_zcl_10
(assert (or (not r_p8) (not r_p7) r_zcl_10))
...
(assert (or (not r_p8) (not r_p7) r_f16_p))
...
;%~r_p10 | ~r_f19 | r_zcl_19
(assert (or (not r_p10) (not r_f19) r_zcl_19))
...
;%~r_p10 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p10) (not r_f19_p) r_f18_p))
...
;%~r_p14 | ~r_f27 | r_zcl_21
(assert (or (not r_p14) (not r_f27) r_zcl_21))
