...
;%~p11 | ~p10 | f10_p
(assert (or (not l_p11) (not l_p10) l_f10_p))
...
;%~p13 | ~p12 | zcl_6
(assert (or (not l_p13) (not l_p12) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((~p13 & ~p12) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p13 | ~p12 | f11_p
(assert (or (not l_p13) (not l_p12) l_f11_p))
...
(assert (or (not r_p11) (not r_p10) r_f10_p))
...
;%~r_p13 | ~r_p12 | r_zcl_6
(assert (or (not r_p13) (not r_p12) r_zcl_6))
...
(assert (or (not r_p13) (not r_p12) r_f11_p))
