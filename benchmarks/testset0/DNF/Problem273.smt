;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p3 & p0))) | ((p0 & (p0 & (p0 & p4))) | ((p0 & (p6 & (p7 & p5))) | ((p0 & (p0 & (p0 & p8))) | ((p0 & (p0 & (p0 & p9))) | ((p0 & (p11 & (p0 & p10))) | (p13 & (p0 & (p0 & p12))))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p13 | ~f24 | zcl_20
(assert (or (not l_p13) (not l_f24) l_zcl_20))
...
;%~r_p13 | ~r_f24 | r_zcl_20
(assert (or (not r_p13) (not r_f24) r_zcl_20))
