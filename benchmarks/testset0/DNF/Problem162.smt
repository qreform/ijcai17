;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & p0)) | ((p4 & (p0 & p3)) | ((p6 & (p3 & p5)) | ((p5 & (p5 & p7)) | (p5 & (p0 & p8)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p5 | ~p7 | zcl_6
(assert (or (not l_p5) (not l_p7) l_zcl_6))
...
;%~p5 | ~f12 | zcl_9
(assert (or (not l_p5) (not l_f12) l_zcl_9))
...
;%~r_p5 | ~r_p7 | r_zcl_6
(assert (or (not r_p5) (not r_p7) r_zcl_6))
...
;%~r_p5 | ~r_f12 | r_zcl_9
(assert (or (not r_p5) (not r_f12) r_zcl_9))
