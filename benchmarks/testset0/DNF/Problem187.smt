;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (~p2 & (p3 & (p4 & ~p0)))) | ((p6 & (~p7 & (p0 & (p0 & ~p5)))) | ((p5 & (~p5 & (p0 & (~p0 & ~p8)))) | ((p5 & (~p10 & (~p11 & (~p0 & p9)))) | (~p5 & (p13 & (~p5 & (~p8 & ~p12)))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p12 | zcl_16
(assert (or (not l_p8) (not l_p12) l_zcl_16))
...
;%~p5 | ~f22 | zcl_17
(assert (or (not l_p5) (not l_f22) l_zcl_17))
...
;%~p13 | ~f21 | zcl_18
(assert (or (not l_p13) (not l_f21) l_zcl_18))
...
;%~p5 | ~f20 | zcl_19
(assert (or (not l_p5) (not l_f20) l_zcl_19))
...
;%Non-clausified dependency
;%(forall[]((~p5 & f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p5 | ~f20_p | f19_p
(assert (or (not l_p5) (not l_f20_p) l_f19_p))
...
;%~r_p8 | ~r_p12 | r_zcl_16
(assert (or (not r_p8) (not r_p12) r_zcl_16))
...
;%~r_p5 | ~r_f22 | r_zcl_17
(assert (or (not r_p5) (not r_f22) r_zcl_17))
...
;%~r_p13 | ~r_f21 | r_zcl_18
(assert (or (not r_p13) (not r_f21) r_zcl_18))
...
;%~r_p5 | ~r_f20 | r_zcl_19
(assert (or (not r_p5) (not r_f20) r_zcl_19))
...
;%~r_p5 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p5) (not r_f20_p) r_f19_p))
