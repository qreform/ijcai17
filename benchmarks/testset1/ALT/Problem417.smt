...
;%~p2 | ~p8 | f2_p
(assert (or (not l_p2) (not l_p8) l_f2_p))
...
;%~p7 | ~f2 | zcl_1
(assert (or (not l_p7) (not l_f2) l_zcl_1))
...
;%~p3 | ~f1 | zcl_2
(assert (or (not l_p3) (not l_f1) l_zcl_2))
...
;%~p3 | ~p5 | f10_p
(assert (or (not l_p3) (not l_p5) l_f10_p))
...
;%~p2 | ~f10 | zcl_4
(assert (or (not l_p2) (not l_f10) l_zcl_4))
...
;%~p2 | ~f10_p | f9_p
(assert (or (not l_p2) (not l_f10_p) l_f9_p))
...
;%~p1 | ~f9 | zcl_5
(assert (or (not l_p1) (not l_f9) l_zcl_5))
...
;%~p1 | ~f9_p | f8_p
(assert (or (not l_p1) (not l_f9_p) l_f8_p))
...
;%~f13 | p3 | f14
(assert (or (not l_f13) l_p3 l_f14))
...
(assert (or (not r_p2) (not r_p8) r_f2_p))
...
;%~r_p7 | ~r_f2 | r_zcl_1
(assert (or (not r_p7) (not r_f2) r_zcl_1))
...
;%~r_p3 | ~r_f1 | r_zcl_2
(assert (or (not r_p3) (not r_f1) r_zcl_2))
...
(assert (or (not r_f4) r_p1 r_f5))


;%~r_p1 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p1) r_f4_p))
...
(assert (or (not r_p3) (not r_p5) r_f10_p))
...
;%~r_p2 | ~r_f10 | r_zcl_4
(assert (or (not r_p2) (not r_f10) r_zcl_4))
...
(assert (or (not r_p2) (not r_f10_p) r_f9_p))
...
;%~r_p1 | ~r_f9 | r_zcl_5
(assert (or (not r_p1) (not r_f9) r_zcl_5))
...
(assert (or (not r_p1) (not r_f9_p) r_f8_p))
...
(assert (or (not r_f13) r_p3 r_f14))
