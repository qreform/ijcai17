...
;%~p3 | ~f2 | zcl_2
(assert (or (not l_p3) (not l_f2) l_zcl_2))
...
;%~p3 | ~f2_p | f1_p
(assert (or (not l_p3) (not l_f2_p) l_f1_p))
...
;%~p3 | ~p8 | zcl_4
(assert (or (not l_p3) (not l_p8) l_zcl_4))
...
;%~p3 | ~p8 | f13_p
(assert (or (not l_p3) (not l_p8) l_f13_p))
...
;%~f17 | p2 | f18
(assert (or (not l_f17) l_p2 l_f18))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p2 | f18_p) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p2 | f17_p
(assert (or (not l_p2) l_f17_p))
...
;%~r_p3 | ~r_f2 | r_zcl_2
(assert (or (not r_p3) (not r_f2) r_zcl_2))
...
(assert (or (not r_p3) (not r_f2_p) r_f1_p))
...
(assert (or (not r_f5) r_p3 r_f6))


;%~r_p3 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p3) r_f5_p))
...
;%~r_p3 | ~r_p8 | r_zcl_4
(assert (or (not r_p3) (not r_p8) r_zcl_4))
...
(assert (or (not r_p3) (not r_p8) r_f13_p))
...
(assert (or (not r_f17) r_p2 r_f18))


;%~r_p2 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p2) r_f17_p))
