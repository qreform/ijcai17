...
;%~p11 | ~p10 | zcl_0
(assert (or (not l_p11) (not l_p10) l_zcl_0))
...
;%~p11 | ~p10 | f6_p
(assert (or (not l_p11) (not l_p10) l_f6_p))
...
;%~zcl_1 | p7
(assert (or (not l_zcl_1) l_p7))

;%~zcl_1 | f6
(assert (or (not l_zcl_1) l_f6))

;%~p7 | ~f6 | zcl_1
(assert (or (not l_p7) (not l_f6) l_zcl_1))
...
;%~p7 | ~f6_p | f5_p
(assert (or (not l_p7) (not l_f6_p) l_f5_p))
...
;%~p9 | ~f5 | zcl_2
(assert (or (not l_p9) (not l_f5) l_zcl_2))
...
;%~p9 | ~f5_p | f4_p
(assert (or (not l_p9) (not l_f5_p) l_f4_p))
...
;%~f17 | p4 | f18
(assert (or (not l_f17) l_p4 l_f18))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p4 | f18_p) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p4 | f17_p
(assert (or (not l_p4) l_f17_p))
...
;%~f16 | p6 | f17
(assert (or (not l_f16) l_p6 l_f17))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p6 | f17_p) --> f16_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f1) r_p7 r_f2))


;%~r_p7 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p7) r_f1_p))
...
;%~r_p11 | ~r_p10 | r_zcl_0
(assert (or (not r_p11) (not r_p10) r_zcl_0))
...
(assert (or (not r_p11) (not r_p10) r_f6_p))


;%~r_zcl_1 | r_p7
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p7))
...
;%~r_p7 | ~r_f6 | r_zcl_1
(assert (or (not r_p7) (not r_f6) r_zcl_1))
...
(assert (or (not r_p7) (not r_f6_p) r_f5_p))
...
;%~r_p9 | ~r_f5 | r_zcl_2
(assert (or (not r_p9) (not r_f5) r_zcl_2))
...
(assert (or (not r_p9) (not r_f5_p) r_f4_p))


;%~r_f10 | r_p0 | r_p8
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p0 r_p8))
...
(assert (or (not r_f17) r_p4 r_f18))


;%~r_p4 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p4) r_f17_p))
...
(assert (or (not r_f16) r_p6 r_f17))
