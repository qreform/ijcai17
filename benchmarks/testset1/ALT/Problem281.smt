...
;%~f4 | p17 | p19
(assert (or (not l_f4) l_p17 l_p19))
...
;%~f0 | p10 | f1
(assert (or (not l_f0) l_p10 l_f1))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p10 | f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
...
;%~p14 | ~p17 | zcl_0
(assert (or (not l_p14) (not l_p17) l_zcl_0))
...
;%Non-clausified dependency
;%(forall[]((p14 & p17) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p14 | ~p17 | f10_p
(assert (or (not l_p14) (not l_p17) l_f10_p))
...
;%~zcl_1 | p18
(assert (or (not l_zcl_1) l_p18))

;%~zcl_1 | f10
(assert (or (not l_zcl_1) l_f10))

;%~p18 | ~f10 | zcl_1
(assert (or (not l_p18) (not l_f10) l_zcl_1))
...
;%~p18 | ~f10_p | f9_p
(assert (or (not l_p18) (not l_f10_p) l_f9_p))
...
;%~p0 | ~f9 | zcl_2
(assert (or (not l_p0) (not l_f9) l_zcl_2))
...
;%~zcl_3 | p15
(assert (or (not l_zcl_3) l_p15))

;%~zcl_3 | f8
(assert (or (not l_zcl_3) l_f8))

;%~p15 | ~f8 | zcl_3
(assert (or (not l_p15) (not l_f8) l_zcl_3))
...
;%~p15 | ~f8_p | f7_p
(assert (or (not l_p15) (not l_f8_p) l_f7_p))
...
;%~p6 | ~f7 | zcl_4
(assert (or (not l_p6) (not l_f7) l_zcl_4))
...
;%~f16 | p16 | p13
(assert (or (not l_f16) l_p16 l_p13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p16 | p13) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p16 | f16_p
(assert (or (not l_p16) l_f16_p))

;%~p13 | f16_p
(assert (or (not l_p13) l_f16_p))
...
;%~f15 | p15 | f16
(assert (or (not l_f15) l_p15 l_f16))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p15 | f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p15 | f15_p
(assert (or (not l_p15) l_f15_p))
...
;%~f12 | p11 | f13
(assert (or (not l_f12) l_p11 l_f13))
...
;%~zcl_5 | p12
(assert (or (not l_zcl_5) l_p12))

;%~zcl_5 | p11
(assert (or (not l_zcl_5) l_p11))

;%~p12 | ~p11 | zcl_5
(assert (or (not l_p12) (not l_p11) l_zcl_5))
...
;%Non-clausified dependency
;%(forall[]((p12 & p11) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p12 | ~p11 | f22_p
(assert (or (not l_p12) (not l_p11) l_f22_p))
...
;%~p0 | ~f21 | zcl_7
(assert (or (not l_p0) (not l_f21) l_zcl_7))
...
;%~p10 | ~f20 | zcl_8
(assert (or (not l_p10) (not l_f20) l_zcl_8))
...
;%Non-clausified dependency
;%(forall[]((p10 & f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p10 | ~f20_p | f19_p
(assert (or (not l_p10) (not l_f20_p) l_f19_p))
...
;%~p0 | ~f19 | zcl_9
(assert (or (not l_p0) (not l_f19) l_zcl_9))
...
;%~f28 | p10 | p8
(assert (or (not l_f28) l_p10 l_p8))
...
;%~f26 | p9 | f27
(assert (or (not l_f26) l_p9 l_f27))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p9 | f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f4) r_p17 r_p19))
...
;%~r_p19 | r_f4_p
(assert (or (not r_p19) r_f4_p))


;%~r_f3 | r_p9 | r_f4
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_p9 r_f4))


;%~r_p9 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p9) r_f3_p))
...
(assert (or (not r_f1) r_p20 r_f2))


;%~r_p20 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p20) r_f1_p))
...
;%~r_p14 | ~r_p17 | r_zcl_0
(assert (or (not r_p14) (not r_p17) r_zcl_0))
...
(assert (or (not r_p14) (not r_p17) r_f10_p))


;%~r_zcl_1 | r_p18
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p18))
...
;%~r_p18 | ~r_f10 | r_zcl_1
(assert (or (not r_p18) (not r_f10) r_zcl_1))
...
;%~r_p18 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p18) (not r_f10_p) r_f9_p))
...
;%~r_p0 | ~r_f9 | r_zcl_2
(assert (or (not r_p0) (not r_f9) r_zcl_2))
...
;%~r_p15 | ~r_f8 | r_zcl_3
(assert (or (not r_p15) (not r_f8) r_zcl_3))
...
(assert (or (not r_p15) (not r_f8_p) r_f7_p))
...
;%~r_p6 | ~r_f7 | r_zcl_4
(assert (or (not r_p6) (not r_f7) r_zcl_4))
...
(assert (or (not r_f16) r_p16 r_p13))


;%~r_p16 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p16) r_f16_p))


;%~r_p13 | r_f16_p
(assert (or (not r_p13) r_f16_p))


;%~r_f15 | r_p15 | r_f16
(declare-fun r_f15 () Bool)
(assert (or (not r_f15) r_p15 r_f16))


;%~r_p15 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p15) r_f15_p))
...
(assert (or (not r_f12) r_p11 r_f13))


;%~r_p11 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p11) r_f12_p))
...
;%~r_p12 | ~r_p11 | r_zcl_5
(assert (or (not r_p12) (not r_p11) r_zcl_5))
...
(assert (or (not r_p12) (not r_p11) r_f22_p))
...
;%~r_p0 | ~r_f21 | r_zcl_7
(assert (or (not r_p0) (not r_f21) r_zcl_7))
...
;%~r_p10 | ~r_f20 | r_zcl_8
(assert (or (not r_p10) (not r_f20) r_zcl_8))
...
;%~r_p10 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p10) (not r_f20_p) r_f19_p))
...
;%~r_p0 | ~r_f19 | r_zcl_9
(assert (or (not r_p0) (not r_f19) r_zcl_9))
...
(assert (or (not r_f28) r_p10 r_p8))


;%~r_p10 | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p10) r_f28_p))
...
(assert (or (not r_f26) r_p9 r_f27))
