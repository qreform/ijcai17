...
;%~p0 | ~p11 | f12_p
(assert (or (not l_p0) (not l_p11) l_f12_p))
...
;%~p10 | ~f11 | zcl_2
(assert (or (not l_p10) (not l_f11) l_zcl_2))
...
;%~p7 | ~f10 | zcl_3
(assert (or (not l_p7) (not l_f10) l_zcl_3))
...
;%~p12 | ~f8 | zcl_5
(assert (or (not l_p12) (not l_f8) l_zcl_5))
...
;%~p8 | ~f24 | zcl_9
(assert (or (not l_p8) (not l_f24) l_zcl_9))
...
;%Non-clausified dependency
;%(forall[]((p8 & f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p8 | ~f24_p | f23_p
(assert (or (not l_p8) (not l_f24_p) l_f23_p))
...
(assert (or (not r_p0) (not r_p11) r_f12_p))
...
;%~r_p10 | ~r_f11 | r_zcl_2
(assert (or (not r_p10) (not r_f11) r_zcl_2))
...
;%~r_p7 | ~r_f10 | r_zcl_3
(assert (or (not r_p7) (not r_f10) r_zcl_3))
...
;%~r_p12 | ~r_f8 | r_zcl_5
(assert (or (not r_p12) (not r_f8) r_zcl_5))
...
;%~r_p8 | ~r_f24 | r_zcl_9
(assert (or (not r_p8) (not r_f24) r_zcl_9))
...
;%~r_p8 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p8) (not r_f24_p) r_f23_p))
