...
;%~p8 | ~p12 | zcl_0
(assert (or (not l_p8) (not l_p12) l_zcl_0))
...
;%~p8 | ~p12 | f12_p
(assert (or (not l_p8) (not l_p12) l_f12_p))
...
;%~p8 | ~f11 | zcl_2
(assert (or (not l_p8) (not l_f11) l_zcl_2))
...
;%~p9 | ~f9 | zcl_4
(assert (or (not l_p9) (not l_f9) l_zcl_4))
...
;%~f19 | p11 | p8
(assert (or (not l_f19) l_p11 l_p8))
...
;%~r_p8 | ~r_p12 | r_zcl_0
(assert (or (not r_p8) (not r_p12) r_zcl_0))
...
(assert (or (not r_p8) (not r_p12) r_f12_p))
...
;%~r_p8 | ~r_f11 | r_zcl_2
(assert (or (not r_p8) (not r_f11) r_zcl_2))
...
;%~r_p9 | ~r_f9 | r_zcl_4
(assert (or (not r_p9) (not r_f9) r_zcl_4))
...
(assert (or (not r_f19) r_p11 r_p8))
