...
;%~p0 | ~p8 | f1_p
(assert (or (not l_p0) (not l_p8) l_f1_p))
...
;%~p9 | ~f1 | zcl_1
(assert (or (not l_p9) (not l_f1) l_zcl_1))
...
;%~p6 | ~p5 | zcl_2
(assert (or (not l_p6) (not l_p5) l_zcl_2))
...
;%~p6 | ~p5 | f7_p
(assert (or (not l_p6) (not l_p5) l_f7_p))
...
(assert (or (not r_p0) (not r_p8) r_f1_p))
...
;%~r_p9 | ~r_f1 | r_zcl_1
(assert (or (not r_p9) (not r_f1) r_zcl_1))
...
;%~r_p6 | ~r_p5 | r_zcl_2
(assert (or (not r_p6) (not r_p5) r_zcl_2))
...
(assert (or (not r_p6) (not r_p5) r_f7_p))
