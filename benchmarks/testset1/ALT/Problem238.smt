...
;%~p0 | ~p18 | zcl_0
(assert (or (not l_p0) (not l_p18) l_zcl_0))
...
;%~p0 | ~p18 | f5_p
(assert (or (not l_p0) (not l_p18) l_f5_p))
...
;%~zcl_1 | p16
(assert (or (not l_zcl_1) l_p16))

;%~zcl_1 | f5
(assert (or (not l_zcl_1) l_f5))

;%~p16 | ~f5 | zcl_1
(assert (or (not l_p16) (not l_f5) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((~p16 & f5_p) --> f4_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f4_p () Bool)
;%~p16 | ~f5_p | f4_p
(assert (or (not l_p16) (not l_f5_p) l_f4_p))
...
;%~p19 | ~f4 | zcl_2
(assert (or (not l_p19) (not l_f4) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p19 & f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p19 | ~f4_p | f3_p
(assert (or (not l_p19) (not l_f4_p) l_f3_p))
...
;%~zcl_4 | p17
(assert (or (not l_zcl_4) l_p17))

;%~zcl_4 | f2
(assert (or (not l_zcl_4) l_f2))

;%~p17 | ~f2 | zcl_4
(assert (or (not l_p17) (not l_f2) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((~p17 & f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p17 | ~f2_p | f1_p
(assert (or (not l_p17) (not l_f2_p) l_f1_p))
...
;%~p0 | ~f1 | zcl_5
(assert (or (not l_p0) (not l_f1) l_zcl_5))
...
;%~f12 | p0 | p15
(assert (or (not l_f12) l_p0 l_p15))
...
;%~p0 | ~p13 | zcl_6
(assert (or (not l_p0) (not l_p13) l_zcl_6))
...
;%~p0 | ~p13 | f19_p
(assert (or (not l_p0) (not l_p13) l_f19_p))
...
;%~zcl_7 | p14
(assert (or (not l_zcl_7) l_p14))

;%~zcl_7 | f19
(assert (or (not l_zcl_7) l_f19))

;%~p14 | ~f19 | zcl_7
(assert (or (not l_p14) (not l_f19) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p14 | ~f19_p | f18_p
(assert (or (not l_p14) (not l_f19_p) l_f18_p))
...
;%~p0 | ~f17 | zcl_9
(assert (or (not l_p0) (not l_f17) l_zcl_9))
...
;%~p12 | ~f15 | zcl_11
(assert (or (not l_p12) (not l_f15) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((~p12 & f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p12 | ~f15_p | f14_p
(assert (or (not l_p12) (not l_f15_p) l_f14_p))
...
;%~f26 | p0 | p11
(assert (or (not l_f26) l_p0 l_p11))
...
;%~f24 | p7 | f25
(assert (or (not l_f24) l_p7 l_f25))
...
;%~f23 | p7 | f24
(assert (or (not l_f23) l_p7 l_f24))
...
;%~p10 | ~p7 | f33_p
(assert (or (not l_p10) (not l_p7) l_f33_p))
...
;%~p0 | ~f32 | zcl_14
(assert (or (not l_p0) (not l_f32) l_zcl_14))
...
;%~r_p0 | ~r_p18 | r_zcl_0
(assert (or (not r_p0) (not r_p18) r_zcl_0))
...
(assert (or (not r_p0) (not r_p18) r_f5_p))


;%~r_zcl_1 | r_p16
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p16))
...
;%~r_p16 | ~r_f5 | r_zcl_1
(assert (or (not r_p16) (not r_f5) r_zcl_1))
...
(assert (or (not r_p16) (not r_f5_p) r_f4_p))
...
;%~r_p19 | ~r_f4 | r_zcl_2
(assert (or (not r_p19) (not r_f4) r_zcl_2))
...
(assert (or (not r_p19) (not r_f4_p) r_f3_p))
...
;%~r_p17 | ~r_f2 | r_zcl_4
(assert (or (not r_p17) (not r_f2) r_zcl_4))
...
(assert (or (not r_p17) (not r_f2_p) r_f1_p))
...
;%~r_p0 | ~r_f1 | r_zcl_5
(assert (or (not r_p0) (not r_f1) r_zcl_5))
...
(assert (or (not r_f12) r_p0 r_p15))
...
(assert (or (not r_f8) r_p13 r_f9))


;%~r_p13 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p13) r_f8_p))
...
(assert (or (not r_f7) r_p12 r_f8))


;%~r_p12 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p12) r_f7_p))
...
;%~r_p0 | ~r_p13 | r_zcl_6
(assert (or (not r_p0) (not r_p13) r_zcl_6))
...
(assert (or (not r_p0) (not r_p13) r_f19_p))


;%~r_zcl_7 | r_p14
(declare-fun r_zcl_7 () Bool)
(assert (or (not r_zcl_7) r_p14))
...
;%~r_p14 | ~r_f19 | r_zcl_7
(assert (or (not r_p14) (not r_f19) r_zcl_7))
...
;%~r_p14 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p14) (not r_f19_p) r_f18_p))
...
;%~r_p0 | ~r_f17 | r_zcl_9
(assert (or (not r_p0) (not r_f17) r_zcl_9))
...
;%~r_p12 | ~r_f15 | r_zcl_11
(assert (or (not r_p12) (not r_f15) r_zcl_11))
...
;%~r_p12 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p12) (not r_f15_p) r_f14_p))


;%~r_f26 | r_p0 | r_p11
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_p0 r_p11))
...
(assert (or (not r_f24) r_p7 r_f25))


;%~r_p7 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p7) r_f24_p))
...
(assert (or (not r_f23) r_p7 r_f24))
...
(assert (or (not r_p10) (not r_p7) r_f33_p))
...
;%~r_p0 | ~r_f32 | r_zcl_14
(assert (or (not r_p0) (not r_f32) r_zcl_14))
