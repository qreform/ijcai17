...
;%~p5 | ~p6 | f1_p
(assert (or (not l_p5) (not l_p6) l_f1_p))
...
;%~p4 | ~p3 | f7_p
(assert (or (not l_p4) (not l_p3) l_f7_p))
...
(assert (or (not r_p5) (not r_p6) r_f1_p))
...
(assert (or (not r_p4) (not r_p3) r_f7_p))
