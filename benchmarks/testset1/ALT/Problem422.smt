...
;%~p1 | ~f3 | zcl_1
(assert (or (not l_p1) (not l_f3) l_zcl_1))
...
;%~p1 | ~f3_p | f2_p
(assert (or (not l_p1) (not l_f3_p) l_f2_p))
...
;%~p7 | ~f2 | zcl_2
(assert (or (not l_p7) (not l_f2) l_zcl_2))
...
;%~p7 | ~f2_p | f1_p
(assert (or (not l_p7) (not l_f2_p) l_f1_p))
...
;%~p7 | ~f1 | zcl_3
(assert (or (not l_p7) (not l_f1) l_zcl_3))
...
;%~p7 | ~f1_p | f0_p
(assert (or (not l_p7) (not l_f1_p) l_f0_p))
...
;%~p1 | ~p7 | zcl_4
(assert (or (not l_p1) (not l_p7) l_zcl_4))
...
;%~p1 | ~p7 | f13_p
(assert (or (not l_p1) (not l_p7) l_f13_p))
...
;%~p3 | ~f12 | zcl_6
(assert (or (not l_p3) (not l_f12) l_zcl_6))
...
;%~p2 | ~f11 | zcl_7
(assert (or (not l_p2) (not l_f11) l_zcl_7))
...
;%~f17 | p3 | f18
(assert (or (not l_f17) l_p3 l_f18))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p3 | f18_p) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p3 | f17_p
(assert (or (not l_p3) l_f17_p))
...
;%~r_p1 | ~r_f3 | r_zcl_1
(assert (or (not r_p1) (not r_f3) r_zcl_1))
...
(assert (or (not r_p1) (not r_f3_p) r_f2_p))
...
;%~r_p7 | ~r_f2 | r_zcl_2
(assert (or (not r_p7) (not r_f2) r_zcl_2))
...
(assert (or (not r_p7) (not r_f2_p) r_f1_p))
...
;%~r_p7 | ~r_f1 | r_zcl_3
(assert (or (not r_p7) (not r_f1) r_zcl_3))
...
(assert (or (not r_p7) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p0 | r_p8
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p0 r_p8))
...
;%~r_p1 | ~r_p7 | r_zcl_4
(assert (or (not r_p1) (not r_p7) r_zcl_4))
...
(assert (or (not r_p1) (not r_p7) r_f13_p))
...
;%~r_p3 | ~r_f12 | r_zcl_6
(assert (or (not r_p3) (not r_f12) r_zcl_6))
...
;%~r_p2 | ~r_f11 | r_zcl_7
(assert (or (not r_p2) (not r_f11) r_zcl_7))
...
(assert (or (not r_f17) r_p3 r_f18))


;%~r_p3 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p3) r_f17_p))
