...
;%~p8 | ~f9 | zcl_2
(assert (or (not l_p8) (not l_f9) l_zcl_2))
...
;%~p7 | ~f8 | zcl_3
(assert (or (not l_p7) (not l_f8) l_zcl_3))
...
;%~r_p8 | ~r_f9 | r_zcl_2
(assert (or (not r_p8) (not r_f9) r_zcl_2))
...
;%~r_p7 | ~r_f8 | r_zcl_3
(assert (or (not r_p7) (not r_f8) r_zcl_3))
