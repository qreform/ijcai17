...
;%~f5 | p20 | p14
(assert (or (not l_f5) l_p20 l_p14))
...
;%~f4 | p19 | f5
(assert (or (not l_f4) l_p19 l_f5))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p19 | f5_p) --> f4_p))
;%------------------------Clausification start------------------------%
...
;%~f0 | p15 | f1
(assert (or (not l_f0) l_p15 l_f1))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p15 | f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f0_p () Bool)
;%~p15 | f0_p
(assert (or (not l_p15) l_f0_p))
...
;%~p13 | ~p7 | zcl_0
(assert (or (not l_p13) (not l_p7) l_zcl_0))
...
;%~p12 | ~f12 | zcl_1
(assert (or (not l_p12) (not l_f12) l_zcl_1))
...
;%~p11 | ~f11 | zcl_2
(assert (or (not l_p11) (not l_f11) l_zcl_2))
...
(assert (or (not r_f5) r_p20 r_p14))


;%~r_p20 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p20) r_f5_p))
...
(assert (or (not r_f0) r_p15 r_f1))


;%~r_p15 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p15) r_f0_p))
...
;%~r_p13 | ~r_p7 | r_zcl_0
(assert (or (not r_p13) (not r_p7) r_zcl_0))
...
;%~r_p12 | ~r_f12 | r_zcl_1
(assert (or (not r_p12) (not r_f12) r_zcl_1))
...
;%~r_p11 | ~r_f11 | r_zcl_2
(assert (or (not r_p11) (not r_f11) r_zcl_2))
