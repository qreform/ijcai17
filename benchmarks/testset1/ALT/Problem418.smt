...
;%~p5 | ~p8 | zcl_0
(assert (or (not l_p5) (not l_p8) l_zcl_0))
...
;%~p5 | ~p8 | f2_p
(assert (or (not l_p5) (not l_p8) l_f2_p))
...
;%~p1 | ~p6 | zcl_3
(assert (or (not l_p1) (not l_p6) l_zcl_3))
...
;%~p1 | ~p6 | f10_p
(assert (or (not l_p1) (not l_p6) l_f10_p))
...
;%~r_p5 | ~r_p8 | r_zcl_0
(assert (or (not r_p5) (not r_p8) r_zcl_0))
...
(assert (or (not r_p5) (not r_p8) r_f2_p))
...
;%~r_p1 | ~r_p6 | r_zcl_3
(assert (or (not r_p1) (not r_p6) r_zcl_3))
...
(assert (or (not r_p1) (not r_p6) r_f10_p))
