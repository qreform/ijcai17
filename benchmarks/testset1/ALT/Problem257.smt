...
;%~f1 | p12 | p10
(assert (or (not l_f1) l_p12 l_p10))
...
;%~p7 | ~p8 | zcl_0
(assert (or (not l_p7) (not l_p8) l_zcl_0))
...
;%~p7 | ~p8 | f4_p
(assert (or (not l_p7) (not l_p8) l_f4_p))
...
;%~p3 | ~p5 | zcl_2
(assert (or (not l_p3) (not l_p5) l_zcl_2))
...
;%~p6 | ~f10 | zcl_3
(assert (or (not l_p6) (not l_f10) l_zcl_3))
...
(assert (or (not r_f1) r_p12 r_p10))
...
;%~r_p7 | ~r_p8 | r_zcl_0
(assert (or (not r_p7) (not r_p8) r_zcl_0))
...
(assert (or (not r_p7) (not r_p8) r_f4_p))
...
;%~r_p3 | ~r_p5 | r_zcl_2
(assert (or (not r_p3) (not r_p5) r_zcl_2))
...
;%~r_p6 | ~r_f10 | r_zcl_3
(assert (or (not r_p6) (not r_f10) r_zcl_3))
