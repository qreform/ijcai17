...
;%~p0 | ~p13 | f5_p
(assert (or (not l_p0) (not l_p13) l_f5_p))
...
;%~p12 | ~f5 | zcl_1
(assert (or (not l_p12) (not l_f5) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((p12 & f5_p) --> f4_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f4_p () Bool)
;%~p12 | ~f5_p | f4_p
(assert (or (not l_p12) (not l_f5_p) l_f4_p))
...
;%~p10 | ~p7 | f19_p
(assert (or (not l_p10) (not l_p7) l_f19_p))
...
;%~p9 | ~f17 | zcl_9
(assert (or (not l_p9) (not l_f17) l_zcl_9))
...
(assert (or (not r_p0) (not r_p13) r_f5_p))
...
;%~r_p12 | ~r_f5 | r_zcl_1
(assert (or (not r_p12) (not r_f5) r_zcl_1))
...
(assert (or (not r_p12) (not r_f5_p) r_f4_p))
...
(assert (or (not r_p10) (not r_p7) r_f19_p))
...
;%~r_p9 | ~r_f17 | r_zcl_9
(assert (or (not r_p9) (not r_f17) r_zcl_9))
