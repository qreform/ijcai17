%%%%%%%%%%%%%%%% Target reformulation: ((p6 | ~p5) & ((~p0 & ~p4) | ((~p3 | ~p2) & (p1 | ~p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom4,axiom,(~zcl_6 | p0)) .
cnf(l_axiom5,axiom,(~zcl_6 | p4)) .
cnf(l_axiom6,axiom,(~p0 | ~p4 | zcl_6)) .
...
cnf(r_axiom10,axiom,(~acc_zcl_6 | acc_p0)) .
cnf(r_axiom11,axiom,(~acc_zcl_6 | acc_p4)) .
cnf(r_axiom12,axiom,(~acc_p0 | ~acc_p4 | acc_zcl_6)) .
cnf(r_axiom13,axiom,(~acc_f2 | acc_zcl_6)) .
cnf(r_axiom14,axiom,(~acc_p0 | ~acc_p4 | acc_f2_p)) .
cnf(r_axiom15,axiom,(~acc_f4 | acc_p3 | acc_p2)) .
