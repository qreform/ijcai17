...
;%~f4 | p29 | p24
(assert (or (not l_f4) l_p29 l_p24))
...
;%~p29 | f4_p
(assert (or (not l_p29) l_f4_p))

;%~p24 | f4_p
(assert (or (not l_p24) l_f4_p))
...
;%~f3 | p28 | f4
(assert (or (not l_f3) l_p28 l_f4))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p28 | f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p28 | f3_p
(assert (or (not l_p28) l_f3_p))
...
;%~f2 | p27 | f3
(assert (or (not l_f2) l_p27 l_f3))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p27 | f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p27 | f2_p
(assert (or (not l_p27) l_f2_p))
...
;%Non-clausified dependency
;%(forall[]((p23 & p18) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p23 | ~p18 | f10_p
(assert (or (not l_p23) (not l_p18) l_f10_p))
...
;%~p22 | ~f10 | zcl_1
(assert (or (not l_p22) (not l_f10) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((p22 & f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p22 | ~f10_p | f9_p
(assert (or (not l_p22) (not l_f10_p) l_f9_p))
...
;%~p21 | ~f9 | zcl_2
(assert (or (not l_p21) (not l_f9) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p21 & f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p21 | ~f9_p | f8_p
(assert (or (not l_p21) (not l_f9_p) l_f8_p))
...
;%~p20 | ~f8 | zcl_3
(assert (or (not l_p20) (not l_f8) l_zcl_3))
...
;%Non-clausified dependency
;%(forall[]((p20 & f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p20 | ~f8_p | f7_p
(assert (or (not l_p20) (not l_f8_p) l_f7_p))
...
;%~p19 | ~f7 | zcl_4
(assert (or (not l_p19) (not l_f7) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p19 & f7_p) --> f6_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f6_p () Bool)
;%~p19 | ~f7_p | f6_p
(assert (or (not l_p19) (not l_f7_p) l_f6_p))
...
;%~p11 | ~p6 | f22_p
(assert (or (not l_p11) (not l_p6) l_f22_p))
...
;%~p10 | ~f22 | zcl_6
(assert (or (not l_p10) (not l_f22) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p10 & f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p10 | ~f22_p | f21_p
(assert (or (not l_p10) (not l_f22_p) l_f21_p))
...
;%~p9 | ~f21 | zcl_7
(assert (or (not l_p9) (not l_f21) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p9 & f21_p) --> f20_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f20_p () Bool)
;%~p9 | ~f21_p | f20_p
(assert (or (not l_p9) (not l_f21_p) l_f20_p))
...
;%~p8 | ~f20 | zcl_8
(assert (or (not l_p8) (not l_f20) l_zcl_8))
...
;%~p8 | ~f20_p | f19_p
(assert (or (not l_p8) (not l_f20_p) l_f19_p))
...
;%~p7 | ~f19 | zcl_9
(assert (or (not l_p7) (not l_f19) l_zcl_9))
...
(assert (or (not r_f4) r_p29 r_p24))


;%~r_p29 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p29) r_f4_p))


;%~r_p24 | r_f4_p
(assert (or (not r_p24) r_f4_p))


;%~r_f3 | r_p28 | r_f4
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_p28 r_f4))


;%~r_p28 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p28) r_f3_p))
...
(assert (or (not r_f2) r_p27 r_f3))


;%~r_p27 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p27) r_f2_p))
...
(assert (or (not r_f1) r_p26 r_f2))


;%~r_p26 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p26) r_f1_p))
...
(assert (or (not r_f0) r_p25 r_f1))


;%~r_p25 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p25) r_f0_p))
...
(assert (or (not r_p23) (not r_p18) r_f10_p))
...
;%~r_p22 | ~r_f10 | r_zcl_1
(assert (or (not r_p22) (not r_f10) r_zcl_1))
...
;%~r_p22 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p22) (not r_f10_p) r_f9_p))
...
;%~r_p21 | ~r_f9 | r_zcl_2
(assert (or (not r_p21) (not r_f9) r_zcl_2))
...
(assert (or (not r_p21) (not r_f9_p) r_f8_p))
...
;%~r_p20 | ~r_f8 | r_zcl_3
(assert (or (not r_p20) (not r_f8) r_zcl_3))
...
(assert (or (not r_p20) (not r_f8_p) r_f7_p))
...
;%~r_p19 | ~r_f7 | r_zcl_4
(assert (or (not r_p19) (not r_f7) r_zcl_4))
...
(assert (or (not r_p19) (not r_f7_p) r_f6_p))
...
(assert (or (not r_p11) (not r_p6) r_f22_p))
...
;%~r_p10 | ~r_f22 | r_zcl_6
(assert (or (not r_p10) (not r_f22) r_zcl_6))
...
;%~r_p10 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p10) (not r_f22_p) r_f21_p))
...
;%~r_p9 | ~r_f21 | r_zcl_7
(assert (or (not r_p9) (not r_f21) r_zcl_7))
...
;%~r_p9 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p9) (not r_f21_p) r_f20_p))
...
;%~r_p8 | ~r_f20 | r_zcl_8
(assert (or (not r_p8) (not r_f20) r_zcl_8))
...
;%~r_p8 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p8) (not r_f20_p) r_f19_p))
...
;%~r_p7 | ~r_f19 | r_zcl_9
(assert (or (not r_p7) (not r_f19) r_zcl_9))
