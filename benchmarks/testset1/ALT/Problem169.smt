...
;%~f2 | p11 | f3
(assert (or (not l_f2) l_p11 l_f3))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p11 | f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p11 | f2_p
(assert (or (not l_p11) l_f2_p))
...
;%~p6 | ~p11 | zcl_0
(assert (or (not l_p6) (not l_p11) l_zcl_0))
...
;%~p6 | ~p11 | f10_p
(assert (or (not l_p6) (not l_p11) l_f10_p))
...
;%~p13 | ~f10 | zcl_1
(assert (or (not l_p13) (not l_f10) l_zcl_1))
...
;%~p13 | ~f10_p | f9_p
(assert (or (not l_p13) (not l_f10_p) l_f9_p))
...
;%~p10 | ~f7 | zcl_4
(assert (or (not l_p10) (not l_f7) l_zcl_4))
...
;%~p10 | ~f7_p | f6_p
(assert (or (not l_p10) (not l_f7_p) l_f6_p))
...
;%~f16 | p0 | p10
(assert (or (not l_f16) l_p0 l_p10))
...
;%~p9 | ~p6 | f22_p
(assert (or (not l_p9) (not l_p6) l_f22_p))
...
;%~p8 | ~f21 | zcl_7
(assert (or (not l_p8) (not l_f21) l_zcl_7))
...
;%~p7 | ~f20 | zcl_8
(assert (or (not l_p7) (not l_f20) l_zcl_8))
...
;%~p5 | ~p0 | f27_p
(assert (or (not l_p5) (not l_p0) l_f27_p))
...
;%~zcl_11 | f27
(assert (or (not l_zcl_11) l_f27))

;%~p4 | ~f27 | zcl_11
(assert (or (not l_p4) (not l_f27) l_zcl_11))

(declare-fun l_f26 () Bool)
;%~f26 | zcl_11
(assert (or (not l_f26) l_zcl_11))
...
;%~p4 | ~f27_p | f26_p
(assert (or (not l_p4) (not l_f27_p) l_f26_p))
...
;%~zcl_12 | f26
(assert (or (not l_zcl_12) l_f26))

;%~p3 | ~f26 | zcl_12
(assert (or (not l_p3) (not l_f26) l_zcl_12))
...
;%~p3 | ~f26_p | f25_p
(assert (or (not l_p3) (not l_f26_p) l_f25_p))
...
;%~p2 | ~f25 | zcl_13
(assert (or (not l_p2) (not l_f25) l_zcl_13))
...
;%~p2 | ~f25_p | f24_p
(assert (or (not l_p2) (not l_f25_p) l_f24_p))
...
;%~p1 | ~f24 | zcl_14
(assert (or (not l_p1) (not l_f24) l_zcl_14))
...
;%~p1 | ~f24_p | f23_p
(assert (or (not l_p1) (not l_f24_p) l_f23_p))
...
;%~zcl_15 | f12
(assert (or (not l_zcl_15) l_f12))

;%~zcl_15 | f17
(assert (or (not l_zcl_15) l_f17))

;%~f12 | ~f17 | zcl_15
(assert (or (not l_f12) (not l_f17) l_zcl_15))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_15
(assert (or (not l_f11) l_zcl_15))
...
;%~zcl_16 | f0
(assert (or (not l_zcl_16) l_f0))

;%~zcl_16 | f5
(assert (or (not l_zcl_16) l_f5))

;%~f0 | ~f5 | zcl_16
(assert (or (not l_f0) (not l_f5) l_zcl_16))

;%~Q | zcl_16
(assert (or (not l_q) l_zcl_16))
...
(assert (or (not r_f2) r_p11 r_f3))


;%~r_p11 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p11) r_f2_p))
...
(assert (or (not r_f1) r_p6 r_f2))


;%~r_p6 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p6) r_f1_p))
...
;%~r_p6 | ~r_p11 | r_zcl_0
(assert (or (not r_p6) (not r_p11) r_zcl_0))
...
(assert (or (not r_p6) (not r_p11) r_f10_p))
...
;%~r_p13 | ~r_f10 | r_zcl_1
(assert (or (not r_p13) (not r_f10) r_zcl_1))
...
;%~r_p13 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p13) (not r_f10_p) r_f9_p))
...
;%~r_p10 | ~r_f7 | r_zcl_4
(assert (or (not r_p10) (not r_f7) r_zcl_4))
...
(assert (or (not r_p10) (not r_f7_p) r_f6_p))


;%~r_f16 | r_p0 | r_p10
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_p0 r_p10))
...
(assert (or (not r_p9) (not r_p6) r_f22_p))
...
;%~r_p8 | ~r_f21 | r_zcl_7
(assert (or (not r_p8) (not r_f21) r_zcl_7))
...
;%~r_p7 | ~r_f20 | r_zcl_8
(assert (or (not r_p7) (not r_f20) r_zcl_8))
...
(assert (or (not r_f27) r_zcl_10))


;%~r_p5 | ~r_p0 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p5) (not r_p0) r_f27_p))
...
;%~r_zcl_11 | r_f27
(assert (or (not r_zcl_11) r_f27))


;%~r_p4 | ~r_f27 | r_zcl_11
(assert (or (not r_p4) (not r_f27) r_zcl_11))


;%~r_f26 | r_zcl_11
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_zcl_11))


;%~r_p4 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p4) (not r_f27_p) r_f26_p))
...
;%~r_zcl_12 | r_f26
(assert (or (not r_zcl_12) r_f26))


;%~r_p3 | ~r_f26 | r_zcl_12
(assert (or (not r_p3) (not r_f26) r_zcl_12))
...
;%~r_p3 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p3) (not r_f26_p) r_f25_p))
...
;%~r_p2 | ~r_f25 | r_zcl_13
(assert (or (not r_p2) (not r_f25) r_zcl_13))
...
;%~r_p2 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p2) (not r_f25_p) r_f24_p))
...
;%~r_p1 | ~r_f24 | r_zcl_14
(assert (or (not r_p1) (not r_f24) r_zcl_14))
...
;%~r_p1 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p1) (not r_f24_p) r_f23_p))
...
;%~r_f12 | ~r_f17 | r_zcl_15
(assert (or (not r_f12) (not r_f17) r_zcl_15))


;%~r_f11 | r_zcl_15
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_15))
...
(assert (or (not r_zcl_16) r_f0))


;%~r_zcl_16 | r_f5
(assert (or (not r_zcl_16) r_f5))


;%~r_f0 | ~r_f5 | r_zcl_16
(assert (or (not r_f0) (not r_f5) r_zcl_16))


;%~r_Q | r_zcl_16
(declare-fun r_q () Bool)
(assert (or (not r_q) r_zcl_16))
