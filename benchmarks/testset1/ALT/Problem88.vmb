%%%%%%%%%%%%%%%% Target reformulation: ((~p8 & (~p6 & (p9 & ~p7))) | ((~p0 | (~p0 | (~p6 | ~p5))) & ((~p0 & (p0 & (p0 & ~p4))) | (p1 & (p2 & (~p3 & ~p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom25,axiom,(~zcl_23 | p0)) .
cnf(l_axiom26,axiom,(~zcl_23 | p4)) .
cnf(l_axiom27,axiom,(~p0 | ~p4 | zcl_23)) .
cnf(l_axiom28,axiom,(~f10 | zcl_23)) .
cnf(l_axiom29,axiom,(~p0 | ~p4 | f10_p)) .
...
cnf(r_axiom10,axiom,(~acc_zcl_20 | acc_p9)) .
cnf(r_axiom11,axiom,(~acc_zcl_20 | acc_p7)) .
cnf(r_axiom12,axiom,(~acc_p9 | ~acc_p7 | acc_zcl_20)) .
cnf(r_axiom13,axiom,(~acc_f2 | acc_zcl_20)) .
cnf(r_axiom14,axiom,(~acc_p9 | ~acc_p7 | acc_f2_p)) .
cnf(r_axiom15,axiom,(~acc_zcl_21 | acc_p6)) .
cnf(r_axiom16,axiom,(~acc_zcl_21 | acc_f2)) .
cnf(r_axiom17,axiom,(~acc_p6 | ~acc_f2 | acc_zcl_21)) .
cnf(r_axiom18,axiom,(~acc_f1 | acc_zcl_21)) .
cnf(r_axiom19,axiom,(~acc_p6 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom20,axiom,(~acc_zcl_22 | acc_p8)) .
cnf(r_axiom21,axiom,(~acc_zcl_22 | acc_f1)) .
cnf(r_axiom22,axiom,(~acc_p8 | ~acc_f1 | acc_zcl_22)) .
cnf(r_axiom23,axiom,(~acc_f0 | acc_zcl_22)) .
cnf(r_axiom24,axiom,(~acc_p8 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom25,axiom,(~acc_f6 | acc_p6 | acc_p5)) .
cnf(r_axiom26,axiom,(~acc_p6 | acc_f6_p)) .
cnf(r_axiom27,axiom,(~acc_p5 | acc_f6_p)) .
cnf(r_axiom28,axiom,(~acc_f5 | acc_p0 | acc_f6)) .
cnf(r_axiom29,axiom,(~acc_p0 | acc_f5_p)) .
...
cnf(r_axiom34,axiom,(~acc_zcl_23 | acc_p0)) .
cnf(r_axiom35,axiom,(~acc_zcl_23 | acc_p4)) .
cnf(r_axiom36,axiom,(~acc_p0 | ~acc_p4 | acc_zcl_23)) .
cnf(r_axiom37,axiom,(~acc_f10 | acc_zcl_23)) .
cnf(r_axiom38,axiom,(~acc_p0 | ~acc_p4 | acc_f10_p)) .
