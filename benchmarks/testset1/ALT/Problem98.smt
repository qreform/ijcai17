;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p6 & (~p5 & (p0 & (~p6 & p9)))) | ((~p7 | (~p0 | (~p8 | (~p0 | ~p6)))) & ((~p0 & (p0 & (~p0 & (~p0 & ~p5)))) | (p1 & (~p2 & (~p3 & (~p4 & ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p6 | ~f1 | zcl_3
(assert (or (not l_p6) (not l_f1) l_zcl_3))
...
;%~r_p6 | ~r_f1 | r_zcl_3
(assert (or (not r_p6) (not r_f1) r_zcl_3))
