...
cnf(l_axiom1,axiom,(~zcl_8 | p9)) .
cnf(l_axiom2,axiom,(~zcl_8 | p8)) .
cnf(l_axiom3,axiom,(~p9 | ~p8 | zcl_8)) .
...
cnf(l_axiom9,axiom,(~zcl_9 | p5)) .
cnf(l_axiom10,axiom,(~zcl_9 | p4)) .
cnf(l_axiom11,axiom,(~p5 | ~p4 | zcl_9)) .
...
cnf(r_axiom10,axiom,(~acc_zcl_8 | acc_p9)) .
cnf(r_axiom11,axiom,(~acc_zcl_8 | acc_p8)) .
cnf(r_axiom12,axiom,(~acc_p9 | ~acc_p8 | acc_zcl_8)) .
cnf(r_axiom13,axiom,(~acc_f0 | acc_zcl_8)) .
...
cnf(r_axiom19,axiom,(~acc_zcl_9 | acc_p4)) .
cnf(r_axiom20,axiom,(~acc_p5 | ~acc_p4 | acc_zcl_9)) .
cnf(r_axiom21,axiom,(~acc_f4 | acc_zcl_9)) .
cnf(r_axiom22,axiom,(~acc_p5 | ~acc_p4 | acc_f4_p)) .
cnf(r_axiom23,axiom,(~acc_f6 | acc_p3 | acc_p2)) .
cnf(r_axiom24,axiom,(~acc_p3 | acc_f6_p)) .
cnf(r_axiom25,axiom,(~acc_p2 | acc_f6_p)) .
cnf(r_axiom26,axiom,(~acc_f7 | acc_p1 | acc_p0)) .
cnf(r_axiom27,axiom,(~acc_p1 | acc_f7_p)) .
cnf(r_axiom28,axiom,(~acc_p0 | acc_f7_p)) .
cnf(r_axiom29,axiom,(~acc_zcl_10 | acc_f6)) .
cnf(r_axiom30,axiom,(~acc_zcl_10 | acc_f7)) .
cnf(r_axiom31,axiom,(~acc_f6 | ~acc_f7 | acc_zcl_10)) .
cnf(r_axiom32,axiom,(~acc_f5 | acc_zcl_10)) .
cnf(r_axiom33,axiom,(~acc_f6_p | ~acc_f7_p | acc_f5_p)) .
cnf(r_axiom34,axiom,(~acc_f3 | acc_f4 | acc_f5)) .
cnf(r_axiom35,axiom,(~acc_f4_p | acc_f3_p)) .
cnf(r_axiom36,axiom,(~acc_f5_p | acc_f3_p)) .
cnf(r_axiom37,axiom,(~acc_zcl_11 | acc_f2)) .
cnf(r_axiom38,axiom,(~acc_zcl_11 | acc_f3)) .
cnf(r_axiom39,axiom,(~acc_f2 | ~acc_f3 | acc_zcl_11)) .
cnf(r_axiom40,axiom,(~acc_f1 | acc_zcl_11)) .
cnf(r_axiom41,axiom,(~acc_f2_p | ~acc_f3_p | acc_f1_p)) .
