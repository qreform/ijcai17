;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p9 | p8) & ((p5 & p7) | ((p2 | p6) & ((p2 & p5) | ((p0 | p4) & ((p3 & p2) | (p1 & p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p2 | ~p5 | zcl_1
(assert (or (not l_p2) (not l_p5) l_zcl_1))
...
;%~p2 | ~p5 | f6_p
(assert (or (not l_p2) (not l_p5) l_f6_p))
...
;%~r_p2 | ~r_p5 | r_zcl_1
(assert (or (not r_p2) (not r_p5) r_zcl_1))
...
(assert (or (not r_p2) (not r_p5) r_f6_p))


;%~r_f8 | r_p0 | r_p4
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p0 r_p4))
