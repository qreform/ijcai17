...
;%~p2 | ~p5 | f0_p
(assert (or (not l_p2) (not l_p5) l_f0_p))
...
;%~p1 | ~p3 | zcl_1
(assert (or (not l_p1) (not l_p3) l_zcl_1))
...
;%~p1 | ~p3 | f4_p
(assert (or (not l_p1) (not l_p3) l_f4_p))
...
(assert (or (not r_p2) (not r_p5) r_f0_p))


;%~r_f2 | r_p1 | r_p4
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p1 r_p4))
...
;%~r_p1 | ~r_p3 | r_zcl_1
(assert (or (not r_p1) (not r_p3) r_zcl_1))
...
(assert (or (not r_p1) (not r_p3) r_f4_p))


;%~r_f6 | r_p0 | r_p2
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_p0 r_p2))
