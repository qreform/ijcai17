%%%%%%%%%%%%%%%% Target reformulation: ((p3 & p5) | ((p4 | p3) & ((p0 & p2) | (p1 & p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p3 | ~p5 | zcl_8)) .
cnf(l_axiom4,axiom,(~f0 | zcl_8)) .
cnf(l_axiom5,axiom,(~p3 | ~p5 | f0_p)) .
...
cnf(r_axiom6,axiom,(~acc_zcl_8 | acc_p3)) .
cnf(r_axiom7,axiom,(~acc_zcl_8 | acc_p5)) .
cnf(r_axiom8,axiom,(~acc_p3 | ~acc_p5 | acc_zcl_8)) .
cnf(r_axiom9,axiom,(~acc_f0 | acc_zcl_8)) .
cnf(r_axiom10,axiom,(~acc_p3 | ~acc_p5 | acc_f0_p)) .
