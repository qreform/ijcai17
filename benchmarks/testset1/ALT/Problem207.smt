...
;%~p8 | ~p11 | f2_p
(assert (or (not l_p8) (not l_p11) l_f2_p))
...
;%~p9 | ~p8 | zcl_3
(assert (or (not l_p9) (not l_p8) l_zcl_3))
...
;%~p9 | ~p8 | f10_p
(assert (or (not l_p9) (not l_p8) l_f10_p))
...
(assert (or (not r_p8) (not r_p11) r_f2_p))
...
;%~r_p9 | ~r_p8 | r_zcl_3
(assert (or (not r_p9) (not r_p8) r_zcl_3))
...
(assert (or (not r_p9) (not r_p8) r_f10_p))
