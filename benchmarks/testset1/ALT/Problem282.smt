...
;%~f3 | p18 | f4
(assert (or (not l_f3) l_p18 l_f4))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p18 | f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p18 | f3_p
(assert (or (not l_p18) l_f3_p))
...
;%~f2 | p16 | f3
(assert (or (not l_f2) l_p16 l_f3))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p16 | f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p16 | f2_p
(assert (or (not l_p16) l_f2_p))
...
;%~p8 | ~p16 | zcl_0
(assert (or (not l_p8) (not l_p16) l_zcl_0))
...
;%~p8 | ~p16 | f10_p
(assert (or (not l_p8) (not l_p16) l_f10_p))
...
;%~p6 | ~f10 | zcl_1
(assert (or (not l_p6) (not l_f10) l_zcl_1))
...
;%~zcl_2 | p14
(assert (or (not l_zcl_2) l_p14))

;%~zcl_2 | f9
(assert (or (not l_zcl_2) l_f9))

;%~p14 | ~f9 | zcl_2
(assert (or (not l_p14) (not l_f9) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p14 & f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p14 | ~f9_p | f8_p
(assert (or (not l_p14) (not l_f9_p) l_f8_p))
...
;%~zcl_3 | p12
(assert (or (not l_zcl_3) l_p12))

;%~zcl_3 | f8
(assert (or (not l_zcl_3) l_f8))

;%~p12 | ~f8 | zcl_3
(assert (or (not l_p12) (not l_f8) l_zcl_3))
...
;%Non-clausified dependency
;%(forall[]((p12 & f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p12 | ~f8_p | f7_p
(assert (or (not l_p12) (not l_f8_p) l_f7_p))
...
;%~p14 | ~f7 | zcl_4
(assert (or (not l_p14) (not l_f7) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p14 & f7_p) --> f6_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f6_p () Bool)
;%~p14 | ~f7_p | f6_p
(assert (or (not l_p14) (not l_f7_p) l_f6_p))
...
;%~f16 | p15 | p12
(assert (or (not l_f16) l_p15 l_p12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p15 | p12) --> f16_p))
;%------------------------Clausification start------------------------%
...
;%~f14 | p14 | f15
(assert (or (not l_f14) l_p14 l_f15))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p14 | f14_p
(assert (or (not l_p14) l_f14_p))
...
;%~f13 | p0 | f14
(assert (or (not l_f13) l_p0 l_f14))
...
;%~zcl_5 | p9
(assert (or (not l_zcl_5) l_p9))

;%~p11 | ~p9 | zcl_5
(assert (or (not l_p11) (not l_p9) l_zcl_5))
...
;%~p11 | ~p9 | f22_p
(assert (or (not l_p11) (not l_p9) l_f22_p))
...
;%~p8 | ~f22 | zcl_6
(assert (or (not l_p8) (not l_f22) l_zcl_6))
...
;%~p6 | ~f20 | zcl_8
(assert (or (not l_p6) (not l_f20) l_zcl_8))
...
;%~zcl_9 | p6
(assert (or (not l_zcl_9) l_p6))

;%~zcl_9 | f19
(assert (or (not l_zcl_9) l_f19))

;%~p6 | ~f19 | zcl_9
(assert (or (not l_p6) (not l_f19) l_zcl_9))
...
;%~p0 | ~p6 | f34_p
(assert (or (not l_p0) (not l_p6) l_f34_p))
...
;%~p7 | ~f32 | zcl_13
(assert (or (not l_p7) (not l_f32) l_zcl_13))
...
;%Non-clausified dependency
;%(forall[]((p7 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p7 | ~f32_p | f31_p
(assert (or (not l_p7) (not l_f32_p) l_f31_p))
...
;%~p0 | ~f31 | zcl_14
(assert (or (not l_p0) (not l_f31) l_zcl_14))
...
(assert (or (not r_f3) r_p18 r_f4))


;%~r_p18 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p18) r_f3_p))
...
(assert (or (not r_f2) r_p16 r_f3))


;%~r_p16 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p16) r_f2_p))
...
(assert (or (not r_f1) r_p8 r_f2))


;%~r_p8 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p8) r_f1_p))
...
(assert (or (not r_f0) r_p8 r_f1))


;%~r_p8 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p8) r_f0_p))
...
;%~r_p8 | ~r_p16 | r_zcl_0
(assert (or (not r_p8) (not r_p16) r_zcl_0))
...
(assert (or (not r_p8) (not r_p16) r_f10_p))
...
;%~r_p6 | ~r_f10 | r_zcl_1
(assert (or (not r_p6) (not r_f10) r_zcl_1))
...
;%~r_p14 | ~r_f9 | r_zcl_2
(assert (or (not r_p14) (not r_f9) r_zcl_2))
...
(assert (or (not r_p14) (not r_f9_p) r_f8_p))


;%~r_zcl_3 | r_p12
(declare-fun r_zcl_3 () Bool)
(assert (or (not r_zcl_3) r_p12))
...
;%~r_p12 | ~r_f8 | r_zcl_3
(assert (or (not r_p12) (not r_f8) r_zcl_3))
...
(assert (or (not r_p12) (not r_f8_p) r_f7_p))
...
;%~r_p14 | ~r_f7 | r_zcl_4
(assert (or (not r_p14) (not r_f7) r_zcl_4))
...
(assert (or (not r_p14) (not r_f7_p) r_f6_p))


;%~r_f16 | r_p15 | r_p12
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_p15 r_p12))
...
(assert (or (not r_f14) r_p14 r_f15))


;%~r_p14 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p14) r_f14_p))
...
(assert (or (not r_f13) r_p0 r_f14))
...
;%~r_zcl_5 | r_p9
(assert (or (not r_zcl_5) r_p9))


;%~r_p11 | ~r_p9 | r_zcl_5
(assert (or (not r_p11) (not r_p9) r_zcl_5))
...
(assert (or (not r_p11) (not r_p9) r_f22_p))
...
;%~r_p8 | ~r_f22 | r_zcl_6
(assert (or (not r_p8) (not r_f22) r_zcl_6))
...
;%~r_p6 | ~r_f20 | r_zcl_8
(assert (or (not r_p6) (not r_f20) r_zcl_8))
...
;%~r_p6 | ~r_f19 | r_zcl_9
(assert (or (not r_p6) (not r_f19) r_zcl_9))
...
(assert (or (not r_p0) (not r_p6) r_f34_p))
...
;%~r_p7 | ~r_f32 | r_zcl_13
(assert (or (not r_p7) (not r_f32) r_zcl_13))
...
;%~r_p7 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p7) (not r_f32_p) r_f31_p))
...
;%~r_p0 | ~r_f31 | r_zcl_14
(assert (or (not r_p0) (not r_f31) r_zcl_14))
