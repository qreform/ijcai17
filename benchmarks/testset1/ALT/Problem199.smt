...
;%~p4 | ~p10 | f1_p
(assert (or (not l_p4) (not l_p10) l_f1_p))
...
;%~p7 | ~f7 | zcl_3
(assert (or (not l_p7) (not l_f7) l_zcl_3))
...
(assert (or (not r_p4) (not r_p10) r_f1_p))
...
;%~r_p7 | ~r_f7 | r_zcl_3
(assert (or (not r_p7) (not r_f7) r_zcl_3))
