;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p4 | p9)) & ((p3 & (p8 & p7)) | ((p2 | (p2 | p6)) & ((p0 & (p5 & p4)) | ((p1 | (p1 | p3)) & (p1 | (p2 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p7 | f4_p
(assert (or (not l_p8) (not l_p7) l_f4_p))
...
;%~p3 | ~f4 | zcl_1
(assert (or (not l_p3) (not l_f4) l_zcl_1))
...
;%~p3 | ~f4_p | f3_p
(assert (or (not l_p3) (not l_f4_p) l_f3_p))
...
(assert (or (not r_p8) (not r_p7) r_f4_p))
...
;%~r_p3 | ~r_f4 | r_zcl_1
(assert (or (not r_p3) (not r_f4) r_zcl_1))
...
(assert (or (not r_p3) (not r_f4_p) r_f3_p))


;%~r_f7 | r_p2 | r_p6
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_p2 r_p6))
