...
;%~p0 | ~p10 | zcl_0
(assert (or (not l_p0) (not l_p10) l_zcl_0))
...
;%~p0 | ~p10 | f10_p
(assert (or (not l_p0) (not l_p10) l_f10_p))
...
;%~f14 | p9 | f15
(assert (or (not l_f14) l_p9 l_f15))
...
;%~r_p0 | ~r_p10 | r_zcl_0
(assert (or (not r_p0) (not r_p10) r_zcl_0))
...
(assert (or (not r_p0) (not r_p10) r_f10_p))
...
(assert (or (not r_f14) r_p9 r_f15))


;%~r_p9 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p9) r_f14_p))
