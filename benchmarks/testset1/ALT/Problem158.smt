...
;%~p11 | ~p10 | f8_p
(assert (or (not l_p11) (not l_p10) l_f8_p))
...
;%~p9 | ~f7 | zcl_2
(assert (or (not l_p9) (not l_f7) l_zcl_2))
...
(assert (or (not r_p11) (not r_p10) r_f8_p))
...
;%~r_p9 | ~r_f7 | r_zcl_2
(assert (or (not r_p9) (not r_f7) r_zcl_2))
