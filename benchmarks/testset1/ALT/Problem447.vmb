%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | ~p7) & ((~p0 & ~p6) | ((p0 | ~p5) & ((~p4 & ~p3) | ((p0 | p2) & (p1 | p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~f0 | p1 | p7)) .
cnf(l_axiom2,axiom,(~p1 | f0_p)) .
cnf(l_axiom3,axiom,(~p7 | f0_p)) .
cnf(l_axiom4,axiom,(~zcl_10 | p0)) .
cnf(l_axiom5,axiom,(~zcl_10 | p6)) .
cnf(l_axiom6,axiom,(~p0 | ~p6 | zcl_10)) .
cnf(l_axiom7,axiom,(~f2 | zcl_10)) .
cnf(l_axiom8,axiom,(~p0 | ~p6 | f2_p)) .
cnf(l_axiom9,axiom,(~f4 | p0 | p5)) .
cnf(l_axiom10,axiom,(~p0 | f4_p)) .
cnf(l_axiom11,axiom,(~p5 | f4_p)) .
cnf(l_axiom12,axiom,(~zcl_11 | p4)) .
cnf(l_axiom13,axiom,(~zcl_11 | p3)) .
cnf(l_axiom14,axiom,(~p4 | ~p3 | zcl_11)) .
cnf(l_axiom15,axiom,(~f6 | zcl_11)) .
cnf(l_axiom16,axiom,(~p4 | ~p3 | f6_p)) .
...
cnf(r_axiom8,axiom,(~acc_f0 | acc_p1 | acc_p7)) .
cnf(r_axiom9,axiom,(~acc_p1 | acc_f0_p)) .
cnf(r_axiom10,axiom,(~acc_p7 | acc_f0_p)) .
cnf(r_axiom11,axiom,(~acc_zcl_10 | acc_p0)) .
cnf(r_axiom12,axiom,(~acc_zcl_10 | acc_p6)) .
cnf(r_axiom13,axiom,(~acc_p0 | ~acc_p6 | acc_zcl_10)) .
cnf(r_axiom14,axiom,(~acc_f2 | acc_zcl_10)) .
cnf(r_axiom15,axiom,(~acc_p0 | ~acc_p6 | acc_f2_p)) .
cnf(r_axiom16,axiom,(~acc_f4 | acc_p0 | acc_p5)) .
cnf(r_axiom17,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom18,axiom,(~acc_p5 | acc_f4_p)) .
cnf(r_axiom19,axiom,(~acc_zcl_11 | acc_p4)) .
cnf(r_axiom20,axiom,(~acc_zcl_11 | acc_p3)) .
cnf(r_axiom21,axiom,(~acc_p4 | ~acc_p3 | acc_zcl_11)) .
cnf(r_axiom22,axiom,(~acc_f6 | acc_zcl_11)) .
cnf(r_axiom23,axiom,(~acc_p4 | ~acc_p3 | acc_f6_p)) .
cnf(r_axiom24,axiom,(~acc_f8 | acc_p0 | acc_p2)) .
