%%%%%%%%%%%%%%%% Target reformulation: ((p0 & (p0 & (p6 & p9))) | ((p0 | (p7 | (p8 | p6))) & ((p5 & (p0 & (p0 & p4))) | (p1 & (p2 & (p3 & p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p6 | ~p9 | zcl_20)) .
cnf(l_axiom4,axiom,(~f2 | zcl_20)) .
cnf(l_axiom5,axiom,(~p6 | ~p9 | f2_p)) .
...
cnf(r_axiom12,axiom,(~acc_p6 | ~acc_p9 | acc_zcl_20)) .
cnf(r_axiom13,axiom,(~acc_f2 | acc_zcl_20)) .
cnf(r_axiom14,axiom,(~acc_p6 | ~acc_p9 | acc_f2_p)) .
cnf(r_axiom15,axiom,(~acc_zcl_21 | acc_p0)) .
cnf(r_axiom16,axiom,(~acc_zcl_21 | acc_f2)) .
cnf(r_axiom17,axiom,(~acc_p0 | ~acc_f2 | acc_zcl_21)) .
cnf(r_axiom18,axiom,(~acc_f1 | acc_zcl_21)) .
cnf(r_axiom19,axiom,(~acc_p0 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom20,axiom,(~acc_zcl_22 | acc_p0)) .
cnf(r_axiom21,axiom,(~acc_zcl_22 | acc_f1)) .
cnf(r_axiom22,axiom,(~acc_p0 | ~acc_f1 | acc_zcl_22)) .
cnf(r_axiom23,axiom,(~acc_f0 | acc_zcl_22)) .
cnf(r_axiom24,axiom,(~acc_p0 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom25,axiom,(~acc_f6 | acc_p8 | acc_p6)) .
cnf(r_axiom26,axiom,(~acc_p8 | acc_f6_p)) .
cnf(r_axiom27,axiom,(~acc_p6 | acc_f6_p)) .
cnf(r_axiom28,axiom,(~acc_f5 | acc_p7 | acc_f6)) .
cnf(r_axiom29,axiom,(~acc_p7 | acc_f5_p)) .
...
cnf(r_axiom46,axiom,(~acc_p5 | ~acc_f9 | acc_zcl_25)) .
