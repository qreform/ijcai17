...
;%~p1 | ~f4 | zcl_1
(assert (or (not l_p1) (not l_f4) l_zcl_1))
...
;%~p1 | ~f4_p | f3_p
(assert (or (not l_p1) (not l_f4_p) l_f3_p))
...
;%~p4 | ~p5 | zcl_2
(assert (or (not l_p4) (not l_p5) l_zcl_2))
...
;%~p4 | ~p5 | f10_p
(assert (or (not l_p4) (not l_p5) l_f10_p))
...
;%~r_p1 | ~r_f4 | r_zcl_1
(assert (or (not r_p1) (not r_f4) r_zcl_1))
...
(assert (or (not r_p1) (not r_f4_p) r_f3_p))
...
;%~r_p4 | ~r_p5 | r_zcl_2
(assert (or (not r_p4) (not r_p5) r_zcl_2))
...
(assert (or (not r_p4) (not r_p5) r_f10_p))
