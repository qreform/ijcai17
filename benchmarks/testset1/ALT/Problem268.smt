...
;%~f2 | p12 | p10
(assert (or (not l_f2) l_p12 l_p10))
...
;%~p5 | ~p9 | f6_p
(assert (or (not l_p5) (not l_p9) l_f6_p))
...
;%~zcl_3 | p5
(assert (or (not l_zcl_3) l_p5))

;%~zcl_3 | p6
(assert (or (not l_zcl_3) l_p6))

;%~p5 | ~p6 | zcl_3
(assert (or (not l_p5) (not l_p6) l_zcl_3))
...
;%~p5 | ~p6 | f14_p
(assert (or (not l_p5) (not l_p6) l_f14_p))
...
(assert (or (not r_f2) r_p12 r_p10))
...
(assert (or (not r_p5) (not r_p9) r_f6_p))
...
;%~r_p5 | ~r_p6 | r_zcl_3
(assert (or (not r_p5) (not r_p6) r_zcl_3))
...
(assert (or (not r_p5) (not r_p6) r_f14_p))
