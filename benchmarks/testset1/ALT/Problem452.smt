...
;%~p0 | ~p10 | f4_p
(assert (or (not l_p0) (not l_p10) l_f4_p))
...
;%~p11 | ~f4 | zcl_1
(assert (or (not l_p11) (not l_f4) l_zcl_1))
...
;%~p2 | ~p6 | zcl_2
(assert (or (not l_p2) (not l_p6) l_zcl_2))
...
(assert (or (not r_p0) (not r_p10) r_f4_p))
...
;%~r_p11 | ~r_f4 | r_zcl_1
(assert (or (not r_p11) (not r_f4) r_zcl_1))
...
;%~r_p2 | ~r_p6 | r_zcl_2
(assert (or (not r_p2) (not r_p6) r_zcl_2))
