...
;%~zcl_0 | p29
(assert (or (not l_zcl_0) l_p29))

(declare-fun l_p25 () Bool)
;%~zcl_0 | p25
(assert (or (not l_zcl_0) l_p25))

;%~p29 | ~p25 | zcl_0
(assert (or (not l_p29) (not l_p25) l_zcl_0))
...
;%~p29 | ~p25 | f3_p
(assert (or (not l_p29) (not l_p25) l_f3_p))
...
;%~zcl_1 | p28
(assert (or (not l_zcl_1) l_p28))

;%~zcl_1 | f3
(assert (or (not l_zcl_1) l_f3))

;%~p28 | ~f3 | zcl_1
(assert (or (not l_p28) (not l_f3) l_zcl_1))
...
;%~p28 | ~f3_p | f2_p
(assert (or (not l_p28) (not l_f3_p) l_f2_p))
...
;%~zcl_2 | p27
(assert (or (not l_zcl_2) l_p27))

;%~zcl_2 | f2
(assert (or (not l_zcl_2) l_f2))

;%~p27 | ~f2 | zcl_2
(assert (or (not l_p27) (not l_f2) l_zcl_2))
...
;%~p27 | ~f2_p | f1_p
(assert (or (not l_p27) (not l_f2_p) l_f1_p))
...
;%~zcl_3 | p26
(assert (or (not l_zcl_3) l_p26))

;%~zcl_3 | f1
(assert (or (not l_zcl_3) l_f1))

;%~p26 | ~f1 | zcl_3
(assert (or (not l_p26) (not l_f1) l_zcl_3))
...
;%~p26 | ~f1_p | f0_p
(assert (or (not l_p26) (not l_f1_p) l_f0_p))
...
;%~f8 | p24 | p20
(assert (or (not l_f8) l_p24 l_p20))
...
;%~p24 | f8_p
(assert (or (not l_p24) l_f8_p))

;%~p20 | f8_p
(assert (or (not l_p20) l_f8_p))
...
;%~zcl_4 | p15
(assert (or (not l_zcl_4) l_p15))

;%~p19 | ~p15 | zcl_4
(assert (or (not l_p19) (not l_p15) l_zcl_4))
...
;%~p19 | ~p15 | f13_p
(assert (or (not l_p19) (not l_p15) l_f13_p))
...
;%~p18 | ~f13 | zcl_5
(assert (or (not l_p18) (not l_f13) l_zcl_5))
...
;%~p18 | ~f13_p | f12_p
(assert (or (not l_p18) (not l_f13_p) l_f12_p))
...
;%~zcl_6 | p17
(assert (or (not l_zcl_6) l_p17))

;%~zcl_6 | f12
(assert (or (not l_zcl_6) l_f12))

;%~p17 | ~f12 | zcl_6
(assert (or (not l_p17) (not l_f12) l_zcl_6))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_6
(assert (or (not l_f11) l_zcl_6))
...
;%~p17 | ~f12_p | f11_p
(assert (or (not l_p17) (not l_f12_p) l_f11_p))
...
;%~zcl_7 | p16
(assert (or (not l_zcl_7) l_p16))

;%~zcl_7 | f11
(assert (or (not l_zcl_7) l_f11))

;%~p16 | ~f11 | zcl_7
(assert (or (not l_p16) (not l_f11) l_zcl_7))

(declare-fun l_f10 () Bool)
;%~f10 | zcl_7
(assert (or (not l_f10) l_zcl_7))
...
;%~p16 | ~f11_p | f10_p
(assert (or (not l_p16) (not l_f11_p) l_f10_p))
...
;%~f18 | p14 | p10
(assert (or (not l_f18) l_p14 l_p10))
...
;%~p14 | f18_p
(assert (or (not l_p14) l_f18_p))

;%~p10 | f18_p
(assert (or (not l_p10) l_f18_p))
...
;%~f17 | p13 | f18
(assert (or (not l_f17) l_p13 l_f18))
...
;%~f16 | p12 | f17
(assert (or (not l_f16) l_p12 l_f17))
...
;%~f15 | p11 | f16
(assert (or (not l_f15) l_p11 l_f16))
...
;%~p9 | ~p5 | zcl_8
(assert (or (not l_p9) (not l_p5) l_zcl_8))

(declare-fun l_f23 () Bool)
;%~f23 | zcl_8
(assert (or (not l_f23) l_zcl_8))
...
;%~p9 | ~p5 | f23_p
(assert (or (not l_p9) (not l_p5) l_f23_p))
...
;%~zcl_9 | f23
(assert (or (not l_zcl_9) l_f23))

;%~p8 | ~f23 | zcl_9
(assert (or (not l_p8) (not l_f23) l_zcl_9))

(declare-fun l_f22 () Bool)
;%~f22 | zcl_9
(assert (or (not l_f22) l_zcl_9))
...
;%~p8 | ~f23_p | f22_p
(assert (or (not l_p8) (not l_f23_p) l_f22_p))
...
;%~zcl_10 | f22
(assert (or (not l_zcl_10) l_f22))

;%~p7 | ~f22 | zcl_10
(assert (or (not l_p7) (not l_f22) l_zcl_10))
...
;%~p7 | ~f22_p | f21_p
(assert (or (not l_p7) (not l_f22_p) l_f21_p))
...
;%~p6 | ~f21 | zcl_11
(assert (or (not l_p6) (not l_f21) l_zcl_11))
...
;%~p4 | ~p0 | f27_p
(assert (or (not l_p4) (not l_p0) l_f27_p))
...
;%~zcl_13 | f27
(assert (or (not l_zcl_13) l_f27))

;%~p3 | ~f27 | zcl_13
(assert (or (not l_p3) (not l_f27) l_zcl_13))

(declare-fun l_f26 () Bool)
;%~f26 | zcl_13
(assert (or (not l_f26) l_zcl_13))
...
;%~p3 | ~f27_p | f26_p
(assert (or (not l_p3) (not l_f27_p) l_f26_p))
...
;%~zcl_14 | f26
(assert (or (not l_zcl_14) l_f26))

;%~p2 | ~f26 | zcl_14
(assert (or (not l_p2) (not l_f26) l_zcl_14))

(declare-fun l_f25 () Bool)
;%~f25 | zcl_14
(assert (or (not l_f25) l_zcl_14))
...
;%~p2 | ~f26_p | f25_p
(assert (or (not l_p2) (not l_f26_p) l_f25_p))
...
;%~zcl_15 | f25
(assert (or (not l_zcl_15) l_f25))

;%~p1 | ~f25 | zcl_15
(assert (or (not l_p1) (not l_f25) l_zcl_15))

(declare-fun l_f24 () Bool)
;%~f24 | zcl_15
(assert (or (not l_f24) l_zcl_15))
...
;%~p1 | ~f25_p | f24_p
(assert (or (not l_p1) (not l_f25_p) l_f24_p))
...
;%~zcl_16 | f15
(assert (or (not l_zcl_16) l_f15))

;%~zcl_16 | f19
(assert (or (not l_zcl_16) l_f19))

;%~f15 | ~f19 | zcl_16
(assert (or (not l_f15) (not l_f19) l_zcl_16))

(declare-fun l_f14 () Bool)
;%~f14 | zcl_16
(assert (or (not l_f14) l_zcl_16))
...
;%~zcl_17 | f5
(assert (or (not l_zcl_17) l_f5))

;%~zcl_17 | f9
(assert (or (not l_zcl_17) l_f9))

;%~f5 | ~f9 | zcl_17
(assert (or (not l_f5) (not l_f9) l_zcl_17))

(declare-fun l_f4 () Bool)
;%~f4 | zcl_17
(assert (or (not l_f4) l_zcl_17))
...
(assert (or (not r_zcl_0) r_p29))


;%~r_zcl_0 | r_p25
(assert (or (not r_zcl_0) r_p25))


;%~r_p29 | ~r_p25 | r_zcl_0
(assert (or (not r_p29) (not r_p25) r_zcl_0))
...
(assert (or (not r_p29) (not r_p25) r_f3_p))


;%~r_zcl_1 | r_p28
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p28))
...
;%~r_p28 | ~r_f3 | r_zcl_1
(assert (or (not r_p28) (not r_f3) r_zcl_1))
...
(assert (or (not r_p28) (not r_f3_p) r_f2_p))


;%~r_zcl_2 | r_p27
(declare-fun r_zcl_2 () Bool)
(assert (or (not r_zcl_2) r_p27))
...
;%~r_p27 | ~r_f2 | r_zcl_2
(assert (or (not r_p27) (not r_f2) r_zcl_2))
...
(assert (or (not r_p27) (not r_f2_p) r_f1_p))


;%~r_zcl_3 | r_p26
(declare-fun r_zcl_3 () Bool)
(assert (or (not r_zcl_3) r_p26))
...
;%~r_p26 | ~r_f1 | r_zcl_3
(assert (or (not r_p26) (not r_f1) r_zcl_3))
...
(assert (or (not r_p26) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p24 | r_p20
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p24 r_p20))


;%~r_p24 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p24) r_f8_p))


;%~r_p20 | r_f8_p
(assert (or (not r_p20) r_f8_p))


;%~r_f7 | r_p23 | r_f8
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_p23 r_f8))


;%~r_p23 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p23) r_f7_p))
...
(assert (or (not r_f6) r_p22 r_f7))


;%~r_p22 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p22) r_f6_p))
...
(assert (or (not r_f5) r_p21 r_f6))


;%~r_p21 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p21) r_f5_p))
...
;%~r_zcl_4 | r_p15
(assert (or (not r_zcl_4) r_p15))


;%~r_p19 | ~r_p15 | r_zcl_4
(assert (or (not r_p19) (not r_p15) r_zcl_4))
...
(assert (or (not r_p19) (not r_p15) r_f13_p))
...
;%~r_p18 | ~r_f13 | r_zcl_5
(assert (or (not r_p18) (not r_f13) r_zcl_5))
...
;%~r_p18 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p18) (not r_f13_p) r_f12_p))


;%~r_zcl_6 | r_p17
(declare-fun r_zcl_6 () Bool)
(assert (or (not r_zcl_6) r_p17))


;%~r_zcl_6 | r_f12
(assert (or (not r_zcl_6) r_f12))


;%~r_p17 | ~r_f12 | r_zcl_6
(assert (or (not r_p17) (not r_f12) r_zcl_6))


;%~r_f11 | r_zcl_6
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_6))


;%~r_p17 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p17) (not r_f12_p) r_f11_p))


;%~r_zcl_7 | r_p16
(declare-fun r_zcl_7 () Bool)
(assert (or (not r_zcl_7) r_p16))


;%~r_zcl_7 | r_f11
(assert (or (not r_zcl_7) r_f11))


;%~r_p16 | ~r_f11 | r_zcl_7
(assert (or (not r_p16) (not r_f11) r_zcl_7))


;%~r_f10 | r_zcl_7
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_zcl_7))


;%~r_p16 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p16) (not r_f11_p) r_f10_p))


;%~r_f18 | r_p14 | r_p10
(declare-fun r_f18 () Bool)
(assert (or (not r_f18) r_p14 r_p10))


;%~r_p14 | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p14) r_f18_p))


;%~r_p10 | r_f18_p
(assert (or (not r_p10) r_f18_p))


;%~r_f17 | r_p13 | r_f18
(declare-fun r_f17 () Bool)
(assert (or (not r_f17) r_p13 r_f18))


;%~r_p13 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p13) r_f17_p))
...
(assert (or (not r_f16) r_p12 r_f17))
...
(assert (or (not r_f15) r_p11 r_f16))


;%~r_p11 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p11) r_f15_p))
...
;%~r_p9 | ~r_p5 | r_zcl_8
(assert (or (not r_p9) (not r_p5) r_zcl_8))


;%~r_f23 | r_zcl_8
(declare-fun r_f23 () Bool)
(assert (or (not r_f23) r_zcl_8))


;%~r_p9 | ~r_p5 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p9) (not r_p5) r_f23_p))
...
;%~r_zcl_9 | r_f23
(assert (or (not r_zcl_9) r_f23))


;%~r_p8 | ~r_f23 | r_zcl_9
(assert (or (not r_p8) (not r_f23) r_zcl_9))


;%~r_f22 | r_zcl_9
(declare-fun r_f22 () Bool)
(assert (or (not r_f22) r_zcl_9))


;%~r_p8 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p8) (not r_f23_p) r_f22_p))
...
;%~r_zcl_10 | r_f22
(assert (or (not r_zcl_10) r_f22))


;%~r_p7 | ~r_f22 | r_zcl_10
(assert (or (not r_p7) (not r_f22) r_zcl_10))
...
;%~r_p7 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p7) (not r_f22_p) r_f21_p))
...
;%~r_p6 | ~r_f21 | r_zcl_11
(assert (or (not r_p6) (not r_f21) r_zcl_11))
...
(assert (or (not r_f27) r_zcl_12))


;%~r_p4 | ~r_p0 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p4) (not r_p0) r_f27_p))
...
;%~r_zcl_13 | r_f27
(assert (or (not r_zcl_13) r_f27))


;%~r_p3 | ~r_f27 | r_zcl_13
(assert (or (not r_p3) (not r_f27) r_zcl_13))


;%~r_f26 | r_zcl_13
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_zcl_13))


;%~r_p3 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p3) (not r_f27_p) r_f26_p))
...
;%~r_zcl_14 | r_f26
(assert (or (not r_zcl_14) r_f26))


;%~r_p2 | ~r_f26 | r_zcl_14
(assert (or (not r_p2) (not r_f26) r_zcl_14))


;%~r_f25 | r_zcl_14
(declare-fun r_f25 () Bool)
(assert (or (not r_f25) r_zcl_14))


;%~r_p2 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p2) (not r_f26_p) r_f25_p))
...
;%~r_zcl_15 | r_f25
(assert (or (not r_zcl_15) r_f25))


;%~r_p1 | ~r_f25 | r_zcl_15
(assert (or (not r_p1) (not r_f25) r_zcl_15))


;%~r_f24 | r_zcl_15
(declare-fun r_f24 () Bool)
(assert (or (not r_f24) r_zcl_15))


;%~r_p1 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p1) (not r_f25_p) r_f24_p))
...
(assert (or (not r_zcl_16) r_f15))


;%~r_zcl_16 | r_f19
(assert (or (not r_zcl_16) r_f19))


;%~r_f15 | ~r_f19 | r_zcl_16
(assert (or (not r_f15) (not r_f19) r_zcl_16))


;%~r_f14 | r_zcl_16
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_zcl_16))
...
(assert (or (not r_zcl_17) r_f5))


;%~r_zcl_17 | r_f9
(assert (or (not r_zcl_17) r_f9))


;%~r_f5 | ~r_f9 | r_zcl_17
(assert (or (not r_f5) (not r_f9) r_zcl_17))


;%~r_f4 | r_zcl_17
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_zcl_17))
