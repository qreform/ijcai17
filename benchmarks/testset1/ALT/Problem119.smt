...
;%~p14 | ~p12 | f5_p
(assert (or (not l_p14) (not l_p12) l_f5_p))
...
;%~p13 | ~f3 | zcl_3
(assert (or (not l_p13) (not l_f3) l_zcl_3))
...
;%~f12 | p11 | p10
(assert (or (not l_f12) l_p11 l_p10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p11 | ~p10) --> f12_p))
;%------------------------Clausification start------------------------%
...
;%~p9 | ~p7 | f19_p
(assert (or (not l_p9) (not l_p7) l_f19_p))
...
;%~p8 | ~f17 | zcl_9
(assert (or (not l_p8) (not l_f17) l_zcl_9))
...
(assert (or (not r_p14) (not r_p12) r_f5_p))
...
;%~r_p13 | ~r_f3 | r_zcl_3
(assert (or (not r_p13) (not r_f3) r_zcl_3))
...
(assert (or (not r_f12) r_p11 r_p10))
...
(assert (or (not r_p9) (not r_p7) r_f19_p))
...
;%~r_p8 | ~r_f17 | r_zcl_9
(assert (or (not r_p8) (not r_f17) r_zcl_9))
