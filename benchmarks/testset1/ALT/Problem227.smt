...
;%~p18 | ~p16 | zcl_0
(assert (or (not l_p18) (not l_p16) l_zcl_0))
...
;%~p18 | ~p16 | f4_p
(assert (or (not l_p18) (not l_p16) l_f4_p))
...
;%~p6 | ~f4 | zcl_1
(assert (or (not l_p6) (not l_f4) l_zcl_1))
...
;%~p6 | ~f4_p | f3_p
(assert (or (not l_p6) (not l_f4_p) l_f3_p))
...
;%~zcl_2 | p12
(assert (or (not l_zcl_2) l_p12))

;%~zcl_2 | f3
(assert (or (not l_zcl_2) l_f3))

;%~p12 | ~f3 | zcl_2
(assert (or (not l_p12) (not l_f3) l_zcl_2))
...
;%~p12 | ~f3_p | f2_p
(assert (or (not l_p12) (not l_f3_p) l_f2_p))
...
;%~p6 | ~f2 | zcl_3
(assert (or (not l_p6) (not l_f2) l_zcl_3))
...
;%~p17 | ~f1 | zcl_4
(assert (or (not l_p17) (not l_f1) l_zcl_4))
...
;%~f10 | p6 | p14
(assert (or (not l_f10) l_p6 l_p14))
...
;%~f6 | p15 | f7
(assert (or (not l_f6) l_p15 l_f7))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p15 | f7_p) --> f6_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f6_p () Bool)
;%~p15 | f6_p
(assert (or (not l_p15) l_f6_p))
...
;%~p0 | ~p12 | zcl_5
(assert (or (not l_p0) (not l_p12) l_zcl_5))
...
;%~p0 | ~p12 | f16_p
(assert (or (not l_p0) (not l_p12) l_f16_p))
...
;%~p13 | ~f16 | zcl_6
(assert (or (not l_p13) (not l_f16) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p13 & f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p13 | ~f16_p | f15_p
(assert (or (not l_p13) (not l_f16_p) l_f15_p))
...
;%~p6 | ~f15 | zcl_7
(assert (or (not l_p6) (not l_f15) l_zcl_7))
...
;%~f22 | p11 | p10
(assert (or (not l_f22) l_p11 l_p10))
...
;%~f19 | p6 | f20
(assert (or (not l_f19) l_p6 l_f20))
...
;%~p9 | ~f28 | zcl_11
(assert (or (not l_p9) (not l_f28) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((~p9 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p9 | ~f28_p | f27_p
(assert (or (not l_p9) (not l_f28_p) l_f27_p))
...
;%~p8 | ~f27 | zcl_12
(assert (or (not l_p8) (not l_f27) l_zcl_12))
...
;%~p0 | ~f26 | zcl_13
(assert (or (not l_p0) (not l_f26) l_zcl_13))
...
;%~r_p18 | ~r_p16 | r_zcl_0
(assert (or (not r_p18) (not r_p16) r_zcl_0))
...
(assert (or (not r_p18) (not r_p16) r_f4_p))
...
;%~r_p6 | ~r_f4 | r_zcl_1
(assert (or (not r_p6) (not r_f4) r_zcl_1))
...
(assert (or (not r_p6) (not r_f4_p) r_f3_p))


;%~r_zcl_2 | r_p12
(declare-fun r_zcl_2 () Bool)
(assert (or (not r_zcl_2) r_p12))
...
;%~r_p12 | ~r_f3 | r_zcl_2
(assert (or (not r_p12) (not r_f3) r_zcl_2))
...
(assert (or (not r_p12) (not r_f3_p) r_f2_p))
...
;%~r_p6 | ~r_f2 | r_zcl_3
(assert (or (not r_p6) (not r_f2) r_zcl_3))
...
;%~r_p17 | ~r_f1 | r_zcl_4
(assert (or (not r_p17) (not r_f1) r_zcl_4))
...
(assert (or (not r_f10) r_p6 r_p14))
...
(assert (or (not r_f6) r_p15 r_f7))


;%~r_p15 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p15) r_f6_p))
...
;%~r_p0 | ~r_p12 | r_zcl_5
(assert (or (not r_p0) (not r_p12) r_zcl_5))
...
(assert (or (not r_p0) (not r_p12) r_f16_p))
...
;%~r_p13 | ~r_f16 | r_zcl_6
(assert (or (not r_p13) (not r_f16) r_zcl_6))
...
;%~r_p13 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p13) (not r_f16_p) r_f15_p))
...
;%~r_p6 | ~r_f15 | r_zcl_7
(assert (or (not r_p6) (not r_f15) r_zcl_7))
...
(assert (or (not r_f22) r_p11 r_p10))
...
(assert (or (not r_f19) r_p6 r_f20))


;%~r_p6 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p6) r_f19_p))
...
;%~r_p9 | ~r_f28 | r_zcl_11
(assert (or (not r_p9) (not r_f28) r_zcl_11))
...
;%~r_p9 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p9) (not r_f28_p) r_f27_p))
...
;%~r_p8 | ~r_f27 | r_zcl_12
(assert (or (not r_p8) (not r_f27) r_zcl_12))
...
;%~r_p0 | ~r_f26 | r_zcl_13
(assert (or (not r_p0) (not r_f26) r_zcl_13))
