...
;%~p6 | ~p9 | zcl_0
(assert (or (not l_p6) (not l_p9) l_zcl_0))
...
;%~p6 | ~p9 | f3_p
(assert (or (not l_p6) (not l_p9) l_f3_p))
...
;%~r_p6 | ~r_p9 | r_zcl_0
(assert (or (not r_p6) (not r_p9) r_zcl_0))
...
(assert (or (not r_p6) (not r_p9) r_f3_p))
