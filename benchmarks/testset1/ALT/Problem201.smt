...
;%~p9 | ~p10 | f2_p
(assert (or (not l_p9) (not l_p10) l_f2_p))
...
;%~p7 | ~f1 | zcl_2
(assert (or (not l_p7) (not l_f1) l_zcl_2))
...
;%~p7 | ~p8 | zcl_3
(assert (or (not l_p7) (not l_p8) l_zcl_3))
...
;%~p7 | ~p8 | f10_p
(assert (or (not l_p7) (not l_p8) l_f10_p))
...
;%~p7 | ~f9 | zcl_5
(assert (or (not l_p7) (not l_f9) l_zcl_5))
...
;%~f13 | p7 | f14
(assert (or (not l_f13) l_p7 l_f14))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p7 | f14_p) --> f13_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_p9) (not r_p10) r_f2_p))
...
;%~r_p7 | ~r_f1 | r_zcl_2
(assert (or (not r_p7) (not r_f1) r_zcl_2))
...
;%~r_p7 | ~r_p8 | r_zcl_3
(assert (or (not r_p7) (not r_p8) r_zcl_3))
...
(assert (or (not r_p7) (not r_p8) r_f10_p))
...
;%~r_p7 | ~r_f9 | r_zcl_5
(assert (or (not r_p7) (not r_f9) r_zcl_5))
...
(assert (or (not r_f13) r_p7 r_f14))
