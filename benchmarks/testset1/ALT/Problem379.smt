...
;%~p3 | ~f7 | zcl_2
(assert (or (not l_p3) (not l_f7) l_zcl_2))
...
;%~f10 | p3 | f11
(assert (or (not l_f10) l_p3 l_f11))
...
;%~r_p3 | ~r_f7 | r_zcl_2
(assert (or (not r_p3) (not r_f7) r_zcl_2))
...
(assert (or (not r_f10) r_p3 r_f11))
