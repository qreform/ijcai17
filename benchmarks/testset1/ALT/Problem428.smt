...
;%~p2 | ~p8 | zcl_0
(assert (or (not l_p2) (not l_p8) l_zcl_0))
...
;%~p2 | ~p8 | f3_p
(assert (or (not l_p2) (not l_p8) l_f3_p))
...
;%~p5 | ~p6 | zcl_4
(assert (or (not l_p5) (not l_p6) l_zcl_4))
...
;%~r_p2 | ~r_p8 | r_zcl_0
(assert (or (not r_p2) (not r_p8) r_zcl_0))
...
(assert (or (not r_p2) (not r_p8) r_f3_p))
...
;%~r_p5 | ~r_p6 | r_zcl_4
(assert (or (not r_p5) (not r_p6) r_zcl_4))
