...
;%~p12 | ~p9 | f10_p
(assert (or (not l_p12) (not l_p9) l_f10_p))
...
;%~p4 | ~f8 | zcl_3
(assert (or (not l_p4) (not l_f8) l_zcl_3))
...
(assert (or (not r_p12) (not r_p9) r_f10_p))
...
;%~r_p4 | ~r_f8 | r_zcl_3
(assert (or (not r_p4) (not r_f8) r_zcl_3))
