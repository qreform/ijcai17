...
;%~p14 | ~p13 | f4_p
(assert (or (not l_p14) (not l_p13) l_f4_p))
...
;%~p8 | ~f3 | zcl_2
(assert (or (not l_p8) (not l_f3) l_zcl_2))
...
;%~p1 | ~f2 | zcl_3
(assert (or (not l_p1) (not l_f2) l_zcl_3))
...
;%~p6 | ~f1 | zcl_4
(assert (or (not l_p6) (not l_f1) l_zcl_4))
...
;%~f10 | p5 | p12
(assert (or (not l_f10) l_p5 l_p12))
...
;%Non-clausified dependency
;%(forall[]((~p11 & p10) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p11 | ~p10 | f16_p
(assert (or (not l_p11) (not l_p10) l_f16_p))
...
;%~p2 | ~f15 | zcl_7
(assert (or (not l_p2) (not l_f15) l_zcl_7))
...
;%~p5 | ~f14 | zcl_8
(assert (or (not l_p5) (not l_f14) l_zcl_8))
...
(assert (or (not r_p14) (not r_p13) r_f4_p))
...
;%~r_p8 | ~r_f3 | r_zcl_2
(assert (or (not r_p8) (not r_f3) r_zcl_2))
...
;%~r_p1 | ~r_f2 | r_zcl_3
(assert (or (not r_p1) (not r_f2) r_zcl_3))
...
;%~r_p6 | ~r_f1 | r_zcl_4
(assert (or (not r_p6) (not r_f1) r_zcl_4))
...
(assert (or (not r_f10) r_p5 r_p12))
...
(assert (or (not r_p11) (not r_p10) r_f16_p))
...
;%~r_p2 | ~r_f15 | r_zcl_7
(assert (or (not r_p2) (not r_f15) r_zcl_7))
...
;%~r_p5 | ~r_f14 | r_zcl_8
(assert (or (not r_p5) (not r_f14) r_zcl_8))
