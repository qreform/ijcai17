...
;%~p17 | ~p15 | f1_p
(assert (or (not l_p17) (not l_p15) l_f1_p))
...
;%~p16 | ~f1 | zcl_1
(assert (or (not l_p16) (not l_f1) l_zcl_1))
...
;%~f4 | p14 | p12
(assert (or (not l_f4) l_p14 l_p12))
...
;%~p11 | ~p9 | f7_p
(assert (or (not l_p11) (not l_p9) l_f7_p))
...
;%~p10 | ~f7 | zcl_3
(assert (or (not l_p10) (not l_f7) l_zcl_3))
...
;%~p5 | ~p3 | f13_p
(assert (or (not l_p5) (not l_p3) l_f13_p))
...
;%~p2 | ~p0 | f15_p
(assert (or (not l_p2) (not l_p0) l_f15_p))
...
;%~p1 | ~f15 | zcl_7
(assert (or (not l_p1) (not l_f15) l_zcl_7))
...
;%~f9 | ~f11 | zcl_8
(assert (or (not l_f9) (not l_f11) l_zcl_8))
...
;%~zcl_9 | f3
(assert (or (not l_zcl_9) l_f3))

;%~zcl_9 | f5
(assert (or (not l_zcl_9) l_f5))

;%~f3 | ~f5 | zcl_9
(assert (or (not l_f3) (not l_f5) l_zcl_9))

(declare-fun l_f2 () Bool)
;%~f2 | zcl_9
(assert (or (not l_f2) l_zcl_9))
...
(assert (or (not r_p17) (not r_p15) r_f1_p))
...
;%~r_p16 | ~r_f1 | r_zcl_1
(assert (or (not r_p16) (not r_f1) r_zcl_1))
...
(assert (or (not r_f4) r_p14 r_p12))
...
(assert (or (not r_p11) (not r_p9) r_f7_p))
...
;%~r_p10 | ~r_f7 | r_zcl_3
(assert (or (not r_p10) (not r_f7) r_zcl_3))
...
(assert (or (not r_p5) (not r_p3) r_f13_p))
...
(assert (or (not r_p2) (not r_p0) r_f15_p))
...
;%~r_p1 | ~r_f15 | r_zcl_7
(assert (or (not r_p1) (not r_f15) r_zcl_7))
...
;%~r_f9 | ~r_f11 | r_zcl_8
(assert (or (not r_f9) (not r_f11) r_zcl_8))
...
;%~r_f3 | ~r_f5 | r_zcl_9
(assert (or (not r_f3) (not r_f5) r_zcl_9))


;%~r_f2 | r_zcl_9
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_zcl_9))
