...
;%~p0 | ~p9 | zcl_0
(assert (or (not l_p0) (not l_p9) l_zcl_0))
...
;%~p0 | ~p9 | f2_p
(assert (or (not l_p0) (not l_p9) l_f2_p))
...
;%~p8 | ~f2 | zcl_1
(assert (or (not l_p8) (not l_f2) l_zcl_1))
...
;%~p8 | ~f1 | zcl_2
(assert (or (not l_p8) (not l_f1) l_zcl_2))
...
;%~p5 | ~p6 | f10_p
(assert (or (not l_p5) (not l_p6) l_f10_p))
...
;%~p0 | ~f10 | zcl_4
(assert (or (not l_p0) (not l_f10) l_zcl_4))
...
;%~p5 | ~f9 | zcl_5
(assert (or (not l_p5) (not l_f9) l_zcl_5))
...
;%~p5 | ~f9_p | f8_p
(assert (or (not l_p5) (not l_f9_p) l_f8_p))
...
;%~p0 | ~p4 | f18_p
(assert (or (not l_p0) (not l_p4) l_f18_p))
...
;%~r_p0 | ~r_p9 | r_zcl_0
(assert (or (not r_p0) (not r_p9) r_zcl_0))
...
(assert (or (not r_p0) (not r_p9) r_f2_p))
...
;%~r_p8 | ~r_f2 | r_zcl_1
(assert (or (not r_p8) (not r_f2) r_zcl_1))
...
;%~r_p8 | ~r_f1 | r_zcl_2
(assert (or (not r_p8) (not r_f1) r_zcl_2))
...
(assert (or (not r_f5) r_p8 r_f6))


;%~r_p8 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p8) r_f5_p))
...
(assert (or (not r_p5) (not r_p6) r_f10_p))
...
;%~r_p0 | ~r_f10 | r_zcl_4
(assert (or (not r_p0) (not r_f10) r_zcl_4))
...
;%~r_p5 | ~r_f9 | r_zcl_5
(assert (or (not r_p5) (not r_f9) r_zcl_5))
...
(assert (or (not r_p5) (not r_f9_p) r_f8_p))


;%~r_f14 | r_p0 | r_p5
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_p0 r_p5))
...
(assert (or (not r_p0) (not r_p4) r_f18_p))
