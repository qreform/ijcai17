...
;%~p8 | ~p7 | zcl_0
(assert (or (not l_p8) (not l_p7) l_zcl_0))
...
;%~p8 | ~p7 | f6_p
(assert (or (not l_p8) (not l_p7) l_f6_p))
...
;%~p2 | ~f6 | zcl_1
(assert (or (not l_p2) (not l_f6) l_zcl_1))
...
;%~p2 | ~f6_p | f5_p
(assert (or (not l_p2) (not l_f6_p) l_f5_p))
...
;%~f9 | p5 | f10
(assert (or (not l_f9) l_p5 l_f10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p5 | f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
...
;%~p3 | ~p5 | zcl_3
(assert (or (not l_p3) (not l_p5) l_zcl_3))
...
;%~p3 | ~p5 | f14_p
(assert (or (not l_p3) (not l_p5) l_f14_p))
...
(assert (or (not r_f2) r_p1 r_p9))


;%~r_p1 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p1) r_f2_p))
...
(assert (or (not r_f1) r_p1 r_f2))


;%~r_p1 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p1) r_f1_p))
...
;%~r_p8 | ~r_p7 | r_zcl_0
(assert (or (not r_p8) (not r_p7) r_zcl_0))
...
(assert (or (not r_p8) (not r_p7) r_f6_p))
...
;%~r_p2 | ~r_f6 | r_zcl_1
(assert (or (not r_p2) (not r_f6) r_zcl_1))
...
(assert (or (not r_p2) (not r_f6_p) r_f5_p))
...
(assert (or (not r_f10) r_p1 r_p6))


;%~r_p1 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p1) r_f10_p))
...
;%~r_p3 | ~r_p5 | r_zcl_3
(assert (or (not r_p3) (not r_p5) r_zcl_3))
...
(assert (or (not r_p3) (not r_p5) r_f14_p))
