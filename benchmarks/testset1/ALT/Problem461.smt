...
;%~f2 | p14 | p12
(assert (or (not l_f2) l_p14 l_p12))
...
;%~p8 | ~p10 | zcl_0
(assert (or (not l_p8) (not l_p10) l_zcl_0))
...
;%~p8 | ~p10 | f6_p
(assert (or (not l_p8) (not l_p10) l_f6_p))
...
;%~p6 | ~p5 | zcl_3
(assert (or (not l_p6) (not l_p5) l_zcl_3))
...
;%~p6 | ~p5 | f14_p
(assert (or (not l_p6) (not l_p5) l_f14_p))
...
(assert (or (not r_f2) r_p14 r_p12))


;%~r_p14 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p14) r_f2_p))
...
;%~r_p8 | ~r_p10 | r_zcl_0
(assert (or (not r_p8) (not r_p10) r_zcl_0))
...
(assert (or (not r_p8) (not r_p10) r_f6_p))
...
;%~r_p6 | ~r_p5 | r_zcl_3
(assert (or (not r_p6) (not r_p5) r_zcl_3))
...
(assert (or (not r_p6) (not r_p5) r_f14_p))
