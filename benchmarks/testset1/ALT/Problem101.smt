...
;%~p0 | ~p14 | zcl_0
(assert (or (not l_p0) (not l_p14) l_zcl_0))
...
;%~p0 | ~p14 | f4_p
(assert (or (not l_p0) (not l_p14) l_f4_p))
...
;%~p13 | ~f3 | zcl_2
(assert (or (not l_p13) (not l_f3) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p13 & f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p13 | ~f3_p | f2_p
(assert (or (not l_p13) (not l_f3_p) l_f2_p))
...
;%~p11 | ~f1 | zcl_4
(assert (or (not l_p11) (not l_f1) l_zcl_4))
...
;%~f10 | p13 | p9
(assert (or (not l_f10) l_p13 l_p9))
...
;%~p0 | ~p6 | f16_p
(assert (or (not l_p0) (not l_p6) l_f16_p))
...
;%~p8 | ~f16 | zcl_6
(assert (or (not l_p8) (not l_f16) l_zcl_6))
...
;%~p7 | ~f15 | zcl_7
(assert (or (not l_p7) (not l_f15) l_zcl_7))
...
;%~r_p0 | ~r_p14 | r_zcl_0
(assert (or (not r_p0) (not r_p14) r_zcl_0))
...
(assert (or (not r_p0) (not r_p14) r_f4_p))
...
;%~r_p13 | ~r_f3 | r_zcl_2
(assert (or (not r_p13) (not r_f3) r_zcl_2))
...
(assert (or (not r_p13) (not r_f3_p) r_f2_p))
...
;%~r_p11 | ~r_f1 | r_zcl_4
(assert (or (not r_p11) (not r_f1) r_zcl_4))
...
(assert (or (not r_f10) r_p13 r_p9))
...
(assert (or (not r_p0) (not r_p6) r_f16_p))
...
;%~r_p8 | ~r_f16 | r_zcl_6
(assert (or (not r_p8) (not r_f16) r_zcl_6))
...
;%~r_p7 | ~r_f15 | r_zcl_7
(assert (or (not r_p7) (not r_f15) r_zcl_7))
