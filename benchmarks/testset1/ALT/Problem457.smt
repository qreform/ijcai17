...
;%~p7 | ~p6 | f4_p
(assert (or (not l_p7) (not l_p6) l_f4_p))
...
;%~p0 | ~p4 | zcl_2
(assert (or (not l_p0) (not l_p4) l_zcl_2))
...
(assert (or (not r_p7) (not r_p6) r_f4_p))
...
;%~r_p0 | ~r_p4 | r_zcl_2
(assert (or (not r_p0) (not r_p4) r_zcl_2))
