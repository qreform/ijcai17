...
;%~p41 | ~p35 | zcl_0
(assert (or (not l_p41) (not l_p35) l_zcl_0))
...
;%~p41 | ~p35 | f5_p
(assert (or (not l_p41) (not l_p35) l_f5_p))
...
;%~zcl_1 | p40
(assert (or (not l_zcl_1) l_p40))

;%~zcl_1 | f5
(assert (or (not l_zcl_1) l_f5))

;%~p40 | ~f5 | zcl_1
(assert (or (not l_p40) (not l_f5) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((~p40 & f5_p) --> f4_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f4_p () Bool)
;%~p40 | ~f5_p | f4_p
(assert (or (not l_p40) (not l_f5_p) l_f4_p))
...
;%~zcl_2 | p39
(assert (or (not l_zcl_2) l_p39))

;%~zcl_2 | f4
(assert (or (not l_zcl_2) l_f4))

;%~p39 | ~f4 | zcl_2
(assert (or (not l_p39) (not l_f4) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p39 & f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p39 | ~f4_p | f3_p
(assert (or (not l_p39) (not l_f4_p) l_f3_p))
...
;%~zcl_3 | p38
(assert (or (not l_zcl_3) l_p38))

;%~zcl_3 | f3
(assert (or (not l_zcl_3) l_f3))

;%~p38 | ~f3 | zcl_3
(assert (or (not l_p38) (not l_f3) l_zcl_3))
...
;%Non-clausified dependency
;%(forall[]((~p38 & f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p38 | ~f3_p | f2_p
(assert (or (not l_p38) (not l_f3_p) l_f2_p))
...
;%~zcl_4 | p37
(assert (or (not l_zcl_4) l_p37))

;%~zcl_4 | f2
(assert (or (not l_zcl_4) l_f2))

;%~p37 | ~f2 | zcl_4
(assert (or (not l_p37) (not l_f2) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p37 & f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p37 | ~f2_p | f1_p
(assert (or (not l_p37) (not l_f2_p) l_f1_p))
...
;%~zcl_5 | p36
(assert (or (not l_zcl_5) l_p36))

;%~zcl_5 | f1
(assert (or (not l_zcl_5) l_f1))

;%~p36 | ~f1 | zcl_5
(assert (or (not l_p36) (not l_f1) l_zcl_5))
...
;%Non-clausified dependency
;%(forall[]((~p36 & f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f0_p () Bool)
;%~p36 | ~f1_p | f0_p
(assert (or (not l_p36) (not l_f1_p) l_f0_p))
...
;%~f12 | p34 | p28
(assert (or (not l_f12) l_p34 l_p28))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p34 | p28) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p34 | f12_p
(assert (or (not l_p34) l_f12_p))

;%~p28 | f12_p
(assert (or (not l_p28) l_f12_p))
...
;%~f11 | p33 | f12
(assert (or (not l_f11) l_p33 l_f12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p33 | f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p33 | f11_p
(assert (or (not l_p33) l_f11_p))
...
;%~f10 | p32 | f11
(assert (or (not l_f10) l_p32 l_f11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p32 | f11_p) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p32 | f10_p
(assert (or (not l_p32) l_f10_p))
...
;%~f9 | p31 | f10
(assert (or (not l_f9) l_p31 l_f10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p31 | f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p31 | f9_p
(assert (or (not l_p31) l_f9_p))
...
;%~f8 | p30 | f9
(assert (or (not l_f8) l_p30 l_f9))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p30 | f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p30 | f8_p
(assert (or (not l_p30) l_f8_p))
...
;%~f7 | p29 | f8
(assert (or (not l_f7) l_p29 l_f8))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p29 | f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p29 | f7_p
(assert (or (not l_p29) l_f7_p))
...
;%~zcl_6 | p27
(assert (or (not l_zcl_6) l_p27))

(declare-fun l_p21 () Bool)
;%~zcl_6 | p21
(assert (or (not l_zcl_6) l_p21))

;%~p27 | ~p21 | zcl_6
(assert (or (not l_p27) (not l_p21) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((~p27 & p21) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p27 | ~p21 | f19_p
(assert (or (not l_p27) (not l_p21) l_f19_p))
...
;%~zcl_7 | p26
(assert (or (not l_zcl_7) l_p26))

;%~zcl_7 | f19
(assert (or (not l_zcl_7) l_f19))

;%~p26 | ~f19 | zcl_7
(assert (or (not l_p26) (not l_f19) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((~p26 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p26 | ~f19_p | f18_p
(assert (or (not l_p26) (not l_f19_p) l_f18_p))
...
;%~zcl_8 | p25
(assert (or (not l_zcl_8) l_p25))

;%~zcl_8 | f18
(assert (or (not l_zcl_8) l_f18))

;%~p25 | ~f18 | zcl_8
(assert (or (not l_p25) (not l_f18) l_zcl_8))
...
;%Non-clausified dependency
;%(forall[]((~p25 & f18_p) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p25 | ~f18_p | f17_p
(assert (or (not l_p25) (not l_f18_p) l_f17_p))
...
;%~zcl_9 | p24
(assert (or (not l_zcl_9) l_p24))

;%~zcl_9 | f17
(assert (or (not l_zcl_9) l_f17))

;%~p24 | ~f17 | zcl_9
(assert (or (not l_p24) (not l_f17) l_zcl_9))
...
;%Non-clausified dependency
;%(forall[]((~p24 & f17_p) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p24 | ~f17_p | f16_p
(assert (or (not l_p24) (not l_f17_p) l_f16_p))
...
;%~zcl_10 | p23
(assert (or (not l_zcl_10) l_p23))

;%~zcl_10 | f16
(assert (or (not l_zcl_10) l_f16))

;%~p23 | ~f16 | zcl_10
(assert (or (not l_p23) (not l_f16) l_zcl_10))
...
;%Non-clausified dependency
;%(forall[]((p23 & f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p23 | ~f16_p | f15_p
(assert (or (not l_p23) (not l_f16_p) l_f15_p))
...
;%~zcl_11 | p22
(assert (or (not l_zcl_11) l_p22))

;%~zcl_11 | f15
(assert (or (not l_zcl_11) l_f15))

;%~p22 | ~f15 | zcl_11
(assert (or (not l_p22) (not l_f15) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((p22 & f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p22 | ~f15_p | f14_p
(assert (or (not l_p22) (not l_f15_p) l_f14_p))
...
;%~f26 | p20 | p14
(assert (or (not l_f26) l_p20 l_p14))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p20 | p14) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p20 | f26_p
(assert (or (not l_p20) l_f26_p))
...
;%~f25 | p19 | f26
(assert (or (not l_f25) l_p19 l_f26))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p19 | f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p19 | f25_p
(assert (or (not l_p19) l_f25_p))
...
;%~f24 | p18 | f25
(assert (or (not l_f24) l_p18 l_f25))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p18 | f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p18 | f24_p
(assert (or (not l_p18) l_f24_p))
...
;%~f23 | p17 | f24
(assert (or (not l_f23) l_p17 l_f24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p17 | f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p17 | f23_p
(assert (or (not l_p17) l_f23_p))
...
;%~f22 | p16 | f23
(assert (or (not l_f22) l_p16 l_f23))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p16 | f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p16 | f22_p
(assert (or (not l_p16) l_f22_p))
...
;%~f21 | p15 | f22
(assert (or (not l_f21) l_p15 l_f22))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p15 | f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p15 | f21_p
(assert (or (not l_p15) l_f21_p))
...
;%~p13 | ~p7 | zcl_12
(assert (or (not l_p13) (not l_p7) l_zcl_12))
...
;%~p13 | ~p7 | f33_p
(assert (or (not l_p13) (not l_p7) l_f33_p))
...
;%~zcl_13 | p12
(assert (or (not l_zcl_13) l_p12))

;%~zcl_13 | f33
(assert (or (not l_zcl_13) l_f33))

;%~p12 | ~f33 | zcl_13
(assert (or (not l_p12) (not l_f33) l_zcl_13))
...
;%~zcl_14 | p11
(assert (or (not l_zcl_14) l_p11))

;%~zcl_14 | f32
(assert (or (not l_zcl_14) l_f32))

;%~p11 | ~f32 | zcl_14
(assert (or (not l_p11) (not l_f32) l_zcl_14))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p11 | ~f32_p | f31_p
(assert (or (not l_p11) (not l_f32_p) l_f31_p))
...
;%~p10 | ~f31 | zcl_15
(assert (or (not l_p10) (not l_f31) l_zcl_15))
...
;%~p9 | ~f30 | zcl_16
(assert (or (not l_p9) (not l_f30) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((p9 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p9 | ~f30_p | f29_p
(assert (or (not l_p9) (not l_f30_p) l_f29_p))
...
;%~p8 | ~f29 | zcl_17
(assert (or (not l_p8) (not l_f29) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((p8 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p8 | ~f29_p | f28_p
(assert (or (not l_p8) (not l_f29_p) l_f28_p))
...
;%~r_p41 | ~r_p35 | r_zcl_0
(assert (or (not r_p41) (not r_p35) r_zcl_0))
...
(assert (or (not r_p41) (not r_p35) r_f5_p))


;%~r_zcl_1 | r_p40
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p40))
...
;%~r_p40 | ~r_f5 | r_zcl_1
(assert (or (not r_p40) (not r_f5) r_zcl_1))
...
(assert (or (not r_p40) (not r_f5_p) r_f4_p))


;%~r_zcl_2 | r_p39
(declare-fun r_zcl_2 () Bool)
(assert (or (not r_zcl_2) r_p39))
...
;%~r_p39 | ~r_f4 | r_zcl_2
(assert (or (not r_p39) (not r_f4) r_zcl_2))
...
(assert (or (not r_p39) (not r_f4_p) r_f3_p))


;%~r_zcl_3 | r_p38
(declare-fun r_zcl_3 () Bool)
(assert (or (not r_zcl_3) r_p38))
...
;%~r_p38 | ~r_f3 | r_zcl_3
(assert (or (not r_p38) (not r_f3) r_zcl_3))
...
(assert (or (not r_p38) (not r_f3_p) r_f2_p))


;%~r_zcl_4 | r_p37
(declare-fun r_zcl_4 () Bool)
(assert (or (not r_zcl_4) r_p37))
...
;%~r_p37 | ~r_f2 | r_zcl_4
(assert (or (not r_p37) (not r_f2) r_zcl_4))
...
(assert (or (not r_p37) (not r_f2_p) r_f1_p))


;%~r_zcl_5 | r_p36
(declare-fun r_zcl_5 () Bool)
(assert (or (not r_zcl_5) r_p36))
...
;%~r_p36 | ~r_f1 | r_zcl_5
(assert (or (not r_p36) (not r_f1) r_zcl_5))
...
(assert (or (not r_p36) (not r_f1_p) r_f0_p))


;%~r_f12 | r_p34 | r_p28
(declare-fun r_f12 () Bool)
(assert (or (not r_f12) r_p34 r_p28))


;%~r_p34 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p34) r_f12_p))


;%~r_p28 | r_f12_p
(assert (or (not r_p28) r_f12_p))


;%~r_f11 | r_p33 | r_f12
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_p33 r_f12))


;%~r_p33 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p33) r_f11_p))
...
(assert (or (not r_f10) r_p32 r_f11))


;%~r_p32 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p32) r_f10_p))
...
(assert (or (not r_f9) r_p31 r_f10))


;%~r_p31 | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p31) r_f9_p))
...
(assert (or (not r_f8) r_p30 r_f9))


;%~r_p30 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p30) r_f8_p))
...
(assert (or (not r_f7) r_p29 r_f8))


;%~r_p29 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p29) r_f7_p))
...
(assert (or (not r_zcl_6) r_p27))


;%~r_zcl_6 | r_p21
(assert (or (not r_zcl_6) r_p21))


;%~r_p27 | ~r_p21 | r_zcl_6
(assert (or (not r_p27) (not r_p21) r_zcl_6))
...
(assert (or (not r_p27) (not r_p21) r_f19_p))


;%~r_zcl_7 | r_p26
(declare-fun r_zcl_7 () Bool)
(assert (or (not r_zcl_7) r_p26))
...
;%~r_p26 | ~r_f19 | r_zcl_7
(assert (or (not r_p26) (not r_f19) r_zcl_7))
...
;%~r_p26 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p26) (not r_f19_p) r_f18_p))


;%~r_zcl_8 | r_p25
(declare-fun r_zcl_8 () Bool)
(assert (or (not r_zcl_8) r_p25))
...
;%~r_p25 | ~r_f18 | r_zcl_8
(assert (or (not r_p25) (not r_f18) r_zcl_8))
...
;%~r_p25 | ~r_f18_p | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p25) (not r_f18_p) r_f17_p))


;%~r_zcl_9 | r_p24
(declare-fun r_zcl_9 () Bool)
(assert (or (not r_zcl_9) r_p24))
...
;%~r_p24 | ~r_f17 | r_zcl_9
(assert (or (not r_p24) (not r_f17) r_zcl_9))
...
;%~r_p24 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p24) (not r_f17_p) r_f16_p))


;%~r_zcl_10 | r_p23
(declare-fun r_zcl_10 () Bool)
(assert (or (not r_zcl_10) r_p23))
...
;%~r_p23 | ~r_f16 | r_zcl_10
(assert (or (not r_p23) (not r_f16) r_zcl_10))
...
;%~r_p23 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p23) (not r_f16_p) r_f15_p))


;%~r_zcl_11 | r_p22
(declare-fun r_zcl_11 () Bool)
(assert (or (not r_zcl_11) r_p22))
...
;%~r_p22 | ~r_f15 | r_zcl_11
(assert (or (not r_p22) (not r_f15) r_zcl_11))
...
;%~r_p22 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p22) (not r_f15_p) r_f14_p))


;%~r_f26 | r_p20 | r_p14
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_p20 r_p14))


;%~r_p20 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p20) r_f26_p))
...
(assert (or (not r_f25) r_p19 r_f26))


;%~r_p19 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p19) r_f25_p))
...
(assert (or (not r_f24) r_p18 r_f25))


;%~r_p18 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p18) r_f24_p))
...
(assert (or (not r_f23) r_p17 r_f24))


;%~r_p17 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p17) r_f23_p))
...
(assert (or (not r_f22) r_p16 r_f23))


;%~r_p16 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p16) r_f22_p))
...
(assert (or (not r_f21) r_p15 r_f22))


;%~r_p15 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p15) r_f21_p))
...
;%~r_p13 | ~r_p7 | r_zcl_12
(assert (or (not r_p13) (not r_p7) r_zcl_12))
...
(assert (or (not r_p13) (not r_p7) r_f33_p))


;%~r_zcl_13 | r_p12
(declare-fun r_zcl_13 () Bool)
(assert (or (not r_zcl_13) r_p12))
...
;%~r_p12 | ~r_f33 | r_zcl_13
(assert (or (not r_p12) (not r_f33) r_zcl_13))
...
;%~r_p11 | ~r_f32 | r_zcl_14
(assert (or (not r_p11) (not r_f32) r_zcl_14))
...
;%~r_p11 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p11) (not r_f32_p) r_f31_p))
...
;%~r_p10 | ~r_f31 | r_zcl_15
(assert (or (not r_p10) (not r_f31) r_zcl_15))
...
;%~r_p9 | ~r_f30 | r_zcl_16
(assert (or (not r_p9) (not r_f30) r_zcl_16))
...
;%~r_p9 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p9) (not r_f30_p) r_f29_p))
...
;%~r_p8 | ~r_f29 | r_zcl_17
(assert (or (not r_p8) (not r_f29) r_zcl_17))
...
;%~r_p8 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p8) (not r_f29_p) r_f28_p))
