...
;%~p1 | ~p11 | zcl_0
(assert (or (not l_p1) (not l_p11) l_zcl_0))
...
;%~p1 | ~p11 | f4_p
(assert (or (not l_p1) (not l_p11) l_f4_p))
...
;%~p12 | ~f4 | zcl_1
(assert (or (not l_p12) (not l_f4) l_zcl_1))
...
;%~p12 | ~f4_p | f3_p
(assert (or (not l_p12) (not l_f4_p) l_f3_p))
...
;%~p2 | ~f3 | zcl_2
(assert (or (not l_p2) (not l_f3) l_zcl_2))
...
;%~p4 | ~f2 | zcl_3
(assert (or (not l_p4) (not l_f2) l_zcl_3))
...
;%~p2 | ~f1 | zcl_4
(assert (or (not l_p2) (not l_f1) l_zcl_4))
...
;%~f10 | p4 | p10
(assert (or (not l_f10) l_p4 l_p10))
...
;%~p5 | ~p8 | zcl_5
(assert (or (not l_p5) (not l_p8) l_zcl_5))
...
;%~p5 | ~p8 | f16_p
(assert (or (not l_p5) (not l_p8) l_f16_p))
...
;%~p4 | ~f16 | zcl_6
(assert (or (not l_p4) (not l_f16) l_zcl_6))
...
;%~p4 | ~f15 | zcl_7
(assert (or (not l_p4) (not l_f15) l_zcl_7))
...
;%~zcl_8 | p3
(assert (or (not l_zcl_8) l_p3))

;%~zcl_8 | f14
(assert (or (not l_zcl_8) l_f14))

;%~p3 | ~f14 | zcl_8
(assert (or (not l_p3) (not l_f14) l_zcl_8))
...
;%~f21 | p1 | f22
(assert (or (not l_f21) l_p1 l_f22))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p1 | f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p1 | f21_p
(assert (or (not l_p1) l_f21_p))
...
;%~r_p1 | ~r_p11 | r_zcl_0
(assert (or (not r_p1) (not r_p11) r_zcl_0))
...
(assert (or (not r_p1) (not r_p11) r_f4_p))
...
;%~r_p12 | ~r_f4 | r_zcl_1
(assert (or (not r_p12) (not r_f4) r_zcl_1))
...
(assert (or (not r_p12) (not r_f4_p) r_f3_p))
...
;%~r_p2 | ~r_f3 | r_zcl_2
(assert (or (not r_p2) (not r_f3) r_zcl_2))
...
;%~r_p4 | ~r_f2 | r_zcl_3
(assert (or (not r_p4) (not r_f2) r_zcl_3))
...
;%~r_p2 | ~r_f1 | r_zcl_4
(assert (or (not r_p2) (not r_f1) r_zcl_4))
...
(assert (or (not r_f10) r_p4 r_p10))


;%~r_p4 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p4) r_f10_p))
...
;%~r_p5 | ~r_p8 | r_zcl_5
(assert (or (not r_p5) (not r_p8) r_zcl_5))
...
(assert (or (not r_p5) (not r_p8) r_f16_p))
...
;%~r_p4 | ~r_f16 | r_zcl_6
(assert (or (not r_p4) (not r_f16) r_zcl_6))
...
;%~r_p4 | ~r_f15 | r_zcl_7
(assert (or (not r_p4) (not r_f15) r_zcl_7))
...
;%~r_p3 | ~r_f14 | r_zcl_8
(assert (or (not r_p3) (not r_f14) r_zcl_8))
...
(assert (or (not r_f21) r_p1 r_f22))


;%~r_p1 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p1) r_f21_p))
