...
;%~p5 | ~p10 | zcl_0
(assert (or (not l_p5) (not l_p10) l_zcl_0))
...
;%~p5 | ~p10 | f6_p
(assert (or (not l_p5) (not l_p10) l_f6_p))
...
;%~p1 | ~f6 | zcl_1
(assert (or (not l_p1) (not l_f6) l_zcl_1))
...
;%~r_p5 | ~r_p10 | r_zcl_0
(assert (or (not r_p5) (not r_p10) r_zcl_0))
...
(assert (or (not r_p5) (not r_p10) r_f6_p))
...
;%~r_p1 | ~r_f6 | r_zcl_1
(assert (or (not r_p1) (not r_f6) r_zcl_1))
