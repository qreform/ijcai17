...
;%~p15 | ~p12 | zcl_0
(assert (or (not l_p15) (not l_p12) l_zcl_0))
...
;%~p15 | ~p12 | f2_p
(assert (or (not l_p15) (not l_p12) l_f2_p))
...
;%~p14 | ~f2 | zcl_1
(assert (or (not l_p14) (not l_f2) l_zcl_1))
...
;%~p13 | ~f1 | zcl_2
(assert (or (not l_p13) (not l_f1) l_zcl_2))
...
;%~p13 | ~f1_p | f0_p
(assert (or (not l_p13) (not l_f1_p) l_f0_p))
...
;%~p7 | ~p4 | f10_p
(assert (or (not l_p7) (not l_p4) l_f10_p))
...
;%~p3 | ~p0 | f13_p
(assert (or (not l_p3) (not l_p0) l_f13_p))
...
;%~zcl_7 | f13
(assert (or (not l_zcl_7) l_f13))

;%~p2 | ~f13 | zcl_7
(assert (or (not l_p2) (not l_f13) l_zcl_7))

(declare-fun l_f12 () Bool)
;%~f12 | zcl_7
(assert (or (not l_f12) l_zcl_7))
...
;%~p1 | ~f12 | zcl_8
(assert (or (not l_p1) (not l_f12) l_zcl_8))
...
;%~zcl_9 | f4
(assert (or (not l_zcl_9) l_f4))

;%~zcl_9 | f7
(assert (or (not l_zcl_9) l_f7))

;%~f4 | ~f7 | zcl_9
(assert (or (not l_f4) (not l_f7) l_zcl_9))

(declare-fun l_f3 () Bool)
;%~f3 | zcl_9
(assert (or (not l_f3) l_zcl_9))
...
;%~r_p15 | ~r_p12 | r_zcl_0
(assert (or (not r_p15) (not r_p12) r_zcl_0))
...
(assert (or (not r_p15) (not r_p12) r_f2_p))
...
;%~r_p14 | ~r_f2 | r_zcl_1
(assert (or (not r_p14) (not r_f2) r_zcl_1))
...
;%~r_p13 | ~r_f1 | r_zcl_2
(assert (or (not r_p13) (not r_f1) r_zcl_2))
...
(assert (or (not r_p13) (not r_f1_p) r_f0_p))


;%~r_f6 | r_p11 | r_p8
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_p11 r_p8))
...
(assert (or (not r_p7) (not r_p4) r_f10_p))
...
(assert (or (not r_f13) r_zcl_6))


;%~r_p3 | ~r_p0 | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p3) (not r_p0) r_f13_p))
...
;%~r_zcl_7 | r_f13
(assert (or (not r_zcl_7) r_f13))


;%~r_p2 | ~r_f13 | r_zcl_7
(assert (or (not r_p2) (not r_f13) r_zcl_7))


;%~r_f12 | r_zcl_7
(declare-fun r_f12 () Bool)
(assert (or (not r_f12) r_zcl_7))
...
;%~r_p1 | ~r_f12 | r_zcl_8
(assert (or (not r_p1) (not r_f12) r_zcl_8))
...
;%~r_f4 | ~r_f7 | r_zcl_9
(assert (or (not r_f4) (not r_f7) r_zcl_9))


;%~r_f3 | r_zcl_9
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_zcl_9))
