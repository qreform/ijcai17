...
cnf(l_axiom4,axiom,(~zcl_14 | p5)) .
cnf(l_axiom5,axiom,(~zcl_14 | p7)) .
cnf(l_axiom6,axiom,(~p5 | ~p7 | zcl_14)) .
cnf(l_axiom7,axiom,(~f2 | zcl_14)) .
cnf(l_axiom8,axiom,(~p5 | ~p7 | f2_p)) .
cnf(l_axiom9,axiom,(~f4 | p2 | p6)) .
cnf(l_axiom10,axiom,(~p2 | f4_p)) .
cnf(l_axiom11,axiom,(~p6 | f4_p)) .
cnf(l_axiom12,axiom,(~zcl_15 | p2)) .
cnf(l_axiom13,axiom,(~zcl_15 | p5)) .
cnf(l_axiom14,axiom,(~p2 | ~p5 | zcl_15)) .
cnf(l_axiom15,axiom,(~f6 | zcl_15)) .
cnf(l_axiom16,axiom,(~p2 | ~p5 | f6_p)) .
cnf(l_axiom17,axiom,(~f8 | p0 | p4)) .
...
cnf(r_axiom13,axiom,(~acc_zcl_14 | acc_p5)) .
cnf(r_axiom14,axiom,(~acc_zcl_14 | acc_p7)) .
cnf(r_axiom15,axiom,(~acc_p5 | ~acc_p7 | acc_zcl_14)) .
cnf(r_axiom16,axiom,(~acc_f2 | acc_zcl_14)) .
cnf(r_axiom17,axiom,(~acc_p5 | ~acc_p7 | acc_f2_p)) .
cnf(r_axiom18,axiom,(~acc_f4 | acc_p2 | acc_p6)) .
cnf(r_axiom19,axiom,(~acc_p2 | acc_f4_p)) .
cnf(r_axiom20,axiom,(~acc_p6 | acc_f4_p)) .
cnf(r_axiom21,axiom,(~acc_zcl_15 | acc_p2)) .
cnf(r_axiom22,axiom,(~acc_zcl_15 | acc_p5)) .
cnf(r_axiom23,axiom,(~acc_p2 | ~acc_p5 | acc_zcl_15)) .
cnf(r_axiom24,axiom,(~acc_f6 | acc_zcl_15)) .
cnf(r_axiom25,axiom,(~acc_p2 | ~acc_p5 | acc_f6_p)) .
cnf(r_axiom26,axiom,(~acc_f8 | acc_p0 | acc_p4)) .
...
cnf(r_axiom31,axiom,(~acc_p3 | ~acc_p2 | acc_zcl_16)) .
cnf(r_axiom32,axiom,(~acc_f10 | acc_zcl_16)) .
cnf(r_axiom33,axiom,(~acc_p3 | ~acc_p2 | acc_f10_p)) .
