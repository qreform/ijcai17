...
;%~p4 | ~p8 | zcl_0
(assert (or (not l_p4) (not l_p8) l_zcl_0))
...
;%~p4 | ~p8 | f6_p
(assert (or (not l_p4) (not l_p8) l_f6_p))
...
;%~zcl_2 | p7
(assert (or (not l_zcl_2) l_p7))

;%~zcl_2 | f5
(assert (or (not l_zcl_2) l_f5))

;%~p7 | ~f5 | zcl_2
(assert (or (not l_p7) (not l_f5) l_zcl_2))
...
;%~p7 | ~f5_p | f4_p
(assert (or (not l_p7) (not l_f5_p) l_f4_p))
...
;%~p0 | ~p6 | f14_p
(assert (or (not l_p0) (not l_p6) l_f14_p))
...
;%~p5 | ~f14 | zcl_4
(assert (or (not l_p5) (not l_f14) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p5 & f14_p) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p5 | ~f14_p | f13_p
(assert (or (not l_p5) (not l_f14_p) l_f13_p))
...
;%~p0 | ~f22 | zcl_7
(assert (or (not l_p0) (not l_f22) l_zcl_7))
...
;%~r_p4 | ~r_p8 | r_zcl_0
(assert (or (not r_p4) (not r_p8) r_zcl_0))
...
(assert (or (not r_p4) (not r_p8) r_f6_p))
...
;%~r_p7 | ~r_f5 | r_zcl_2
(assert (or (not r_p7) (not r_f5) r_zcl_2))
...
(assert (or (not r_p7) (not r_f5_p) r_f4_p))


;%~r_f10 | r_p5 | r_p7
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p5 r_p7))
...
(assert (or (not r_p0) (not r_p6) r_f14_p))
...
;%~r_p5 | ~r_f14 | r_zcl_4
(assert (or (not r_p5) (not r_f14) r_zcl_4))
...
;%~r_p5 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p5) (not r_f14_p) r_f13_p))
...
(assert (or (not r_f18) r_p4 r_p5))


;%~r_p4 | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p4) r_f18_p))
...
;%~r_p0 | ~r_f22 | r_zcl_7
(assert (or (not r_p0) (not r_f22) r_zcl_7))
