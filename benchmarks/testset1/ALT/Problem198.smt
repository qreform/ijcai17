...
;%~p3 | ~p8 | f1_p
(assert (or (not l_p3) (not l_p8) l_f1_p))
...
;%~p4 | ~f7 | zcl_3
(assert (or (not l_p4) (not l_f7) l_zcl_3))
...
(assert (or (not r_p3) (not r_p8) r_f1_p))
...
;%~r_p4 | ~r_f7 | r_zcl_3
(assert (or (not r_p4) (not r_f7) r_zcl_3))
