...
;%~p13 | ~p12 | zcl_0
(assert (or (not l_p13) (not l_p12) l_zcl_0))
...
;%~p13 | ~p12 | f8_p
(assert (or (not l_p13) (not l_p12) l_f8_p))
...
;%~p11 | ~f7 | zcl_2
(assert (or (not l_p11) (not l_f7) l_zcl_2))
...
;%~p11 | ~f7_p | f6_p
(assert (or (not l_p11) (not l_f7_p) l_f6_p))
...
;%~p9 | ~f6 | zcl_3
(assert (or (not l_p9) (not l_f6) l_zcl_3))
...
;%~p9 | ~f6_p | f5_p
(assert (or (not l_p9) (not l_f6_p) l_f5_p))
...
;%~f13 | p9 | p11
(assert (or (not l_f13) l_p9 l_p11))
...
;%~p9 | ~p10 | zcl_4
(assert (or (not l_p9) (not l_p10) l_zcl_4))
...
;%~p9 | ~p10 | f18_p
(assert (or (not l_p9) (not l_p10) l_f18_p))
...
;%~p9 | ~f17 | zcl_6
(assert (or (not l_p9) (not l_f17) l_zcl_6))
...
;%~p9 | ~f17_p | f16_p
(assert (or (not l_p9) (not l_f17_p) l_f16_p))
...
;%~p9 | ~f16 | zcl_7
(assert (or (not l_p9) (not l_f16) l_zcl_7))
...
;%~f22 | p5 | f23
(assert (or (not l_f22) l_p5 l_f23))
...
;%~p8 | ~p5 | f28_p
(assert (or (not l_p8) (not l_p5) l_f28_p))
...
(assert (or (not r_f1) r_p15 r_f2))


;%~r_p15 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p15) r_f1_p))
...
;%~r_p13 | ~r_p12 | r_zcl_0
(assert (or (not r_p13) (not r_p12) r_zcl_0))
...
(assert (or (not r_p13) (not r_p12) r_f8_p))
...
;%~r_p11 | ~r_f7 | r_zcl_2
(assert (or (not r_p11) (not r_f7) r_zcl_2))
...
(assert (or (not r_p11) (not r_f7_p) r_f6_p))
...
;%~r_p9 | ~r_f6 | r_zcl_3
(assert (or (not r_p9) (not r_f6) r_zcl_3))
...
(assert (or (not r_p9) (not r_f6_p) r_f5_p))


;%~r_f13 | r_p9 | r_p11
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_p9 r_p11))
...
;%~r_p9 | ~r_p10 | r_zcl_4
(assert (or (not r_p9) (not r_p10) r_zcl_4))
...
(assert (or (not r_p9) (not r_p10) r_f18_p))
...
;%~r_p9 | ~r_f17 | r_zcl_6
(assert (or (not r_p9) (not r_f17) r_zcl_6))
...
;%~r_p9 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p9) (not r_f17_p) r_f16_p))
...
;%~r_p9 | ~r_f16 | r_zcl_7
(assert (or (not r_p9) (not r_f16) r_zcl_7))
...
(assert (or (not r_f22) r_p5 r_f23))
...
(assert (or (not r_p8) (not r_p5) r_f28_p))
