...
;%~p0 | ~p13 | f4_p
(assert (or (not l_p0) (not l_p13) l_f4_p))
...
;%~p7 | ~f2 | zcl_3
(assert (or (not l_p7) (not l_f2) l_zcl_3))
...
;%~f10 | p7 | p11
(assert (or (not l_f10) l_p7 l_p11))
...
;%~p10 | ~p9 | zcl_5
(assert (or (not l_p10) (not l_p9) l_zcl_5))
...
(assert (or (not r_p0) (not r_p13) r_f4_p))
...
;%~r_p7 | ~r_f2 | r_zcl_3
(assert (or (not r_p7) (not r_f2) r_zcl_3))
...
(assert (or (not r_f10) r_p7 r_p11))
...
;%~r_p10 | ~r_p9 | r_zcl_5
(assert (or (not r_p10) (not r_p9) r_zcl_5))
