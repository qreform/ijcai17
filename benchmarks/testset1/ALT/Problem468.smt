...
;%~p3 | ~p9 | f6_p
(assert (or (not l_p3) (not l_p9) l_f6_p))
...
;%~p3 | ~p6 | f14_p
(assert (or (not l_p3) (not l_p6) l_f14_p))
...
;%~p7 | ~f14 | zcl_4
(assert (or (not l_p7) (not l_f14) l_zcl_4))
...
;%~p7 | ~f14_p | f13_p
(assert (or (not l_p7) (not l_f14_p) l_f13_p))
...
(assert (or (not r_p3) (not r_p9) r_f6_p))
...
(assert (or (not r_p3) (not r_p6) r_f14_p))
...
;%~r_p7 | ~r_f14 | r_zcl_4
(assert (or (not r_p7) (not r_f14) r_zcl_4))
...
;%~r_p7 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p7) (not r_f14_p) r_f13_p))
