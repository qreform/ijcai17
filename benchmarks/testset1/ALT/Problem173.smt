...
;%~f5 | p18 | p16
(assert (or (not l_f5) l_p18 l_p16))
...
;%~p18 | f5_p
(assert (or (not l_p18) l_f5_p))

;%~p16 | f5_p
(assert (or (not l_p16) l_f5_p))
...
;%~p0 | ~p12 | zcl_0
(assert (or (not l_p0) (not l_p12) l_zcl_0))
...
;%~p0 | ~p12 | f12_p
(assert (or (not l_p0) (not l_p12) l_f12_p))
...
;%~p15 | ~f12 | zcl_1
(assert (or (not l_p15) (not l_f12) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((p15 & f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p15 | ~f12_p | f11_p
(assert (or (not l_p15) (not l_f12_p) l_f11_p))
...
;%~p14 | ~f10 | zcl_3
(assert (or (not l_p14) (not l_f10) l_zcl_3))
...
;%~p14 | ~f10_p | f9_p
(assert (or (not l_p14) (not l_f10_p) l_f9_p))
...
;%~p0 | ~f9 | zcl_4
(assert (or (not l_p0) (not l_f9) l_zcl_4))
...
;%~p13 | ~f8 | zcl_5
(assert (or (not l_p13) (not l_f8) l_zcl_5))
...
;%Non-clausified dependency
;%(forall[]((p13 & f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p13 | ~f8_p | f7_p
(assert (or (not l_p13) (not l_f8_p) l_f7_p))
...
;%~f19 | p0 | p10
(assert (or (not l_f19) l_p0 l_p10))
...
;%~p0 | f19_p
(assert (or (not l_p0) l_f19_p))

;%~p10 | f19_p
(assert (or (not l_p10) l_f19_p))
...
;%~f16 | p11 | f17
(assert (or (not l_f16) l_p11 l_f17))
...
;%~p9 | ~p7 | f26_p
(assert (or (not l_p9) (not l_p7) l_f26_p))
...
;%~p0 | ~f26 | zcl_7
(assert (or (not l_p0) (not l_f26) l_zcl_7))
...
;%~p0 | ~f25 | zcl_8
(assert (or (not l_p0) (not l_f25) l_zcl_8))
...
;%~p0 | ~f24 | zcl_9
(assert (or (not l_p0) (not l_f24) l_zcl_9))
...
;%~p8 | ~f23 | zcl_10
(assert (or (not l_p8) (not l_f23) l_zcl_10))
...
;%~p0 | ~f22 | zcl_11
(assert (or (not l_p0) (not l_f22) l_zcl_11))
...
(assert (or (not r_f5) r_p18 r_p16))


;%~r_p18 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p18) r_f5_p))


;%~r_p16 | r_f5_p
(assert (or (not r_p16) r_f5_p))


;%~r_f4 | r_p17 | r_f5
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_p17 r_f5))
...
;%~r_p0 | ~r_p12 | r_zcl_0
(assert (or (not r_p0) (not r_p12) r_zcl_0))
...
(assert (or (not r_p0) (not r_p12) r_f12_p))
...
;%~r_p15 | ~r_f12 | r_zcl_1
(assert (or (not r_p15) (not r_f12) r_zcl_1))
...
;%~r_p15 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p15) (not r_f12_p) r_f11_p))
...
;%~r_p14 | ~r_f10 | r_zcl_3
(assert (or (not r_p14) (not r_f10) r_zcl_3))
...
;%~r_p14 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p14) (not r_f10_p) r_f9_p))
...
;%~r_p0 | ~r_f9 | r_zcl_4
(assert (or (not r_p0) (not r_f9) r_zcl_4))
...
;%~r_p13 | ~r_f8 | r_zcl_5
(assert (or (not r_p13) (not r_f8) r_zcl_5))
...
(assert (or (not r_p13) (not r_f8_p) r_f7_p))


;%~r_f19 | r_p0 | r_p10
(declare-fun r_f19 () Bool)
(assert (or (not r_f19) r_p0 r_p10))


;%~r_p0 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p0) r_f19_p))


;%~r_p10 | r_f19_p
(assert (or (not r_p10) r_f19_p))
...
(assert (or (not r_f16) r_p11 r_f17))


;%~r_p11 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p11) r_f16_p))
...
(assert (or (not r_p9) (not r_p7) r_f26_p))
...
;%~r_p0 | ~r_f26 | r_zcl_7
(assert (or (not r_p0) (not r_f26) r_zcl_7))
...
;%~r_p0 | ~r_f25 | r_zcl_8
(assert (or (not r_p0) (not r_f25) r_zcl_8))
...
;%~r_p0 | ~r_f24 | r_zcl_9
(assert (or (not r_p0) (not r_f24) r_zcl_9))
...
;%~r_p8 | ~r_f23 | r_zcl_10
(assert (or (not r_p8) (not r_f23) r_zcl_10))
...
;%~r_p0 | ~r_f22 | r_zcl_11
(assert (or (not r_p0) (not r_f22) r_zcl_11))
