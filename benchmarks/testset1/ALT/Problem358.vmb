%%%%%%%%%%%%%%%% Target reformulation: ((p6 | (~p1 | p5)) & ((p1 & (p2 & p4)) | ((~p0 | (p2 | p3)) & (~p1 | (~p2 | p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom7,axiom,(~zcl_8 | p2)) .
cnf(l_axiom8,axiom,(~zcl_8 | p4)) .
cnf(l_axiom9,axiom,(~p2 | ~p4 | zcl_8)) .
cnf(l_axiom10,axiom,(~f4 | zcl_8)) .
cnf(l_axiom11,axiom,(~p2 | ~p4 | f4_p)) .
...
cnf(r_axiom7,axiom,(~acc_f1 | acc_p1 | acc_p5)) .
cnf(r_axiom8,axiom,(~acc_p1 | acc_f1_p)) .
cnf(r_axiom9,axiom,(~acc_p5 | acc_f1_p)) .
cnf(r_axiom10,axiom,(~acc_f0 | acc_p6 | acc_f1)) .
cnf(r_axiom11,axiom,(~acc_p6 | acc_f0_p)) .
cnf(r_axiom12,axiom,(~acc_f1_p | acc_f0_p)) .
cnf(r_axiom13,axiom,(~acc_zcl_8 | acc_p2)) .
cnf(r_axiom14,axiom,(~acc_zcl_8 | acc_p4)) .
cnf(r_axiom15,axiom,(~acc_p2 | ~acc_p4 | acc_zcl_8)) .
cnf(r_axiom16,axiom,(~acc_f4 | acc_zcl_8)) .
cnf(r_axiom17,axiom,(~acc_p2 | ~acc_p4 | acc_f4_p)) .
cnf(r_axiom18,axiom,(~acc_zcl_9 | acc_p1)) .
cnf(r_axiom19,axiom,(~acc_zcl_9 | acc_f4)) .
cnf(r_axiom20,axiom,(~acc_p1 | ~acc_f4 | acc_zcl_9)) .
cnf(r_axiom21,axiom,(~acc_f3 | acc_zcl_9)) .
cnf(r_axiom22,axiom,(~acc_p1 | ~acc_f4_p | acc_f3_p)) .
