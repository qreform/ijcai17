%%%%%%%%%%%%%%%% Target reformulation: ((p3 & (p10 & (p0 & p9))) | ((p8 | (p6 | (p4 | p7))) & ((p0 & (p5 & (p4 & p6))) | ((p5 | (p3 | (p3 | p4))) & (p1 | (p2 | (p3 | p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_16 | p0)) .
cnf(l_axiom2,axiom,(~zcl_16 | p9)) .
cnf(l_axiom3,axiom,(~p0 | ~p9 | zcl_16)) .
cnf(l_axiom4,axiom,(~f2 | zcl_16)) .
cnf(l_axiom5,axiom,(~p0 | ~p9 | f2_p)) .
cnf(l_axiom6,axiom,(~zcl_17 | p10)) .
cnf(l_axiom7,axiom,(~zcl_17 | f2)) .
cnf(l_axiom8,axiom,(~p10 | ~f2 | zcl_17)) .
cnf(l_axiom9,axiom,(~f1 | zcl_17)) .
cnf(l_axiom10,axiom,(~p10 | ~f2_p | f1_p)) .
cnf(l_axiom11,axiom,(~zcl_18 | p3)) .
cnf(l_axiom12,axiom,(~zcl_18 | f1)) .
cnf(l_axiom13,axiom,(~p3 | ~f1 | zcl_18)) .
cnf(l_axiom14,axiom,(~f0 | zcl_18)) .
cnf(l_axiom15,axiom,(~p3 | ~f1_p | f0_p)) .
cnf(l_axiom16,axiom,(~f6 | p4 | p7)) .
cnf(l_axiom17,axiom,(~p4 | f6_p)) .
cnf(l_axiom18,axiom,(~p7 | f6_p)) .
cnf(l_axiom19,axiom,(~f5 | p6 | f6)) .
cnf(l_axiom20,axiom,(~p6 | f5_p)) .
cnf(l_axiom21,axiom,(~f6_p | f5_p)) .
cnf(l_axiom22,axiom,(~f4 | p8 | f5)) .
cnf(l_axiom23,axiom,(~p8 | f4_p)) .
...
cnf(l_axiom40,axiom,(~f14 | p3 | p4)) .
cnf(l_axiom41,axiom,(~p3 | f14_p)) .
...
cnf(r_axiom11,axiom,(~acc_zcl_16 | acc_p0)) .
cnf(r_axiom12,axiom,(~acc_zcl_16 | acc_p9)) .
cnf(r_axiom13,axiom,(~acc_p0 | ~acc_p9 | acc_zcl_16)) .
cnf(r_axiom14,axiom,(~acc_f2 | acc_zcl_16)) .
cnf(r_axiom15,axiom,(~acc_p0 | ~acc_p9 | acc_f2_p)) .
cnf(r_axiom16,axiom,(~acc_zcl_17 | acc_p10)) .
cnf(r_axiom17,axiom,(~acc_zcl_17 | acc_f2)) .
cnf(r_axiom18,axiom,(~acc_p10 | ~acc_f2 | acc_zcl_17)) .
cnf(r_axiom19,axiom,(~acc_f1 | acc_zcl_17)) .
cnf(r_axiom20,axiom,(~acc_p10 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom21,axiom,(~acc_zcl_18 | acc_p3)) .
cnf(r_axiom22,axiom,(~acc_zcl_18 | acc_f1)) .
cnf(r_axiom23,axiom,(~acc_p3 | ~acc_f1 | acc_zcl_18)) .
cnf(r_axiom24,axiom,(~acc_f0 | acc_zcl_18)) .
cnf(r_axiom25,axiom,(~acc_p3 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom26,axiom,(~acc_f6 | acc_p4 | acc_p7)) .
cnf(r_axiom27,axiom,(~acc_p4 | acc_f6_p)) .
cnf(r_axiom28,axiom,(~acc_p7 | acc_f6_p)) .
cnf(r_axiom29,axiom,(~acc_f5 | acc_p6 | acc_f6)) .
cnf(r_axiom30,axiom,(~acc_p6 | acc_f5_p)) .
cnf(r_axiom31,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom32,axiom,(~acc_f4 | acc_p8 | acc_f5)) .
cnf(r_axiom33,axiom,(~acc_p8 | acc_f4_p)) .
...
cnf(r_axiom40,axiom,(~acc_zcl_20 | acc_p5)) .
cnf(r_axiom41,axiom,(~acc_zcl_20 | acc_f10)) .
cnf(r_axiom42,axiom,(~acc_p5 | ~acc_f10 | acc_zcl_20)) .
cnf(r_axiom43,axiom,(~acc_f9 | acc_zcl_20)) .
cnf(r_axiom44,axiom,(~acc_p5 | ~acc_f10_p | acc_f9_p)) .
...
cnf(r_axiom50,axiom,(~acc_f14 | acc_p3 | acc_p4)) .
cnf(r_axiom51,axiom,(~acc_p3 | acc_f14_p)) .
...
cnf(r_axiom56,axiom,(~acc_f12 | acc_p5 | acc_f13)) .
cnf(r_axiom57,axiom,(~acc_p5 | acc_f12_p)) .
