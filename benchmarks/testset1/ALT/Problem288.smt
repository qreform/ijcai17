...
;%~f4 | p10 | p20
(assert (or (not l_f4) l_p10 l_p20))
...
;%~p10 | f4_p
(assert (or (not l_p10) l_f4_p))

;%~p20 | f4_p
(assert (or (not l_p20) l_f4_p))
...
;%~f3 | p15 | f4
(assert (or (not l_f3) l_p15 l_f4))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p15 | f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p15 | f3_p
(assert (or (not l_p15) l_f3_p))
...
;%~zcl_0 | p17
(assert (or (not l_zcl_0) l_p17))

;%~p11 | ~p17 | zcl_0
(assert (or (not l_p11) (not l_p17) l_zcl_0))
...
;%Non-clausified dependency
;%(forall[]((p11 & ~p17) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p11 | ~p17 | f10_p
(assert (or (not l_p11) (not l_p17) l_f10_p))
...
;%~zcl_1 | p15
(assert (or (not l_zcl_1) l_p15))

;%~zcl_1 | f10
(assert (or (not l_zcl_1) l_f10))

;%~p15 | ~f10 | zcl_1
(assert (or (not l_p15) (not l_f10) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((~p15 & f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p15 | ~f10_p | f9_p
(assert (or (not l_p15) (not l_f10_p) l_f9_p))
...
;%~zcl_2 | p19
(assert (or (not l_zcl_2) l_p19))

;%~zcl_2 | f9
(assert (or (not l_zcl_2) l_f9))

;%~p19 | ~f9 | zcl_2
(assert (or (not l_p19) (not l_f9) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((~p19 & f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p19 | ~f9_p | f8_p
(assert (or (not l_p19) (not l_f9_p) l_f8_p))
...
;%~zcl_3 | p18
(assert (or (not l_zcl_3) l_p18))

;%~zcl_3 | f8
(assert (or (not l_zcl_3) l_f8))

;%~p18 | ~f8 | zcl_3
(assert (or (not l_p18) (not l_f8) l_zcl_3))
...
;%~p18 | ~f8_p | f7_p
(assert (or (not l_p18) (not l_f8_p) l_f7_p))
...
;%~p9 | ~f7 | zcl_4
(assert (or (not l_p9) (not l_f7) l_zcl_4))
...
;%~p9 | ~f7_p | f6_p
(assert (or (not l_p9) (not l_f7_p) l_f6_p))
...
;%~f16 | p0 | p15
(assert (or (not l_f16) l_p0 l_p15))
...
;%~p0 | f16_p
(assert (or (not l_p0) l_f16_p))

;%~p15 | f16_p
(assert (or (not l_p15) l_f16_p))
...
;%~f15 | p0 | f16
(assert (or (not l_f15) l_p0 l_f16))
...
;%~f14 | p0 | f15
(assert (or (not l_f14) l_p0 l_f15))
...
;%~f13 | p11 | f14
(assert (or (not l_f13) l_p11 l_f14))
...
;%~f12 | p16 | f13
(assert (or (not l_f12) l_p16 l_f13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p16 | f13_p) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p16 | f12_p
(assert (or (not l_p16) l_f12_p))
...
;%~zcl_5 | p14
(assert (or (not l_zcl_5) l_p14))

;%~zcl_5 | p11
(assert (or (not l_zcl_5) l_p11))

;%~p14 | ~p11 | zcl_5
(assert (or (not l_p14) (not l_p11) l_zcl_5))
...
;%Non-clausified dependency
;%(forall[]((~p14 & p11) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p14 | ~p11 | f22_p
(assert (or (not l_p14) (not l_p11) l_f22_p))
...
;%~p0 | ~f22 | zcl_6
(assert (or (not l_p0) (not l_f22) l_zcl_6))
...
;%~p10 | ~f21 | zcl_7
(assert (or (not l_p10) (not l_f21) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p10 & f21_p) --> f20_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f20_p () Bool)
;%~p10 | ~f21_p | f20_p
(assert (or (not l_p10) (not l_f21_p) l_f20_p))
...
;%~zcl_8 | p13
(assert (or (not l_zcl_8) l_p13))

;%~zcl_8 | f20
(assert (or (not l_zcl_8) l_f20))

;%~p13 | ~f20 | zcl_8
(assert (or (not l_p13) (not l_f20) l_zcl_8))
...
;%~p12 | ~f19 | zcl_9
(assert (or (not l_p12) (not l_f19) l_zcl_9))
...
;%~p0 | f28_p
(assert (or (not l_p0) l_f28_p))

;%~p9 | f28_p
(assert (or (not l_p9) l_f28_p))
...
;%~f27 | p0 | f28
(assert (or (not l_f27) l_p0 l_f28))
...
;%~f26 | p0 | f27
(assert (or (not l_f26) l_p0 l_f27))
...
;%~f25 | p10 | f26
(assert (or (not l_f25) l_p10 l_f26))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p10 | f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p10 | f25_p
(assert (or (not l_p10) l_f25_p))
...
;%~f24 | p0 | f25
(assert (or (not l_f24) l_p0 l_f25))
...
;%~p8 | ~p6 | zcl_10
(assert (or (not l_p8) (not l_p6) l_zcl_10))
...
;%~p8 | ~p6 | f34_p
(assert (or (not l_p8) (not l_p6) l_f34_p))
...
;%~p0 | ~f34 | zcl_11
(assert (or (not l_p0) (not l_f34) l_zcl_11))
...
;%~p0 | ~f33 | zcl_12
(assert (or (not l_p0) (not l_f33) l_zcl_12))
...
;%~p0 | ~f32 | zcl_13
(assert (or (not l_p0) (not l_f32) l_zcl_13))
...
(assert (or (not r_f4) r_p10 r_p20))


;%~r_p10 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p10) r_f4_p))


;%~r_p20 | r_f4_p
(assert (or (not r_p20) r_f4_p))


;%~r_f3 | r_p15 | r_f4
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_p15 r_f4))


;%~r_p15 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p15) r_f3_p))
...
(assert (or (not r_f1) r_p11 r_f2))


;%~r_p11 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p11) r_f1_p))
...
;%~r_zcl_0 | r_p17
(assert (or (not r_zcl_0) r_p17))


;%~r_p11 | ~r_p17 | r_zcl_0
(assert (or (not r_p11) (not r_p17) r_zcl_0))
...
(assert (or (not r_p11) (not r_p17) r_f10_p))


;%~r_zcl_1 | r_p15
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p15))
...
;%~r_p15 | ~r_f10 | r_zcl_1
(assert (or (not r_p15) (not r_f10) r_zcl_1))
...
;%~r_p15 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p15) (not r_f10_p) r_f9_p))


;%~r_zcl_2 | r_p19
(declare-fun r_zcl_2 () Bool)
(assert (or (not r_zcl_2) r_p19))
...
;%~r_p19 | ~r_f9 | r_zcl_2
(assert (or (not r_p19) (not r_f9) r_zcl_2))
...
(assert (or (not r_p19) (not r_f9_p) r_f8_p))


;%~r_zcl_3 | r_p18
(declare-fun r_zcl_3 () Bool)
(assert (or (not r_zcl_3) r_p18))
...
;%~r_p18 | ~r_f8 | r_zcl_3
(assert (or (not r_p18) (not r_f8) r_zcl_3))
...
(assert (or (not r_p18) (not r_f8_p) r_f7_p))
...
;%~r_p9 | ~r_f7 | r_zcl_4
(assert (or (not r_p9) (not r_f7) r_zcl_4))
...
(assert (or (not r_p9) (not r_f7_p) r_f6_p))


;%~r_f16 | r_p0 | r_p15
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_p0 r_p15))


;%~r_p0 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p0) r_f16_p))


;%~r_p15 | r_f16_p
(assert (or (not r_p15) r_f16_p))


;%~r_f15 | r_p0 | r_f16
(declare-fun r_f15 () Bool)
(assert (or (not r_f15) r_p0 r_f16))


;%~r_p0 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p0) r_f15_p))
...
(assert (or (not r_f14) r_p0 r_f15))


;%~r_p0 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p0) r_f14_p))
...
(assert (or (not r_f13) r_p11 r_f14))
...
(assert (or (not r_f12) r_p16 r_f13))


;%~r_p16 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p16) r_f12_p))
...
;%~r_p14 | ~r_p11 | r_zcl_5
(assert (or (not r_p14) (not r_p11) r_zcl_5))
...
(assert (or (not r_p14) (not r_p11) r_f22_p))
...
;%~r_p0 | ~r_f22 | r_zcl_6
(assert (or (not r_p0) (not r_f22) r_zcl_6))
...
;%~r_p10 | ~r_f21 | r_zcl_7
(assert (or (not r_p10) (not r_f21) r_zcl_7))
...
;%~r_p10 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p10) (not r_f21_p) r_f20_p))


;%~r_zcl_8 | r_p13
(declare-fun r_zcl_8 () Bool)
(assert (or (not r_zcl_8) r_p13))
...
;%~r_p13 | ~r_f20 | r_zcl_8
(assert (or (not r_p13) (not r_f20) r_zcl_8))
...
;%~r_p12 | ~r_f19 | r_zcl_9
(assert (or (not r_p12) (not r_f19) r_zcl_9))
...
(assert (or (not r_f28) r_p0 r_p9))


;%~r_p0 | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p0) r_f28_p))


;%~r_p9 | r_f28_p
(assert (or (not r_p9) r_f28_p))


;%~r_f27 | r_p0 | r_f28
(declare-fun r_f27 () Bool)
(assert (or (not r_f27) r_p0 r_f28))
...
(assert (or (not r_f26) r_p0 r_f27))
...
(assert (or (not r_f25) r_p10 r_f26))


;%~r_p10 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p10) r_f25_p))
...
(assert (or (not r_f24) r_p0 r_f25))


;%~r_p0 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p0) r_f24_p))
...
;%~r_p8 | ~r_p6 | r_zcl_10
(assert (or (not r_p8) (not r_p6) r_zcl_10))
...
(assert (or (not r_p8) (not r_p6) r_f34_p))
...
;%~r_p0 | ~r_f34 | r_zcl_11
(assert (or (not r_p0) (not r_f34) r_zcl_11))
...
;%~r_p0 | ~r_f33 | r_zcl_12
(assert (or (not r_p0) (not r_f33) r_zcl_12))
...
;%~r_p0 | ~r_f32 | r_zcl_13
(assert (or (not r_p0) (not r_f32) r_zcl_13))
