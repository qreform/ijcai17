...
;%~p8 | ~p11 | f3_p
(assert (or (not l_p8) (not l_p11) l_f3_p))
...
;%~p3 | ~f1 | zcl_3
(assert (or (not l_p3) (not l_f1) l_zcl_3))
...
;%~p3 | ~f1_p | f0_p
(assert (or (not l_p3) (not l_f1_p) l_f0_p))
...
;%~p6 | ~p8 | zcl_4
(assert (or (not l_p6) (not l_p8) l_zcl_4))
...
;%~p6 | ~p8 | f13_p
(assert (or (not l_p6) (not l_p8) l_f13_p))
...
;%~p1 | ~f12 | zcl_6
(assert (or (not l_p1) (not l_f12) l_zcl_6))
...
;%~p1 | ~f11 | zcl_7
(assert (or (not l_p1) (not l_f11) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p1 & f11_p) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p1 | ~f11_p | f10_p
(assert (or (not l_p1) (not l_f11_p) l_f10_p))
...
;%~f16 | p4 | f17
(assert (or (not l_f16) l_p4 l_f17))
...
(assert (or (not r_p8) (not r_p11) r_f3_p))
...
;%~r_p3 | ~r_f1 | r_zcl_3
(assert (or (not r_p3) (not r_f1) r_zcl_3))
...
(assert (or (not r_p3) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p8 | r_p9
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p8 r_p9))
...
;%~r_p6 | ~r_p8 | r_zcl_4
(assert (or (not r_p6) (not r_p8) r_zcl_4))
...
(assert (or (not r_p6) (not r_p8) r_f13_p))
...
;%~r_p1 | ~r_f12 | r_zcl_6
(assert (or (not r_p1) (not r_f12) r_zcl_6))
...
;%~r_p1 | ~r_f11 | r_zcl_7
(assert (or (not r_p1) (not r_f11) r_zcl_7))
...
;%~r_p1 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p1) (not r_f11_p) r_f10_p))
...
(assert (or (not r_f16) r_p4 r_f17))


;%~r_p4 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p4) r_f16_p))
