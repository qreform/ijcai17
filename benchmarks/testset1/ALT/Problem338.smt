...
;%~p11 | ~p9 | f4_p
(assert (or (not l_p11) (not l_p9) l_f4_p))
...
;%~p10 | ~f3 | zcl_2
(assert (or (not l_p10) (not l_f3) l_zcl_2))
...
;%~p3 | ~f1 | zcl_4
(assert (or (not l_p3) (not l_f1) l_zcl_4))
...
(assert (or (not r_p11) (not r_p9) r_f4_p))
...
;%~r_p10 | ~r_f3 | r_zcl_2
(assert (or (not r_p10) (not r_f3) r_zcl_2))
...
;%~r_p3 | ~r_f1 | r_zcl_4
(assert (or (not r_p3) (not r_f1) r_zcl_4))
