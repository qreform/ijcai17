...
;%~f2 | p27 | p24
(assert (or (not l_f2) l_p27 l_p24))
...
;%~p23 | ~p20 | zcl_0
(assert (or (not l_p23) (not l_p20) l_zcl_0))
...
;%~p23 | ~p20 | f6_p
(assert (or (not l_p23) (not l_p20) l_f6_p))
...
;%~p22 | ~f6 | zcl_1
(assert (or (not l_p22) (not l_f6) l_zcl_1))
...
;%~p22 | ~f6_p | f5_p
(assert (or (not l_p22) (not l_f6_p) l_f5_p))
...
;%~p21 | ~f5 | zcl_2
(assert (or (not l_p21) (not l_f5) l_zcl_2))
...
;%~p21 | ~f5_p | f4_p
(assert (or (not l_p21) (not l_f5_p) l_f4_p))
...
;%~f10 | p19 | p16
(assert (or (not l_f10) l_p19 l_p16))
...
;%~f9 | p18 | f10
(assert (or (not l_f9) l_p18 l_f10))
...
;%~p15 | ~p12 | zcl_3
(assert (or (not l_p15) (not l_p12) l_zcl_3))
...
;%~p15 | ~p12 | f14_p
(assert (or (not l_p15) (not l_p12) l_f14_p))
...
;%~p14 | ~f14 | zcl_4
(assert (or (not l_p14) (not l_f14) l_zcl_4))
...
;%~p13 | ~f13 | zcl_5
(assert (or (not l_p13) (not l_f13) l_zcl_5))
...
;%~f18 | p11 | p8
(assert (or (not l_f18) l_p11 l_p8))
...
;%~p7 | ~p4 | zcl_6
(assert (or (not l_p7) (not l_p4) l_zcl_6))

(declare-fun l_f22 () Bool)
;%~f22 | zcl_6
(assert (or (not l_f22) l_zcl_6))
...
;%~p7 | ~p4 | f22_p
(assert (or (not l_p7) (not l_p4) l_f22_p))
...
;%~zcl_7 | f22
(assert (or (not l_zcl_7) l_f22))

;%~p6 | ~f22 | zcl_7
(assert (or (not l_p6) (not l_f22) l_zcl_7))

(declare-fun l_f21 () Bool)
;%~f21 | zcl_7
(assert (or (not l_f21) l_zcl_7))
...
;%~zcl_8 | f21
(assert (or (not l_zcl_8) l_f21))

;%~p5 | ~f21 | zcl_8
(assert (or (not l_p5) (not l_f21) l_zcl_8))

(declare-fun l_f20 () Bool)
;%~f20 | zcl_8
(assert (or (not l_f20) l_zcl_8))
...
;%~p3 | ~p0 | zcl_9
(assert (or (not l_p3) (not l_p0) l_zcl_9))

(declare-fun l_f25 () Bool)
;%~f25 | zcl_9
(assert (or (not l_f25) l_zcl_9))
...
;%~p3 | ~p0 | f25_p
(assert (or (not l_p3) (not l_p0) l_f25_p))
...
;%~zcl_10 | f25
(assert (or (not l_zcl_10) l_f25))

;%~p2 | ~f25 | zcl_10
(assert (or (not l_p2) (not l_f25) l_zcl_10))

(declare-fun l_f24 () Bool)
;%~f24 | zcl_10
(assert (or (not l_f24) l_zcl_10))
...
;%~zcl_11 | f24
(assert (or (not l_zcl_11) l_f24))

;%~p1 | ~f24 | zcl_11
(assert (or (not l_p1) (not l_f24) l_zcl_11))

(declare-fun l_f23 () Bool)
;%~f23 | zcl_11
(assert (or (not l_f23) l_zcl_11))
...
;%~zcl_12 | f16
(assert (or (not l_zcl_12) l_f16))

;%~zcl_12 | f19
(assert (or (not l_zcl_12) l_f19))

;%~f16 | ~f19 | zcl_12
(assert (or (not l_f16) (not l_f19) l_zcl_12))

(declare-fun l_f15 () Bool)
;%~f15 | zcl_12
(assert (or (not l_f15) l_zcl_12))
...
;%~zcl_13 | f8
(assert (or (not l_zcl_13) l_f8))

;%~zcl_13 | f11
(assert (or (not l_zcl_13) l_f11))

;%~f8 | ~f11 | zcl_13
(assert (or (not l_f8) (not l_f11) l_zcl_13))

(declare-fun l_f7 () Bool)
;%~f7 | zcl_13
(assert (or (not l_f7) l_zcl_13))
...
;%~zcl_14 | f0
(assert (or (not l_zcl_14) l_f0))

;%~zcl_14 | f3
(assert (or (not l_zcl_14) l_f3))

;%~f0 | ~f3 | zcl_14
(assert (or (not l_f0) (not l_f3) l_zcl_14))

;%~Q | zcl_14
(assert (or (not l_q) l_zcl_14))
...
(assert (or (not r_f2) r_p27 r_p24))
...
;%~r_p23 | ~r_p20 | r_zcl_0
(assert (or (not r_p23) (not r_p20) r_zcl_0))
...
(assert (or (not r_p23) (not r_p20) r_f6_p))
...
;%~r_p22 | ~r_f6 | r_zcl_1
(assert (or (not r_p22) (not r_f6) r_zcl_1))
...
(assert (or (not r_p22) (not r_f6_p) r_f5_p))
...
;%~r_p21 | ~r_f5 | r_zcl_2
(assert (or (not r_p21) (not r_f5) r_zcl_2))
...
(assert (or (not r_p21) (not r_f5_p) r_f4_p))


;%~r_f10 | r_p19 | r_p16
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p19 r_p16))


;%~r_p19 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p19) r_f10_p))
...
(assert (or (not r_f9) r_p18 r_f10))


;%~r_p18 | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p18) r_f9_p))
...
(assert (or (not r_f8) r_p17 r_f9))


;%~r_p17 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p17) r_f8_p))
...
;%~r_p15 | ~r_p12 | r_zcl_3
(assert (or (not r_p15) (not r_p12) r_zcl_3))
...
(assert (or (not r_p15) (not r_p12) r_f14_p))
...
;%~r_p14 | ~r_f14 | r_zcl_4
(assert (or (not r_p14) (not r_f14) r_zcl_4))
...
;%~r_p13 | ~r_f13 | r_zcl_5
(assert (or (not r_p13) (not r_f13) r_zcl_5))
...
(assert (or (not r_f18) r_p11 r_p8))
...
;%~r_p7 | ~r_p4 | r_zcl_6
(assert (or (not r_p7) (not r_p4) r_zcl_6))


;%~r_f22 | r_zcl_6
(declare-fun r_f22 () Bool)
(assert (or (not r_f22) r_zcl_6))


;%~r_p7 | ~r_p4 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p7) (not r_p4) r_f22_p))
...
;%~r_zcl_7 | r_f22
(assert (or (not r_zcl_7) r_f22))


;%~r_p6 | ~r_f22 | r_zcl_7
(assert (or (not r_p6) (not r_f22) r_zcl_7))


;%~r_f21 | r_zcl_7
(declare-fun r_f21 () Bool)
(assert (or (not r_f21) r_zcl_7))
...
;%~r_zcl_8 | r_f21
(assert (or (not r_zcl_8) r_f21))


;%~r_p5 | ~r_f21 | r_zcl_8
(assert (or (not r_p5) (not r_f21) r_zcl_8))


;%~r_f20 | r_zcl_8
(declare-fun r_f20 () Bool)
(assert (or (not r_f20) r_zcl_8))
...
;%~r_p3 | ~r_p0 | r_zcl_9
(assert (or (not r_p3) (not r_p0) r_zcl_9))


;%~r_f25 | r_zcl_9
(declare-fun r_f25 () Bool)
(assert (or (not r_f25) r_zcl_9))


;%~r_p3 | ~r_p0 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p3) (not r_p0) r_f25_p))
...
;%~r_zcl_10 | r_f25
(assert (or (not r_zcl_10) r_f25))


;%~r_p2 | ~r_f25 | r_zcl_10
(assert (or (not r_p2) (not r_f25) r_zcl_10))


;%~r_f24 | r_zcl_10
(declare-fun r_f24 () Bool)
(assert (or (not r_f24) r_zcl_10))
...
;%~r_zcl_11 | r_f24
(assert (or (not r_zcl_11) r_f24))


;%~r_p1 | ~r_f24 | r_zcl_11
(assert (or (not r_p1) (not r_f24) r_zcl_11))


;%~r_f23 | r_zcl_11
(declare-fun r_f23 () Bool)
(assert (or (not r_f23) r_zcl_11))
...
(assert (or (not r_zcl_12) r_f16))


;%~r_zcl_12 | r_f19
(assert (or (not r_zcl_12) r_f19))


;%~r_f16 | ~r_f19 | r_zcl_12
(assert (or (not r_f16) (not r_f19) r_zcl_12))


;%~r_f15 | r_zcl_12
(declare-fun r_f15 () Bool)
(assert (or (not r_f15) r_zcl_12))
...
(assert (or (not r_zcl_13) r_f8))


;%~r_zcl_13 | r_f11
(assert (or (not r_zcl_13) r_f11))


;%~r_f8 | ~r_f11 | r_zcl_13
(assert (or (not r_f8) (not r_f11) r_zcl_13))


;%~r_f7 | r_zcl_13
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_zcl_13))
...
(assert (or (not r_zcl_14) r_f0))


;%~r_zcl_14 | r_f3
(assert (or (not r_zcl_14) r_f3))


;%~r_f0 | ~r_f3 | r_zcl_14
(assert (or (not r_f0) (not r_f3) r_zcl_14))


;%~r_Q | r_zcl_14
(declare-fun r_q () Bool)
(assert (or (not r_q) r_zcl_14))
