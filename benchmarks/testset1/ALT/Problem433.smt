...
;%~p4 | ~p10 | f4_p
(assert (or (not l_p4) (not l_p10) l_f4_p))
...
;%~p5 | ~f4 | zcl_1
(assert (or (not l_p5) (not l_f4) l_zcl_1))
...
;%~p5 | ~f4_p | f3_p
(assert (or (not l_p5) (not l_f4_p) l_f3_p))
...
;%~p5 | ~f1 | zcl_4
(assert (or (not l_p5) (not l_f1) l_zcl_4))
...
;%~p4 | ~p7 | zcl_5
(assert (or (not l_p4) (not l_p7) l_zcl_5))
...
;%~p4 | ~p7 | f16_p
(assert (or (not l_p4) (not l_p7) l_f16_p))
...
;%~p5 | ~f15 | zcl_7
(assert (or (not l_p5) (not l_f15) l_zcl_7))
...
;%~p5 | ~f15_p | f14_p
(assert (or (not l_p5) (not l_f15_p) l_f14_p))
...
;%~p2 | ~f14 | zcl_8
(assert (or (not l_p2) (not l_f14) l_zcl_8))
...
(assert (or (not r_p4) (not r_p10) r_f4_p))
...
;%~r_p5 | ~r_f4 | r_zcl_1
(assert (or (not r_p5) (not r_f4) r_zcl_1))
...
(assert (or (not r_p5) (not r_f4_p) r_f3_p))
...
;%~r_p5 | ~r_f1 | r_zcl_4
(assert (or (not r_p5) (not r_f1) r_zcl_4))
...
;%~r_p4 | ~r_p7 | r_zcl_5
(assert (or (not r_p4) (not r_p7) r_zcl_5))
...
(assert (or (not r_p4) (not r_p7) r_f16_p))
...
;%~r_p5 | ~r_f15 | r_zcl_7
(assert (or (not r_p5) (not r_f15) r_zcl_7))
...
;%~r_p5 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p5) (not r_f15_p) r_f14_p))
...
;%~r_p2 | ~r_f14 | r_zcl_8
(assert (or (not r_p2) (not r_f14) r_zcl_8))
