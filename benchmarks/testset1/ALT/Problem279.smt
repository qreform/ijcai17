...
;%~f3 | p19 | p17
(assert (or (not l_f3) l_p19 l_p17))
...
;%~f2 | p14 | f3
(assert (or (not l_f2) l_p14 l_f3))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
...
;%~f0 | p18 | f1
(assert (or (not l_f0) l_p18 l_f1))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p18 | f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f0_p () Bool)
;%~p18 | f0_p
(assert (or (not l_p18) l_f0_p))
...
;%~p0 | ~p15 | f8_p
(assert (or (not l_p0) (not l_p15) l_f8_p))
...
;%~p7 | ~f7 | zcl_2
(assert (or (not l_p7) (not l_f7) l_zcl_2))
...
;%~p16 | ~f6 | zcl_3
(assert (or (not l_p16) (not l_f6) l_zcl_3))
...
;%~p16 | ~f6_p | f5_p
(assert (or (not l_p16) (not l_f6_p) l_f5_p))
...
;%~f13 | p0 | p12
(assert (or (not l_f13) l_p0 l_p12))
...
;%~p11 | ~f17 | zcl_6
(assert (or (not l_p11) (not l_f17) l_zcl_6))
...
;%~p10 | ~f16 | zcl_7
(assert (or (not l_p10) (not l_f16) l_zcl_7))
...
(assert (or (not r_f3) r_p19 r_p17))
...
;%~r_p17 | r_f3_p
(assert (or (not r_p17) r_f3_p))


;%~r_f2 | r_p14 | r_f3
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p14 r_f3))
...
(assert (or (not r_f0) r_p18 r_f1))


;%~r_p18 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p18) r_f0_p))
...
(assert (or (not r_p0) (not r_p15) r_f8_p))
...
;%~r_p7 | ~r_f7 | r_zcl_2
(assert (or (not r_p7) (not r_f7) r_zcl_2))
...
;%~r_p16 | ~r_f6 | r_zcl_3
(assert (or (not r_p16) (not r_f6) r_zcl_3))
...
(assert (or (not r_p16) (not r_f6_p) r_f5_p))


;%~r_f13 | r_p0 | r_p12
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_p0 r_p12))
...
;%~r_p11 | ~r_f17 | r_zcl_6
(assert (or (not r_p11) (not r_f17) r_zcl_6))
...
;%~r_p10 | ~r_f16 | r_zcl_7
(assert (or (not r_p10) (not r_f16) r_zcl_7))
...
(assert (or (not r_f23) r_p8 r_p6))


;%~r_p8 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p8) r_f23_p))
