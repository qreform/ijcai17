...
;%~f4 | p23 | p18
(assert (or (not l_f4) l_p23 l_p18))
...
;%~p17 | ~p12 | zcl_0
(assert (or (not l_p17) (not l_p12) l_zcl_0))
...
;%~p17 | ~p12 | f10_p
(assert (or (not l_p17) (not l_p12) l_f10_p))
...
;%~p16 | ~f10 | zcl_1
(assert (or (not l_p16) (not l_f10) l_zcl_1))
...
;%~p16 | ~f10_p | f9_p
(assert (or (not l_p16) (not l_f10_p) l_f9_p))
...
;%~p15 | ~f9 | zcl_2
(assert (or (not l_p15) (not l_f9) l_zcl_2))
...
;%~p15 | ~f9_p | f8_p
(assert (or (not l_p15) (not l_f9_p) l_f8_p))
...
;%~p14 | ~f8 | zcl_3
(assert (or (not l_p14) (not l_f8) l_zcl_3))
...
;%~p13 | ~f7 | zcl_4
(assert (or (not l_p13) (not l_f7) l_zcl_4))
...
;%~f16 | p11 | p6
(assert (or (not l_f16) l_p11 l_p6))
...
(assert (or (not r_f4) r_p23 r_p18))


;%~r_p23 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p23) r_f4_p))
...
(assert (or (not r_f3) r_p22 r_f4))


;%~r_p22 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p22) r_f3_p))
...
(assert (or (not r_f2) r_p21 r_f3))


;%~r_p21 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p21) r_f2_p))
...
;%~r_p17 | ~r_p12 | r_zcl_0
(assert (or (not r_p17) (not r_p12) r_zcl_0))
...
(assert (or (not r_p17) (not r_p12) r_f10_p))
...
;%~r_p16 | ~r_f10 | r_zcl_1
(assert (or (not r_p16) (not r_f10) r_zcl_1))
...
;%~r_p16 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p16) (not r_f10_p) r_f9_p))
...
;%~r_p15 | ~r_f9 | r_zcl_2
(assert (or (not r_p15) (not r_f9) r_zcl_2))
...
(assert (or (not r_p15) (not r_f9_p) r_f8_p))
...
;%~r_p14 | ~r_f8 | r_zcl_3
(assert (or (not r_p14) (not r_f8) r_zcl_3))
...
;%~r_p13 | ~r_f7 | r_zcl_4
(assert (or (not r_p13) (not r_f7) r_zcl_4))
...
(assert (or (not r_f16) r_p11 r_p6))
