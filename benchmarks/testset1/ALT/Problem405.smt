...
;%~p14 | ~p12 | f1_p
(assert (or (not l_p14) (not l_p12) l_f1_p))
...
;%~p13 | ~f1 | zcl_1
(assert (or (not l_p13) (not l_f1) l_zcl_1))
...
(assert (or (not r_p14) (not r_p12) r_f1_p))
...
;%~r_p13 | ~r_f1 | r_zcl_1
(assert (or (not r_p13) (not r_f1) r_zcl_1))
