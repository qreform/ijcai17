...
;%~p4 | ~p7 | zcl_0
(assert (or (not l_p4) (not l_p7) l_zcl_0))
...
;%~p4 | ~p7 | f6_p
(assert (or (not l_p4) (not l_p7) l_f6_p))
...
;%~p4 | ~f6 | zcl_1
(assert (or (not l_p4) (not l_f6) l_zcl_1))
...
;%~p4 | ~f6_p | f5_p
(assert (or (not l_p4) (not l_f6_p) l_f5_p))
...
;%~p1 | ~f5 | zcl_2
(assert (or (not l_p1) (not l_f5) l_zcl_2))
...
;%~p1 | ~f5_p | f4_p
(assert (or (not l_p1) (not l_f5_p) l_f4_p))
...
;%~p4 | ~p5 | zcl_3
(assert (or (not l_p4) (not l_p5) l_zcl_3))
...
;%~p4 | ~p5 | f14_p
(assert (or (not l_p4) (not l_p5) l_f14_p))
...
;%~p1 | ~f14 | zcl_4
(assert (or (not l_p1) (not l_f14) l_zcl_4))
...
(assert (or (not r_f1) r_p9 r_f2))


;%~r_p9 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p9) r_f1_p))
...
(assert (or (not r_f0) r_p7 r_f1))


;%~r_p7 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p7) r_f0_p))
...
;%~r_p4 | ~r_p7 | r_zcl_0
(assert (or (not r_p4) (not r_p7) r_zcl_0))
...
(assert (or (not r_p4) (not r_p7) r_f6_p))
...
;%~r_p4 | ~r_f6 | r_zcl_1
(assert (or (not r_p4) (not r_f6) r_zcl_1))
...
(assert (or (not r_p4) (not r_f6_p) r_f5_p))
...
;%~r_p1 | ~r_f5 | r_zcl_2
(assert (or (not r_p1) (not r_f5) r_zcl_2))
...
(assert (or (not r_p1) (not r_f5_p) r_f4_p))


;%~r_f10 | r_p3 | r_p6
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p3 r_p6))
...
;%~r_p4 | ~r_p5 | r_zcl_3
(assert (or (not r_p4) (not r_p5) r_zcl_3))
...
(assert (or (not r_p4) (not r_p5) r_f14_p))
...
;%~r_p1 | ~r_f14 | r_zcl_4
(assert (or (not r_p1) (not r_f14) r_zcl_4))
