...
;%~p14 | ~p11 | zcl_0
(assert (or (not l_p14) (not l_p11) l_zcl_0))
...
;%Non-clausified dependency
;%(forall[]((p14 & p11) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p14 | ~p11 | f10_p
(assert (or (not l_p14) (not l_p11) l_f10_p))
...
;%~p6 | ~f8 | zcl_3
(assert (or (not l_p6) (not l_f8) l_zcl_3))
...
;%~p6 | ~f8_p | f7_p
(assert (or (not l_p6) (not l_f8_p) l_f7_p))
...
;%~p12 | ~f7 | zcl_4
(assert (or (not l_p12) (not l_f7) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p12 & f7_p) --> f6_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f6_p () Bool)
;%~p12 | ~f7_p | f6_p
(assert (or (not l_p12) (not l_f7_p) l_f6_p))
...
;%~p8 | ~p6 | f22_p
(assert (or (not l_p8) (not l_p6) l_f22_p))
...
;%~r_p14 | ~r_p11 | r_zcl_0
(assert (or (not r_p14) (not r_p11) r_zcl_0))
...
(assert (or (not r_p14) (not r_p11) r_f10_p))
...
;%~r_p6 | ~r_f8 | r_zcl_3
(assert (or (not r_p6) (not r_f8) r_zcl_3))
...
(assert (or (not r_p6) (not r_f8_p) r_f7_p))
...
;%~r_p12 | ~r_f7 | r_zcl_4
(assert (or (not r_p12) (not r_f7) r_zcl_4))
...
(assert (or (not r_p12) (not r_f7_p) r_f6_p))


;%~r_f16 | r_p6 | r_p9
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_p6 r_p9))
...
(assert (or (not r_p8) (not r_p6) r_f22_p))
