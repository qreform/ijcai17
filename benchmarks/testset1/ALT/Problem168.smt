...
;%~f0 | p14 | f1
(assert (or (not l_f0) l_p14 l_f1))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p14 | f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f0_p () Bool)
;%~p14 | f0_p
(assert (or (not l_p14) l_f0_p))
...
;%~p8 | ~p11 | zcl_0
(assert (or (not l_p8) (not l_p11) l_zcl_0))
...
;%~p8 | ~p11 | f10_p
(assert (or (not l_p8) (not l_p11) l_f10_p))
...
;%~zcl_1 | p12
(assert (or (not l_zcl_1) l_p12))

;%~zcl_1 | f10
(assert (or (not l_zcl_1) l_f10))

;%~p12 | ~f10 | zcl_1
(assert (or (not l_p12) (not l_f10) l_zcl_1))
...
;%~p12 | ~f10_p | f9_p
(assert (or (not l_p12) (not l_f10_p) l_f9_p))
...
;%~f12 | p9 | f13
(assert (or (not l_f12) l_p9 l_f13))
...
;%~p7 | ~p6 | zcl_5
(assert (or (not l_p7) (not l_p6) l_zcl_5))
...
;%~p7 | ~p6 | f22_p
(assert (or (not l_p7) (not l_p6) l_f22_p))
...
(assert (or (not r_f0) r_p14 r_f1))


;%~r_p14 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p14) r_f0_p))
...
;%~r_p8 | ~r_p11 | r_zcl_0
(assert (or (not r_p8) (not r_p11) r_zcl_0))
...
(assert (or (not r_p8) (not r_p11) r_f10_p))


;%~r_zcl_1 | r_p12
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p12))
...
;%~r_p12 | ~r_f10 | r_zcl_1
(assert (or (not r_p12) (not r_f10) r_zcl_1))
...
;%~r_p12 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p12) (not r_f10_p) r_f9_p))
...
(assert (or (not r_f12) r_p9 r_f13))


;%~r_p9 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p9) r_f12_p))
...
;%~r_p7 | ~r_p6 | r_zcl_5
(assert (or (not r_p7) (not r_p6) r_zcl_5))
...
(assert (or (not r_p7) (not r_p6) r_f22_p))
