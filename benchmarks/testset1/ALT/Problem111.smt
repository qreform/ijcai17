...
;%~zcl_1 | p17
(assert (or (not l_zcl_1) l_p17))

;%~zcl_1 | f5
(assert (or (not l_zcl_1) l_f5))

;%~p17 | ~f5 | zcl_1
(assert (or (not l_p17) (not l_f5) l_zcl_1))
...
;%~p11 | ~f4 | zcl_2
(assert (or (not l_p11) (not l_f4) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p11 & f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p11 | ~f4_p | f3_p
(assert (or (not l_p11) (not l_f4_p) l_f3_p))
...
;%~p16 | ~f3 | zcl_3
(assert (or (not l_p16) (not l_f3) l_zcl_3))
...
;%~p16 | ~f3_p | f2_p
(assert (or (not l_p16) (not l_f3_p) l_f2_p))
...
;%~f12 | p14 | p11
(assert (or (not l_f12) l_p14 l_p11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | p11) --> f12_p))
;%------------------------Clausification start------------------------%
...
;%~f10 | p7 | f11
(assert (or (not l_f10) l_p7 l_f11))
...
;%~f8 | p12 | f9
(assert (or (not l_f8) l_p12 l_f9))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p12 | f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
...
;%~p0 | ~p7 | f19_p
(assert (or (not l_p0) (not l_p7) l_f19_p))
...
;%~p10 | ~f19 | zcl_7
(assert (or (not l_p10) (not l_f19) l_zcl_7))
...
;%~p9 | ~f18 | zcl_8
(assert (or (not l_p9) (not l_f18) l_zcl_8))
...
;%~p8 | ~f16 | zcl_10
(assert (or (not l_p8) (not l_f16) l_zcl_10))
...
;%~r_p17 | ~r_f5 | r_zcl_1
(assert (or (not r_p17) (not r_f5) r_zcl_1))
...
;%~r_p11 | ~r_f4 | r_zcl_2
(assert (or (not r_p11) (not r_f4) r_zcl_2))
...
(assert (or (not r_p11) (not r_f4_p) r_f3_p))
...
;%~r_p16 | ~r_f3 | r_zcl_3
(assert (or (not r_p16) (not r_f3) r_zcl_3))
...
(assert (or (not r_p16) (not r_f3_p) r_f2_p))
...
(assert (or (not r_f12) r_p14 r_p11))
...
(assert (or (not r_f10) r_p7 r_f11))
...
(assert (or (not r_p0) (not r_p7) r_f19_p))
...
;%~r_p10 | ~r_f19 | r_zcl_7
(assert (or (not r_p10) (not r_f19) r_zcl_7))
...
;%~r_p9 | ~r_f18 | r_zcl_8
(assert (or (not r_p9) (not r_f18) r_zcl_8))
...
;%~r_p8 | ~r_f16 | r_zcl_10
(assert (or (not r_p8) (not r_f16) r_zcl_10))
