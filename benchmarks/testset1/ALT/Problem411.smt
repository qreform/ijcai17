...
;%~p11 | ~f1 | zcl_2
(assert (or (not l_p11) (not l_f1) l_zcl_2))
...
;%~p5 | ~p7 | zcl_3
(assert (or (not l_p5) (not l_p7) l_zcl_3))
...
;%~p5 | ~p7 | f10_p
(assert (or (not l_p5) (not l_p7) l_f10_p))
...
;%~r_p11 | ~r_f1 | r_zcl_2
(assert (or (not r_p11) (not r_f1) r_zcl_2))
...
(assert (or (not r_f5) r_p5 r_f6))


;%~r_p5 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p5) r_f5_p))
...
;%~r_p5 | ~r_p7 | r_zcl_3
(assert (or (not r_p5) (not r_p7) r_zcl_3))
...
(assert (or (not r_p5) (not r_p7) r_f10_p))
