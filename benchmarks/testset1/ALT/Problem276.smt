...
;%~f3 | p34 | p30
(assert (or (not l_f3) l_p34 l_p30))
...
;%~p34 | f3_p
(assert (or (not l_p34) l_f3_p))

;%~p30 | f3_p
(assert (or (not l_p30) l_f3_p))
...
;%~p29 | ~p25 | f8_p
(assert (or (not l_p29) (not l_p25) l_f8_p))
...
;%~p28 | ~f8 | zcl_1
(assert (or (not l_p28) (not l_f8) l_zcl_1))
...
;%~p28 | ~f8_p | f7_p
(assert (or (not l_p28) (not l_f8_p) l_f7_p))
...
;%~p27 | ~f7 | zcl_2
(assert (or (not l_p27) (not l_f7) l_zcl_2))
...
;%~p27 | ~f7_p | f6_p
(assert (or (not l_p27) (not l_f7_p) l_f6_p))
...
;%~p26 | ~f6 | zcl_3
(assert (or (not l_p26) (not l_f6) l_zcl_3))
...
;%~p26 | ~f6_p | f5_p
(assert (or (not l_p26) (not l_f6_p) l_f5_p))
...
;%~f13 | p24 | p20
(assert (or (not l_f13) l_p24 l_p20))
...
;%~p24 | f13_p
(assert (or (not l_p24) l_f13_p))

;%~p20 | f13_p
(assert (or (not l_p20) l_f13_p))
...
;%~f12 | p23 | f13
(assert (or (not l_f12) l_p23 l_f13))
...
;%~f11 | p22 | f12
(assert (or (not l_f11) l_p22 l_f12))
...
;%~f10 | p21 | f11
(assert (or (not l_f10) l_p21 l_f11))
...
;%~p18 | ~f18 | zcl_5
(assert (or (not l_p18) (not l_f18) l_zcl_5))
...
;%~p17 | ~f17 | zcl_6
(assert (or (not l_p17) (not l_f17) l_zcl_6))
...
;%~p16 | ~f16 | zcl_7
(assert (or (not l_p16) (not l_f16) l_zcl_7))
...
;%~f23 | p14 | p10
(assert (or (not l_f23) l_p14 l_p10))
...
;%~p14 | f23_p
(assert (or (not l_p14) l_f23_p))

;%~p10 | f23_p
(assert (or (not l_p10) l_f23_p))
...
;%~f21 | p12 | f22
(assert (or (not l_f21) l_p12 l_f22))
...
;%~f20 | p11 | f21
(assert (or (not l_f20) l_p11 l_f21))
...
;%~p9 | ~p5 | f28_p
(assert (or (not l_p9) (not l_p5) l_f28_p))
...
;%~p8 | ~f28 | zcl_9
(assert (or (not l_p8) (not l_f28) l_zcl_9))
...
;%~p7 | ~f27 | zcl_10
(assert (or (not l_p7) (not l_f27) l_zcl_10))
...
;%~p7 | ~f27_p | f26_p
(assert (or (not l_p7) (not l_f27_p) l_f26_p))
...
;%~p6 | ~f26 | zcl_11
(assert (or (not l_p6) (not l_f26) l_zcl_11))
...
(assert (or (not r_f3) r_p34 r_p30))


;%~r_p34 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p34) r_f3_p))


;%~r_p30 | r_f3_p
(assert (or (not r_p30) r_f3_p))


;%~r_f2 | r_p33 | r_f3
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p33 r_f3))


;%~r_p33 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p33) r_f2_p))
...
(assert (or (not r_f1) r_p32 r_f2))


;%~r_p32 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p32) r_f1_p))
...
(assert (or (not r_f0) r_p31 r_f1))


;%~r_p31 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p31) r_f0_p))
...
(assert (or (not r_p29) (not r_p25) r_f8_p))
...
;%~r_p28 | ~r_f8 | r_zcl_1
(assert (or (not r_p28) (not r_f8) r_zcl_1))
...
(assert (or (not r_p28) (not r_f8_p) r_f7_p))
...
;%~r_p27 | ~r_f7 | r_zcl_2
(assert (or (not r_p27) (not r_f7) r_zcl_2))
...
(assert (or (not r_p27) (not r_f7_p) r_f6_p))
...
;%~r_p26 | ~r_f6 | r_zcl_3
(assert (or (not r_p26) (not r_f6) r_zcl_3))
...
(assert (or (not r_p26) (not r_f6_p) r_f5_p))


;%~r_f13 | r_p24 | r_p20
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_p24 r_p20))


;%~r_p24 | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p24) r_f13_p))


;%~r_p20 | r_f13_p
(assert (or (not r_p20) r_f13_p))


;%~r_f12 | r_p23 | r_f13
(declare-fun r_f12 () Bool)
(assert (or (not r_f12) r_p23 r_f13))


;%~r_p23 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p23) r_f12_p))
...
(assert (or (not r_f11) r_p22 r_f12))


;%~r_p22 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p22) r_f11_p))
...
(assert (or (not r_f10) r_p21 r_f11))


;%~r_p21 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p21) r_f10_p))
...
;%~r_p18 | ~r_f18 | r_zcl_5
(assert (or (not r_p18) (not r_f18) r_zcl_5))
...
;%~r_p17 | ~r_f17 | r_zcl_6
(assert (or (not r_p17) (not r_f17) r_zcl_6))
...
;%~r_p16 | ~r_f16 | r_zcl_7
(assert (or (not r_p16) (not r_f16) r_zcl_7))
...
(assert (or (not r_f23) r_p14 r_p10))


;%~r_p14 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p14) r_f23_p))


;%~r_p10 | r_f23_p
(assert (or (not r_p10) r_f23_p))
...
(assert (or (not r_f21) r_p12 r_f22))


;%~r_p12 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p12) r_f21_p))
...
(assert (or (not r_f20) r_p11 r_f21))


;%~r_p11 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p11) r_f20_p))
...
(assert (or (not r_p9) (not r_p5) r_f28_p))
...
;%~r_p8 | ~r_f28 | r_zcl_9
(assert (or (not r_p8) (not r_f28) r_zcl_9))
...
;%~r_p7 | ~r_f27 | r_zcl_10
(assert (or (not r_p7) (not r_f27) r_zcl_10))
...
;%~r_p7 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p7) (not r_f27_p) r_f26_p))
...
;%~r_p6 | ~r_f26 | r_zcl_11
(assert (or (not r_p6) (not r_f26) r_zcl_11))
