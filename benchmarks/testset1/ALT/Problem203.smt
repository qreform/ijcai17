...
;%~p10 | ~p13 | f2_p
(assert (or (not l_p10) (not l_p13) l_f2_p))
...
;%~p4 | ~f1 | zcl_2
(assert (or (not l_p4) (not l_f1) l_zcl_2))
...
;%~p0 | ~p10 | zcl_3
(assert (or (not l_p0) (not l_p10) l_zcl_3))
...
;%~p8 | ~f10 | zcl_4
(assert (or (not l_p8) (not l_f10) l_zcl_4))
...
;%~p11 | ~f9 | zcl_5
(assert (or (not l_p11) (not l_f9) l_zcl_5))
...
;%~p6 | ~p4 | zcl_6
(assert (or (not l_p6) (not l_p4) l_zcl_6))
...
;%~p6 | ~p4 | f18_p
(assert (or (not l_p6) (not l_p4) l_f18_p))
...
(assert (or (not r_p10) (not r_p13) r_f2_p))
...
;%~r_p4 | ~r_f1 | r_zcl_2
(assert (or (not r_p4) (not r_f1) r_zcl_2))
...
;%~r_p0 | ~r_p10 | r_zcl_3
(assert (or (not r_p0) (not r_p10) r_zcl_3))
...
;%~r_p8 | ~r_f10 | r_zcl_4
(assert (or (not r_p8) (not r_f10) r_zcl_4))
...
;%~r_p11 | ~r_f9 | r_zcl_5
(assert (or (not r_p11) (not r_f9) r_zcl_5))
...
;%~r_p6 | ~r_p4 | r_zcl_6
(assert (or (not r_p6) (not r_p4) r_zcl_6))
...
(assert (or (not r_p6) (not r_p4) r_f18_p))
