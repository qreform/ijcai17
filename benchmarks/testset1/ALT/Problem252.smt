...
;%~p0 | ~p8 | f4_p
(assert (or (not l_p0) (not l_p8) l_f4_p))
...
;%~p0 | ~p6 | zcl_2
(assert (or (not l_p0) (not l_p6) l_zcl_2))
...
;%~p4 | ~f10 | zcl_3
(assert (or (not l_p4) (not l_f10) l_zcl_3))
...
;%~p0 | ~p3 | zcl_4
(assert (or (not l_p0) (not l_p3) l_zcl_4))
...
;%~p0 | ~p3 | f16_p
(assert (or (not l_p0) (not l_p3) l_f16_p))
...
;%~p0 | ~f16 | zcl_5
(assert (or (not l_p0) (not l_f16) l_zcl_5))
...
(assert (or (not r_p0) (not r_p8) r_f4_p))
...
;%~r_p0 | ~r_p6 | r_zcl_2
(assert (or (not r_p0) (not r_p6) r_zcl_2))
...
;%~r_p4 | ~r_f10 | r_zcl_3
(assert (or (not r_p4) (not r_f10) r_zcl_3))
...
;%~r_p0 | ~r_p3 | r_zcl_4
(assert (or (not r_p0) (not r_p3) r_zcl_4))
...
(assert (or (not r_p0) (not r_p3) r_f16_p))
...
;%~r_p0 | ~r_f16 | r_zcl_5
(assert (or (not r_p0) (not r_f16) r_zcl_5))
