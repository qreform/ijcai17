...
;%~p6 | ~p5 | f2_p
(assert (or (not l_p6) (not l_p5) l_f2_p))
...
;%~p0 | ~p2 | f6_p
(assert (or (not l_p0) (not l_p2) l_f6_p))
...
;%~p1 | ~p0 | zcl_2
(assert (or (not l_p1) (not l_p0) l_zcl_2))
...
;%~p1 | ~p0 | f7_p
(assert (or (not l_p1) (not l_p0) l_f7_p))
...
(assert (or (not r_p6) (not r_p5) r_f2_p))
...
(assert (or (not r_p0) (not r_p2) r_f6_p))
...
;%~r_p1 | ~r_p0 | r_zcl_2
(assert (or (not r_p1) (not r_p0) r_zcl_2))
...
(assert (or (not r_p1) (not r_p0) r_f7_p))
