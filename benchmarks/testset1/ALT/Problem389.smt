...
;%~f4 | p11 | p10
(assert (or (not l_f4) l_p11 l_p10))
...
;%~p3 | ~f9 | zcl_2
(assert (or (not l_p3) (not l_f9) l_zcl_2))
...
;%~p8 | ~f7 | zcl_4
(assert (or (not l_p8) (not l_f7) l_zcl_4))
...
(assert (or (not r_f4) r_p11 r_p10))
...
;%~r_p3 | ~r_f9 | r_zcl_2
(assert (or (not r_p3) (not r_f9) r_zcl_2))
...
;%~r_p8 | ~r_f7 | r_zcl_4
(assert (or (not r_p8) (not r_f7) r_zcl_4))
