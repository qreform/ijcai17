%%%%%%%%%%%%%%%% Target reformulation: ((p10 | (p4 | (p7 | p9))) & ((p8 & (p4 & (p0 & p7))) | ((p0 | (p6 | (p0 | p5))) & ((p0 & (p0 & (p0 & p4))) | (p1 & (p2 & (p3 & p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~f2 | p7 | p9)) .
cnf(l_axiom2,axiom,(~p7 | f2_p)) .
cnf(l_axiom3,axiom,(~p9 | f2_p)) .
cnf(l_axiom4,axiom,(~f1 | p4 | f2)) .
cnf(l_axiom5,axiom,(~p4 | f1_p)) .
...
cnf(l_axiom12,axiom,(~p0 | ~p7 | zcl_22)) .
cnf(l_axiom13,axiom,(~f6 | zcl_22)) .
cnf(l_axiom14,axiom,(~p0 | ~p7 | f6_p)) .
cnf(l_axiom15,axiom,(~zcl_23 | p4)) .
cnf(l_axiom16,axiom,(~zcl_23 | f6)) .
cnf(l_axiom17,axiom,(~p4 | ~f6 | zcl_23)) .
cnf(l_axiom18,axiom,(~f5 | zcl_23)) .
cnf(l_axiom19,axiom,(~p4 | ~f6_p | f5_p)) .
cnf(l_axiom20,axiom,(~zcl_24 | p8)) .
cnf(l_axiom21,axiom,(~zcl_24 | f5)) .
cnf(l_axiom22,axiom,(~p8 | ~f5 | zcl_24)) .
...
cnf(r_axiom11,axiom,(~acc_f2 | acc_p7 | acc_p9)) .
cnf(r_axiom12,axiom,(~acc_p7 | acc_f2_p)) .
cnf(r_axiom13,axiom,(~acc_p9 | acc_f2_p)) .
cnf(r_axiom14,axiom,(~acc_f1 | acc_p4 | acc_f2)) .
cnf(r_axiom15,axiom,(~acc_p4 | acc_f1_p)) .
cnf(r_axiom16,axiom,(~acc_f2_p | acc_f1_p)) .
cnf(r_axiom17,axiom,(~acc_f0 | acc_p10 | acc_f1)) .
cnf(r_axiom18,axiom,(~acc_p10 | acc_f0_p)) .
cnf(r_axiom19,axiom,(~acc_f1_p | acc_f0_p)) .
cnf(r_axiom20,axiom,(~acc_zcl_22 | acc_p0)) .
cnf(r_axiom21,axiom,(~acc_zcl_22 | acc_p7)) .
cnf(r_axiom22,axiom,(~acc_p0 | ~acc_p7 | acc_zcl_22)) .
cnf(r_axiom23,axiom,(~acc_f6 | acc_zcl_22)) .
cnf(r_axiom24,axiom,(~acc_p0 | ~acc_p7 | acc_f6_p)) .
cnf(r_axiom25,axiom,(~acc_zcl_23 | acc_p4)) .
cnf(r_axiom26,axiom,(~acc_zcl_23 | acc_f6)) .
cnf(r_axiom27,axiom,(~acc_p4 | ~acc_f6 | acc_zcl_23)) .
cnf(r_axiom28,axiom,(~acc_f5 | acc_zcl_23)) .
cnf(r_axiom29,axiom,(~acc_p4 | ~acc_f6_p | acc_f5_p)) .
cnf(r_axiom30,axiom,(~acc_zcl_24 | acc_p8)) .
cnf(r_axiom31,axiom,(~acc_zcl_24 | acc_f5)) .
cnf(r_axiom32,axiom,(~acc_p8 | ~acc_f5 | acc_zcl_24)) .
cnf(r_axiom33,axiom,(~acc_f4 | acc_zcl_24)) .
cnf(r_axiom34,axiom,(~acc_p8 | ~acc_f5_p | acc_f4_p)) .
cnf(r_axiom35,axiom,(~acc_f10 | acc_p0 | acc_p5)) .
cnf(r_axiom36,axiom,(~acc_p0 | acc_f10_p)) .
cnf(r_axiom37,axiom,(~acc_p5 | acc_f10_p)) .
cnf(r_axiom38,axiom,(~acc_f9 | acc_p6 | acc_f10)) .
cnf(r_axiom39,axiom,(~acc_p6 | acc_f9_p)) .
