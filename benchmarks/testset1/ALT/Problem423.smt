...
;%~p0 | ~p11 | zcl_0
(assert (or (not l_p0) (not l_p11) l_zcl_0))
...
;%~p0 | ~p11 | f3_p
(assert (or (not l_p0) (not l_p11) l_f3_p))
...
;%~p1 | ~f13 | zcl_5
(assert (or (not l_p1) (not l_f13) l_zcl_5))
...
;%Non-clausified dependency
;%(forall[]((p1 & f13_p) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p1 | ~f13_p | f12_p
(assert (or (not l_p1) (not l_f13_p) l_f12_p))
...
;%~r_p0 | ~r_p11 | r_zcl_0
(assert (or (not r_p0) (not r_p11) r_zcl_0))
...
(assert (or (not r_p0) (not r_p11) r_f3_p))
...
;%~r_p1 | ~r_f13 | r_zcl_5
(assert (or (not r_p1) (not r_f13) r_zcl_5))
...
;%~r_p1 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p1) (not r_f13_p) r_f12_p))
