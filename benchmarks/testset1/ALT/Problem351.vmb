%%%%%%%%%%%%%%%% Target reformulation: ((p3 | (p0 | p6)) & ((p3 & (p5 & p4)) | ((p2 | (p0 | p3)) & (p1 | (p2 | p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom7,axiom,(~zcl_8 | p5)) .
cnf(l_axiom8,axiom,(~zcl_8 | p4)) .
cnf(l_axiom9,axiom,(~p5 | ~p4 | zcl_8)) .
cnf(l_axiom10,axiom,(~f4 | zcl_8)) .
cnf(l_axiom11,axiom,(~p5 | ~p4 | f4_p)) .
...
cnf(r_axiom13,axiom,(~acc_zcl_8 | acc_p5)) .
cnf(r_axiom14,axiom,(~acc_zcl_8 | acc_p4)) .
cnf(r_axiom15,axiom,(~acc_p5 | ~acc_p4 | acc_zcl_8)) .
cnf(r_axiom16,axiom,(~acc_f4 | acc_zcl_8)) .
cnf(r_axiom17,axiom,(~acc_p5 | ~acc_p4 | acc_f4_p)) .
cnf(r_axiom18,axiom,(~acc_zcl_9 | acc_p3)) .
cnf(r_axiom19,axiom,(~acc_zcl_9 | acc_f4)) .
cnf(r_axiom20,axiom,(~acc_p3 | ~acc_f4 | acc_zcl_9)) .
cnf(r_axiom21,axiom,(~acc_f3 | acc_zcl_9)) .
cnf(r_axiom22,axiom,(~acc_p3 | ~acc_f4_p | acc_f3_p)) .
cnf(r_axiom23,axiom,(~acc_f7 | acc_p0 | acc_p3)) .
