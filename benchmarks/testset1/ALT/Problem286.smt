...
;%~f4 | p41 | p36
(assert (or (not l_f4) l_p41 l_p36))
...
;%~p41 | f4_p
(assert (or (not l_p41) l_f4_p))

;%~p36 | f4_p
(assert (or (not l_p36) l_f4_p))
...
;%~f3 | p40 | f4
(assert (or (not l_f3) l_p40 l_f4))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p40 | f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p40 | f3_p
(assert (or (not l_p40) l_f3_p))
...
;%~f2 | p39 | f3
(assert (or (not l_f2) l_p39 l_f3))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p39 | f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p39 | f2_p
(assert (or (not l_p39) l_f2_p))
...
;%~f1 | p38 | f2
(assert (or (not l_f1) l_p38 l_f2))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p38 | f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p38 | f1_p
(assert (or (not l_p38) l_f1_p))
...
;%~f0 | p37 | f1
(assert (or (not l_f0) l_p37 l_f1))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p37 | f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f0_p () Bool)
;%~p37 | f0_p
(assert (or (not l_p37) l_f0_p))
...
;%~zcl_0 | p35
(assert (or (not l_zcl_0) l_p35))

(declare-fun l_p30 () Bool)
;%~zcl_0 | p30
(assert (or (not l_zcl_0) l_p30))

;%~p35 | ~p30 | zcl_0
(assert (or (not l_p35) (not l_p30) l_zcl_0))
...
;%Non-clausified dependency
;%(forall[]((~p35 & p30) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p35 | ~p30 | f10_p
(assert (or (not l_p35) (not l_p30) l_f10_p))
...
;%~zcl_1 | p34
(assert (or (not l_zcl_1) l_p34))

;%~zcl_1 | f10
(assert (or (not l_zcl_1) l_f10))

;%~p34 | ~f10 | zcl_1
(assert (or (not l_p34) (not l_f10) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((~p34 & f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p34 | ~f10_p | f9_p
(assert (or (not l_p34) (not l_f10_p) l_f9_p))
...
;%~zcl_2 | p33
(assert (or (not l_zcl_2) l_p33))

;%~zcl_2 | f9
(assert (or (not l_zcl_2) l_f9))

;%~p33 | ~f9 | zcl_2
(assert (or (not l_p33) (not l_f9) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((~p33 & f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p33 | ~f9_p | f8_p
(assert (or (not l_p33) (not l_f9_p) l_f8_p))
...
;%~zcl_3 | p32
(assert (or (not l_zcl_3) l_p32))

;%~zcl_3 | f8
(assert (or (not l_zcl_3) l_f8))

;%~p32 | ~f8 | zcl_3
(assert (or (not l_p32) (not l_f8) l_zcl_3))
...
;%Non-clausified dependency
;%(forall[]((~p32 & f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p32 | ~f8_p | f7_p
(assert (or (not l_p32) (not l_f8_p) l_f7_p))
...
;%~zcl_4 | p31
(assert (or (not l_zcl_4) l_p31))

;%~zcl_4 | f7
(assert (or (not l_zcl_4) l_f7))

;%~p31 | ~f7 | zcl_4
(assert (or (not l_p31) (not l_f7) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((~p31 & f7_p) --> f6_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f6_p () Bool)
;%~p31 | ~f7_p | f6_p
(assert (or (not l_p31) (not l_f7_p) l_f6_p))
...
;%~f16 | p29 | p24
(assert (or (not l_f16) l_p29 l_p24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p29 | ~p24) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p29 | f16_p
(assert (or (not l_p29) l_f16_p))

;%~p24 | f16_p
(assert (or (not l_p24) l_f16_p))
...
;%~f15 | p28 | f16
(assert (or (not l_f15) l_p28 l_f16))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p28 | f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p28 | f15_p
(assert (or (not l_p28) l_f15_p))
...
;%~f14 | p27 | f15
(assert (or (not l_f14) l_p27 l_f15))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p27 | f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p27 | f14_p
(assert (or (not l_p27) l_f14_p))
...
;%~f13 | p26 | f14
(assert (or (not l_f13) l_p26 l_f14))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p26 | f14_p) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p26 | f13_p
(assert (or (not l_p26) l_f13_p))
...
;%~f12 | p25 | f13
(assert (or (not l_f12) l_p25 l_f13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p25 | f13_p) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p25 | f12_p
(assert (or (not l_p25) l_f12_p))
...
;%~zcl_5 | p23
(assert (or (not l_zcl_5) l_p23))

(declare-fun l_p18 () Bool)
;%~zcl_5 | p18
(assert (or (not l_zcl_5) l_p18))

;%~p23 | ~p18 | zcl_5
(assert (or (not l_p23) (not l_p18) l_zcl_5))

(declare-fun l_f22 () Bool)
;%~f22 | zcl_5
(assert (or (not l_f22) l_zcl_5))
...
;%~zcl_6 | p22
(assert (or (not l_zcl_6) l_p22))

;%~zcl_6 | f22
(assert (or (not l_zcl_6) l_f22))

;%~p22 | ~f22 | zcl_6
(assert (or (not l_p22) (not l_f22) l_zcl_6))

(declare-fun l_f21 () Bool)
;%~f21 | zcl_6
(assert (or (not l_f21) l_zcl_6))
...
;%~zcl_7 | p21
(assert (or (not l_zcl_7) l_p21))

;%~zcl_7 | f21
(assert (or (not l_zcl_7) l_f21))

;%~p21 | ~f21 | zcl_7
(assert (or (not l_p21) (not l_f21) l_zcl_7))

(declare-fun l_f20 () Bool)
;%~f20 | zcl_7
(assert (or (not l_f20) l_zcl_7))
...
;%~zcl_8 | p20
(assert (or (not l_zcl_8) l_p20))

;%~zcl_8 | f20
(assert (or (not l_zcl_8) l_f20))

;%~p20 | ~f20 | zcl_8
(assert (or (not l_p20) (not l_f20) l_zcl_8))
...
;%~zcl_9 | p19
(assert (or (not l_zcl_9) l_p19))

;%~zcl_9 | f19
(assert (or (not l_zcl_9) l_f19))

;%~p19 | ~f19 | zcl_9
(assert (or (not l_p19) (not l_f19) l_zcl_9))

(declare-fun l_f18 () Bool)
;%~f18 | zcl_9
(assert (or (not l_f18) l_zcl_9))
...
;%~f28 | p17 | p12
(assert (or (not l_f28) l_p17 l_p12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p17 | ~p12) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p17 | f28_p
(assert (or (not l_p17) l_f28_p))

;%~p12 | f28_p
(assert (or (not l_p12) l_f28_p))
...
;%~f27 | p16 | f28
(assert (or (not l_f27) l_p16 l_f28))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p16 | f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p16 | f27_p
(assert (or (not l_p16) l_f27_p))
...
;%~f25 | p14 | f26
(assert (or (not l_f25) l_p14 l_f26))
...
;%~p11 | ~p6 | zcl_10
(assert (or (not l_p11) (not l_p6) l_zcl_10))

(declare-fun l_f34 () Bool)
;%~f34 | zcl_10
(assert (or (not l_f34) l_zcl_10))
...
;%~p11 | ~p6 | f34_p
(assert (or (not l_p11) (not l_p6) l_f34_p))
...
;%~zcl_11 | f34
(assert (or (not l_zcl_11) l_f34))

;%~p10 | ~f34 | zcl_11
(assert (or (not l_p10) (not l_f34) l_zcl_11))

(declare-fun l_f33 () Bool)
;%~f33 | zcl_11
(assert (or (not l_f33) l_zcl_11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p10 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p10 | ~f34_p | f33_p
(assert (or (not l_p10) (not l_f34_p) l_f33_p))
...
;%~zcl_12 | f33
(assert (or (not l_zcl_12) l_f33))

;%~p9 | ~f33 | zcl_12
(assert (or (not l_p9) (not l_f33) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((~p9 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p9 | ~f33_p | f32_p
(assert (or (not l_p9) (not l_f33_p) l_f32_p))
...
;%~zcl_13 | p8
(assert (or (not l_zcl_13) l_p8))

;%~zcl_13 | f32
(assert (or (not l_zcl_13) l_f32))

;%~p8 | ~f32 | zcl_13
(assert (or (not l_p8) (not l_f32) l_zcl_13))
...
;%~zcl_14 | p7
(assert (or (not l_zcl_14) l_p7))

;%~zcl_14 | f31
(assert (or (not l_zcl_14) l_f31))

;%~p7 | ~f31 | zcl_14
(assert (or (not l_p7) (not l_f31) l_zcl_14))
...
;%Non-clausified dependency
;%(forall[]((p7 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p7 | ~f31_p | f30_p
(assert (or (not l_p7) (not l_f31_p) l_f30_p))
...
;%~p5 | ~p0 | f39_p
(assert (or (not l_p5) (not l_p0) l_f39_p))
...
;%~zcl_16 | f39
(assert (or (not l_zcl_16) l_f39))

;%~p4 | ~f39 | zcl_16
(assert (or (not l_p4) (not l_f39) l_zcl_16))

(declare-fun l_f38 () Bool)
;%~f38 | zcl_16
(assert (or (not l_f38) l_zcl_16))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p4 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p4 | ~f39_p | f38_p
(assert (or (not l_p4) (not l_f39_p) l_f38_p))
...
;%~zcl_17 | f38
(assert (or (not l_zcl_17) l_f38))

;%~p3 | ~f38 | zcl_17
(assert (or (not l_p3) (not l_f38) l_zcl_17))

(declare-fun l_f37 () Bool)
;%~f37 | zcl_17
(assert (or (not l_f37) l_zcl_17))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p3 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p3 | ~f38_p | f37_p
(assert (or (not l_p3) (not l_f38_p) l_f37_p))
...
;%~zcl_18 | f37
(assert (or (not l_zcl_18) l_f37))

;%~p2 | ~f37 | zcl_18
(assert (or (not l_p2) (not l_f37) l_zcl_18))

(declare-fun l_f36 () Bool)
;%~f36 | zcl_18
(assert (or (not l_f36) l_zcl_18))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p2 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p2 | ~f37_p | f36_p
(assert (or (not l_p2) (not l_f37_p) l_f36_p))
...
;%~zcl_19 | f36
(assert (or (not l_zcl_19) l_f36))

;%~p1 | ~f36 | zcl_19
(assert (or (not l_p1) (not l_f36) l_zcl_19))

(declare-fun l_f35 () Bool)
;%~f35 | zcl_19
(assert (or (not l_f35) l_zcl_19))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p1 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p1 | ~f36_p | f35_p
(assert (or (not l_p1) (not l_f36_p) l_f35_p))
...
;%~zcl_20 | f29
(assert (or (not l_zcl_20) l_f29))

;%~f24 | ~f29 | zcl_20
(assert (or (not l_f24) (not l_f29) l_zcl_20))
...
;%~f24_p | ~f29_p | f23_p
(assert (or (not l_f24_p) (not l_f29_p) l_f23_p))
...
;%~zcl_21 | f12
(assert (or (not l_zcl_21) l_f12))

;%~zcl_21 | f17
(assert (or (not l_zcl_21) l_f17))

;%~f12 | ~f17 | zcl_21
(assert (or (not l_f12) (not l_f17) l_zcl_21))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_21
(assert (or (not l_f11) l_zcl_21))
...
;%~zcl_22 | f0
(assert (or (not l_zcl_22) l_f0))

;%~zcl_22 | f5
(assert (or (not l_zcl_22) l_f5))

;%~f0 | ~f5 | zcl_22
(assert (or (not l_f0) (not l_f5) l_zcl_22))

;%~Q | zcl_22
(assert (or (not l_q) l_zcl_22))
...
(assert (or (not r_f4) r_p41 r_p36))


;%~r_p41 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p41) r_f4_p))


;%~r_p36 | r_f4_p
(assert (or (not r_p36) r_f4_p))


;%~r_f3 | r_p40 | r_f4
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_p40 r_f4))


;%~r_p40 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p40) r_f3_p))
...
(assert (or (not r_f2) r_p39 r_f3))


;%~r_p39 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p39) r_f2_p))
...
(assert (or (not r_f1) r_p38 r_f2))


;%~r_p38 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p38) r_f1_p))
...
(assert (or (not r_f0) r_p37 r_f1))


;%~r_p37 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p37) r_f0_p))
...
(assert (or (not r_zcl_0) r_p35))


;%~r_zcl_0 | r_p30
(assert (or (not r_zcl_0) r_p30))


;%~r_p35 | ~r_p30 | r_zcl_0
(assert (or (not r_p35) (not r_p30) r_zcl_0))
...
(assert (or (not r_p35) (not r_p30) r_f10_p))


;%~r_zcl_1 | r_p34
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p34))
...
;%~r_p34 | ~r_f10 | r_zcl_1
(assert (or (not r_p34) (not r_f10) r_zcl_1))
...
;%~r_p34 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p34) (not r_f10_p) r_f9_p))


;%~r_zcl_2 | r_p33
(declare-fun r_zcl_2 () Bool)
(assert (or (not r_zcl_2) r_p33))
...
;%~r_p33 | ~r_f9 | r_zcl_2
(assert (or (not r_p33) (not r_f9) r_zcl_2))
...
(assert (or (not r_p33) (not r_f9_p) r_f8_p))


;%~r_zcl_3 | r_p32
(declare-fun r_zcl_3 () Bool)
(assert (or (not r_zcl_3) r_p32))
...
;%~r_p32 | ~r_f8 | r_zcl_3
(assert (or (not r_p32) (not r_f8) r_zcl_3))
...
(assert (or (not r_p32) (not r_f8_p) r_f7_p))


;%~r_zcl_4 | r_p31
(declare-fun r_zcl_4 () Bool)
(assert (or (not r_zcl_4) r_p31))
...
;%~r_p31 | ~r_f7 | r_zcl_4
(assert (or (not r_p31) (not r_f7) r_zcl_4))
...
(assert (or (not r_p31) (not r_f7_p) r_f6_p))


;%~r_f16 | r_p29 | r_p24
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_p29 r_p24))


;%~r_p29 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p29) r_f16_p))


;%~r_p24 | r_f16_p
(assert (or (not r_p24) r_f16_p))


;%~r_f15 | r_p28 | r_f16
(declare-fun r_f15 () Bool)
(assert (or (not r_f15) r_p28 r_f16))


;%~r_p28 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p28) r_f15_p))
...
(assert (or (not r_f14) r_p27 r_f15))


;%~r_p27 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p27) r_f14_p))
...
(assert (or (not r_f13) r_p26 r_f14))


;%~r_p26 | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p26) r_f13_p))
...
(assert (or (not r_f12) r_p25 r_f13))


;%~r_p25 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p25) r_f12_p))
...
(assert (or (not r_zcl_5) r_p23))


;%~r_zcl_5 | r_p18
(assert (or (not r_zcl_5) r_p18))


;%~r_p23 | ~r_p18 | r_zcl_5
(assert (or (not r_p23) (not r_p18) r_zcl_5))


;%~r_f22 | r_zcl_5
(declare-fun r_f22 () Bool)
(assert (or (not r_f22) r_zcl_5))
...
(assert (or (not r_zcl_6) r_p22))


;%~r_zcl_6 | r_f22
(assert (or (not r_zcl_6) r_f22))


;%~r_p22 | ~r_f22 | r_zcl_6
(assert (or (not r_p22) (not r_f22) r_zcl_6))


;%~r_f21 | r_zcl_6
(declare-fun r_f21 () Bool)
(assert (or (not r_f21) r_zcl_6))
...
(assert (or (not r_zcl_7) r_p21))


;%~r_zcl_7 | r_f21
(assert (or (not r_zcl_7) r_f21))


;%~r_p21 | ~r_f21 | r_zcl_7
(assert (or (not r_p21) (not r_f21) r_zcl_7))


;%~r_f20 | r_zcl_7
(declare-fun r_f20 () Bool)
(assert (or (not r_f20) r_zcl_7))
...
;%~r_p20 | ~r_f20 | r_zcl_8
(assert (or (not r_p20) (not r_f20) r_zcl_8))
...
(assert (or (not r_zcl_9) r_p19))


;%~r_zcl_9 | r_f19
(assert (or (not r_zcl_9) r_f19))


;%~r_p19 | ~r_f19 | r_zcl_9
(assert (or (not r_p19) (not r_f19) r_zcl_9))


;%~r_f18 | r_zcl_9
(declare-fun r_f18 () Bool)
(assert (or (not r_f18) r_zcl_9))
...
(assert (or (not r_f28) r_p17 r_p12))


;%~r_p17 | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p17) r_f28_p))


;%~r_p12 | r_f28_p
(assert (or (not r_p12) r_f28_p))


;%~r_f27 | r_p16 | r_f28
(declare-fun r_f27 () Bool)
(assert (or (not r_f27) r_p16 r_f28))


;%~r_p16 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p16) r_f27_p))
...
(assert (or (not r_f25) r_p14 r_f26))


;%~r_p14 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p14) r_f25_p))
...
;%~r_p11 | ~r_p6 | r_zcl_10
(assert (or (not r_p11) (not r_p6) r_zcl_10))


;%~r_f34 | r_zcl_10
(declare-fun r_f34 () Bool)
(assert (or (not r_f34) r_zcl_10))


;%~r_p11 | ~r_p6 | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p11) (not r_p6) r_f34_p))
...
;%~r_zcl_11 | r_f34
(assert (or (not r_zcl_11) r_f34))


;%~r_p10 | ~r_f34 | r_zcl_11
(assert (or (not r_p10) (not r_f34) r_zcl_11))


;%~r_f33 | r_zcl_11
(declare-fun r_f33 () Bool)
(assert (or (not r_f33) r_zcl_11))


;%~r_p10 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p10) (not r_f34_p) r_f33_p))
...
;%~r_zcl_12 | r_f33
(assert (or (not r_zcl_12) r_f33))


;%~r_p9 | ~r_f33 | r_zcl_12
(assert (or (not r_p9) (not r_f33) r_zcl_12))
...
;%~r_p9 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p9) (not r_f33_p) r_f32_p))


;%~r_zcl_13 | r_p8
(declare-fun r_zcl_13 () Bool)
(assert (or (not r_zcl_13) r_p8))
...
;%~r_p8 | ~r_f32 | r_zcl_13
(assert (or (not r_p8) (not r_f32) r_zcl_13))
...
;%~r_p7 | ~r_f31 | r_zcl_14
(assert (or (not r_p7) (not r_f31) r_zcl_14))
...
;%~r_p7 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p7) (not r_f31_p) r_f30_p))
...
(assert (or (not r_f39) r_zcl_15))


;%~r_p5 | ~r_p0 | r_f39_p
(declare-fun r_f39_p () Bool)
(assert (or (not r_p5) (not r_p0) r_f39_p))
...
;%~r_zcl_16 | r_f39
(assert (or (not r_zcl_16) r_f39))


;%~r_p4 | ~r_f39 | r_zcl_16
(assert (or (not r_p4) (not r_f39) r_zcl_16))


;%~r_f38 | r_zcl_16
(declare-fun r_f38 () Bool)
(assert (or (not r_f38) r_zcl_16))


;%~r_p4 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p4) (not r_f39_p) r_f38_p))
...
;%~r_zcl_17 | r_f38
(assert (or (not r_zcl_17) r_f38))


;%~r_p3 | ~r_f38 | r_zcl_17
(assert (or (not r_p3) (not r_f38) r_zcl_17))


;%~r_f37 | r_zcl_17
(declare-fun r_f37 () Bool)
(assert (or (not r_f37) r_zcl_17))


;%~r_p3 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p3) (not r_f38_p) r_f37_p))
...
;%~r_zcl_18 | r_f37
(assert (or (not r_zcl_18) r_f37))


;%~r_p2 | ~r_f37 | r_zcl_18
(assert (or (not r_p2) (not r_f37) r_zcl_18))


;%~r_f36 | r_zcl_18
(declare-fun r_f36 () Bool)
(assert (or (not r_f36) r_zcl_18))


;%~r_p2 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p2) (not r_f37_p) r_f36_p))
...
;%~r_zcl_19 | r_f36
(assert (or (not r_zcl_19) r_f36))


;%~r_p1 | ~r_f36 | r_zcl_19
(assert (or (not r_p1) (not r_f36) r_zcl_19))


;%~r_f35 | r_zcl_19
(declare-fun r_f35 () Bool)
(assert (or (not r_f35) r_zcl_19))


;%~r_p1 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p1) (not r_f36_p) r_f35_p))
...
;%~r_zcl_20 | r_f29
(assert (or (not r_zcl_20) r_f29))


;%~r_f24 | ~r_f29 | r_zcl_20
(assert (or (not r_f24) (not r_f29) r_zcl_20))
...
;%~r_f24_p | ~r_f29_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_f24_p) (not r_f29_p) r_f23_p))
...
(assert (or (not r_zcl_21) r_f12))


;%~r_zcl_21 | r_f17
(assert (or (not r_zcl_21) r_f17))


;%~r_f12 | ~r_f17 | r_zcl_21
(assert (or (not r_f12) (not r_f17) r_zcl_21))


;%~r_f11 | r_zcl_21
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_21))
...
(assert (or (not r_zcl_22) r_f0))


;%~r_zcl_22 | r_f5
(assert (or (not r_zcl_22) r_f5))


;%~r_f0 | ~r_f5 | r_zcl_22
(assert (or (not r_f0) (not r_f5) r_zcl_22))


;%~r_Q | r_zcl_22
(declare-fun r_q () Bool)
(assert (or (not r_q) r_zcl_22))
