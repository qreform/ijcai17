...
;%~p12 | ~p11 | zcl_0
(assert (or (not l_p12) (not l_p11) l_zcl_0))
...
;%~p12 | ~p11 | f3_p
(assert (or (not l_p12) (not l_p11) l_f3_p))
...
;%~p0 | ~p8 | zcl_4
(assert (or (not l_p0) (not l_p8) l_zcl_4))
...
;%~p9 | ~f13 | zcl_5
(assert (or (not l_p9) (not l_f13) l_zcl_5))
...
;%~f16 | p7 | f17
(assert (or (not l_f16) l_p7 l_f17))
...
;%~r_p12 | ~r_p11 | r_zcl_0
(assert (or (not r_p12) (not r_p11) r_zcl_0))
...
(assert (or (not r_p12) (not r_p11) r_f3_p))
...
;%~r_p0 | ~r_p8 | r_zcl_4
(assert (or (not r_p0) (not r_p8) r_zcl_4))
...
;%~r_p9 | ~r_f13 | r_zcl_5
(assert (or (not r_p9) (not r_f13) r_zcl_5))
...
(assert (or (not r_f16) r_p7 r_f17))
