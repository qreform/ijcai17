...
;%~p9 | f4_p
(assert (or (not l_p9) l_f4_p))

;%~p16 | f4_p
(assert (or (not l_p16) l_f4_p))
...
;%~f3 | p14 | f4
(assert (or (not l_f3) l_p14 l_f4))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p14 | f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
...
;%~p10 | ~p15 | zcl_0
(assert (or (not l_p10) (not l_p15) l_zcl_0))
...
;%Non-clausified dependency
;%(forall[]((~p10 & p15) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p10 | ~p15 | f10_p
(assert (or (not l_p10) (not l_p15) l_f10_p))
...
;%~p11 | ~f10 | zcl_1
(assert (or (not l_p11) (not l_f10) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p11 | ~f10_p | f9_p
(assert (or (not l_p11) (not l_f10_p) l_f9_p))
...
;%~zcl_2 | p11
(assert (or (not l_zcl_2) l_p11))

;%~zcl_2 | f9
(assert (or (not l_zcl_2) l_f9))

;%~p11 | ~f9 | zcl_2
(assert (or (not l_p11) (not l_f9) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p11 & f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p11 | ~f9_p | f8_p
(assert (or (not l_p11) (not l_f9_p) l_f8_p))
...
;%~p0 | ~f8 | zcl_3
(assert (or (not l_p0) (not l_f8) l_zcl_3))
...
;%~p0 | ~f7 | zcl_4
(assert (or (not l_p0) (not l_f7) l_zcl_4))
...
;%~f16 | p9 | p13
(assert (or (not l_f16) l_p9 l_p13))
...
;%~f15 | p9 | f16
(assert (or (not l_f15) l_p9 l_f16))
...
;%~p9 | ~p11 | zcl_5
(assert (or (not l_p9) (not l_p11) l_zcl_5))
...
;%~p9 | ~p11 | f22_p
(assert (or (not l_p9) (not l_p11) l_f22_p))
...
;%~p12 | ~f21 | zcl_7
(assert (or (not l_p12) (not l_f21) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p12 & f21_p) --> f20_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f20_p () Bool)
;%~p12 | ~f21_p | f20_p
(assert (or (not l_p12) (not l_f21_p) l_f20_p))
...
;%~p0 | ~f20 | zcl_8
(assert (or (not l_p0) (not l_f20) l_zcl_8))
...
;%~zcl_9 | p9
(assert (or (not l_zcl_9) l_p9))

;%~zcl_9 | f19
(assert (or (not l_zcl_9) l_f19))

;%~p9 | ~f19 | zcl_9
(assert (or (not l_p9) (not l_f19) l_zcl_9))
...
;%Non-clausified dependency
;%(forall[]((~p9 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p9 | ~f19_p | f18_p
(assert (or (not l_p9) (not l_f19_p) l_f18_p))
...
;%~f27 | p6 | f28
(assert (or (not l_f27) l_p6 l_f28))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p6 | f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p6 | f27_p
(assert (or (not l_p6) l_f27_p))
...
;%~f26 | p10 | f27
(assert (or (not l_f26) l_p10 l_f27))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p10 | f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p10 | f26_p
(assert (or (not l_p10) l_f26_p))
...
;%~zcl_12 | p8
(assert (or (not l_zcl_12) l_p8))

;%~zcl_12 | f33
(assert (or (not l_zcl_12) l_f33))

;%~p8 | ~f33 | zcl_12
(assert (or (not l_p8) (not l_f33) l_zcl_12))
...
(assert (or (not r_f4) r_p9 r_p16))


;%~r_p9 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p9) r_f4_p))


;%~r_p16 | r_f4_p
(assert (or (not r_p16) r_f4_p))


;%~r_f3 | r_p14 | r_f4
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_p14 r_f4))
...
(assert (or (not r_f2) r_p17 r_f3))


;%~r_p17 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p17) r_f2_p))
...
;%~r_p10 | ~r_p15 | r_zcl_0
(assert (or (not r_p10) (not r_p15) r_zcl_0))
...
(assert (or (not r_p10) (not r_p15) r_f10_p))
...
;%~r_p11 | ~r_f10 | r_zcl_1
(assert (or (not r_p11) (not r_f10) r_zcl_1))
...
;%~r_p11 | ~r_f10_p | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p11) (not r_f10_p) r_f9_p))


;%~r_zcl_2 | r_p11
(declare-fun r_zcl_2 () Bool)
(assert (or (not r_zcl_2) r_p11))
...
;%~r_p11 | ~r_f9 | r_zcl_2
(assert (or (not r_p11) (not r_f9) r_zcl_2))
...
(assert (or (not r_p11) (not r_f9_p) r_f8_p))
...
;%~r_p0 | ~r_f8 | r_zcl_3
(assert (or (not r_p0) (not r_f8) r_zcl_3))
...
;%~r_p0 | ~r_f7 | r_zcl_4
(assert (or (not r_p0) (not r_f7) r_zcl_4))
...
(assert (or (not r_f16) r_p9 r_p13))
...
(assert (or (not r_f15) r_p9 r_f16))
...
;%~r_p9 | ~r_p11 | r_zcl_5
(assert (or (not r_p9) (not r_p11) r_zcl_5))
...
(assert (or (not r_p9) (not r_p11) r_f22_p))
...
;%~r_p12 | ~r_f21 | r_zcl_7
(assert (or (not r_p12) (not r_f21) r_zcl_7))
...
;%~r_p12 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p12) (not r_f21_p) r_f20_p))
...
;%~r_p0 | ~r_f20 | r_zcl_8
(assert (or (not r_p0) (not r_f20) r_zcl_8))
...
;%~r_p9 | ~r_f19 | r_zcl_9
(assert (or (not r_p9) (not r_f19) r_zcl_9))
...
;%~r_p9 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p9) (not r_f19_p) r_f18_p))


;%~r_f28 | r_p6 | r_p9
(declare-fun r_f28 () Bool)
(assert (or (not r_f28) r_p6 r_p9))


;%~r_p6 | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p6) r_f28_p))
...
(assert (or (not r_f27) r_p6 r_f28))


;%~r_p6 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p6) r_f27_p))
...
(assert (or (not r_f26) r_p10 r_f27))


;%~r_p10 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p10) r_f26_p))
...
;%~r_p8 | ~r_f33 | r_zcl_12
(assert (or (not r_p8) (not r_f33) r_zcl_12))
