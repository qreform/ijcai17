...
;%~p7 | ~p11 | zcl_0
(assert (or (not l_p7) (not l_p11) l_zcl_0))
...
;%~p7 | ~p11 | f8_p
(assert (or (not l_p7) (not l_p11) l_f8_p))
...
;%~p5 | ~f8 | zcl_1
(assert (or (not l_p5) (not l_f8) l_zcl_1))
...
;%~p5 | ~f8_p | f7_p
(assert (or (not l_p5) (not l_f8_p) l_f7_p))
...
;%~f13 | p7 | p10
(assert (or (not l_f13) l_p7 l_p10))
...
;%~p5 | ~f18 | zcl_5
(assert (or (not l_p5) (not l_f18) l_zcl_5))
...
;%~p5 | ~f17 | zcl_6
(assert (or (not l_p5) (not l_f17) l_zcl_6))
...
;%~p7 | ~f16 | zcl_7
(assert (or (not l_p7) (not l_f16) l_zcl_7))
...
;%~p6 | ~f28 | zcl_9
(assert (or (not l_p6) (not l_f28) l_zcl_9))
...
;%~r_p7 | ~r_p11 | r_zcl_0
(assert (or (not r_p7) (not r_p11) r_zcl_0))
...
(assert (or (not r_p7) (not r_p11) r_f8_p))
...
;%~r_p5 | ~r_f8 | r_zcl_1
(assert (or (not r_p5) (not r_f8) r_zcl_1))
...
(assert (or (not r_p5) (not r_f8_p) r_f7_p))
...
(assert (or (not r_f13) r_p7 r_p10))
...
;%~r_p5 | ~r_f18 | r_zcl_5
(assert (or (not r_p5) (not r_f18) r_zcl_5))
...
;%~r_p5 | ~r_f17 | r_zcl_6
(assert (or (not r_p5) (not r_f17) r_zcl_6))
...
;%~r_p7 | ~r_f16 | r_zcl_7
(assert (or (not r_p7) (not r_f16) r_zcl_7))
...
;%~r_p6 | ~r_f28 | r_zcl_9
(assert (or (not r_p6) (not r_f28) r_zcl_9))
