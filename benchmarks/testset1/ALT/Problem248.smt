...
;%~p3 | ~p4 | zcl_1
(assert (or (not l_p3) (not l_p4) l_zcl_1))
...
;%~p3 | ~p4 | f6_p
(assert (or (not l_p3) (not l_p4) l_f6_p))
...
;%~p0 | ~p2 | zcl_2
(assert (or (not l_p0) (not l_p2) l_zcl_2))
...
;%~p0 | ~p2 | f10_p
(assert (or (not l_p0) (not l_p2) l_f10_p))
...
;%~r_p3 | ~r_p4 | r_zcl_1
(assert (or (not r_p3) (not r_p4) r_zcl_1))
...
(assert (or (not r_p3) (not r_p4) r_f6_p))


;%~r_f8 | r_p0 | r_p3
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p0 r_p3))
...
;%~r_p0 | ~r_p2 | r_zcl_2
(assert (or (not r_p0) (not r_p2) r_zcl_2))
...
(assert (or (not r_p0) (not r_p2) r_f10_p))
