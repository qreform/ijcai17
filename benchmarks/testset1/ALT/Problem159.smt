...
;%~f3 | p11 | p13
(assert (or (not l_f3) l_p11 l_p13))
...
;%~p5 | ~p11 | f8_p
(assert (or (not l_p5) (not l_p11) l_f8_p))
...
;%~p7 | ~p5 | f18_p
(assert (or (not l_p7) (not l_p5) l_f18_p))
...
(assert (or (not r_f3) r_p11 r_p13))
...
(assert (or (not r_p5) (not r_p11) r_f8_p))
...
(assert (or (not r_p7) (not r_p5) r_f18_p))
