...
;%~p3 | ~p12 | zcl_0
(assert (or (not l_p3) (not l_p12) l_zcl_0))
...
;%~p3 | ~p12 | f2_p
(assert (or (not l_p3) (not l_p12) l_f2_p))
...
;%~p1 | ~f2 | zcl_1
(assert (or (not l_p1) (not l_f2) l_zcl_1))
...
;%~p6 | ~f1 | zcl_2
(assert (or (not l_p6) (not l_f1) l_zcl_2))
...
;%~p6 | ~f1_p | f0_p
(assert (or (not l_p6) (not l_f1_p) l_f0_p))
...
;%~p3 | ~p6 | zcl_3
(assert (or (not l_p3) (not l_p6) l_zcl_3))
...
;%~p3 | ~p6 | f10_p
(assert (or (not l_p3) (not l_p6) l_f10_p))
...
;%~f12 | p1 | f13
(assert (or (not l_f12) l_p1 l_f13))
...
;%~f12 | ~f15 | zcl_6
(assert (or (not l_f12) (not l_f15) l_zcl_6))
...
;%~zcl_7 | f4
(assert (or (not l_zcl_7) l_f4))

;%~zcl_7 | f7
(assert (or (not l_zcl_7) l_f7))

;%~f4 | ~f7 | zcl_7
(assert (or (not l_f4) (not l_f7) l_zcl_7))

(declare-fun l_f3 () Bool)
;%~f3 | zcl_7
(assert (or (not l_f3) l_zcl_7))
...
;%~r_p3 | ~r_p12 | r_zcl_0
(assert (or (not r_p3) (not r_p12) r_zcl_0))
...
(assert (or (not r_p3) (not r_p12) r_f2_p))
...
;%~r_p1 | ~r_f2 | r_zcl_1
(assert (or (not r_p1) (not r_f2) r_zcl_1))
...
;%~r_p6 | ~r_f1 | r_zcl_2
(assert (or (not r_p6) (not r_f1) r_zcl_2))
...
(assert (or (not r_p6) (not r_f1_p) r_f0_p))


;%~r_f6 | r_p11 | r_p9
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_p11 r_p9))
...
;%~r_p3 | ~r_p6 | r_zcl_3
(assert (or (not r_p3) (not r_p6) r_zcl_3))
...
(assert (or (not r_p3) (not r_p6) r_f10_p))
...
(assert (or (not r_f12) r_p1 r_f13))


;%~r_p1 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p1) r_f12_p))
...
;%~r_f12 | ~r_f15 | r_zcl_6
(assert (or (not r_f12) (not r_f15) r_zcl_6))
...
(assert (or (not r_zcl_7) r_f4))


;%~r_zcl_7 | r_f7
(assert (or (not r_zcl_7) r_f7))


;%~r_f4 | ~r_f7 | r_zcl_7
(assert (or (not r_f4) (not r_f7) r_zcl_7))


;%~r_f3 | r_zcl_7
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_zcl_7))
