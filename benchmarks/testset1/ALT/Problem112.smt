...
;%~p0 | ~p11 | f5_p
(assert (or (not l_p0) (not l_p11) l_f5_p))
...
;%~p10 | ~f5 | zcl_1
(assert (or (not l_p10) (not l_f5) l_zcl_1))
...
;%~p10 | ~f5_p | f4_p
(assert (or (not l_p10) (not l_f5_p) l_f4_p))
...
(assert (or (not r_p0) (not r_p11) r_f5_p))
...
;%~r_p10 | ~r_f5 | r_zcl_1
(assert (or (not r_p10) (not r_f5) r_zcl_1))
...
(assert (or (not r_p10) (not r_f5_p) r_f4_p))
