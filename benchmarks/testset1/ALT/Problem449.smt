...
;%~p0 | ~p3 | zcl_1
(assert (or (not l_p0) (not l_p3) l_zcl_1))
...
;%~p0 | ~p3 | f6_p
(assert (or (not l_p0) (not l_p3) l_f6_p))
...
;%~r_p0 | ~r_p3 | r_zcl_1
(assert (or (not r_p0) (not r_p3) r_zcl_1))
...
(assert (or (not r_p0) (not r_p3) r_f6_p))


;%~r_f8 | r_p0 | r_p2
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p0 r_p2))
