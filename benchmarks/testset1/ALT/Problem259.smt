...
;%~p0 | ~p7 | f4_p
(assert (or (not l_p0) (not l_p7) l_f4_p))
...
;%~p0 | ~p5 | zcl_2
(assert (or (not l_p0) (not l_p5) l_zcl_2))
...
(assert (or (not r_p0) (not r_p7) r_f4_p))
...
;%~r_p0 | ~r_p5 | r_zcl_2
(assert (or (not r_p0) (not r_p5) r_zcl_2))
