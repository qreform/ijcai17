...
;%~p12 | ~f8 | zcl_1
(assert (or (not l_p12) (not l_f8) l_zcl_1))
...
;%~p12 | ~f6 | zcl_3
(assert (or (not l_p12) (not l_f6) l_zcl_3))
...
;%~p12 | ~f6_p | f5_p
(assert (or (not l_p12) (not l_f6_p) l_f5_p))
...
;%~f13 | p14 | p12
(assert (or (not l_f13) l_p14 l_p12))
...
;%~f10 | p10 | f11
(assert (or (not l_f10) l_p10 l_f11))
...
;%~f22 | p9 | f23
(assert (or (not l_f22) l_p9 l_f23))
...
;%~p7 | ~p5 | f28_p
(assert (or (not l_p7) (not l_p5) l_f28_p))
...
;%~p6 | ~f27 | zcl_10
(assert (or (not l_p6) (not l_f27) l_zcl_10))
...
;%~r_p12 | ~r_f8 | r_zcl_1
(assert (or (not r_p12) (not r_f8) r_zcl_1))
...
;%~r_p12 | ~r_f6 | r_zcl_3
(assert (or (not r_p12) (not r_f6) r_zcl_3))
...
(assert (or (not r_p12) (not r_f6_p) r_f5_p))


;%~r_f13 | r_p14 | r_p12
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_p14 r_p12))
...
(assert (or (not r_f10) r_p10 r_f11))
...
(assert (or (not r_f22) r_p9 r_f23))
...
(assert (or (not r_p7) (not r_p5) r_f28_p))
...
;%~r_p6 | ~r_f27 | r_zcl_10
(assert (or (not r_p6) (not r_f27) r_zcl_10))
