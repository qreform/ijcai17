...
;%~zcl_0 | p22
(assert (or (not l_zcl_0) l_p22))

;%~p9 | ~p22 | zcl_0
(assert (or (not l_p9) (not l_p22) l_zcl_0))
...
;%~p9 | ~p22 | f5_p
(assert (or (not l_p9) (not l_p22) l_f5_p))
...
;%~zcl_1 | p24
(assert (or (not l_zcl_1) l_p24))

;%~zcl_1 | f5
(assert (or (not l_zcl_1) l_f5))

;%~p24 | ~f5 | zcl_1
(assert (or (not l_p24) (not l_f5) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((p24 & f5_p) --> f4_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f4_p () Bool)
;%~p24 | ~f5_p | f4_p
(assert (or (not l_p24) (not l_f5_p) l_f4_p))
...
;%~p9 | ~f3 | zcl_3
(assert (or (not l_p9) (not l_f3) l_zcl_3))
...
;%~p9 | ~f3_p | f2_p
(assert (or (not l_p9) (not l_f3_p) l_f2_p))
...
;%~f12 | p21 | p18
(assert (or (not l_f12) l_p21 l_p18))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p21 | p18) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p21 | f12_p
(assert (or (not l_p21) l_f12_p))
...
;%~f11 | p20 | f12
(assert (or (not l_f11) l_p20 l_f12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p20 | f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p20 | f11_p
(assert (or (not l_p20) l_f11_p))
...
;%~f10 | p9 | f11
(assert (or (not l_f10) l_p9 l_f11))
...
;%~p17 | ~p13 | zcl_6
(assert (or (not l_p17) (not l_p13) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p17 & p13) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p17 | ~p13 | f19_p
(assert (or (not l_p17) (not l_p13) l_f19_p))
...
;%~p9 | ~f19 | zcl_7
(assert (or (not l_p9) (not l_f19) l_zcl_7))
...
;%~zcl_9 | p16
(assert (or (not l_zcl_9) l_p16))

;%~zcl_9 | f17
(assert (or (not l_zcl_9) l_f17))

;%~p16 | ~f17 | zcl_9
(assert (or (not l_p16) (not l_f17) l_zcl_9))
...
;%Non-clausified dependency
;%(forall[]((p16 & f17_p) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p16 | ~f17_p | f16_p
(assert (or (not l_p16) (not l_f17_p) l_f16_p))
...
;%~zcl_10 | p15
(assert (or (not l_zcl_10) l_p15))

;%~zcl_10 | f16
(assert (or (not l_zcl_10) l_f16))

;%~p15 | ~f16 | zcl_10
(assert (or (not l_p15) (not l_f16) l_zcl_10))
...
;%~p15 | ~f16_p | f15_p
(assert (or (not l_p15) (not l_f16_p) l_f15_p))
...
;%~zcl_11 | p14
(assert (or (not l_zcl_11) l_p14))

;%~zcl_11 | f15
(assert (or (not l_zcl_11) l_f15))

;%~p14 | ~f15 | zcl_11
(assert (or (not l_p14) (not l_f15) l_zcl_11))
...
;%~p14 | ~f15_p | f14_p
(assert (or (not l_p14) (not l_f15_p) l_f14_p))
...
;%~f26 | p12 | p9
(assert (or (not l_f26) l_p12 l_p9))
...
;%~f24 | p11 | f25
(assert (or (not l_f24) l_p11 l_f25))
...
;%~f22 | p10 | f23
(assert (or (not l_f22) l_p10 l_f23))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p10 | f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
...
;%~r_zcl_0 | r_p22
(assert (or (not r_zcl_0) r_p22))


;%~r_p9 | ~r_p22 | r_zcl_0
(assert (or (not r_p9) (not r_p22) r_zcl_0))
...
(assert (or (not r_p9) (not r_p22) r_f5_p))


;%~r_zcl_1 | r_p24
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p24))
...
;%~r_p24 | ~r_f5 | r_zcl_1
(assert (or (not r_p24) (not r_f5) r_zcl_1))
...
(assert (or (not r_p24) (not r_f5_p) r_f4_p))
...
;%~r_p9 | ~r_f3 | r_zcl_3
(assert (or (not r_p9) (not r_f3) r_zcl_3))
...
(assert (or (not r_p9) (not r_f3_p) r_f2_p))
...
(assert (or (not r_f12) r_p21 r_p18))


;%~r_p21 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p21) r_f12_p))
...
(assert (or (not r_f11) r_p20 r_f12))


;%~r_p20 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p20) r_f11_p))
...
(assert (or (not r_f10) r_p9 r_f11))
...
(assert (or (not r_f8) r_p19 r_f9))


;%~r_p19 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p19) r_f8_p))
...
;%~r_p17 | ~r_p13 | r_zcl_6
(assert (or (not r_p17) (not r_p13) r_zcl_6))
...
(assert (or (not r_p17) (not r_p13) r_f19_p))
...
;%~r_p9 | ~r_f19 | r_zcl_7
(assert (or (not r_p9) (not r_f19) r_zcl_7))
...
;%~r_p16 | ~r_f17 | r_zcl_9
(assert (or (not r_p16) (not r_f17) r_zcl_9))
...
;%~r_p16 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p16) (not r_f17_p) r_f16_p))


;%~r_zcl_10 | r_p15
(declare-fun r_zcl_10 () Bool)
(assert (or (not r_zcl_10) r_p15))
...
;%~r_p15 | ~r_f16 | r_zcl_10
(assert (or (not r_p15) (not r_f16) r_zcl_10))
...
;%~r_p15 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p15) (not r_f16_p) r_f15_p))


;%~r_zcl_11 | r_p14
(declare-fun r_zcl_11 () Bool)
(assert (or (not r_zcl_11) r_p14))
...
;%~r_p14 | ~r_f15 | r_zcl_11
(assert (or (not r_p14) (not r_f15) r_zcl_11))
...
;%~r_p14 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p14) (not r_f15_p) r_f14_p))


;%~r_f26 | r_p12 | r_p9
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_p12 r_p9))


;%~r_p12 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p12) r_f26_p))
...
(assert (or (not r_f24) r_p11 r_f25))


;%~r_p11 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p11) r_f24_p))
...
(assert (or (not r_f22) r_p10 r_f23))
