...
;%~f3 | p17 | p16
(assert (or (not l_f3) l_p17 l_p16))
...
;%~p7 | ~p14 | zcl_0
(assert (or (not l_p7) (not l_p14) l_zcl_0))
...
;%~p7 | ~p14 | f8_p
(assert (or (not l_p7) (not l_p14) l_f8_p))
...
;%~p1 | ~f8 | zcl_1
(assert (or (not l_p1) (not l_f8) l_zcl_1))
...
;%~p15 | ~f7 | zcl_2
(assert (or (not l_p15) (not l_f7) l_zcl_2))
...
;%~p15 | ~f7_p | f6_p
(assert (or (not l_p15) (not l_f7_p) l_f6_p))
...
;%~p10 | ~f6 | zcl_3
(assert (or (not l_p10) (not l_f6) l_zcl_3))
...
;%~p10 | ~f6_p | f5_p
(assert (or (not l_p10) (not l_f6_p) l_f5_p))
...
;%~f13 | p13 | p10
(assert (or (not l_f13) l_p13 l_p10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p13 | p10) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p13 | f13_p
(assert (or (not l_p13) l_f13_p))
...
;%~f12 | p12 | f13
(assert (or (not l_f12) l_p12 l_f13))
...
;%~f11 | p8 | f12
(assert (or (not l_f11) l_p8 l_f12))
...
;%~p8 | ~p9 | zcl_4
(assert (or (not l_p8) (not l_p9) l_zcl_4))
...
;%~p8 | ~p9 | f18_p
(assert (or (not l_p8) (not l_p9) l_f18_p))
...
;%~p8 | ~f18 | zcl_5
(assert (or (not l_p8) (not l_f18) l_zcl_5))
...
(assert (or (not r_f3) r_p17 r_p16))
...
;%~r_p7 | ~r_p14 | r_zcl_0
(assert (or (not r_p7) (not r_p14) r_zcl_0))
...
(assert (or (not r_p7) (not r_p14) r_f8_p))
...
;%~r_p1 | ~r_f8 | r_zcl_1
(assert (or (not r_p1) (not r_f8) r_zcl_1))
...
;%~r_p15 | ~r_f7 | r_zcl_2
(assert (or (not r_p15) (not r_f7) r_zcl_2))
...
(assert (or (not r_p15) (not r_f7_p) r_f6_p))
...
;%~r_p10 | ~r_f6 | r_zcl_3
(assert (or (not r_p10) (not r_f6) r_zcl_3))
...
(assert (or (not r_p10) (not r_f6_p) r_f5_p))


;%~r_f13 | r_p13 | r_p10
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_p13 r_p10))


;%~r_p13 | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p13) r_f13_p))
...
(assert (or (not r_f12) r_p12 r_f13))
...
(assert (or (not r_f11) r_p8 r_f12))


;%~r_p8 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p8) r_f11_p))
...
;%~r_p8 | ~r_p9 | r_zcl_4
(assert (or (not r_p8) (not r_p9) r_zcl_4))
...
(assert (or (not r_p8) (not r_p9) r_f18_p))
...
;%~r_p8 | ~r_f18 | r_zcl_5
(assert (or (not r_p8) (not r_f18) r_zcl_5))
