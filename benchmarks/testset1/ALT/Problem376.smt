...
;%~f3 | p19 | p15
(assert (or (not l_f3) l_p19 l_p15))
...
;%~p14 | ~p10 | zcl_0
(assert (or (not l_p14) (not l_p10) l_zcl_0))
...
;%~p14 | ~p10 | f8_p
(assert (or (not l_p14) (not l_p10) l_f8_p))
...
;%~p13 | ~f8 | zcl_1
(assert (or (not l_p13) (not l_f8) l_zcl_1))
...
;%~p12 | ~f7 | zcl_2
(assert (or (not l_p12) (not l_f7) l_zcl_2))
...
;%~f11 | p7 | f12
(assert (or (not l_f11) l_p7 l_f12))
...
(assert (or (not r_f3) r_p19 r_p15))


;%~r_p19 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p19) r_f3_p))
...
(assert (or (not r_f2) r_p18 r_f3))


;%~r_p18 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p18) r_f2_p))
...
(assert (or (not r_f1) r_p17 r_f2))


;%~r_p17 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p17) r_f1_p))
...
(assert (or (not r_f0) r_p16 r_f1))


;%~r_p16 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p16) r_f0_p))
...
;%~r_p14 | ~r_p10 | r_zcl_0
(assert (or (not r_p14) (not r_p10) r_zcl_0))
...
(assert (or (not r_p14) (not r_p10) r_f8_p))
...
;%~r_p13 | ~r_f8 | r_zcl_1
(assert (or (not r_p13) (not r_f8) r_zcl_1))
...
;%~r_p12 | ~r_f7 | r_zcl_2
(assert (or (not r_p12) (not r_f7) r_zcl_2))
...
(assert (or (not r_f11) r_p7 r_f12))


;%~r_p7 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p7) r_f11_p))
