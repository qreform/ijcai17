...
;%~p5 | ~f2 | zcl_3
(assert (or (not l_p5) (not l_f2) l_zcl_3))
...
;%~f10 | p6 | p11
(assert (or (not l_f10) l_p6 l_p11))
...
;%~p10 | ~p7 | zcl_5
(assert (or (not l_p10) (not l_p7) l_zcl_5))
...
;%~p10 | ~p7 | f16_p
(assert (or (not l_p10) (not l_p7) l_f16_p))
...
;%~p6 | ~f16 | zcl_6
(assert (or (not l_p6) (not l_f16) l_zcl_6))
...
;%~p1 | ~f14 | zcl_8
(assert (or (not l_p1) (not l_f14) l_zcl_8))
...
;%~r_p5 | ~r_f2 | r_zcl_3
(assert (or (not r_p5) (not r_f2) r_zcl_3))
...
(assert (or (not r_f10) r_p6 r_p11))
...
;%~r_p10 | ~r_p7 | r_zcl_5
(assert (or (not r_p10) (not r_p7) r_zcl_5))
...
(assert (or (not r_p10) (not r_p7) r_f16_p))
...
;%~r_p6 | ~r_f16 | r_zcl_6
(assert (or (not r_p6) (not r_f16) r_zcl_6))
...
;%~r_p1 | ~r_f14 | r_zcl_8
(assert (or (not r_p1) (not r_f14) r_zcl_8))
