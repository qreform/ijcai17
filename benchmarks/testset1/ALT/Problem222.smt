...
;%~p13 | ~p12 | f4_p
(assert (or (not l_p13) (not l_p12) l_f4_p))
...
;%~p7 | ~f3 | zcl_2
(assert (or (not l_p7) (not l_f3) l_zcl_2))
...
;%~f10 | p0 | p10
(assert (or (not l_f10) l_p0 l_p10))
...
;%~p0 | ~p8 | zcl_5
(assert (or (not l_p0) (not l_p8) l_zcl_5))
...
;%~p9 | ~f14 | zcl_8
(assert (or (not l_p9) (not l_f14) l_zcl_8))
...
(assert (or (not r_p13) (not r_p12) r_f4_p))
...
;%~r_p7 | ~r_f3 | r_zcl_2
(assert (or (not r_p7) (not r_f3) r_zcl_2))
...
(assert (or (not r_f10) r_p0 r_p10))
...
;%~r_p0 | ~r_p8 | r_zcl_5
(assert (or (not r_p0) (not r_p8) r_zcl_5))
...
;%~r_p9 | ~r_f14 | r_zcl_8
(assert (or (not r_p9) (not r_f14) r_zcl_8))
