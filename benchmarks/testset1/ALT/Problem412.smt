...
;%~p10 | ~f2 | zcl_1
(assert (or (not l_p10) (not l_f2) l_zcl_1))
...
;%~p4 | ~p6 | zcl_3
(assert (or (not l_p4) (not l_p6) l_zcl_3))
...
;%~p0 | ~f9 | zcl_5
(assert (or (not l_p0) (not l_f9) l_zcl_5))
...
;%~r_p10 | ~r_f2 | r_zcl_1
(assert (or (not r_p10) (not r_f2) r_zcl_1))
...
;%~r_p4 | ~r_p6 | r_zcl_3
(assert (or (not r_p4) (not r_p6) r_zcl_3))
...
;%~r_p0 | ~r_f9 | r_zcl_5
(assert (or (not r_p0) (not r_f9) r_zcl_5))
