...
;%~p19 | ~p16 | f2_p
(assert (or (not l_p19) (not l_p16) l_f2_p))
...
;%~p18 | ~f2 | zcl_1
(assert (or (not l_p18) (not l_f2) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((~p18 & f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p18 | ~f2_p | f1_p
(assert (or (not l_p18) (not l_f2_p) l_f1_p))
...
;%~p17 | ~f1 | zcl_2
(assert (or (not l_p17) (not l_f1) l_zcl_2))
...
;%~f6 | p15 | p12
(assert (or (not l_f6) l_p15 l_p12))
...
;%~p10 | ~f10 | zcl_4
(assert (or (not l_p10) (not l_f10) l_zcl_4))
...
(assert (or (not r_p19) (not r_p16) r_f2_p))
...
;%~r_p18 | ~r_f2 | r_zcl_1
(assert (or (not r_p18) (not r_f2) r_zcl_1))
...
(assert (or (not r_p18) (not r_f2_p) r_f1_p))
...
;%~r_p17 | ~r_f1 | r_zcl_2
(assert (or (not r_p17) (not r_f1) r_zcl_2))
...
(assert (or (not r_f6) r_p15 r_p12))
...
(assert (or (not r_f5) r_p14 r_f6))


;%~r_p14 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p14) r_f5_p))
...
;%~r_p10 | ~r_f10 | r_zcl_4
(assert (or (not r_p10) (not r_f10) r_zcl_4))
