...
;%~p3 | ~p11 | zcl_0
(assert (or (not l_p3) (not l_p11) l_zcl_0))
...
;%~p3 | ~p11 | f1_p
(assert (or (not l_p3) (not l_p11) l_f1_p))
...
;%~p8 | ~f7 | zcl_3
(assert (or (not l_p8) (not l_f7) l_zcl_3))
...
;%~p4 | ~p3 | zcl_4
(assert (or (not l_p4) (not l_p3) l_zcl_4))
...
;%~p4 | ~p3 | f13_p
(assert (or (not l_p4) (not l_p3) l_f13_p))
...
;%~r_p3 | ~r_p11 | r_zcl_0
(assert (or (not r_p3) (not r_p11) r_zcl_0))
...
(assert (or (not r_p3) (not r_p11) r_f1_p))
...
;%~r_p8 | ~r_f7 | r_zcl_3
(assert (or (not r_p8) (not r_f7) r_zcl_3))
...
;%~r_p4 | ~r_p3 | r_zcl_4
(assert (or (not r_p4) (not r_p3) r_zcl_4))
...
(assert (or (not r_p4) (not r_p3) r_f13_p))
