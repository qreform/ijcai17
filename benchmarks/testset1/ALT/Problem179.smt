...
;%~p14 | ~p13 | zcl_0
(assert (or (not l_p14) (not l_p13) l_zcl_0))
...
;%~p14 | ~p13 | f12_p
(assert (or (not l_p14) (not l_p13) l_f12_p))
...
;%~p9 | ~f25 | zcl_8
(assert (or (not l_p9) (not l_f25) l_zcl_8))
...
;%~r_p15 | r_f5_p
(assert (or (not r_p15) r_f5_p))


;%~r_f4 | r_p10 | r_f5
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_p10 r_f5))
...
;%~r_p14 | ~r_p13 | r_zcl_0
(assert (or (not r_p14) (not r_p13) r_zcl_0))
...
(assert (or (not r_p14) (not r_p13) r_f12_p))
...
;%~r_p9 | ~r_f25 | r_zcl_8
(assert (or (not r_p9) (not r_f25) r_zcl_8))
