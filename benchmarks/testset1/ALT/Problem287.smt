...
;%~f3 | p12 | f4
(assert (or (not l_f3) l_p12 l_f4))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p12 | f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
...
;%~f1 | p21 | f2
(assert (or (not l_f1) l_p21 l_f2))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p21 | f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p21 | f1_p
(assert (or (not l_p21) l_f1_p))
...
;%~f0 | p20 | f1
(assert (or (not l_f0) l_p20 l_f1))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p20 | f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f0_p () Bool)
;%~p20 | f0_p
(assert (or (not l_p20) l_f0_p))
...
;%~p0 | ~p16 | zcl_0
(assert (or (not l_p0) (not l_p16) l_zcl_0))
...
;%~p0 | ~p16 | f10_p
(assert (or (not l_p0) (not l_p16) l_f10_p))
...
;%~p0 | ~f10 | zcl_1
(assert (or (not l_p0) (not l_f10) l_zcl_1))
...
;%~zcl_2 | p18
(assert (or (not l_zcl_2) l_p18))

;%~zcl_2 | f9
(assert (or (not l_zcl_2) l_f9))

;%~p18 | ~f9 | zcl_2
(assert (or (not l_p18) (not l_f9) l_zcl_2))
...
;%Non-clausified dependency
;%(forall[]((p18 & f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p18 | ~f9_p | f8_p
(assert (or (not l_p18) (not l_f9_p) l_f8_p))
...
;%~zcl_3 | p17
(assert (or (not l_zcl_3) l_p17))

;%~zcl_3 | f8
(assert (or (not l_zcl_3) l_f8))

;%~p17 | ~f8 | zcl_3
(assert (or (not l_p17) (not l_f8) l_zcl_3))
...
;%Non-clausified dependency
;%(forall[]((~p17 & f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p17 | ~f8_p | f7_p
(assert (or (not l_p17) (not l_f8_p) l_f7_p))
...
;%~f16 | p7 | p12
(assert (or (not l_f16) l_p7 l_p12))
...
;%~p11 | ~p8 | zcl_5
(assert (or (not l_p11) (not l_p8) l_zcl_5))
...
;%~p11 | ~p8 | f22_p
(assert (or (not l_p11) (not l_p8) l_f22_p))
...
;%~p7 | ~f21 | zcl_7
(assert (or (not l_p7) (not l_f21) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((~p7 & f21_p) --> f20_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f20_p () Bool)
;%~p7 | ~f21_p | f20_p
(assert (or (not l_p7) (not l_f21_p) l_f20_p))
...
(assert (or (not r_f1) r_p21 r_f2))


;%~r_p21 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p21) r_f1_p))
...
(assert (or (not r_f0) r_p20 r_f1))


;%~r_p20 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p20) r_f0_p))
...
;%~r_p0 | ~r_p16 | r_zcl_0
(assert (or (not r_p0) (not r_p16) r_zcl_0))
...
(assert (or (not r_p0) (not r_p16) r_f10_p))
...
;%~r_p0 | ~r_f10 | r_zcl_1
(assert (or (not r_p0) (not r_f10) r_zcl_1))
...
;%~r_p18 | ~r_f9 | r_zcl_2
(assert (or (not r_p18) (not r_f9) r_zcl_2))
...
(assert (or (not r_p18) (not r_f9_p) r_f8_p))


;%~r_zcl_3 | r_p17
(declare-fun r_zcl_3 () Bool)
(assert (or (not r_zcl_3) r_p17))
...
;%~r_p17 | ~r_f8 | r_zcl_3
(assert (or (not r_p17) (not r_f8) r_zcl_3))
...
(assert (or (not r_p17) (not r_f8_p) r_f7_p))
...
(assert (or (not r_f16) r_p7 r_p12))


;%~r_p7 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p7) r_f16_p))
...
;%~r_p11 | ~r_p8 | r_zcl_5
(assert (or (not r_p11) (not r_p8) r_zcl_5))
...
(assert (or (not r_p11) (not r_p8) r_f22_p))
...
;%~r_p7 | ~r_f21 | r_zcl_7
(assert (or (not r_p7) (not r_f21) r_zcl_7))
...
;%~r_p7 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p7) (not r_f21_p) r_f20_p))
