%%%%%%%%%%%%%%%% Target reformulation: ((p0 & p3) | ((p1 | p2) & (p1 | p0))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_4 | p0)) .
cnf(l_axiom2,axiom,(~zcl_4 | p3)) .
cnf(l_axiom3,axiom,(~p0 | ~p3 | zcl_4)) .
...
cnf(r_axiom4,axiom,(~acc_zcl_4 | acc_p0)) .
cnf(r_axiom5,axiom,(~acc_zcl_4 | acc_p3)) .
cnf(r_axiom6,axiom,(~acc_p0 | ~acc_p3 | acc_zcl_4)) .
cnf(r_axiom7,axiom,(~acc_f0 | acc_zcl_4)) .
cnf(r_axiom8,axiom,(~acc_p0 | ~acc_p3 | acc_f0_p)) .
