...
;%~p8 | ~p6 | f6_p
(assert (or (not l_p8) (not l_p6) l_f6_p))
...
;%~p5 | ~f6 | zcl_1
(assert (or (not l_p5) (not l_f6) l_zcl_1))
...
(assert (or (not r_p8) (not r_p6) r_f6_p))
...
;%~r_p5 | ~r_f6 | r_zcl_1
(assert (or (not r_p5) (not r_f6) r_zcl_1))
