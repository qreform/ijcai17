...
;%~f1 | p20 | p18
(assert (or (not l_f1) l_p20 l_p18))
...
;%~p17 | ~p15 | zcl_0
(assert (or (not l_p17) (not l_p15) l_zcl_0))
...
;%~p17 | ~p15 | f4_p
(assert (or (not l_p17) (not l_p15) l_f4_p))
...
;%~p16 | ~f4 | zcl_1
(assert (or (not l_p16) (not l_f4) l_zcl_1))
...
;%~p16 | ~f4_p | f3_p
(assert (or (not l_p16) (not l_f4_p) l_f3_p))
...
;%~f7 | p14 | p12
(assert (or (not l_f7) l_p14 l_p12))
...
;%~p11 | ~p9 | zcl_2
(assert (or (not l_p11) (not l_p9) l_zcl_2))
...
;%~p11 | ~p9 | f10_p
(assert (or (not l_p11) (not l_p9) l_f10_p))
...
;%~p10 | ~f10 | zcl_3
(assert (or (not l_p10) (not l_f10) l_zcl_3))
...
;%~p5 | ~p3 | zcl_4
(assert (or (not l_p5) (not l_p3) l_zcl_4))

(declare-fun l_f16 () Bool)
;%~f16 | zcl_4
(assert (or (not l_f16) l_zcl_4))
...
;%~p5 | ~p3 | f16_p
(assert (or (not l_p5) (not l_p3) l_f16_p))
...
;%~zcl_5 | f16
(assert (or (not l_zcl_5) l_f16))

;%~p4 | ~f16 | zcl_5
(assert (or (not l_p4) (not l_f16) l_zcl_5))
...
;%~p4 | ~f16_p | f15_p
(assert (or (not l_p4) (not l_f16_p) l_f15_p))
...
;%~p2 | ~p0 | zcl_6
(assert (or (not l_p2) (not l_p0) l_zcl_6))
...
;%~p2 | ~p0 | f18_p
(assert (or (not l_p2) (not l_p0) l_f18_p))
...
;%~p1 | ~f18 | zcl_7
(assert (or (not l_p1) (not l_f18) l_zcl_7))
...
;%~f14 | f15 | f17
(assert (or (not l_f14) l_f15 l_f17))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((f15_p | f17_p) --> f14_p))
;%------------------------Clausification start------------------------%
...
;%~zcl_8 | f12
(assert (or (not l_zcl_8) l_f12))

;%~zcl_8 | f14
(assert (or (not l_zcl_8) l_f14))

;%~f12 | ~f14 | zcl_8
(assert (or (not l_f12) (not l_f14) l_zcl_8))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_8
(assert (or (not l_f11) l_zcl_8))
...
;%~zcl_9 | f6
(assert (or (not l_zcl_9) l_f6))

;%~zcl_9 | f8
(assert (or (not l_zcl_9) l_f8))

;%~f6 | ~f8 | zcl_9
(assert (or (not l_f6) (not l_f8) l_zcl_9))

(declare-fun l_f5 () Bool)
;%~f5 | zcl_9
(assert (or (not l_f5) l_zcl_9))
...
;%~zcl_10 | f2
(assert (or (not l_zcl_10) l_f2))

;%~f0 | ~f2 | zcl_10
(assert (or (not l_f0) (not l_f2) l_zcl_10))
...
(assert (or (not r_f1) r_p20 r_p18))
...
;%~r_p17 | ~r_p15 | r_zcl_0
(assert (or (not r_p17) (not r_p15) r_zcl_0))
...
(assert (or (not r_p17) (not r_p15) r_f4_p))
...
;%~r_p16 | ~r_f4 | r_zcl_1
(assert (or (not r_p16) (not r_f4) r_zcl_1))
...
(assert (or (not r_p16) (not r_f4_p) r_f3_p))


;%~r_f7 | r_p14 | r_p12
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_p14 r_p12))
...
;%~r_p11 | ~r_p9 | r_zcl_2
(assert (or (not r_p11) (not r_p9) r_zcl_2))
...
(assert (or (not r_p11) (not r_p9) r_f10_p))
...
;%~r_p10 | ~r_f10 | r_zcl_3
(assert (or (not r_p10) (not r_f10) r_zcl_3))
...
(assert (or (not r_f13) r_p8 r_p6))


;%~r_p8 | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p8) r_f13_p))
...
;%~r_p5 | ~r_p3 | r_zcl_4
(assert (or (not r_p5) (not r_p3) r_zcl_4))


;%~r_f16 | r_zcl_4
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_zcl_4))


;%~r_p5 | ~r_p3 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p5) (not r_p3) r_f16_p))
...
;%~r_zcl_5 | r_f16
(assert (or (not r_zcl_5) r_f16))


;%~r_p4 | ~r_f16 | r_zcl_5
(assert (or (not r_p4) (not r_f16) r_zcl_5))
...
;%~r_p4 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p4) (not r_f16_p) r_f15_p))
...
;%~r_p2 | ~r_p0 | r_zcl_6
(assert (or (not r_p2) (not r_p0) r_zcl_6))
...
(assert (or (not r_p2) (not r_p0) r_f18_p))
...
;%~r_p1 | ~r_f18 | r_zcl_7
(assert (or (not r_p1) (not r_f18) r_zcl_7))
...
(assert (or (not r_f14) r_f15 r_f17))
...
;%~r_f17_p | r_f14_p
(assert (or (not r_f17_p) r_f14_p))


;%~r_zcl_8 | r_f12
(declare-fun r_zcl_8 () Bool)
(assert (or (not r_zcl_8) r_f12))
...
;%~r_f12 | ~r_f14 | r_zcl_8
(assert (or (not r_f12) (not r_f14) r_zcl_8))


;%~r_f11 | r_zcl_8
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_8))
...
;%~r_f6 | ~r_f8 | r_zcl_9
(assert (or (not r_f6) (not r_f8) r_zcl_9))


;%~r_f5 | r_zcl_9
(declare-fun r_f5 () Bool)
(assert (or (not r_f5) r_zcl_9))
...
;%~r_zcl_10 | r_f2
(assert (or (not r_zcl_10) r_f2))


;%~r_f0 | ~r_f2 | r_zcl_10
(assert (or (not r_f0) (not r_f2) r_zcl_10))
