...
;%~f1 | p13 | f2
(assert (or (not l_f1) l_p13 l_f2))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p13 | f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p13 | f1_p
(assert (or (not l_p13) l_f1_p))
...
;%~p9 | ~p10 | zcl_0
(assert (or (not l_p9) (not l_p10) l_zcl_0))
...
;%~p9 | ~p10 | f6_p
(assert (or (not l_p9) (not l_p10) l_f6_p))
...
;%~p8 | ~f6 | zcl_1
(assert (or (not l_p8) (not l_f6) l_zcl_1))
...
;%~p8 | ~f6_p | f5_p
(assert (or (not l_p8) (not l_f6_p) l_f5_p))
...
;%~p11 | ~f5 | zcl_2
(assert (or (not l_p11) (not l_f5) l_zcl_2))
...
;%~p11 | ~f5_p | f4_p
(assert (or (not l_p11) (not l_f5_p) l_f4_p))
...
;%~p0 | ~p7 | zcl_3
(assert (or (not l_p0) (not l_p7) l_zcl_3))
...
;%~zcl_5 | p4
(assert (or (not l_zcl_5) l_p4))

;%~zcl_5 | f13
(assert (or (not l_zcl_5) l_f13))

;%~p4 | ~f13 | zcl_5
(assert (or (not l_p4) (not l_f13) l_zcl_5))
...
;%~p4 | ~f13_p | f12_p
(assert (or (not l_p4) (not l_f13_p) l_f12_p))
...
;%~p0 | ~p4 | zcl_6
(assert (or (not l_p0) (not l_p4) l_zcl_6))
...
;%~p0 | ~p4 | f22_p
(assert (or (not l_p0) (not l_p4) l_f22_p))
...
;%~p5 | ~f22 | zcl_7
(assert (or (not l_p5) (not l_f22) l_zcl_7))
...
;%~p5 | ~f22_p | f21_p
(assert (or (not l_p5) (not l_f22_p) l_f21_p))
...
;%~p0 | ~f21 | zcl_8
(assert (or (not l_p0) (not l_f21) l_zcl_8))
...
(assert (or (not r_f2) r_p4 r_p12))


;%~r_p4 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p4) r_f2_p))
...
(assert (or (not r_f1) r_p13 r_f2))


;%~r_p13 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p13) r_f1_p))
...
;%~r_p9 | ~r_p10 | r_zcl_0
(assert (or (not r_p9) (not r_p10) r_zcl_0))
...
(assert (or (not r_p9) (not r_p10) r_f6_p))
...
;%~r_p8 | ~r_f6 | r_zcl_1
(assert (or (not r_p8) (not r_f6) r_zcl_1))
...
(assert (or (not r_p8) (not r_f6_p) r_f5_p))
...
;%~r_p11 | ~r_f5 | r_zcl_2
(assert (or (not r_p11) (not r_f5) r_zcl_2))
...
(assert (or (not r_p11) (not r_f5_p) r_f4_p))


;%~r_f10 | r_p9 | r_p8
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p9 r_p8))


;%~r_p9 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p9) r_f10_p))
...
;%~r_p0 | ~r_p7 | r_zcl_3
(assert (or (not r_p0) (not r_p7) r_zcl_3))
...
;%~r_p4 | ~r_f13 | r_zcl_5
(assert (or (not r_p4) (not r_f13) r_zcl_5))
...
;%~r_p4 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p4) (not r_f13_p) r_f12_p))


;%~r_f18 | r_p0 | r_p6
(declare-fun r_f18 () Bool)
(assert (or (not r_f18) r_p0 r_p6))
...
;%~r_p0 | ~r_p4 | r_zcl_6
(assert (or (not r_p0) (not r_p4) r_zcl_6))
...
(assert (or (not r_p0) (not r_p4) r_f22_p))
...
;%~r_p5 | ~r_f22 | r_zcl_7
(assert (or (not r_p5) (not r_f22) r_zcl_7))
...
;%~r_p5 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p5) (not r_f22_p) r_f21_p))
...
;%~r_p0 | ~r_f21 | r_zcl_8
(assert (or (not r_p0) (not r_f21) r_zcl_8))
