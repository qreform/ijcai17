;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p6 | p9) & ((p8 & p7) | ((p0 | p6) & ((p5 & p4) | ((p2 | p3) & ((p0 & p2) | (p1 & p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p8 | ~p7 | f2_p
(assert (or (not l_p8) (not l_p7) l_f2_p))
...
(assert (or (not r_p8) (not r_p7) r_f2_p))


;%~r_f4 | r_p0 | r_p6
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_p0 r_p6))
