...
;%~p3 | ~p9 | f1_p
(assert (or (not l_p3) (not l_p9) l_f1_p))
...
;%~p6 | ~f1 | zcl_1
(assert (or (not l_p6) (not l_f1) l_zcl_1))
...
;%~p6 | ~p7 | zcl_2
(assert (or (not l_p6) (not l_p7) l_zcl_2))
...
;%~p6 | ~p7 | f7_p
(assert (or (not l_p6) (not l_p7) l_f7_p))
...
;%~p0 | ~f7 | zcl_3
(assert (or (not l_p0) (not l_f7) l_zcl_3))
...
;%~p0 | ~p3 | f13_p
(assert (or (not l_p0) (not l_p3) l_f13_p))
...
(assert (or (not r_p3) (not r_p9) r_f1_p))
...
;%~r_p6 | ~r_f1 | r_zcl_1
(assert (or (not r_p6) (not r_f1) r_zcl_1))
...
;%~r_p6 | ~r_p7 | r_zcl_2
(assert (or (not r_p6) (not r_p7) r_zcl_2))
...
(assert (or (not r_p6) (not r_p7) r_f7_p))
...
;%~r_p0 | ~r_f7 | r_zcl_3
(assert (or (not r_p0) (not r_f7) r_zcl_3))
...
(assert (or (not r_p0) (not r_p3) r_f13_p))
