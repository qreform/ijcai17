...
;%~p0 | ~p13 | zcl_0
(assert (or (not l_p0) (not l_p13) l_zcl_0))
...
;%~p0 | ~p13 | f3_p
(assert (or (not l_p0) (not l_p13) l_f3_p))
...
;%~p8 | ~f2 | zcl_2
(assert (or (not l_p8) (not l_f2) l_zcl_2))
...
;%~p8 | ~f2_p | f1_p
(assert (or (not l_p8) (not l_f2_p) l_f1_p))
...
;%~p5 | ~p9 | zcl_4
(assert (or (not l_p5) (not l_p9) l_zcl_4))
...
;%~p5 | ~p9 | f13_p
(assert (or (not l_p5) (not l_p9) l_f13_p))
...
;%~p0 | ~f13 | zcl_5
(assert (or (not l_p0) (not l_f13) l_zcl_5))
...
;%~p0 | ~f12 | zcl_6
(assert (or (not l_p0) (not l_f12) l_zcl_6))
...
;%~p10 | ~f11 | zcl_7
(assert (or (not l_p10) (not l_f11) l_zcl_7))
...
;%~p7 | ~p5 | zcl_8
(assert (or (not l_p7) (not l_p5) l_zcl_8))
...
;%~p7 | ~p5 | f23_p
(assert (or (not l_p7) (not l_p5) l_f23_p))
...
;%~p0 | ~f23 | zcl_9
(assert (or (not l_p0) (not l_f23) l_zcl_9))
...
;%~r_p0 | ~r_p13 | r_zcl_0
(assert (or (not r_p0) (not r_p13) r_zcl_0))
...
(assert (or (not r_p0) (not r_p13) r_f3_p))
...
;%~r_p8 | ~r_f2 | r_zcl_2
(assert (or (not r_p8) (not r_f2) r_zcl_2))
...
(assert (or (not r_p8) (not r_f2_p) r_f1_p))
...
;%~r_p5 | ~r_p9 | r_zcl_4
(assert (or (not r_p5) (not r_p9) r_zcl_4))
...
(assert (or (not r_p5) (not r_p9) r_f13_p))
...
;%~r_p0 | ~r_f13 | r_zcl_5
(assert (or (not r_p0) (not r_f13) r_zcl_5))
...
;%~r_p0 | ~r_f12 | r_zcl_6
(assert (or (not r_p0) (not r_f12) r_zcl_6))
...
;%~r_p10 | ~r_f11 | r_zcl_7
(assert (or (not r_p10) (not r_f11) r_zcl_7))
...
;%~r_p7 | ~r_p5 | r_zcl_8
(assert (or (not r_p7) (not r_p5) r_zcl_8))
...
(assert (or (not r_p7) (not r_p5) r_f23_p))
...
;%~r_p0 | ~r_f23 | r_zcl_9
(assert (or (not r_p0) (not r_f23) r_zcl_9))
