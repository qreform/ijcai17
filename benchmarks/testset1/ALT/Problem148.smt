...
;%~p8 | ~p9 | f6_p
(assert (or (not l_p8) (not l_p9) l_f6_p))
...
;%~p10 | ~f6 | zcl_1
(assert (or (not l_p10) (not l_f6) l_zcl_1))
...
;%~p5 | ~p4 | f14_p
(assert (or (not l_p5) (not l_p4) l_f14_p))
...
(assert (or (not r_p8) (not r_p9) r_f6_p))
...
;%~r_p10 | ~r_f6 | r_zcl_1
(assert (or (not r_p10) (not r_f6) r_zcl_1))
...
(assert (or (not r_p5) (not r_p4) r_f14_p))
