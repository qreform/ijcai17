%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p1 & (p9 & (~p10 & (p7 & ~p8))))) | ((~p2 | (~p3 | (~p1 | (~p1 | (~p7 | p6))))) & (~p1 | (~p2 | (p3 | (~p4 | (~p5 | p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom38,axiom,(~f6 | p2 | f7)) .
cnf(l_axiom39,axiom,(~p2 | f6_p)) .
...
cnf(r_axiom11,axiom,(~acc_zcl_12 | acc_p7)) .
cnf(r_axiom12,axiom,(~acc_zcl_12 | acc_p8)) .
cnf(r_axiom13,axiom,(~acc_p7 | ~acc_p8 | acc_zcl_12)) .
cnf(r_axiom14,axiom,(~acc_f4 | acc_zcl_12)) .
cnf(r_axiom15,axiom,(~acc_p7 | ~acc_p8 | acc_f4_p)) .
cnf(r_axiom16,axiom,(~acc_zcl_13 | acc_p10)) .
cnf(r_axiom17,axiom,(~acc_zcl_13 | acc_f4)) .
cnf(r_axiom18,axiom,(~acc_p10 | ~acc_f4 | acc_zcl_13)) .
cnf(r_axiom19,axiom,(~acc_f3 | acc_zcl_13)) .
cnf(r_axiom20,axiom,(~acc_p10 | ~acc_f4_p | acc_f3_p)) .
cnf(r_axiom21,axiom,(~acc_zcl_14 | acc_p9)) .
cnf(r_axiom22,axiom,(~acc_zcl_14 | acc_f3)) .
cnf(r_axiom23,axiom,(~acc_p9 | ~acc_f3 | acc_zcl_14)) .
cnf(r_axiom24,axiom,(~acc_f2 | acc_zcl_14)) .
cnf(r_axiom25,axiom,(~acc_p9 | ~acc_f3_p | acc_f2_p)) .
cnf(r_axiom26,axiom,(~acc_zcl_15 | acc_p1)) .
cnf(r_axiom27,axiom,(~acc_zcl_15 | acc_f2)) .
cnf(r_axiom28,axiom,(~acc_p1 | ~acc_f2 | acc_zcl_15)) .
cnf(r_axiom29,axiom,(~acc_f1 | acc_zcl_15)) .
cnf(r_axiom30,axiom,(~acc_p1 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom31,axiom,(~acc_zcl_16 | acc_p1)) .
cnf(r_axiom32,axiom,(~acc_zcl_16 | acc_f1)) .
cnf(r_axiom33,axiom,(~acc_p1 | ~acc_f1 | acc_zcl_16)) .
cnf(r_axiom34,axiom,(~acc_f0 | acc_zcl_16)) .
cnf(r_axiom35,axiom,(~acc_p1 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom36,axiom,(~acc_f10 | acc_p7 | acc_p6)) .
cnf(r_axiom37,axiom,(~acc_p7 | acc_f10_p)) .
cnf(r_axiom38,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom39,axiom,(~acc_f9 | acc_p1 | acc_f10)) .
cnf(r_axiom40,axiom,(~acc_p1 | acc_f9_p)) .
cnf(r_axiom41,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom42,axiom,(~acc_f8 | acc_p1 | acc_f9)) .
cnf(r_axiom43,axiom,(~acc_p1 | acc_f8_p)) .
cnf(r_axiom44,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom45,axiom,(~acc_f7 | acc_p3 | acc_f8)) .
cnf(r_axiom46,axiom,(~acc_p3 | acc_f7_p)) .
cnf(r_axiom47,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom48,axiom,(~acc_f6 | acc_p2 | acc_f7)) .
cnf(r_axiom49,axiom,(~acc_p2 | acc_f6_p)) .
