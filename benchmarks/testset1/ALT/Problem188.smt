...
;%~p7 | ~p8 | f0_p
(assert (or (not l_p7) (not l_p8) l_f0_p))
...
;%~p6 | ~p5 | zcl_1
(assert (or (not l_p6) (not l_p5) l_zcl_1))
...
;%~p0 | ~p2 | f8_p
(assert (or (not l_p0) (not l_p2) l_f8_p))
...
;%~p1 | ~p0 | f9_p
(assert (or (not l_p1) (not l_p0) l_f9_p))
...
;%~f6 | ~f7 | zcl_4
(assert (or (not l_f6) (not l_f7) l_zcl_4))
...
;%~f2 | ~f3 | zcl_5
(assert (or (not l_f2) (not l_f3) l_zcl_5))
...
(assert (or (not r_p7) (not r_p8) r_f0_p))
...
;%~r_p6 | ~r_p5 | r_zcl_1
(assert (or (not r_p6) (not r_p5) r_zcl_1))
...
(assert (or (not r_p0) (not r_p2) r_f8_p))
...
(assert (or (not r_p1) (not r_p0) r_f9_p))
...
;%~r_f6 | ~r_f7 | r_zcl_4
(assert (or (not r_f6) (not r_f7) r_zcl_4))
...
;%~r_f2 | ~r_f3 | r_zcl_5
(assert (or (not r_f2) (not r_f3) r_zcl_5))
