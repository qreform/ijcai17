...
;%~p13 | ~p10 | zcl_0
(assert (or (not l_p13) (not l_p10) l_zcl_0))
...
;%~p13 | ~p10 | f4_p
(assert (or (not l_p13) (not l_p10) l_f4_p))
...
;%~p8 | ~f2 | zcl_3
(assert (or (not l_p8) (not l_f2) l_zcl_3))
...
;%~r_p13 | ~r_p10 | r_zcl_0
(assert (or (not r_p13) (not r_p10) r_zcl_0))
...
(assert (or (not r_p13) (not r_p10) r_f4_p))
...
;%~r_p8 | ~r_f2 | r_zcl_3
(assert (or (not r_p8) (not r_f2) r_zcl_3))
