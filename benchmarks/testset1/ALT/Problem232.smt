...
;%~p0 | ~p15 | f5_p
(assert (or (not l_p0) (not l_p15) l_f5_p))
...
;%~zcl_2 | p16
(assert (or (not l_zcl_2) l_p16))

;%~zcl_2 | f4
(assert (or (not l_zcl_2) l_f4))

;%~p16 | ~f4 | zcl_2
(assert (or (not l_p16) (not l_f4) l_zcl_2))
...
;%~p7 | ~f3 | zcl_3
(assert (or (not l_p7) (not l_f3) l_zcl_3))
...
;%~p0 | ~f2 | zcl_4
(assert (or (not l_p0) (not l_f2) l_zcl_4))
...
;%~f12 | p0 | p12
(assert (or (not l_f12) l_p0 l_p12))
...
;%~p10 | ~f18 | zcl_8
(assert (or (not l_p10) (not l_f18) l_zcl_8))
...
(assert (or (not r_p0) (not r_p15) r_f5_p))
...
;%~r_p16 | ~r_f4 | r_zcl_2
(assert (or (not r_p16) (not r_f4) r_zcl_2))
...
;%~r_p7 | ~r_f3 | r_zcl_3
(assert (or (not r_p7) (not r_f3) r_zcl_3))
...
;%~r_p0 | ~r_f2 | r_zcl_4
(assert (or (not r_p0) (not r_f2) r_zcl_4))
...
(assert (or (not r_f12) r_p0 r_p12))
...
;%~r_p10 | ~r_f18 | r_zcl_8
(assert (or (not r_p10) (not r_f18) r_zcl_8))
