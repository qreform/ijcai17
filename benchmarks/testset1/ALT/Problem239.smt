...
;%~p20 | ~p18 | zcl_0
(assert (or (not l_p20) (not l_p18) l_zcl_0))
...
;%~p20 | ~p18 | f5_p
(assert (or (not l_p20) (not l_p18) l_f5_p))
...
;%~p15 | ~f2 | zcl_4
(assert (or (not l_p15) (not l_f2) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p15 & f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p15 | ~f2_p | f1_p
(assert (or (not l_p15) (not l_f2_p) l_f1_p))
...
;%~p14 | ~f1 | zcl_5
(assert (or (not l_p14) (not l_f1) l_zcl_5))
...
;%~p14 | ~f1_p | f0_p
(assert (or (not l_p14) (not l_f1_p) l_f0_p))
...
;%~f12 | p0 | p14
(assert (or (not l_f12) l_p0 l_p14))
...
;%~p13 | ~p11 | zcl_6
(assert (or (not l_p13) (not l_p11) l_zcl_6))
...
;%~p0 | ~f19 | zcl_7
(assert (or (not l_p0) (not l_f19) l_zcl_7))
...
;%~zcl_8 | p12
(assert (or (not l_zcl_8) l_p12))

;%~zcl_8 | f18
(assert (or (not l_zcl_8) l_f18))

;%~p12 | ~f18 | zcl_8
(assert (or (not l_p12) (not l_f18) l_zcl_8))
...
;%~p10 | ~f16 | zcl_10
(assert (or (not l_p10) (not l_f16) l_zcl_10))
...
;%~p10 | ~f15 | zcl_11
(assert (or (not l_p10) (not l_f15) l_zcl_11))
...
;%~r_p20 | ~r_p18 | r_zcl_0
(assert (or (not r_p20) (not r_p18) r_zcl_0))
...
(assert (or (not r_p20) (not r_p18) r_f5_p))
...
;%~r_p15 | ~r_f2 | r_zcl_4
(assert (or (not r_p15) (not r_f2) r_zcl_4))
...
(assert (or (not r_p15) (not r_f2_p) r_f1_p))
...
;%~r_p14 | ~r_f1 | r_zcl_5
(assert (or (not r_p14) (not r_f1) r_zcl_5))
...
(assert (or (not r_p14) (not r_f1_p) r_f0_p))


;%~r_f12 | r_p0 | r_p14
(declare-fun r_f12 () Bool)
(assert (or (not r_f12) r_p0 r_p14))
...
;%~r_p13 | ~r_p11 | r_zcl_6
(assert (or (not r_p13) (not r_p11) r_zcl_6))
...
;%~r_p0 | ~r_f19 | r_zcl_7
(assert (or (not r_p0) (not r_f19) r_zcl_7))
...
;%~r_p12 | ~r_f18 | r_zcl_8
(assert (or (not r_p12) (not r_f18) r_zcl_8))
...
;%~r_p10 | ~r_f16 | r_zcl_10
(assert (or (not r_p10) (not r_f16) r_zcl_10))
...
;%~r_p10 | ~r_f15 | r_zcl_11
(assert (or (not r_p10) (not r_f15) r_zcl_11))
