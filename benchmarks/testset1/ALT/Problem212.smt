...
;%~p11 | ~p16 | zcl_0
(assert (or (not l_p11) (not l_p16) l_zcl_0))
...
;%~p11 | ~p16 | f3_p
(assert (or (not l_p11) (not l_p16) l_f3_p))
...
;%~p18 | ~f3 | zcl_1
(assert (or (not l_p18) (not l_f3) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((p18 & f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p18 | ~f3_p | f2_p
(assert (or (not l_p18) (not l_f3_p) l_f2_p))
...
;%~p5 | ~f2 | zcl_2
(assert (or (not l_p5) (not l_f2) l_zcl_2))
...
;%~p5 | ~f2_p | f1_p
(assert (or (not l_p5) (not l_f2_p) l_f1_p))
...
;%~p17 | ~f1 | zcl_3
(assert (or (not l_p17) (not l_f1) l_zcl_3))
...
;%Non-clausified dependency
;%(forall[]((p17 & f1_p) --> f0_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f0_p () Bool)
;%~p17 | ~f1_p | f0_p
(assert (or (not l_p17) (not l_f1_p) l_f0_p))
...
;%~f8 | p15 | p14
(assert (or (not l_f8) l_p15 l_p14))
...
;%~zcl_4 | p12
(assert (or (not l_zcl_4) l_p12))

;%~p0 | ~p12 | zcl_4
(assert (or (not l_p0) (not l_p12) l_zcl_4))
...
;%~p0 | ~p12 | f13_p
(assert (or (not l_p0) (not l_p12) l_f13_p))
...
;%~p9 | ~f12 | zcl_6
(assert (or (not l_p9) (not l_f12) l_zcl_6))
...
;%~zcl_7 | p13
(assert (or (not l_zcl_7) l_p13))

;%~zcl_7 | f11
(assert (or (not l_zcl_7) l_f11))

;%~p13 | ~f11 | zcl_7
(assert (or (not l_p13) (not l_f11) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p13 & f11_p) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p13 | ~f11_p | f10_p
(assert (or (not l_p13) (not l_f11_p) l_f10_p))
...
;%~f17 | p11 | f18
(assert (or (not l_f17) l_p11 l_f18))
...
;%~p8 | ~p5 | zcl_8
(assert (or (not l_p8) (not l_p5) l_zcl_8))
...
;%~p8 | ~p5 | f23_p
(assert (or (not l_p8) (not l_p5) l_f23_p))
...
;%~p7 | ~f23 | zcl_9
(assert (or (not l_p7) (not l_f23) l_zcl_9))
...
;%~p6 | ~f22 | zcl_10
(assert (or (not l_p6) (not l_f22) l_zcl_10))
...
;%~p0 | ~f21 | zcl_11
(assert (or (not l_p0) (not l_f21) l_zcl_11))
...
;%~r_p11 | ~r_p16 | r_zcl_0
(assert (or (not r_p11) (not r_p16) r_zcl_0))
...
(assert (or (not r_p11) (not r_p16) r_f3_p))
...
;%~r_p18 | ~r_f3 | r_zcl_1
(assert (or (not r_p18) (not r_f3) r_zcl_1))
...
(assert (or (not r_p18) (not r_f3_p) r_f2_p))
...
;%~r_p5 | ~r_f2 | r_zcl_2
(assert (or (not r_p5) (not r_f2) r_zcl_2))
...
(assert (or (not r_p5) (not r_f2_p) r_f1_p))
...
;%~r_p17 | ~r_f1 | r_zcl_3
(assert (or (not r_p17) (not r_f1) r_zcl_3))
...
(assert (or (not r_p17) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p15 | r_p14
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p15 r_p14))
...
;%~r_p14 | r_f8_p
(assert (or (not r_p14) r_f8_p))


;%~r_f7 | r_p9 | r_f8
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_p9 r_f8))
...
;%~r_zcl_4 | r_p12
(assert (or (not r_zcl_4) r_p12))


;%~r_p0 | ~r_p12 | r_zcl_4
(assert (or (not r_p0) (not r_p12) r_zcl_4))
...
(assert (or (not r_p0) (not r_p12) r_f13_p))
...
;%~r_p9 | ~r_f12 | r_zcl_6
(assert (or (not r_p9) (not r_f12) r_zcl_6))
...
;%~r_p13 | ~r_f11 | r_zcl_7
(assert (or (not r_p13) (not r_f11) r_zcl_7))
...
;%~r_p13 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p13) (not r_f11_p) r_f10_p))


;%~r_f18 | r_p0 | r_p9
(declare-fun r_f18 () Bool)
(assert (or (not r_f18) r_p0 r_p9))
...
(assert (or (not r_f17) r_p11 r_f18))
...
;%~r_p8 | ~r_p5 | r_zcl_8
(assert (or (not r_p8) (not r_p5) r_zcl_8))
...
(assert (or (not r_p8) (not r_p5) r_f23_p))
...
;%~r_p7 | ~r_f23 | r_zcl_9
(assert (or (not r_p7) (not r_f23) r_zcl_9))
...
;%~r_p6 | ~r_f22 | r_zcl_10
(assert (or (not r_p6) (not r_f22) r_zcl_10))
...
;%~r_p0 | ~r_f21 | r_zcl_11
(assert (or (not r_p0) (not r_f21) r_zcl_11))
