...
;%~p0 | ~p10 | f5_p
(assert (or (not l_p0) (not l_p10) l_f5_p))
...
;%~p9 | ~f5 | zcl_1
(assert (or (not l_p9) (not l_f5) l_zcl_1))
...
;%~p8 | ~f3 | zcl_3
(assert (or (not l_p8) (not l_f3) l_zcl_3))
...
(assert (or (not r_p0) (not r_p10) r_f5_p))
...
;%~r_p9 | ~r_f5 | r_zcl_1
(assert (or (not r_p9) (not r_f5) r_zcl_1))
...
;%~r_p8 | ~r_f3 | r_zcl_3
(assert (or (not r_p8) (not r_f3) r_zcl_3))
