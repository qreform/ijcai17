...
;%~p10 | ~p12 | f6_p
(assert (or (not l_p10) (not l_p12) l_f6_p))
...
;%~zcl_1 | p14
(assert (or (not l_zcl_1) l_p14))

;%~zcl_1 | f6
(assert (or (not l_zcl_1) l_f6))

;%~p14 | ~f6 | zcl_1
(assert (or (not l_p14) (not l_f6) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((p14 & f6_p) --> f5_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f5_p () Bool)
;%~p14 | ~f6_p | f5_p
(assert (or (not l_p14) (not l_f6_p) l_f5_p))
...
;%~p13 | ~f5 | zcl_2
(assert (or (not l_p13) (not l_f5) l_zcl_2))
...
;%~f10 | p11 | p10
(assert (or (not l_f10) l_p11 l_p10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p11 | p10) --> f10_p))
;%------------------------Clausification start------------------------%
...
;%~p9 | ~p7 | zcl_3
(assert (or (not l_p9) (not l_p7) l_zcl_3))
...
;%~p9 | ~p7 | f14_p
(assert (or (not l_p9) (not l_p7) l_f14_p))
...
;%~p8 | ~f14 | zcl_4
(assert (or (not l_p8) (not l_f14) l_zcl_4))
...
(assert (or (not r_f1) r_p16 r_f2))


;%~r_p16 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p16) r_f1_p))
...
(assert (or (not r_p10) (not r_p12) r_f6_p))


;%~r_zcl_1 | r_p14
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p14))
...
;%~r_p14 | ~r_f6 | r_zcl_1
(assert (or (not r_p14) (not r_f6) r_zcl_1))
...
(assert (or (not r_p14) (not r_f6_p) r_f5_p))
...
;%~r_p13 | ~r_f5 | r_zcl_2
(assert (or (not r_p13) (not r_f5) r_zcl_2))
...
(assert (or (not r_f10) r_p11 r_p10))
...
;%~r_p9 | ~r_p7 | r_zcl_3
(assert (or (not r_p9) (not r_p7) r_zcl_3))
...
(assert (or (not r_p9) (not r_p7) r_f14_p))
...
;%~r_p8 | ~r_f14 | r_zcl_4
(assert (or (not r_p8) (not r_f14) r_zcl_4))
