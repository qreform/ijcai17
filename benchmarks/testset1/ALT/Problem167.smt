...
;%~f3 | p13 | f4
(assert (or (not l_f3) l_p13 l_f4))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p13 | f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
...
;%~p10 | ~p8 | zcl_0
(assert (or (not l_p10) (not l_p8) l_zcl_0))
...
;%~p10 | ~p8 | f10_p
(assert (or (not l_p10) (not l_p8) l_f10_p))
...
;%~zcl_3 | p9
(assert (or (not l_zcl_3) l_p9))

;%~zcl_3 | f8
(assert (or (not l_zcl_3) l_f8))

;%~p9 | ~f8 | zcl_3
(assert (or (not l_p9) (not l_f8) l_zcl_3))
...
;%~p9 | ~f8_p | f7_p
(assert (or (not l_p9) (not l_f8_p) l_f7_p))
...
;%~p0 | ~p6 | f22_p
(assert (or (not l_p0) (not l_p6) l_f22_p))
...
(assert (or (not r_f0) r_p12 r_f1))


;%~r_p12 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p12) r_f0_p))
...
;%~r_p10 | ~r_p8 | r_zcl_0
(assert (or (not r_p10) (not r_p8) r_zcl_0))
...
(assert (or (not r_p10) (not r_p8) r_f10_p))
...
;%~r_p9 | ~r_f8 | r_zcl_3
(assert (or (not r_p9) (not r_f8) r_zcl_3))
...
(assert (or (not r_p9) (not r_f8_p) r_f7_p))
...
(assert (or (not r_p0) (not r_p6) r_f22_p))
