...
;%~p10 | ~p13 | zcl_0
(assert (or (not l_p10) (not l_p13) l_zcl_0))
...
;%~p10 | ~p13 | f3_p
(assert (or (not l_p10) (not l_p13) l_f3_p))
...
;%~p11 | ~f3 | zcl_1
(assert (or (not l_p11) (not l_f3) l_zcl_1))
...
;%~p11 | ~f3_p | f2_p
(assert (or (not l_p11) (not l_f3_p) l_f2_p))
...
;%~zcl_2 | p10
(assert (or (not l_zcl_2) l_p10))

;%~zcl_2 | f2
(assert (or (not l_zcl_2) l_f2))

;%~p10 | ~f2 | zcl_2
(assert (or (not l_p10) (not l_f2) l_zcl_2))
...
;%~p12 | ~f1 | zcl_3
(assert (or (not l_p12) (not l_f1) l_zcl_3))
...
;%~p12 | ~f1_p | f0_p
(assert (or (not l_p12) (not l_f1_p) l_f0_p))
...
;%~f8 | p12 | p10
(assert (or (not l_f8) l_p12 l_p10))
...
;%~f15 | p7 | f16
(assert (or (not l_f15) l_p7 l_f16))
...
;%~r_p10 | ~r_p13 | r_zcl_0
(assert (or (not r_p10) (not r_p13) r_zcl_0))
...
(assert (or (not r_p10) (not r_p13) r_f3_p))
...
;%~r_p11 | ~r_f3 | r_zcl_1
(assert (or (not r_p11) (not r_f3) r_zcl_1))
...
(assert (or (not r_p11) (not r_f3_p) r_f2_p))


;%~r_zcl_2 | r_p10
(declare-fun r_zcl_2 () Bool)
(assert (or (not r_zcl_2) r_p10))
...
;%~r_p10 | ~r_f2 | r_zcl_2
(assert (or (not r_p10) (not r_f2) r_zcl_2))
...
;%~r_p12 | ~r_f1 | r_zcl_3
(assert (or (not r_p12) (not r_f1) r_zcl_3))
...
(assert (or (not r_p12) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p12 | r_p10
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p12 r_p10))
...
(assert (or (not r_f7) r_p11 r_f8))


;%~r_p11 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p11) r_f7_p))
...
(assert (or (not r_f15) r_p7 r_f16))
