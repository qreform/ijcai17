...
;%~f4 | p15 | p14
(assert (or (not l_f4) l_p15 l_p14))
...
;%~p11 | ~p12 | zcl_0
(assert (or (not l_p11) (not l_p12) l_zcl_0))
...
;%Non-clausified dependency
;%(forall[]((p11 & p12) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p11 | ~p12 | f10_p
(assert (or (not l_p11) (not l_p12) l_f10_p))
...
(assert (or (not r_f4) r_p15 r_p14))
...
;%~r_p11 | ~r_p12 | r_zcl_0
(assert (or (not r_p11) (not r_p12) r_zcl_0))
...
(assert (or (not r_p11) (not r_p12) r_f10_p))
