...
cnf(l_axiom1,axiom,(~zcl_4 | p5)) .
cnf(l_axiom2,axiom,(~zcl_4 | p4)) .
cnf(l_axiom3,axiom,(~p5 | ~p4 | zcl_4)) .
cnf(l_axiom4,axiom,(~f0 | zcl_4)) .
cnf(l_axiom5,axiom,(~p5 | ~p4 | f0_p)) .
cnf(l_axiom6,axiom,(~f2 | p3 | p2)) .
...
cnf(r_axiom6,axiom,(~acc_zcl_4 | acc_p5)) .
cnf(r_axiom7,axiom,(~acc_zcl_4 | acc_p4)) .
cnf(r_axiom8,axiom,(~acc_p5 | ~acc_p4 | acc_zcl_4)) .
cnf(r_axiom9,axiom,(~acc_f0 | acc_zcl_4)) .
...
cnf(r_axiom14,axiom,(~acc_f3 | acc_p1 | acc_p0)) .
cnf(r_axiom15,axiom,(~acc_p1 | acc_f3_p)) .
cnf(r_axiom16,axiom,(~acc_p0 | acc_f3_p)) .
cnf(r_axiom17,axiom,(~acc_zcl_5 | acc_f2)) .
cnf(r_axiom18,axiom,(~acc_zcl_5 | acc_f3)) .
cnf(r_axiom19,axiom,(~acc_f2 | ~acc_f3 | acc_zcl_5)) .
cnf(r_axiom20,axiom,(~acc_f1 | acc_zcl_5)) .
cnf(r_axiom21,axiom,(~acc_f2_p | ~acc_f3_p | acc_f1_p)) .
cnf(r_axiom22,axiom,(~acc_q | acc_f0 | acc_f1)) .
cnf(r_axiom23,axiom,(~acc_f0_p | acc_q)) .
cnf(r_axiom24,axiom,(~acc_f1_p | acc_q)) .
