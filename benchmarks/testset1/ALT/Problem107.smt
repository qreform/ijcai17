...
;%~p0 | ~p9 | f4_p
(assert (or (not l_p0) (not l_p9) l_f4_p))
...
;%~p6 | ~f3 | zcl_2
(assert (or (not l_p6) (not l_f3) l_zcl_2))
...
;%~p7 | ~p6 | f16_p
(assert (or (not l_p7) (not l_p6) l_f16_p))
...
(assert (or (not r_p0) (not r_p9) r_f4_p))
...
;%~r_p6 | ~r_f3 | r_zcl_2
(assert (or (not r_p6) (not r_f3) r_zcl_2))
...
(assert (or (not r_p7) (not r_p6) r_f16_p))
