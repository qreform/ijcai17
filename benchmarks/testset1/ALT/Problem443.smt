...
;%~p5 | ~p6 | f2_p
(assert (or (not l_p5) (not l_p6) l_f2_p))
...
;%~p2 | ~p3 | zcl_1
(assert (or (not l_p2) (not l_p3) l_zcl_1))
...
;%~p2 | ~p3 | f6_p
(assert (or (not l_p2) (not l_p3) l_f6_p))
...
(assert (or (not r_p5) (not r_p6) r_f2_p))
...
;%~r_p2 | ~r_p3 | r_zcl_1
(assert (or (not r_p2) (not r_p3) r_zcl_1))
...
(assert (or (not r_p2) (not r_p3) r_f6_p))


;%~r_f8 | r_p1 | r_p2
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p1 r_p2))
