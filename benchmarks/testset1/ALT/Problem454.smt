...
;%~f1 | p17 | p15
(assert (or (not l_f1) l_p17 l_p15))
...
;%~p14 | ~p12 | f4_p
(assert (or (not l_p14) (not l_p12) l_f4_p))
...
;%~p13 | ~f4 | zcl_1
(assert (or (not l_p13) (not l_f4) l_zcl_1))
...
;%~p13 | ~f4_p | f3_p
(assert (or (not l_p13) (not l_f4_p) l_f3_p))
...
;%~p8 | ~p6 | zcl_2
(assert (or (not l_p8) (not l_p6) l_zcl_2))
...
;%~zcl_4 | f12
(assert (or (not l_zcl_4) l_f12))

;%~zcl_4 | f14
(assert (or (not l_zcl_4) l_f14))

;%~f12 | ~f14 | zcl_4
(assert (or (not l_f12) (not l_f14) l_zcl_4))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_4
(assert (or (not l_f11) l_zcl_4))
...
;%~zcl_5 | f6
(assert (or (not l_zcl_5) l_f6))

;%~zcl_5 | f8
(assert (or (not l_zcl_5) l_f8))

;%~f6 | ~f8 | zcl_5
(assert (or (not l_f6) (not l_f8) l_zcl_5))

(declare-fun l_f5 () Bool)
;%~f5 | zcl_5
(assert (or (not l_f5) l_zcl_5))
...
;%~zcl_6 | f2
(assert (or (not l_zcl_6) l_f2))

;%~f0 | ~f2 | zcl_6
(assert (or (not l_f0) (not l_f2) l_zcl_6))
...
(assert (or (not r_f1) r_p17 r_p15))
...
(assert (or (not r_p14) (not r_p12) r_f4_p))
...
;%~r_p13 | ~r_f4 | r_zcl_1
(assert (or (not r_p13) (not r_f4) r_zcl_1))
...
(assert (or (not r_p13) (not r_f4_p) r_f3_p))


;%~r_f7 | r_p11 | r_p9
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_p11 r_p9))
...
;%~r_p8 | ~r_p6 | r_zcl_2
(assert (or (not r_p8) (not r_p6) r_zcl_2))
...
;%~r_f12 | ~r_f14 | r_zcl_4
(assert (or (not r_f12) (not r_f14) r_zcl_4))


;%~r_f11 | r_zcl_4
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_4))
...
;%~r_f6 | ~r_f8 | r_zcl_5
(assert (or (not r_f6) (not r_f8) r_zcl_5))


;%~r_f5 | r_zcl_5
(declare-fun r_f5 () Bool)
(assert (or (not r_f5) r_zcl_5))
...
;%~r_zcl_6 | r_f2
(assert (or (not r_zcl_6) r_f2))


;%~r_f0 | ~r_f2 | r_zcl_6
(assert (or (not r_f0) (not r_f2) r_zcl_6))
