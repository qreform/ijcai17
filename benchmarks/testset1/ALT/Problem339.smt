...
;%~p10 | ~f4 | zcl_1
(assert (or (not l_p10) (not l_f4) l_zcl_1))
...
;%~p10 | ~f4_p | f3_p
(assert (or (not l_p10) (not l_f4_p) l_f3_p))
...
;%~p9 | ~f3 | zcl_2
(assert (or (not l_p9) (not l_f3) l_zcl_2))
...
;%~r_p10 | ~r_f4 | r_zcl_1
(assert (or (not r_p10) (not r_f4) r_zcl_1))
...
(assert (or (not r_p10) (not r_f4_p) r_f3_p))
...
;%~r_p9 | ~r_f3 | r_zcl_2
(assert (or (not r_p9) (not r_f3) r_zcl_2))
