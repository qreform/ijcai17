...
;%~p18 | ~p17 | zcl_0
(assert (or (not l_p18) (not l_p17) l_zcl_0))
...
;%~p18 | ~p17 | f4_p
(assert (or (not l_p18) (not l_p17) l_f4_p))
...
;%~p0 | ~f3 | zcl_2
(assert (or (not l_p0) (not l_f3) l_zcl_2))
...
;%~p9 | ~f2 | zcl_3
(assert (or (not l_p9) (not l_f2) l_zcl_3))
...
;%~p8 | ~f1 | zcl_4
(assert (or (not l_p8) (not l_f1) l_zcl_4))
...
;%~f10 | p0 | p15
(assert (or (not l_f10) l_p0 l_p15))
...
;%~p14 | ~f16 | zcl_6
(assert (or (not l_p14) (not l_f16) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p14 & f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p14 | ~f16_p | f15_p
(assert (or (not l_p14) (not l_f16_p) l_f15_p))
...
;%~p13 | ~f14 | zcl_8
(assert (or (not l_p13) (not l_f14) l_zcl_8))
...
;%Non-clausified dependency
;%(forall[]((p13 & f14_p) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p13 | ~f14_p | f13_p
(assert (or (not l_p13) (not l_f14_p) l_f13_p))
...
;%~p12 | ~f13 | zcl_9
(assert (or (not l_p12) (not l_f13) l_zcl_9))
...
;%Non-clausified dependency
;%(forall[]((p12 & f13_p) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p12 | ~f13_p | f12_p
(assert (or (not l_p12) (not l_f13_p) l_f12_p))
...
;%~f22 | p10 | p8
(assert (or (not l_f22) l_p10 l_p8))
...
;%~f21 | p6 | f22
(assert (or (not l_f21) l_p6 l_f22))
...
;%~f19 | p0 | f20
(assert (or (not l_f19) l_p0 l_f20))
...
;%~p7 | ~f28 | zcl_11
(assert (or (not l_p7) (not l_f28) l_zcl_11))
...
;%~r_p18 | ~r_p17 | r_zcl_0
(assert (or (not r_p18) (not r_p17) r_zcl_0))
...
(assert (or (not r_p18) (not r_p17) r_f4_p))
...
;%~r_p0 | ~r_f3 | r_zcl_2
(assert (or (not r_p0) (not r_f3) r_zcl_2))
...
;%~r_p9 | ~r_f2 | r_zcl_3
(assert (or (not r_p9) (not r_f2) r_zcl_3))
...
;%~r_p8 | ~r_f1 | r_zcl_4
(assert (or (not r_p8) (not r_f1) r_zcl_4))
...
(assert (or (not r_f10) r_p0 r_p15))
...
;%~r_p14 | ~r_f16 | r_zcl_6
(assert (or (not r_p14) (not r_f16) r_zcl_6))
...
;%~r_p14 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p14) (not r_f16_p) r_f15_p))
...
;%~r_p13 | ~r_f14 | r_zcl_8
(assert (or (not r_p13) (not r_f14) r_zcl_8))
...
;%~r_p13 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p13) (not r_f14_p) r_f13_p))
...
;%~r_p12 | ~r_f13 | r_zcl_9
(assert (or (not r_p12) (not r_f13) r_zcl_9))
...
;%~r_p12 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p12) (not r_f13_p) r_f12_p))


;%~r_f22 | r_p10 | r_p8
(declare-fun r_f22 () Bool)
(assert (or (not r_f22) r_p10 r_p8))
...
(assert (or (not r_f21) r_p6 r_f22))
...
(assert (or (not r_f19) r_p0 r_f20))
...
;%~r_p7 | ~r_f28 | r_zcl_11
(assert (or (not r_p7) (not r_f28) r_zcl_11))
