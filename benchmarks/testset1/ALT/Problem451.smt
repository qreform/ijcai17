;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p2 | (p3 | p9)) & ((p6 & (p4 & p8)) | ((p1 | (p7 | p6)) & ((p0 & (p5 & p4)) | ((p1 | (p1 | p3)) & (p1 | (p2 | p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p8 | f4_p
(assert (or (not l_p4) (not l_p8) l_f4_p))
...
(assert (or (not r_p4) (not r_p8) r_f4_p))
