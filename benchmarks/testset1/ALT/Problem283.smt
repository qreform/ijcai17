...
;%~f4 | p20 | p18
(assert (or (not l_f4) l_p20 l_p18))
...
;%~p14 | ~p15 | zcl_0
(assert (or (not l_p14) (not l_p15) l_zcl_0))
...
;%Non-clausified dependency
;%(forall[]((p14 & p15) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p14 | ~p15 | f10_p
(assert (or (not l_p14) (not l_p15) l_f10_p))
...
;%~zcl_2 | p17
(assert (or (not l_zcl_2) l_p17))

;%~zcl_2 | f9
(assert (or (not l_zcl_2) l_f9))

;%~p17 | ~f9 | zcl_2
(assert (or (not l_p17) (not l_f9) l_zcl_2))
...
;%~p17 | ~f9_p | f8_p
(assert (or (not l_p17) (not l_f9_p) l_f8_p))
...
;%~zcl_4 | p16
(assert (or (not l_zcl_4) l_p16))

;%~zcl_4 | f7
(assert (or (not l_zcl_4) l_f7))

;%~p16 | ~f7 | zcl_4
(assert (or (not l_p16) (not l_f7) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p16 & f7_p) --> f6_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f6_p () Bool)
;%~p16 | ~f7_p | f6_p
(assert (or (not l_p16) (not l_f7_p) l_f6_p))
...
;%~f16 | p0 | p13
(assert (or (not l_f16) l_p0 l_p13))
...
;%~f12 | p10 | f13
(assert (or (not l_f12) l_p10 l_f13))
...
;%~p0 | ~p11 | zcl_5
(assert (or (not l_p0) (not l_p11) l_zcl_5))
...
;%~p6 | ~f21 | zcl_7
(assert (or (not l_p6) (not l_f21) l_zcl_7))
...
(assert (or (not r_f4) r_p20 r_p18))
...
(assert (or (not r_f2) r_p8 r_f3))


;%~r_p8 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p8) r_f2_p))
...
(assert (or (not r_f0) r_p19 r_f1))


;%~r_p19 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p19) r_f0_p))
...
;%~r_p14 | ~r_p15 | r_zcl_0
(assert (or (not r_p14) (not r_p15) r_zcl_0))
...
(assert (or (not r_p14) (not r_p15) r_f10_p))
...
;%~r_p17 | ~r_f9 | r_zcl_2
(assert (or (not r_p17) (not r_f9) r_zcl_2))
...
(assert (or (not r_p17) (not r_f9_p) r_f8_p))
...
;%~r_p16 | ~r_f7 | r_zcl_4
(assert (or (not r_p16) (not r_f7) r_zcl_4))
...
(assert (or (not r_p16) (not r_f7_p) r_f6_p))


;%~r_f16 | r_p0 | r_p13
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_p0 r_p13))
...
(assert (or (not r_f12) r_p10 r_f13))


;%~r_p10 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p10) r_f12_p))
...
;%~r_p0 | ~r_p11 | r_zcl_5
(assert (or (not r_p0) (not r_p11) r_zcl_5))
...
;%~r_p6 | ~r_f21 | r_zcl_7
(assert (or (not r_p6) (not r_f21) r_zcl_7))
