...
;%~p9 | ~p7 | zcl_0
(assert (or (not l_p9) (not l_p7) l_zcl_0))
...
;%~p9 | ~p7 | f2_p
(assert (or (not l_p9) (not l_p7) l_f2_p))
...
;%~r_p9 | ~r_p7 | r_zcl_0
(assert (or (not r_p9) (not r_p7) r_zcl_0))
...
(assert (or (not r_p9) (not r_p7) r_f2_p))
