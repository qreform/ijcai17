...
;%~f3 | p24 | p20
(assert (or (not l_f3) l_p24 l_p20))
...
;%~p24 | f3_p
(assert (or (not l_p24) l_f3_p))

;%~p20 | f3_p
(assert (or (not l_p20) l_f3_p))
...
;%~p19 | ~p15 | f8_p
(assert (or (not l_p19) (not l_p15) l_f8_p))
...
;%~p18 | ~f8 | zcl_1
(assert (or (not l_p18) (not l_f8) l_zcl_1))
...
;%~p17 | ~f7 | zcl_2
(assert (or (not l_p17) (not l_f7) l_zcl_2))
...
;%~p17 | ~f7_p | f6_p
(assert (or (not l_p17) (not l_f7_p) l_f6_p))
...
;%~p9 | ~p5 | f18_p
(assert (or (not l_p9) (not l_p5) l_f18_p))
...
;%~p7 | ~f17 | zcl_6
(assert (or (not l_p7) (not l_f17) l_zcl_6))
...
(assert (or (not r_f3) r_p24 r_p20))


;%~r_p24 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p24) r_f3_p))


;%~r_p20 | r_f3_p
(assert (or (not r_p20) r_f3_p))


;%~r_f2 | r_p23 | r_f3
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p23 r_f3))
...
(assert (or (not r_p19) (not r_p15) r_f8_p))
...
;%~r_p18 | ~r_f8 | r_zcl_1
(assert (or (not r_p18) (not r_f8) r_zcl_1))
...
;%~r_p17 | ~r_f7 | r_zcl_2
(assert (or (not r_p17) (not r_f7) r_zcl_2))
...
(assert (or (not r_p17) (not r_f7_p) r_f6_p))
...
(assert (or (not r_p9) (not r_p5) r_f18_p))
...
;%~r_p7 | ~r_f17 | r_zcl_6
(assert (or (not r_p7) (not r_f17) r_zcl_6))
