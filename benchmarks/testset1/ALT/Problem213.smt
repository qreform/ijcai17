...
;%~p16 | ~p15 | zcl_0
(assert (or (not l_p16) (not l_p15) l_zcl_0))
...
;%~p16 | ~p15 | f3_p
(assert (or (not l_p16) (not l_p15) l_f3_p))
...
;%~p0 | ~f3 | zcl_1
(assert (or (not l_p0) (not l_f3) l_zcl_1))
...
;%~p9 | ~f2 | zcl_2
(assert (or (not l_p9) (not l_f2) l_zcl_2))
...
;%~p9 | ~f2_p | f1_p
(assert (or (not l_p9) (not l_f2_p) l_f1_p))
...
;%~p0 | ~f1 | zcl_3
(assert (or (not l_p0) (not l_f1) l_zcl_3))
...
;%~p8 | f8_p
(assert (or (not l_p8) l_f8_p))

;%~p12 | f8_p
(assert (or (not l_p12) l_f8_p))
...
;%~f7 | p10 | f8
(assert (or (not l_f7) l_p10 l_f8))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p10 | f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p10 | f7_p
(assert (or (not l_p10) l_f7_p))
...
;%~p0 | ~p10 | zcl_4
(assert (or (not l_p0) (not l_p10) l_zcl_4))
...
;%~p0 | ~p10 | f13_p
(assert (or (not l_p0) (not l_p10) l_f13_p))
...
;%~p11 | ~f13 | zcl_5
(assert (or (not l_p11) (not l_f13) l_zcl_5))
...
;%~p0 | ~f11 | zcl_7
(assert (or (not l_p0) (not l_f11) l_zcl_7))
...
;%~f17 | p0 | f18
(assert (or (not l_f17) l_p0 l_f18))
...
;%~f16 | p9 | f17
(assert (or (not l_f16) l_p9 l_f17))
...
;%~f15 | p8 | f16
(assert (or (not l_f15) l_p8 l_f16))
...
;%~p0 | ~p5 | f23_p
(assert (or (not l_p0) (not l_p5) l_f23_p))
...
;%~p6 | ~f23 | zcl_9
(assert (or (not l_p6) (not l_f23) l_zcl_9))
...
;%Non-clausified dependency
;%(forall[]((p6 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p6 | ~f23_p | f22_p
(assert (or (not l_p6) (not l_f23_p) l_f22_p))
...
;%~p0 | ~f22 | zcl_10
(assert (or (not l_p0) (not l_f22) l_zcl_10))
...
;%~r_p16 | ~r_p15 | r_zcl_0
(assert (or (not r_p16) (not r_p15) r_zcl_0))
...
(assert (or (not r_p16) (not r_p15) r_f3_p))
...
;%~r_p0 | ~r_f3 | r_zcl_1
(assert (or (not r_p0) (not r_f3) r_zcl_1))
...
;%~r_p9 | ~r_f2 | r_zcl_2
(assert (or (not r_p9) (not r_f2) r_zcl_2))
...
(assert (or (not r_p9) (not r_f2_p) r_f1_p))
...
;%~r_p0 | ~r_f1 | r_zcl_3
(assert (or (not r_p0) (not r_f1) r_zcl_3))
...
(assert (or (not r_f8) r_p8 r_p12))


;%~r_p8 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p8) r_f8_p))


;%~r_p12 | r_f8_p
(assert (or (not r_p12) r_f8_p))


;%~r_f7 | r_p10 | r_f8
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_p10 r_f8))


;%~r_p10 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p10) r_f7_p))
...
(assert (or (not r_f6) r_p14 r_f7))


;%~r_p14 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p14) r_f6_p))
...
(assert (or (not r_f5) r_p13 r_f6))


;%~r_p13 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p13) r_f5_p))
...
;%~r_p0 | ~r_p10 | r_zcl_4
(assert (or (not r_p0) (not r_p10) r_zcl_4))
...
(assert (or (not r_p0) (not r_p10) r_f13_p))
...
;%~r_p11 | ~r_f13 | r_zcl_5
(assert (or (not r_p11) (not r_f13) r_zcl_5))
...
;%~r_p0 | ~r_f11 | r_zcl_7
(assert (or (not r_p0) (not r_f11) r_zcl_7))
...
;%~r_p7 | r_f18_p
(assert (or (not r_p7) r_f18_p))


;%~r_f17 | r_p0 | r_f18
(declare-fun r_f17 () Bool)
(assert (or (not r_f17) r_p0 r_f18))


;%~r_p0 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p0) r_f17_p))
...
(assert (or (not r_f16) r_p9 r_f17))
...
(assert (or (not r_f15) r_p8 r_f16))


;%~r_p8 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p8) r_f15_p))
...
(assert (or (not r_p0) (not r_p5) r_f23_p))
...
;%~r_p6 | ~r_f23 | r_zcl_9
(assert (or (not r_p6) (not r_f23) r_zcl_9))
...
;%~r_p6 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p6) (not r_f23_p) r_f22_p))
...
;%~r_p0 | ~r_f22 | r_zcl_10
(assert (or (not r_p0) (not r_f22) r_zcl_10))
