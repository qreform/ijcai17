...
;%~p2 | ~p6 | zcl_0
(assert (or (not l_p2) (not l_p6) l_zcl_0))
...
;%~p2 | ~p6 | f2_p
(assert (or (not l_p2) (not l_p6) l_f2_p))
...
;%~p0 | ~p4 | zcl_1
(assert (or (not l_p0) (not l_p4) l_zcl_1))
...
;%~r_p2 | ~r_p6 | r_zcl_0
(assert (or (not r_p2) (not r_p6) r_zcl_0))
...
(assert (or (not r_p2) (not r_p6) r_f2_p))
...
;%~r_p0 | ~r_p4 | r_zcl_1
(assert (or (not r_p0) (not r_p4) r_zcl_1))
