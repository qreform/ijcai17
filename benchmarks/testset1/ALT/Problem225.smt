...
;%~p35 | ~p30 | f4_p
(assert (or (not l_p35) (not l_p30) l_f4_p))
...
;%~p34 | ~f4 | zcl_1
(assert (or (not l_p34) (not l_f4) l_zcl_1))
...
;%Non-clausified dependency
;%(forall[]((p34 & f4_p) --> f3_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f3_p () Bool)
;%~p34 | ~f4_p | f3_p
(assert (or (not l_p34) (not l_f4_p) l_f3_p))
...
;%~p33 | ~f3 | zcl_2
(assert (or (not l_p33) (not l_f3) l_zcl_2))
...
;%~p33 | ~f3_p | f2_p
(assert (or (not l_p33) (not l_f3_p) l_f2_p))
...
;%~p32 | ~f2 | zcl_3
(assert (or (not l_p32) (not l_f2) l_zcl_3))
...
;%~p32 | ~f2_p | f1_p
(assert (or (not l_p32) (not l_f2_p) l_f1_p))
...
;%~p31 | ~f1 | zcl_4
(assert (or (not l_p31) (not l_f1) l_zcl_4))
...
;%~p31 | ~f1_p | f0_p
(assert (or (not l_p31) (not l_f1_p) l_f0_p))
...
;%~f10 | p29 | p24
(assert (or (not l_f10) l_p29 l_p24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p29 | ~p24) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p29 | f10_p
(assert (or (not l_p29) l_f10_p))

;%~p24 | f10_p
(assert (or (not l_p24) l_f10_p))
...
;%~f9 | p28 | f10
(assert (or (not l_f9) l_p28 l_f10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p28 | f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p28 | f9_p
(assert (or (not l_p28) l_f9_p))
...
;%~f8 | p27 | f9
(assert (or (not l_f8) l_p27 l_f9))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p27 | f9_p) --> f8_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f8_p () Bool)
;%~p27 | f8_p
(assert (or (not l_p27) l_f8_p))
...
;%~f7 | p26 | f8
(assert (or (not l_f7) l_p26 l_f8))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p26 | f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p26 | f7_p
(assert (or (not l_p26) l_f7_p))
...
;%~f6 | p25 | f7
(assert (or (not l_f6) l_p25 l_f7))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p25 | f7_p) --> f6_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f6_p () Bool)
;%~p25 | f6_p
(assert (or (not l_p25) l_f6_p))
...
;%Non-clausified dependency
;%(forall[]((~p23 & p18) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p23 | ~p18 | f16_p
(assert (or (not l_p23) (not l_p18) l_f16_p))
...
;%~p22 | ~f16 | zcl_6
(assert (or (not l_p22) (not l_f16) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p22 & f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p22 | ~f16_p | f15_p
(assert (or (not l_p22) (not l_f16_p) l_f15_p))
...
;%~p21 | ~f15 | zcl_7
(assert (or (not l_p21) (not l_f15) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p21 & f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p21 | ~f15_p | f14_p
(assert (or (not l_p21) (not l_f15_p) l_f14_p))
...
;%~p20 | ~f14 | zcl_8
(assert (or (not l_p20) (not l_f14) l_zcl_8))
...
;%Non-clausified dependency
;%(forall[]((~p20 & f14_p) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p20 | ~f14_p | f13_p
(assert (or (not l_p20) (not l_f14_p) l_f13_p))
...
;%~p19 | ~f13 | zcl_9
(assert (or (not l_p19) (not l_f13) l_zcl_9))
...
;%Non-clausified dependency
;%(forall[]((~p19 & f13_p) --> f12_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f12_p () Bool)
;%~p19 | ~f13_p | f12_p
(assert (or (not l_p19) (not l_f13_p) l_f12_p))
...
;%~f22 | p17 | p12
(assert (or (not l_f22) l_p17 l_p12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p17 | p12) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p17 | f22_p
(assert (or (not l_p17) l_f22_p))

;%~p12 | f22_p
(assert (or (not l_p12) l_f22_p))
...
;%~f21 | p16 | f22
(assert (or (not l_f21) l_p16 l_f22))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p16 | f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p16 | f21_p
(assert (or (not l_p16) l_f21_p))
...
;%~f20 | p15 | f21
(assert (or (not l_f20) l_p15 l_f21))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p15 | f21_p) --> f20_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f20_p () Bool)
;%~p15 | f20_p
(assert (or (not l_p15) l_f20_p))
...
;%~f19 | p14 | f20
(assert (or (not l_f19) l_p14 l_f20))
...
;%~f18 | p13 | f19
(assert (or (not l_f18) l_p13 l_f19))
...
;%~p11 | ~p6 | f28_p
(assert (or (not l_p11) (not l_p6) l_f28_p))
...
;%~p10 | ~f28 | zcl_11
(assert (or (not l_p10) (not l_f28) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((p10 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p10 | ~f28_p | f27_p
(assert (or (not l_p10) (not l_f28_p) l_f27_p))
...
;%~p9 | ~f27 | zcl_12
(assert (or (not l_p9) (not l_f27) l_zcl_12))
...
;%~p9 | ~f27_p | f26_p
(assert (or (not l_p9) (not l_f27_p) l_f26_p))
...
;%~p8 | ~f26 | zcl_13
(assert (or (not l_p8) (not l_f26) l_zcl_13))
...
;%~p7 | ~f25 | zcl_14
(assert (or (not l_p7) (not l_f25) l_zcl_14))
...
(assert (or (not r_p35) (not r_p30) r_f4_p))
...
;%~r_p34 | ~r_f4 | r_zcl_1
(assert (or (not r_p34) (not r_f4) r_zcl_1))
...
(assert (or (not r_p34) (not r_f4_p) r_f3_p))
...
;%~r_p33 | ~r_f3 | r_zcl_2
(assert (or (not r_p33) (not r_f3) r_zcl_2))
...
(assert (or (not r_p33) (not r_f3_p) r_f2_p))
...
;%~r_p32 | ~r_f2 | r_zcl_3
(assert (or (not r_p32) (not r_f2) r_zcl_3))
...
(assert (or (not r_p32) (not r_f2_p) r_f1_p))
...
;%~r_p31 | ~r_f1 | r_zcl_4
(assert (or (not r_p31) (not r_f1) r_zcl_4))
...
(assert (or (not r_p31) (not r_f1_p) r_f0_p))


;%~r_f10 | r_p29 | r_p24
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p29 r_p24))


;%~r_p29 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p29) r_f10_p))


;%~r_p24 | r_f10_p
(assert (or (not r_p24) r_f10_p))


;%~r_f9 | r_p28 | r_f10
(declare-fun r_f9 () Bool)
(assert (or (not r_f9) r_p28 r_f10))


;%~r_p28 | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p28) r_f9_p))
...
(assert (or (not r_f8) r_p27 r_f9))


;%~r_p27 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p27) r_f8_p))
...
(assert (or (not r_f7) r_p26 r_f8))


;%~r_p26 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p26) r_f7_p))
...
(assert (or (not r_f6) r_p25 r_f7))


;%~r_p25 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p25) r_f6_p))
...
(assert (or (not r_p23) (not r_p18) r_f16_p))
...
;%~r_p22 | ~r_f16 | r_zcl_6
(assert (or (not r_p22) (not r_f16) r_zcl_6))
...
;%~r_p22 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p22) (not r_f16_p) r_f15_p))
...
;%~r_p21 | ~r_f15 | r_zcl_7
(assert (or (not r_p21) (not r_f15) r_zcl_7))
...
;%~r_p21 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p21) (not r_f15_p) r_f14_p))
...
;%~r_p20 | ~r_f14 | r_zcl_8
(assert (or (not r_p20) (not r_f14) r_zcl_8))
...
;%~r_p20 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p20) (not r_f14_p) r_f13_p))
...
;%~r_p19 | ~r_f13 | r_zcl_9
(assert (or (not r_p19) (not r_f13) r_zcl_9))
...
;%~r_p19 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p19) (not r_f13_p) r_f12_p))


;%~r_f22 | r_p17 | r_p12
(declare-fun r_f22 () Bool)
(assert (or (not r_f22) r_p17 r_p12))


;%~r_p17 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p17) r_f22_p))


;%~r_p12 | r_f22_p
(assert (or (not r_p12) r_f22_p))


;%~r_f21 | r_p16 | r_f22
(declare-fun r_f21 () Bool)
(assert (or (not r_f21) r_p16 r_f22))


;%~r_p16 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p16) r_f21_p))
...
(assert (or (not r_f20) r_p15 r_f21))


;%~r_p15 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p15) r_f20_p))
...
(assert (or (not r_f19) r_p14 r_f20))
...
(assert (or (not r_f18) r_p13 r_f19))


;%~r_p13 | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p13) r_f18_p))
...
(assert (or (not r_p11) (not r_p6) r_f28_p))
...
;%~r_p10 | ~r_f28 | r_zcl_11
(assert (or (not r_p10) (not r_f28) r_zcl_11))
...
;%~r_p10 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p10) (not r_f28_p) r_f27_p))
...
;%~r_p9 | ~r_f27 | r_zcl_12
(assert (or (not r_p9) (not r_f27) r_zcl_12))
...
;%~r_p9 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p9) (not r_f27_p) r_f26_p))
...
;%~r_p8 | ~r_f26 | r_zcl_13
(assert (or (not r_p8) (not r_f26) r_zcl_13))
...
;%~r_p7 | ~r_f25 | r_zcl_14
(assert (or (not r_p7) (not r_f25) r_zcl_14))
