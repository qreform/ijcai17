...
;%~p7 | ~p12 | zcl_0
(assert (or (not l_p7) (not l_p12) l_zcl_0))
...
;%~p7 | ~p12 | f8_p
(assert (or (not l_p7) (not l_p12) l_f8_p))
...
;%~p14 | ~f8 | zcl_1
(assert (or (not l_p14) (not l_f8) l_zcl_1))
...
;%~p14 | ~f8_p | f7_p
(assert (or (not l_p14) (not l_f8_p) l_f7_p))
...
;%~zcl_3 | p13
(assert (or (not l_zcl_3) l_p13))

;%~zcl_3 | f6
(assert (or (not l_zcl_3) l_f6))

;%~p13 | ~f6 | zcl_3
(assert (or (not l_p13) (not l_f6) l_zcl_3))
...
;%~p13 | ~f6_p | f5_p
(assert (or (not l_p13) (not l_f6_p) l_f5_p))
...
;%~f13 | p3 | p10
(assert (or (not l_f13) l_p3 l_p10))
...
;%~p5 | ~p8 | zcl_4
(assert (or (not l_p5) (not l_p8) l_zcl_4))
...
;%~p9 | ~f18 | zcl_5
(assert (or (not l_p9) (not l_f18) l_zcl_5))
...
;%~p2 | ~f17 | zcl_6
(assert (or (not l_p2) (not l_f17) l_zcl_6))
...
;%~p0 | ~f16 | zcl_7
(assert (or (not l_p0) (not l_f16) l_zcl_7))
...
;%~f22 | p4 | f23
(assert (or (not l_f22) l_p4 l_f23))
...
;%~r_p7 | ~r_p12 | r_zcl_0
(assert (or (not r_p7) (not r_p12) r_zcl_0))
...
(assert (or (not r_p7) (not r_p12) r_f8_p))
...
;%~r_p14 | ~r_f8 | r_zcl_1
(assert (or (not r_p14) (not r_f8) r_zcl_1))
...
(assert (or (not r_p14) (not r_f8_p) r_f7_p))
...
;%~r_p13 | ~r_f6 | r_zcl_3
(assert (or (not r_p13) (not r_f6) r_zcl_3))
...
(assert (or (not r_p13) (not r_f6_p) r_f5_p))


;%~r_f13 | r_p3 | r_p10
(declare-fun r_f13 () Bool)
(assert (or (not r_f13) r_p3 r_p10))
...
;%~r_p5 | ~r_p8 | r_zcl_4
(assert (or (not r_p5) (not r_p8) r_zcl_4))
...
;%~r_p9 | ~r_f18 | r_zcl_5
(assert (or (not r_p9) (not r_f18) r_zcl_5))
...
;%~r_p2 | ~r_f17 | r_zcl_6
(assert (or (not r_p2) (not r_f17) r_zcl_6))
...
;%~r_p0 | ~r_f16 | r_zcl_7
(assert (or (not r_p0) (not r_f16) r_zcl_7))
...
(assert (or (not r_f22) r_p4 r_f23))
