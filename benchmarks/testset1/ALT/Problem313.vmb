%%%%%%%%%%%%%%%% Target reformulation: ((p0 & (p7 & (p3 & p6))) | ((p2 | (p1 | (p5 | p4))) & (p1 | (p2 | (p3 | p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_8 | p3)) .
cnf(l_axiom2,axiom,(~zcl_8 | p6)) .
cnf(l_axiom3,axiom,(~p3 | ~p6 | zcl_8)) .
cnf(l_axiom4,axiom,(~f2 | zcl_8)) .
cnf(l_axiom5,axiom,(~p3 | ~p6 | f2_p)) .
...
cnf(r_axiom8,axiom,(~acc_zcl_8 | acc_p3)) .
cnf(r_axiom9,axiom,(~acc_zcl_8 | acc_p6)) .
cnf(r_axiom10,axiom,(~acc_p3 | ~acc_p6 | acc_zcl_8)) .
cnf(r_axiom11,axiom,(~acc_f2 | acc_zcl_8)) .
cnf(r_axiom12,axiom,(~acc_p3 | ~acc_p6 | acc_f2_p)) .
...
cnf(r_axiom18,axiom,(~acc_zcl_10 | acc_p0)) .
cnf(r_axiom19,axiom,(~acc_zcl_10 | acc_f1)) .
cnf(r_axiom20,axiom,(~acc_p0 | ~acc_f1 | acc_zcl_10)) .
...
cnf(r_axiom26,axiom,(~acc_f5 | acc_p1 | acc_f6)) .
cnf(r_axiom27,axiom,(~acc_p1 | acc_f5_p)) .
