%%%%%%%%%%%%%%%% Target reformulation: ((p3 & (p7 & (~p2 & p8))) | ((~p1 | (p7 | (~p4 | ~p6))) & ((~p1 & (p2 & (~p3 & ~p5))) | ((~p3 | (p3 | (~p1 | ~p4))) & (~p1 | (p2 | (~p3 | ~p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p2 | ~p8 | zcl_16)) .
cnf(l_axiom4,axiom,(~f2 | zcl_16)) .
cnf(l_axiom5,axiom,(~p2 | ~p8 | f2_p)) .
...
cnf(l_axiom27,axiom,(~p3 | ~p5 | zcl_19)) .
cnf(l_axiom28,axiom,(~f10 | zcl_19)) .
cnf(l_axiom29,axiom,(~p3 | ~p5 | f10_p)) .
...
cnf(l_axiom46,axiom,(~f12 | p3 | f13)) .
cnf(l_axiom47,axiom,(~p3 | f12_p)) .
...
cnf(r_axiom9,axiom,(~acc_zcl_16 | acc_p2)) .
cnf(r_axiom10,axiom,(~acc_zcl_16 | acc_p8)) .
cnf(r_axiom11,axiom,(~acc_p2 | ~acc_p8 | acc_zcl_16)) .
cnf(r_axiom12,axiom,(~acc_f2 | acc_zcl_16)) .
cnf(r_axiom13,axiom,(~acc_p2 | ~acc_p8 | acc_f2_p)) .
cnf(r_axiom14,axiom,(~acc_zcl_17 | acc_p7)) .
cnf(r_axiom15,axiom,(~acc_zcl_17 | acc_f2)) .
cnf(r_axiom16,axiom,(~acc_p7 | ~acc_f2 | acc_zcl_17)) .
cnf(r_axiom17,axiom,(~acc_f1 | acc_zcl_17)) .
cnf(r_axiom18,axiom,(~acc_p7 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom19,axiom,(~acc_zcl_18 | acc_p3)) .
cnf(r_axiom20,axiom,(~acc_zcl_18 | acc_f1)) .
cnf(r_axiom21,axiom,(~acc_p3 | ~acc_f1 | acc_zcl_18)) .
cnf(r_axiom22,axiom,(~acc_f0 | acc_zcl_18)) .
cnf(r_axiom23,axiom,(~acc_p3 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom24,axiom,(~acc_f6 | acc_p4 | acc_p6)) .
cnf(r_axiom25,axiom,(~acc_p4 | acc_f6_p)) .
cnf(r_axiom26,axiom,(~acc_p6 | acc_f6_p)) .
cnf(r_axiom27,axiom,(~acc_f5 | acc_p7 | acc_f6)) .
cnf(r_axiom28,axiom,(~acc_p7 | acc_f5_p)) .
cnf(r_axiom29,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom30,axiom,(~acc_f4 | acc_p1 | acc_f5)) .
cnf(r_axiom31,axiom,(~acc_p1 | acc_f4_p)) .
cnf(r_axiom32,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom33,axiom,(~acc_zcl_19 | acc_p3)) .
cnf(r_axiom34,axiom,(~acc_zcl_19 | acc_p5)) .
cnf(r_axiom35,axiom,(~acc_p3 | ~acc_p5 | acc_zcl_19)) .
cnf(r_axiom36,axiom,(~acc_f10 | acc_zcl_19)) .
cnf(r_axiom37,axiom,(~acc_p3 | ~acc_p5 | acc_f10_p)) .
