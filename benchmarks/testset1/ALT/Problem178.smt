...
;%~p9 | ~f10 | zcl_3
(assert (or (not l_p9) (not l_f10) l_zcl_3))
...
;%~p10 | ~f9 | zcl_4
(assert (or (not l_p10) (not l_f9) l_zcl_4))
...
;%~f19 | p11 | p9
(assert (or (not l_f19) l_p11 l_p9))
...
;%~p8 | ~f25 | zcl_8
(assert (or (not l_p8) (not l_f25) l_zcl_8))
...
;%~r_p9 | ~r_f10 | r_zcl_3
(assert (or (not r_p9) (not r_f10) r_zcl_3))
...
;%~r_p10 | ~r_f9 | r_zcl_4
(assert (or (not r_p10) (not r_f9) r_zcl_4))
...
(assert (or (not r_f19) r_p11 r_p9))


;%~r_p11 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p11) r_f19_p))
...
;%~r_p8 | ~r_f25 | r_zcl_8
(assert (or (not r_p8) (not r_f25) r_zcl_8))
