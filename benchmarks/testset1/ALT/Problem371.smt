...
;%~f3 | p15 | p12
(assert (or (not l_f3) l_p15 l_p12))
...
;%~p6 | ~p8 | f8_p
(assert (or (not l_p6) (not l_p8) l_f8_p))
...
;%~p10 | ~f7 | zcl_2
(assert (or (not l_p10) (not l_f7) l_zcl_2))
...
(assert (or (not r_f3) r_p15 r_p12))
...
(assert (or (not r_p6) (not r_p8) r_f8_p))
...
;%~r_p10 | ~r_f7 | r_zcl_2
(assert (or (not r_p10) (not r_f7) r_zcl_2))
