...
;%~p13 | ~p14 | zcl_0
(assert (or (not l_p13) (not l_p14) l_zcl_0))
...
;%~p13 | ~p14 | f5_p
(assert (or (not l_p13) (not l_p14) l_f5_p))
...
;%~p15 | ~f3 | zcl_3
(assert (or (not l_p15) (not l_f3) l_zcl_3))
...
;%~zcl_4 | p13
(assert (or (not l_zcl_4) l_p13))

;%~zcl_4 | f2
(assert (or (not l_zcl_4) l_f2))

;%~p13 | ~f2 | zcl_4
(assert (or (not l_p13) (not l_f2) l_zcl_4))
...
;%~p12 | ~f1 | zcl_5
(assert (or (not l_p12) (not l_f1) l_zcl_5))
...
;%~f12 | p0 | p11
(assert (or (not l_f12) l_p0 l_p11))
...
;%~r_p13 | ~r_p14 | r_zcl_0
(assert (or (not r_p13) (not r_p14) r_zcl_0))
...
(assert (or (not r_p13) (not r_p14) r_f5_p))
...
;%~r_p15 | ~r_f3 | r_zcl_3
(assert (or (not r_p15) (not r_f3) r_zcl_3))
...
;%~r_p13 | ~r_f2 | r_zcl_4
(assert (or (not r_p13) (not r_f2) r_zcl_4))
...
;%~r_p12 | ~r_f1 | r_zcl_5
(assert (or (not r_p12) (not r_f1) r_zcl_5))
...
(assert (or (not r_f12) r_p0 r_p11))
