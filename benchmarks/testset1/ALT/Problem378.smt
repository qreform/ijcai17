...
;%~p6 | ~f6 | zcl_3
(assert (or (not l_p6) (not l_f6) l_zcl_3))
...
;%~f11 | p2 | f12
(assert (or (not l_f11) l_p2 l_f12))
...
;%~r_p6 | ~r_f6 | r_zcl_3
(assert (or (not r_p6) (not r_f6) r_zcl_3))
...
(assert (or (not r_f11) r_p2 r_f12))


;%~r_p2 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p2) r_f11_p))
