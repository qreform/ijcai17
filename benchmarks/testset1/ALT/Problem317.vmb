%%%%%%%%%%%%%%%% Target reformulation: ((~p5 & (p5 & (~p7 & ~p6))) | ((~p3 | (~p5 | (~p1 | p4))) & (p1 | (p2 | (~p3 | ~p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom2,axiom,(~zcl_8 | p6)) .
cnf(l_axiom3,axiom,(~p7 | ~p6 | zcl_8)) .
cnf(l_axiom4,axiom,(~f2 | zcl_8)) .
cnf(l_axiom5,axiom,(~p7 | ~p6 | f2_p)) .
cnf(l_axiom6,axiom,(~zcl_9 | p5)) .
cnf(l_axiom7,axiom,(~zcl_9 | f2)) .
cnf(l_axiom8,axiom,(~p5 | ~f2 | zcl_9)) .
cnf(l_axiom9,axiom,(~f1 | zcl_9)) .
cnf(l_axiom10,axiom,(~p5 | ~f2_p | f1_p)) .
cnf(l_axiom11,axiom,(~zcl_10 | p5)) .
cnf(l_axiom12,axiom,(~zcl_10 | f1)) .
cnf(l_axiom13,axiom,(~p5 | ~f1 | zcl_10)) .
cnf(l_axiom14,axiom,(~f0 | zcl_10)) .
cnf(l_axiom15,axiom,(~p5 | ~f1_p | f0_p)) .
cnf(l_axiom16,axiom,(~f6 | p1 | p4)) .
...
cnf(r_axiom9,axiom,(~acc_zcl_8 | acc_p6)) .
cnf(r_axiom10,axiom,(~acc_p7 | ~acc_p6 | acc_zcl_8)) .
cnf(r_axiom11,axiom,(~acc_f2 | acc_zcl_8)) .
cnf(r_axiom12,axiom,(~acc_p7 | ~acc_p6 | acc_f2_p)) .
cnf(r_axiom13,axiom,(~acc_zcl_9 | acc_p5)) .
cnf(r_axiom14,axiom,(~acc_zcl_9 | acc_f2)) .
cnf(r_axiom15,axiom,(~acc_p5 | ~acc_f2 | acc_zcl_9)) .
cnf(r_axiom16,axiom,(~acc_f1 | acc_zcl_9)) .
cnf(r_axiom17,axiom,(~acc_p5 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom18,axiom,(~acc_zcl_10 | acc_p5)) .
cnf(r_axiom19,axiom,(~acc_zcl_10 | acc_f1)) .
cnf(r_axiom20,axiom,(~acc_p5 | ~acc_f1 | acc_zcl_10)) .
cnf(r_axiom21,axiom,(~acc_f0 | acc_zcl_10)) .
cnf(r_axiom22,axiom,(~acc_p5 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom23,axiom,(~acc_f6 | acc_p1 | acc_p4)) .
cnf(r_axiom24,axiom,(~acc_p1 | acc_f6_p)) .
cnf(r_axiom25,axiom,(~acc_p4 | acc_f6_p)) .
cnf(r_axiom26,axiom,(~acc_f5 | acc_p5 | acc_f6)) .
cnf(r_axiom27,axiom,(~acc_p5 | acc_f5_p)) .
cnf(r_axiom28,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom29,axiom,(~acc_f4 | acc_p3 | acc_f5)) .
cnf(r_axiom30,axiom,(~acc_p3 | acc_f4_p)) .
