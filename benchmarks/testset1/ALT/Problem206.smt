...
;%~p23 | ~p20 | f2_p
(assert (or (not l_p23) (not l_p20) l_f2_p))
...
;%~p22 | ~f2 | zcl_1
(assert (or (not l_p22) (not l_f2) l_zcl_1))
...
;%~p22 | ~f2_p | f1_p
(assert (or (not l_p22) (not l_f2_p) l_f1_p))
...
;%~p21 | ~f1 | zcl_2
(assert (or (not l_p21) (not l_f1) l_zcl_2))
...
;%~p21 | ~f1_p | f0_p
(assert (or (not l_p21) (not l_f1_p) l_f0_p))
...
;%~f6 | p19 | p16
(assert (or (not l_f6) l_p19 l_p16))
...
;%~p19 | f6_p
(assert (or (not l_p19) l_f6_p))

;%~p16 | f6_p
(assert (or (not l_p16) l_f6_p))
...
;%~p15 | ~p12 | f10_p
(assert (or (not l_p15) (not l_p12) l_f10_p))
...
;%~zcl_4 | f10
(assert (or (not l_zcl_4) l_f10))

;%~p14 | ~f10 | zcl_4
(assert (or (not l_p14) (not l_f10) l_zcl_4))

(declare-fun l_f9 () Bool)
;%~f9 | zcl_4
(assert (or (not l_f9) l_zcl_4))
...
;%~zcl_5 | f9
(assert (or (not l_zcl_5) l_f9))

;%~p13 | ~f9 | zcl_5
(assert (or (not l_p13) (not l_f9) l_zcl_5))

(declare-fun l_f8 () Bool)
;%~f8 | zcl_5
(assert (or (not l_f8) l_zcl_5))
...
;%~p13 | ~f9_p | f8_p
(assert (or (not l_p13) (not l_f9_p) l_f8_p))
...
;%~f14 | p11 | p8
(assert (or (not l_f14) l_p11 l_p8))
...
;%~f13 | p10 | f14
(assert (or (not l_f13) l_p10 l_f14))
...
;%~p7 | ~p4 | f18_p
(assert (or (not l_p7) (not l_p4) l_f18_p))
...
;%~p6 | ~f18 | zcl_7
(assert (or (not l_p6) (not l_f18) l_zcl_7))
...
;%~p5 | ~f17 | zcl_8
(assert (or (not l_p5) (not l_f17) l_zcl_8))
...
;%~p3 | ~p0 | f21_p
(assert (or (not l_p3) (not l_p0) l_f21_p))
...
;%~zcl_12 | f12
(assert (or (not l_zcl_12) l_f12))

;%~zcl_12 | f15
(assert (or (not l_zcl_12) l_f15))

;%~f12 | ~f15 | zcl_12
(assert (or (not l_f12) (not l_f15) l_zcl_12))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_12
(assert (or (not l_f11) l_zcl_12))
...
;%~zcl_13 | f7
(assert (or (not l_zcl_13) l_f7))

;%~f4 | ~f7 | zcl_13
(assert (or (not l_f4) (not l_f7) l_zcl_13))

(declare-fun l_f3 () Bool)
;%~f3 | zcl_13
(assert (or (not l_f3) l_zcl_13))
...
(assert (or (not r_p23) (not r_p20) r_f2_p))
...
;%~r_p22 | ~r_f2 | r_zcl_1
(assert (or (not r_p22) (not r_f2) r_zcl_1))
...
(assert (or (not r_p22) (not r_f2_p) r_f1_p))
...
;%~r_p21 | ~r_f1 | r_zcl_2
(assert (or (not r_p21) (not r_f1) r_zcl_2))
...
(assert (or (not r_p21) (not r_f1_p) r_f0_p))


;%~r_f6 | r_p19 | r_p16
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_p19 r_p16))


;%~r_p19 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p19) r_f6_p))


;%~r_p16 | r_f6_p
(assert (or (not r_p16) r_f6_p))


;%~r_f5 | r_p18 | r_f6
(declare-fun r_f5 () Bool)
(assert (or (not r_f5) r_p18 r_f6))
...
(assert (or (not r_f10) r_zcl_3))


;%~r_p15 | ~r_p12 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p15) (not r_p12) r_f10_p))
...
;%~r_zcl_4 | r_f10
(assert (or (not r_zcl_4) r_f10))


;%~r_p14 | ~r_f10 | r_zcl_4
(assert (or (not r_p14) (not r_f10) r_zcl_4))


;%~r_f9 | r_zcl_4
(declare-fun r_f9 () Bool)
(assert (or (not r_f9) r_zcl_4))
...
;%~r_zcl_5 | r_f9
(assert (or (not r_zcl_5) r_f9))


;%~r_p13 | ~r_f9 | r_zcl_5
(assert (or (not r_p13) (not r_f9) r_zcl_5))


;%~r_f8 | r_zcl_5
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_zcl_5))


;%~r_p13 | ~r_f9_p | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p13) (not r_f9_p) r_f8_p))


;%~r_f14 | r_p11 | r_p8
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_p11 r_p8))


;%~r_p11 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p11) r_f14_p))
...
(assert (or (not r_f13) r_p10 r_f14))
...
(assert (or (not r_p7) (not r_p4) r_f18_p))
...
;%~r_p6 | ~r_f18 | r_zcl_7
(assert (or (not r_p6) (not r_f18) r_zcl_7))
...
;%~r_p5 | ~r_f17 | r_zcl_8
(assert (or (not r_p5) (not r_f17) r_zcl_8))
...
(assert (or (not r_p3) (not r_p0) r_f21_p))
...
;%~r_f12 | ~r_f15 | r_zcl_12
(assert (or (not r_f12) (not r_f15) r_zcl_12))


;%~r_f11 | r_zcl_12
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_12))
...
;%~r_zcl_13 | r_f7
(assert (or (not r_zcl_13) r_f7))


;%~r_f4 | ~r_f7 | r_zcl_13
(assert (or (not r_f4) (not r_f7) r_zcl_13))


;%~r_f3 | r_zcl_13
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_zcl_13))
