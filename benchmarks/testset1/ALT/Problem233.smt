...
;%~p21 | ~p18 | zcl_0
(assert (or (not l_p21) (not l_p18) l_zcl_0))
...
;%~p21 | ~p18 | f5_p
(assert (or (not l_p21) (not l_p18) l_f5_p))
...
;%~p0 | ~f5 | zcl_1
(assert (or (not l_p0) (not l_f5) l_zcl_1))
...
;%~p20 | ~f3 | zcl_3
(assert (or (not l_p20) (not l_f3) l_zcl_3))
...
;%Non-clausified dependency
;%(forall[]((p20 & f3_p) --> f2_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f2_p () Bool)
;%~p20 | ~f3_p | f2_p
(assert (or (not l_p20) (not l_f3_p) l_f2_p))
...
;%~p19 | ~f2 | zcl_4
(assert (or (not l_p19) (not l_f2) l_zcl_4))
...
;%Non-clausified dependency
;%(forall[]((p19 & f2_p) --> f1_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f1_p () Bool)
;%~p19 | ~f2_p | f1_p
(assert (or (not l_p19) (not l_f2_p) l_f1_p))
...
;%~p11 | ~f1 | zcl_5
(assert (or (not l_p11) (not l_f1) l_zcl_5))
...
;%~p11 | ~f1_p | f0_p
(assert (or (not l_p11) (not l_f1_p) l_f0_p))
...
;%~f12 | p10 | p15
(assert (or (not l_f12) l_p10 l_p15))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p10 | p15) --> f12_p))
;%------------------------Clausification start------------------------%
...
;%~f7 | p16 | f8
(assert (or (not l_f7) l_p16 l_f8))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p16 | f8_p) --> f7_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f7_p () Bool)
;%~p16 | f7_p
(assert (or (not l_p16) l_f7_p))
...
;%~p14 | ~p12 | zcl_6
(assert (or (not l_p14) (not l_p12) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p14 & p12) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p14 | ~p12 | f19_p
(assert (or (not l_p14) (not l_p12) l_f19_p))
...
;%~p13 | ~f18 | zcl_8
(assert (or (not l_p13) (not l_f18) l_zcl_8))
...
;%~p0 | ~f15 | zcl_11
(assert (or (not l_p0) (not l_f15) l_zcl_11))
...
;%~f23 | p10 | f24
(assert (or (not l_f23) l_p10 l_f24))
...
;%~f22 | p7 | f23
(assert (or (not l_f22) l_p7 l_f23))
...
;%~p8 | ~f30 | zcl_16
(assert (or (not l_p8) (not l_f30) l_zcl_16))
...
;%~r_p21 | ~r_p18 | r_zcl_0
(assert (or (not r_p21) (not r_p18) r_zcl_0))
...
(assert (or (not r_p21) (not r_p18) r_f5_p))
...
;%~r_p0 | ~r_f5 | r_zcl_1
(assert (or (not r_p0) (not r_f5) r_zcl_1))
...
;%~r_p20 | ~r_f3 | r_zcl_3
(assert (or (not r_p20) (not r_f3) r_zcl_3))
...
(assert (or (not r_p20) (not r_f3_p) r_f2_p))
...
;%~r_p19 | ~r_f2 | r_zcl_4
(assert (or (not r_p19) (not r_f2) r_zcl_4))
...
(assert (or (not r_p19) (not r_f2_p) r_f1_p))
...
;%~r_p11 | ~r_f1 | r_zcl_5
(assert (or (not r_p11) (not r_f1) r_zcl_5))
...
(assert (or (not r_p11) (not r_f1_p) r_f0_p))


;%~r_f12 | r_p10 | r_p15
(declare-fun r_f12 () Bool)
(assert (or (not r_f12) r_p10 r_p15))
...
(assert (or (not r_f7) r_p16 r_f8))


;%~r_p16 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p16) r_f7_p))
...
;%~r_p14 | ~r_p12 | r_zcl_6
(assert (or (not r_p14) (not r_p12) r_zcl_6))
...
(assert (or (not r_p14) (not r_p12) r_f19_p))
...
;%~r_p13 | ~r_f18 | r_zcl_8
(assert (or (not r_p13) (not r_f18) r_zcl_8))
...
;%~r_p0 | ~r_f15 | r_zcl_11
(assert (or (not r_p0) (not r_f15) r_zcl_11))
...
(assert (or (not r_f23) r_p10 r_f24))
...
(assert (or (not r_f22) r_p7 r_f23))
...
;%~r_p8 | ~r_f30 | r_zcl_16
(assert (or (not r_p8) (not r_f30) r_zcl_16))
