...
;%~p1 | ~p8 | f6_p
(assert (or (not l_p1) (not l_p8) l_f6_p))
...
;%~p3 | ~f6 | zcl_1
(assert (or (not l_p3) (not l_f6) l_zcl_1))
...
;%~p3 | ~f6_p | f5_p
(assert (or (not l_p3) (not l_f6_p) l_f5_p))
...
;%~p6 | ~f5 | zcl_2
(assert (or (not l_p6) (not l_f5) l_zcl_2))
...
;%~p6 | ~f5_p | f4_p
(assert (or (not l_p6) (not l_f5_p) l_f4_p))
...
;%~p2 | ~p6 | f14_p
(assert (or (not l_p2) (not l_p6) l_f14_p))
...
;%~p2 | ~f14 | zcl_4
(assert (or (not l_p2) (not l_f14) l_zcl_4))
...
;%~p2 | ~f14_p | f13_p
(assert (or (not l_p2) (not l_f14_p) l_f13_p))
...
(assert (or (not r_p1) (not r_p8) r_f6_p))
...
;%~r_p3 | ~r_f6 | r_zcl_1
(assert (or (not r_p3) (not r_f6) r_zcl_1))
...
(assert (or (not r_p3) (not r_f6_p) r_f5_p))
...
;%~r_p6 | ~r_f5 | r_zcl_2
(assert (or (not r_p6) (not r_f5) r_zcl_2))
...
(assert (or (not r_p6) (not r_f5_p) r_f4_p))
...
(assert (or (not r_p2) (not r_p6) r_f14_p))
...
;%~r_p2 | ~r_f14 | r_zcl_4
(assert (or (not r_p2) (not r_f14) r_zcl_4))
...
;%~r_p2 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p2) (not r_f14_p) r_f13_p))
