...
;%~p29 | ~p24 | zcl_0
(assert (or (not l_p29) (not l_p24) l_zcl_0))
...
;%~p29 | ~p24 | f4_p
(assert (or (not l_p29) (not l_p24) l_f4_p))
...
;%~p28 | ~f4 | zcl_1
(assert (or (not l_p28) (not l_f4) l_zcl_1))
...
;%~p28 | ~f4_p | f3_p
(assert (or (not l_p28) (not l_f4_p) l_f3_p))
...
;%~p27 | ~f3 | zcl_2
(assert (or (not l_p27) (not l_f3) l_zcl_2))
...
;%~p27 | ~f3_p | f2_p
(assert (or (not l_p27) (not l_f3_p) l_f2_p))
...
;%~p26 | ~f2 | zcl_3
(assert (or (not l_p26) (not l_f2) l_zcl_3))
...
;%~p26 | ~f2_p | f1_p
(assert (or (not l_p26) (not l_f2_p) l_f1_p))
...
;%~zcl_4 | p25
(assert (or (not l_zcl_4) l_p25))

;%~zcl_4 | f1
(assert (or (not l_zcl_4) l_f1))

;%~p25 | ~f1 | zcl_4
(assert (or (not l_p25) (not l_f1) l_zcl_4))
...
;%~p25 | ~f1_p | f0_p
(assert (or (not l_p25) (not l_f1_p) l_f0_p))
...
;%~f10 | p23 | p18
(assert (or (not l_f10) l_p23 l_p18))
...
;%~f9 | p22 | f10
(assert (or (not l_f9) l_p22 l_f10))
...
;%~p17 | ~p12 | zcl_5
(assert (or (not l_p17) (not l_p12) l_zcl_5))
...
;%~zcl_6 | p16
(assert (or (not l_zcl_6) l_p16))

;%~zcl_6 | f16
(assert (or (not l_zcl_6) l_f16))

;%~p16 | ~f16 | zcl_6
(assert (or (not l_p16) (not l_f16) l_zcl_6))
...
;%~p15 | ~f15 | zcl_7
(assert (or (not l_p15) (not l_f15) l_zcl_7))
...
;%~f22 | p11 | p6
(assert (or (not l_f22) l_p11 l_p6))
...
;%~f21 | p10 | f22
(assert (or (not l_f21) l_p10 l_f22))
...
;%~f20 | p9 | f21
(assert (or (not l_f20) l_p9 l_f21))
...
;%~r_p29 | ~r_p24 | r_zcl_0
(assert (or (not r_p29) (not r_p24) r_zcl_0))
...
(assert (or (not r_p29) (not r_p24) r_f4_p))
...
;%~r_p28 | ~r_f4 | r_zcl_1
(assert (or (not r_p28) (not r_f4) r_zcl_1))
...
(assert (or (not r_p28) (not r_f4_p) r_f3_p))
...
;%~r_p27 | ~r_f3 | r_zcl_2
(assert (or (not r_p27) (not r_f3) r_zcl_2))
...
(assert (or (not r_p27) (not r_f3_p) r_f2_p))
...
;%~r_p26 | ~r_f2 | r_zcl_3
(assert (or (not r_p26) (not r_f2) r_zcl_3))
...
(assert (or (not r_p26) (not r_f2_p) r_f1_p))


;%~r_zcl_4 | r_p25
(declare-fun r_zcl_4 () Bool)
(assert (or (not r_zcl_4) r_p25))
...
;%~r_p25 | ~r_f1 | r_zcl_4
(assert (or (not r_p25) (not r_f1) r_zcl_4))
...
(assert (or (not r_p25) (not r_f1_p) r_f0_p))


;%~r_f10 | r_p23 | r_p18
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p23 r_p18))


;%~r_p23 | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p23) r_f10_p))
...
(assert (or (not r_f9) r_p22 r_f10))


;%~r_p22 | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p22) r_f9_p))
...
(assert (or (not r_f8) r_p21 r_f9))


;%~r_p21 | r_f8_p
(declare-fun r_f8_p () Bool)
(assert (or (not r_p21) r_f8_p))
...
(assert (or (not r_f7) r_p20 r_f8))


;%~r_p20 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p20) r_f7_p))
...
;%~r_p17 | ~r_p12 | r_zcl_5
(assert (or (not r_p17) (not r_p12) r_zcl_5))
...
;%~r_p16 | ~r_f16 | r_zcl_6
(assert (or (not r_p16) (not r_f16) r_zcl_6))
...
;%~r_p15 | ~r_f15 | r_zcl_7
(assert (or (not r_p15) (not r_f15) r_zcl_7))
...
(assert (or (not r_f22) r_p11 r_p6))
...
(assert (or (not r_f21) r_p10 r_f22))


;%~r_p10 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p10) r_f21_p))
...
(assert (or (not r_f20) r_p9 r_f21))


;%~r_p9 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p9) r_f20_p))
