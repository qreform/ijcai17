...
;%~p3 | ~p7 | f10_p
(assert (or (not l_p3) (not l_p7) l_f10_p))
...
;%~p1 | ~f9 | zcl_2
(assert (or (not l_p1) (not l_f9) l_zcl_2))
...
;%~p2 | ~f7 | zcl_4
(assert (or (not l_p2) (not l_f7) l_zcl_4))
...
(assert (or (not r_p3) (not r_p7) r_f10_p))
...
;%~r_p1 | ~r_f9 | r_zcl_2
(assert (or (not r_p1) (not r_f9) r_zcl_2))
...
;%~r_p2 | ~r_f7 | r_zcl_4
(assert (or (not r_p2) (not r_f7) r_zcl_4))
