...
;%~p7 | ~p9 | f1_p
(assert (or (not l_p7) (not l_p9) l_f1_p))
...
;%~p7 | ~f1 | zcl_1
(assert (or (not l_p7) (not l_f1) l_zcl_1))
...
;%~p0 | ~p6 | f7_p
(assert (or (not l_p0) (not l_p6) l_f7_p))
...
(assert (or (not r_p7) (not r_p9) r_f1_p))
...
;%~r_p7 | ~r_f1 | r_zcl_1
(assert (or (not r_p7) (not r_f1) r_zcl_1))
...
(assert (or (not r_p0) (not r_p6) r_f7_p))
