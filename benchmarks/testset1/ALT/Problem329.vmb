%%%%%%%%%%%%%%%% Target reformulation: ((~p5 & (~p7 & (~p4 & (~p0 & p6)))) | ((p3 | (p4 | (p2 | (~p4 | ~p5)))) & (~p1 | (~p2 | (~p3 | (~p4 | ~p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom6,axiom,(~zcl_11 | p4)) .
cnf(l_axiom7,axiom,(~zcl_11 | f3)) .
cnf(l_axiom8,axiom,(~p4 | ~f3 | zcl_11)) .
cnf(l_axiom9,axiom,(~f2 | zcl_11)) .
cnf(l_axiom10,axiom,(~p4 | ~f3_p | f2_p)) .
...
cnf(l_axiom21,axiom,(~f8 | p4 | p5)) .
cnf(l_axiom22,axiom,(~p4 | f8_p)) .
...
cnf(r_axiom10,axiom,(~acc_p0 | ~acc_p6 | acc_zcl_10)) .
cnf(r_axiom11,axiom,(~acc_f3 | acc_zcl_10)) .
cnf(r_axiom12,axiom,(~acc_p0 | ~acc_p6 | acc_f3_p)) .
cnf(r_axiom13,axiom,(~acc_zcl_11 | acc_p4)) .
cnf(r_axiom14,axiom,(~acc_zcl_11 | acc_f3)) .
cnf(r_axiom15,axiom,(~acc_p4 | ~acc_f3 | acc_zcl_11)) .
cnf(r_axiom16,axiom,(~acc_f2 | acc_zcl_11)) .
cnf(r_axiom17,axiom,(~acc_p4 | ~acc_f3_p | acc_f2_p)) .
...
cnf(r_axiom28,axiom,(~acc_f8 | acc_p4 | acc_p5)) .
...
cnf(r_axiom34,axiom,(~acc_f6 | acc_p4 | acc_f7)) .
