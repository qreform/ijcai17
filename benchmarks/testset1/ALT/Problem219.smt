...
;%~p5 | ~p13 | zcl_0
(assert (or (not l_p5) (not l_p13) l_zcl_0))
...
;%~p5 | ~p13 | f3_p
(assert (or (not l_p5) (not l_p13) l_f3_p))
...
;%~zcl_1 | p8
(assert (or (not l_zcl_1) l_p8))

;%~zcl_1 | f3
(assert (or (not l_zcl_1) l_f3))

;%~p8 | ~f3 | zcl_1
(assert (or (not l_p8) (not l_f3) l_zcl_1))
...
;%~p8 | ~f3_p | f2_p
(assert (or (not l_p8) (not l_f3_p) l_f2_p))
...
;%~p0 | ~f2 | zcl_2
(assert (or (not l_p0) (not l_f2) l_zcl_2))
...
;%~p0 | ~f2_p | f1_p
(assert (or (not l_p0) (not l_f2_p) l_f1_p))
...
;%~p8 | ~f1 | zcl_3
(assert (or (not l_p8) (not l_f1) l_zcl_3))
...
;%~p8 | ~f1_p | f0_p
(assert (or (not l_p8) (not l_f1_p) l_f0_p))
...
;%~f5 | p12 | f6
(assert (or (not l_f5) l_p12 l_f6))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p12 | f6_p) --> f5_p))
;%------------------------Clausification start------------------------%
...
;%~p0 | ~p9 | zcl_4
(assert (or (not l_p0) (not l_p9) l_zcl_4))
...
;%~p0 | ~p9 | f13_p
(assert (or (not l_p0) (not l_p9) l_f13_p))
...
;%~p10 | ~f12 | zcl_6
(assert (or (not l_p10) (not l_f12) l_zcl_6))
...
;%~f17 | p8 | f18
(assert (or (not l_f17) l_p8 l_f18))
...
;%~f16 | p0 | f17
(assert (or (not l_f16) l_p0 l_f17))
...
;%~r_p5 | ~r_p13 | r_zcl_0
(assert (or (not r_p5) (not r_p13) r_zcl_0))
...
(assert (or (not r_p5) (not r_p13) r_f3_p))


;%~r_zcl_1 | r_p8
(declare-fun r_zcl_1 () Bool)
(assert (or (not r_zcl_1) r_p8))
...
;%~r_p8 | ~r_f3 | r_zcl_1
(assert (or (not r_p8) (not r_f3) r_zcl_1))
...
(assert (or (not r_p8) (not r_f3_p) r_f2_p))
...
;%~r_p0 | ~r_f2 | r_zcl_2
(assert (or (not r_p0) (not r_f2) r_zcl_2))
...
(assert (or (not r_p0) (not r_f2_p) r_f1_p))
...
;%~r_p8 | ~r_f1 | r_zcl_3
(assert (or (not r_p8) (not r_f1) r_zcl_3))
...
(assert (or (not r_p8) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p0 | r_p11
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p0 r_p11))
...
;%~r_p0 | ~r_p9 | r_zcl_4
(assert (or (not r_p0) (not r_p9) r_zcl_4))
...
(assert (or (not r_p0) (not r_p9) r_f13_p))
...
;%~r_p10 | ~r_f12 | r_zcl_6
(assert (or (not r_p10) (not r_f12) r_zcl_6))
...
(assert (or (not r_f18) r_p5 r_p7))


;%~r_p5 | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p5) r_f18_p))
...
(assert (or (not r_f17) r_p8 r_f18))


;%~r_p8 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p8) r_f17_p))
...
(assert (or (not r_f16) r_p0 r_f17))
