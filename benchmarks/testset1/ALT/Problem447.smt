...
;%~p4 | ~p3 | zcl_1
(assert (or (not l_p4) (not l_p3) l_zcl_1))
...
;%~p4 | ~p3 | f6_p
(assert (or (not l_p4) (not l_p3) l_f6_p))
...
;%~r_p4 | ~r_p3 | r_zcl_1
(assert (or (not r_p4) (not r_p3) r_zcl_1))
...
(assert (or (not r_p4) (not r_p3) r_f6_p))
