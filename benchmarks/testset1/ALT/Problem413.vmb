%%%%%%%%%%%%%%%% Target reformulation: ((p2 & (p4 & (p10 & p9))) | ((p2 | (p8 | (p6 | p7))) & ((p0 & (p2 & (p4 & p6))) | ((p0 | (p1 | (p5 | p4))) & (p1 | (p2 | (p3 | p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom6,axiom,(~zcl_17 | p4)) .
cnf(l_axiom7,axiom,(~zcl_17 | f2)) .
cnf(l_axiom8,axiom,(~p4 | ~f2 | zcl_17)) .
cnf(l_axiom9,axiom,(~f1 | zcl_17)) .
cnf(l_axiom10,axiom,(~p4 | ~f2_p | f1_p)) .
cnf(l_axiom11,axiom,(~zcl_18 | p2)) .
cnf(l_axiom12,axiom,(~zcl_18 | f1)) .
cnf(l_axiom13,axiom,(~p2 | ~f1 | zcl_18)) .
cnf(l_axiom14,axiom,(~f0 | zcl_18)) .
cnf(l_axiom15,axiom,(~p2 | ~f1_p | f0_p)) .
cnf(l_axiom16,axiom,(~f6 | p6 | p7)) .
...
cnf(l_axiom22,axiom,(~f4 | p2 | f5)) .
cnf(l_axiom23,axiom,(~p2 | f4_p)) .
cnf(l_axiom24,axiom,(~f5_p | f4_p)) .
cnf(l_axiom25,axiom,(~zcl_19 | p4)) .
cnf(l_axiom26,axiom,(~zcl_19 | p6)) .
cnf(l_axiom27,axiom,(~p4 | ~p6 | zcl_19)) .
cnf(l_axiom28,axiom,(~f10 | zcl_19)) .
cnf(l_axiom29,axiom,(~p4 | ~p6 | f10_p)) .
...
cnf(l_axiom35,axiom,(~zcl_21 | p0)) .
cnf(l_axiom36,axiom,(~zcl_21 | f9)) .
cnf(l_axiom37,axiom,(~p0 | ~f9 | zcl_21)) .
...
cnf(r_axiom16,axiom,(~acc_zcl_17 | acc_p4)) .
cnf(r_axiom17,axiom,(~acc_zcl_17 | acc_f2)) .
cnf(r_axiom18,axiom,(~acc_p4 | ~acc_f2 | acc_zcl_17)) .
cnf(r_axiom19,axiom,(~acc_f1 | acc_zcl_17)) .
cnf(r_axiom20,axiom,(~acc_p4 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom21,axiom,(~acc_zcl_18 | acc_p2)) .
cnf(r_axiom22,axiom,(~acc_zcl_18 | acc_f1)) .
cnf(r_axiom23,axiom,(~acc_p2 | ~acc_f1 | acc_zcl_18)) .
cnf(r_axiom24,axiom,(~acc_f0 | acc_zcl_18)) .
cnf(r_axiom25,axiom,(~acc_p2 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom26,axiom,(~acc_f6 | acc_p6 | acc_p7)) .
cnf(r_axiom27,axiom,(~acc_p6 | acc_f6_p)) .
cnf(r_axiom28,axiom,(~acc_p7 | acc_f6_p)) .
cnf(r_axiom29,axiom,(~acc_f5 | acc_p8 | acc_f6)) .
cnf(r_axiom30,axiom,(~acc_p8 | acc_f5_p)) .
cnf(r_axiom31,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom32,axiom,(~acc_f4 | acc_p2 | acc_f5)) .
cnf(r_axiom33,axiom,(~acc_p2 | acc_f4_p)) .
cnf(r_axiom34,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom35,axiom,(~acc_zcl_19 | acc_p4)) .
cnf(r_axiom36,axiom,(~acc_zcl_19 | acc_p6)) .
cnf(r_axiom37,axiom,(~acc_p4 | ~acc_p6 | acc_zcl_19)) .
cnf(r_axiom38,axiom,(~acc_f10 | acc_zcl_19)) .
cnf(r_axiom39,axiom,(~acc_p4 | ~acc_p6 | acc_f10_p)) .
...
cnf(r_axiom45,axiom,(~acc_zcl_21 | acc_p0)) .
cnf(r_axiom46,axiom,(~acc_zcl_21 | acc_f9)) .
cnf(r_axiom47,axiom,(~acc_p0 | ~acc_f9 | acc_zcl_21)) .
cnf(r_axiom48,axiom,(~acc_f8 | acc_zcl_21)) .
cnf(r_axiom49,axiom,(~acc_p0 | ~acc_f9_p | acc_f8_p)) .
cnf(r_axiom50,axiom,(~acc_f14 | acc_p5 | acc_p4)) .
cnf(r_axiom51,axiom,(~acc_p5 | acc_f14_p)) .
cnf(r_axiom52,axiom,(~acc_p4 | acc_f14_p)) .
cnf(r_axiom53,axiom,(~acc_f13 | acc_p1 | acc_f14)) .
cnf(r_axiom54,axiom,(~acc_p1 | acc_f13_p)) .
