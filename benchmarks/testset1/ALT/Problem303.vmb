...
cnf(l_axiom1,axiom,(~zcl_6 | p0)) .
cnf(l_axiom2,axiom,(~zcl_6 | p4)) .
cnf(l_axiom3,axiom,(~p0 | ~p4 | zcl_6)) .
cnf(l_axiom4,axiom,(~f1 | zcl_6)) .
cnf(l_axiom5,axiom,(~p0 | ~p4 | f1_p)) .
...
cnf(r_axiom5,axiom,(~acc_zcl_6 | acc_p0)) .
cnf(r_axiom6,axiom,(~acc_zcl_6 | acc_p4)) .
cnf(r_axiom7,axiom,(~acc_p0 | ~acc_p4 | acc_zcl_6)) .
cnf(r_axiom8,axiom,(~acc_f1 | acc_zcl_6)) .
cnf(r_axiom9,axiom,(~acc_p0 | ~acc_p4 | acc_f1_p)) .
cnf(r_axiom10,axiom,(~acc_zcl_7 | acc_p1)) .
cnf(r_axiom11,axiom,(~acc_zcl_7 | acc_f1)) .
cnf(r_axiom12,axiom,(~acc_p1 | ~acc_f1 | acc_zcl_7)) .
cnf(r_axiom13,axiom,(~acc_f0 | acc_zcl_7)) .
cnf(r_axiom14,axiom,(~acc_p1 | ~acc_f1_p | acc_f0_p)) .
