%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & (p5 & p7))) | ((p5 | (p6 | (p1 | p4))) & (p1 | (p2 | (p3 | p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_8 | p5)) .
cnf(l_axiom2,axiom,(~zcl_8 | p7)) .
cnf(l_axiom3,axiom,(~p5 | ~p7 | zcl_8)) .
cnf(l_axiom4,axiom,(~f2 | zcl_8)) .
cnf(l_axiom5,axiom,(~p5 | ~p7 | f2_p)) .
cnf(l_axiom6,axiom,(~zcl_9 | p2)) .
cnf(l_axiom7,axiom,(~zcl_9 | f2)) .
cnf(l_axiom8,axiom,(~p2 | ~f2 | zcl_9)) .
cnf(l_axiom9,axiom,(~f1 | zcl_9)) .
cnf(l_axiom10,axiom,(~p2 | ~f2_p | f1_p)) .
cnf(l_axiom11,axiom,(~zcl_10 | p1)) .
cnf(l_axiom12,axiom,(~zcl_10 | f1)) .
cnf(l_axiom13,axiom,(~p1 | ~f1 | zcl_10)) .
...
cnf(r_axiom8,axiom,(~acc_zcl_8 | acc_p5)) .
cnf(r_axiom9,axiom,(~acc_zcl_8 | acc_p7)) .
cnf(r_axiom10,axiom,(~acc_p5 | ~acc_p7 | acc_zcl_8)) .
cnf(r_axiom11,axiom,(~acc_f2 | acc_zcl_8)) .
cnf(r_axiom12,axiom,(~acc_p5 | ~acc_p7 | acc_f2_p)) .
cnf(r_axiom13,axiom,(~acc_zcl_9 | acc_p2)) .
cnf(r_axiom14,axiom,(~acc_zcl_9 | acc_f2)) .
cnf(r_axiom15,axiom,(~acc_p2 | ~acc_f2 | acc_zcl_9)) .
cnf(r_axiom16,axiom,(~acc_f1 | acc_zcl_9)) .
cnf(r_axiom17,axiom,(~acc_p2 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom18,axiom,(~acc_zcl_10 | acc_p1)) .
cnf(r_axiom19,axiom,(~acc_zcl_10 | acc_f1)) .
cnf(r_axiom20,axiom,(~acc_p1 | ~acc_f1 | acc_zcl_10)) .
...
cnf(r_axiom26,axiom,(~acc_f5 | acc_p6 | acc_f6)) .
cnf(r_axiom27,axiom,(~acc_p6 | acc_f5_p)) .
cnf(r_axiom28,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom29,axiom,(~acc_f4 | acc_p5 | acc_f5)) .
cnf(r_axiom30,axiom,(~acc_p5 | acc_f4_p)) .
