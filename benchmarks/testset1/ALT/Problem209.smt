...
;%~p13 | ~p12 | f2_p
(assert (or (not l_p13) (not l_p12) l_f2_p))
...
;%~f6 | p11 | p10
(assert (or (not l_f6) l_p11 l_p10))
...
;%~p0 | ~p8 | zcl_3
(assert (or (not l_p0) (not l_p8) l_zcl_3))
...
;%~p0 | ~p8 | f10_p
(assert (or (not l_p0) (not l_p8) l_f10_p))
...
;%~p9 | ~f9 | zcl_5
(assert (or (not l_p9) (not l_f9) l_zcl_5))
...
;%~f13 | p4 | f14
(assert (or (not l_f13) l_p4 l_f14))
...
(assert (or (not r_p13) (not r_p12) r_f2_p))
...
(assert (or (not r_f6) r_p11 r_p10))
...
;%~r_p0 | ~r_p8 | r_zcl_3
(assert (or (not r_p0) (not r_p8) r_zcl_3))
...
(assert (or (not r_p0) (not r_p8) r_f10_p))
...
;%~r_p9 | ~r_f9 | r_zcl_5
(assert (or (not r_p9) (not r_f9) r_zcl_5))
...
(assert (or (not r_f13) r_p4 r_f14))


;%~r_p4 | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p4) r_f13_p))
