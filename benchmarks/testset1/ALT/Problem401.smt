...
;%~p2 | ~p8 | f1_p
(assert (or (not l_p2) (not l_p8) l_f1_p))
...
;%~p2 | ~f1 | zcl_1
(assert (or (not l_p2) (not l_f1) l_zcl_1))
...
;%~p2 | ~p5 | zcl_2
(assert (or (not l_p2) (not l_p5) l_zcl_2))
...
;%~p2 | ~p5 | f7_p
(assert (or (not l_p2) (not l_p5) l_f7_p))
...
(assert (or (not r_p2) (not r_p8) r_f1_p))
...
;%~r_p2 | ~r_f1 | r_zcl_1
(assert (or (not r_p2) (not r_f1) r_zcl_1))
...
;%~r_p2 | ~r_p5 | r_zcl_2
(assert (or (not r_p2) (not r_p5) r_zcl_2))
...
(assert (or (not r_p2) (not r_p5) r_f7_p))
