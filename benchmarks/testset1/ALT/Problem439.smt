...
;%~p0 | ~p15 | zcl_0
(assert (or (not l_p0) (not l_p15) l_zcl_0))
...
;%~p0 | ~p15 | f4_p
(assert (or (not l_p0) (not l_p15) l_f4_p))
...
;%~p8 | ~f4 | zcl_1
(assert (or (not l_p8) (not l_f4) l_zcl_1))
...
;%~p8 | ~f4_p | f3_p
(assert (or (not l_p8) (not l_f4_p) l_f3_p))
...
;%~p1 | ~f3 | zcl_2
(assert (or (not l_p1) (not l_f3) l_zcl_2))
...
;%~p12 | ~f2 | zcl_3
(assert (or (not l_p12) (not l_f2) l_zcl_3))
...
;%~p12 | ~f2_p | f1_p
(assert (or (not l_p12) (not l_f2_p) l_f1_p))
...
;%~p7 | ~f1 | zcl_4
(assert (or (not l_p7) (not l_f1) l_zcl_4))
...
;%~f10 | p3 | p12
(assert (or (not l_f10) l_p3 l_p12))
...
;%~p5 | ~p9 | zcl_5
(assert (or (not l_p5) (not l_p9) l_zcl_5))
...
;%~p5 | ~p9 | f16_p
(assert (or (not l_p5) (not l_p9) l_f16_p))
...
;%~p7 | ~f16 | zcl_6
(assert (or (not l_p7) (not l_f16) l_zcl_6))
...
;%~p11 | ~f15 | zcl_7
(assert (or (not l_p11) (not l_f15) l_zcl_7))
...
;%~r_p0 | ~r_p15 | r_zcl_0
(assert (or (not r_p0) (not r_p15) r_zcl_0))
...
(assert (or (not r_p0) (not r_p15) r_f4_p))
...
;%~r_p8 | ~r_f4 | r_zcl_1
(assert (or (not r_p8) (not r_f4) r_zcl_1))
...
(assert (or (not r_p8) (not r_f4_p) r_f3_p))
...
;%~r_p1 | ~r_f3 | r_zcl_2
(assert (or (not r_p1) (not r_f3) r_zcl_2))
...
;%~r_p12 | ~r_f2 | r_zcl_3
(assert (or (not r_p12) (not r_f2) r_zcl_3))
...
(assert (or (not r_p12) (not r_f2_p) r_f1_p))
...
;%~r_p7 | ~r_f1 | r_zcl_4
(assert (or (not r_p7) (not r_f1) r_zcl_4))
...
(assert (or (not r_f10) r_p3 r_p12))
...
;%~r_p5 | ~r_p9 | r_zcl_5
(assert (or (not r_p5) (not r_p9) r_zcl_5))
...
(assert (or (not r_p5) (not r_p9) r_f16_p))
...
;%~r_p7 | ~r_f16 | r_zcl_6
(assert (or (not r_p7) (not r_f16) r_zcl_6))
...
;%~r_p11 | ~r_f15 | r_zcl_7
(assert (or (not r_p11) (not r_f15) r_zcl_7))
