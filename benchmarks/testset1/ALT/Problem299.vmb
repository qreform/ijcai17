...
cnf(l_axiom3,axiom,(~p2 | ~p4 | zcl_4)) .
cnf(l_axiom4,axiom,(~f0 | zcl_4)) .
cnf(l_axiom5,axiom,(~p2 | ~p4 | f0_p)) .
...
cnf(r_axiom5,axiom,(~acc_zcl_4 | acc_p2)) .
cnf(r_axiom6,axiom,(~acc_zcl_4 | acc_p4)) .
cnf(r_axiom7,axiom,(~acc_p2 | ~acc_p4 | acc_zcl_4)) .
cnf(r_axiom8,axiom,(~acc_f0 | acc_zcl_4)) .
cnf(r_axiom9,axiom,(~acc_p2 | ~acc_p4 | acc_f0_p)) .
