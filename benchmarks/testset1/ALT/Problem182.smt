...
;%~p2 | ~p6 | f0_p
(assert (or (not l_p2) (not l_p6) l_f0_p))
...
;%~p2 | ~p4 | zcl_1
(assert (or (not l_p2) (not l_p4) l_zcl_1))
...
;%~p2 | ~p4 | f4_p
(assert (or (not l_p2) (not l_p4) l_f4_p))
...
(assert (or (not r_p2) (not r_p6) r_f0_p))
...
;%~r_p2 | ~r_p4 | r_zcl_1
(assert (or (not r_p2) (not r_p4) r_zcl_1))
...
(assert (or (not r_p2) (not r_p4) r_f4_p))


;%~r_f6 | r_p0 | r_p3
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_p0 r_p3))
