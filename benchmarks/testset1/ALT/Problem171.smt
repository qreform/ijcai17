...
;%~f4 | p14 | f5
(assert (or (not l_f4) l_p14 l_f5))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | f5_p) --> f4_p))
;%------------------------Clausification start------------------------%
...
;%~p0 | ~p10 | f12_p
(assert (or (not l_p0) (not l_p10) l_f12_p))
...
;%~p9 | ~f12 | zcl_1
(assert (or (not l_p9) (not l_f12) l_zcl_1))
...
;%~p12 | ~f10 | zcl_3
(assert (or (not l_p12) (not l_f10) l_zcl_3))
...
;%~p11 | ~f9 | zcl_4
(assert (or (not l_p11) (not l_f9) l_zcl_4))
...
;%~f17 | p9 | f18
(assert (or (not l_f17) l_p9 l_f18))
...
;%~f14 | p7 | f15
(assert (or (not l_f14) l_p7 l_f15))
...
;%~p0 | ~p7 | f26_p
(assert (or (not l_p0) (not l_p7) l_f26_p))
...
;%~p0 | ~f23 | zcl_10
(assert (or (not l_p0) (not l_f23) l_zcl_10))
...
(assert (or (not r_p0) (not r_p10) r_f12_p))
...
;%~r_p9 | ~r_f12 | r_zcl_1
(assert (or (not r_p9) (not r_f12) r_zcl_1))
...
;%~r_p12 | ~r_f10 | r_zcl_3
(assert (or (not r_p12) (not r_f10) r_zcl_3))
...
;%~r_p11 | ~r_f9 | r_zcl_4
(assert (or (not r_p11) (not r_f9) r_zcl_4))
...
(assert (or (not r_f17) r_p9 r_f18))
...
(assert (or (not r_f14) r_p7 r_f15))
...
(assert (or (not r_p0) (not r_p7) r_f26_p))
...
;%~r_p0 | ~r_f23 | r_zcl_10
(assert (or (not r_p0) (not r_f23) r_zcl_10))
