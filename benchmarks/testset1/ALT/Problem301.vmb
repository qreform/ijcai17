%%%%%%%%%%%%%%%% Target reformulation: ((p5 & (p6 & p4)) | ((p0 | (p1 | p3)) & (p1 | (p2 | p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p6 | ~p4 | zcl_6)) .
cnf(l_axiom4,axiom,(~f1 | zcl_6)) .
cnf(l_axiom5,axiom,(~p6 | ~p4 | f1_p)) .
cnf(l_axiom6,axiom,(~zcl_7 | p5)) .
cnf(l_axiom7,axiom,(~zcl_7 | f1)) .
cnf(l_axiom8,axiom,(~p5 | ~f1 | zcl_7)) .
cnf(l_axiom9,axiom,(~f0 | zcl_7)) .
cnf(l_axiom10,axiom,(~p5 | ~f1_p | f0_p)) .
cnf(l_axiom11,axiom,(~f4 | p1 | p3)) .
...
cnf(r_axiom7,axiom,(~acc_zcl_6 | acc_p6)) .
cnf(r_axiom8,axiom,(~acc_zcl_6 | acc_p4)) .
cnf(r_axiom9,axiom,(~acc_p6 | ~acc_p4 | acc_zcl_6)) .
cnf(r_axiom10,axiom,(~acc_f1 | acc_zcl_6)) .
cnf(r_axiom11,axiom,(~acc_p6 | ~acc_p4 | acc_f1_p)) .
cnf(r_axiom12,axiom,(~acc_zcl_7 | acc_p5)) .
cnf(r_axiom13,axiom,(~acc_zcl_7 | acc_f1)) .
cnf(r_axiom14,axiom,(~acc_p5 | ~acc_f1 | acc_zcl_7)) .
cnf(r_axiom15,axiom,(~acc_f0 | acc_zcl_7)) .
cnf(r_axiom16,axiom,(~acc_p5 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom17,axiom,(~acc_f4 | acc_p1 | acc_p3)) .
