...
cnf(l_axiom16,axiom,(~zcl_13 | p8)) .
cnf(l_axiom17,axiom,(~zcl_13 | f1)) .
cnf(l_axiom18,axiom,(~p8 | ~f1 | zcl_13)) .
...
cnf(r_axiom14,axiom,(~acc_zcl_11 | acc_p3)) .
cnf(r_axiom15,axiom,(~acc_zcl_11 | acc_f3)) .
cnf(r_axiom16,axiom,(~acc_p3 | ~acc_f3 | acc_zcl_11)) .
cnf(r_axiom17,axiom,(~acc_f2 | acc_zcl_11)) .
cnf(r_axiom18,axiom,(~acc_p3 | ~acc_f3_p | acc_f2_p)) .
cnf(r_axiom19,axiom,(~acc_zcl_12 | acc_p1)) .
cnf(r_axiom20,axiom,(~acc_zcl_12 | acc_f2)) .
cnf(r_axiom21,axiom,(~acc_p1 | ~acc_f2 | acc_zcl_12)) .
cnf(r_axiom22,axiom,(~acc_f1 | acc_zcl_12)) .
cnf(r_axiom23,axiom,(~acc_p1 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom24,axiom,(~acc_zcl_13 | acc_p8)) .
cnf(r_axiom25,axiom,(~acc_zcl_13 | acc_f1)) .
cnf(r_axiom26,axiom,(~acc_p8 | ~acc_f1 | acc_zcl_13)) .
cnf(r_axiom27,axiom,(~acc_f0 | acc_zcl_13)) .
cnf(r_axiom28,axiom,(~acc_p8 | ~acc_f1_p | acc_f0_p)) .
