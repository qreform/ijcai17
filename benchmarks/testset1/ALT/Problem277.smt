...
;%~p0 | ~p12 | f8_p
(assert (or (not l_p0) (not l_p12) l_f8_p))
...
;%~f13 | p8 | p11
(assert (or (not l_f13) l_p8 l_p11))
...
;%~f11 | p5 | f12
(assert (or (not l_f11) l_p5 l_f12))
...
;%~f10 | p5 | f11
(assert (or (not l_f10) l_p5 l_f11))
...
;%~p10 | ~p9 | zcl_4
(assert (or (not l_p10) (not l_p9) l_zcl_4))
...
(assert (or (not r_p0) (not r_p12) r_f8_p))
...
(assert (or (not r_f13) r_p8 r_p11))
...
(assert (or (not r_f11) r_p5 r_f12))


;%~r_p5 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p5) r_f11_p))
...
(assert (or (not r_f10) r_p5 r_f11))
...
;%~r_p10 | ~r_p9 | r_zcl_4
(assert (or (not r_p10) (not r_p9) r_zcl_4))
