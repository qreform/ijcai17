...
;%~p12 | ~p9 | f4_p
(assert (or (not l_p12) (not l_p9) l_f4_p))
...
;%~p7 | ~f4 | zcl_1
(assert (or (not l_p7) (not l_f4) l_zcl_1))
...
;%~p7 | ~f4_p | f3_p
(assert (or (not l_p7) (not l_f4_p) l_f3_p))
...
;%~p3 | ~f2 | zcl_3
(assert (or (not l_p3) (not l_f2) l_zcl_3))
...
;%~p10 | ~f1 | zcl_4
(assert (or (not l_p10) (not l_f1) l_zcl_4))
...
;%~zcl_5 | f11
(assert (or (not l_zcl_5) l_f11))

;%~f6 | ~f11 | zcl_5
(assert (or (not l_f6) (not l_f11) l_zcl_5))
...
(assert (or (not r_p12) (not r_p9) r_f4_p))
...
;%~r_p7 | ~r_f4 | r_zcl_1
(assert (or (not r_p7) (not r_f4) r_zcl_1))
...
(assert (or (not r_p7) (not r_f4_p) r_f3_p))
...
;%~r_p3 | ~r_f2 | r_zcl_3
(assert (or (not r_p3) (not r_f2) r_zcl_3))
...
;%~r_p10 | ~r_f1 | r_zcl_4
(assert (or (not r_p10) (not r_f1) r_zcl_4))
...
;%~r_zcl_5 | r_f11
(assert (or (not r_zcl_5) r_f11))


;%~r_f6 | ~r_f11 | r_zcl_5
(assert (or (not r_f6) (not r_f11) r_zcl_5))
