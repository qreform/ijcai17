...
;%~p0 | ~p12 | f2_p
(assert (or (not l_p0) (not l_p12) l_f2_p))
...
;%~p0 | ~f2 | zcl_1
(assert (or (not l_p0) (not l_f2) l_zcl_1))
...
;%~p9 | ~f1 | zcl_2
(assert (or (not l_p9) (not l_f1) l_zcl_2))
...
;%~p9 | ~f1_p | f0_p
(assert (or (not l_p9) (not l_f1_p) l_f0_p))
...
;%~p0 | ~p9 | zcl_3
(assert (or (not l_p0) (not l_p9) l_zcl_3))
...
;%~p0 | ~p9 | f10_p
(assert (or (not l_p0) (not l_p9) l_f10_p))
...
;%~p7 | ~f10 | zcl_4
(assert (or (not l_p7) (not l_f10) l_zcl_4))
...
;%~p10 | ~f9 | zcl_5
(assert (or (not l_p10) (not l_f9) l_zcl_5))
...
;%~p10 | ~f9_p | f8_p
(assert (or (not l_p10) (not l_f9_p) l_f8_p))
...
;%~f13 | p8 | f14
(assert (or (not l_f13) l_p8 l_f14))
...
;%~p5 | ~p4 | zcl_6
(assert (or (not l_p5) (not l_p4) l_zcl_6))
...
;%~p5 | ~p4 | f18_p
(assert (or (not l_p5) (not l_p4) l_f18_p))
...
;%~p0 | ~f18 | zcl_7
(assert (or (not l_p0) (not l_f18) l_zcl_7))
...
;%~p0 | ~f17 | zcl_8
(assert (or (not l_p0) (not l_f17) l_zcl_8))
...
(assert (or (not r_p0) (not r_p12) r_f2_p))
...
;%~r_p0 | ~r_f2 | r_zcl_1
(assert (or (not r_p0) (not r_f2) r_zcl_1))
...
;%~r_p9 | ~r_f1 | r_zcl_2
(assert (or (not r_p9) (not r_f1) r_zcl_2))
...
(assert (or (not r_p9) (not r_f1_p) r_f0_p))


;%~r_f6 | r_p7 | r_p11
(declare-fun r_f6 () Bool)
(assert (or (not r_f6) r_p7 r_p11))
...
(assert (or (not r_f4) r_p4 r_f5))


;%~r_p4 | r_f4_p
(declare-fun r_f4_p () Bool)
(assert (or (not r_p4) r_f4_p))
...
;%~r_p0 | ~r_p9 | r_zcl_3
(assert (or (not r_p0) (not r_p9) r_zcl_3))
...
(assert (or (not r_p0) (not r_p9) r_f10_p))
...
;%~r_p7 | ~r_f10 | r_zcl_4
(assert (or (not r_p7) (not r_f10) r_zcl_4))
...
;%~r_p10 | ~r_f9 | r_zcl_5
(assert (or (not r_p10) (not r_f9) r_zcl_5))
...
(assert (or (not r_p10) (not r_f9_p) r_f8_p))


;%~r_f14 | r_p0 | r_p6
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_p0 r_p6))
...
(assert (or (not r_f13) r_p8 r_f14))
...
;%~r_p5 | ~r_p4 | r_zcl_6
(assert (or (not r_p5) (not r_p4) r_zcl_6))
...
(assert (or (not r_p5) (not r_p4) r_f18_p))
...
;%~r_p0 | ~r_f18 | r_zcl_7
(assert (or (not r_p0) (not r_f18) r_zcl_7))
...
;%~r_p0 | ~r_f17 | r_zcl_8
(assert (or (not r_p0) (not r_f17) r_zcl_8))
