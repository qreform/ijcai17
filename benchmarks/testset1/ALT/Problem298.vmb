%%%%%%%%%%%%%%%% Target reformulation: ((~p2 & ~p3) | ((~p1 | ~p2) & (p1 | ~p0))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p2 | ~p3 | zcl_4)) .
cnf(l_axiom4,axiom,(~f0 | zcl_4)) .
cnf(l_axiom5,axiom,(~p2 | ~p3 | f0_p)) .
...
cnf(r_axiom4,axiom,(~acc_zcl_4 | acc_p2)) .
cnf(r_axiom5,axiom,(~acc_zcl_4 | acc_p3)) .
cnf(r_axiom6,axiom,(~acc_p2 | ~acc_p3 | acc_zcl_4)) .
cnf(r_axiom7,axiom,(~acc_f0 | acc_zcl_4)) .
cnf(r_axiom8,axiom,(~acc_p2 | ~acc_p3 | acc_f0_p)) .
