...
cnf(l_axiom1,axiom,(~f0 | p6 | p9)) .
cnf(l_axiom2,axiom,(~p6 | f0_p)) .
cnf(l_axiom3,axiom,(~p9 | f0_p)) .
cnf(l_axiom4,axiom,(~zcl_14 | p8)) .
cnf(l_axiom5,axiom,(~zcl_14 | p7)) .
cnf(l_axiom6,axiom,(~p8 | ~p7 | zcl_14)) .
cnf(l_axiom7,axiom,(~f2 | zcl_14)) .
cnf(l_axiom8,axiom,(~p8 | ~p7 | f2_p)) .
cnf(l_axiom9,axiom,(~f4 | p0 | p6)) .
cnf(l_axiom10,axiom,(~p0 | f4_p)) .
cnf(l_axiom11,axiom,(~p6 | f4_p)) .
cnf(l_axiom12,axiom,(~zcl_15 | p5)) .
cnf(l_axiom13,axiom,(~zcl_15 | p4)) .
cnf(l_axiom14,axiom,(~p5 | ~p4 | zcl_15)) .
cnf(l_axiom15,axiom,(~f6 | zcl_15)) .
cnf(l_axiom16,axiom,(~p5 | ~p4 | f6_p)) .
cnf(l_axiom17,axiom,(~f8 | p2 | p3)) .
cnf(l_axiom18,axiom,(~p2 | f8_p)) .
...
cnf(r_axiom10,axiom,(~acc_f0 | acc_p6 | acc_p9)) .
cnf(r_axiom11,axiom,(~acc_p6 | acc_f0_p)) .
cnf(r_axiom12,axiom,(~acc_p9 | acc_f0_p)) .
cnf(r_axiom13,axiom,(~acc_zcl_14 | acc_p8)) .
cnf(r_axiom14,axiom,(~acc_zcl_14 | acc_p7)) .
cnf(r_axiom15,axiom,(~acc_p8 | ~acc_p7 | acc_zcl_14)) .
cnf(r_axiom16,axiom,(~acc_f2 | acc_zcl_14)) .
cnf(r_axiom17,axiom,(~acc_p8 | ~acc_p7 | acc_f2_p)) .
cnf(r_axiom18,axiom,(~acc_f4 | acc_p0 | acc_p6)) .
...
cnf(r_axiom23,axiom,(~acc_p5 | ~acc_p4 | acc_zcl_15)) .
cnf(r_axiom24,axiom,(~acc_f6 | acc_zcl_15)) .
cnf(r_axiom25,axiom,(~acc_p5 | ~acc_p4 | acc_f6_p)) .
cnf(r_axiom26,axiom,(~acc_f8 | acc_p2 | acc_p3)) .
