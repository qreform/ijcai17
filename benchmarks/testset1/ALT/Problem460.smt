...
;%~f2 | p23 | p20
(assert (or (not l_f2) l_p23 l_p20))
...
;%~p23 | f2_p
(assert (or (not l_p23) l_f2_p))

;%~p20 | f2_p
(assert (or (not l_p20) l_f2_p))
...
;%~p19 | ~p16 | zcl_0
(assert (or (not l_p19) (not l_p16) l_zcl_0))
...
;%~p19 | ~p16 | f6_p
(assert (or (not l_p19) (not l_p16) l_f6_p))
...
;%~p18 | ~f6 | zcl_1
(assert (or (not l_p18) (not l_f6) l_zcl_1))
...
;%~p18 | ~f6_p | f5_p
(assert (or (not l_p18) (not l_f6_p) l_f5_p))
...
;%~p17 | ~f5 | zcl_2
(assert (or (not l_p17) (not l_f5) l_zcl_2))
...
;%~p17 | ~f5_p | f4_p
(assert (or (not l_p17) (not l_f5_p) l_f4_p))
...
;%~f10 | p15 | p12
(assert (or (not l_f10) l_p15 l_p12))
...
;%~f9 | p14 | f10
(assert (or (not l_f9) l_p14 l_f10))
...
;%~p11 | ~p8 | zcl_3
(assert (or (not l_p11) (not l_p8) l_zcl_3))
...
;%~p10 | ~f14 | zcl_4
(assert (or (not l_p10) (not l_f14) l_zcl_4))
...
;%~f16 | p5 | f17
(assert (or (not l_f16) l_p5 l_f17))
...
;%~zcl_6 | f19
(assert (or (not l_zcl_6) l_f19))

;%~f16 | ~f19 | zcl_6
(assert (or (not l_f16) (not l_f19) l_zcl_6))
...
;%~zcl_7 | f8
(assert (or (not l_zcl_7) l_f8))

;%~zcl_7 | f11
(assert (or (not l_zcl_7) l_f11))

;%~f8 | ~f11 | zcl_7
(assert (or (not l_f8) (not l_f11) l_zcl_7))

(declare-fun l_f7 () Bool)
;%~f7 | zcl_7
(assert (or (not l_f7) l_zcl_7))
...
;%~zcl_8 | f3
(assert (or (not l_zcl_8) l_f3))

;%~f0 | ~f3 | zcl_8
(assert (or (not l_f0) (not l_f3) l_zcl_8))
...
(assert (or (not r_f2) r_p23 r_p20))


;%~r_p23 | r_f2_p
(declare-fun r_f2_p () Bool)
(assert (or (not r_p23) r_f2_p))


;%~r_p20 | r_f2_p
(assert (or (not r_p20) r_f2_p))


;%~r_f1 | r_p22 | r_f2
(declare-fun r_f1 () Bool)
(assert (or (not r_f1) r_p22 r_f2))


;%~r_p22 | r_f1_p
(declare-fun r_f1_p () Bool)
(assert (or (not r_p22) r_f1_p))
...
(assert (or (not r_f0) r_p21 r_f1))


;%~r_p21 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p21) r_f0_p))
...
;%~r_p19 | ~r_p16 | r_zcl_0
(assert (or (not r_p19) (not r_p16) r_zcl_0))
...
(assert (or (not r_p19) (not r_p16) r_f6_p))
...
;%~r_p18 | ~r_f6 | r_zcl_1
(assert (or (not r_p18) (not r_f6) r_zcl_1))
...
(assert (or (not r_p18) (not r_f6_p) r_f5_p))
...
;%~r_p17 | ~r_f5 | r_zcl_2
(assert (or (not r_p17) (not r_f5) r_zcl_2))
...
(assert (or (not r_p17) (not r_f5_p) r_f4_p))


;%~r_f10 | r_p15 | r_p12
(declare-fun r_f10 () Bool)
(assert (or (not r_f10) r_p15 r_p12))
...
(assert (or (not r_f9) r_p14 r_f10))


;%~r_p14 | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p14) r_f9_p))
...
;%~r_p11 | ~r_p8 | r_zcl_3
(assert (or (not r_p11) (not r_p8) r_zcl_3))
...
;%~r_p10 | ~r_f14 | r_zcl_4
(assert (or (not r_p10) (not r_f14) r_zcl_4))
...
(assert (or (not r_f16) r_p5 r_f17))
...
;%~r_zcl_6 | r_f19
(assert (or (not r_zcl_6) r_f19))


;%~r_f16 | ~r_f19 | r_zcl_6
(assert (or (not r_f16) (not r_f19) r_zcl_6))
...
;%~r_f8 | ~r_f11 | r_zcl_7
(assert (or (not r_f8) (not r_f11) r_zcl_7))


;%~r_f7 | r_zcl_7
(declare-fun r_f7 () Bool)
(assert (or (not r_f7) r_zcl_7))
...
;%~r_zcl_8 | r_f3
(assert (or (not r_zcl_8) r_f3))


;%~r_f0 | ~r_f3 | r_zcl_8
(assert (or (not r_f0) (not r_f3) r_zcl_8))
