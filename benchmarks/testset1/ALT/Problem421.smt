...
;%~p3 | ~p9 | zcl_0
(assert (or (not l_p3) (not l_p9) l_zcl_0))
...
;%~p3 | ~p9 | f3_p
(assert (or (not l_p3) (not l_p9) l_f3_p))
...
;%~p2 | ~f12 | zcl_6
(assert (or (not l_p2) (not l_f12) l_zcl_6))
...
;%~p2 | ~f12_p | f11_p
(assert (or (not l_p2) (not l_f12_p) l_f11_p))
...
;%~p4 | ~f11 | zcl_7
(assert (or (not l_p4) (not l_f11) l_zcl_7))
...
;%~p4 | ~f11_p | f10_p
(assert (or (not l_p4) (not l_f11_p) l_f10_p))
...
;%~f16 | p2 | f17
(assert (or (not l_f16) l_p2 l_f17))
...
;%~r_p3 | ~r_p9 | r_zcl_0
(assert (or (not r_p3) (not r_p9) r_zcl_0))
...
(assert (or (not r_p3) (not r_p9) r_f3_p))
...
;%~r_p2 | ~r_f12 | r_zcl_6
(assert (or (not r_p2) (not r_f12) r_zcl_6))
...
;%~r_p2 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p2) (not r_f12_p) r_f11_p))
...
;%~r_p4 | ~r_f11 | r_zcl_7
(assert (or (not r_p4) (not r_f11) r_zcl_7))
...
;%~r_p4 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p4) (not r_f11_p) r_f10_p))


;%~r_f18 | r_p3 | r_p5
(declare-fun r_f18 () Bool)
(assert (or (not r_f18) r_p3 r_p5))


;%~r_p3 | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p3) r_f18_p))
...
(assert (or (not r_f16) r_p2 r_f17))


;%~r_p2 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p2) r_f16_p))
