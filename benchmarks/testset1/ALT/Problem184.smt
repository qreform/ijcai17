...
;%~p11 | ~p10 | f0_p
(assert (or (not l_p11) (not l_p10) l_f0_p))
...
;%~p3 | ~p2 | f8_p
(assert (or (not l_p3) (not l_p2) l_f8_p))
...
(assert (or (not r_p11) (not r_p10) r_f0_p))


;%~r_f2 | r_p9 | r_p8
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p9 r_p8))
...
(assert (or (not r_p3) (not r_p2) r_f8_p))
