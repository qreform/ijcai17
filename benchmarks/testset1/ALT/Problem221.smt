...
;%~p16 | ~p15 | f4_p
(assert (or (not l_p16) (not l_p15) l_f4_p))
...
;%~p11 | ~f3 | zcl_2
(assert (or (not l_p11) (not l_f3) l_zcl_2))
...
;%~p0 | ~f2 | zcl_3
(assert (or (not l_p0) (not l_f2) l_zcl_3))
...
;%~p14 | ~f1 | zcl_4
(assert (or (not l_p14) (not l_f1) l_zcl_4))
...
;%~f10 | p14 | p13
(assert (or (not l_f10) l_p14 l_p13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | p13) --> f10_p))
;%------------------------Clausification start------------------------%
...
;%~p0 | ~p11 | f16_p
(assert (or (not l_p0) (not l_p11) l_f16_p))
...
;%~p12 | ~f15 | zcl_7
(assert (or (not l_p12) (not l_f15) l_zcl_7))
...
;%~p6 | ~f13 | zcl_9
(assert (or (not l_p6) (not l_f13) l_zcl_9))
...
;%~f20 | p10 | f21
(assert (or (not l_f20) l_p10 l_f21))
...
;%~p8 | ~f28 | zcl_11
(assert (or (not l_p8) (not l_f28) l_zcl_11))
...
(assert (or (not r_p16) (not r_p15) r_f4_p))
...
;%~r_p11 | ~r_f3 | r_zcl_2
(assert (or (not r_p11) (not r_f3) r_zcl_2))
...
;%~r_p0 | ~r_f2 | r_zcl_3
(assert (or (not r_p0) (not r_f2) r_zcl_3))
...
;%~r_p14 | ~r_f1 | r_zcl_4
(assert (or (not r_p14) (not r_f1) r_zcl_4))
...
(assert (or (not r_f10) r_p14 r_p13))
...
(assert (or (not r_p0) (not r_p11) r_f16_p))
...
;%~r_p12 | ~r_f15 | r_zcl_7
(assert (or (not r_p12) (not r_f15) r_zcl_7))
...
;%~r_p6 | ~r_f13 | r_zcl_9
(assert (or (not r_p6) (not r_f13) r_zcl_9))
...
(assert (or (not r_f20) r_p10 r_f21))


;%~r_p10 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p10) r_f20_p))
...
;%~r_p8 | ~r_f28 | r_zcl_11
(assert (or (not r_p8) (not r_f28) r_zcl_11))
