...
;%~f0 | p13 | p12
(assert (or (not l_f0) l_p13 l_p12))
...
;%~p11 | ~p10 | f2_p
(assert (or (not l_p11) (not l_p10) l_f2_p))
...
;%~p7 | ~p6 | zcl_1
(assert (or (not l_p7) (not l_p6) l_zcl_1))
...
;%~p3 | ~p2 | zcl_2
(assert (or (not l_p3) (not l_p2) l_zcl_2))
...
;%~p3 | ~p2 | f10_p
(assert (or (not l_p3) (not l_p2) l_f10_p))
...
;%~p1 | ~p0 | zcl_3
(assert (or (not l_p1) (not l_p0) l_zcl_3))

(declare-fun l_f11 () Bool)
;%~f11 | zcl_3
(assert (or (not l_f11) l_zcl_3))
...
;%~p1 | ~p0 | f11_p
(assert (or (not l_p1) (not l_p0) l_f11_p))
...
;%~f9 | f10 | f11
(assert (or (not l_f9) l_f10 l_f11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((f10_p | f11_p) --> f9_p))
;%------------------------Clausification start------------------------%
...
;%~zcl_4 | f8
(assert (or (not l_zcl_4) l_f8))

;%~zcl_4 | f9
(assert (or (not l_zcl_4) l_f9))

;%~f8 | ~f9 | zcl_4
(assert (or (not l_f8) (not l_f9) l_zcl_4))
...
;%~f4 | ~f5 | zcl_5
(assert (or (not l_f4) (not l_f5) l_zcl_5))

(declare-fun l_f3 () Bool)
;%~f3 | zcl_5
(assert (or (not l_f3) l_zcl_5))
...
;%~f0 | ~f1 | zcl_6
(assert (or (not l_f0) (not l_f1) l_zcl_6))
...
(assert (or (not r_f0) r_p13 r_p12))
...
(assert (or (not r_p11) (not r_p10) r_f2_p))


;%~r_f4 | r_p9 | r_p8
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_p9 r_p8))
...
;%~r_p7 | ~r_p6 | r_zcl_1
(assert (or (not r_p7) (not r_p6) r_zcl_1))
...
;%~r_p3 | ~r_p2 | r_zcl_2
(assert (or (not r_p3) (not r_p2) r_zcl_2))
...
(assert (or (not r_p3) (not r_p2) r_f10_p))
...
;%~r_p1 | ~r_p0 | r_zcl_3
(assert (or (not r_p1) (not r_p0) r_zcl_3))


;%~r_f11 | r_zcl_3
(declare-fun r_f11 () Bool)
(assert (or (not r_f11) r_zcl_3))


;%~r_p1 | ~r_p0 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p1) (not r_p0) r_f11_p))


;%~r_f9 | r_f10 | r_f11
(declare-fun r_f9 () Bool)
(assert (or (not r_f9) r_f10 r_f11))
...
;%~r_f11_p | r_f9_p
(assert (or (not r_f11_p) r_f9_p))


;%~r_zcl_4 | r_f8
(declare-fun r_zcl_4 () Bool)
(assert (or (not r_zcl_4) r_f8))
...
;%~r_f8 | ~r_f9 | r_zcl_4
(assert (or (not r_f8) (not r_f9) r_zcl_4))
...
;%~r_f4 | ~r_f5 | r_zcl_5
(assert (or (not r_f4) (not r_f5) r_zcl_5))


;%~r_f3 | r_zcl_5
(declare-fun r_f3 () Bool)
(assert (or (not r_f3) r_zcl_5))
...
;%~r_f0 | ~r_f1 | r_zcl_6
(assert (or (not r_f0) (not r_f1) r_zcl_6))
