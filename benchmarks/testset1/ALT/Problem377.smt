...
;%~p5 | ~p8 | f8_p
(assert (or (not l_p5) (not l_p8) l_f8_p))
...
;%~p6 | ~f8 | zcl_1
(assert (or (not l_p6) (not l_f8) l_zcl_1))
...
(assert (or (not r_p5) (not r_p8) r_f8_p))
...
;%~r_p6 | ~r_f8 | r_zcl_1
(assert (or (not r_p6) (not r_f8) r_zcl_1))
