...
;%~p10 | ~f12 | zcl_7
(assert (or (not l_p10) (not l_f12) l_zcl_7))
...
;%~p13 | ~p11 | zcl_12
(assert (or (not l_p13) (not l_p11) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((~p13 & ~p11) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p13 | ~p11 | f19_p
(assert (or (not l_p13) (not l_p11) l_f19_p))
...
;%~p12 | ~f18 | zcl_14
(assert (or (not l_p12) (not l_f18) l_zcl_14))
...
;%~p15 | ~f24 | zcl_21
(assert (or (not l_p15) (not l_f24) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p15 & f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p15 | ~f24_p | f23_p
(assert (or (not l_p15) (not l_f24_p) l_f23_p))
...
;%~p11 | ~p18 | zcl_24
(assert (or (not l_p11) (not l_p18) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p11 & ~p18) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p11 | ~p18 | f32_p
(assert (or (not l_p11) (not l_p18) l_f32_p))
...
;%~zcl_26 | p11
(assert (or (not l_zcl_26) l_p11))

;%~zcl_26 | f31
(assert (or (not l_zcl_26) l_f31))

;%~p11 | ~f31 | zcl_26
(assert (or (not l_p11) (not l_f31) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p11 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p11 | ~f31_p | f30_p
(assert (or (not l_p11) (not l_f31_p) l_f30_p))
...
;%~r_p10 | ~r_f12 | r_zcl_7
(assert (or (not r_p10) (not r_f12) r_zcl_7))
...
;%~r_p13 | ~r_p11 | r_zcl_12
(assert (or (not r_p13) (not r_p11) r_zcl_12))
...
(assert (or (not r_p13) (not r_p11) r_f19_p))
...
;%~r_p12 | ~r_f18 | r_zcl_14
(assert (or (not r_p12) (not r_f18) r_zcl_14))
...
;%~r_p15 | ~r_f24 | r_zcl_21
(assert (or (not r_p15) (not r_f24) r_zcl_21))
...
;%~r_p15 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p15) (not r_f24_p) r_f23_p))
...
;%~r_p11 | ~r_p18 | r_zcl_24
(assert (or (not r_p11) (not r_p18) r_zcl_24))
...
(assert (or (not r_p11) (not r_p18) r_f32_p))
...
;%~r_p11 | ~r_f31 | r_zcl_26
(assert (or (not r_p11) (not r_f31) r_zcl_26))
...
;%~r_p11 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p11) (not r_f31_p) r_f30_p))
