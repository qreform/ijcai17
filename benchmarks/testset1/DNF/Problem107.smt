...
;%~p9 | ~p8 | zcl_12
(assert (or (not l_p9) (not l_p8) l_zcl_12))
...
;%~p9 | ~p8 | f18_p
(assert (or (not l_p9) (not l_p8) l_f18_p))
...
;%~p11 | ~p10 | zcl_16
(assert (or (not l_p11) (not l_p10) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((~p11 & p10) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p11 | ~p10 | f23_p
(assert (or (not l_p11) (not l_p10) l_f23_p))
...
;%~r_p9 | ~r_p8 | r_zcl_12
(assert (or (not r_p9) (not r_p8) r_zcl_12))
...
(assert (or (not r_p9) (not r_p8) r_f18_p))
...
;%~r_p11 | ~r_p10 | r_zcl_16
(assert (or (not r_p11) (not r_p10) r_zcl_16))
...
(assert (or (not r_p11) (not r_p10) r_f23_p))
