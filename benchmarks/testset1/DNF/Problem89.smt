...
;%~p11 | ~p10 | zcl_10
(assert (or (not l_p11) (not l_p10) l_zcl_10))
...
;%Non-clausified dependency
;%(forall[]((~p11 & ~p10) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p11 | ~p10 | f15_p
(assert (or (not l_p11) (not l_p10) l_f15_p))
...
;%~r_p11 | ~r_p10 | r_zcl_10
(assert (or (not r_p11) (not r_p10) r_zcl_10))
...
(assert (or (not r_p11) (not r_p10) r_f15_p))
