...
;%~p2 | ~p4 | zcl_3
(assert (or (not l_p2) (not l_p4) l_zcl_3))
...
;%~p2 | ~p4 | f6_p
(assert (or (not l_p2) (not l_p4) l_f6_p))
...
;%~p3 | ~p5 | f8_p
(assert (or (not l_p3) (not l_p5) l_f8_p))
...
;%~p3 | ~p6 | zcl_5
(assert (or (not l_p3) (not l_p6) l_zcl_5))
...
;%~p2 | ~p7 | zcl_6
(assert (or (not l_p2) (not l_p7) l_zcl_6))
...
;%~p2 | ~p7 | f11_p
(assert (or (not l_p2) (not l_p7) l_f11_p))
...
;%~r_p2 | ~r_p4 | r_zcl_3
(assert (or (not r_p2) (not r_p4) r_zcl_3))
...
(assert (or (not r_p2) (not r_p4) r_f6_p))
...
(assert (or (not r_p3) (not r_p5) r_f8_p))
...
;%~r_p3 | ~r_p6 | r_zcl_5
(assert (or (not r_p3) (not r_p6) r_zcl_5))
...
;%~r_p2 | ~r_p7 | r_zcl_6
(assert (or (not r_p2) (not r_p7) r_zcl_6))
...
(assert (or (not r_p2) (not r_p7) r_f11_p))
