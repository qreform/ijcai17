...
;%~zcl_17 | p12
(assert (or (not l_zcl_17) l_p12))

;%~zcl_17 | f21
(assert (or (not l_zcl_17) l_f21))

;%~p12 | ~f21 | zcl_17
(assert (or (not l_p12) (not l_f21) l_zcl_17))
...
;%~zcl_21 | p8
(assert (or (not l_zcl_21) l_p8))

;%~zcl_21 | f28
(assert (or (not l_zcl_21) l_f28))

;%~p8 | ~f28 | zcl_21
(assert (or (not l_p8) (not l_f28) l_zcl_21))
...
;%~p8 | ~f28_p | f27_p
(assert (or (not l_p8) (not l_f28_p) l_f27_p))
...
;%~p14 | ~f25 | zcl_24
(assert (or (not l_p14) (not l_f25) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p14 | ~f25_p | f24_p
(assert (or (not l_p14) (not l_f25_p) l_f24_p))
...
;%~p17 | ~p15 | zcl_25
(assert (or (not l_p17) (not l_p15) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p17 & ~p15) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p17 | ~p15 | f33_p
(assert (or (not l_p17) (not l_p15) l_f33_p))
...
;%~zcl_28 | p8
(assert (or (not l_zcl_28) l_p8))

;%~zcl_28 | f31
(assert (or (not l_zcl_28) l_f31))

;%~p8 | ~f31 | zcl_28
(assert (or (not l_p8) (not l_f31) l_zcl_28))
...
;%~zcl_29 | p16
(assert (or (not l_zcl_29) l_p16))

;%~zcl_29 | f30
(assert (or (not l_zcl_29) l_f30))

;%~p16 | ~f30 | zcl_29
(assert (or (not l_p16) (not l_f30) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((~p16 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p16 | ~f30_p | f29_p
(assert (or (not l_p16) (not l_f30_p) l_f29_p))
...
;%~r_p12 | ~r_f21 | r_zcl_17
(assert (or (not r_p12) (not r_f21) r_zcl_17))
...
;%~r_p8 | ~r_f28 | r_zcl_21
(assert (or (not r_p8) (not r_f28) r_zcl_21))
...
;%~r_p8 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p8) (not r_f28_p) r_f27_p))
...
;%~r_p14 | ~r_f25 | r_zcl_24
(assert (or (not r_p14) (not r_f25) r_zcl_24))
...
;%~r_p14 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p14) (not r_f25_p) r_f24_p))
...
;%~r_p17 | ~r_p15 | r_zcl_25
(assert (or (not r_p17) (not r_p15) r_zcl_25))
...
(assert (or (not r_p17) (not r_p15) r_f33_p))
...
;%~r_p8 | ~r_f31 | r_zcl_28
(assert (or (not r_p8) (not r_f31) r_zcl_28))
...
;%~r_p16 | ~r_f30 | r_zcl_29
(assert (or (not r_p16) (not r_f30) r_zcl_29))
...
;%~r_p16 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p16) (not r_f30_p) r_f29_p))
