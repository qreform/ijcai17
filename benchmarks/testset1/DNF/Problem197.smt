...
;%~p10 | ~f17 | zcl_15
(assert (or (not l_p10) (not l_f17) l_zcl_15))
...
;%~p9 | ~f16 | zcl_16
(assert (or (not l_p9) (not l_f16) l_zcl_16))
...
;%~p16 | ~f32 | zcl_26
(assert (or (not l_p16) (not l_f32) l_zcl_26))
...
;%~p21 | ~p18 | zcl_36
(assert (or (not l_p21) (not l_p18) l_zcl_36))
...
;%Non-clausified dependency
;%(forall[]((p21 & p18) --> f46_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f46_p () Bool)
;%~p21 | ~p18 | f46_p
(assert (or (not l_p21) (not l_p18) l_f46_p))
...
;%~zcl_38 | p20
(assert (or (not l_zcl_38) l_p20))

;%~zcl_38 | f45
(assert (or (not l_zcl_38) l_f45))

;%~p20 | ~f45 | zcl_38
(assert (or (not l_p20) (not l_f45) l_zcl_38))
...
;%Non-clausified dependency
;%(forall[]((p20 & f45_p) --> f44_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f44_p () Bool)
;%~p20 | ~f45_p | f44_p
(assert (or (not l_p20) (not l_f45_p) l_f44_p))
...
;%~p19 | ~f43 | zcl_40
(assert (or (not l_p19) (not l_f43) l_zcl_40))
...
;%Non-clausified dependency
;%(forall[]((p19 & f43_p) --> f42_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f42_p () Bool)
;%~p19 | ~f43_p | f42_p
(assert (or (not l_p19) (not l_f43_p) l_f42_p))
...
;%~r_p10 | ~r_f17 | r_zcl_15
(assert (or (not r_p10) (not r_f17) r_zcl_15))
...
;%~r_p9 | ~r_f16 | r_zcl_16
(assert (or (not r_p9) (not r_f16) r_zcl_16))
...
;%~r_p16 | ~r_f32 | r_zcl_26
(assert (or (not r_p16) (not r_f32) r_zcl_26))
...
;%~r_p21 | ~r_p18 | r_zcl_36
(assert (or (not r_p21) (not r_p18) r_zcl_36))
...
(assert (or (not r_p21) (not r_p18) r_f46_p))
...
;%~r_p20 | ~r_f45 | r_zcl_38
(assert (or (not r_p20) (not r_f45) r_zcl_38))
...
;%~r_p20 | ~r_f45_p | r_f44_p
(declare-fun r_f44_p () Bool)
(assert (or (not r_p20) (not r_f45_p) r_f44_p))
...
;%~r_p19 | ~r_f43 | r_zcl_40
(assert (or (not r_p19) (not r_f43) r_zcl_40))
...
;%~r_p19 | ~r_f43_p | r_f42_p
(declare-fun r_f42_p () Bool)
(assert (or (not r_p19) (not r_f43_p) r_f42_p))
