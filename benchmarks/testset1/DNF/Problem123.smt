...
;%~p9 | ~p7 | zcl_6
(assert (or (not l_p9) (not l_p7) l_zcl_6))
...
;%~p9 | ~p7 | f12_p
(assert (or (not l_p9) (not l_p7) l_f12_p))
...
;%~p8 | ~f9 | zcl_10
(assert (or (not l_p8) (not l_f9) l_zcl_10))
...
;%~p0 | ~p10 | zcl_12
(assert (or (not l_p0) (not l_p10) l_zcl_12))
...
;%~p0 | ~p10 | f19_p
(assert (or (not l_p0) (not l_p10) l_f19_p))
...
;%~p11 | ~f19 | zcl_13
(assert (or (not l_p11) (not l_f19) l_zcl_13))
...
;%~zcl_17 | p7
(assert (or (not l_zcl_17) l_p7))

;%~zcl_17 | f15
(assert (or (not l_zcl_17) l_f15))

;%~p7 | ~f15 | zcl_17
(assert (or (not l_p7) (not l_f15) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((p7 & f15_p) --> f14_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f14_p () Bool)
;%~p7 | ~f15_p | f14_p
(assert (or (not l_p7) (not l_f15_p) l_f14_p))
...
;%~zcl_19 | p14
(assert (or (not l_zcl_19) l_p14))

;%~zcl_19 | f26
(assert (or (not l_zcl_19) l_f26))

;%~p14 | ~f26 | zcl_19
(assert (or (not l_p14) (not l_f26) l_zcl_19))
...
;%~p13 | ~f25 | zcl_20
(assert (or (not l_p13) (not l_f25) l_zcl_20))
...
;%~zcl_21 | p7
(assert (or (not l_zcl_21) l_p7))

;%~zcl_21 | f24
(assert (or (not l_zcl_21) l_f24))

;%~p7 | ~f24 | zcl_21
(assert (or (not l_p7) (not l_f24) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p7 & f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p7 | ~f24_p | f23_p
(assert (or (not l_p7) (not l_f24_p) l_f23_p))
...
;%~zcl_25 | p7
(assert (or (not l_zcl_25) l_p7))

;%~zcl_25 | f33
(assert (or (not l_zcl_25) l_f33))

;%~p7 | ~f33 | zcl_25
(assert (or (not l_p7) (not l_f33) l_zcl_25))
...
;%~zcl_28 | p16
(assert (or (not l_zcl_28) l_p16))

;%~zcl_28 | f30
(assert (or (not l_zcl_28) l_f30))

;%~p16 | ~f30 | zcl_28
(assert (or (not l_p16) (not l_f30) l_zcl_28))
...
;%~p19 | ~p17 | zcl_30
(assert (or (not l_p19) (not l_p17) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p19 & p17) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p19 | ~p17 | f39_p
(assert (or (not l_p19) (not l_p17) l_f39_p))
...
;%~zcl_35 | p7
(assert (or (not l_zcl_35) l_p7))

;%~zcl_35 | f35
(assert (or (not l_zcl_35) l_f35))

;%~p7 | ~f35 | zcl_35
(assert (or (not l_p7) (not l_f35) l_zcl_35))
...
;%Non-clausified dependency
;%(forall[]((p7 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p7 | ~f35_p | f34_p
(assert (or (not l_p7) (not l_f35_p) l_f34_p))
...
;%~r_p9 | ~r_p7 | r_zcl_6
(assert (or (not r_p9) (not r_p7) r_zcl_6))
...
(assert (or (not r_p9) (not r_p7) r_f12_p))
...
;%~r_p8 | ~r_f9 | r_zcl_10
(assert (or (not r_p8) (not r_f9) r_zcl_10))
...
;%~r_p0 | ~r_p10 | r_zcl_12
(assert (or (not r_p0) (not r_p10) r_zcl_12))
...
(assert (or (not r_p0) (not r_p10) r_f19_p))
...
;%~r_p11 | ~r_f19 | r_zcl_13
(assert (or (not r_p11) (not r_f19) r_zcl_13))
...
;%~r_p7 | ~r_f15 | r_zcl_17
(assert (or (not r_p7) (not r_f15) r_zcl_17))
...
;%~r_p7 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p7) (not r_f15_p) r_f14_p))
...
;%~r_p14 | ~r_f26 | r_zcl_19
(assert (or (not r_p14) (not r_f26) r_zcl_19))
...
;%~r_p13 | ~r_f25 | r_zcl_20
(assert (or (not r_p13) (not r_f25) r_zcl_20))
...
;%~r_p7 | ~r_f24 | r_zcl_21
(assert (or (not r_p7) (not r_f24) r_zcl_21))
...
;%~r_p7 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p7) (not r_f24_p) r_f23_p))
...
;%~r_p7 | ~r_f33 | r_zcl_25
(assert (or (not r_p7) (not r_f33) r_zcl_25))
...
;%~r_p16 | ~r_f30 | r_zcl_28
(assert (or (not r_p16) (not r_f30) r_zcl_28))
...
;%~r_p19 | ~r_p17 | r_zcl_30
(assert (or (not r_p19) (not r_p17) r_zcl_30))
...
(assert (or (not r_p19) (not r_p17) r_f39_p))
...
;%~r_p7 | ~r_f35 | r_zcl_35
(assert (or (not r_p7) (not r_f35) r_zcl_35))
...
;%~r_p7 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p7) (not r_f35_p) r_f34_p))
