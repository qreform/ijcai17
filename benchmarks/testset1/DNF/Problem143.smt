...
;%~p8 | ~p7 | zcl_5
(assert (or (not l_p8) (not l_p7) l_zcl_5))
...
;%~p3 | ~p9 | zcl_6
(assert (or (not l_p3) (not l_p9) l_zcl_6))
...
;%~p3 | ~p9 | f11_p
(assert (or (not l_p3) (not l_p9) l_f11_p))
...
;%~r_p8 | ~r_p7 | r_zcl_5
(assert (or (not r_p8) (not r_p7) r_zcl_5))
...
;%~r_p3 | ~r_p9 | r_zcl_6
(assert (or (not r_p3) (not r_p9) r_zcl_6))
...
(assert (or (not r_p3) (not r_p9) r_f11_p))
