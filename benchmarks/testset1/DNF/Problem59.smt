...
;%~p12 | ~p10 | zcl_18
(assert (or (not l_p12) (not l_p10) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((~p12 & ~p10) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p12 | ~p10 | f26_p
(assert (or (not l_p12) (not l_p10) l_f26_p))
...
;%Non-clausified dependency
;%(forall[]((p16 & ~p13) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p16 | ~p13 | f32_p
(assert (or (not l_p16) (not l_p13) l_f32_p))
...
;%~r_p12 | ~r_p10 | r_zcl_18
(assert (or (not r_p12) (not r_p10) r_zcl_18))
...
(assert (or (not r_p12) (not r_p10) r_f26_p))
...
(assert (or (not r_p16) (not r_p13) r_f32_p))
