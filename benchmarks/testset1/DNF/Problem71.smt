...
;%~p2 | ~p4 | zcl_2
(assert (or (not l_p2) (not l_p4) l_zcl_2))
...
;%~p0 | ~p5 | zcl_3
(assert (or (not l_p0) (not l_p5) l_zcl_3))
...
;%~p0 | ~p5 | f6_p
(assert (or (not l_p0) (not l_p5) l_f6_p))
...
;%~p0 | ~p6 | zcl_4
(assert (or (not l_p0) (not l_p6) l_zcl_4))
...
;%~p4 | ~p7 | f9_p
(assert (or (not l_p4) (not l_p7) l_f9_p))
...
;%~r_p2 | ~r_p4 | r_zcl_2
(assert (or (not r_p2) (not r_p4) r_zcl_2))
...
;%~r_p0 | ~r_p5 | r_zcl_3
(assert (or (not r_p0) (not r_p5) r_zcl_3))
...
(assert (or (not r_p0) (not r_p5) r_f6_p))
...
;%~r_p0 | ~r_p6 | r_zcl_4
(assert (or (not r_p0) (not r_p6) r_zcl_4))
...
(assert (or (not r_p4) (not r_p7) r_f9_p))
