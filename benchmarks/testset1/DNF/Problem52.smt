...
;%~zcl_13 | p13
(assert (or (not l_zcl_13) l_p13))

;%~zcl_13 | f19
(assert (or (not l_zcl_13) l_f19))

;%~p13 | ~f19 | zcl_13
(assert (or (not l_p13) (not l_f19) l_zcl_13))
...
;%~p11 | ~f16 | zcl_16
(assert (or (not l_p11) (not l_f16) l_zcl_16))
...
;%~p17 | ~p14 | zcl_18
(assert (or (not l_p17) (not l_p14) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p17 & p14) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p17 | ~p14 | f26_p
(assert (or (not l_p17) (not l_p14) l_f26_p))
...
;%~p16 | ~f25 | zcl_20
(assert (or (not l_p16) (not l_f25) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p16 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p16 | ~f25_p | f24_p
(assert (or (not l_p16) (not l_f25_p) l_f24_p))
...
;%~p15 | ~f23 | zcl_22
(assert (or (not l_p15) (not l_f23) l_zcl_22))
...
;%~zcl_24 | p18
(assert (or (not l_zcl_24) l_p18))

;%~p0 | ~p18 | zcl_24
(assert (or (not l_p0) (not l_p18) l_zcl_24))
...
;%~p0 | ~p18 | f32_p
(assert (or (not l_p0) (not l_p18) l_f32_p))
...
;%~p20 | ~f32 | zcl_25
(assert (or (not l_p20) (not l_f32) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p20 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p20 | ~f32_p | f31_p
(assert (or (not l_p20) (not l_f32_p) l_f31_p))
...
;%~p7 | ~f31 | zcl_26
(assert (or (not l_p7) (not l_f31) l_zcl_26))
...
;%~p0 | ~f30 | zcl_27
(assert (or (not l_p0) (not l_f30) l_zcl_27))
...
;%~p7 | ~f29 | zcl_28
(assert (or (not l_p7) (not l_f29) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p7 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p7 | ~f29_p | f28_p
(assert (or (not l_p7) (not l_f29_p) l_f28_p))
...
;%~p19 | ~f28 | zcl_29
(assert (or (not l_p19) (not l_f28) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p19 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p19 | ~f28_p | f27_p
(assert (or (not l_p19) (not l_f28_p) l_f27_p))
...
;%~r_p13 | ~r_f19 | r_zcl_13
(assert (or (not r_p13) (not r_f19) r_zcl_13))
...
;%~r_p11 | ~r_f16 | r_zcl_16
(assert (or (not r_p11) (not r_f16) r_zcl_16))
...
;%~r_p17 | ~r_p14 | r_zcl_18
(assert (or (not r_p17) (not r_p14) r_zcl_18))
...
(assert (or (not r_p17) (not r_p14) r_f26_p))
...
;%~r_p16 | ~r_f25 | r_zcl_20
(assert (or (not r_p16) (not r_f25) r_zcl_20))
...
;%~r_p16 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p16) (not r_f25_p) r_f24_p))
...
;%~r_p15 | ~r_f23 | r_zcl_22
(assert (or (not r_p15) (not r_f23) r_zcl_22))
...
;%~r_zcl_24 | r_p18
(assert (or (not r_zcl_24) r_p18))


;%~r_p0 | ~r_p18 | r_zcl_24
(assert (or (not r_p0) (not r_p18) r_zcl_24))
...
(assert (or (not r_p0) (not r_p18) r_f32_p))
...
;%~r_p20 | ~r_f32 | r_zcl_25
(assert (or (not r_p20) (not r_f32) r_zcl_25))
...
;%~r_p20 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p20) (not r_f32_p) r_f31_p))
...
;%~r_p7 | ~r_f31 | r_zcl_26
(assert (or (not r_p7) (not r_f31) r_zcl_26))
...
;%~r_p0 | ~r_f30 | r_zcl_27
(assert (or (not r_p0) (not r_f30) r_zcl_27))
...
;%~r_p7 | ~r_f29 | r_zcl_28
(assert (or (not r_p7) (not r_f29) r_zcl_28))
...
;%~r_p7 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p7) (not r_f29_p) r_f28_p))
...
;%~r_p19 | ~r_f28 | r_zcl_29
(assert (or (not r_p19) (not r_f28) r_zcl_29))
...
;%~r_p19 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p19) (not r_f28_p) r_f27_p))
