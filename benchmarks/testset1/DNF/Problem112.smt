...
;%~zcl_15 | p9
(assert (or (not l_zcl_15) l_p9))

;%~p0 | ~p9 | zcl_15
(assert (or (not l_p0) (not l_p9) l_zcl_15))
...
;%~p0 | ~p9 | f22_p
(assert (or (not l_p0) (not l_p9) l_f22_p))
...
;%~zcl_17 | p10
(assert (or (not l_zcl_17) l_p10))

;%~zcl_17 | f21
(assert (or (not l_zcl_17) l_f21))

;%~p10 | ~f21 | zcl_17
(assert (or (not l_p10) (not l_f21) l_zcl_17))
...
;%~p0 | ~p11 | zcl_20
(assert (or (not l_p0) (not l_p11) l_zcl_20))
...
;%~p0 | ~p11 | f28_p
(assert (or (not l_p0) (not l_p11) l_f28_p))
...
;%~zcl_23 | p9
(assert (or (not l_zcl_23) l_p9))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p9 | ~f26 | zcl_23
(assert (or (not l_p9) (not l_f26) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((p9 & f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p9 | ~f26_p | f25_p
(assert (or (not l_p9) (not l_f26_p) l_f25_p))
...
;%~p15 | ~p14 | zcl_25
(assert (or (not l_p15) (not l_p14) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p15 & p14) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p15 | ~p14 | f33_p
(assert (or (not l_p15) (not l_p14) l_f33_p))
...
;%~p0 | ~f33 | zcl_26
(assert (or (not l_p0) (not l_f33) l_zcl_26))
...
;%~zcl_29 | p11
(assert (or (not l_zcl_29) l_p11))

;%~zcl_29 | f30
(assert (or (not l_zcl_29) l_f30))

;%~p11 | ~f30 | zcl_29
(assert (or (not l_p11) (not l_f30) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p11 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p11 | ~f30_p | f29_p
(assert (or (not l_p11) (not l_f30_p) l_f29_p))
...
;%~r_zcl_15 | r_p9
(assert (or (not r_zcl_15) r_p9))


;%~r_p0 | ~r_p9 | r_zcl_15
(assert (or (not r_p0) (not r_p9) r_zcl_15))
...
(assert (or (not r_p0) (not r_p9) r_f22_p))
...
;%~r_p10 | ~r_f21 | r_zcl_17
(assert (or (not r_p10) (not r_f21) r_zcl_17))
...
;%~r_p0 | ~r_p11 | r_zcl_20
(assert (or (not r_p0) (not r_p11) r_zcl_20))
...
(assert (or (not r_p0) (not r_p11) r_f28_p))
...
;%~r_p9 | ~r_f26 | r_zcl_23
(assert (or (not r_p9) (not r_f26) r_zcl_23))
...
;%~r_p9 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p9) (not r_f26_p) r_f25_p))
...
;%~r_p15 | ~r_p14 | r_zcl_25
(assert (or (not r_p15) (not r_p14) r_zcl_25))
...
(assert (or (not r_p15) (not r_p14) r_f33_p))
...
;%~r_p0 | ~r_f33 | r_zcl_26
(assert (or (not r_p0) (not r_f33) r_zcl_26))
...
;%~r_p11 | ~r_f30 | r_zcl_29
(assert (or (not r_p11) (not r_f30) r_zcl_29))
...
;%~r_p11 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p11) (not r_f30_p) r_f29_p))
