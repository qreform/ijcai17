...
;%~p11 | ~p12 | zcl_20
(assert (or (not l_p11) (not l_p12) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p11 & p12) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p11 | ~p12 | f27_p
(assert (or (not l_p11) (not l_p12) l_f27_p))
...
;%~p13 | ~f25 | zcl_23
(assert (or (not l_p13) (not l_f25) l_zcl_23))
...
;%~r_p11 | ~r_p12 | r_zcl_20
(assert (or (not r_p11) (not r_p12) r_zcl_20))
...
(assert (or (not r_p11) (not r_p12) r_f27_p))
...
;%~r_p13 | ~r_f25 | r_zcl_23
(assert (or (not r_p13) (not r_f25) r_zcl_23))
