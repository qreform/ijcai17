...
;%~zcl_17 | p14
(assert (or (not l_zcl_17) l_p14))

;%~zcl_17 | f21
(assert (or (not l_zcl_17) l_f21))

;%~p14 | ~f21 | zcl_17
(assert (or (not l_p14) (not l_f21) l_zcl_17))
...
;%~p0 | ~p15 | zcl_20
(assert (or (not l_p0) (not l_p15) l_zcl_20))
...
;%~p0 | ~p15 | f28_p
(assert (or (not l_p0) (not l_p15) l_f28_p))
...
;%~zcl_24 | p6
(assert (or (not l_zcl_24) l_p6))

;%~zcl_24 | f25
(assert (or (not l_zcl_24) l_f25))

;%~p6 | ~f25 | zcl_24
(assert (or (not l_p6) (not l_f25) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p6 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p6 | ~f25_p | f24_p
(assert (or (not l_p6) (not l_f25_p) l_f24_p))
...
;%~p0 | ~p16 | zcl_25
(assert (or (not l_p0) (not l_p16) l_zcl_25))
...
;%~p0 | ~p16 | f34_p
(assert (or (not l_p0) (not l_p16) l_f34_p))
...
;%~zcl_26 | p6
(assert (or (not l_zcl_26) l_p6))

;%~zcl_26 | f34
(assert (or (not l_zcl_26) l_f34))

;%~p6 | ~f34 | zcl_26
(assert (or (not l_p6) (not l_f34) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((~p6 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p6 | ~f34_p | f33_p
(assert (or (not l_p6) (not l_f34_p) l_f33_p))
...
;%~zcl_29 | p17
(assert (or (not l_zcl_29) l_p17))

;%~zcl_29 | f31
(assert (or (not l_zcl_29) l_f31))

;%~p17 | ~f31 | zcl_29
(assert (or (not l_p17) (not l_f31) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p17 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p17 | ~f31_p | f30_p
(assert (or (not l_p17) (not l_f31_p) l_f30_p))
...
;%~p0 | ~p18 | zcl_30
(assert (or (not l_p0) (not l_p18) l_zcl_30))
...
;%~p0 | ~p18 | f39_p
(assert (or (not l_p0) (not l_p18) l_f39_p))
...
;%~r_p14 | ~r_f21 | r_zcl_17
(assert (or (not r_p14) (not r_f21) r_zcl_17))
...
;%~r_p0 | ~r_p15 | r_zcl_20
(assert (or (not r_p0) (not r_p15) r_zcl_20))
...
(assert (or (not r_p0) (not r_p15) r_f28_p))
...
;%~r_p6 | ~r_f25 | r_zcl_24
(assert (or (not r_p6) (not r_f25) r_zcl_24))
...
;%~r_p6 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p6) (not r_f25_p) r_f24_p))
...
;%~r_p0 | ~r_p16 | r_zcl_25
(assert (or (not r_p0) (not r_p16) r_zcl_25))
...
(assert (or (not r_p0) (not r_p16) r_f34_p))


;%~r_zcl_26 | r_p6
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p6))
...
;%~r_p6 | ~r_f34 | r_zcl_26
(assert (or (not r_p6) (not r_f34) r_zcl_26))
...
;%~r_p6 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p6) (not r_f34_p) r_f33_p))
...
;%~r_p17 | ~r_f31 | r_zcl_29
(assert (or (not r_p17) (not r_f31) r_zcl_29))
...
;%~r_p17 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p17) (not r_f31_p) r_f30_p))
...
;%~r_p0 | ~r_p18 | r_zcl_30
(assert (or (not r_p0) (not r_p18) r_zcl_30))
...
(assert (or (not r_p0) (not r_p18) r_f39_p))
