...
;%Non-clausified dependency
;%(forall[]((p39 & p32) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p39 | ~p32 | f38_p
(assert (or (not l_p39) (not l_p32) l_f38_p))
...
;%~p38 | ~f38 | zcl_29
(assert (or (not l_p38) (not l_f38) l_zcl_29))
...
;%~p37 | ~f37 | zcl_30
(assert (or (not l_p37) (not l_f37) l_zcl_30))
...
;%~p36 | ~f36 | zcl_31
(assert (or (not l_p36) (not l_f36) l_zcl_31))
...
;%~p35 | ~f35 | zcl_32
(assert (or (not l_p35) (not l_f35) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p35 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p35 | ~f35_p | f34_p
(assert (or (not l_p35) (not l_f35_p) l_f34_p))
...
;%~p34 | ~f34 | zcl_33
(assert (or (not l_p34) (not l_f34) l_zcl_33))
...
;%~p33 | ~f33 | zcl_34
(assert (or (not l_p33) (not l_f33) l_zcl_34))
...
;%~zcl_35 | p47
(assert (or (not l_zcl_35) l_p47))

(declare-fun l_p40 () Bool)
;%~zcl_35 | p40
(assert (or (not l_zcl_35) l_p40))

;%~p47 | ~p40 | zcl_35
(assert (or (not l_p47) (not l_p40) l_zcl_35))
...
;%Non-clausified dependency
;%(forall[]((p47 & p40) --> f45_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f45_p () Bool)
;%~p47 | ~p40 | f45_p
(assert (or (not l_p47) (not l_p40) l_f45_p))
...
;%~zcl_36 | p46
(assert (or (not l_zcl_36) l_p46))

;%~zcl_36 | f45
(assert (or (not l_zcl_36) l_f45))

;%~p46 | ~f45 | zcl_36
(assert (or (not l_p46) (not l_f45) l_zcl_36))
...
;%~zcl_37 | p45
(assert (or (not l_zcl_37) l_p45))

;%~zcl_37 | f44
(assert (or (not l_zcl_37) l_f44))

;%~p45 | ~f44 | zcl_37
(assert (or (not l_p45) (not l_f44) l_zcl_37))
...
;%~zcl_38 | p44
(assert (or (not l_zcl_38) l_p44))

;%~zcl_38 | f43
(assert (or (not l_zcl_38) l_f43))

;%~p44 | ~f43 | zcl_38
(assert (or (not l_p44) (not l_f43) l_zcl_38))
...
;%~zcl_39 | p43
(assert (or (not l_zcl_39) l_p43))

;%~zcl_39 | f42
(assert (or (not l_zcl_39) l_f42))

;%~p43 | ~f42 | zcl_39
(assert (or (not l_p43) (not l_f42) l_zcl_39))
...
;%~zcl_40 | p42
(assert (or (not l_zcl_40) l_p42))

;%~zcl_40 | f41
(assert (or (not l_zcl_40) l_f41))

;%~p42 | ~f41 | zcl_40
(assert (or (not l_p42) (not l_f41) l_zcl_40))
...
;%Non-clausified dependency
;%(forall[]((p42 & f41_p) --> f40_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f40_p () Bool)
;%~p42 | ~f41_p | f40_p
(assert (or (not l_p42) (not l_f41_p) l_f40_p))
...
;%~zcl_41 | p41
(assert (or (not l_zcl_41) l_p41))

;%~zcl_41 | f40
(assert (or (not l_zcl_41) l_f40))

;%~p41 | ~f40 | zcl_41
(assert (or (not l_p41) (not l_f40) l_zcl_41))
...
;%Non-clausified dependency
;%(forall[]((p41 & f40_p) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p41 | ~f40_p | f39_p
(assert (or (not l_p41) (not l_f40_p) l_f39_p))
...
(assert (or (not r_p39) (not r_p32) r_f38_p))
...
;%~r_p38 | ~r_f38 | r_zcl_29
(assert (or (not r_p38) (not r_f38) r_zcl_29))
...
;%~r_p37 | ~r_f37 | r_zcl_30
(assert (or (not r_p37) (not r_f37) r_zcl_30))
...
;%~r_p36 | ~r_f36 | r_zcl_31
(assert (or (not r_p36) (not r_f36) r_zcl_31))
...
;%~r_p35 | ~r_f35 | r_zcl_32
(assert (or (not r_p35) (not r_f35) r_zcl_32))
...
;%~r_p35 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p35) (not r_f35_p) r_f34_p))
...
;%~r_p34 | ~r_f34 | r_zcl_33
(assert (or (not r_p34) (not r_f34) r_zcl_33))
...
;%~r_p33 | ~r_f33 | r_zcl_34
(assert (or (not r_p33) (not r_f33) r_zcl_34))
...
(assert (or (not r_zcl_35) r_p47))


;%~r_zcl_35 | r_p40
(assert (or (not r_zcl_35) r_p40))


;%~r_p47 | ~r_p40 | r_zcl_35
(assert (or (not r_p47) (not r_p40) r_zcl_35))
...
(assert (or (not r_p47) (not r_p40) r_f45_p))


;%~r_zcl_36 | r_p46
(declare-fun r_zcl_36 () Bool)
(assert (or (not r_zcl_36) r_p46))
...
;%~r_p46 | ~r_f45 | r_zcl_36
(assert (or (not r_p46) (not r_f45) r_zcl_36))
...
;%~r_p45 | ~r_f44 | r_zcl_37
(assert (or (not r_p45) (not r_f44) r_zcl_37))
...
;%~r_p44 | ~r_f43 | r_zcl_38
(assert (or (not r_p44) (not r_f43) r_zcl_38))
...
;%~r_p43 | ~r_f42 | r_zcl_39
(assert (or (not r_p43) (not r_f42) r_zcl_39))
...
;%~r_p42 | ~r_f41 | r_zcl_40
(assert (or (not r_p42) (not r_f41) r_zcl_40))
...
;%~r_p42 | ~r_f41_p | r_f40_p
(declare-fun r_f40_p () Bool)
(assert (or (not r_p42) (not r_f41_p) r_f40_p))


;%~r_zcl_41 | r_p41
(declare-fun r_zcl_41 () Bool)
(assert (or (not r_zcl_41) r_p41))
...
;%~r_p41 | ~r_f40 | r_zcl_41
(assert (or (not r_p41) (not r_f40) r_zcl_41))
...
;%~r_p41 | ~r_f40_p | r_f39_p
(declare-fun r_f39_p () Bool)
(assert (or (not r_p41) (not r_f40_p) r_f39_p))
