...
;%~p9 | ~f16 | zcl_15
(assert (or (not l_p9) (not l_f16) l_zcl_15))
...
;%~p13 | ~p12 | zcl_20
(assert (or (not l_p13) (not l_p12) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((~p13 & ~p12) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p13 | ~p12 | f27_p
(assert (or (not l_p13) (not l_p12) l_f27_p))
...
;%~r_p9 | ~r_f16 | r_zcl_15
(assert (or (not r_p9) (not r_f16) r_zcl_15))
...
;%~r_p13 | ~r_p12 | r_zcl_20
(assert (or (not r_p13) (not r_p12) r_zcl_20))
...
(assert (or (not r_p13) (not r_p12) r_f27_p))
