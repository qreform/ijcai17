...
;%~p0 | ~p11 | f27_p
(assert (or (not l_p0) (not l_p11) l_f27_p))
...
;%~p0 | ~f26 | zcl_22
(assert (or (not l_p0) (not l_f26) l_zcl_22))
...
;%~p12 | ~f24 | zcl_24
(assert (or (not l_p12) (not l_f24) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p12 & f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p12 | ~f24_p | f23_p
(assert (or (not l_p12) (not l_f24_p) l_f23_p))
...
(assert (or (not r_p0) (not r_p11) r_f27_p))
...
;%~r_p0 | ~r_f26 | r_zcl_22
(assert (or (not r_p0) (not r_f26) r_zcl_22))
...
;%~r_p12 | ~r_f24 | r_zcl_24
(assert (or (not r_p12) (not r_f24) r_zcl_24))
...
;%~r_p12 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p12) (not r_f24_p) r_f23_p))
