...
;%~p11 | ~p8 | zcl_7
(assert (or (not l_p11) (not l_p8) l_zcl_7))
...
;%~p11 | ~p8 | f14_p
(assert (or (not l_p11) (not l_p8) l_f14_p))
...
;%~p10 | ~f14 | zcl_8
(assert (or (not l_p10) (not l_f14) l_zcl_8))
...
;%~p8 | ~p12 | zcl_14
(assert (or (not l_p8) (not l_p12) l_zcl_14))
...
;%~p8 | ~p12 | f22_p
(assert (or (not l_p8) (not l_p12) l_f22_p))
...
;%~p14 | ~f22 | zcl_15
(assert (or (not l_p14) (not l_f22) l_zcl_15))
...
;%~p0 | ~f21 | zcl_16
(assert (or (not l_p0) (not l_f21) l_zcl_16))
...
;%~p0 | ~f19 | zcl_18
(assert (or (not l_p0) (not l_f19) l_zcl_18))
...
;%~p0 | ~p15 | zcl_21
(assert (or (not l_p0) (not l_p15) l_zcl_21))
...
;%~p0 | ~p15 | f30_p
(assert (or (not l_p0) (not l_p15) l_f30_p))
...
;%~p0 | ~f30 | zcl_22
(assert (or (not l_p0) (not l_f30) l_zcl_22))
...
;%~p12 | ~f27 | zcl_25
(assert (or (not l_p12) (not l_f27) l_zcl_25))
...
;%~p16 | ~f25 | zcl_27
(assert (or (not l_p16) (not l_f25) l_zcl_27))
...
;%~zcl_28 | p17
(assert (or (not l_zcl_28) l_p17))

;%~p19 | ~p17 | zcl_28
(assert (or (not l_p19) (not l_p17) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((~p19 & p17) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p19 | ~p17 | f38_p
(assert (or (not l_p19) (not l_p17) l_f38_p))
...
;%~p18 | ~f35 | zcl_32
(assert (or (not l_p18) (not l_f35) l_zcl_32))
...
;%~p0 | ~p20 | zcl_35
(assert (or (not l_p0) (not l_p20) l_zcl_35))
...
;%~p0 | ~p20 | f45_p
(assert (or (not l_p0) (not l_p20) l_f45_p))
...
;%~zcl_36 | p12
(assert (or (not l_zcl_36) l_p12))

;%~zcl_36 | f45
(assert (or (not l_zcl_36) l_f45))

;%~p12 | ~f45 | zcl_36
(assert (or (not l_p12) (not l_f45) l_zcl_36))
...
;%Non-clausified dependency
;%(forall[]((p12 & f45_p) --> f44_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f44_p () Bool)
;%~p12 | ~f45_p | f44_p
(assert (or (not l_p12) (not l_f45_p) l_f44_p))
...
;%~zcl_37 | p21
(assert (or (not l_zcl_37) l_p21))

;%~zcl_37 | f44
(assert (or (not l_zcl_37) l_f44))

;%~p21 | ~f44 | zcl_37
(assert (or (not l_p21) (not l_f44) l_zcl_37))
...
;%Non-clausified dependency
;%(forall[]((p21 & f44_p) --> f43_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f43_p () Bool)
;%~p21 | ~f44_p | f43_p
(assert (or (not l_p21) (not l_f44_p) l_f43_p))
...
;%~p0 | ~f42 | zcl_39
(assert (or (not l_p0) (not l_f42) l_zcl_39))
...
;%~r_p11 | ~r_p8 | r_zcl_7
(assert (or (not r_p11) (not r_p8) r_zcl_7))
...
(assert (or (not r_p11) (not r_p8) r_f14_p))
...
;%~r_p10 | ~r_f14 | r_zcl_8
(assert (or (not r_p10) (not r_f14) r_zcl_8))
...
;%~r_p8 | ~r_p12 | r_zcl_14
(assert (or (not r_p8) (not r_p12) r_zcl_14))
...
(assert (or (not r_p8) (not r_p12) r_f22_p))
...
;%~r_p14 | ~r_f22 | r_zcl_15
(assert (or (not r_p14) (not r_f22) r_zcl_15))
...
;%~r_p0 | ~r_f21 | r_zcl_16
(assert (or (not r_p0) (not r_f21) r_zcl_16))
...
;%~r_p0 | ~r_f19 | r_zcl_18
(assert (or (not r_p0) (not r_f19) r_zcl_18))
...
;%~r_p0 | ~r_p15 | r_zcl_21
(assert (or (not r_p0) (not r_p15) r_zcl_21))
...
(assert (or (not r_p0) (not r_p15) r_f30_p))
...
;%~r_p0 | ~r_f30 | r_zcl_22
(assert (or (not r_p0) (not r_f30) r_zcl_22))
...
;%~r_p12 | ~r_f27 | r_zcl_25
(assert (or (not r_p12) (not r_f27) r_zcl_25))
...
;%~r_p16 | ~r_f25 | r_zcl_27
(assert (or (not r_p16) (not r_f25) r_zcl_27))
...
;%~r_zcl_28 | r_p17
(assert (or (not r_zcl_28) r_p17))


;%~r_p19 | ~r_p17 | r_zcl_28
(assert (or (not r_p19) (not r_p17) r_zcl_28))
...
(assert (or (not r_p19) (not r_p17) r_f38_p))
...
;%~r_p18 | ~r_f35 | r_zcl_32
(assert (or (not r_p18) (not r_f35) r_zcl_32))
...
;%~r_p0 | ~r_p20 | r_zcl_35
(assert (or (not r_p0) (not r_p20) r_zcl_35))
...
(assert (or (not r_p0) (not r_p20) r_f45_p))


;%~r_zcl_36 | r_p12
(declare-fun r_zcl_36 () Bool)
(assert (or (not r_zcl_36) r_p12))
...
;%~r_p12 | ~r_f45 | r_zcl_36
(assert (or (not r_p12) (not r_f45) r_zcl_36))
...
;%~r_p12 | ~r_f45_p | r_f44_p
(declare-fun r_f44_p () Bool)
(assert (or (not r_p12) (not r_f45_p) r_f44_p))


;%~r_zcl_37 | r_p21
(declare-fun r_zcl_37 () Bool)
(assert (or (not r_zcl_37) r_p21))
...
;%~r_p21 | ~r_f44 | r_zcl_37
(assert (or (not r_p21) (not r_f44) r_zcl_37))
...
;%~r_p21 | ~r_f44_p | r_f43_p
(declare-fun r_f43_p () Bool)
(assert (or (not r_p21) (not r_f44_p) r_f43_p))
...
;%~r_p0 | ~r_f42 | r_zcl_39
(assert (or (not r_p0) (not r_f42) r_zcl_39))
