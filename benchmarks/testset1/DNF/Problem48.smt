...
;%~p8 | ~f16 | zcl_11
(assert (or (not l_p8) (not l_f16) l_zcl_11))
...
;%~p6 | ~p9 | zcl_15
(assert (or (not l_p6) (not l_p9) l_zcl_15))
...
;%~p6 | ~p9 | f22_p
(assert (or (not l_p6) (not l_p9) l_f22_p))
...
;%~zcl_18 | p7
(assert (or (not l_zcl_18) l_p7))

;%~zcl_18 | f20
(assert (or (not l_zcl_18) l_f20))

;%~p7 | ~f20 | zcl_18
(assert (or (not l_p7) (not l_f20) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p7 & f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p7 | ~f20_p | f19_p
(assert (or (not l_p7) (not l_f20_p) l_f19_p))
...
;%~p12 | ~p10 | zcl_20
(assert (or (not l_p12) (not l_p10) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p12 & ~p10) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p12 | ~p10 | f27_p
(assert (or (not l_p12) (not l_p10) l_f27_p))
...
;%~p11 | ~f24 | zcl_24
(assert (or (not l_p11) (not l_f24) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p11 | ~f24_p | f23_p
(assert (or (not l_p11) (not l_f24_p) l_f23_p))
...
;%~r_p8 | ~r_f16 | r_zcl_11
(assert (or (not r_p8) (not r_f16) r_zcl_11))
...
;%~r_p6 | ~r_p9 | r_zcl_15
(assert (or (not r_p6) (not r_p9) r_zcl_15))
...
(assert (or (not r_p6) (not r_p9) r_f22_p))
...
;%~r_p7 | ~r_f20 | r_zcl_18
(assert (or (not r_p7) (not r_f20) r_zcl_18))
...
;%~r_p7 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p7) (not r_f20_p) r_f19_p))
...
;%~r_p12 | ~r_p10 | r_zcl_20
(assert (or (not r_p12) (not r_p10) r_zcl_20))
...
(assert (or (not r_p12) (not r_p10) r_f27_p))
...
;%~r_p11 | ~r_f24 | r_zcl_24
(assert (or (not r_p11) (not r_f24) r_zcl_24))
...
;%~r_p11 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p11) (not r_f24_p) r_f23_p))
