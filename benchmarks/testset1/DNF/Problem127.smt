...
;%~p8 | ~f10 | zcl_9
(assert (or (not l_p8) (not l_f10) l_zcl_9))
...
;%~p7 | ~f17 | zcl_15
(assert (or (not l_p7) (not l_f17) l_zcl_15))
...
;%~p7 | ~f17_p | f16_p
(assert (or (not l_p7) (not l_f17_p) l_f16_p))
...
;%~p0 | ~f16 | zcl_16
(assert (or (not l_p0) (not l_f16) l_zcl_16))
...
;%~p0 | ~p12 | zcl_18
(assert (or (not l_p0) (not l_p12) l_zcl_18))
...
;%~p0 | ~p12 | f26_p
(assert (or (not l_p0) (not l_p12) l_f26_p))
...
;%~zcl_19 | p7
(assert (or (not l_zcl_19) l_p7))

;%~zcl_19 | f26
(assert (or (not l_zcl_19) l_f26))

;%~p7 | ~f26 | zcl_19
(assert (or (not l_p7) (not l_f26) l_zcl_19))
...
;%~p14 | ~f24 | zcl_21
(assert (or (not l_p14) (not l_f24) l_zcl_21))
...
;%~p13 | ~f22 | zcl_23
(assert (or (not l_p13) (not l_f22) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((p13 & f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p13 | ~f22_p | f21_p
(assert (or (not l_p13) (not l_f22_p) l_f21_p))
...
;%~zcl_24 | p15
(assert (or (not l_zcl_24) l_p15))

;%~p0 | ~p15 | zcl_24
(assert (or (not l_p0) (not l_p15) l_zcl_24))
...
;%~p0 | ~p15 | f33_p
(assert (or (not l_p0) (not l_p15) l_f33_p))
...
;%~p17 | ~f33 | zcl_25
(assert (or (not l_p17) (not l_f33) l_zcl_25))
...
;%~p7 | ~f32 | zcl_26
(assert (or (not l_p7) (not l_f32) l_zcl_26))
...
;%~p16 | ~f29 | zcl_29
(assert (or (not l_p16) (not l_f29) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p16 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p16 | ~f29_p | f28_p
(assert (or (not l_p16) (not l_f29_p) l_f28_p))
...
;%~p19 | ~p18 | zcl_30
(assert (or (not l_p19) (not l_p18) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p19 & p18) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p19 | ~p18 | f39_p
(assert (or (not l_p19) (not l_p18) l_f39_p))
...
;%~zcl_31 | p7
(assert (or (not l_zcl_31) l_p7))

;%~zcl_31 | f39
(assert (or (not l_zcl_31) l_f39))

;%~p7 | ~f39 | zcl_31
(assert (or (not l_p7) (not l_f39) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p7 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p7 | ~f39_p | f38_p
(assert (or (not l_p7) (not l_f39_p) l_f38_p))
...
;%~p0 | ~f35 | zcl_35
(assert (or (not l_p0) (not l_f35) l_zcl_35))
...
;%~r_p8 | ~r_f10 | r_zcl_9
(assert (or (not r_p8) (not r_f10) r_zcl_9))
...
;%~r_p7 | ~r_f17 | r_zcl_15
(assert (or (not r_p7) (not r_f17) r_zcl_15))
...
;%~r_p7 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p7) (not r_f17_p) r_f16_p))
...
;%~r_p0 | ~r_f16 | r_zcl_16
(assert (or (not r_p0) (not r_f16) r_zcl_16))
...
;%~r_p0 | ~r_p12 | r_zcl_18
(assert (or (not r_p0) (not r_p12) r_zcl_18))
...
(assert (or (not r_p0) (not r_p12) r_f26_p))


;%~r_zcl_19 | r_p7
(declare-fun r_zcl_19 () Bool)
(assert (or (not r_zcl_19) r_p7))
...
;%~r_p7 | ~r_f26 | r_zcl_19
(assert (or (not r_p7) (not r_f26) r_zcl_19))
...
;%~r_p14 | ~r_f24 | r_zcl_21
(assert (or (not r_p14) (not r_f24) r_zcl_21))
...
;%~r_p13 | ~r_f22 | r_zcl_23
(assert (or (not r_p13) (not r_f22) r_zcl_23))
...
;%~r_p13 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p13) (not r_f22_p) r_f21_p))
...
;%~r_zcl_24 | r_p15
(assert (or (not r_zcl_24) r_p15))


;%~r_p0 | ~r_p15 | r_zcl_24
(assert (or (not r_p0) (not r_p15) r_zcl_24))
...
(assert (or (not r_p0) (not r_p15) r_f33_p))
...
;%~r_p17 | ~r_f33 | r_zcl_25
(assert (or (not r_p17) (not r_f33) r_zcl_25))
...
;%~r_p7 | ~r_f32 | r_zcl_26
(assert (or (not r_p7) (not r_f32) r_zcl_26))
...
;%~r_p16 | ~r_f29 | r_zcl_29
(assert (or (not r_p16) (not r_f29) r_zcl_29))
...
;%~r_p16 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p16) (not r_f29_p) r_f28_p))


;%~r_zcl_30 | r_p19
(declare-fun r_zcl_30 () Bool)
(assert (or (not r_zcl_30) r_p19))
...
;%~r_p19 | ~r_p18 | r_zcl_30
(assert (or (not r_p19) (not r_p18) r_zcl_30))
...
(assert (or (not r_p19) (not r_p18) r_f39_p))


;%~r_zcl_31 | r_p7
(declare-fun r_zcl_31 () Bool)
(assert (or (not r_zcl_31) r_p7))
...
;%~r_p7 | ~r_f39 | r_zcl_31
(assert (or (not r_p7) (not r_f39) r_zcl_31))
...
;%~r_p7 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p7) (not r_f39_p) r_f38_p))
...
;%~r_p0 | ~r_f35 | r_zcl_35
(assert (or (not r_p0) (not r_f35) r_zcl_35))
