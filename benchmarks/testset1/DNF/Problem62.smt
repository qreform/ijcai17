...
;%~p11 | ~f29 | zcl_23
(assert (or (not l_p11) (not l_f29) l_zcl_23))
...
;%~p16 | ~p14 | zcl_28
(assert (or (not l_p16) (not l_p14) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p16 & p14) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p16 | ~p14 | f37_p
(assert (or (not l_p16) (not l_p14) l_f37_p))
...
;%~p0 | ~f36 | zcl_30
(assert (or (not l_p0) (not l_f36) l_zcl_30))
...
;%~zcl_31 | p15
(assert (or (not l_zcl_31) l_p15))

;%~zcl_31 | f35
(assert (or (not l_zcl_31) l_f35))

;%~p15 | ~f35 | zcl_31
(assert (or (not l_p15) (not l_f35) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p15 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p15 | ~f35_p | f34_p
(assert (or (not l_p15) (not l_f35_p) l_f34_p))
...
;%~p8 | ~f32 | zcl_34
(assert (or (not l_p8) (not l_f32) l_zcl_34))
...
;%~r_p11 | ~r_f29 | r_zcl_23
(assert (or (not r_p11) (not r_f29) r_zcl_23))
...
;%~r_p16 | ~r_p14 | r_zcl_28
(assert (or (not r_p16) (not r_p14) r_zcl_28))
...
(assert (or (not r_p16) (not r_p14) r_f37_p))
...
;%~r_p0 | ~r_f36 | r_zcl_30
(assert (or (not r_p0) (not r_f36) r_zcl_30))
...
;%~r_p15 | ~r_f35 | r_zcl_31
(assert (or (not r_p15) (not r_f35) r_zcl_31))
...
;%~r_p15 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p15) (not r_f35_p) r_f34_p))
...
;%~r_p8 | ~r_f32 | r_zcl_34
(assert (or (not r_p8) (not r_f32) r_zcl_34))
