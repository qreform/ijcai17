...
;%~p4 | ~p11 | f22_p
(assert (or (not l_p4) (not l_p11) l_f22_p))
...
;%~p13 | ~p12 | zcl_18
(assert (or (not l_p13) (not l_p12) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p13 & ~p12) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p13 | ~p12 | f25_p
(assert (or (not l_p13) (not l_p12) l_f25_p))
...
;%~p11 | ~f24 | zcl_20
(assert (or (not l_p11) (not l_f24) l_zcl_20))
...
(assert (or (not r_p4) (not r_p11) r_f22_p))
...
;%~r_p13 | ~r_p12 | r_zcl_18
(assert (or (not r_p13) (not r_p12) r_zcl_18))
...
(assert (or (not r_p13) (not r_p12) r_f25_p))
...
;%~r_p11 | ~r_f24 | r_zcl_20
(assert (or (not r_p11) (not r_f24) r_zcl_20))
