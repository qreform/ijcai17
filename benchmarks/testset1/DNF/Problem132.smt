...
;%~p0 | ~p9 | zcl_14
(assert (or (not l_p0) (not l_p9) l_zcl_14))
...
;%~zcl_21 | p10
(assert (or (not l_zcl_21) l_p10))

;%~p0 | ~p10 | zcl_21
(assert (or (not l_p0) (not l_p10) l_zcl_21))
...
;%~p0 | ~p10 | f30_p
(assert (or (not l_p0) (not l_p10) l_f30_p))
...
;%~p11 | ~f28 | zcl_24
(assert (or (not l_p11) (not l_f28) l_zcl_24))
...
;%~p9 | ~f26 | zcl_26
(assert (or (not l_p9) (not l_f26) l_zcl_26))
...
;%~p0 | ~p12 | zcl_28
(assert (or (not l_p0) (not l_p12) l_zcl_28))
...
;%~p0 | ~p12 | f38_p
(assert (or (not l_p0) (not l_p12) l_f38_p))
...
;%~p8 | ~f38 | zcl_29
(assert (or (not l_p8) (not l_f38) l_zcl_29))
...
;%~zcl_30 | p10
(assert (or (not l_zcl_30) l_p10))

;%~zcl_30 | f37
(assert (or (not l_zcl_30) l_f37))

;%~p10 | ~f37 | zcl_30
(assert (or (not l_p10) (not l_f37) l_zcl_30))
...
;%~zcl_33 | p9
(assert (or (not l_zcl_33) l_p9))

;%~zcl_33 | f34
(assert (or (not l_zcl_33) l_f34))

;%~p9 | ~f34 | zcl_33
(assert (or (not l_p9) (not l_f34) l_zcl_33))
...
;%~p0 | ~f33 | zcl_34
(assert (or (not l_p0) (not l_f33) l_zcl_34))
...
;%~p0 | ~p13 | zcl_35
(assert (or (not l_p0) (not l_p13) l_zcl_35))
...
;%~p0 | ~p13 | f45_p
(assert (or (not l_p0) (not l_p13) l_f45_p))
...
;%~zcl_41 | p10
(assert (or (not l_zcl_41) l_p10))

;%~zcl_41 | f40
(assert (or (not l_zcl_41) l_f40))

;%~p10 | ~f40 | zcl_41
(assert (or (not l_p10) (not l_f40) l_zcl_41))
...
;%Non-clausified dependency
;%(forall[]((p10 & f40_p) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p10 | ~f40_p | f39_p
(assert (or (not l_p10) (not l_f40_p) l_f39_p))
...
;%~r_p0 | ~r_p9 | r_zcl_14
(assert (or (not r_p0) (not r_p9) r_zcl_14))
...
;%~r_zcl_21 | r_p10
(assert (or (not r_zcl_21) r_p10))


;%~r_p0 | ~r_p10 | r_zcl_21
(assert (or (not r_p0) (not r_p10) r_zcl_21))
...
(assert (or (not r_p0) (not r_p10) r_f30_p))
...
;%~r_p11 | ~r_f28 | r_zcl_24
(assert (or (not r_p11) (not r_f28) r_zcl_24))
...
;%~r_p9 | ~r_f26 | r_zcl_26
(assert (or (not r_p9) (not r_f26) r_zcl_26))
...
;%~r_p0 | ~r_p12 | r_zcl_28
(assert (or (not r_p0) (not r_p12) r_zcl_28))
...
(assert (or (not r_p0) (not r_p12) r_f38_p))
...
;%~r_p8 | ~r_f38 | r_zcl_29
(assert (or (not r_p8) (not r_f38) r_zcl_29))
...
;%~r_p10 | ~r_f37 | r_zcl_30
(assert (or (not r_p10) (not r_f37) r_zcl_30))
...
;%~r_p9 | ~r_f34 | r_zcl_33
(assert (or (not r_p9) (not r_f34) r_zcl_33))
...
;%~r_p0 | ~r_f33 | r_zcl_34
(assert (or (not r_p0) (not r_f33) r_zcl_34))
...
;%~r_p0 | ~r_p13 | r_zcl_35
(assert (or (not r_p0) (not r_p13) r_zcl_35))
...
(assert (or (not r_p0) (not r_p13) r_f45_p))
...
;%~r_p10 | ~r_f40 | r_zcl_41
(assert (or (not r_p10) (not r_f40) r_zcl_41))
...
;%~r_p10 | ~r_f40_p | r_f39_p
(declare-fun r_f39_p () Bool)
(assert (or (not r_p10) (not r_f40_p) r_f39_p))
