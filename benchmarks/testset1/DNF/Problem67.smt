...
;%~p14 | ~p12 | zcl_14
(assert (or (not l_p14) (not l_p12) l_zcl_14))
...
;%~p13 | ~f17 | zcl_20
(assert (or (not l_p13) (not l_f17) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((~p13 & f17_p) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p13 | ~f17_p | f16_p
(assert (or (not l_p13) (not l_f17_p) l_f16_p))
...
;%~p18 | ~p16 | zcl_28
(assert (or (not l_p18) (not l_p16) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((~p18 & ~p16) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p18 | ~p16 | f37_p
(assert (or (not l_p18) (not l_p16) l_f37_p))
...
;%~zcl_32 | p17
(assert (or (not l_zcl_32) l_p17))

;%~zcl_32 | f34
(assert (or (not l_zcl_32) l_f34))

;%~p17 | ~f34 | zcl_32
(assert (or (not l_p17) (not l_f34) l_zcl_32))
...
;%~r_p14 | ~r_p12 | r_zcl_14
(assert (or (not r_p14) (not r_p12) r_zcl_14))
...
;%~r_p13 | ~r_f17 | r_zcl_20
(assert (or (not r_p13) (not r_f17) r_zcl_20))
...
;%~r_p13 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p13) (not r_f17_p) r_f16_p))
...
;%~r_p18 | ~r_p16 | r_zcl_28
(assert (or (not r_p18) (not r_p16) r_zcl_28))
...
(assert (or (not r_p18) (not r_p16) r_f37_p))
...
;%~r_p17 | ~r_f34 | r_zcl_32
(assert (or (not r_p17) (not r_f34) r_zcl_32))
