...
;%~p6 | ~f13 | zcl_11
(assert (or (not l_p6) (not l_f13) l_zcl_11))
...
;%~p0 | ~p11 | f18_p
(assert (or (not l_p0) (not l_p11) l_f18_p))
...
;%~p11 | ~p12 | zcl_15
(assert (or (not l_p11) (not l_p12) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((p11 & p12) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p11 | ~p12 | f21_p
(assert (or (not l_p11) (not l_p12) l_f21_p))
...
;%~p6 | ~f21 | zcl_16
(assert (or (not l_p6) (not l_f21) l_zcl_16))
...
;%~p9 | ~f20 | zcl_17
(assert (or (not l_p9) (not l_f20) l_zcl_17))
...
;%~r_p6 | ~r_f13 | r_zcl_11
(assert (or (not r_p6) (not r_f13) r_zcl_11))
...
(assert (or (not r_p0) (not r_p11) r_f18_p))
...
;%~r_p11 | ~r_p12 | r_zcl_15
(assert (or (not r_p11) (not r_p12) r_zcl_15))
...
(assert (or (not r_p11) (not r_p12) r_f21_p))
...
;%~r_p6 | ~r_f21 | r_zcl_16
(assert (or (not r_p6) (not r_f21) r_zcl_16))
...
;%~r_p9 | ~r_f20 | r_zcl_17
(assert (or (not r_p9) (not r_f20) r_zcl_17))
