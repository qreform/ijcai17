...
;%~p10 | ~p7 | zcl_6
(assert (or (not l_p10) (not l_p7) l_zcl_6))
...
;%~p10 | ~p7 | f12_p
(assert (or (not l_p10) (not l_p7) l_f12_p))
...
;%~p9 | ~f12 | zcl_7
(assert (or (not l_p9) (not l_f12) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p9 & f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p9 | ~f12_p | f11_p
(assert (or (not l_p9) (not l_f12_p) l_f11_p))
...
;%~p8 | ~f11 | zcl_8
(assert (or (not l_p8) (not l_f11) l_zcl_8))
...
;%~p8 | ~f11_p | f10_p
(assert (or (not l_p8) (not l_f11_p) l_f10_p))
...
;%~p0 | ~f8 | zcl_11
(assert (or (not l_p0) (not l_f8) l_zcl_11))
...
;%~p0 | ~p11 | zcl_12
(assert (or (not l_p0) (not l_p11) l_zcl_12))
...
;%~p7 | ~f18 | zcl_14
(assert (or (not l_p7) (not l_f18) l_zcl_14))
...
;%~p12 | ~f17 | zcl_15
(assert (or (not l_p12) (not l_f17) l_zcl_15))
...
;%~zcl_16 | p7
(assert (or (not l_zcl_16) l_p7))

;%~zcl_16 | f16
(assert (or (not l_zcl_16) l_f16))

;%~p7 | ~f16 | zcl_16
(assert (or (not l_p7) (not l_f16) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((p7 & f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p7 | ~f16_p | f15_p
(assert (or (not l_p7) (not l_f16_p) l_f15_p))
...
;%~p0 | ~p13 | f26_p
(assert (or (not l_p0) (not l_p13) l_f26_p))
...
;%~p7 | ~f25 | zcl_20
(assert (or (not l_p7) (not l_f25) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p7 & f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p7 | ~f25_p | f24_p
(assert (or (not l_p7) (not l_f25_p) l_f24_p))
...
;%~p0 | ~f24 | zcl_21
(assert (or (not l_p0) (not l_f24) l_zcl_21))
...
;%~p0 | ~f24_p | f23_p
(assert (or (not l_p0) (not l_f24_p) l_f23_p))
...
;%~zcl_22 | p7
(assert (or (not l_zcl_22) l_p7))

;%~zcl_22 | f23
(assert (or (not l_zcl_22) l_f23))

;%~p7 | ~f23 | zcl_22
(assert (or (not l_p7) (not l_f23) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((p7 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p7 | ~f23_p | f22_p
(assert (or (not l_p7) (not l_f23_p) l_f22_p))
...
;%~p0 | ~f22 | zcl_23
(assert (or (not l_p0) (not l_f22) l_zcl_23))
...
;%~p0 | ~p14 | zcl_24
(assert (or (not l_p0) (not l_p14) l_zcl_24))
...
;%~p16 | ~f33 | zcl_25
(assert (or (not l_p16) (not l_f33) l_zcl_25))
...
;%~zcl_27 | p7
(assert (or (not l_zcl_27) l_p7))

;%~zcl_27 | f31
(assert (or (not l_zcl_27) l_f31))

;%~p7 | ~f31 | zcl_27
(assert (or (not l_p7) (not l_f31) l_zcl_27))
...
;%~p15 | ~f30 | zcl_28
(assert (or (not l_p15) (not l_f30) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p15 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p15 | ~f30_p | f29_p
(assert (or (not l_p15) (not l_f30_p) l_f29_p))
...
;%~p0 | ~f29 | zcl_29
(assert (or (not l_p0) (not l_f29) l_zcl_29))
...
;%~p0 | ~p17 | f40_p
(assert (or (not l_p0) (not l_p17) l_f40_p))
...
;%~p19 | ~f40 | zcl_31
(assert (or (not l_p19) (not l_f40) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p19 & f40_p) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p19 | ~f40_p | f39_p
(assert (or (not l_p19) (not l_f40_p) l_f39_p))
...
;%~zcl_32 | p18
(assert (or (not l_zcl_32) l_p18))

;%~zcl_32 | f39
(assert (or (not l_zcl_32) l_f39))

;%~p18 | ~f39 | zcl_32
(assert (or (not l_p18) (not l_f39) l_zcl_32))
...
;%~p0 | ~f38 | zcl_33
(assert (or (not l_p0) (not l_f38) l_zcl_33))
...
;%~p0 | ~f37 | zcl_34
(assert (or (not l_p0) (not l_f37) l_zcl_34))
...
;%~zcl_36 | p20
(assert (or (not l_zcl_36) l_p20))

;%~p0 | ~p20 | zcl_36
(assert (or (not l_p0) (not l_p20) l_zcl_36))
...
;%~p0 | ~p20 | f46_p
(assert (or (not l_p0) (not l_p20) l_f46_p))
...
;%~zcl_38 | p0
(assert (or (not l_zcl_38) l_p0))

;%~zcl_38 | f45
(assert (or (not l_zcl_38) l_f45))

;%~p0 | ~f45 | zcl_38
(assert (or (not l_p0) (not l_f45) l_zcl_38))
...
;%~zcl_39 | p0
(assert (or (not l_zcl_39) l_p0))

;%~zcl_39 | f44
(assert (or (not l_zcl_39) l_f44))

;%~p0 | ~f44 | zcl_39
(assert (or (not l_p0) (not l_f44) l_zcl_39))
...
;%Non-clausified dependency
;%(forall[]((p0 & f44_p) --> f43_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f43_p () Bool)
;%~p0 | ~f44_p | f43_p
(assert (or (not l_p0) (not l_f44_p) l_f43_p))
...
;%~zcl_41 | p0
(assert (or (not l_zcl_41) l_p0))

;%~zcl_41 | f42
(assert (or (not l_zcl_41) l_f42))

;%~p0 | ~f42 | zcl_41
(assert (or (not l_p0) (not l_f42) l_zcl_41))
...
;%Non-clausified dependency
;%(forall[]((p0 & f42_p) --> f41_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f41_p () Bool)
;%~p0 | ~f42_p | f41_p
(assert (or (not l_p0) (not l_f42_p) l_f41_p))
...
;%~r_p10 | ~r_p7 | r_zcl_6
(assert (or (not r_p10) (not r_p7) r_zcl_6))
...
(assert (or (not r_p10) (not r_p7) r_f12_p))
...
;%~r_p9 | ~r_f12 | r_zcl_7
(assert (or (not r_p9) (not r_f12) r_zcl_7))
...
;%~r_p9 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p9) (not r_f12_p) r_f11_p))
...
;%~r_p8 | ~r_f11 | r_zcl_8
(assert (or (not r_p8) (not r_f11) r_zcl_8))
...
;%~r_p8 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p8) (not r_f11_p) r_f10_p))
...
;%~r_p0 | ~r_f8 | r_zcl_11
(assert (or (not r_p0) (not r_f8) r_zcl_11))
...
;%~r_p0 | ~r_p11 | r_zcl_12
(assert (or (not r_p0) (not r_p11) r_zcl_12))
...
;%~r_p7 | ~r_f18 | r_zcl_14
(assert (or (not r_p7) (not r_f18) r_zcl_14))
...
;%~r_p12 | ~r_f17 | r_zcl_15
(assert (or (not r_p12) (not r_f17) r_zcl_15))
...
;%~r_p7 | ~r_f16 | r_zcl_16
(assert (or (not r_p7) (not r_f16) r_zcl_16))
...
;%~r_p7 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p7) (not r_f16_p) r_f15_p))
...
(assert (or (not r_p0) (not r_p13) r_f26_p))
...
;%~r_p7 | ~r_f25 | r_zcl_20
(assert (or (not r_p7) (not r_f25) r_zcl_20))
...
;%~r_p7 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p7) (not r_f25_p) r_f24_p))
...
;%~r_p0 | ~r_f24 | r_zcl_21
(assert (or (not r_p0) (not r_f24) r_zcl_21))
...
;%~r_p0 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p0) (not r_f24_p) r_f23_p))


;%~r_zcl_22 | r_p7
(declare-fun r_zcl_22 () Bool)
(assert (or (not r_zcl_22) r_p7))
...
;%~r_p7 | ~r_f23 | r_zcl_22
(assert (or (not r_p7) (not r_f23) r_zcl_22))
...
;%~r_p7 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p7) (not r_f23_p) r_f22_p))
...
;%~r_p0 | ~r_f22 | r_zcl_23
(assert (or (not r_p0) (not r_f22) r_zcl_23))
...
;%~r_p0 | ~r_p14 | r_zcl_24
(assert (or (not r_p0) (not r_p14) r_zcl_24))
...
;%~r_p16 | ~r_f33 | r_zcl_25
(assert (or (not r_p16) (not r_f33) r_zcl_25))
...
;%~r_p7 | ~r_f31 | r_zcl_27
(assert (or (not r_p7) (not r_f31) r_zcl_27))
...
;%~r_p15 | ~r_f30 | r_zcl_28
(assert (or (not r_p15) (not r_f30) r_zcl_28))
...
;%~r_p15 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p15) (not r_f30_p) r_f29_p))
...
;%~r_p0 | ~r_f29 | r_zcl_29
(assert (or (not r_p0) (not r_f29) r_zcl_29))
...
(assert (or (not r_p0) (not r_p17) r_f40_p))
...
;%~r_p19 | ~r_f40 | r_zcl_31
(assert (or (not r_p19) (not r_f40) r_zcl_31))
...
;%~r_p19 | ~r_f40_p | r_f39_p
(declare-fun r_f39_p () Bool)
(assert (or (not r_p19) (not r_f40_p) r_f39_p))


;%~r_zcl_32 | r_p18
(declare-fun r_zcl_32 () Bool)
(assert (or (not r_zcl_32) r_p18))
...
;%~r_p18 | ~r_f39 | r_zcl_32
(assert (or (not r_p18) (not r_f39) r_zcl_32))
...
;%~r_p0 | ~r_f38 | r_zcl_33
(assert (or (not r_p0) (not r_f38) r_zcl_33))
...
;%~r_p0 | ~r_f37 | r_zcl_34
(assert (or (not r_p0) (not r_f37) r_zcl_34))
...
;%~r_zcl_36 | r_p20
(assert (or (not r_zcl_36) r_p20))


;%~r_p0 | ~r_p20 | r_zcl_36
(assert (or (not r_p0) (not r_p20) r_zcl_36))
...
(assert (or (not r_p0) (not r_p20) r_f46_p))
...
;%~r_p0 | ~r_f45 | r_zcl_38
(assert (or (not r_p0) (not r_f45) r_zcl_38))
...
;%~r_p0 | ~r_f44 | r_zcl_39
(assert (or (not r_p0) (not r_f44) r_zcl_39))
...
;%~r_p0 | ~r_f44_p | r_f43_p
(declare-fun r_f43_p () Bool)
(assert (or (not r_p0) (not r_f44_p) r_f43_p))
...
;%~r_p0 | ~r_f42 | r_zcl_41
(assert (or (not r_p0) (not r_f42) r_zcl_41))
...
;%~r_p0 | ~r_f42_p | r_f41_p
(declare-fun r_f41_p () Bool)
(assert (or (not r_p0) (not r_f42_p) r_f41_p))
