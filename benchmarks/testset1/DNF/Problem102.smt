...
;%~p12 | ~p9 | zcl_12
(assert (or (not l_p12) (not l_p9) l_zcl_12))
...
;%~p12 | ~p9 | f18_p
(assert (or (not l_p12) (not l_p9) l_f18_p))
...
;%~p11 | ~f18 | zcl_13
(assert (or (not l_p11) (not l_f18) l_zcl_13))
...
;%~p14 | ~f22 | zcl_18
(assert (or (not l_p14) (not l_f22) l_zcl_18))
...
;%~p13 | ~p16 | zcl_20
(assert (or (not l_p13) (not l_p16) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p13 & p16) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p13 | ~p16 | f27_p
(assert (or (not l_p13) (not l_p16) l_f27_p))
...
;%~p8 | ~f27 | zcl_21
(assert (or (not l_p8) (not l_f27) l_zcl_21))
...
;%~r_p12 | ~r_p9 | r_zcl_12
(assert (or (not r_p12) (not r_p9) r_zcl_12))
...
(assert (or (not r_p12) (not r_p9) r_f18_p))
...
;%~r_p11 | ~r_f18 | r_zcl_13
(assert (or (not r_p11) (not r_f18) r_zcl_13))
...
;%~r_p14 | ~r_f22 | r_zcl_18
(assert (or (not r_p14) (not r_f22) r_zcl_18))
...
;%~r_p13 | ~r_p16 | r_zcl_20
(assert (or (not r_p13) (not r_p16) r_zcl_20))
...
(assert (or (not r_p13) (not r_p16) r_f27_p))
...
;%~r_p8 | ~r_f27 | r_zcl_21
(assert (or (not r_p8) (not r_f27) r_zcl_21))
