...
;%~p5 | ~p10 | zcl_15
(assert (or (not l_p5) (not l_p10) l_zcl_15))
...
;%~p5 | ~p10 | f21_p
(assert (or (not l_p5) (not l_p10) l_f21_p))
...
;%~p5 | ~f21 | zcl_16
(assert (or (not l_p5) (not l_f21) l_zcl_16))
...
;%~r_p5 | ~r_p10 | r_zcl_15
(assert (or (not r_p5) (not r_p10) r_zcl_15))
...
(assert (or (not r_p5) (not r_p10) r_f21_p))
...
;%~r_p5 | ~r_f21 | r_zcl_16
(assert (or (not r_p5) (not r_f21) r_zcl_16))
