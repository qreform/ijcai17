...
;%~p0 | ~p6 | zcl_5
(assert (or (not l_p0) (not l_p6) l_zcl_5))
...
;%~p7 | ~f10 | zcl_6
(assert (or (not l_p7) (not l_f10) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p7 & f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p7 | ~f10_p | f9_p
(assert (or (not l_p7) (not l_f10_p) l_f9_p))
...
;%~p0 | ~f8 | zcl_8
(assert (or (not l_p0) (not l_f8) l_zcl_8))
...
;%~p0 | ~f7 | zcl_9
(assert (or (not l_p0) (not l_f7) l_zcl_9))
...
;%~p11 | ~p8 | zcl_10
(assert (or (not l_p11) (not l_p8) l_zcl_10))
...
;%~p11 | ~p8 | f16_p
(assert (or (not l_p11) (not l_p8) l_f16_p))
...
;%~p0 | ~f16 | zcl_11
(assert (or (not l_p0) (not l_f16) l_zcl_11))
...
;%~p10 | ~f15 | zcl_12
(assert (or (not l_p10) (not l_f15) l_zcl_12))
...
;%~p10 | ~f15_p | f14_p
(assert (or (not l_p10) (not l_f15_p) l_f14_p))
...
;%~p0 | ~f14 | zcl_13
(assert (or (not l_p0) (not l_f14) l_zcl_13))
...
;%~zcl_14 | p9
(assert (or (not l_zcl_14) l_p9))

;%~zcl_14 | f13
(assert (or (not l_zcl_14) l_f13))

;%~p9 | ~f13 | zcl_14
(assert (or (not l_p9) (not l_f13) l_zcl_14))
...
;%~p9 | ~f13_p | f12_p
(assert (or (not l_p9) (not l_f13_p) l_f12_p))
...
;%~p0 | ~p12 | zcl_15
(assert (or (not l_p0) (not l_p12) l_zcl_15))
...
;%~p0 | ~f22 | zcl_16
(assert (or (not l_p0) (not l_f22) l_zcl_16))
...
;%~zcl_17 | p8
(assert (or (not l_zcl_17) l_p8))

;%~zcl_17 | f21
(assert (or (not l_zcl_17) l_f21))

;%~p8 | ~f21 | zcl_17
(assert (or (not l_p8) (not l_f21) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((p8 & f21_p) --> f20_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f20_p () Bool)
;%~p8 | ~f21_p | f20_p
(assert (or (not l_p8) (not l_f21_p) l_f20_p))
...
;%~p13 | ~f20 | zcl_18
(assert (or (not l_p13) (not l_f20) l_zcl_18))
...
;%~p0 | ~f19 | zcl_19
(assert (or (not l_p0) (not l_f19) l_zcl_19))
...
;%~p16 | ~p14 | zcl_20
(assert (or (not l_p16) (not l_p14) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p16 & p14) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p16 | ~p14 | f28_p
(assert (or (not l_p16) (not l_p14) l_f28_p))
...
;%~p0 | ~f28 | zcl_21
(assert (or (not l_p0) (not l_f28) l_zcl_21))
...
;%~p0 | ~f27 | zcl_22
(assert (or (not l_p0) (not l_f27) l_zcl_22))
...
;%~zcl_23 | p15
(assert (or (not l_zcl_23) l_p15))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p15 | ~f26 | zcl_23
(assert (or (not l_p15) (not l_f26) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((p15 & f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p15 | ~f26_p | f25_p
(assert (or (not l_p15) (not l_f26_p) l_f25_p))
...
;%~p0 | ~f25 | zcl_24
(assert (or (not l_p0) (not l_f25) l_zcl_24))
...
;%~zcl_25 | p20
(assert (or (not l_zcl_25) l_p20))

(declare-fun l_p17 () Bool)
;%~zcl_25 | p17
(assert (or (not l_zcl_25) l_p17))

;%~p20 | ~p17 | zcl_25
(assert (or (not l_p20) (not l_p17) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p20 & p17) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p20 | ~p17 | f34_p
(assert (or (not l_p20) (not l_p17) l_f34_p))
...
;%~zcl_26 | p19
(assert (or (not l_zcl_26) l_p19))

;%~zcl_26 | f34
(assert (or (not l_zcl_26) l_f34))

;%~p19 | ~f34 | zcl_26
(assert (or (not l_p19) (not l_f34) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p19 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p19 | ~f34_p | f33_p
(assert (or (not l_p19) (not l_f34_p) l_f33_p))
...
;%~zcl_27 | p12
(assert (or (not l_zcl_27) l_p12))

;%~zcl_27 | f33
(assert (or (not l_zcl_27) l_f33))

;%~p12 | ~f33 | zcl_27
(assert (or (not l_p12) (not l_f33) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p12 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p12 | ~f33_p | f32_p
(assert (or (not l_p12) (not l_f33_p) l_f32_p))
...
;%~zcl_28 | p6
(assert (or (not l_zcl_28) l_p6))

;%~zcl_28 | f32
(assert (or (not l_zcl_28) l_f32))

;%~p6 | ~f32 | zcl_28
(assert (or (not l_p6) (not l_f32) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p6 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p6 | ~f32_p | f31_p
(assert (or (not l_p6) (not l_f32_p) l_f31_p))
...
;%~zcl_29 | p18
(assert (or (not l_zcl_29) l_p18))

;%~zcl_29 | f31
(assert (or (not l_zcl_29) l_f31))

;%~p18 | ~f31 | zcl_29
(assert (or (not l_p18) (not l_f31) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p18 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p18 | ~f31_p | f30_p
(assert (or (not l_p18) (not l_f31_p) l_f30_p))
...
;%~zcl_30 | p24
(assert (or (not l_zcl_30) l_p24))

(declare-fun l_p21 () Bool)
;%~zcl_30 | p21
(assert (or (not l_zcl_30) l_p21))

;%~p24 | ~p21 | zcl_30
(assert (or (not l_p24) (not l_p21) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p24 & p21) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p24 | ~p21 | f39_p
(assert (or (not l_p24) (not l_p21) l_f39_p))
...
;%~p0 | ~f39 | zcl_31
(assert (or (not l_p0) (not l_f39) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p0 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p0 | ~f39_p | f38_p
(assert (or (not l_p0) (not l_f39_p) l_f38_p))
...
;%~zcl_32 | p23
(assert (or (not l_zcl_32) l_p23))

;%~zcl_32 | f38
(assert (or (not l_zcl_32) l_f38))

;%~p23 | ~f38 | zcl_32
(assert (or (not l_p23) (not l_f38) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p23 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p23 | ~f38_p | f37_p
(assert (or (not l_p23) (not l_f38_p) l_f37_p))
...
;%~zcl_33 | p0
(assert (or (not l_zcl_33) l_p0))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p0 | ~f37 | zcl_33
(assert (or (not l_p0) (not l_f37) l_zcl_33))
...
;%~zcl_34 | p22
(assert (or (not l_zcl_34) l_p22))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p22 | ~f36 | zcl_34
(assert (or (not l_p22) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((p22 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p22 | ~f36_p | f35_p
(assert (or (not l_p22) (not l_f36_p) l_f35_p))
...
;%~r_p0 | ~r_p6 | r_zcl_5
(assert (or (not r_p0) (not r_p6) r_zcl_5))
...
;%~r_p7 | ~r_f10 | r_zcl_6
(assert (or (not r_p7) (not r_f10) r_zcl_6))
...
(assert (or (not r_p7) (not r_f10_p) r_f9_p))
...
;%~r_p0 | ~r_f8 | r_zcl_8
(assert (or (not r_p0) (not r_f8) r_zcl_8))
...
;%~r_p0 | ~r_f7 | r_zcl_9
(assert (or (not r_p0) (not r_f7) r_zcl_9))
...
;%~r_p11 | ~r_p8 | r_zcl_10
(assert (or (not r_p11) (not r_p8) r_zcl_10))
...
(assert (or (not r_p11) (not r_p8) r_f16_p))
...
;%~r_p0 | ~r_f16 | r_zcl_11
(assert (or (not r_p0) (not r_f16) r_zcl_11))
...
;%~r_p10 | ~r_f15 | r_zcl_12
(assert (or (not r_p10) (not r_f15) r_zcl_12))
...
;%~r_p10 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p10) (not r_f15_p) r_f14_p))
...
;%~r_p0 | ~r_f14 | r_zcl_13
(assert (or (not r_p0) (not r_f14) r_zcl_13))
...
;%~r_p9 | ~r_f13 | r_zcl_14
(assert (or (not r_p9) (not r_f13) r_zcl_14))
...
;%~r_p9 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p9) (not r_f13_p) r_f12_p))
...
;%~r_p0 | ~r_p12 | r_zcl_15
(assert (or (not r_p0) (not r_p12) r_zcl_15))
...
;%~r_p0 | ~r_f22 | r_zcl_16
(assert (or (not r_p0) (not r_f22) r_zcl_16))
...
;%~r_p8 | ~r_f21 | r_zcl_17
(assert (or (not r_p8) (not r_f21) r_zcl_17))
...
;%~r_p8 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p8) (not r_f21_p) r_f20_p))
...
;%~r_p13 | ~r_f20 | r_zcl_18
(assert (or (not r_p13) (not r_f20) r_zcl_18))
...
;%~r_p0 | ~r_f19 | r_zcl_19
(assert (or (not r_p0) (not r_f19) r_zcl_19))
...
;%~r_p16 | ~r_p14 | r_zcl_20
(assert (or (not r_p16) (not r_p14) r_zcl_20))
...
(assert (or (not r_p16) (not r_p14) r_f28_p))
...
;%~r_p0 | ~r_f28 | r_zcl_21
(assert (or (not r_p0) (not r_f28) r_zcl_21))
...
;%~r_p0 | ~r_f27 | r_zcl_22
(assert (or (not r_p0) (not r_f27) r_zcl_22))
...
;%~r_p15 | ~r_f26 | r_zcl_23
(assert (or (not r_p15) (not r_f26) r_zcl_23))
...
;%~r_p15 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p15) (not r_f26_p) r_f25_p))
...
;%~r_p0 | ~r_f25 | r_zcl_24
(assert (or (not r_p0) (not r_f25) r_zcl_24))
...
(assert (or (not r_zcl_25) r_p20))


;%~r_zcl_25 | r_p17
(assert (or (not r_zcl_25) r_p17))


;%~r_p20 | ~r_p17 | r_zcl_25
(assert (or (not r_p20) (not r_p17) r_zcl_25))
...
(assert (or (not r_p20) (not r_p17) r_f34_p))


;%~r_zcl_26 | r_p19
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p19))
...
;%~r_p19 | ~r_f34 | r_zcl_26
(assert (or (not r_p19) (not r_f34) r_zcl_26))
...
;%~r_p19 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p19) (not r_f34_p) r_f33_p))


;%~r_zcl_27 | r_p12
(declare-fun r_zcl_27 () Bool)
(assert (or (not r_zcl_27) r_p12))
...
;%~r_p12 | ~r_f33 | r_zcl_27
(assert (or (not r_p12) (not r_f33) r_zcl_27))
...
;%~r_p12 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p12) (not r_f33_p) r_f32_p))


;%~r_zcl_28 | r_p6
(declare-fun r_zcl_28 () Bool)
(assert (or (not r_zcl_28) r_p6))
...
;%~r_p6 | ~r_f32 | r_zcl_28
(assert (or (not r_p6) (not r_f32) r_zcl_28))
...
;%~r_p6 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p6) (not r_f32_p) r_f31_p))


;%~r_zcl_29 | r_p18
(declare-fun r_zcl_29 () Bool)
(assert (or (not r_zcl_29) r_p18))
...
;%~r_p18 | ~r_f31 | r_zcl_29
(assert (or (not r_p18) (not r_f31) r_zcl_29))
...
;%~r_p18 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p18) (not r_f31_p) r_f30_p))


;%~r_zcl_30 | r_p24
(declare-fun r_zcl_30 () Bool)
(assert (or (not r_zcl_30) r_p24))


;%~r_zcl_30 | r_p21
(assert (or (not r_zcl_30) r_p21))


;%~r_p24 | ~r_p21 | r_zcl_30
(assert (or (not r_p24) (not r_p21) r_zcl_30))
...
(assert (or (not r_p24) (not r_p21) r_f39_p))
...
;%~r_p0 | ~r_f39 | r_zcl_31
(assert (or (not r_p0) (not r_f39) r_zcl_31))
...
;%~r_p0 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p0) (not r_f39_p) r_f38_p))


;%~r_zcl_32 | r_p23
(declare-fun r_zcl_32 () Bool)
(assert (or (not r_zcl_32) r_p23))
...
;%~r_p23 | ~r_f38 | r_zcl_32
(assert (or (not r_p23) (not r_f38) r_zcl_32))
...
;%~r_p23 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p23) (not r_f38_p) r_f37_p))


;%~r_zcl_33 | r_p0
(declare-fun r_zcl_33 () Bool)
(assert (or (not r_zcl_33) r_p0))
...
;%~r_p0 | ~r_f37 | r_zcl_33
(assert (or (not r_p0) (not r_f37) r_zcl_33))
...
;%~r_p22 | ~r_f36 | r_zcl_34
(assert (or (not r_p22) (not r_f36) r_zcl_34))
...
;%~r_p22 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p22) (not r_f36_p) r_f35_p))
