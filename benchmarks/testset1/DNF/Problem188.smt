...
;%~p0 | ~p8 | zcl_10
(assert (or (not l_p0) (not l_p8) l_zcl_10))
...
;%~p0 | ~p8 | f16_p
(assert (or (not l_p0) (not l_p8) l_f16_p))
...
;%~p6 | ~f15 | zcl_12
(assert (or (not l_p6) (not l_f15) l_zcl_12))
...
;%~p6 | ~f15_p | f14_p
(assert (or (not l_p6) (not l_f15_p) l_f14_p))
...
;%~p9 | ~f14 | zcl_13
(assert (or (not l_p9) (not l_f14) l_zcl_13))
...
;%Non-clausified dependency
;%(forall[]((~p9 & f14_p) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p9 | ~f14_p | f13_p
(assert (or (not l_p9) (not l_f14_p) l_f13_p))
...
;%~zcl_16 | p6
(assert (or (not l_zcl_16) l_p6))

;%~zcl_16 | f22
(assert (or (not l_zcl_16) l_f22))

;%~p6 | ~f22 | zcl_16
(assert (or (not l_p6) (not l_f22) l_zcl_16))
...
;%~p6 | ~f22_p | f21_p
(assert (or (not l_p6) (not l_f22_p) l_f21_p))
...
;%~p0 | ~f21 | zcl_17
(assert (or (not l_p0) (not l_f21) l_zcl_17))
...
;%~p11 | ~f20 | zcl_18
(assert (or (not l_p11) (not l_f20) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p11 & f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p11 | ~f20_p | f19_p
(assert (or (not l_p11) (not l_f20_p) l_f19_p))
...
;%~p6 | ~p13 | zcl_20
(assert (or (not l_p6) (not l_p13) l_zcl_20))
...
;%~p6 | ~p13 | f28_p
(assert (or (not l_p6) (not l_p13) l_f28_p))
...
;%~zcl_24 | p10
(assert (or (not l_zcl_24) l_p10))

;%~zcl_24 | f25
(assert (or (not l_zcl_24) l_f25))

;%~p10 | ~f25 | zcl_24
(assert (or (not l_p10) (not l_f25) l_zcl_24))
...
;%~p10 | ~f25_p | f24_p
(assert (or (not l_p10) (not l_f25_p) l_f24_p))
...
;%~zcl_25 | p14
(assert (or (not l_zcl_25) l_p14))

;%~p0 | ~p14 | zcl_25
(assert (or (not l_p0) (not l_p14) l_zcl_25))
...
;%~p0 | ~p14 | f34_p
(assert (or (not l_p0) (not l_p14) l_f34_p))
...
;%~zcl_26 | p17
(assert (or (not l_zcl_26) l_p17))

;%~zcl_26 | f34
(assert (or (not l_zcl_26) l_f34))

;%~p17 | ~f34 | zcl_26
(assert (or (not l_p17) (not l_f34) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p17 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p17 | ~f34_p | f33_p
(assert (or (not l_p17) (not l_f34_p) l_f33_p))
...
;%~zcl_27 | p16
(assert (or (not l_zcl_27) l_p16))

;%~zcl_27 | f33
(assert (or (not l_zcl_27) l_f33))

;%~p16 | ~f33 | zcl_27
(assert (or (not l_p16) (not l_f33) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p16 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p16 | ~f33_p | f32_p
(assert (or (not l_p16) (not l_f33_p) l_f32_p))
...
;%~zcl_28 | p15
(assert (or (not l_zcl_28) l_p15))

;%~zcl_28 | f32
(assert (or (not l_zcl_28) l_f32))

;%~p15 | ~f32 | zcl_28
(assert (or (not l_p15) (not l_f32) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p15 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p15 | ~f32_p | f31_p
(assert (or (not l_p15) (not l_f32_p) l_f31_p))
...
;%~zcl_30 | p18
(assert (or (not l_zcl_30) l_p18))

;%~p20 | ~p18 | zcl_30
(assert (or (not l_p20) (not l_p18) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p20 & ~p18) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p20 | ~p18 | f39_p
(assert (or (not l_p20) (not l_p18) l_f39_p))
...
;%~zcl_31 | p19
(assert (or (not l_zcl_31) l_p19))

;%~zcl_31 | f39
(assert (or (not l_zcl_31) l_f39))

;%~p19 | ~f39 | zcl_31
(assert (or (not l_p19) (not l_f39) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((~p19 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p19 | ~f39_p | f38_p
(assert (or (not l_p19) (not l_f39_p) l_f38_p))
...
;%~zcl_32 | p8
(assert (or (not l_zcl_32) l_p8))

;%~zcl_32 | f38
(assert (or (not l_zcl_32) l_f38))

;%~p8 | ~f38 | zcl_32
(assert (or (not l_p8) (not l_f38) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((~p8 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p8 | ~f38_p | f37_p
(assert (or (not l_p8) (not l_f38_p) l_f37_p))
...
;%~zcl_33 | p10
(assert (or (not l_zcl_33) l_p10))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p10 | ~f37 | zcl_33
(assert (or (not l_p10) (not l_f37) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((~p10 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p10 | ~f37_p | f36_p
(assert (or (not l_p10) (not l_f37_p) l_f36_p))
...
;%~zcl_34 | p10
(assert (or (not l_zcl_34) l_p10))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p10 | ~f36 | zcl_34
(assert (or (not l_p10) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((~p10 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p10 | ~f36_p | f35_p
(assert (or (not l_p10) (not l_f36_p) l_f35_p))
...
;%~r_p0 | ~r_p8 | r_zcl_10
(assert (or (not r_p0) (not r_p8) r_zcl_10))
...
(assert (or (not r_p0) (not r_p8) r_f16_p))
...
;%~r_p6 | ~r_f15 | r_zcl_12
(assert (or (not r_p6) (not r_f15) r_zcl_12))
...
;%~r_p6 | ~r_f15_p | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p6) (not r_f15_p) r_f14_p))
...
;%~r_p9 | ~r_f14 | r_zcl_13
(assert (or (not r_p9) (not r_f14) r_zcl_13))
...
;%~r_p9 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p9) (not r_f14_p) r_f13_p))
...
;%~r_p6 | ~r_f22 | r_zcl_16
(assert (or (not r_p6) (not r_f22) r_zcl_16))
...
;%~r_p6 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p6) (not r_f22_p) r_f21_p))
...
;%~r_p0 | ~r_f21 | r_zcl_17
(assert (or (not r_p0) (not r_f21) r_zcl_17))
...
;%~r_p11 | ~r_f20 | r_zcl_18
(assert (or (not r_p11) (not r_f20) r_zcl_18))
...
;%~r_p11 | ~r_f20_p | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p11) (not r_f20_p) r_f19_p))
...
;%~r_p6 | ~r_p13 | r_zcl_20
(assert (or (not r_p6) (not r_p13) r_zcl_20))
...
(assert (or (not r_p6) (not r_p13) r_f28_p))
...
;%~r_p10 | ~r_f25 | r_zcl_24
(assert (or (not r_p10) (not r_f25) r_zcl_24))
...
;%~r_p10 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p10) (not r_f25_p) r_f24_p))
...
;%~r_zcl_25 | r_p14
(assert (or (not r_zcl_25) r_p14))


;%~r_p0 | ~r_p14 | r_zcl_25
(assert (or (not r_p0) (not r_p14) r_zcl_25))
...
(assert (or (not r_p0) (not r_p14) r_f34_p))


;%~r_zcl_26 | r_p17
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p17))
...
;%~r_p17 | ~r_f34 | r_zcl_26
(assert (or (not r_p17) (not r_f34) r_zcl_26))
...
;%~r_p17 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p17) (not r_f34_p) r_f33_p))


;%~r_zcl_27 | r_p16
(declare-fun r_zcl_27 () Bool)
(assert (or (not r_zcl_27) r_p16))
...
;%~r_p16 | ~r_f33 | r_zcl_27
(assert (or (not r_p16) (not r_f33) r_zcl_27))
...
;%~r_p16 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p16) (not r_f33_p) r_f32_p))


;%~r_zcl_28 | r_p15
(declare-fun r_zcl_28 () Bool)
(assert (or (not r_zcl_28) r_p15))
...
;%~r_p15 | ~r_f32 | r_zcl_28
(assert (or (not r_p15) (not r_f32) r_zcl_28))
...
;%~r_p15 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p15) (not r_f32_p) r_f31_p))
...
;%~r_zcl_30 | r_p18
(assert (or (not r_zcl_30) r_p18))


;%~r_p20 | ~r_p18 | r_zcl_30
(assert (or (not r_p20) (not r_p18) r_zcl_30))
...
(assert (or (not r_p20) (not r_p18) r_f39_p))


;%~r_zcl_31 | r_p19
(declare-fun r_zcl_31 () Bool)
(assert (or (not r_zcl_31) r_p19))
...
;%~r_p19 | ~r_f39 | r_zcl_31
(assert (or (not r_p19) (not r_f39) r_zcl_31))
...
;%~r_p19 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p19) (not r_f39_p) r_f38_p))


;%~r_zcl_32 | r_p8
(declare-fun r_zcl_32 () Bool)
(assert (or (not r_zcl_32) r_p8))
...
;%~r_p8 | ~r_f38 | r_zcl_32
(assert (or (not r_p8) (not r_f38) r_zcl_32))
...
;%~r_p8 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p8) (not r_f38_p) r_f37_p))


;%~r_zcl_33 | r_p10
(declare-fun r_zcl_33 () Bool)
(assert (or (not r_zcl_33) r_p10))
...
;%~r_p10 | ~r_f37 | r_zcl_33
(assert (or (not r_p10) (not r_f37) r_zcl_33))
...
;%~r_p10 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p10) (not r_f37_p) r_f36_p))


;%~r_zcl_34 | r_p10
(declare-fun r_zcl_34 () Bool)
(assert (or (not r_zcl_34) r_p10))
...
;%~r_p10 | ~r_f36 | r_zcl_34
(assert (or (not r_p10) (not r_f36) r_zcl_34))
...
;%~r_p10 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p10) (not r_f36_p) r_f35_p))
