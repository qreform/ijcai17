...
;%~p9 | ~p7 | zcl_10
(assert (or (not l_p9) (not l_p7) l_zcl_10))
...
;%~p9 | ~p7 | f16_p
(assert (or (not l_p9) (not l_p7) l_f16_p))
...
;%~p8 | ~f14 | zcl_13
(assert (or (not l_p8) (not l_f14) l_zcl_13))
...
;%~p7 | ~p10 | zcl_15
(assert (or (not l_p7) (not l_p10) l_zcl_15))
...
;%~p7 | ~p10 | f22_p
(assert (or (not l_p7) (not l_p10) l_f22_p))
...
;%~zcl_24 | p13
(assert (or (not l_zcl_24) l_p13))

;%~zcl_24 | f25
(assert (or (not l_zcl_24) l_f25))

;%~p13 | ~f25 | zcl_24
(assert (or (not l_p13) (not l_f25) l_zcl_24))
...
;%~p13 | ~f25_p | f24_p
(assert (or (not l_p13) (not l_f25_p) l_f24_p))
...
;%~p17 | ~p14 | zcl_25
(assert (or (not l_p17) (not l_p14) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((~p17 & ~p14) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p17 | ~p14 | f33_p
(assert (or (not l_p17) (not l_p14) l_f33_p))
...
;%~p16 | ~f32 | zcl_27
(assert (or (not l_p16) (not l_f32) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p16 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p16 | ~f32_p | f31_p
(assert (or (not l_p16) (not l_f32_p) l_f31_p))
...
;%~p15 | ~f31 | zcl_28
(assert (or (not l_p15) (not l_f31) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p15 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p15 | ~f31_p | f30_p
(assert (or (not l_p15) (not l_f31_p) l_f30_p))
...
;%~r_p9 | ~r_p7 | r_zcl_10
(assert (or (not r_p9) (not r_p7) r_zcl_10))
...
(assert (or (not r_p9) (not r_p7) r_f16_p))
...
;%~r_p8 | ~r_f14 | r_zcl_13
(assert (or (not r_p8) (not r_f14) r_zcl_13))
...
;%~r_p7 | ~r_p10 | r_zcl_15
(assert (or (not r_p7) (not r_p10) r_zcl_15))
...
(assert (or (not r_p7) (not r_p10) r_f22_p))
...
;%~r_p13 | ~r_f25 | r_zcl_24
(assert (or (not r_p13) (not r_f25) r_zcl_24))
...
;%~r_p13 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p13) (not r_f25_p) r_f24_p))
...
;%~r_p17 | ~r_p14 | r_zcl_25
(assert (or (not r_p17) (not r_p14) r_zcl_25))
...
(assert (or (not r_p17) (not r_p14) r_f33_p))
...
;%~r_p16 | ~r_f32 | r_zcl_27
(assert (or (not r_p16) (not r_f32) r_zcl_27))
...
;%~r_p16 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p16) (not r_f32_p) r_f31_p))
...
;%~r_p15 | ~r_f31 | r_zcl_28
(assert (or (not r_p15) (not r_f31) r_zcl_28))
...
;%~r_p15 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p15) (not r_f31_p) r_f30_p))
