...
;%~p17 | ~p15 | zcl_21
(assert (or (not l_p17) (not l_p15) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p17 & p15) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p17 | ~p15 | f30_p
(assert (or (not l_p17) (not l_p15) l_f30_p))
...
;%~p0 | ~p18 | zcl_28
(assert (or (not l_p0) (not l_p18) l_zcl_28))
...
;%~p0 | ~p18 | f37_p
(assert (or (not l_p0) (not l_p18) l_f37_p))
...
;%~zcl_31 | p20
(assert (or (not l_zcl_31) l_p20))

;%~zcl_31 | f35
(assert (or (not l_zcl_31) l_f35))

;%~p20 | ~f35 | zcl_31
(assert (or (not l_p20) (not l_f35) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p20 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p20 | ~f35_p | f34_p
(assert (or (not l_p20) (not l_f35_p) l_f34_p))
...
;%~zcl_32 | p19
(assert (or (not l_zcl_32) l_p19))

;%~zcl_32 | f34
(assert (or (not l_zcl_32) l_f34))

;%~p19 | ~f34 | zcl_32
(assert (or (not l_p19) (not l_f34) l_zcl_32))
...
;%~r_p17 | ~r_p15 | r_zcl_21
(assert (or (not r_p17) (not r_p15) r_zcl_21))
...
(assert (or (not r_p17) (not r_p15) r_f30_p))
...
;%~r_p0 | ~r_p18 | r_zcl_28
(assert (or (not r_p0) (not r_p18) r_zcl_28))
...
(assert (or (not r_p0) (not r_p18) r_f37_p))
...
;%~r_p20 | ~r_f35 | r_zcl_31
(assert (or (not r_p20) (not r_f35) r_zcl_31))
...
;%~r_p20 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p20) (not r_f35_p) r_f34_p))


;%~r_zcl_32 | r_p19
(declare-fun r_zcl_32 () Bool)
(assert (or (not r_zcl_32) r_p19))
...
;%~r_p19 | ~r_f34 | r_zcl_32
(assert (or (not r_p19) (not r_f34) r_zcl_32))
