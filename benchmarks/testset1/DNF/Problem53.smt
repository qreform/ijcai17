...
;%~p11 | ~f22 | zcl_23
(assert (or (not l_p11) (not l_f22) l_zcl_23))
...
;%~p0 | ~p12 | f32_p
(assert (or (not l_p0) (not l_p12) l_f32_p))
...
;%~p14 | ~f29 | zcl_28
(assert (or (not l_p14) (not l_f29) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p14 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p14 | ~f29_p | f28_p
(assert (or (not l_p14) (not l_f29_p) l_f28_p))
...
;%~zcl_29 | p13
(assert (or (not l_zcl_29) l_p13))

;%~zcl_29 | f28
(assert (or (not l_zcl_29) l_f28))

;%~p13 | ~f28 | zcl_29
(assert (or (not l_p13) (not l_f28) l_zcl_29))
...
;%~r_p11 | ~r_f22 | r_zcl_23
(assert (or (not r_p11) (not r_f22) r_zcl_23))
...
(assert (or (not r_p0) (not r_p12) r_f32_p))
...
;%~r_p14 | ~r_f29 | r_zcl_28
(assert (or (not r_p14) (not r_f29) r_zcl_28))
...
;%~r_p14 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p14) (not r_f29_p) r_f28_p))


;%~r_zcl_29 | r_p13
(declare-fun r_zcl_29 () Bool)
(assert (or (not r_zcl_29) r_p13))
...
;%~r_p13 | ~r_f28 | r_zcl_29
(assert (or (not r_p13) (not r_f28) r_zcl_29))
