...
;%~p8 | ~p11 | zcl_16
(assert (or (not l_p8) (not l_p11) l_zcl_16))
...
;%~p8 | ~p11 | f23_p
(assert (or (not l_p8) (not l_p11) l_f23_p))
...
;%~zcl_22 | p5
(assert (or (not l_zcl_22) l_p5))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p5 | ~f27 | zcl_22
(assert (or (not l_p5) (not l_f27) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((p5 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p5 | ~f27_p | f26_p
(assert (or (not l_p5) (not l_f27_p) l_f26_p))
...
;%~p8 | ~p15 | zcl_24
(assert (or (not l_p8) (not l_p15) l_zcl_24))
...
;%~p8 | ~p15 | f32_p
(assert (or (not l_p8) (not l_p15) l_f32_p))
...
;%~zcl_27 | p5
(assert (or (not l_zcl_27) l_p5))

;%~zcl_27 | f30
(assert (or (not l_zcl_27) l_f30))

;%~p5 | ~f30 | zcl_27
(assert (or (not l_p5) (not l_f30) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p5 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p5 | ~f30_p | f29_p
(assert (or (not l_p5) (not l_f30_p) l_f29_p))
...
;%~r_p8 | ~r_p11 | r_zcl_16
(assert (or (not r_p8) (not r_p11) r_zcl_16))
...
(assert (or (not r_p8) (not r_p11) r_f23_p))
...
;%~r_p5 | ~r_f27 | r_zcl_22
(assert (or (not r_p5) (not r_f27) r_zcl_22))
...
;%~r_p5 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p5) (not r_f27_p) r_f26_p))
...
;%~r_p8 | ~r_p15 | r_zcl_24
(assert (or (not r_p8) (not r_p15) r_zcl_24))
...
(assert (or (not r_p8) (not r_p15) r_f32_p))
...
;%~r_p5 | ~r_f30 | r_zcl_27
(assert (or (not r_p5) (not r_f30) r_zcl_27))
...
;%~r_p5 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p5) (not r_f30_p) r_f29_p))
