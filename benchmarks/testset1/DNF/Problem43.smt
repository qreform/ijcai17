...
;%~p6 | ~p8 | zcl_10
(assert (or (not l_p6) (not l_p8) l_zcl_10))
...
;%~p6 | ~p8 | f16_p
(assert (or (not l_p6) (not l_p8) l_f16_p))
...
;%~p0 | ~p10 | f27_p
(assert (or (not l_p0) (not l_p10) l_f27_p))
...
;%~zcl_21 | p12
(assert (or (not l_zcl_21) l_p12))

;%~zcl_21 | f27
(assert (or (not l_zcl_21) l_f27))

;%~p12 | ~f27 | zcl_21
(assert (or (not l_p12) (not l_f27) l_zcl_21))
...
;%~p11 | ~f25 | zcl_23
(assert (or (not l_p11) (not l_f25) l_zcl_23))
...
;%~r_p6 | ~r_p8 | r_zcl_10
(assert (or (not r_p6) (not r_p8) r_zcl_10))
...
(assert (or (not r_p6) (not r_p8) r_f16_p))
...
(assert (or (not r_p0) (not r_p10) r_f27_p))


;%~r_zcl_21 | r_p12
(declare-fun r_zcl_21 () Bool)
(assert (or (not r_zcl_21) r_p12))
...
;%~r_p12 | ~r_f27 | r_zcl_21
(assert (or (not r_p12) (not r_f27) r_zcl_21))
...
;%~r_p11 | ~r_f25 | r_zcl_23
(assert (or (not r_p11) (not r_f25) r_zcl_23))
