...
;%~p0 | ~p8 | zcl_12
(assert (or (not l_p0) (not l_p8) l_zcl_12))
...
;%~p0 | ~p8 | f19_p
(assert (or (not l_p0) (not l_p8) l_f19_p))
...
;%~p0 | ~p9 | zcl_18
(assert (or (not l_p0) (not l_p9) l_zcl_18))
...
;%~p0 | ~p9 | f26_p
(assert (or (not l_p0) (not l_p9) l_f26_p))
...
;%~zcl_19 | p10
(assert (or (not l_zcl_19) l_p10))

;%~zcl_19 | f26
(assert (or (not l_zcl_19) l_f26))

;%~p10 | ~f26 | zcl_19
(assert (or (not l_p10) (not l_f26) l_zcl_19))
...
;%~p10 | ~f26_p | f25_p
(assert (or (not l_p10) (not l_f26_p) l_f25_p))
...
;%~p0 | ~p11 | zcl_24
(assert (or (not l_p0) (not l_p11) l_zcl_24))
...
;%~p0 | ~p11 | f33_p
(assert (or (not l_p0) (not l_p11) l_f33_p))
...
;%~zcl_27 | p9
(assert (or (not l_zcl_27) l_p9))

;%~zcl_27 | f31
(assert (or (not l_zcl_27) l_f31))

;%~p9 | ~f31 | zcl_27
(assert (or (not l_p9) (not l_f31) l_zcl_27))
...
;%~p9 | ~f30 | zcl_28
(assert (or (not l_p9) (not l_f30) l_zcl_28))
...
;%~zcl_29 | p9
(assert (or (not l_zcl_29) l_p9))

;%~zcl_29 | f29
(assert (or (not l_zcl_29) l_f29))

;%~p9 | ~f29 | zcl_29
(assert (or (not l_p9) (not l_f29) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((~p9 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p9 | ~f29_p | f28_p
(assert (or (not l_p9) (not l_f29_p) l_f28_p))
...
;%~zcl_30 | p12
(assert (or (not l_zcl_30) l_p12))

;%~p16 | ~p12 | zcl_30
(assert (or (not l_p16) (not l_p12) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((~p16 & ~p12) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p16 | ~p12 | f39_p
(assert (or (not l_p16) (not l_p12) l_f39_p))
...
;%~zcl_33 | p15
(assert (or (not l_zcl_33) l_p15))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p15 | ~f37 | zcl_33
(assert (or (not l_p15) (not l_f37) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((p15 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p15 | ~f37_p | f36_p
(assert (or (not l_p15) (not l_f37_p) l_f36_p))
...
;%~zcl_34 | p14
(assert (or (not l_zcl_34) l_p14))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p14 | ~f36 | zcl_34
(assert (or (not l_p14) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p14 | ~f36_p | f35_p
(assert (or (not l_p14) (not l_f36_p) l_f35_p))
...
;%~zcl_35 | p13
(assert (or (not l_zcl_35) l_p13))

;%~zcl_35 | f35
(assert (or (not l_zcl_35) l_f35))

;%~p13 | ~f35 | zcl_35
(assert (or (not l_p13) (not l_f35) l_zcl_35))
...
;%Non-clausified dependency
;%(forall[]((p13 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p13 | ~f35_p | f34_p
(assert (or (not l_p13) (not l_f35_p) l_f34_p))
...
;%~r_p0 | ~r_p8 | r_zcl_12
(assert (or (not r_p0) (not r_p8) r_zcl_12))
...
(assert (or (not r_p0) (not r_p8) r_f19_p))
...
;%~r_p0 | ~r_p9 | r_zcl_18
(assert (or (not r_p0) (not r_p9) r_zcl_18))
...
(assert (or (not r_p0) (not r_p9) r_f26_p))


;%~r_zcl_19 | r_p10
(declare-fun r_zcl_19 () Bool)
(assert (or (not r_zcl_19) r_p10))
...
;%~r_p10 | ~r_f26 | r_zcl_19
(assert (or (not r_p10) (not r_f26) r_zcl_19))
...
;%~r_p10 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p10) (not r_f26_p) r_f25_p))
...
;%~r_p0 | ~r_p11 | r_zcl_24
(assert (or (not r_p0) (not r_p11) r_zcl_24))
...
(assert (or (not r_p0) (not r_p11) r_f33_p))
...
;%~r_p9 | ~r_f31 | r_zcl_27
(assert (or (not r_p9) (not r_f31) r_zcl_27))
...
;%~r_p9 | ~r_f30 | r_zcl_28
(assert (or (not r_p9) (not r_f30) r_zcl_28))
...
;%~r_p9 | ~r_f29 | r_zcl_29
(assert (or (not r_p9) (not r_f29) r_zcl_29))
...
;%~r_p9 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p9) (not r_f29_p) r_f28_p))
...
;%~r_zcl_30 | r_p12
(assert (or (not r_zcl_30) r_p12))


;%~r_p16 | ~r_p12 | r_zcl_30
(assert (or (not r_p16) (not r_p12) r_zcl_30))
...
(assert (or (not r_p16) (not r_p12) r_f39_p))
...
;%~r_p15 | ~r_f37 | r_zcl_33
(assert (or (not r_p15) (not r_f37) r_zcl_33))
...
;%~r_p15 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p15) (not r_f37_p) r_f36_p))


;%~r_zcl_34 | r_p14
(declare-fun r_zcl_34 () Bool)
(assert (or (not r_zcl_34) r_p14))
...
;%~r_p14 | ~r_f36 | r_zcl_34
(assert (or (not r_p14) (not r_f36) r_zcl_34))
...
;%~r_p14 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p14) (not r_f36_p) r_f35_p))


;%~r_zcl_35 | r_p13
(declare-fun r_zcl_35 () Bool)
(assert (or (not r_zcl_35) r_p13))
...
;%~r_p13 | ~r_f35 | r_zcl_35
(assert (or (not r_p13) (not r_f35) r_zcl_35))
...
;%~r_p13 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p13) (not r_f35_p) r_f34_p))
