...
;%~p3 | ~p4 | zcl_3
(assert (or (not l_p3) (not l_p4) l_zcl_3))
...
;%~p4 | ~p5 | zcl_4
(assert (or (not l_p4) (not l_p5) l_zcl_4))
...
;%~p4 | ~p5 | f8_p
(assert (or (not l_p4) (not l_p5) l_f8_p))
...
;%~p5 | ~p6 | zcl_5
(assert (or (not l_p5) (not l_p6) l_zcl_5))
...
;%~p5 | ~p6 | f9_p
(assert (or (not l_p5) (not l_p6) l_f9_p))
...
;%~r_p3 | ~r_p4 | r_zcl_3
(assert (or (not r_p3) (not r_p4) r_zcl_3))
...
;%~r_p4 | ~r_p5 | r_zcl_4
(assert (or (not r_p4) (not r_p5) r_zcl_4))
...
(assert (or (not r_p4) (not r_p5) r_f8_p))
...
;%~r_p5 | ~r_p6 | r_zcl_5
(assert (or (not r_p5) (not r_p6) r_zcl_5))
...
(assert (or (not r_p5) (not r_p6) r_f9_p))
