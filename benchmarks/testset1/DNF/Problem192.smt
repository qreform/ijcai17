...
;%~p13 | ~p9 | zcl_12
(assert (or (not l_p13) (not l_p9) l_zcl_12))
...
;%~p13 | ~p9 | f19_p
(assert (or (not l_p13) (not l_p9) l_f19_p))
...
;%~p12 | ~f19 | zcl_13
(assert (or (not l_p12) (not l_f19) l_zcl_13))
...
;%~p11 | ~f18 | zcl_14
(assert (or (not l_p11) (not l_f18) l_zcl_14))
...
;%~p0 | ~p14 | zcl_18
(assert (or (not l_p0) (not l_p14) l_zcl_18))
...
;%~p0 | ~p14 | f26_p
(assert (or (not l_p0) (not l_p14) l_f26_p))
...
;%~p9 | ~f38 | zcl_33
(assert (or (not l_p9) (not l_f38) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((p9 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p9 | ~f38_p | f37_p
(assert (or (not l_p9) (not l_f38_p) l_f37_p))
...
;%~p20 | ~p17 | zcl_36
(assert (or (not l_p20) (not l_p17) l_zcl_36))
...
;%Non-clausified dependency
;%(forall[]((p20 & p17) --> f46_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f46_p () Bool)
;%~p20 | ~p17 | f46_p
(assert (or (not l_p20) (not l_p17) l_f46_p))
...
;%~p18 | ~f43 | zcl_40
(assert (or (not l_p18) (not l_f43) l_zcl_40))
...
;%Non-clausified dependency
;%(forall[]((p18 & f43_p) --> f42_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f42_p () Bool)
;%~p18 | ~f43_p | f42_p
(assert (or (not l_p18) (not l_f43_p) l_f42_p))
...
;%~r_p13 | ~r_p9 | r_zcl_12
(assert (or (not r_p13) (not r_p9) r_zcl_12))
...
(assert (or (not r_p13) (not r_p9) r_f19_p))
...
;%~r_p12 | ~r_f19 | r_zcl_13
(assert (or (not r_p12) (not r_f19) r_zcl_13))
...
;%~r_p11 | ~r_f18 | r_zcl_14
(assert (or (not r_p11) (not r_f18) r_zcl_14))
...
;%~r_p0 | ~r_p14 | r_zcl_18
(assert (or (not r_p0) (not r_p14) r_zcl_18))
...
(assert (or (not r_p0) (not r_p14) r_f26_p))
...
;%~r_p9 | ~r_f38 | r_zcl_33
(assert (or (not r_p9) (not r_f38) r_zcl_33))
...
;%~r_p9 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p9) (not r_f38_p) r_f37_p))
...
;%~r_p20 | ~r_p17 | r_zcl_36
(assert (or (not r_p20) (not r_p17) r_zcl_36))
...
(assert (or (not r_p20) (not r_p17) r_f46_p))
...
;%~r_p18 | ~r_f43 | r_zcl_40
(assert (or (not r_p18) (not r_f43) r_zcl_40))
...
;%~r_p18 | ~r_f43_p | r_f42_p
(declare-fun r_f42_p () Bool)
(assert (or (not r_p18) (not r_f43_p) r_f42_p))
