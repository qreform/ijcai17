...
;%~p8 | ~p6 | zcl_6
(assert (or (not l_p8) (not l_p6) l_zcl_6))
...
;%~p7 | ~f9 | zcl_8
(assert (or (not l_p7) (not l_f9) l_zcl_8))
...
;%~p10 | ~p9 | zcl_9
(assert (or (not l_p10) (not l_p9) l_zcl_9))
...
;%~p10 | ~p9 | f14_p
(assert (or (not l_p10) (not l_p9) l_f14_p))
...
;%~p4 | ~f13 | zcl_11
(assert (or (not l_p4) (not l_f13) l_zcl_11))
...
;%~p4 | ~p11 | zcl_12
(assert (or (not l_p4) (not l_p11) l_zcl_12))
...
;%~p4 | ~p11 | f18_p
(assert (or (not l_p4) (not l_p11) l_f18_p))
...
;%~p4 | ~p13 | zcl_18
(assert (or (not l_p4) (not l_p13) l_zcl_18))
...
;%~p4 | ~p13 | f25_p
(assert (or (not l_p4) (not l_p13) l_f25_p))
...
;%~p9 | ~f25 | zcl_19
(assert (or (not l_p9) (not l_f25) l_zcl_19))
...
;%~r_p8 | ~r_p6 | r_zcl_6
(assert (or (not r_p8) (not r_p6) r_zcl_6))
...
;%~r_p7 | ~r_f9 | r_zcl_8
(assert (or (not r_p7) (not r_f9) r_zcl_8))
...
;%~r_p10 | ~r_p9 | r_zcl_9
(assert (or (not r_p10) (not r_p9) r_zcl_9))
...
(assert (or (not r_p10) (not r_p9) r_f14_p))
...
;%~r_p4 | ~r_f13 | r_zcl_11
(assert (or (not r_p4) (not r_f13) r_zcl_11))
...
;%~r_p4 | ~r_p11 | r_zcl_12
(assert (or (not r_p4) (not r_p11) r_zcl_12))
...
(assert (or (not r_p4) (not r_p11) r_f18_p))
...
;%~r_p4 | ~r_p13 | r_zcl_18
(assert (or (not r_p4) (not r_p13) r_zcl_18))
...
(assert (or (not r_p4) (not r_p13) r_f25_p))
...
;%~r_p9 | ~r_f25 | r_zcl_19
(assert (or (not r_p9) (not r_f25) r_zcl_19))
