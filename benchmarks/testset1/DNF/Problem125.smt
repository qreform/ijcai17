...
;%Non-clausified dependency
;%(forall[]((~p41 & ~p35) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p41 | ~p35 | f39_p
(assert (or (not l_p41) (not l_p35) l_f39_p))
...
;%~zcl_35 | f35
(assert (or (not l_zcl_35) l_f35))

;%~p36 | ~f35 | zcl_35
(assert (or (not l_p36) (not l_f35) l_zcl_35))

(declare-fun l_f34 () Bool)
;%~f34 | zcl_35
(assert (or (not l_f34) l_zcl_35))
...
(assert (or (not r_p41) (not r_p35) r_f39_p))
...
;%~r_zcl_35 | r_f35
(assert (or (not r_zcl_35) r_f35))


;%~r_p36 | ~r_f35 | r_zcl_35
(assert (or (not r_p36) (not r_f35) r_zcl_35))


;%~r_f34 | r_zcl_35
(declare-fun r_f34 () Bool)
(assert (or (not r_f34) r_zcl_35))
