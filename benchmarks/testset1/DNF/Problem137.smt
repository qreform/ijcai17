...
;%~p9 | ~f10 | zcl_12
(assert (or (not l_p9) (not l_f10) l_zcl_12))
...
;%~p8 | ~p11 | zcl_14
(assert (or (not l_p8) (not l_p11) l_zcl_14))
...
;%~p12 | ~f18 | zcl_19
(assert (or (not l_p12) (not l_f18) l_zcl_19))
...
;%Non-clausified dependency
;%(forall[]((p12 & f18_p) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p12 | ~f18_p | f17_p
(assert (or (not l_p12) (not l_f18_p) l_f17_p))
...
;%~p14 | ~f28 | zcl_24
(assert (or (not l_p14) (not l_f28) l_zcl_24))
...
;%~p0 | ~p15 | zcl_28
(assert (or (not l_p0) (not l_p15) l_zcl_28))
...
;%~p0 | ~p15 | f38_p
(assert (or (not l_p0) (not l_p15) l_f38_p))
...
;%~p16 | ~f35 | zcl_32
(assert (or (not l_p16) (not l_f35) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((~p16 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p16 | ~f35_p | f34_p
(assert (or (not l_p16) (not l_f35_p) l_f34_p))
...
;%~p11 | ~f34 | zcl_33
(assert (or (not l_p11) (not l_f34) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f34_p) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p11 | ~f34_p | f33_p
(assert (or (not l_p11) (not l_f34_p) l_f33_p))
...
;%~p0 | ~p17 | zcl_35
(assert (or (not l_p0) (not l_p17) l_zcl_35))
...
;%~p0 | ~p17 | f45_p
(assert (or (not l_p0) (not l_p17) l_f45_p))
...
;%~p19 | ~f43 | zcl_38
(assert (or (not l_p19) (not l_f43) l_zcl_38))
...
;%~zcl_40 | p18
(assert (or (not l_zcl_40) l_p18))

;%~zcl_40 | f41
(assert (or (not l_zcl_40) l_f41))

;%~p18 | ~f41 | zcl_40
(assert (or (not l_p18) (not l_f41) l_zcl_40))
...
;%Non-clausified dependency
;%(forall[]((p18 & f41_p) --> f40_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f40_p () Bool)
;%~p18 | ~f41_p | f40_p
(assert (or (not l_p18) (not l_f41_p) l_f40_p))
...
;%~r_p9 | ~r_f10 | r_zcl_12
(assert (or (not r_p9) (not r_f10) r_zcl_12))
...
;%~r_p8 | ~r_p11 | r_zcl_14
(assert (or (not r_p8) (not r_p11) r_zcl_14))
...
;%~r_p12 | ~r_f18 | r_zcl_19
(assert (or (not r_p12) (not r_f18) r_zcl_19))
...
;%~r_p12 | ~r_f18_p | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p12) (not r_f18_p) r_f17_p))
...
;%~r_p14 | ~r_f28 | r_zcl_24
(assert (or (not r_p14) (not r_f28) r_zcl_24))
...
;%~r_p0 | ~r_p15 | r_zcl_28
(assert (or (not r_p0) (not r_p15) r_zcl_28))
...
(assert (or (not r_p0) (not r_p15) r_f38_p))
...
;%~r_p16 | ~r_f35 | r_zcl_32
(assert (or (not r_p16) (not r_f35) r_zcl_32))
...
;%~r_p16 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p16) (not r_f35_p) r_f34_p))
...
;%~r_p11 | ~r_f34 | r_zcl_33
(assert (or (not r_p11) (not r_f34) r_zcl_33))
...
;%~r_p11 | ~r_f34_p | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p11) (not r_f34_p) r_f33_p))
...
;%~r_p0 | ~r_p17 | r_zcl_35
(assert (or (not r_p0) (not r_p17) r_zcl_35))
...
(assert (or (not r_p0) (not r_p17) r_f45_p))
...
;%~r_p19 | ~r_f43 | r_zcl_38
(assert (or (not r_p19) (not r_f43) r_zcl_38))
...
;%~r_p18 | ~r_f41 | r_zcl_40
(assert (or (not r_p18) (not r_f41) r_zcl_40))
...
;%~r_p18 | ~r_f41_p | r_f40_p
(declare-fun r_f40_p () Bool)
(assert (or (not r_p18) (not r_f41_p) r_f40_p))
