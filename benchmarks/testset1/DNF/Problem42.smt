...
;%~zcl_6 | p9
(assert (or (not l_zcl_6) l_p9))

;%~zcl_6 | f10
(assert (or (not l_zcl_6) l_f10))

;%~p9 | ~f10 | zcl_6
(assert (or (not l_p9) (not l_f10) l_zcl_6))
...
;%~p9 | ~f10_p | f9_p
(assert (or (not l_p9) (not l_f10_p) l_f9_p))
...
;%~p11 | ~f13 | zcl_14
(assert (or (not l_p11) (not l_f13) l_zcl_14))
...
;%~p10 | ~p12 | zcl_15
(assert (or (not l_p10) (not l_p12) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((p10 & p12) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p10 | ~p12 | f22_p
(assert (or (not l_p10) (not l_p12) l_f22_p))
...
;%~p12 | ~p14 | zcl_20
(assert (or (not l_p12) (not l_p14) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p12 & p14) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p12 | ~p14 | f27_p
(assert (or (not l_p12) (not l_p14) l_f27_p))
...
;%~zcl_21 | p16
(assert (or (not l_zcl_21) l_p16))

;%~zcl_21 | f27
(assert (or (not l_zcl_21) l_f27))

;%~p16 | ~f27 | zcl_21
(assert (or (not l_p16) (not l_f27) l_zcl_21))
...
;%~p15 | ~f26 | zcl_22
(assert (or (not l_p15) (not l_f26) l_zcl_22))
...
;%~p6 | ~f25 | zcl_23
(assert (or (not l_p6) (not l_f25) l_zcl_23))
...
;%~p6 | ~f24 | zcl_24
(assert (or (not l_p6) (not l_f24) l_zcl_24))
...
;%~p6 | ~f24_p | f23_p
(assert (or (not l_p6) (not l_f24_p) l_f23_p))
...
;%~r_p9 | ~r_f10 | r_zcl_6
(assert (or (not r_p9) (not r_f10) r_zcl_6))
...
(assert (or (not r_p9) (not r_f10_p) r_f9_p))
...
;%~r_p11 | ~r_f13 | r_zcl_14
(assert (or (not r_p11) (not r_f13) r_zcl_14))
...
;%~r_p10 | ~r_p12 | r_zcl_15
(assert (or (not r_p10) (not r_p12) r_zcl_15))
...
(assert (or (not r_p10) (not r_p12) r_f22_p))
...
;%~r_p12 | ~r_p14 | r_zcl_20
(assert (or (not r_p12) (not r_p14) r_zcl_20))
...
(assert (or (not r_p12) (not r_p14) r_f27_p))


;%~r_zcl_21 | r_p16
(declare-fun r_zcl_21 () Bool)
(assert (or (not r_zcl_21) r_p16))
...
;%~r_p16 | ~r_f27 | r_zcl_21
(assert (or (not r_p16) (not r_f27) r_zcl_21))
...
;%~r_p15 | ~r_f26 | r_zcl_22
(assert (or (not r_p15) (not r_f26) r_zcl_22))
...
;%~r_p6 | ~r_f25 | r_zcl_23
(assert (or (not r_p6) (not r_f25) r_zcl_23))
...
;%~r_p6 | ~r_f24 | r_zcl_24
(assert (or (not r_p6) (not r_f24) r_zcl_24))
...
;%~r_p6 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p6) (not r_f24_p) r_f23_p))
