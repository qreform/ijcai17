...
;%~p13 | ~p11 | zcl_18
(assert (or (not l_p13) (not l_p11) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p13 & p11) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p13 | ~p11 | f26_p
(assert (or (not l_p13) (not l_p11) l_f26_p))
...
;%~p12 | ~f24 | zcl_21
(assert (or (not l_p12) (not l_f24) l_zcl_21))
...
;%~p0 | ~f28 | zcl_29
(assert (or (not l_p0) (not l_f28) l_zcl_29))
...
;%~r_p13 | ~r_p11 | r_zcl_18
(assert (or (not r_p13) (not r_p11) r_zcl_18))
...
(assert (or (not r_p13) (not r_p11) r_f26_p))
...
;%~r_p12 | ~r_f24 | r_zcl_21
(assert (or (not r_p12) (not r_f24) r_zcl_21))
...
;%~r_p0 | ~r_f28 | r_zcl_29
(assert (or (not r_p0) (not r_f28) r_zcl_29))
