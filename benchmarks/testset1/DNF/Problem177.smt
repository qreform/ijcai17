...
;%~p8 | ~p7 | zcl_8
(assert (or (not l_p8) (not l_p7) l_zcl_8))
...
;%~p8 | ~p7 | f13_p
(assert (or (not l_p8) (not l_p7) l_f13_p))
...
;%~p14 | ~p11 | zcl_16
(assert (or (not l_p14) (not l_p11) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((~p14 & p11) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p14 | ~p11 | f23_p
(assert (or (not l_p14) (not l_p11) l_f23_p))
...
;%~p12 | ~f21 | zcl_19
(assert (or (not l_p12) (not l_f21) l_zcl_19))
...
;%~p11 | ~p15 | zcl_20
(assert (or (not l_p11) (not l_p15) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((~p11 & p15) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p11 | ~p15 | f28_p
(assert (or (not l_p11) (not l_p15) l_f28_p))
...
;%~zcl_21 | p5
(assert (or (not l_zcl_21) l_p5))

;%~zcl_21 | f28
(assert (or (not l_zcl_21) l_f28))

;%~p5 | ~f28 | zcl_21
(assert (or (not l_p5) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((~p5 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p5 | ~f28_p | f27_p
(assert (or (not l_p5) (not l_f28_p) l_f27_p))
...
;%~p9 | ~p17 | zcl_24
(assert (or (not l_p9) (not l_p17) l_zcl_24))
...
;%~p9 | ~p17 | f32_p
(assert (or (not l_p9) (not l_p17) l_f32_p))
...
;%~r_p8 | ~r_p7 | r_zcl_8
(assert (or (not r_p8) (not r_p7) r_zcl_8))
...
(assert (or (not r_p8) (not r_p7) r_f13_p))
...
;%~r_p14 | ~r_p11 | r_zcl_16
(assert (or (not r_p14) (not r_p11) r_zcl_16))
...
(assert (or (not r_p14) (not r_p11) r_f23_p))
...
;%~r_p12 | ~r_f21 | r_zcl_19
(assert (or (not r_p12) (not r_f21) r_zcl_19))
...
;%~r_p11 | ~r_p15 | r_zcl_20
(assert (or (not r_p11) (not r_p15) r_zcl_20))
...
(assert (or (not r_p11) (not r_p15) r_f28_p))


;%~r_zcl_21 | r_p5
(declare-fun r_zcl_21 () Bool)
(assert (or (not r_zcl_21) r_p5))
...
;%~r_p5 | ~r_f28 | r_zcl_21
(assert (or (not r_p5) (not r_f28) r_zcl_21))
...
;%~r_p5 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p5) (not r_f28_p) r_f27_p))
...
;%~r_p9 | ~r_p17 | r_zcl_24
(assert (or (not r_p9) (not r_p17) r_zcl_24))
...
(assert (or (not r_p9) (not r_p17) r_f32_p))
