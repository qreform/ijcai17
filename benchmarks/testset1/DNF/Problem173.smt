...
;%~p8 | ~f18 | zcl_13
(assert (or (not l_p8) (not l_f18) l_zcl_13))
...
;%~p5 | ~p9 | zcl_16
(assert (or (not l_p5) (not l_p9) l_zcl_16))
...
;%~p5 | ~p9 | f23_p
(assert (or (not l_p5) (not l_p9) l_f23_p))
...
;%~p6 | ~f30 | zcl_27
(assert (or (not l_p6) (not l_f30) l_zcl_27))
...
;%~r_p8 | ~r_f18 | r_zcl_13
(assert (or (not r_p8) (not r_f18) r_zcl_13))
...
;%~r_p5 | ~r_p9 | r_zcl_16
(assert (or (not r_p5) (not r_p9) r_zcl_16))
...
(assert (or (not r_p5) (not r_p9) r_f23_p))
...
;%~r_p6 | ~r_f30 | r_zcl_27
(assert (or (not r_p6) (not r_f30) r_zcl_27))
