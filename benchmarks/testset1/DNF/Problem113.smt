...
;%~p6 | ~p9 | zcl_10
(assert (or (not l_p6) (not l_p9) l_zcl_10))
...
;%~p6 | ~p9 | f16_p
(assert (or (not l_p6) (not l_p9) l_f16_p))
...
;%~p6 | ~p12 | zcl_15
(assert (or (not l_p6) (not l_p12) l_zcl_15))
...
;%~p6 | ~p12 | f22_p
(assert (or (not l_p6) (not l_p12) l_f22_p))
...
;%~zcl_16 | p9
(assert (or (not l_zcl_16) l_p9))

;%~zcl_16 | f22
(assert (or (not l_zcl_16) l_f22))

;%~p9 | ~f22 | zcl_16
(assert (or (not l_p9) (not l_f22) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((p9 & f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p9 | ~f22_p | f21_p
(assert (or (not l_p9) (not l_f22_p) l_f21_p))
...
;%Non-clausified dependency
;%(forall[]((p19 & p16) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p19 | ~p16 | f33_p
(assert (or (not l_p19) (not l_p16) l_f33_p))
...
;%~p18 | ~f33 | zcl_26
(assert (or (not l_p18) (not l_f33) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p18 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p18 | ~f33_p | f32_p
(assert (or (not l_p18) (not l_f33_p) l_f32_p))
...
;%~p17 | ~f32 | zcl_27
(assert (or (not l_p17) (not l_f32) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p17 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p17 | ~f32_p | f31_p
(assert (or (not l_p17) (not l_f32_p) l_f31_p))
...
;%~p0 | ~f31 | zcl_28
(assert (or (not l_p0) (not l_f31) l_zcl_28))
...
;%~p6 | ~f30 | zcl_29
(assert (or (not l_p6) (not l_f30) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p6 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p6 | ~f30_p | f29_p
(assert (or (not l_p6) (not l_f30_p) l_f29_p))
...
;%~r_p6 | ~r_p9 | r_zcl_10
(assert (or (not r_p6) (not r_p9) r_zcl_10))
...
(assert (or (not r_p6) (not r_p9) r_f16_p))
...
;%~r_p6 | ~r_p12 | r_zcl_15
(assert (or (not r_p6) (not r_p12) r_zcl_15))
...
(assert (or (not r_p6) (not r_p12) r_f22_p))


;%~r_zcl_16 | r_p9
(declare-fun r_zcl_16 () Bool)
(assert (or (not r_zcl_16) r_p9))
...
;%~r_p9 | ~r_f22 | r_zcl_16
(assert (or (not r_p9) (not r_f22) r_zcl_16))
...
;%~r_p9 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p9) (not r_f22_p) r_f21_p))
...
(assert (or (not r_p19) (not r_p16) r_f33_p))
...
;%~r_p18 | ~r_f33 | r_zcl_26
(assert (or (not r_p18) (not r_f33) r_zcl_26))
...
;%~r_p18 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p18) (not r_f33_p) r_f32_p))
...
;%~r_p17 | ~r_f32 | r_zcl_27
(assert (or (not r_p17) (not r_f32) r_zcl_27))
...
;%~r_p17 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p17) (not r_f32_p) r_f31_p))
...
;%~r_p0 | ~r_f31 | r_zcl_28
(assert (or (not r_p0) (not r_f31) r_zcl_28))
...
;%~r_p6 | ~r_f30 | r_zcl_29
(assert (or (not r_p6) (not r_f30) r_zcl_29))
...
;%~r_p6 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p6) (not r_f30_p) r_f29_p))
