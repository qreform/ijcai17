...
;%~p0 | ~p10 | zcl_18
(assert (or (not l_p0) (not l_p10) l_zcl_18))
...
;%~p0 | ~p10 | f26_p
(assert (or (not l_p0) (not l_p10) l_f26_p))
...
;%~p9 | ~f25 | zcl_20
(assert (or (not l_p9) (not l_f25) l_zcl_20))
...
;%~p9 | ~f25_p | f24_p
(assert (or (not l_p9) (not l_f25_p) l_f24_p))
...
;%~p0 | ~p12 | zcl_24
(assert (or (not l_p0) (not l_p12) l_zcl_24))
...
;%~p0 | ~p12 | f33_p
(assert (or (not l_p0) (not l_p12) l_f33_p))
...
;%~p13 | ~f31 | zcl_27
(assert (or (not l_p13) (not l_f31) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((p13 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p13 | ~f31_p | f30_p
(assert (or (not l_p13) (not l_f31_p) l_f30_p))
...
;%~zcl_29 | p10
(assert (or (not l_zcl_29) l_p10))

;%~zcl_29 | f29
(assert (or (not l_zcl_29) l_f29))

;%~p10 | ~f29 | zcl_29
(assert (or (not l_p10) (not l_f29) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p10 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p10 | ~f29_p | f28_p
(assert (or (not l_p10) (not l_f29_p) l_f28_p))
...
;%~p0 | ~p14 | zcl_30
(assert (or (not l_p0) (not l_p14) l_zcl_30))
...
;%~p0 | ~p14 | f39_p
(assert (or (not l_p0) (not l_p14) l_f39_p))
...
;%~zcl_32 | p7
(assert (or (not l_zcl_32) l_p7))

;%~zcl_32 | f38
(assert (or (not l_zcl_32) l_f38))

;%~p7 | ~f38 | zcl_32
(assert (or (not l_p7) (not l_f38) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p7 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p7 | ~f38_p | f37_p
(assert (or (not l_p7) (not l_f38_p) l_f37_p))
...
;%~zcl_33 | p16
(assert (or (not l_zcl_33) l_p16))

;%~zcl_33 | f37
(assert (or (not l_zcl_33) l_f37))

;%~p16 | ~f37 | zcl_33
(assert (or (not l_p16) (not l_f37) l_zcl_33))
...
;%~p15 | ~f36 | zcl_34
(assert (or (not l_p15) (not l_f36) l_zcl_34))
...
;%~r_p0 | ~r_p10 | r_zcl_18
(assert (or (not r_p0) (not r_p10) r_zcl_18))
...
(assert (or (not r_p0) (not r_p10) r_f26_p))
...
;%~r_p9 | ~r_f25 | r_zcl_20
(assert (or (not r_p9) (not r_f25) r_zcl_20))
...
;%~r_p9 | ~r_f25_p | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p9) (not r_f25_p) r_f24_p))
...
;%~r_p0 | ~r_p12 | r_zcl_24
(assert (or (not r_p0) (not r_p12) r_zcl_24))
...
(assert (or (not r_p0) (not r_p12) r_f33_p))
...
;%~r_p13 | ~r_f31 | r_zcl_27
(assert (or (not r_p13) (not r_f31) r_zcl_27))
...
;%~r_p13 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p13) (not r_f31_p) r_f30_p))
...
;%~r_p10 | ~r_f29 | r_zcl_29
(assert (or (not r_p10) (not r_f29) r_zcl_29))
...
;%~r_p10 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p10) (not r_f29_p) r_f28_p))
...
;%~r_p0 | ~r_p14 | r_zcl_30
(assert (or (not r_p0) (not r_p14) r_zcl_30))
...
(assert (or (not r_p0) (not r_p14) r_f39_p))
...
;%~r_p7 | ~r_f38 | r_zcl_32
(assert (or (not r_p7) (not r_f38) r_zcl_32))
...
;%~r_p7 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p7) (not r_f38_p) r_f37_p))


;%~r_zcl_33 | r_p16
(declare-fun r_zcl_33 () Bool)
(assert (or (not r_zcl_33) r_p16))
...
;%~r_p16 | ~r_f37 | r_zcl_33
(assert (or (not r_p16) (not r_f37) r_zcl_33))
...
;%~r_p15 | ~r_f36 | r_zcl_34
(assert (or (not r_p15) (not r_f36) r_zcl_34))
