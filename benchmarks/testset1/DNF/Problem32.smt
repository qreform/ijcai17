...
;%~p13 | ~p11 | zcl_16
(assert (or (not l_p13) (not l_p11) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((p13 & p11) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p13 | ~p11 | f22_p
(assert (or (not l_p13) (not l_p11) l_f22_p))
...
;%~p5 | ~f21 | zcl_18
(assert (or (not l_p5) (not l_f21) l_zcl_18))
...
;%~p12 | ~f20 | zcl_19
(assert (or (not l_p12) (not l_f20) l_zcl_19))
...
;%~r_p13 | ~r_p11 | r_zcl_16
(assert (or (not r_p13) (not r_p11) r_zcl_16))
...
(assert (or (not r_p13) (not r_p11) r_f22_p))
...
;%~r_p5 | ~r_f21 | r_zcl_18
(assert (or (not r_p5) (not r_f21) r_zcl_18))
...
;%~r_p12 | ~r_f20 | r_zcl_19
(assert (or (not r_p12) (not r_f20) r_zcl_19))
