...
;%~p13 | ~f22 | zcl_17
(assert (or (not l_p13) (not l_f22) l_zcl_17))
...
;%~p12 | ~f21 | zcl_18
(assert (or (not l_p12) (not l_f21) l_zcl_18))
...
;%~r_p13 | ~r_f22 | r_zcl_17
(assert (or (not r_p13) (not r_f22) r_zcl_17))
...
;%~r_p12 | ~r_f21 | r_zcl_18
(assert (or (not r_p12) (not r_f21) r_zcl_18))
