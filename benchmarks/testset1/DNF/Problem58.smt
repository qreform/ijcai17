...
;%~p9 | ~f11 | zcl_8
(assert (or (not l_p9) (not l_f11) l_zcl_8))
...
;%~p13 | ~p10 | zcl_12
(assert (or (not l_p13) (not l_p10) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((p13 & ~p10) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p13 | ~p10 | f19_p
(assert (or (not l_p13) (not l_p10) l_f19_p))
...
;%~p16 | ~p14 | zcl_18
(assert (or (not l_p16) (not l_p14) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((~p16 & p14) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p16 | ~p14 | f26_p
(assert (or (not l_p16) (not l_p14) l_f26_p))
...
;%~p15 | ~f25 | zcl_20
(assert (or (not l_p15) (not l_f25) l_zcl_20))
...
;%~p0 | ~p17 | zcl_24
(assert (or (not l_p0) (not l_p17) l_zcl_24))
...
;%~p0 | ~p17 | f32_p
(assert (or (not l_p0) (not l_p17) l_f32_p))
...
;%~p14 | ~f32 | zcl_25
(assert (or (not l_p14) (not l_f32) l_zcl_25))
...
;%~p19 | ~f31 | zcl_26
(assert (or (not l_p19) (not l_f31) l_zcl_26))
...
;%~p0 | ~f29 | zcl_28
(assert (or (not l_p0) (not l_f29) l_zcl_28))
...
;%~zcl_29 | p7
(assert (or (not l_zcl_29) l_p7))

;%~zcl_29 | f28
(assert (or (not l_zcl_29) l_f28))

;%~p7 | ~f28 | zcl_29
(assert (or (not l_p7) (not l_f28) l_zcl_29))
...
;%~r_p9 | ~r_f11 | r_zcl_8
(assert (or (not r_p9) (not r_f11) r_zcl_8))
...
;%~r_p13 | ~r_p10 | r_zcl_12
(assert (or (not r_p13) (not r_p10) r_zcl_12))
...
(assert (or (not r_p13) (not r_p10) r_f19_p))
...
;%~r_p16 | ~r_p14 | r_zcl_18
(assert (or (not r_p16) (not r_p14) r_zcl_18))
...
(assert (or (not r_p16) (not r_p14) r_f26_p))
...
;%~r_p15 | ~r_f25 | r_zcl_20
(assert (or (not r_p15) (not r_f25) r_zcl_20))
...
;%~r_p0 | ~r_p17 | r_zcl_24
(assert (or (not r_p0) (not r_p17) r_zcl_24))
...
(assert (or (not r_p0) (not r_p17) r_f32_p))
...
;%~r_p14 | ~r_f32 | r_zcl_25
(assert (or (not r_p14) (not r_f32) r_zcl_25))
...
;%~r_p19 | ~r_f31 | r_zcl_26
(assert (or (not r_p19) (not r_f31) r_zcl_26))
...
;%~r_p0 | ~r_f29 | r_zcl_28
(assert (or (not r_p0) (not r_f29) r_zcl_28))
...
;%~r_p7 | ~r_f28 | r_zcl_29
(assert (or (not r_p7) (not r_f28) r_zcl_29))
