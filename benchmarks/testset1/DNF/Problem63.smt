...
;%~p12 | ~p10 | zcl_14
(assert (or (not l_p12) (not l_p10) l_zcl_14))
...
;%~p11 | ~f17 | zcl_20
(assert (or (not l_p11) (not l_f17) l_zcl_20))
...
;%~p14 | ~f30 | zcl_22
(assert (or (not l_p14) (not l_f30) l_zcl_22))
...
;%~p0 | ~p15 | f37_p
(assert (or (not l_p0) (not l_p15) l_f37_p))
...
;%~p17 | ~f37 | zcl_29
(assert (or (not l_p17) (not l_f37) l_zcl_29))
...
;%~p8 | ~f36 | zcl_30
(assert (or (not l_p8) (not l_f36) l_zcl_30))
...
;%~zcl_31 | p16
(assert (or (not l_zcl_31) l_p16))

;%~zcl_31 | f35
(assert (or (not l_zcl_31) l_f35))

;%~p16 | ~f35 | zcl_31
(assert (or (not l_p16) (not l_f35) l_zcl_31))
...
;%~p8 | ~f34 | zcl_32
(assert (or (not l_p8) (not l_f34) l_zcl_32))
...
;%~p0 | ~f32 | zcl_34
(assert (or (not l_p0) (not l_f32) l_zcl_34))
...
;%~r_p12 | ~r_p10 | r_zcl_14
(assert (or (not r_p12) (not r_p10) r_zcl_14))
...
;%~r_p11 | ~r_f17 | r_zcl_20
(assert (or (not r_p11) (not r_f17) r_zcl_20))
...
;%~r_p14 | ~r_f30 | r_zcl_22
(assert (or (not r_p14) (not r_f30) r_zcl_22))
...
(assert (or (not r_p0) (not r_p15) r_f37_p))
...
;%~r_p17 | ~r_f37 | r_zcl_29
(assert (or (not r_p17) (not r_f37) r_zcl_29))
...
;%~r_p8 | ~r_f36 | r_zcl_30
(assert (or (not r_p8) (not r_f36) r_zcl_30))
...
;%~r_p16 | ~r_f35 | r_zcl_31
(assert (or (not r_p16) (not r_f35) r_zcl_31))
...
;%~r_p8 | ~r_f34 | r_zcl_32
(assert (or (not r_p8) (not r_f34) r_zcl_32))
...
;%~r_p0 | ~r_f32 | r_zcl_34
(assert (or (not r_p0) (not r_f32) r_zcl_34))
