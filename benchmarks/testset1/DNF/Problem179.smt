...
;%~p5 | ~p8 | zcl_8
(assert (or (not l_p5) (not l_p8) l_zcl_8))
...
;%~p5 | ~p8 | f13_p
(assert (or (not l_p5) (not l_p8) l_f13_p))
...
;%~p10 | ~f12 | zcl_10
(assert (or (not l_p10) (not l_f12) l_zcl_10))
...
;%~p10 | ~f12_p | f11_p
(assert (or (not l_p10) (not l_f12_p) l_f11_p))
...
;%~p9 | ~f11 | zcl_11
(assert (or (not l_p9) (not l_f11) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((~p9 & f11_p) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p9 | ~f11_p | f10_p
(assert (or (not l_p9) (not l_f11_p) l_f10_p))
...
;%~p15 | ~f23 | zcl_17
(assert (or (not l_p15) (not l_f23) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((~p15 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p15 | ~f23_p | f22_p
(assert (or (not l_p15) (not l_f23_p) l_f22_p))
...
;%~p11 | ~f22 | zcl_18
(assert (or (not l_p11) (not l_f22) l_zcl_18))
...
;%~p14 | ~f21 | zcl_19
(assert (or (not l_p14) (not l_f21) l_zcl_19))
...
;%~p18 | ~p16 | zcl_20
(assert (or (not l_p18) (not l_p16) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p18 & ~p16) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p18 | ~p16 | f28_p
(assert (or (not l_p18) (not l_p16) l_f28_p))
...
;%~zcl_21 | p17
(assert (or (not l_zcl_21) l_p17))

;%~zcl_21 | f28
(assert (or (not l_zcl_21) l_f28))

;%~p17 | ~f28 | zcl_21
(assert (or (not l_p17) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((~p17 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p17 | ~f28_p | f27_p
(assert (or (not l_p17) (not l_f28_p) l_f27_p))
...
;%~zcl_24 | p19
(assert (or (not l_zcl_24) l_p19))

;%~p0 | ~p19 | zcl_24
(assert (or (not l_p0) (not l_p19) l_zcl_24))
...
;%~p0 | ~p19 | f32_p
(assert (or (not l_p0) (not l_p19) l_f32_p))
...
;%~p21 | ~f32 | zcl_25
(assert (or (not l_p21) (not l_f32) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((~p21 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p21 | ~f32_p | f31_p
(assert (or (not l_p21) (not l_f32_p) l_f31_p))
...
;%~zcl_26 | p20
(assert (or (not l_zcl_26) l_p20))

;%~zcl_26 | f31
(assert (or (not l_zcl_26) l_f31))

;%~p20 | ~f31 | zcl_26
(assert (or (not l_p20) (not l_f31) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((~p20 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p20 | ~f31_p | f30_p
(assert (or (not l_p20) (not l_f31_p) l_f30_p))
...
;%~p16 | ~f30 | zcl_27
(assert (or (not l_p16) (not l_f30) l_zcl_27))
...
;%~r_p5 | ~r_p8 | r_zcl_8
(assert (or (not r_p5) (not r_p8) r_zcl_8))
...
(assert (or (not r_p5) (not r_p8) r_f13_p))
...
;%~r_p10 | ~r_f12 | r_zcl_10
(assert (or (not r_p10) (not r_f12) r_zcl_10))
...
;%~r_p10 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p10) (not r_f12_p) r_f11_p))
...
;%~r_p9 | ~r_f11 | r_zcl_11
(assert (or (not r_p9) (not r_f11) r_zcl_11))
...
;%~r_p9 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p9) (not r_f11_p) r_f10_p))
...
;%~r_p15 | ~r_f23 | r_zcl_17
(assert (or (not r_p15) (not r_f23) r_zcl_17))
...
;%~r_p15 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p15) (not r_f23_p) r_f22_p))
...
;%~r_p11 | ~r_f22 | r_zcl_18
(assert (or (not r_p11) (not r_f22) r_zcl_18))
...
;%~r_p14 | ~r_f21 | r_zcl_19
(assert (or (not r_p14) (not r_f21) r_zcl_19))
...
;%~r_p18 | ~r_p16 | r_zcl_20
(assert (or (not r_p18) (not r_p16) r_zcl_20))
...
(assert (or (not r_p18) (not r_p16) r_f28_p))


;%~r_zcl_21 | r_p17
(declare-fun r_zcl_21 () Bool)
(assert (or (not r_zcl_21) r_p17))
...
;%~r_p17 | ~r_f28 | r_zcl_21
(assert (or (not r_p17) (not r_f28) r_zcl_21))
...
;%~r_p17 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p17) (not r_f28_p) r_f27_p))
...
;%~r_zcl_24 | r_p19
(assert (or (not r_zcl_24) r_p19))


;%~r_p0 | ~r_p19 | r_zcl_24
(assert (or (not r_p0) (not r_p19) r_zcl_24))
...
(assert (or (not r_p0) (not r_p19) r_f32_p))
...
;%~r_p21 | ~r_f32 | r_zcl_25
(assert (or (not r_p21) (not r_f32) r_zcl_25))
...
;%~r_p21 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p21) (not r_f32_p) r_f31_p))


;%~r_zcl_26 | r_p20
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p20))
...
;%~r_p20 | ~r_f31 | r_zcl_26
(assert (or (not r_p20) (not r_f31) r_zcl_26))
...
;%~r_p20 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p20) (not r_f31_p) r_f30_p))
...
;%~r_p16 | ~r_f30 | r_zcl_27
(assert (or (not r_p16) (not r_f30) r_zcl_27))
