...
;%~p5 | ~p10 | f22_p
(assert (or (not l_p5) (not l_p10) l_f22_p))
...
;%~p12 | ~f22 | zcl_17
(assert (or (not l_p12) (not l_f22) l_zcl_17))
...
;%~p11 | ~f21 | zcl_18
(assert (or (not l_p11) (not l_f21) l_zcl_18))
...
(assert (or (not r_p5) (not r_p10) r_f22_p))
...
;%~r_p12 | ~r_f22 | r_zcl_17
(assert (or (not r_p12) (not r_f22) r_zcl_17))
...
;%~r_p11 | ~r_f21 | r_zcl_18
(assert (or (not r_p11) (not r_f21) r_zcl_18))
