...
;%~p9 | ~p6 | zcl_5
(assert (or (not l_p9) (not l_p6) l_zcl_5))
...
;%~p9 | ~p6 | f10_p
(assert (or (not l_p9) (not l_p6) l_f10_p))
...
;%~p0 | ~p10 | zcl_10
(assert (or (not l_p0) (not l_p10) l_zcl_10))
...
;%~p13 | ~p12 | zcl_15
(assert (or (not l_p13) (not l_p12) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((p13 & p12) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p13 | ~p12 | f22_p
(assert (or (not l_p13) (not l_p12) l_f22_p))
...
;%~p0 | ~p17 | zcl_25
(assert (or (not l_p0) (not l_p17) l_zcl_25))
...
;%~p0 | ~p17 | f33_p
(assert (or (not l_p0) (not l_p17) l_f33_p))
...
;%~p10 | ~f31 | zcl_28
(assert (or (not l_p10) (not l_f31) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p10 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p10 | ~f31_p | f30_p
(assert (or (not l_p10) (not l_f31_p) l_f30_p))
...
;%~r_p9 | ~r_p6 | r_zcl_5
(assert (or (not r_p9) (not r_p6) r_zcl_5))
...
(assert (or (not r_p9) (not r_p6) r_f10_p))
...
;%~r_p0 | ~r_p10 | r_zcl_10
(assert (or (not r_p0) (not r_p10) r_zcl_10))
...
;%~r_p13 | ~r_p12 | r_zcl_15
(assert (or (not r_p13) (not r_p12) r_zcl_15))
...
(assert (or (not r_p13) (not r_p12) r_f22_p))
...
;%~r_p0 | ~r_p17 | r_zcl_25
(assert (or (not r_p0) (not r_p17) r_zcl_25))
...
(assert (or (not r_p0) (not r_p17) r_f33_p))
...
;%~r_p10 | ~r_f31 | r_zcl_28
(assert (or (not r_p10) (not r_f31) r_zcl_28))
...
;%~r_p10 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p10) (not r_f31_p) r_f30_p))
