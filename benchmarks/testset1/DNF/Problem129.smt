...
;%~p7 | ~p10 | zcl_18
(assert (or (not l_p7) (not l_p10) l_zcl_18))
...
;%~p7 | ~p10 | f26_p
(assert (or (not l_p7) (not l_p10) l_f26_p))
...
;%~p12 | ~f25 | zcl_20
(assert (or (not l_p12) (not l_f25) l_zcl_20))
...
;%~p11 | ~f23 | zcl_22
(assert (or (not l_p11) (not l_f23) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((p11 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p11 | ~f23_p | f22_p
(assert (or (not l_p11) (not l_f23_p) l_f22_p))
...
;%~p16 | ~p13 | zcl_24
(assert (or (not l_p16) (not l_p13) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p16 & p13) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p16 | ~p13 | f33_p
(assert (or (not l_p16) (not l_p13) l_f33_p))
...
;%~p15 | ~f32 | zcl_26
(assert (or (not l_p15) (not l_f32) l_zcl_26))
...
;%~p14 | ~f31 | zcl_27
(assert (or (not l_p14) (not l_f31) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p14 | ~f31_p | f30_p
(assert (or (not l_p14) (not l_f31_p) l_f30_p))
...
;%~p18 | ~f35 | zcl_35
(assert (or (not l_p18) (not l_f35) l_zcl_35))
...
;%Non-clausified dependency
;%(forall[]((~p18 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p18 | ~f35_p | f34_p
(assert (or (not l_p18) (not l_f35_p) l_f34_p))
...
;%~r_p7 | ~r_p10 | r_zcl_18
(assert (or (not r_p7) (not r_p10) r_zcl_18))
...
(assert (or (not r_p7) (not r_p10) r_f26_p))
...
;%~r_p12 | ~r_f25 | r_zcl_20
(assert (or (not r_p12) (not r_f25) r_zcl_20))
...
;%~r_p11 | ~r_f23 | r_zcl_22
(assert (or (not r_p11) (not r_f23) r_zcl_22))
...
;%~r_p11 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p11) (not r_f23_p) r_f22_p))
...
;%~r_p16 | ~r_p13 | r_zcl_24
(assert (or (not r_p16) (not r_p13) r_zcl_24))
...
(assert (or (not r_p16) (not r_p13) r_f33_p))
...
;%~r_p15 | ~r_f32 | r_zcl_26
(assert (or (not r_p15) (not r_f32) r_zcl_26))
...
;%~r_p14 | ~r_f31 | r_zcl_27
(assert (or (not r_p14) (not r_f31) r_zcl_27))
...
;%~r_p14 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p14) (not r_f31_p) r_f30_p))
...
;%~r_p18 | ~r_f35 | r_zcl_35
(assert (or (not r_p18) (not r_f35) r_zcl_35))
...
;%~r_p18 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p18) (not r_f35_p) r_f34_p))
