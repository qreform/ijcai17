...
;%~p0 | ~p11 | zcl_14
(assert (or (not l_p0) (not l_p11) l_zcl_14))
...
;%~p0 | ~p12 | zcl_21
(assert (or (not l_p0) (not l_p12) l_zcl_21))
...
;%~p0 | ~p12 | f30_p
(assert (or (not l_p0) (not l_p12) l_f30_p))
...
;%~p11 | ~f30 | zcl_22
(assert (or (not l_p11) (not l_f30) l_zcl_22))
...
;%~p8 | ~f29 | zcl_23
(assert (or (not l_p8) (not l_f29) l_zcl_23))
...
;%~p8 | ~f27 | zcl_25
(assert (or (not l_p8) (not l_f27) l_zcl_25))
...
;%~zcl_28 | p13
(assert (or (not l_zcl_28) l_p13))

;%~p0 | ~p13 | zcl_28
(assert (or (not l_p0) (not l_p13) l_zcl_28))
...
;%~p0 | ~p13 | f38_p
(assert (or (not l_p0) (not l_p13) l_f38_p))
...
;%~p14 | ~f37 | zcl_30
(assert (or (not l_p14) (not l_f37) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p14 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p14 | ~f37_p | f36_p
(assert (or (not l_p14) (not l_f37_p) l_f36_p))
...
;%~p17 | ~p15 | zcl_35
(assert (or (not l_p17) (not l_p15) l_zcl_35))
...
;%Non-clausified dependency
;%(forall[]((p17 & p15) --> f45_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f45_p () Bool)
;%~p17 | ~p15 | f45_p
(assert (or (not l_p17) (not l_p15) l_f45_p))
...
;%~zcl_38 | p16
(assert (or (not l_zcl_38) l_p16))

;%~zcl_38 | f43
(assert (or (not l_zcl_38) l_f43))

;%~p16 | ~f43 | zcl_38
(assert (or (not l_p16) (not l_f43) l_zcl_38))
...
;%Non-clausified dependency
;%(forall[]((p16 & f43_p) --> f42_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f42_p () Bool)
;%~p16 | ~f43_p | f42_p
(assert (or (not l_p16) (not l_f43_p) l_f42_p))
...
;%~r_p0 | ~r_p11 | r_zcl_14
(assert (or (not r_p0) (not r_p11) r_zcl_14))
...
;%~r_p0 | ~r_p12 | r_zcl_21
(assert (or (not r_p0) (not r_p12) r_zcl_21))
...
(assert (or (not r_p0) (not r_p12) r_f30_p))
...
;%~r_p11 | ~r_f30 | r_zcl_22
(assert (or (not r_p11) (not r_f30) r_zcl_22))
...
;%~r_p8 | ~r_f29 | r_zcl_23
(assert (or (not r_p8) (not r_f29) r_zcl_23))
...
;%~r_p8 | ~r_f27 | r_zcl_25
(assert (or (not r_p8) (not r_f27) r_zcl_25))
...
;%~r_zcl_28 | r_p13
(assert (or (not r_zcl_28) r_p13))


;%~r_p0 | ~r_p13 | r_zcl_28
(assert (or (not r_p0) (not r_p13) r_zcl_28))
...
(assert (or (not r_p0) (not r_p13) r_f38_p))
...
;%~r_p14 | ~r_f37 | r_zcl_30
(assert (or (not r_p14) (not r_f37) r_zcl_30))
...
;%~r_p14 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p14) (not r_f37_p) r_f36_p))
...
;%~r_p17 | ~r_p15 | r_zcl_35
(assert (or (not r_p17) (not r_p15) r_zcl_35))
...
(assert (or (not r_p17) (not r_p15) r_f45_p))
...
;%~r_p16 | ~r_f43 | r_zcl_38
(assert (or (not r_p16) (not r_f43) r_zcl_38))
...
;%~r_p16 | ~r_f43_p | r_f42_p
(declare-fun r_f42_p () Bool)
(assert (or (not r_p16) (not r_f43_p) r_f42_p))
