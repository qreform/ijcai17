...
;%~p11 | ~p9 | zcl_14
(assert (or (not l_p11) (not l_p9) l_zcl_14))
...
;%~p10 | ~f20 | zcl_17
(assert (or (not l_p10) (not l_f20) l_zcl_17))
...
;%~p14 | ~p12 | zcl_21
(assert (or (not l_p14) (not l_p12) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((~p14 & p12) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p14 | ~p12 | f30_p
(assert (or (not l_p14) (not l_p12) l_f30_p))
...
;%~p13 | ~f30 | zcl_22
(assert (or (not l_p13) (not l_f30) l_zcl_22))
...
;%~p9 | ~f25 | zcl_27
(assert (or (not l_p9) (not l_f25) l_zcl_27))
...
;%~p8 | ~p15 | zcl_28
(assert (or (not l_p8) (not l_p15) l_zcl_28))
...
;%~p8 | ~p15 | f37_p
(assert (or (not l_p8) (not l_p15) l_f37_p))
...
;%~p0 | ~f37 | zcl_29
(assert (or (not l_p0) (not l_f37) l_zcl_29))
...
;%~p17 | ~f36 | zcl_30
(assert (or (not l_p17) (not l_f36) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((~p17 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p17 | ~f36_p | f35_p
(assert (or (not l_p17) (not l_f36_p) l_f35_p))
...
;%~p0 | ~f35 | zcl_31
(assert (or (not l_p0) (not l_f35) l_zcl_31))
...
;%~p0 | ~f34 | zcl_32
(assert (or (not l_p0) (not l_f34) l_zcl_32))
...
;%~p0 | ~f33 | zcl_33
(assert (or (not l_p0) (not l_f33) l_zcl_33))
...
;%~p16 | ~f32 | zcl_34
(assert (or (not l_p16) (not l_f32) l_zcl_34))
...
;%~r_p11 | ~r_p9 | r_zcl_14
(assert (or (not r_p11) (not r_p9) r_zcl_14))
...
;%~r_p10 | ~r_f20 | r_zcl_17
(assert (or (not r_p10) (not r_f20) r_zcl_17))
...
;%~r_p14 | ~r_p12 | r_zcl_21
(assert (or (not r_p14) (not r_p12) r_zcl_21))
...
(assert (or (not r_p14) (not r_p12) r_f30_p))
...
;%~r_p13 | ~r_f30 | r_zcl_22
(assert (or (not r_p13) (not r_f30) r_zcl_22))
...
;%~r_p9 | ~r_f25 | r_zcl_27
(assert (or (not r_p9) (not r_f25) r_zcl_27))
...
;%~r_p8 | ~r_p15 | r_zcl_28
(assert (or (not r_p8) (not r_p15) r_zcl_28))
...
(assert (or (not r_p8) (not r_p15) r_f37_p))
...
;%~r_p0 | ~r_f37 | r_zcl_29
(assert (or (not r_p0) (not r_f37) r_zcl_29))
...
;%~r_p17 | ~r_f36 | r_zcl_30
(assert (or (not r_p17) (not r_f36) r_zcl_30))
...
;%~r_p17 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p17) (not r_f36_p) r_f35_p))
...
;%~r_p0 | ~r_f35 | r_zcl_31
(assert (or (not r_p0) (not r_f35) r_zcl_31))
...
;%~r_p0 | ~r_f34 | r_zcl_32
(assert (or (not r_p0) (not r_f34) r_zcl_32))
...
;%~r_p0 | ~r_f33 | r_zcl_33
(assert (or (not r_p0) (not r_f33) r_zcl_33))
...
;%~r_p16 | ~r_f32 | r_zcl_34
(assert (or (not r_p16) (not r_f32) r_zcl_34))
