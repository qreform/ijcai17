...
;%~p8 | ~p6 | zcl_8
(assert (or (not l_p8) (not l_p6) l_zcl_8))
...
;%~p8 | ~p6 | f13_p
(assert (or (not l_p8) (not l_p6) l_f13_p))
...
;%~p11 | ~p9 | f15_p
(assert (or (not l_p11) (not l_p9) l_f15_p))
...
;%~r_p8 | ~r_p6 | r_zcl_8
(assert (or (not r_p8) (not r_p6) r_zcl_8))
...
(assert (or (not r_p8) (not r_p6) r_f13_p))
...
(assert (or (not r_p11) (not r_p9) r_f15_p))
