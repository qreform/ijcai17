...
;%~p10 | ~f22 | zcl_17
(assert (or (not l_p10) (not l_f22) l_zcl_17))
...
;%~p8 | ~f21 | zcl_18
(assert (or (not l_p8) (not l_f21) l_zcl_18))
...
;%~p0 | ~f20 | zcl_19
(assert (or (not l_p0) (not l_f20) l_zcl_19))
...
;%~r_p10 | ~r_f22 | r_zcl_17
(assert (or (not r_p10) (not r_f22) r_zcl_17))
...
;%~r_p8 | ~r_f21 | r_zcl_18
(assert (or (not r_p8) (not r_f21) r_zcl_18))
...
;%~r_p0 | ~r_f20 | r_zcl_19
(assert (or (not r_p0) (not r_f20) r_zcl_19))
