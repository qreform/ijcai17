...
;%~p0 | ~p7 | zcl_5
(assert (or (not l_p0) (not l_p7) l_zcl_5))
...
;%~p9 | ~p8 | zcl_6
(assert (or (not l_p9) (not l_p8) l_zcl_6))
...
;%~p9 | ~p8 | f11_p
(assert (or (not l_p9) (not l_p8) l_f11_p))
...
;%~r_p0 | ~r_p7 | r_zcl_5
(assert (or (not r_p0) (not r_p7) r_zcl_5))
...
;%~r_p9 | ~r_p8 | r_zcl_6
(assert (or (not r_p9) (not r_p8) r_zcl_6))
...
(assert (or (not r_p9) (not r_p8) r_f11_p))
