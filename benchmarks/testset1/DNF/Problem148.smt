...
;%~p5 | ~p7 | zcl_4
(assert (or (not l_p5) (not l_p7) l_zcl_4))
...
;%~p5 | ~p7 | f8_p
(assert (or (not l_p5) (not l_p7) l_f8_p))
...
;%~p9 | ~p8 | zcl_5
(assert (or (not l_p9) (not l_p8) l_zcl_5))
...
;%~p11 | ~p10 | zcl_6
(assert (or (not l_p11) (not l_p10) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((~p11 & p10) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p11 | ~p10 | f11_p
(assert (or (not l_p11) (not l_p10) l_f11_p))
...
;%~r_p5 | ~r_p7 | r_zcl_4
(assert (or (not r_p5) (not r_p7) r_zcl_4))
...
(assert (or (not r_p5) (not r_p7) r_f8_p))
...
;%~r_p9 | ~r_p8 | r_zcl_5
(assert (or (not r_p9) (not r_p8) r_zcl_5))
...
;%~r_p11 | ~r_p10 | r_zcl_6
(assert (or (not r_p11) (not r_p10) r_zcl_6))
...
(assert (or (not r_p11) (not r_p10) r_f11_p))
