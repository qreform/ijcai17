...
;%~p8 | ~f11 | zcl_11
(assert (or (not l_p8) (not l_f11) l_zcl_11))
...
;%~p0 | ~p9 | f18_p
(assert (or (not l_p0) (not l_p9) l_f18_p))
...
;%~p5 | ~p10 | zcl_16
(assert (or (not l_p5) (not l_p10) l_zcl_16))
...
;%~p5 | ~p10 | f23_p
(assert (or (not l_p5) (not l_p10) l_f23_p))
...
;%~p5 | ~p13 | zcl_20
(assert (or (not l_p5) (not l_p13) l_zcl_20))
...
;%~p5 | ~p13 | f28_p
(assert (or (not l_p5) (not l_p13) l_f28_p))
...
;%~p9 | ~p15 | zcl_24
(assert (or (not l_p9) (not l_p15) l_zcl_24))
...
;%~p9 | ~p15 | f32_p
(assert (or (not l_p9) (not l_p15) l_f32_p))
...
;%~p9 | ~f32 | zcl_25
(assert (or (not l_p9) (not l_f32) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p9 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p9 | ~f32_p | f31_p
(assert (or (not l_p9) (not l_f32_p) l_f31_p))
...
;%~p0 | ~f31 | zcl_26
(assert (or (not l_p0) (not l_f31) l_zcl_26))
...
;%~r_p8 | ~r_f11 | r_zcl_11
(assert (or (not r_p8) (not r_f11) r_zcl_11))
...
(assert (or (not r_p0) (not r_p9) r_f18_p))
...
;%~r_p5 | ~r_p10 | r_zcl_16
(assert (or (not r_p5) (not r_p10) r_zcl_16))
...
(assert (or (not r_p5) (not r_p10) r_f23_p))
...
;%~r_p5 | ~r_p13 | r_zcl_20
(assert (or (not r_p5) (not r_p13) r_zcl_20))
...
(assert (or (not r_p5) (not r_p13) r_f28_p))
...
;%~r_p9 | ~r_p15 | r_zcl_24
(assert (or (not r_p9) (not r_p15) r_zcl_24))
...
(assert (or (not r_p9) (not r_p15) r_f32_p))
...
;%~r_p9 | ~r_f32 | r_zcl_25
(assert (or (not r_p9) (not r_f32) r_zcl_25))
...
;%~r_p9 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p9) (not r_f32_p) r_f31_p))
...
;%~r_p0 | ~r_f31 | r_zcl_26
(assert (or (not r_p0) (not r_f31) r_zcl_26))
