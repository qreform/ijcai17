...
;%~p6 | ~f14 | zcl_10
(assert (or (not l_p6) (not l_f14) l_zcl_10))
...
;%~p11 | ~p9 | zcl_15
(assert (or (not l_p11) (not l_p9) l_zcl_15))
...
;%~p11 | ~p9 | f21_p
(assert (or (not l_p11) (not l_p9) l_f21_p))
...
;%~p10 | ~f21 | zcl_16
(assert (or (not l_p10) (not l_f21) l_zcl_16))
...
;%~r_p6 | ~r_f14 | r_zcl_10
(assert (or (not r_p6) (not r_f14) r_zcl_10))
...
;%~r_p11 | ~r_p9 | r_zcl_15
(assert (or (not r_p11) (not r_p9) r_zcl_15))
...
(assert (or (not r_p11) (not r_p9) r_f21_p))
...
;%~r_p10 | ~r_f21 | r_zcl_16
(assert (or (not r_p10) (not r_f21) r_zcl_16))
