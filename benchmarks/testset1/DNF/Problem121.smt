...
;%~p8 | ~f12 | zcl_7
(assert (or (not l_p8) (not l_f12) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p8 & f12_p) --> f11_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f11_p () Bool)
;%~p8 | ~f12_p | f11_p
(assert (or (not l_p8) (not l_f12_p) l_f11_p))
...
;%~p10 | ~p9 | zcl_12
(assert (or (not l_p10) (not l_p9) l_zcl_12))
...
;%~p10 | ~p9 | f19_p
(assert (or (not l_p10) (not l_p9) l_f19_p))
...
;%~zcl_19 | p9
(assert (or (not l_zcl_19) l_p9))

;%~zcl_19 | f26
(assert (or (not l_zcl_19) l_f26))

;%~p9 | ~f26 | zcl_19
(assert (or (not l_p9) (not l_f26) l_zcl_19))
...
;%~p14 | ~p12 | zcl_24
(assert (or (not l_p14) (not l_p12) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p14 & p12) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p14 | ~p12 | f33_p
(assert (or (not l_p14) (not l_p12) l_f33_p))
...
;%~p13 | ~f33 | zcl_25
(assert (or (not l_p13) (not l_f33) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p13 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p13 | ~f33_p | f32_p
(assert (or (not l_p13) (not l_f33_p) l_f32_p))
...
;%~p9 | ~p15 | zcl_30
(assert (or (not l_p9) (not l_p15) l_zcl_30))
...
;%~p9 | ~p15 | f39_p
(assert (or (not l_p9) (not l_p15) l_f39_p))
...
;%~p18 | ~f38 | zcl_32
(assert (or (not l_p18) (not l_f38) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p18 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p18 | ~f38_p | f37_p
(assert (or (not l_p18) (not l_f38_p) l_f37_p))
...
;%~p16 | ~f36 | zcl_34
(assert (or (not l_p16) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((p16 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p16 | ~f36_p | f35_p
(assert (or (not l_p16) (not l_f36_p) l_f35_p))
...
;%~r_p8 | ~r_f12 | r_zcl_7
(assert (or (not r_p8) (not r_f12) r_zcl_7))
...
;%~r_p8 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p8) (not r_f12_p) r_f11_p))
...
;%~r_p10 | ~r_p9 | r_zcl_12
(assert (or (not r_p10) (not r_p9) r_zcl_12))
...
(assert (or (not r_p10) (not r_p9) r_f19_p))
...
;%~r_p9 | ~r_f26 | r_zcl_19
(assert (or (not r_p9) (not r_f26) r_zcl_19))
...
;%~r_p14 | ~r_p12 | r_zcl_24
(assert (or (not r_p14) (not r_p12) r_zcl_24))
...
(assert (or (not r_p14) (not r_p12) r_f33_p))
...
;%~r_p13 | ~r_f33 | r_zcl_25
(assert (or (not r_p13) (not r_f33) r_zcl_25))
...
;%~r_p13 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p13) (not r_f33_p) r_f32_p))
...
;%~r_p9 | ~r_p15 | r_zcl_30
(assert (or (not r_p9) (not r_p15) r_zcl_30))
...
(assert (or (not r_p9) (not r_p15) r_f39_p))
...
;%~r_p18 | ~r_f38 | r_zcl_32
(assert (or (not r_p18) (not r_f38) r_zcl_32))
...
;%~r_p18 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p18) (not r_f38_p) r_f37_p))
...
;%~r_p16 | ~r_f36 | r_zcl_34
(assert (or (not r_p16) (not r_f36) r_zcl_34))
...
;%~r_p16 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p16) (not r_f36_p) r_f35_p))
