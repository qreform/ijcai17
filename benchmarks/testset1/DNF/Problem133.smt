...
;%~p9 | ~p8 | zcl_7
(assert (or (not l_p9) (not l_p8) l_zcl_7))
...
;%~p9 | ~p8 | f14_p
(assert (or (not l_p9) (not l_p8) l_f14_p))
...
;%~p0 | ~f9 | zcl_13
(assert (or (not l_p0) (not l_f9) l_zcl_13))
...
;%~p0 | ~p10 | zcl_14
(assert (or (not l_p0) (not l_p10) l_zcl_14))
...
;%~zcl_16 | p12
(assert (or (not l_zcl_16) l_p12))

;%~zcl_16 | f21
(assert (or (not l_zcl_16) l_f21))

;%~p12 | ~f21 | zcl_16
(assert (or (not l_p12) (not l_f21) l_zcl_16))
...
;%~p0 | ~f20 | zcl_17
(assert (or (not l_p0) (not l_f20) l_zcl_17))
...
;%~p11 | ~f19 | zcl_18
(assert (or (not l_p11) (not l_f19) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p11 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p11 | ~f19_p | f18_p
(assert (or (not l_p11) (not l_f19_p) l_f18_p))
...
;%~p0 | ~f18 | zcl_19
(assert (or (not l_p0) (not l_f18) l_zcl_19))
...
;%~p0 | ~p13 | zcl_21
(assert (or (not l_p0) (not l_p13) l_zcl_21))
...
;%~p0 | ~p13 | f30_p
(assert (or (not l_p0) (not l_p13) l_f30_p))
...
;%~zcl_22 | p10
(assert (or (not l_zcl_22) l_p10))

;%~zcl_22 | f30
(assert (or (not l_zcl_22) l_f30))

;%~p10 | ~f30 | zcl_22
(assert (or (not l_p10) (not l_f30) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((p10 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p10 | ~f30_p | f29_p
(assert (or (not l_p10) (not l_f30_p) l_f29_p))
...
;%~p0 | ~f27 | zcl_25
(assert (or (not l_p0) (not l_f27) l_zcl_25))
...
;%~p0 | ~f26 | zcl_26
(assert (or (not l_p0) (not l_f26) l_zcl_26))
...
;%~zcl_27 | p10
(assert (or (not l_zcl_27) l_p10))

;%~zcl_27 | f25
(assert (or (not l_zcl_27) l_f25))

;%~p10 | ~f25 | zcl_27
(assert (or (not l_p10) (not l_f25) l_zcl_27))
...
;%~zcl_28 | p14
(assert (or (not l_zcl_28) l_p14))

;%~p0 | ~p14 | zcl_28
(assert (or (not l_p0) (not l_p14) l_zcl_28))
...
;%~p0 | ~p14 | f38_p
(assert (or (not l_p0) (not l_p14) l_f38_p))
...
;%~p17 | ~f38 | zcl_29
(assert (or (not l_p17) (not l_f38) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p17 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p17 | ~f38_p | f37_p
(assert (or (not l_p17) (not l_f38_p) l_f37_p))
...
;%~p16 | ~f37 | zcl_30
(assert (or (not l_p16) (not l_f37) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p16 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p16 | ~f37_p | f36_p
(assert (or (not l_p16) (not l_f37_p) l_f36_p))
...
;%~zcl_32 | p10
(assert (or (not l_zcl_32) l_p10))

;%~zcl_32 | f35
(assert (or (not l_zcl_32) l_f35))

;%~p10 | ~f35 | zcl_32
(assert (or (not l_p10) (not l_f35) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p10 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p10 | ~f35_p | f34_p
(assert (or (not l_p10) (not l_f35_p) l_f34_p))
...
;%~p0 | ~f34 | zcl_33
(assert (or (not l_p0) (not l_f34) l_zcl_33))
...
;%~zcl_34 | p15
(assert (or (not l_zcl_34) l_p15))

;%~zcl_34 | f33
(assert (or (not l_zcl_34) l_f33))

;%~p15 | ~f33 | zcl_34
(assert (or (not l_p15) (not l_f33) l_zcl_34))
...
;%~zcl_35 | p18
(assert (or (not l_zcl_35) l_p18))

;%~p0 | ~p18 | zcl_35
(assert (or (not l_p0) (not l_p18) l_zcl_35))
...
;%~p0 | ~p18 | f45_p
(assert (or (not l_p0) (not l_p18) l_f45_p))
...
;%~p0 | ~f44 | zcl_37
(assert (or (not l_p0) (not l_f44) l_zcl_37))
...
;%~p0 | ~f43 | zcl_38
(assert (or (not l_p0) (not l_f43) l_zcl_38))
...
;%~zcl_39 | p20
(assert (or (not l_zcl_39) l_p20))

;%~zcl_39 | f42
(assert (or (not l_zcl_39) l_f42))

;%~p20 | ~f42 | zcl_39
(assert (or (not l_p20) (not l_f42) l_zcl_39))
...
;%Non-clausified dependency
;%(forall[]((p20 & f42_p) --> f41_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f41_p () Bool)
;%~p20 | ~f42_p | f41_p
(assert (or (not l_p20) (not l_f42_p) l_f41_p))
...
;%~zcl_40 | p19
(assert (or (not l_zcl_40) l_p19))

;%~zcl_40 | f41
(assert (or (not l_zcl_40) l_f41))

;%~p19 | ~f41 | zcl_40
(assert (or (not l_p19) (not l_f41) l_zcl_40))
...
;%Non-clausified dependency
;%(forall[]((p19 & f41_p) --> f40_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f40_p () Bool)
;%~p19 | ~f41_p | f40_p
(assert (or (not l_p19) (not l_f41_p) l_f40_p))
...
;%~p0 | ~f40 | zcl_41
(assert (or (not l_p0) (not l_f40) l_zcl_41))
...
;%~r_p9 | ~r_p8 | r_zcl_7
(assert (or (not r_p9) (not r_p8) r_zcl_7))
...
(assert (or (not r_p9) (not r_p8) r_f14_p))
...
;%~r_p0 | ~r_f9 | r_zcl_13
(assert (or (not r_p0) (not r_f9) r_zcl_13))
...
;%~r_p0 | ~r_p10 | r_zcl_14
(assert (or (not r_p0) (not r_p10) r_zcl_14))
...
;%~r_p12 | ~r_f21 | r_zcl_16
(assert (or (not r_p12) (not r_f21) r_zcl_16))
...
;%~r_p0 | ~r_f20 | r_zcl_17
(assert (or (not r_p0) (not r_f20) r_zcl_17))
...
;%~r_p11 | ~r_f19 | r_zcl_18
(assert (or (not r_p11) (not r_f19) r_zcl_18))
...
;%~r_p11 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p11) (not r_f19_p) r_f18_p))
...
;%~r_p0 | ~r_f18 | r_zcl_19
(assert (or (not r_p0) (not r_f18) r_zcl_19))
...
;%~r_p0 | ~r_p13 | r_zcl_21
(assert (or (not r_p0) (not r_p13) r_zcl_21))
...
(assert (or (not r_p0) (not r_p13) r_f30_p))


;%~r_zcl_22 | r_p10
(declare-fun r_zcl_22 () Bool)
(assert (or (not r_zcl_22) r_p10))
...
;%~r_p10 | ~r_f30 | r_zcl_22
(assert (or (not r_p10) (not r_f30) r_zcl_22))
...
;%~r_p10 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p10) (not r_f30_p) r_f29_p))
...
;%~r_p0 | ~r_f27 | r_zcl_25
(assert (or (not r_p0) (not r_f27) r_zcl_25))
...
;%~r_p0 | ~r_f26 | r_zcl_26
(assert (or (not r_p0) (not r_f26) r_zcl_26))
...
;%~r_p10 | ~r_f25 | r_zcl_27
(assert (or (not r_p10) (not r_f25) r_zcl_27))
...
;%~r_zcl_28 | r_p14
(assert (or (not r_zcl_28) r_p14))


;%~r_p0 | ~r_p14 | r_zcl_28
(assert (or (not r_p0) (not r_p14) r_zcl_28))
...
(assert (or (not r_p0) (not r_p14) r_f38_p))
...
;%~r_p17 | ~r_f38 | r_zcl_29
(assert (or (not r_p17) (not r_f38) r_zcl_29))
...
;%~r_p17 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p17) (not r_f38_p) r_f37_p))
...
;%~r_p16 | ~r_f37 | r_zcl_30
(assert (or (not r_p16) (not r_f37) r_zcl_30))
...
;%~r_p16 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p16) (not r_f37_p) r_f36_p))
...
;%~r_p10 | ~r_f35 | r_zcl_32
(assert (or (not r_p10) (not r_f35) r_zcl_32))
...
;%~r_p10 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p10) (not r_f35_p) r_f34_p))
...
;%~r_p0 | ~r_f34 | r_zcl_33
(assert (or (not r_p0) (not r_f34) r_zcl_33))
...
;%~r_p15 | ~r_f33 | r_zcl_34
(assert (or (not r_p15) (not r_f33) r_zcl_34))
...
;%~r_zcl_35 | r_p18
(assert (or (not r_zcl_35) r_p18))


;%~r_p0 | ~r_p18 | r_zcl_35
(assert (or (not r_p0) (not r_p18) r_zcl_35))
...
(assert (or (not r_p0) (not r_p18) r_f45_p))
...
;%~r_p0 | ~r_f44 | r_zcl_37
(assert (or (not r_p0) (not r_f44) r_zcl_37))
...
;%~r_p0 | ~r_f43 | r_zcl_38
(assert (or (not r_p0) (not r_f43) r_zcl_38))
...
;%~r_p20 | ~r_f42 | r_zcl_39
(assert (or (not r_p20) (not r_f42) r_zcl_39))
...
;%~r_p20 | ~r_f42_p | r_f41_p
(declare-fun r_f41_p () Bool)
(assert (or (not r_p20) (not r_f42_p) r_f41_p))


;%~r_zcl_40 | r_p19
(declare-fun r_zcl_40 () Bool)
(assert (or (not r_zcl_40) r_p19))
...
;%~r_p19 | ~r_f41 | r_zcl_40
(assert (or (not r_p19) (not r_f41) r_zcl_40))
...
;%~r_p19 | ~r_f41_p | r_f40_p
(declare-fun r_f40_p () Bool)
(assert (or (not r_p19) (not r_f41_p) r_f40_p))
...
;%~r_p0 | ~r_f40 | r_zcl_41
(assert (or (not r_p0) (not r_f40) r_zcl_41))
