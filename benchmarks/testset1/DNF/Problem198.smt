...
;%~p7 | ~f19 | zcl_13
(assert (or (not l_p7) (not l_f19) l_zcl_13))
...
;%Non-clausified dependency
;%(forall[]((p7 & f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p7 | ~f19_p | f18_p
(assert (or (not l_p7) (not l_f19_p) l_f18_p))
...
;%~p0 | ~p10 | zcl_24
(assert (or (not l_p0) (not l_p10) l_zcl_24))
...
;%~p0 | ~p10 | f33_p
(assert (or (not l_p0) (not l_p10) l_f33_p))
...
;%~zcl_26 | p13
(assert (or (not l_zcl_26) l_p13))

;%~zcl_26 | f32
(assert (or (not l_zcl_26) l_f32))

;%~p13 | ~f32 | zcl_26
(assert (or (not l_p13) (not l_f32) l_zcl_26))
...
;%~p12 | ~f31 | zcl_27
(assert (or (not l_p12) (not l_f31) l_zcl_27))
...
;%~zcl_28 | p7
(assert (or (not l_zcl_28) l_p7))

;%~zcl_28 | f30
(assert (or (not l_zcl_28) l_f30))

;%~p7 | ~f30 | zcl_28
(assert (or (not l_p7) (not l_f30) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((~p7 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p7 | ~f30_p | f29_p
(assert (or (not l_p7) (not l_f30_p) l_f29_p))
...
;%~p11 | ~f29 | zcl_29
(assert (or (not l_p11) (not l_f29) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p11 | ~f29_p | f28_p
(assert (or (not l_p11) (not l_f29_p) l_f28_p))
...
;%~zcl_30 | p14
(assert (or (not l_zcl_30) l_p14))

;%~p18 | ~p14 | zcl_30
(assert (or (not l_p18) (not l_p14) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((~p18 & ~p14) --> f40_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f40_p () Bool)
;%~p18 | ~p14 | f40_p
(assert (or (not l_p18) (not l_p14) l_f40_p))
...
;%~p0 | ~f39 | zcl_32
(assert (or (not l_p0) (not l_f39) l_zcl_32))
...
;%~p17 | ~f38 | zcl_33
(assert (or (not l_p17) (not l_f38) l_zcl_33))
...
;%~zcl_34 | p16
(assert (or (not l_zcl_34) l_p16))

;%~zcl_34 | f37
(assert (or (not l_zcl_34) l_f37))

;%~p16 | ~f37 | zcl_34
(assert (or (not l_p16) (not l_f37) l_zcl_34))
...
;%~zcl_35 | p15
(assert (or (not l_zcl_35) l_p15))

;%~zcl_35 | f36
(assert (or (not l_zcl_35) l_f36))

;%~p15 | ~f36 | zcl_35
(assert (or (not l_p15) (not l_f36) l_zcl_35))
...
;%Non-clausified dependency
;%(forall[]((~p15 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p15 | ~f36_p | f35_p
(assert (or (not l_p15) (not l_f36_p) l_f35_p))
...
;%~zcl_36 | p19
(assert (or (not l_zcl_36) l_p19))

;%~p0 | ~p19 | zcl_36
(assert (or (not l_p0) (not l_p19) l_zcl_36))
...
;%~p0 | ~p19 | f46_p
(assert (or (not l_p0) (not l_p19) l_f46_p))
...
;%~r_p7 | ~r_f19 | r_zcl_13
(assert (or (not r_p7) (not r_f19) r_zcl_13))
...
;%~r_p7 | ~r_f19_p | r_f18_p
(declare-fun r_f18_p () Bool)
(assert (or (not r_p7) (not r_f19_p) r_f18_p))
...
;%~r_p0 | ~r_p10 | r_zcl_24
(assert (or (not r_p0) (not r_p10) r_zcl_24))
...
(assert (or (not r_p0) (not r_p10) r_f33_p))
...
;%~r_p13 | ~r_f32 | r_zcl_26
(assert (or (not r_p13) (not r_f32) r_zcl_26))
...
;%~r_p12 | ~r_f31 | r_zcl_27
(assert (or (not r_p12) (not r_f31) r_zcl_27))
...
;%~r_p7 | ~r_f30 | r_zcl_28
(assert (or (not r_p7) (not r_f30) r_zcl_28))
...
;%~r_p7 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p7) (not r_f30_p) r_f29_p))
...
;%~r_p11 | ~r_f29 | r_zcl_29
(assert (or (not r_p11) (not r_f29) r_zcl_29))
...
;%~r_p11 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p11) (not r_f29_p) r_f28_p))
...
;%~r_zcl_30 | r_p14
(assert (or (not r_zcl_30) r_p14))


;%~r_p18 | ~r_p14 | r_zcl_30
(assert (or (not r_p18) (not r_p14) r_zcl_30))
...
(assert (or (not r_p18) (not r_p14) r_f40_p))
...
;%~r_p0 | ~r_f39 | r_zcl_32
(assert (or (not r_p0) (not r_f39) r_zcl_32))
...
;%~r_p17 | ~r_f38 | r_zcl_33
(assert (or (not r_p17) (not r_f38) r_zcl_33))
...
;%~r_p16 | ~r_f37 | r_zcl_34
(assert (or (not r_p16) (not r_f37) r_zcl_34))
...
;%~r_p15 | ~r_f36 | r_zcl_35
(assert (or (not r_p15) (not r_f36) r_zcl_35))
...
;%~r_p15 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p15) (not r_f36_p) r_f35_p))
...
;%~r_zcl_36 | r_p19
(assert (or (not r_zcl_36) r_p19))


;%~r_p0 | ~r_p19 | r_zcl_36
(assert (or (not r_p0) (not r_p19) r_zcl_36))
...
(assert (or (not r_p0) (not r_p19) r_f46_p))
