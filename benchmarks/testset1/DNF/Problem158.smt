...
;%~p0 | ~p5 | f7_p
(assert (or (not l_p0) (not l_p5) l_f7_p))
...
;%~p3 | ~p8 | zcl_8
(assert (or (not l_p3) (not l_p8) l_zcl_8))
...
;%~zcl_11 | p3
(assert (or (not l_zcl_11) l_p3))

;%~zcl_11 | f16
(assert (or (not l_zcl_11) l_f16))

;%~p3 | ~f16 | zcl_11
(assert (or (not l_p3) (not l_f16) l_zcl_11))
...
;%~p9 | ~p11 | zcl_12
(assert (or (not l_p9) (not l_p11) l_zcl_12))
...
;%~p9 | ~p11 | f18_p
(assert (or (not l_p9) (not l_p11) l_f18_p))
...
(assert (or (not r_p0) (not r_p5) r_f7_p))
...
;%~r_p3 | ~r_p8 | r_zcl_8
(assert (or (not r_p3) (not r_p8) r_zcl_8))
...
;%~r_p3 | ~r_f16 | r_zcl_11
(assert (or (not r_p3) (not r_f16) r_zcl_11))
...
;%~r_p9 | ~r_p11 | r_zcl_12
(assert (or (not r_p9) (not r_p11) r_zcl_12))
...
(assert (or (not r_p9) (not r_p11) r_f18_p))
