...
;%~f32 | zcl_24
(assert (or (not l_f32) l_zcl_24))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p34 & ~p28) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p34 | ~p28 | f32_p
(assert (or (not l_p34) (not l_p28) l_f32_p))
...
;%~zcl_25 | f32
(assert (or (not l_zcl_25) l_f32))

;%~p33 | ~f32 | zcl_25
(assert (or (not l_p33) (not l_f32) l_zcl_25))

(declare-fun l_f31 () Bool)
;%~f31 | zcl_25
(assert (or (not l_f31) l_zcl_25))
...
;%~zcl_26 | f31
(assert (or (not l_zcl_26) l_f31))

;%~p32 | ~f31 | zcl_26
(assert (or (not l_p32) (not l_f31) l_zcl_26))

(declare-fun l_f30 () Bool)
;%~f30 | zcl_26
(assert (or (not l_f30) l_zcl_26))
...
;%~zcl_27 | f30
(assert (or (not l_zcl_27) l_f30))

;%~p31 | ~f30 | zcl_27
(assert (or (not l_p31) (not l_f30) l_zcl_27))

(declare-fun l_f29 () Bool)
;%~f29 | zcl_27
(assert (or (not l_f29) l_zcl_27))
...
;%~zcl_28 | f29
(assert (or (not l_zcl_28) l_f29))

;%~p30 | ~f29 | zcl_28
(assert (or (not l_p30) (not l_f29) l_zcl_28))

(declare-fun l_f28 () Bool)
;%~f28 | zcl_28
(assert (or (not l_f28) l_zcl_28))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p30 & f29_p) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p30 | ~f29_p | f28_p
(assert (or (not l_p30) (not l_f29_p) l_f28_p))
...
;%~zcl_29 | f28
(assert (or (not l_zcl_29) l_f28))

;%~p29 | ~f28 | zcl_29
(assert (or (not l_p29) (not l_f28) l_zcl_29))

(declare-fun l_f27 () Bool)
;%~f27 | zcl_29
(assert (or (not l_f27) l_zcl_29))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p29 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p29 | ~f28_p | f27_p
(assert (or (not l_p29) (not l_f28_p) l_f27_p))
...
(assert (or (not r_f32) r_zcl_24))


;%~r_p34 | ~r_p28 | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p34) (not r_p28) r_f32_p))
...
;%~r_zcl_25 | r_f32
(assert (or (not r_zcl_25) r_f32))


;%~r_p33 | ~r_f32 | r_zcl_25
(assert (or (not r_p33) (not r_f32) r_zcl_25))


;%~r_f31 | r_zcl_25
(declare-fun r_f31 () Bool)
(assert (or (not r_f31) r_zcl_25))
...
;%~r_zcl_26 | r_f31
(assert (or (not r_zcl_26) r_f31))


;%~r_p32 | ~r_f31 | r_zcl_26
(assert (or (not r_p32) (not r_f31) r_zcl_26))


;%~r_f30 | r_zcl_26
(declare-fun r_f30 () Bool)
(assert (or (not r_f30) r_zcl_26))
...
;%~r_zcl_27 | r_f30
(assert (or (not r_zcl_27) r_f30))


;%~r_p31 | ~r_f30 | r_zcl_27
(assert (or (not r_p31) (not r_f30) r_zcl_27))


;%~r_f29 | r_zcl_27
(declare-fun r_f29 () Bool)
(assert (or (not r_f29) r_zcl_27))
...
;%~r_zcl_28 | r_f29
(assert (or (not r_zcl_28) r_f29))


;%~r_p30 | ~r_f29 | r_zcl_28
(assert (or (not r_p30) (not r_f29) r_zcl_28))


;%~r_f28 | r_zcl_28
(declare-fun r_f28 () Bool)
(assert (or (not r_f28) r_zcl_28))


;%~r_p30 | ~r_f29_p | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p30) (not r_f29_p) r_f28_p))
...
;%~r_zcl_29 | r_f28
(assert (or (not r_zcl_29) r_f28))


;%~r_p29 | ~r_f28 | r_zcl_29
(assert (or (not r_p29) (not r_f28) r_zcl_29))


;%~r_f27 | r_zcl_29
(declare-fun r_f27 () Bool)
(assert (or (not r_f27) r_zcl_29))


;%~r_p29 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p29) (not r_f28_p) r_f27_p))
