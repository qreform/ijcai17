...
;%~p10 | ~f17 | zcl_20
(assert (or (not l_p10) (not l_f17) l_zcl_20))
...
;%~p13 | ~f28 | zcl_24
(assert (or (not l_p13) (not l_f28) l_zcl_24))
...
;%~p0 | ~p14 | f37_p
(assert (or (not l_p0) (not l_p14) l_f37_p))
...
;%~zcl_31 | p8
(assert (or (not l_zcl_31) l_p8))

;%~zcl_31 | f35
(assert (or (not l_zcl_31) l_f35))

;%~p8 | ~f35 | zcl_31
(assert (or (not l_p8) (not l_f35) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p8 & f35_p) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p8 | ~f35_p | f34_p
(assert (or (not l_p8) (not l_f35_p) l_f34_p))
...
;%~r_p10 | ~r_f17 | r_zcl_20
(assert (or (not r_p10) (not r_f17) r_zcl_20))
...
;%~r_p13 | ~r_f28 | r_zcl_24
(assert (or (not r_p13) (not r_f28) r_zcl_24))
...
(assert (or (not r_p0) (not r_p14) r_f37_p))
...
;%~r_p8 | ~r_f35 | r_zcl_31
(assert (or (not r_p8) (not r_f35) r_zcl_31))
...
;%~r_p8 | ~r_f35_p | r_f34_p
(declare-fun r_f34_p () Bool)
(assert (or (not r_p8) (not r_f35_p) r_f34_p))
