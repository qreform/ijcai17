...
;%~p11 | ~p8 | zcl_8
(assert (or (not l_p11) (not l_p8) l_zcl_8))
...
;%~p11 | ~p8 | f13_p
(assert (or (not l_p11) (not l_p8) l_f13_p))
...
;%~p0 | ~p12 | zcl_12
(assert (or (not l_p0) (not l_p12) l_zcl_12))
...
;%~p0 | ~p12 | f18_p
(assert (or (not l_p0) (not l_p12) l_f18_p))
...
;%~p8 | ~f21 | zcl_19
(assert (or (not l_p8) (not l_f21) l_zcl_19))
...
;%~p8 | ~p14 | zcl_20
(assert (or (not l_p8) (not l_p14) l_zcl_20))
...
;%~p8 | ~p14 | f27_p
(assert (or (not l_p8) (not l_p14) l_f27_p))
...
;%~p8 | ~f26 | zcl_22
(assert (or (not l_p8) (not l_f26) l_zcl_22))
...
;%~p8 | ~f25 | zcl_23
(assert (or (not l_p8) (not l_f25) l_zcl_23))
...
;%~r_p11 | ~r_p8 | r_zcl_8
(assert (or (not r_p11) (not r_p8) r_zcl_8))
...
(assert (or (not r_p11) (not r_p8) r_f13_p))
...
;%~r_p0 | ~r_p12 | r_zcl_12
(assert (or (not r_p0) (not r_p12) r_zcl_12))
...
(assert (or (not r_p0) (not r_p12) r_f18_p))
...
;%~r_p8 | ~r_f21 | r_zcl_19
(assert (or (not r_p8) (not r_f21) r_zcl_19))
...
;%~r_p8 | ~r_p14 | r_zcl_20
(assert (or (not r_p8) (not r_p14) r_zcl_20))
...
(assert (or (not r_p8) (not r_p14) r_f27_p))
...
;%~r_p8 | ~r_f26 | r_zcl_22
(assert (or (not r_p8) (not r_f26) r_zcl_22))
...
;%~r_p8 | ~r_f25 | r_zcl_23
(assert (or (not r_p8) (not r_f25) r_zcl_23))
