...
;%~p15 | ~p12 | zcl_24
(assert (or (not l_p15) (not l_p12) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p15 & p12) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p15 | ~p12 | f33_p
(assert (or (not l_p15) (not l_p12) l_f33_p))
...
;%~p14 | ~f33 | zcl_25
(assert (or (not l_p14) (not l_f33) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((p14 & f33_p) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p14 | ~f33_p | f32_p
(assert (or (not l_p14) (not l_f33_p) l_f32_p))
...
;%~p7 | ~f29 | zcl_29
(assert (or (not l_p7) (not l_f29) l_zcl_29))
...
;%~zcl_36 | p17
(assert (or (not l_zcl_36) l_p17))

;%~p0 | ~p17 | zcl_36
(assert (or (not l_p0) (not l_p17) l_zcl_36))
...
;%~p0 | ~p17 | f46_p
(assert (or (not l_p0) (not l_p17) l_f46_p))
...
;%~zcl_39 | p18
(assert (or (not l_zcl_39) l_p18))

;%~zcl_39 | f44
(assert (or (not l_zcl_39) l_f44))

;%~p18 | ~f44 | zcl_39
(assert (or (not l_p18) (not l_f44) l_zcl_39))
...
;%Non-clausified dependency
;%(forall[]((p18 & f44_p) --> f43_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f43_p () Bool)
;%~p18 | ~f44_p | f43_p
(assert (or (not l_p18) (not l_f44_p) l_f43_p))
...
;%~zcl_40 | p12
(assert (or (not l_zcl_40) l_p12))

;%~zcl_40 | f43
(assert (or (not l_zcl_40) l_f43))

;%~p12 | ~f43 | zcl_40
(assert (or (not l_p12) (not l_f43) l_zcl_40))
...
;%Non-clausified dependency
;%(forall[]((p12 & f43_p) --> f42_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f42_p () Bool)
;%~p12 | ~f43_p | f42_p
(assert (or (not l_p12) (not l_f43_p) l_f42_p))
...
;%~r_p15 | ~r_p12 | r_zcl_24
(assert (or (not r_p15) (not r_p12) r_zcl_24))
...
(assert (or (not r_p15) (not r_p12) r_f33_p))
...
;%~r_p14 | ~r_f33 | r_zcl_25
(assert (or (not r_p14) (not r_f33) r_zcl_25))
...
;%~r_p14 | ~r_f33_p | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p14) (not r_f33_p) r_f32_p))
...
;%~r_p7 | ~r_f29 | r_zcl_29
(assert (or (not r_p7) (not r_f29) r_zcl_29))
...
;%~r_zcl_36 | r_p17
(assert (or (not r_zcl_36) r_p17))


;%~r_p0 | ~r_p17 | r_zcl_36
(assert (or (not r_p0) (not r_p17) r_zcl_36))
...
(assert (or (not r_p0) (not r_p17) r_f46_p))
...
;%~r_p18 | ~r_f44 | r_zcl_39
(assert (or (not r_p18) (not r_f44) r_zcl_39))
...
;%~r_p18 | ~r_f44_p | r_f43_p
(declare-fun r_f43_p () Bool)
(assert (or (not r_p18) (not r_f44_p) r_f43_p))


;%~r_zcl_40 | r_p12
(declare-fun r_zcl_40 () Bool)
(assert (or (not r_zcl_40) r_p12))
...
;%~r_p12 | ~r_f43 | r_zcl_40
(assert (or (not r_p12) (not r_f43) r_zcl_40))
...
;%~r_p12 | ~r_f43_p | r_f42_p
(declare-fun r_f42_p () Bool)
(assert (or (not r_p12) (not r_f43_p) r_f42_p))
