...
;%~p8 | ~f10 | zcl_6
(assert (or (not l_p8) (not l_f10) l_zcl_6))
...
;%Non-clausified dependency
;%(forall[]((p8 & f10_p) --> f9_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f9_p () Bool)
;%~p8 | ~f10_p | f9_p
(assert (or (not l_p8) (not l_f10_p) l_f9_p))
...
;%~zcl_11 | p12
(assert (or (not l_zcl_11) l_p12))

;%~zcl_11 | f16
(assert (or (not l_zcl_11) l_f16))

;%~p12 | ~f16 | zcl_11
(assert (or (not l_p12) (not l_f16) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((p12 & f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p12 | ~f16_p | f15_p
(assert (or (not l_p12) (not l_f16_p) l_f15_p))
...
;%~p6 | ~f14 | zcl_13
(assert (or (not l_p6) (not l_f14) l_zcl_13))
...
;%~p6 | ~f14_p | f13_p
(assert (or (not l_p6) (not l_f14_p) l_f13_p))
...
;%~p15 | ~p13 | zcl_15
(assert (or (not l_p15) (not l_p13) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((p15 & p13) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p15 | ~p13 | f22_p
(assert (or (not l_p15) (not l_p13) l_f22_p))
...
;%~p14 | ~f22 | zcl_16
(assert (or (not l_p14) (not l_f22) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f22_p) --> f21_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f21_p () Bool)
;%~p14 | ~f22_p | f21_p
(assert (or (not l_p14) (not l_f22_p) l_f21_p))
...
;%~p0 | ~p16 | zcl_20
(assert (or (not l_p0) (not l_p16) l_zcl_20))
...
;%~p0 | ~p16 | f28_p
(assert (or (not l_p0) (not l_p16) l_f28_p))
...
;%~p18 | ~f28 | zcl_21
(assert (or (not l_p18) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p18 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p18 | ~f28_p | f27_p
(assert (or (not l_p18) (not l_f28_p) l_f27_p))
...
;%~p17 | ~f27 | zcl_22
(assert (or (not l_p17) (not l_f27) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((~p17 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p17 | ~f27_p | f26_p
(assert (or (not l_p17) (not l_f27_p) l_f26_p))
...
;%~p6 | ~p19 | zcl_25
(assert (or (not l_p6) (not l_p19) l_zcl_25))

(declare-fun l_f33 () Bool)
;%~f33 | zcl_25
(assert (or (not l_f33) l_zcl_25))
...
;%~p6 | ~p19 | f33_p
(assert (or (not l_p6) (not l_p19) l_f33_p))
...
;%~zcl_26 | p16
(assert (or (not l_zcl_26) l_p16))

;%~zcl_26 | f33
(assert (or (not l_zcl_26) l_f33))

;%~p16 | ~f33 | zcl_26
(assert (or (not l_p16) (not l_f33) l_zcl_26))

(declare-fun l_f32 () Bool)
;%~f32 | zcl_26
(assert (or (not l_f32) l_zcl_26))
...
;%~zcl_27 | f32
(assert (or (not l_zcl_27) l_f32))

;%~p0 | ~f32 | zcl_27
(assert (or (not l_p0) (not l_f32) l_zcl_27))

(declare-fun l_f31 () Bool)
;%~f31 | zcl_27
(assert (or (not l_f31) l_zcl_27))
...
;%~zcl_28 | p9
(assert (or (not l_zcl_28) l_p9))

;%~zcl_28 | f31
(assert (or (not l_zcl_28) l_f31))

;%~p9 | ~f31 | zcl_28
(assert (or (not l_p9) (not l_f31) l_zcl_28))

(declare-fun l_f30 () Bool)
;%~f30 | zcl_28
(assert (or (not l_f30) l_zcl_28))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p9 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p9 | ~f31_p | f30_p
(assert (or (not l_p9) (not l_f31_p) l_f30_p))
...
;%~zcl_29 | f30
(assert (or (not l_zcl_29) l_f30))

;%~p0 | ~f30 | zcl_29
(assert (or (not l_p0) (not l_f30) l_zcl_29))

(declare-fun l_f29 () Bool)
;%~f29 | zcl_29
(assert (or (not l_f29) l_zcl_29))
...
;%~r_p8 | ~r_f10 | r_zcl_6
(assert (or (not r_p8) (not r_f10) r_zcl_6))
...
(assert (or (not r_p8) (not r_f10_p) r_f9_p))
...
;%~r_p12 | ~r_f16 | r_zcl_11
(assert (or (not r_p12) (not r_f16) r_zcl_11))
...
;%~r_p12 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p12) (not r_f16_p) r_f15_p))
...
;%~r_p6 | ~r_f14 | r_zcl_13
(assert (or (not r_p6) (not r_f14) r_zcl_13))
...
;%~r_p6 | ~r_f14_p | r_f13_p
(declare-fun r_f13_p () Bool)
(assert (or (not r_p6) (not r_f14_p) r_f13_p))
...
;%~r_p15 | ~r_p13 | r_zcl_15
(assert (or (not r_p15) (not r_p13) r_zcl_15))
...
(assert (or (not r_p15) (not r_p13) r_f22_p))
...
;%~r_p14 | ~r_f22 | r_zcl_16
(assert (or (not r_p14) (not r_f22) r_zcl_16))
...
;%~r_p14 | ~r_f22_p | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p14) (not r_f22_p) r_f21_p))
...
;%~r_p0 | ~r_p16 | r_zcl_20
(assert (or (not r_p0) (not r_p16) r_zcl_20))
...
(assert (or (not r_p0) (not r_p16) r_f28_p))
...
;%~r_p18 | ~r_f28 | r_zcl_21
(assert (or (not r_p18) (not r_f28) r_zcl_21))
...
;%~r_p18 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p18) (not r_f28_p) r_f27_p))
...
;%~r_p17 | ~r_f27 | r_zcl_22
(assert (or (not r_p17) (not r_f27) r_zcl_22))
...
;%~r_p17 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p17) (not r_f27_p) r_f26_p))
...
;%~r_p6 | ~r_p19 | r_zcl_25
(assert (or (not r_p6) (not r_p19) r_zcl_25))


;%~r_f33 | r_zcl_25
(declare-fun r_f33 () Bool)
(assert (or (not r_f33) r_zcl_25))


;%~r_p6 | ~r_p19 | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p6) (not r_p19) r_f33_p))


;%~r_zcl_26 | r_p16
(declare-fun r_zcl_26 () Bool)
(assert (or (not r_zcl_26) r_p16))


;%~r_zcl_26 | r_f33
(assert (or (not r_zcl_26) r_f33))


;%~r_p16 | ~r_f33 | r_zcl_26
(assert (or (not r_p16) (not r_f33) r_zcl_26))


;%~r_f32 | r_zcl_26
(declare-fun r_f32 () Bool)
(assert (or (not r_f32) r_zcl_26))
...
;%~r_zcl_27 | r_f32
(assert (or (not r_zcl_27) r_f32))


;%~r_p0 | ~r_f32 | r_zcl_27
(assert (or (not r_p0) (not r_f32) r_zcl_27))


;%~r_f31 | r_zcl_27
(declare-fun r_f31 () Bool)
(assert (or (not r_f31) r_zcl_27))
...
(assert (or (not r_zcl_28) r_p9))


;%~r_zcl_28 | r_f31
(assert (or (not r_zcl_28) r_f31))


;%~r_p9 | ~r_f31 | r_zcl_28
(assert (or (not r_p9) (not r_f31) r_zcl_28))


;%~r_f30 | r_zcl_28
(declare-fun r_f30 () Bool)
(assert (or (not r_f30) r_zcl_28))


;%~r_p9 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p9) (not r_f31_p) r_f30_p))
...
;%~r_zcl_29 | r_f30
(assert (or (not r_zcl_29) r_f30))


;%~r_p0 | ~r_f30 | r_zcl_29
(assert (or (not r_p0) (not r_f30) r_zcl_29))


;%~r_f29 | r_zcl_29
(declare-fun r_f29 () Bool)
(assert (or (not r_f29) r_zcl_29))
