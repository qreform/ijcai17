...
;%~p0 | ~p8 | zcl_16
(assert (or (not l_p0) (not l_p8) l_zcl_16))
...
;%~p0 | ~p8 | f23_p
(assert (or (not l_p0) (not l_p8) l_f23_p))
...
;%~p7 | ~f21 | zcl_19
(assert (or (not l_p7) (not l_f21) l_zcl_19))
...
;%~p0 | ~p9 | zcl_20
(assert (or (not l_p0) (not l_p9) l_zcl_20))
...
;%~p0 | ~p9 | f28_p
(assert (or (not l_p0) (not l_p9) l_f28_p))
...
;%~p10 | ~f28 | zcl_21
(assert (or (not l_p10) (not l_f28) l_zcl_21))
...
;%~zcl_23 | p7
(assert (or (not l_zcl_23) l_p7))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p7 | ~f26 | zcl_23
(assert (or (not l_p7) (not l_f26) l_zcl_23))
...
;%~p7 | ~p11 | zcl_24
(assert (or (not l_p7) (not l_p11) l_zcl_24))
...
;%~p7 | ~p11 | f32_p
(assert (or (not l_p7) (not l_p11) l_f32_p))
...
;%~p12 | ~f30 | zcl_27
(assert (or (not l_p12) (not l_f30) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((~p12 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p12 | ~f30_p | f29_p
(assert (or (not l_p12) (not l_f30_p) l_f29_p))
...
;%~r_p0 | ~r_p8 | r_zcl_16
(assert (or (not r_p0) (not r_p8) r_zcl_16))
...
(assert (or (not r_p0) (not r_p8) r_f23_p))
...
;%~r_p7 | ~r_f21 | r_zcl_19
(assert (or (not r_p7) (not r_f21) r_zcl_19))
...
;%~r_p0 | ~r_p9 | r_zcl_20
(assert (or (not r_p0) (not r_p9) r_zcl_20))
...
(assert (or (not r_p0) (not r_p9) r_f28_p))
...
;%~r_p10 | ~r_f28 | r_zcl_21
(assert (or (not r_p10) (not r_f28) r_zcl_21))
...
;%~r_p7 | ~r_f26 | r_zcl_23
(assert (or (not r_p7) (not r_f26) r_zcl_23))
...
;%~r_p7 | ~r_p11 | r_zcl_24
(assert (or (not r_p7) (not r_p11) r_zcl_24))
...
(assert (or (not r_p7) (not r_p11) r_f32_p))
...
;%~r_p12 | ~r_f30 | r_zcl_27
(assert (or (not r_p12) (not r_f30) r_zcl_27))
...
;%~r_p12 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p12) (not r_f30_p) r_f29_p))
