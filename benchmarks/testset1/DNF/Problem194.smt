...
;%~p13 | ~p7 | f12_p
(assert (or (not l_p13) (not l_p7) l_f12_p))
...
;%~p12 | ~f12 | zcl_7
(assert (or (not l_p12) (not l_f12) l_zcl_7))
...
;%~p11 | ~f11 | zcl_8
(assert (or (not l_p11) (not l_f11) l_zcl_8))
...
;%~p10 | ~f10 | zcl_9
(assert (or (not l_p10) (not l_f10) l_zcl_9))
...
;%~p9 | ~f9 | zcl_10
(assert (or (not l_p9) (not l_f9) l_zcl_10))
...
;%~zcl_12 | p20
(assert (or (not l_zcl_12) l_p20))

(declare-fun l_p14 () Bool)
;%~zcl_12 | p14
(assert (or (not l_zcl_12) l_p14))

;%~p20 | ~p14 | zcl_12
(assert (or (not l_p20) (not l_p14) l_zcl_12))
...
;%~p20 | ~p14 | f19_p
(assert (or (not l_p20) (not l_p14) l_f19_p))
...
;%~zcl_13 | p19
(assert (or (not l_zcl_13) l_p19))

;%~zcl_13 | f19
(assert (or (not l_zcl_13) l_f19))

;%~p19 | ~f19 | zcl_13
(assert (or (not l_p19) (not l_f19) l_zcl_13))
...
;%~zcl_14 | p18
(assert (or (not l_zcl_14) l_p18))

;%~zcl_14 | f18
(assert (or (not l_zcl_14) l_f18))

;%~p18 | ~f18 | zcl_14
(assert (or (not l_p18) (not l_f18) l_zcl_14))
...
;%~zcl_15 | p17
(assert (or (not l_zcl_15) l_p17))

;%~zcl_15 | f17
(assert (or (not l_zcl_15) l_f17))

;%~p17 | ~f17 | zcl_15
(assert (or (not l_p17) (not l_f17) l_zcl_15))
...
;%~zcl_16 | p16
(assert (or (not l_zcl_16) l_p16))

;%~zcl_16 | f16
(assert (or (not l_zcl_16) l_f16))

;%~p16 | ~f16 | zcl_16
(assert (or (not l_p16) (not l_f16) l_zcl_16))
...
;%~zcl_17 | p15
(assert (or (not l_zcl_17) l_p15))

;%~zcl_17 | f15
(assert (or (not l_zcl_17) l_f15))

;%~p15 | ~f15 | zcl_17
(assert (or (not l_p15) (not l_f15) l_zcl_17))
...
;%~zcl_18 | p27
(assert (or (not l_zcl_18) l_p27))

(declare-fun l_p21 () Bool)
;%~zcl_18 | p21
(assert (or (not l_zcl_18) l_p21))

;%~p27 | ~p21 | zcl_18
(assert (or (not l_p27) (not l_p21) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((~p27 & p21) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p27 | ~p21 | f26_p
(assert (or (not l_p27) (not l_p21) l_f26_p))
...
;%~zcl_19 | p26
(assert (or (not l_zcl_19) l_p26))

;%~zcl_19 | f26
(assert (or (not l_zcl_19) l_f26))

;%~p26 | ~f26 | zcl_19
(assert (or (not l_p26) (not l_f26) l_zcl_19))
...
;%~zcl_20 | p25
(assert (or (not l_zcl_20) l_p25))

;%~zcl_20 | f25
(assert (or (not l_zcl_20) l_f25))

;%~p25 | ~f25 | zcl_20
(assert (or (not l_p25) (not l_f25) l_zcl_20))
...
;%~p24 | ~f24 | zcl_21
(assert (or (not l_p24) (not l_f24) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((~p24 & f24_p) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p24 | ~f24_p | f23_p
(assert (or (not l_p24) (not l_f24_p) l_f23_p))
...
;%~zcl_22 | p23
(assert (or (not l_zcl_22) l_p23))

;%~zcl_22 | f23
(assert (or (not l_zcl_22) l_f23))

;%~p23 | ~f23 | zcl_22
(assert (or (not l_p23) (not l_f23) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((~p23 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p23 | ~f23_p | f22_p
(assert (or (not l_p23) (not l_f23_p) l_f22_p))
...
;%~zcl_23 | p22
(assert (or (not l_zcl_23) l_p22))

;%~zcl_23 | f22
(assert (or (not l_zcl_23) l_f22))

;%~p22 | ~f22 | zcl_23
(assert (or (not l_p22) (not l_f22) l_zcl_23))
...
;%~p34 | ~p28 | zcl_24
(assert (or (not l_p34) (not l_p28) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((~p34 & ~p28) --> f33_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f33_p () Bool)
;%~p34 | ~p28 | f33_p
(assert (or (not l_p34) (not l_p28) l_f33_p))
...
;%~zcl_25 | p33
(assert (or (not l_zcl_25) l_p33))

;%~zcl_25 | f33
(assert (or (not l_zcl_25) l_f33))

;%~p33 | ~f33 | zcl_25
(assert (or (not l_p33) (not l_f33) l_zcl_25))
...
;%~zcl_26 | p32
(assert (or (not l_zcl_26) l_p32))

;%~zcl_26 | f32
(assert (or (not l_zcl_26) l_f32))

;%~p32 | ~f32 | zcl_26
(assert (or (not l_p32) (not l_f32) l_zcl_26))
...
;%~zcl_27 | p31
(assert (or (not l_zcl_27) l_p31))

;%~zcl_27 | f31
(assert (or (not l_zcl_27) l_f31))

;%~p31 | ~f31 | zcl_27
(assert (or (not l_p31) (not l_f31) l_zcl_27))
...
;%~zcl_28 | p30
(assert (or (not l_zcl_28) l_p30))

;%~zcl_28 | f30
(assert (or (not l_zcl_28) l_f30))

;%~p30 | ~f30 | zcl_28
(assert (or (not l_p30) (not l_f30) l_zcl_28))
...
;%~zcl_29 | p29
(assert (or (not l_zcl_29) l_p29))

;%~zcl_29 | f29
(assert (or (not l_zcl_29) l_f29))

;%~p29 | ~f29 | zcl_29
(assert (or (not l_p29) (not l_f29) l_zcl_29))
...
;%~zcl_30 | p35
(assert (or (not l_zcl_30) l_p35))

;%~p41 | ~p35 | zcl_30
(assert (or (not l_p41) (not l_p35) l_zcl_30))
...
;%Non-clausified dependency
;%(forall[]((p41 & p35) --> f40_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f40_p () Bool)
;%~p41 | ~p35 | f40_p
(assert (or (not l_p41) (not l_p35) l_f40_p))
...
;%~p40 | ~f40 | zcl_31
(assert (or (not l_p40) (not l_f40) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p40 & f40_p) --> f39_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f39_p () Bool)
;%~p40 | ~f40_p | f39_p
(assert (or (not l_p40) (not l_f40_p) l_f39_p))
...
;%~p39 | ~f39 | zcl_32
(assert (or (not l_p39) (not l_f39) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((~p39 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p39 | ~f39_p | f38_p
(assert (or (not l_p39) (not l_f39_p) l_f38_p))
...
;%~p38 | ~f38 | zcl_33
(assert (or (not l_p38) (not l_f38) l_zcl_33))
...
;%Non-clausified dependency
;%(forall[]((~p38 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p38 | ~f38_p | f37_p
(assert (or (not l_p38) (not l_f38_p) l_f37_p))
...
;%~p37 | ~f37 | zcl_34
(assert (or (not l_p37) (not l_f37) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((~p37 & f37_p) --> f36_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f36_p () Bool)
;%~p37 | ~f37_p | f36_p
(assert (or (not l_p37) (not l_f37_p) l_f36_p))
...
;%~zcl_35 | p36
(assert (or (not l_zcl_35) l_p36))

;%~zcl_35 | f36
(assert (or (not l_zcl_35) l_f36))

;%~p36 | ~f36 | zcl_35
(assert (or (not l_p36) (not l_f36) l_zcl_35))
...
;%Non-clausified dependency
;%(forall[]((p36 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p36 | ~f36_p | f35_p
(assert (or (not l_p36) (not l_f36_p) l_f35_p))
...
(declare-fun l_p48 () Bool)
;%~zcl_36 | p48
(assert (or (not l_zcl_36) l_p48))

(declare-fun l_p42 () Bool)
;%~zcl_36 | p42
(assert (or (not l_zcl_36) l_p42))

;%~p48 | ~p42 | zcl_36
(assert (or (not l_p48) (not l_p42) l_zcl_36))
...
;%Non-clausified dependency
;%(forall[]((~p48 & p42) --> f46_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f46_p () Bool)
;%~p48 | ~p42 | f46_p
(assert (or (not l_p48) (not l_p42) l_f46_p))
...
(declare-fun l_p47 () Bool)
;%~zcl_37 | p47
(assert (or (not l_zcl_37) l_p47))

;%~zcl_37 | f46
(assert (or (not l_zcl_37) l_f46))

;%~p47 | ~f46 | zcl_37
(assert (or (not l_p47) (not l_f46) l_zcl_37))
...
;%Non-clausified dependency
;%(forall[]((p47 & f46_p) --> f45_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f45_p () Bool)
;%~p47 | ~f46_p | f45_p
(assert (or (not l_p47) (not l_f46_p) l_f45_p))
...
(declare-fun l_p46 () Bool)
;%~zcl_38 | p46
(assert (or (not l_zcl_38) l_p46))

;%~zcl_38 | f45
(assert (or (not l_zcl_38) l_f45))

;%~p46 | ~f45 | zcl_38
(assert (or (not l_p46) (not l_f45) l_zcl_38))
...
;%Non-clausified dependency
;%(forall[]((~p46 & f45_p) --> f44_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f44_p () Bool)
;%~p46 | ~f45_p | f44_p
(assert (or (not l_p46) (not l_f45_p) l_f44_p))
...
(declare-fun l_p45 () Bool)
;%~zcl_39 | p45
(assert (or (not l_zcl_39) l_p45))

;%~zcl_39 | f44
(assert (or (not l_zcl_39) l_f44))

;%~p45 | ~f44 | zcl_39
(assert (or (not l_p45) (not l_f44) l_zcl_39))
...
;%Non-clausified dependency
;%(forall[]((~p45 & f44_p) --> f43_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f43_p () Bool)
;%~p45 | ~f44_p | f43_p
(assert (or (not l_p45) (not l_f44_p) l_f43_p))
...
(declare-fun l_p44 () Bool)
;%~zcl_40 | p44
(assert (or (not l_zcl_40) l_p44))

;%~zcl_40 | f43
(assert (or (not l_zcl_40) l_f43))

;%~p44 | ~f43 | zcl_40
(assert (or (not l_p44) (not l_f43) l_zcl_40))
...
;%Non-clausified dependency
;%(forall[]((~p44 & f43_p) --> f42_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f42_p () Bool)
;%~p44 | ~f43_p | f42_p
(assert (or (not l_p44) (not l_f43_p) l_f42_p))
...
(declare-fun l_p43 () Bool)
;%~zcl_41 | p43
(assert (or (not l_zcl_41) l_p43))

;%~zcl_41 | f42
(assert (or (not l_zcl_41) l_f42))

;%~p43 | ~f42 | zcl_41
(assert (or (not l_p43) (not l_f42) l_zcl_41))
...
;%Non-clausified dependency
;%(forall[]((p43 & f42_p) --> f41_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f41_p () Bool)
;%~p43 | ~f42_p | f41_p
(assert (or (not l_p43) (not l_f42_p) l_f41_p))
...
;%~l_p43 | r_p43
(declare-fun r_p43 () Bool)
(assert (or (not l_p43) r_p43))


;%~l_p44 | r_p44
(declare-fun r_p44 () Bool)
(assert (or (not l_p44) r_p44))


;%~l_p45 | r_p45
(declare-fun r_p45 () Bool)
(assert (or (not l_p45) r_p45))


;%~l_p46 | r_p46
(declare-fun r_p46 () Bool)
(assert (or (not l_p46) r_p46))


;%~l_p47 | r_p47
(declare-fun r_p47 () Bool)
(assert (or (not l_p47) r_p47))


;%~l_p48 | r_p48
(declare-fun r_p48 () Bool)
(assert (or (not l_p48) r_p48))


;%~l_p42 | r_p42
(declare-fun r_p42 () Bool)
(assert (or (not l_p42) r_p42))
...
(assert (or (not r_p13) (not r_p7) r_f12_p))
...
;%~r_p12 | ~r_f12 | r_zcl_7
(assert (or (not r_p12) (not r_f12) r_zcl_7))
...
;%~r_p11 | ~r_f11 | r_zcl_8
(assert (or (not r_p11) (not r_f11) r_zcl_8))
...
;%~r_p10 | ~r_f10 | r_zcl_9
(assert (or (not r_p10) (not r_f10) r_zcl_9))
...
;%~r_p9 | ~r_f9 | r_zcl_10
(assert (or (not r_p9) (not r_f9) r_zcl_10))
...
(assert (or (not r_zcl_12) r_p20))


;%~r_zcl_12 | r_p14
(assert (or (not r_zcl_12) r_p14))


;%~r_p20 | ~r_p14 | r_zcl_12
(assert (or (not r_p20) (not r_p14) r_zcl_12))
...
(assert (or (not r_p20) (not r_p14) r_f19_p))


;%~r_zcl_13 | r_p19
(declare-fun r_zcl_13 () Bool)
(assert (or (not r_zcl_13) r_p19))
...
;%~r_p19 | ~r_f19 | r_zcl_13
(assert (or (not r_p19) (not r_f19) r_zcl_13))
...
;%~r_p18 | ~r_f18 | r_zcl_14
(assert (or (not r_p18) (not r_f18) r_zcl_14))
...
;%~r_p17 | ~r_f17 | r_zcl_15
(assert (or (not r_p17) (not r_f17) r_zcl_15))
...
;%~r_p16 | ~r_f16 | r_zcl_16
(assert (or (not r_p16) (not r_f16) r_zcl_16))
...
;%~r_p15 | ~r_f15 | r_zcl_17
(assert (or (not r_p15) (not r_f15) r_zcl_17))
...
(assert (or (not r_zcl_18) r_p27))


;%~r_zcl_18 | r_p21
(assert (or (not r_zcl_18) r_p21))


;%~r_p27 | ~r_p21 | r_zcl_18
(assert (or (not r_p27) (not r_p21) r_zcl_18))
...
(assert (or (not r_p27) (not r_p21) r_f26_p))


;%~r_zcl_19 | r_p26
(declare-fun r_zcl_19 () Bool)
(assert (or (not r_zcl_19) r_p26))
...
;%~r_p26 | ~r_f26 | r_zcl_19
(assert (or (not r_p26) (not r_f26) r_zcl_19))
...
;%~r_p25 | ~r_f25 | r_zcl_20
(assert (or (not r_p25) (not r_f25) r_zcl_20))
...
;%~r_p24 | ~r_f24 | r_zcl_21
(assert (or (not r_p24) (not r_f24) r_zcl_21))
...
;%~r_p24 | ~r_f24_p | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p24) (not r_f24_p) r_f23_p))


;%~r_zcl_22 | r_p23
(declare-fun r_zcl_22 () Bool)
(assert (or (not r_zcl_22) r_p23))
...
;%~r_p23 | ~r_f23 | r_zcl_22
(assert (or (not r_p23) (not r_f23) r_zcl_22))
...
;%~r_p23 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p23) (not r_f23_p) r_f22_p))


;%~r_zcl_23 | r_p22
(declare-fun r_zcl_23 () Bool)
(assert (or (not r_zcl_23) r_p22))
...
;%~r_p22 | ~r_f22 | r_zcl_23
(assert (or (not r_p22) (not r_f22) r_zcl_23))
...
;%~r_p34 | ~r_p28 | r_zcl_24
(assert (or (not r_p34) (not r_p28) r_zcl_24))
...
(assert (or (not r_p34) (not r_p28) r_f33_p))


;%~r_zcl_25 | r_p33
(declare-fun r_zcl_25 () Bool)
(assert (or (not r_zcl_25) r_p33))
...
;%~r_p33 | ~r_f33 | r_zcl_25
(assert (or (not r_p33) (not r_f33) r_zcl_25))
...
;%~r_p32 | ~r_f32 | r_zcl_26
(assert (or (not r_p32) (not r_f32) r_zcl_26))
...
;%~r_p31 | ~r_f31 | r_zcl_27
(assert (or (not r_p31) (not r_f31) r_zcl_27))
...
;%~r_p30 | ~r_f30 | r_zcl_28
(assert (or (not r_p30) (not r_f30) r_zcl_28))
...
;%~r_p29 | ~r_f29 | r_zcl_29
(assert (or (not r_p29) (not r_f29) r_zcl_29))
...
;%~r_zcl_30 | r_p35
(assert (or (not r_zcl_30) r_p35))


;%~r_p41 | ~r_p35 | r_zcl_30
(assert (or (not r_p41) (not r_p35) r_zcl_30))
...
(assert (or (not r_p41) (not r_p35) r_f40_p))
...
;%~r_p40 | ~r_f40 | r_zcl_31
(assert (or (not r_p40) (not r_f40) r_zcl_31))
...
;%~r_p40 | ~r_f40_p | r_f39_p
(declare-fun r_f39_p () Bool)
(assert (or (not r_p40) (not r_f40_p) r_f39_p))
...
;%~r_p39 | ~r_f39 | r_zcl_32
(assert (or (not r_p39) (not r_f39) r_zcl_32))
...
;%~r_p39 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p39) (not r_f39_p) r_f38_p))
...
;%~r_p38 | ~r_f38 | r_zcl_33
(assert (or (not r_p38) (not r_f38) r_zcl_33))
...
;%~r_p38 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p38) (not r_f38_p) r_f37_p))
...
;%~r_p37 | ~r_f37 | r_zcl_34
(assert (or (not r_p37) (not r_f37) r_zcl_34))
...
;%~r_p37 | ~r_f37_p | r_f36_p
(declare-fun r_f36_p () Bool)
(assert (or (not r_p37) (not r_f37_p) r_f36_p))


;%~r_zcl_35 | r_p36
(declare-fun r_zcl_35 () Bool)
(assert (or (not r_zcl_35) r_p36))
...
;%~r_p36 | ~r_f36 | r_zcl_35
(assert (or (not r_p36) (not r_f36) r_zcl_35))
...
;%~r_p36 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p36) (not r_f36_p) r_f35_p))


;%~r_zcl_36 | r_p48
(declare-fun r_zcl_36 () Bool)
(assert (or (not r_zcl_36) r_p48))


;%~r_zcl_36 | r_p42
(assert (or (not r_zcl_36) r_p42))


;%~r_p48 | ~r_p42 | r_zcl_36
(assert (or (not r_p48) (not r_p42) r_zcl_36))
...
(assert (or (not r_p48) (not r_p42) r_f46_p))


;%~r_zcl_37 | r_p47
(declare-fun r_zcl_37 () Bool)
(assert (or (not r_zcl_37) r_p47))
...
;%~r_p47 | ~r_f46 | r_zcl_37
(assert (or (not r_p47) (not r_f46) r_zcl_37))
...
;%~r_p47 | ~r_f46_p | r_f45_p
(declare-fun r_f45_p () Bool)
(assert (or (not r_p47) (not r_f46_p) r_f45_p))


;%~r_zcl_38 | r_p46
(declare-fun r_zcl_38 () Bool)
(assert (or (not r_zcl_38) r_p46))
...
;%~r_p46 | ~r_f45 | r_zcl_38
(assert (or (not r_p46) (not r_f45) r_zcl_38))
...
;%~r_p46 | ~r_f45_p | r_f44_p
(declare-fun r_f44_p () Bool)
(assert (or (not r_p46) (not r_f45_p) r_f44_p))


;%~r_zcl_39 | r_p45
(declare-fun r_zcl_39 () Bool)
(assert (or (not r_zcl_39) r_p45))
...
;%~r_p45 | ~r_f44 | r_zcl_39
(assert (or (not r_p45) (not r_f44) r_zcl_39))
...
;%~r_p45 | ~r_f44_p | r_f43_p
(declare-fun r_f43_p () Bool)
(assert (or (not r_p45) (not r_f44_p) r_f43_p))


;%~r_zcl_40 | r_p44
(declare-fun r_zcl_40 () Bool)
(assert (or (not r_zcl_40) r_p44))
...
;%~r_p44 | ~r_f43 | r_zcl_40
(assert (or (not r_p44) (not r_f43) r_zcl_40))
...
;%~r_p44 | ~r_f43_p | r_f42_p
(declare-fun r_f42_p () Bool)
(assert (or (not r_p44) (not r_f43_p) r_f42_p))


;%~r_zcl_41 | r_p43
(declare-fun r_zcl_41 () Bool)
(assert (or (not r_zcl_41) r_p43))
...
;%~r_p43 | ~r_f42 | r_zcl_41
(assert (or (not r_p43) (not r_f42) r_zcl_41))
...
;%~r_p43 | ~r_f42_p | r_f41_p
(declare-fun r_f41_p () Bool)
(assert (or (not r_p43) (not r_f42_p) r_f41_p))
