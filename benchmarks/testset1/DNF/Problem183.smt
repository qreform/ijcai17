...
;%~zcl_20 | p11
(assert (or (not l_zcl_20) l_p11))

;%~p14 | ~p11 | zcl_20
(assert (or (not l_p14) (not l_p11) l_zcl_20))
...
;%Non-clausified dependency
;%(forall[]((p14 & p11) --> f28_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f28_p () Bool)
;%~p14 | ~p11 | f28_p
(assert (or (not l_p14) (not l_p11) l_f28_p))
...
;%~p12 | ~f26 | zcl_23
(assert (or (not l_p12) (not l_f26) l_zcl_23))
...
;%~p0 | ~p17 | zcl_30
(assert (or (not l_p0) (not l_p17) l_zcl_30))
...
;%~p0 | ~p17 | f39_p
(assert (or (not l_p0) (not l_p17) l_f39_p))
...
;%~zcl_34 | p18
(assert (or (not l_zcl_34) l_p18))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p18 | ~f36 | zcl_34
(assert (or (not l_p18) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((p18 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p18 | ~f36_p | f35_p
(assert (or (not l_p18) (not l_f36_p) l_f35_p))
...
;%~r_zcl_20 | r_p11
(assert (or (not r_zcl_20) r_p11))


;%~r_p14 | ~r_p11 | r_zcl_20
(assert (or (not r_p14) (not r_p11) r_zcl_20))
...
(assert (or (not r_p14) (not r_p11) r_f28_p))
...
;%~r_p12 | ~r_f26 | r_zcl_23
(assert (or (not r_p12) (not r_f26) r_zcl_23))
...
;%~r_p0 | ~r_p17 | r_zcl_30
(assert (or (not r_p0) (not r_p17) r_zcl_30))
...
(assert (or (not r_p0) (not r_p17) r_f39_p))
...
;%~r_p18 | ~r_f36 | r_zcl_34
(assert (or (not r_p18) (not r_f36) r_zcl_34))
...
;%~r_p18 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p18) (not r_f36_p) r_f35_p))
