...
;%~p6 | ~p4 | f6_p
(assert (or (not l_p6) (not l_p4) l_f6_p))
...
;%~p8 | ~p7 | zcl_6
(assert (or (not l_p8) (not l_p7) l_zcl_6))
...
;%~p8 | ~p7 | f10_p
(assert (or (not l_p8) (not l_p7) l_f10_p))
...
;%~p7 | ~p9 | zcl_9
(assert (or (not l_p7) (not l_p9) l_zcl_9))
...
;%~p7 | ~p9 | f14_p
(assert (or (not l_p7) (not l_p9) l_f14_p))
...
;%~p7 | ~p11 | f17_p
(assert (or (not l_p7) (not l_p11) l_f17_p))
...
;%~p9 | ~f17 | zcl_13
(assert (or (not l_p9) (not l_f17) l_zcl_13))
...
;%~p9 | ~f16 | zcl_14
(assert (or (not l_p9) (not l_f16) l_zcl_14))
...
(assert (or (not r_p6) (not r_p4) r_f6_p))
...
;%~r_p8 | ~r_p7 | r_zcl_6
(assert (or (not r_p8) (not r_p7) r_zcl_6))
...
(assert (or (not r_p8) (not r_p7) r_f10_p))
...
;%~r_p7 | ~r_p9 | r_zcl_9
(assert (or (not r_p7) (not r_p9) r_zcl_9))
...
(assert (or (not r_p7) (not r_p9) r_f14_p))
...
(assert (or (not r_p7) (not r_p11) r_f17_p))
...
;%~r_p9 | ~r_f17 | r_zcl_13
(assert (or (not r_p9) (not r_f17) r_zcl_13))
...
;%~r_p9 | ~r_f16 | r_zcl_14
(assert (or (not r_p9) (not r_f16) r_zcl_14))
