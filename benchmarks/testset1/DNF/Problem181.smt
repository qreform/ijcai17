...
;%~zcl_7 | p7
(assert (or (not l_zcl_7) l_p7))

;%~zcl_7 | f9
(assert (or (not l_zcl_7) l_f9))

;%~p7 | ~f9 | zcl_7
(assert (or (not l_p7) (not l_f9) l_zcl_7))
...
;%~p7 | ~f9_p | f8_p
(assert (or (not l_p7) (not l_f9_p) l_f8_p))
...
;%~zcl_16 | p8
(assert (or (not l_zcl_16) l_p8))

;%~zcl_16 | f22
(assert (or (not l_zcl_16) l_f22))

;%~p8 | ~f22 | zcl_16
(assert (or (not l_p8) (not l_f22) l_zcl_16))
...
;%~p0 | ~p13 | f28_p
(assert (or (not l_p0) (not l_p13) l_f28_p))
...
;%~p15 | ~f28 | zcl_21
(assert (or (not l_p15) (not l_f28) l_zcl_21))
...
;%Non-clausified dependency
;%(forall[]((p15 & f28_p) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p15 | ~f28_p | f27_p
(assert (or (not l_p15) (not l_f28_p) l_f27_p))
...
;%~p14 | ~f27 | zcl_22
(assert (or (not l_p14) (not l_f27) l_zcl_22))
...
;%~p14 | ~f27_p | f26_p
(assert (or (not l_p14) (not l_f27_p) l_f26_p))
...
;%~zcl_23 | p8
(assert (or (not l_zcl_23) l_p8))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p8 | ~f26 | zcl_23
(assert (or (not l_p8) (not l_f26) l_zcl_23))
...
;%~p8 | ~p16 | zcl_25
(assert (or (not l_p8) (not l_p16) l_zcl_25))
...
;%~p8 | ~p16 | f34_p
(assert (or (not l_p8) (not l_p16) l_f34_p))
...
;%~zcl_28 | p10
(assert (or (not l_zcl_28) l_p10))

;%~zcl_28 | f32
(assert (or (not l_zcl_28) l_f32))

;%~p10 | ~f32 | zcl_28
(assert (or (not l_p10) (not l_f32) l_zcl_28))
...
;%Non-clausified dependency
;%(forall[]((p10 & f32_p) --> f31_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f31_p () Bool)
;%~p10 | ~f32_p | f31_p
(assert (or (not l_p10) (not l_f32_p) l_f31_p))
...
;%~zcl_29 | p8
(assert (or (not l_zcl_29) l_p8))

;%~zcl_29 | f31
(assert (or (not l_zcl_29) l_f31))

;%~p8 | ~f31 | zcl_29
(assert (or (not l_p8) (not l_f31) l_zcl_29))
...
;%Non-clausified dependency
;%(forall[]((p8 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p8 | ~f31_p | f30_p
(assert (or (not l_p8) (not l_f31_p) l_f30_p))
...
;%~p8 | ~p18 | zcl_30
(assert (or (not l_p8) (not l_p18) l_zcl_30))
...
;%~p8 | ~p18 | f39_p
(assert (or (not l_p8) (not l_p18) l_f39_p))
...
;%~zcl_31 | p6
(assert (or (not l_zcl_31) l_p6))

;%~zcl_31 | f39
(assert (or (not l_zcl_31) l_f39))

;%~p6 | ~f39 | zcl_31
(assert (or (not l_p6) (not l_f39) l_zcl_31))
...
;%Non-clausified dependency
;%(forall[]((p6 & f39_p) --> f38_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f38_p () Bool)
;%~p6 | ~f39_p | f38_p
(assert (or (not l_p6) (not l_f39_p) l_f38_p))
...
;%~p8 | ~f36 | zcl_34
(assert (or (not l_p8) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((p8 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p8 | ~f36_p | f35_p
(assert (or (not l_p8) (not l_f36_p) l_f35_p))
...
;%~r_p7 | ~r_f9 | r_zcl_7
(assert (or (not r_p7) (not r_f9) r_zcl_7))
...
(assert (or (not r_p7) (not r_f9_p) r_f8_p))
...
;%~r_p8 | ~r_f22 | r_zcl_16
(assert (or (not r_p8) (not r_f22) r_zcl_16))
...
(assert (or (not r_p0) (not r_p13) r_f28_p))
...
;%~r_p15 | ~r_f28 | r_zcl_21
(assert (or (not r_p15) (not r_f28) r_zcl_21))
...
;%~r_p15 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p15) (not r_f28_p) r_f27_p))
...
;%~r_p14 | ~r_f27 | r_zcl_22
(assert (or (not r_p14) (not r_f27) r_zcl_22))
...
;%~r_p14 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p14) (not r_f27_p) r_f26_p))


;%~r_zcl_23 | r_p8
(declare-fun r_zcl_23 () Bool)
(assert (or (not r_zcl_23) r_p8))
...
;%~r_p8 | ~r_f26 | r_zcl_23
(assert (or (not r_p8) (not r_f26) r_zcl_23))
...
;%~r_p8 | ~r_p16 | r_zcl_25
(assert (or (not r_p8) (not r_p16) r_zcl_25))
...
(assert (or (not r_p8) (not r_p16) r_f34_p))
...
;%~r_p10 | ~r_f32 | r_zcl_28
(assert (or (not r_p10) (not r_f32) r_zcl_28))
...
;%~r_p10 | ~r_f32_p | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p10) (not r_f32_p) r_f31_p))


;%~r_zcl_29 | r_p8
(declare-fun r_zcl_29 () Bool)
(assert (or (not r_zcl_29) r_p8))
...
;%~r_p8 | ~r_f31 | r_zcl_29
(assert (or (not r_p8) (not r_f31) r_zcl_29))
...
;%~r_p8 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p8) (not r_f31_p) r_f30_p))


;%~r_zcl_30 | r_p8
(declare-fun r_zcl_30 () Bool)
(assert (or (not r_zcl_30) r_p8))
...
;%~r_p8 | ~r_p18 | r_zcl_30
(assert (or (not r_p8) (not r_p18) r_zcl_30))
...
(assert (or (not r_p8) (not r_p18) r_f39_p))


;%~r_zcl_31 | r_p6
(declare-fun r_zcl_31 () Bool)
(assert (or (not r_zcl_31) r_p6))
...
;%~r_p6 | ~r_f39 | r_zcl_31
(assert (or (not r_p6) (not r_f39) r_zcl_31))
...
;%~r_p6 | ~r_f39_p | r_f38_p
(declare-fun r_f38_p () Bool)
(assert (or (not r_p6) (not r_f39_p) r_f38_p))
...
;%~r_p8 | ~r_f36 | r_zcl_34
(assert (or (not r_p8) (not r_f36) r_zcl_34))
...
;%~r_p8 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p8) (not r_f36_p) r_f35_p))
