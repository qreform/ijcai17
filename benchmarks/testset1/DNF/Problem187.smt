...
;%~p10 | ~f16 | zcl_11
(assert (or (not l_p10) (not l_f16) l_zcl_11))
...
;%~p0 | ~f15 | zcl_12
(assert (or (not l_p0) (not l_f15) l_zcl_12))
...
;%~p0 | ~p11 | zcl_15
(assert (or (not l_p0) (not l_p11) l_zcl_15))
...
;%~p0 | ~p11 | f22_p
(assert (or (not l_p0) (not l_p11) l_f22_p))
...
;%~zcl_22 | p11
(assert (or (not l_zcl_22) l_p11))

;%~zcl_22 | f27
(assert (or (not l_zcl_22) l_f27))

;%~p11 | ~f27 | zcl_22
(assert (or (not l_p11) (not l_f27) l_zcl_22))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f27_p) --> f26_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f26_p () Bool)
;%~p11 | ~f27_p | f26_p
(assert (or (not l_p11) (not l_f27_p) l_f26_p))
...
;%~zcl_23 | p13
(assert (or (not l_zcl_23) l_p13))

;%~zcl_23 | f26
(assert (or (not l_zcl_23) l_f26))

;%~p13 | ~f26 | zcl_23
(assert (or (not l_p13) (not l_f26) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((~p13 & f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p13 | ~f26_p | f25_p
(assert (or (not l_p13) (not l_f26_p) l_f25_p))
...
;%~p11 | ~p14 | zcl_25
(assert (or (not l_p11) (not l_p14) l_zcl_25))
...
;%Non-clausified dependency
;%(forall[]((~p11 & ~p14) --> f34_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f34_p () Bool)
;%~p11 | ~p14 | f34_p
(assert (or (not l_p11) (not l_p14) l_f34_p))
...
;%~zcl_30 | p15
(assert (or (not l_zcl_30) l_p15))

;%~p0 | ~p15 | zcl_30
(assert (or (not l_p0) (not l_p15) l_zcl_30))
...
;%~p0 | ~p15 | f39_p
(assert (or (not l_p0) (not l_p15) l_f39_p))
...
;%~zcl_32 | p16
(assert (or (not l_zcl_32) l_p16))

;%~zcl_32 | f38
(assert (or (not l_zcl_32) l_f38))

;%~p16 | ~f38 | zcl_32
(assert (or (not l_p16) (not l_f38) l_zcl_32))
...
;%Non-clausified dependency
;%(forall[]((p16 & f38_p) --> f37_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f37_p () Bool)
;%~p16 | ~f38_p | f37_p
(assert (or (not l_p16) (not l_f38_p) l_f37_p))
...
;%~zcl_34 | p11
(assert (or (not l_zcl_34) l_p11))

;%~zcl_34 | f36
(assert (or (not l_zcl_34) l_f36))

;%~p11 | ~f36 | zcl_34
(assert (or (not l_p11) (not l_f36) l_zcl_34))
...
;%Non-clausified dependency
;%(forall[]((~p11 & f36_p) --> f35_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f35_p () Bool)
;%~p11 | ~f36_p | f35_p
(assert (or (not l_p11) (not l_f36_p) l_f35_p))
...
;%~r_p10 | ~r_f16 | r_zcl_11
(assert (or (not r_p10) (not r_f16) r_zcl_11))
...
;%~r_p0 | ~r_f15 | r_zcl_12
(assert (or (not r_p0) (not r_f15) r_zcl_12))
...
;%~r_p0 | ~r_p11 | r_zcl_15
(assert (or (not r_p0) (not r_p11) r_zcl_15))
...
(assert (or (not r_p0) (not r_p11) r_f22_p))
...
;%~r_p11 | ~r_f27 | r_zcl_22
(assert (or (not r_p11) (not r_f27) r_zcl_22))
...
;%~r_p11 | ~r_f27_p | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p11) (not r_f27_p) r_f26_p))


;%~r_zcl_23 | r_p13
(declare-fun r_zcl_23 () Bool)
(assert (or (not r_zcl_23) r_p13))
...
;%~r_p13 | ~r_f26 | r_zcl_23
(assert (or (not r_p13) (not r_f26) r_zcl_23))
...
;%~r_p13 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p13) (not r_f26_p) r_f25_p))
...
;%~r_p11 | ~r_p14 | r_zcl_25
(assert (or (not r_p11) (not r_p14) r_zcl_25))
...
(assert (or (not r_p11) (not r_p14) r_f34_p))
...
;%~r_zcl_30 | r_p15
(assert (or (not r_zcl_30) r_p15))


;%~r_p0 | ~r_p15 | r_zcl_30
(assert (or (not r_p0) (not r_p15) r_zcl_30))
...
(assert (or (not r_p0) (not r_p15) r_f39_p))
...
;%~r_p16 | ~r_f38 | r_zcl_32
(assert (or (not r_p16) (not r_f38) r_zcl_32))
...
;%~r_p16 | ~r_f38_p | r_f37_p
(declare-fun r_f37_p () Bool)
(assert (or (not r_p16) (not r_f38_p) r_f37_p))
...
;%~r_p11 | ~r_f36 | r_zcl_34
(assert (or (not r_p11) (not r_f36) r_zcl_34))
...
;%~r_p11 | ~r_f36_p | r_f35_p
(declare-fun r_f35_p () Bool)
(assert (or (not r_p11) (not r_f36_p) r_f35_p))
