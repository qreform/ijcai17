;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | p0)) & (p4 | (~p0 | ~p3))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f0 | ~f2 | zcl_0
(assert (or (not l_f0) (not l_f2) l_zcl_0))
...
;%~r_f0 | ~r_f2 | r_zcl_0
(assert (or (not r_f0) (not r_f2) r_zcl_0))
