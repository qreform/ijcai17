%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p0 | (p1 | (p1 | (p3 | p5)))) & ((p5 | (p2 | (p4 | (p4 | p6)))) & (p0 | (p6 | (p8 | (p1 | p7))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom16,axiom,(~f7 | p1 | f8)) .
cnf(l_axiom17,axiom,(~p1 | f7_p)) .
...
cnf(l_axiom25,axiom,(~f13 | p4 | p6)) .
cnf(l_axiom26,axiom,(~p4 | f13_p)) .
...
cnf(l_axiom34,axiom,(~f10 | p5 | f11)) .
cnf(l_axiom35,axiom,(~p5 | f10_p)) .
cnf(l_axiom36,axiom,(~f11_p | f10_p)) .
cnf(l_axiom37,axiom,(~f17 | p1 | p7)) .
cnf(l_axiom38,axiom,(~p1 | f17_p)) .
cnf(l_axiom39,axiom,(~p7 | f17_p)) .
...
cnf(r_axiom24,axiom,(~acc_f7 | acc_p1 | acc_f8)) .
cnf(r_axiom25,axiom,(~acc_p1 | acc_f7_p)) .
cnf(r_axiom26,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom27,axiom,(~acc_f6 | acc_p1 | acc_f7)) .
cnf(r_axiom28,axiom,(~acc_p1 | acc_f6_p)) .
...
cnf(r_axiom33,axiom,(~acc_f13 | acc_p4 | acc_p6)) .
cnf(r_axiom34,axiom,(~acc_p4 | acc_f13_p)) .
cnf(r_axiom35,axiom,(~acc_p6 | acc_f13_p)) .
cnf(r_axiom36,axiom,(~acc_f12 | acc_p4 | acc_f13)) .
cnf(r_axiom37,axiom,(~acc_p4 | acc_f12_p)) .
cnf(r_axiom38,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom39,axiom,(~acc_f11 | acc_p2 | acc_f12)) .
cnf(r_axiom40,axiom,(~acc_p2 | acc_f11_p)) .
cnf(r_axiom41,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom42,axiom,(~acc_f10 | acc_p5 | acc_f11)) .
cnf(r_axiom43,axiom,(~acc_p5 | acc_f10_p)) .
cnf(r_axiom44,axiom,(~acc_f11_p | acc_f10_p)) .
cnf(r_axiom45,axiom,(~acc_f17 | acc_p1 | acc_p7)) .
cnf(r_axiom46,axiom,(~acc_p1 | acc_f17_p)) .
cnf(r_axiom47,axiom,(~acc_p7 | acc_f17_p)) .
cnf(r_axiom48,axiom,(~acc_f16 | acc_p8 | acc_f17)) .
cnf(r_axiom49,axiom,(~acc_p8 | acc_f16_p)) .
cnf(r_axiom50,axiom,(~acc_f17_p | acc_f16_p)) .
cnf(r_axiom51,axiom,(~acc_f15 | acc_p6 | acc_f16)) .
cnf(r_axiom52,axiom,(~acc_p6 | acc_f15_p)) .
cnf(r_axiom53,axiom,(~acc_f16_p | acc_f15_p)) .
cnf(r_axiom54,axiom,(~acc_f14 | acc_p0 | acc_f15)) .
cnf(r_axiom55,axiom,(~acc_p0 | acc_f14_p)) .
cnf(r_axiom56,axiom,(~acc_f15_p | acc_f14_p)) .
cnf(r_axiom57,axiom,(~acc_zcl_6 | acc_f10)) .
cnf(r_axiom58,axiom,(~acc_zcl_6 | acc_f14)) .
cnf(r_axiom59,axiom,(~acc_f10 | ~acc_f14 | acc_zcl_6)) .
cnf(r_axiom60,axiom,(~acc_f9 | acc_zcl_6)) .
cnf(r_axiom61,axiom,(~acc_f10_p | ~acc_f14_p | acc_f9_p)) .
cnf(r_axiom62,axiom,(~acc_zcl_7 | acc_f5)) .
cnf(r_axiom63,axiom,(~acc_zcl_7 | acc_f9)) .
cnf(r_axiom64,axiom,(~acc_f5 | ~acc_f9 | acc_zcl_7)) .
cnf(r_axiom65,axiom,(~acc_f4 | acc_zcl_7)) .
cnf(r_axiom66,axiom,(~acc_f5_p | ~acc_f9_p | acc_f4_p)) .
cnf(r_axiom67,axiom,(~acc_zcl_8 | acc_f0)) .
cnf(r_axiom68,axiom,(~acc_zcl_8 | acc_f4)) .
cnf(r_axiom69,axiom,(~acc_f0 | ~acc_f4 | acc_zcl_8)) .
cnf(r_axiom70,axiom,(~acc_q | acc_zcl_8)) .
cnf(r_axiom71,axiom,(~acc_f0_p | ~acc_f4_p | acc_q)) .
