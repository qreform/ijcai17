...
;%~f18 | p19 | p16
(assert (or (not l_f18) l_p19 l_p16))
...
;%~f21 | p23 | p20
(assert (or (not l_f21) l_p23 l_p20))
...
(assert (or (not r_f18) r_p19 r_p16))
...
(assert (or (not r_f21) r_p23 r_p20))
