...
;%~f18 | p3 | p12
(assert (or (not l_f18) l_p3 l_p12))
...
;%~f21 | p9 | p14
(assert (or (not l_f21) l_p9 l_p14))
...
(assert (or (not r_f18) r_p3 r_p12))
...
(assert (or (not r_f21) r_p9 r_p14))
