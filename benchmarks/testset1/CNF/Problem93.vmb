%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | (p5 | p0))))) & ((p2 | (p4 | (p7 | (p3 | (p0 | p6))))) & (p6 | (p6 | (p5 | (p1 | (p5 | p8))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom31,axiom,(~f15 | p5 | p8)) .
cnf(l_axiom32,axiom,(~p5 | f15_p)) .
cnf(l_axiom33,axiom,(~p8 | f15_p)) .
cnf(l_axiom34,axiom,(~f14 | p1 | f15)) .
cnf(l_axiom35,axiom,(~p1 | f14_p)) .
cnf(l_axiom36,axiom,(~f15_p | f14_p)) .
cnf(l_axiom37,axiom,(~f13 | p5 | f14)) .
cnf(l_axiom38,axiom,(~p5 | f13_p)) .
cnf(l_axiom39,axiom,(~f14_p | f13_p)) .
cnf(l_axiom40,axiom,(~f12 | p6 | f13)) .
cnf(l_axiom41,axiom,(~p6 | f12_p)) .
cnf(l_axiom42,axiom,(~f13_p | f12_p)) .
cnf(l_axiom43,axiom,(~f11 | p6 | f12)) .
cnf(l_axiom44,axiom,(~p6 | f11_p)) .
...
cnf(r_axiom9,axiom,(~acc_f4 | acc_p5 | acc_p0)) .
cnf(r_axiom10,axiom,(~acc_p5 | acc_f4_p)) .
cnf(r_axiom11,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom12,axiom,(~acc_f3 | acc_p4 | acc_f4)) .
...
cnf(r_axiom24,axiom,(~acc_f10 | acc_p0 | acc_p6)) .
cnf(r_axiom25,axiom,(~acc_p0 | acc_f10_p)) .
cnf(r_axiom26,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom27,axiom,(~acc_f9 | acc_p3 | acc_f10)) .
cnf(r_axiom28,axiom,(~acc_p3 | acc_f9_p)) .
cnf(r_axiom29,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom30,axiom,(~acc_f8 | acc_p7 | acc_f9)) .
cnf(r_axiom31,axiom,(~acc_p7 | acc_f8_p)) .
cnf(r_axiom32,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom33,axiom,(~acc_f7 | acc_p4 | acc_f8)) .
cnf(r_axiom34,axiom,(~acc_p4 | acc_f7_p)) .
cnf(r_axiom35,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom36,axiom,(~acc_f6 | acc_p2 | acc_f7)) .
cnf(r_axiom37,axiom,(~acc_p2 | acc_f6_p)) .
cnf(r_axiom38,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom39,axiom,(~acc_f15 | acc_p5 | acc_p8)) .
cnf(r_axiom40,axiom,(~acc_p5 | acc_f15_p)) .
cnf(r_axiom41,axiom,(~acc_p8 | acc_f15_p)) .
cnf(r_axiom42,axiom,(~acc_f14 | acc_p1 | acc_f15)) .
cnf(r_axiom43,axiom,(~acc_p1 | acc_f14_p)) .
cnf(r_axiom44,axiom,(~acc_f15_p | acc_f14_p)) .
cnf(r_axiom45,axiom,(~acc_f13 | acc_p5 | acc_f14)) .
cnf(r_axiom46,axiom,(~acc_p5 | acc_f13_p)) .
cnf(r_axiom47,axiom,(~acc_f14_p | acc_f13_p)) .
cnf(r_axiom48,axiom,(~acc_f12 | acc_p6 | acc_f13)) .
cnf(r_axiom49,axiom,(~acc_p6 | acc_f12_p)) .
...
cnf(r_axiom54,axiom,(~acc_zcl_4 | acc_f6)) .
cnf(r_axiom55,axiom,(~acc_zcl_4 | acc_f11)) .
cnf(r_axiom56,axiom,(~acc_f6 | ~acc_f11 | acc_zcl_4)) .
cnf(r_axiom57,axiom,(~acc_f5 | acc_zcl_4)) .
cnf(r_axiom58,axiom,(~acc_f6_p | ~acc_f11_p | acc_f5_p)) .
cnf(r_axiom59,axiom,(~acc_zcl_5 | acc_f0)) .
cnf(r_axiom60,axiom,(~acc_zcl_5 | acc_f5)) .
cnf(r_axiom61,axiom,(~acc_f0 | ~acc_f5 | acc_zcl_5)) .
cnf(r_axiom62,axiom,(~acc_q | acc_zcl_5)) .
cnf(r_axiom63,axiom,(~acc_f0_p | ~acc_f5_p | acc_q)) .
