%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (p3 | ~p0))) & (p2 | (~p5 | (p2 | ~p4)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~f4 | p5 | f5)) .
cnf(l_axiom14,axiom,(~p5 | f4_p)) .
cnf(l_axiom15,axiom,(~f5_p | f4_p)) .
cnf(l_axiom16,axiom,(~f3 | p2 | f4)) .
cnf(l_axiom17,axiom,(~p2 | f3_p)) .
...
cnf(r_axiom18,axiom,(~acc_f4 | acc_p5 | acc_f5)) .
