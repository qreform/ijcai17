%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p6 | (p7 | (p8 | (p9 | p5)))) & (p11 | (p12 | (p13 | (p14 | p10)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom25,axiom,(~f12 | p14 | p10)) .
cnf(l_axiom26,axiom,(~p14 | f12_p)) .
cnf(l_axiom27,axiom,(~p10 | f12_p)) .
cnf(l_axiom28,axiom,(~f11 | p13 | f12)) .
cnf(l_axiom29,axiom,(~p13 | f11_p)) .
cnf(l_axiom30,axiom,(~f12_p | f11_p)) .
cnf(l_axiom31,axiom,(~f10 | p12 | f11)) .
cnf(l_axiom32,axiom,(~p12 | f10_p)) .
cnf(l_axiom33,axiom,(~f11_p | f10_p)) .
cnf(l_axiom34,axiom,(~f9 | p11 | f10)) .
cnf(l_axiom35,axiom,(~p11 | f9_p)) .
...
cnf(r_axiom27,axiom,(~acc_f8 | acc_p9 | acc_p5)) .
cnf(r_axiom28,axiom,(~acc_p9 | acc_f8_p)) .
cnf(r_axiom29,axiom,(~acc_p5 | acc_f8_p)) .
cnf(r_axiom30,axiom,(~acc_f7 | acc_p8 | acc_f8)) .
...
cnf(r_axiom39,axiom,(~acc_f12 | acc_p14 | acc_p10)) .
cnf(r_axiom40,axiom,(~acc_p14 | acc_f12_p)) .
cnf(r_axiom41,axiom,(~acc_p10 | acc_f12_p)) .
cnf(r_axiom42,axiom,(~acc_f11 | acc_p13 | acc_f12)) .
cnf(r_axiom43,axiom,(~acc_p13 | acc_f11_p)) .
cnf(r_axiom44,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom45,axiom,(~acc_f10 | acc_p12 | acc_f11)) .
cnf(r_axiom46,axiom,(~acc_p12 | acc_f10_p)) .
cnf(r_axiom47,axiom,(~acc_f11_p | acc_f10_p)) .
cnf(r_axiom48,axiom,(~acc_f9 | acc_p11 | acc_f10)) .
cnf(r_axiom49,axiom,(~acc_p11 | acc_f9_p)) .
cnf(r_axiom50,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom51,axiom,(~acc_zcl_4 | acc_f5)) .
cnf(r_axiom52,axiom,(~acc_zcl_4 | acc_f9)) .
cnf(r_axiom53,axiom,(~acc_f5 | ~acc_f9 | acc_zcl_4)) .
cnf(r_axiom54,axiom,(~acc_f4 | acc_zcl_4)) .
cnf(r_axiom55,axiom,(~acc_f5_p | ~acc_f9_p | acc_f4_p)) .
cnf(r_axiom56,axiom,(~acc_zcl_5 | acc_f0)) .
cnf(r_axiom57,axiom,(~acc_zcl_5 | acc_f4)) .
cnf(r_axiom58,axiom,(~acc_f0 | ~acc_f4 | acc_zcl_5)) .
cnf(r_axiom59,axiom,(~acc_q | acc_zcl_5)) .
cnf(r_axiom60,axiom,(~acc_f0_p | ~acc_f4_p | acc_q)) .
