%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | ~p0))) & ((p0 | (~p1 | (~p1 | ~p4))) & ((p2 | (~p2 | (p4 | p5))) & ((p3 | (p1 | (p4 | p6))) & ((~p6 | (~p8 | (~p4 | p7))) & (~p8 | (~p3 | (p8 | ~p9)))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~f5 | p1 | f6)) .
cnf(l_axiom14,axiom,(~p1 | f5_p)) .
cnf(l_axiom15,axiom,(~f6_p | f5_p)) .
cnf(l_axiom16,axiom,(~f4 | p0 | f5)) .
cnf(l_axiom17,axiom,(~p0 | f4_p)) .
cnf(l_axiom18,axiom,(~f5_p | f4_p)) .
cnf(l_axiom19,axiom,(~f10 | p4 | p5)) .
cnf(l_axiom20,axiom,(~p4 | f10_p)) .
cnf(l_axiom21,axiom,(~p5 | f10_p)) .
cnf(l_axiom22,axiom,(~f9 | p2 | f10)) .
cnf(l_axiom23,axiom,(~p2 | f9_p)) .
cnf(l_axiom24,axiom,(~f10_p | f9_p)) .
cnf(l_axiom25,axiom,(~f8 | p2 | f9)) .
cnf(l_axiom26,axiom,(~p2 | f8_p)) .
cnf(l_axiom27,axiom,(~f9_p | f8_p)) .
cnf(l_axiom28,axiom,(~f14 | p4 | p6)) .
cnf(l_axiom29,axiom,(~p4 | f14_p)) .
cnf(l_axiom30,axiom,(~p6 | f14_p)) .
cnf(l_axiom31,axiom,(~f13 | p1 | f14)) .
cnf(l_axiom32,axiom,(~p1 | f13_p)) .
cnf(l_axiom33,axiom,(~f14_p | f13_p)) .
cnf(l_axiom34,axiom,(~f12 | p3 | f13)) .
cnf(l_axiom35,axiom,(~p3 | f12_p)) .
cnf(l_axiom36,axiom,(~f13_p | f12_p)) .
cnf(l_axiom37,axiom,(~f18 | p4 | p7)) .
cnf(l_axiom38,axiom,(~p4 | f18_p)) .
cnf(l_axiom39,axiom,(~p7 | f18_p)) .
cnf(l_axiom40,axiom,(~f17 | p8 | f18)) .
cnf(l_axiom41,axiom,(~p8 | f17_p)) .
cnf(l_axiom42,axiom,(~f18_p | f17_p)) .
cnf(l_axiom43,axiom,(~f16 | p6 | f17)) .
cnf(l_axiom44,axiom,(~p6 | f16_p)) .
cnf(l_axiom45,axiom,(~f17_p | f16_p)) .
cnf(l_axiom46,axiom,(~f21 | p8 | p9)) .
cnf(l_axiom47,axiom,(~p8 | f21_p)) .
cnf(l_axiom48,axiom,(~p9 | f21_p)) .
cnf(l_axiom49,axiom,(~f20 | p3 | f21)) .
cnf(l_axiom50,axiom,(~p3 | f20_p)) .
cnf(l_axiom51,axiom,(~f21_p | f20_p)) .
cnf(l_axiom52,axiom,(~f19 | p8 | f20)) .
cnf(l_axiom53,axiom,(~p8 | f19_p)) .
...
cnf(r_axiom10,axiom,(~acc_f2 | acc_p3 | acc_p0)) .
cnf(r_axiom11,axiom,(~acc_p3 | acc_f2_p)) .
cnf(r_axiom12,axiom,(~acc_p0 | acc_f2_p)) .
cnf(r_axiom13,axiom,(~acc_f1 | acc_p2 | acc_f2)) .
cnf(r_axiom14,axiom,(~acc_p2 | acc_f1_p)) .
cnf(r_axiom15,axiom,(~acc_f2_p | acc_f1_p)) .
cnf(r_axiom16,axiom,(~acc_f0 | acc_p1 | acc_f1)) .
cnf(r_axiom17,axiom,(~acc_p1 | acc_f0_p)) .
cnf(r_axiom18,axiom,(~acc_f1_p | acc_f0_p)) .
cnf(r_axiom19,axiom,(~acc_f6 | acc_p1 | acc_p4)) .
cnf(r_axiom20,axiom,(~acc_p1 | acc_f6_p)) .
cnf(r_axiom21,axiom,(~acc_p4 | acc_f6_p)) .
cnf(r_axiom22,axiom,(~acc_f5 | acc_p1 | acc_f6)) .
cnf(r_axiom23,axiom,(~acc_p1 | acc_f5_p)) .
cnf(r_axiom24,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom25,axiom,(~acc_f4 | acc_p0 | acc_f5)) .
cnf(r_axiom26,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom27,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom28,axiom,(~acc_f10 | acc_p4 | acc_p5)) .
cnf(r_axiom29,axiom,(~acc_p4 | acc_f10_p)) .
cnf(r_axiom30,axiom,(~acc_p5 | acc_f10_p)) .
cnf(r_axiom31,axiom,(~acc_f9 | acc_p2 | acc_f10)) .
cnf(r_axiom32,axiom,(~acc_p2 | acc_f9_p)) .
cnf(r_axiom33,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom34,axiom,(~acc_f8 | acc_p2 | acc_f9)) .
cnf(r_axiom35,axiom,(~acc_p2 | acc_f8_p)) .
cnf(r_axiom36,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom37,axiom,(~acc_f14 | acc_p4 | acc_p6)) .
cnf(r_axiom38,axiom,(~acc_p4 | acc_f14_p)) .
cnf(r_axiom39,axiom,(~acc_p6 | acc_f14_p)) .
cnf(r_axiom40,axiom,(~acc_f13 | acc_p1 | acc_f14)) .
cnf(r_axiom41,axiom,(~acc_p1 | acc_f13_p)) .
cnf(r_axiom42,axiom,(~acc_f14_p | acc_f13_p)) .
cnf(r_axiom43,axiom,(~acc_f12 | acc_p3 | acc_f13)) .
cnf(r_axiom44,axiom,(~acc_p3 | acc_f12_p)) .
cnf(r_axiom45,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom46,axiom,(~acc_f18 | acc_p4 | acc_p7)) .
cnf(r_axiom47,axiom,(~acc_p4 | acc_f18_p)) .
cnf(r_axiom48,axiom,(~acc_p7 | acc_f18_p)) .
cnf(r_axiom49,axiom,(~acc_f17 | acc_p8 | acc_f18)) .
cnf(r_axiom50,axiom,(~acc_p8 | acc_f17_p)) .
cnf(r_axiom51,axiom,(~acc_f18_p | acc_f17_p)) .
cnf(r_axiom52,axiom,(~acc_f16 | acc_p6 | acc_f17)) .
cnf(r_axiom53,axiom,(~acc_p6 | acc_f16_p)) .
cnf(r_axiom54,axiom,(~acc_f17_p | acc_f16_p)) .
cnf(r_axiom55,axiom,(~acc_f21 | acc_p8 | acc_p9)) .
cnf(r_axiom56,axiom,(~acc_p8 | acc_f21_p)) .
cnf(r_axiom57,axiom,(~acc_p9 | acc_f21_p)) .
cnf(r_axiom58,axiom,(~acc_f20 | acc_p3 | acc_f21)) .
cnf(r_axiom59,axiom,(~acc_p3 | acc_f20_p)) .
cnf(r_axiom60,axiom,(~acc_f21_p | acc_f20_p)) .
cnf(r_axiom61,axiom,(~acc_f19 | acc_p8 | acc_f20)) .
cnf(r_axiom62,axiom,(~acc_p8 | acc_f19_p)) .
cnf(r_axiom63,axiom,(~acc_f20_p | acc_f19_p)) .
cnf(r_axiom64,axiom,(~acc_zcl_10 | acc_f16)) .
cnf(r_axiom65,axiom,(~acc_zcl_10 | acc_f19)) .
cnf(r_axiom66,axiom,(~acc_f16 | ~acc_f19 | acc_zcl_10)) .
cnf(r_axiom67,axiom,(~acc_f15 | acc_zcl_10)) .
cnf(r_axiom68,axiom,(~acc_f16_p | ~acc_f19_p | acc_f15_p)) .
cnf(r_axiom69,axiom,(~acc_zcl_11 | acc_f12)) .
cnf(r_axiom70,axiom,(~acc_zcl_11 | acc_f15)) .
cnf(r_axiom71,axiom,(~acc_f12 | ~acc_f15 | acc_zcl_11)) .
cnf(r_axiom72,axiom,(~acc_f11 | acc_zcl_11)) .
cnf(r_axiom73,axiom,(~acc_f12_p | ~acc_f15_p | acc_f11_p)) .
cnf(r_axiom74,axiom,(~acc_zcl_12 | acc_f8)) .
cnf(r_axiom75,axiom,(~acc_zcl_12 | acc_f11)) .
cnf(r_axiom76,axiom,(~acc_f8 | ~acc_f11 | acc_zcl_12)) .
cnf(r_axiom77,axiom,(~acc_f7 | acc_zcl_12)) .
cnf(r_axiom78,axiom,(~acc_f8_p | ~acc_f11_p | acc_f7_p)) .
cnf(r_axiom79,axiom,(~acc_zcl_13 | acc_f4)) .
cnf(r_axiom80,axiom,(~acc_zcl_13 | acc_f7)) .
cnf(r_axiom81,axiom,(~acc_f4 | ~acc_f7 | acc_zcl_13)) .
cnf(r_axiom82,axiom,(~acc_f3 | acc_zcl_13)) .
cnf(r_axiom83,axiom,(~acc_f4_p | ~acc_f7_p | acc_f3_p)) .
cnf(r_axiom84,axiom,(~acc_zcl_14 | acc_f0)) .
cnf(r_axiom85,axiom,(~acc_zcl_14 | acc_f3)) .
cnf(r_axiom86,axiom,(~acc_f0 | ~acc_f3 | acc_zcl_14)) .
cnf(r_axiom87,axiom,(~acc_q | acc_zcl_14)) .
cnf(r_axiom88,axiom,(~acc_f0_p | ~acc_f3_p | acc_q)) .
