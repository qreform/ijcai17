%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (~p3 | p0))) & ((p2 | (p1 | (~p5 | ~p4))) & (~p7 | (p2 | (~p0 | p6))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom20,axiom,(~acc_f5 | acc_p1 | acc_f6)) .
cnf(r_axiom21,axiom,(~acc_p1 | acc_f5_p)) .
...
cnf(r_axiom26,axiom,(~acc_f9 | acc_p0 | acc_p6)) .
cnf(r_axiom27,axiom,(~acc_p0 | acc_f9_p)) .
