...
;%~f17 | p11 | p10
(assert (or (not l_f17) l_p11 l_p10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p11 | ~p10) --> f17_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f17) r_p11 r_p10))
