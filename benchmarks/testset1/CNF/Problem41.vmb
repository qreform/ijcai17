%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | (p5 | p0))))) & (p5 | (p0 | (p4 | (p3 | (p0 | p6)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom16,axiom,(~f9 | p0 | p6)) .
cnf(l_axiom17,axiom,(~p0 | f9_p)) .
cnf(l_axiom18,axiom,(~p6 | f9_p)) .
cnf(l_axiom19,axiom,(~f8 | p3 | f9)) .
cnf(l_axiom20,axiom,(~p3 | f8_p)) .
cnf(l_axiom21,axiom,(~f9_p | f8_p)) .
cnf(l_axiom22,axiom,(~f7 | p4 | f8)) .
cnf(l_axiom23,axiom,(~p4 | f7_p)) .
cnf(l_axiom24,axiom,(~f8_p | f7_p)) .
cnf(l_axiom25,axiom,(~f6 | p0 | f7)) .
cnf(l_axiom26,axiom,(~p0 | f6_p)) .
cnf(l_axiom27,axiom,(~f7_p | f6_p)) .
cnf(l_axiom28,axiom,(~f5 | p5 | f6)) .
cnf(l_axiom29,axiom,(~p5 | f5_p)) .
...
cnf(r_axiom7,axiom,(~acc_f4 | acc_p5 | acc_p0)) .
cnf(r_axiom8,axiom,(~acc_p5 | acc_f4_p)) .
cnf(r_axiom9,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom10,axiom,(~acc_f3 | acc_p4 | acc_f4)) .
cnf(r_axiom11,axiom,(~acc_p4 | acc_f3_p)) .
cnf(r_axiom12,axiom,(~acc_f4_p | acc_f3_p)) .
...
cnf(r_axiom22,axiom,(~acc_f9 | acc_p0 | acc_p6)) .
cnf(r_axiom23,axiom,(~acc_p0 | acc_f9_p)) .
cnf(r_axiom24,axiom,(~acc_p6 | acc_f9_p)) .
cnf(r_axiom25,axiom,(~acc_f8 | acc_p3 | acc_f9)) .
cnf(r_axiom26,axiom,(~acc_p3 | acc_f8_p)) .
cnf(r_axiom27,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom28,axiom,(~acc_f7 | acc_p4 | acc_f8)) .
cnf(r_axiom29,axiom,(~acc_p4 | acc_f7_p)) .
cnf(r_axiom30,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom31,axiom,(~acc_f6 | acc_p0 | acc_f7)) .
cnf(r_axiom32,axiom,(~acc_p0 | acc_f6_p)) .
cnf(r_axiom33,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom34,axiom,(~acc_f5 | acc_p5 | acc_f6)) .
cnf(r_axiom35,axiom,(~acc_p5 | acc_f5_p)) .
cnf(r_axiom36,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom37,axiom,(~acc_zcl_2 | acc_f0)) .
cnf(r_axiom38,axiom,(~acc_zcl_2 | acc_f5)) .
cnf(r_axiom39,axiom,(~acc_f0 | ~acc_f5 | acc_zcl_2)) .
cnf(r_axiom40,axiom,(~acc_q | acc_zcl_2)) .
cnf(r_axiom41,axiom,(~acc_f0_p | ~acc_f5_p | acc_q)) .
