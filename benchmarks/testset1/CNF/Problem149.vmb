%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (~p3 | (p4 | (~p5 | p0))))) & ((p5 | (p7 | (p3 | (~p4 | (~p8 | ~p6))))) & ((~p5 | (~p7 | (p10 | (~p8 | (p11 | ~p9))))) & (~p13 | (~p2 | (~p11 | (p4 | (~p14 | ~p12)))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom31,axiom,(~f16 | p11 | p9)) .
cnf(l_axiom32,axiom,(~p11 | f16_p)) .
cnf(l_axiom33,axiom,(~p9 | f16_p)) .
cnf(l_axiom34,axiom,(~f15 | p8 | f16)) .
cnf(l_axiom35,axiom,(~p8 | f15_p)) .
...
cnf(l_axiom52,axiom,(~f19 | p11 | f20)) .
cnf(l_axiom53,axiom,(~p11 | f19_p)) .
cnf(l_axiom54,axiom,(~f20_p | f19_p)) .
cnf(l_axiom55,axiom,(~f18 | p2 | f19)) .
cnf(l_axiom56,axiom,(~p2 | f18_p)) .
cnf(l_axiom57,axiom,(~f19_p | f18_p)) .
cnf(l_axiom58,axiom,(~f17 | p13 | f18)) .
cnf(l_axiom59,axiom,(~p13 | f17_p)) .
...
cnf(r_axiom30,axiom,(~acc_f10 | acc_p8 | acc_p6)) .
cnf(r_axiom31,axiom,(~acc_p8 | acc_f10_p)) .
cnf(r_axiom32,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom33,axiom,(~acc_f9 | acc_p4 | acc_f10)) .
cnf(r_axiom34,axiom,(~acc_p4 | acc_f9_p)) .
cnf(r_axiom35,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom36,axiom,(~acc_f8 | acc_p3 | acc_f9)) .
cnf(r_axiom37,axiom,(~acc_p3 | acc_f8_p)) .
cnf(r_axiom38,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom39,axiom,(~acc_f7 | acc_p7 | acc_f8)) .
cnf(r_axiom40,axiom,(~acc_p7 | acc_f7_p)) .
cnf(r_axiom41,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom42,axiom,(~acc_f6 | acc_p5 | acc_f7)) .
cnf(r_axiom43,axiom,(~acc_p5 | acc_f6_p)) .
cnf(r_axiom44,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom45,axiom,(~acc_f16 | acc_p11 | acc_p9)) .
cnf(r_axiom46,axiom,(~acc_p11 | acc_f16_p)) .
cnf(r_axiom47,axiom,(~acc_p9 | acc_f16_p)) .
cnf(r_axiom48,axiom,(~acc_f15 | acc_p8 | acc_f16)) .
cnf(r_axiom49,axiom,(~acc_p8 | acc_f15_p)) .
cnf(r_axiom50,axiom,(~acc_f16_p | acc_f15_p)) .
cnf(r_axiom51,axiom,(~acc_f14 | acc_p10 | acc_f15)) .
cnf(r_axiom52,axiom,(~acc_p10 | acc_f14_p)) .
cnf(r_axiom53,axiom,(~acc_f15_p | acc_f14_p)) .
cnf(r_axiom54,axiom,(~acc_f13 | acc_p7 | acc_f14)) .
cnf(r_axiom55,axiom,(~acc_p7 | acc_f13_p)) .
...
cnf(r_axiom66,axiom,(~acc_f19 | acc_p11 | acc_f20)) .
cnf(r_axiom67,axiom,(~acc_p11 | acc_f19_p)) .
cnf(r_axiom68,axiom,(~acc_f20_p | acc_f19_p)) .
cnf(r_axiom69,axiom,(~acc_f18 | acc_p2 | acc_f19)) .
cnf(r_axiom70,axiom,(~acc_p2 | acc_f18_p)) .
cnf(r_axiom71,axiom,(~acc_f19_p | acc_f18_p)) .
cnf(r_axiom72,axiom,(~acc_f17 | acc_p13 | acc_f18)) .
cnf(r_axiom73,axiom,(~acc_p13 | acc_f17_p)) .
cnf(r_axiom74,axiom,(~acc_f18_p | acc_f17_p)) .
cnf(r_axiom75,axiom,(~acc_zcl_6 | acc_f12)) .
cnf(r_axiom76,axiom,(~acc_zcl_6 | acc_f17)) .
cnf(r_axiom77,axiom,(~acc_f12 | ~acc_f17 | acc_zcl_6)) .
cnf(r_axiom78,axiom,(~acc_f11 | acc_zcl_6)) .
cnf(r_axiom79,axiom,(~acc_f12_p | ~acc_f17_p | acc_f11_p)) .
cnf(r_axiom80,axiom,(~acc_zcl_7 | acc_f6)) .
cnf(r_axiom81,axiom,(~acc_zcl_7 | acc_f11)) .
cnf(r_axiom82,axiom,(~acc_f6 | ~acc_f11 | acc_zcl_7)) .
cnf(r_axiom83,axiom,(~acc_f5 | acc_zcl_7)) .
cnf(r_axiom84,axiom,(~acc_f6_p | ~acc_f11_p | acc_f5_p)) .
cnf(r_axiom85,axiom,(~acc_zcl_8 | acc_f0)) .
cnf(r_axiom86,axiom,(~acc_zcl_8 | acc_f5)) .
cnf(r_axiom87,axiom,(~acc_f0 | ~acc_f5 | acc_zcl_8)) .
cnf(r_axiom88,axiom,(~acc_q | acc_zcl_8)) .
cnf(r_axiom89,axiom,(~acc_f0_p | ~acc_f5_p | acc_q)) .
