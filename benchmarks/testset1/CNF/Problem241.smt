...
;%~f15 | p1 | f16
(assert (or (not l_f15) l_p1 l_f16))
...
;%~f22 | p5 | p11
(assert (or (not l_f22) l_p5 l_p11))
...
;%~f21 | p8 | f22
(assert (or (not l_f21) l_p8 l_f22))
...
;%~f19 | p2 | f20
(assert (or (not l_f19) l_p2 l_f20))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p2 | f20_p) --> f19_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f19_p () Bool)
;%~p2 | f19_p
(assert (or (not l_p2) l_f19_p))
...
;%~f18 | p5 | f19
(assert (or (not l_f18) l_p5 l_f19))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p5 | f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
...
;%~f28 | p6 | p12
(assert (or (not l_f28) l_p6 l_p12))
...
;%~f27 | p14 | f28
(assert (or (not l_f27) l_p14 l_f28))
...
;%~f33 | p17 | p15
(assert (or (not l_f33) l_p17 l_p15))
...
;%~p17 | f33_p
(assert (or (not l_p17) l_f33_p))

;%~p15 | f33_p
(assert (or (not l_p15) l_f33_p))
...
;%~f32 | p14 | f33
(assert (or (not l_f32) l_p14 l_f33))
...
;%~f31 | p16 | f32
(assert (or (not l_f31) l_p16 l_f32))
...
;%~f30 | p9 | f31
(assert (or (not l_f30) l_p9 l_f31))
...
;%~f29 | p8 | f30
(assert (or (not l_f29) l_p8 l_f30))
...
(assert (or (not r_f15) r_p1 r_f16))
...
(assert (or (not r_f22) r_p5 r_p11))


;%~r_p5 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p5) r_f22_p))
...
(assert (or (not r_f21) r_p8 r_f22))


;%~r_p8 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p8) r_f21_p))
...
(assert (or (not r_f19) r_p2 r_f20))


;%~r_p2 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p2) r_f19_p))
...
(assert (or (not r_f18) r_p5 r_f19))
...
(assert (or (not r_f28) r_p6 r_p12))
...
(assert (or (not r_f27) r_p14 r_f28))
...
(assert (or (not r_f33) r_p17 r_p15))


;%~r_p17 | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p17) r_f33_p))


;%~r_p15 | r_f33_p
(assert (or (not r_p15) r_f33_p))


;%~r_f32 | r_p14 | r_f33
(declare-fun r_f32 () Bool)
(assert (or (not r_f32) r_p14 r_f33))


;%~r_p14 | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p14) r_f32_p))
...
(assert (or (not r_f31) r_p16 r_f32))


;%~r_p16 | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p16) r_f31_p))
...
(assert (or (not r_f30) r_p9 r_f31))


;%~r_p9 | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p9) r_f30_p))
...
(assert (or (not r_f29) r_p8 r_f30))


;%~r_p8 | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p8) r_f29_p))
