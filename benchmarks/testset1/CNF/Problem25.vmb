...
cnf(l_axiom10,axiom,(~f5 | p7 | p4)) .
cnf(l_axiom11,axiom,(~p7 | f5_p)) .
cnf(l_axiom12,axiom,(~p4 | f5_p)) .
cnf(l_axiom13,axiom,(~f4 | p6 | f5)) .
cnf(l_axiom14,axiom,(~p6 | f4_p)) .
cnf(l_axiom15,axiom,(~f5_p | f4_p)) .
cnf(l_axiom16,axiom,(~f3 | p5 | f4)) .
cnf(l_axiom17,axiom,(~p5 | f3_p)) .
cnf(l_axiom18,axiom,(~f4_p | f3_p)) .
cnf(l_axiom19,axiom,(~zcl_2 | f0)) .
cnf(l_axiom20,axiom,(~zcl_2 | f3)) .
cnf(l_axiom21,axiom,(~f0 | ~f3 | zcl_2)) .
cnf(l_axiom22,axiom,(~q | zcl_2)) .
...
cnf(r_axiom17,axiom,(~acc_f5 | acc_p7 | acc_p4)) .
cnf(r_axiom18,axiom,(~acc_p7 | acc_f5_p)) .
cnf(r_axiom19,axiom,(~acc_p4 | acc_f5_p)) .
cnf(r_axiom20,axiom,(~acc_f4 | acc_p6 | acc_f5)) .
cnf(r_axiom21,axiom,(~acc_p6 | acc_f4_p)) .
cnf(r_axiom22,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom23,axiom,(~acc_f3 | acc_p5 | acc_f4)) .
cnf(r_axiom24,axiom,(~acc_p5 | acc_f3_p)) .
cnf(r_axiom25,axiom,(~acc_f4_p | acc_f3_p)) .
cnf(r_axiom26,axiom,(~acc_zcl_2 | acc_f0)) .
cnf(r_axiom27,axiom,(~acc_zcl_2 | acc_f3)) .
cnf(r_axiom28,axiom,(~acc_f0 | ~acc_f3 | acc_zcl_2)) .
cnf(r_axiom29,axiom,(~acc_q | acc_zcl_2)) .
cnf(r_axiom30,axiom,(~acc_f0_p | ~acc_f3_p | acc_q)) .
