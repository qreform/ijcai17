...
;%~f19 | p11 | f20
(assert (or (not l_f19) l_p11 l_f20))
...
;%~f23 | p8 | f24
(assert (or (not l_f23) l_p8 l_f24))
...
(assert (or (not r_f19) r_p11 r_f20))
...
(assert (or (not r_f23) r_p8 r_f24))
