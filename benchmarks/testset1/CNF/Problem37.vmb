%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (~p3 | (p4 | ~p0)))) & (p0 | (~p4 | (p4 | (p0 | ~p5))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom18,axiom,(~acc_f7 | acc_p0 | acc_p5)) .
cnf(r_axiom19,axiom,(~acc_p0 | acc_f7_p)) .
...
cnf(r_axiom24,axiom,(~acc_f5 | acc_p4 | acc_f6)) .
cnf(r_axiom25,axiom,(~acc_p4 | acc_f5_p)) .
