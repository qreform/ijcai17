%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (p2 | (~p3 | (~p4 | (p5 | ~p0))))) & (~p1 | (p0 | (~p4 | (~p3 | (p4 | p6)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom16,axiom,(~f9 | p4 | p6)) .
cnf(l_axiom17,axiom,(~p4 | f9_p)) .
...
cnf(l_axiom28,axiom,(~f5 | p1 | f6)) .
cnf(l_axiom29,axiom,(~p1 | f5_p)) .
...
cnf(r_axiom22,axiom,(~acc_f9 | acc_p4 | acc_p6)) .
cnf(r_axiom23,axiom,(~acc_p4 | acc_f9_p)) .
...
cnf(r_axiom34,axiom,(~acc_f5 | acc_p1 | acc_f6)) .
cnf(r_axiom35,axiom,(~acc_p1 | acc_f5_p)) .
