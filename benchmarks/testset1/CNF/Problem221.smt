...
;%~f18 | p5 | p10
(assert (or (not l_f18) l_p5 l_p10))
...
;%~f21 | p9 | p12
(assert (or (not l_f21) l_p9 l_p12))
...
(assert (or (not r_f18) r_p5 r_p10))
...
(assert (or (not r_f21) r_p9 r_p12))
