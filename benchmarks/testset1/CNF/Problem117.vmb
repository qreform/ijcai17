%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | p0)) & ((p2 | (p1 | p3)) & ((p5 | (~p2 | p4)) & (p1 | (p7 | ~p6))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom17,axiom,(~acc_f3 | acc_p2 | acc_f4)) .
cnf(r_axiom18,axiom,(~acc_p2 | acc_f3_p)) .
cnf(r_axiom19,axiom,(~acc_f4_p | acc_f3_p)) .
cnf(r_axiom20,axiom,(~acc_f7 | acc_p2 | acc_p4)) .
cnf(r_axiom21,axiom,(~acc_p2 | acc_f7_p)) .
cnf(r_axiom22,axiom,(~acc_p4 | acc_f7_p)) .
cnf(r_axiom23,axiom,(~acc_f6 | acc_p5 | acc_f7)) .
cnf(r_axiom24,axiom,(~acc_p5 | acc_f6_p)) .
cnf(r_axiom25,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom26,axiom,(~acc_f9 | acc_p7 | acc_p6)) .
cnf(r_axiom27,axiom,(~acc_p7 | acc_f9_p)) .
cnf(r_axiom28,axiom,(~acc_p6 | acc_f9_p)) .
cnf(r_axiom29,axiom,(~acc_f8 | acc_p1 | acc_f9)) .
cnf(r_axiom30,axiom,(~acc_p1 | acc_f8_p)) .
cnf(r_axiom31,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom32,axiom,(~acc_zcl_6 | acc_f6)) .
cnf(r_axiom33,axiom,(~acc_zcl_6 | acc_f8)) .
cnf(r_axiom34,axiom,(~acc_f6 | ~acc_f8 | acc_zcl_6)) .
cnf(r_axiom35,axiom,(~acc_f5 | acc_zcl_6)) .
cnf(r_axiom36,axiom,(~acc_f6_p | ~acc_f8_p | acc_f5_p)) .
cnf(r_axiom37,axiom,(~acc_zcl_7 | acc_f3)) .
cnf(r_axiom38,axiom,(~acc_zcl_7 | acc_f5)) .
cnf(r_axiom39,axiom,(~acc_f3 | ~acc_f5 | acc_zcl_7)) .
cnf(r_axiom40,axiom,(~acc_f2 | acc_zcl_7)) .
cnf(r_axiom41,axiom,(~acc_f3_p | ~acc_f5_p | acc_f2_p)) .
cnf(r_axiom42,axiom,(~acc_zcl_8 | acc_f0)) .
cnf(r_axiom43,axiom,(~acc_zcl_8 | acc_f2)) .
cnf(r_axiom44,axiom,(~acc_f0 | ~acc_f2 | acc_zcl_8)) .
cnf(r_axiom45,axiom,(~acc_q | acc_zcl_8)) .
