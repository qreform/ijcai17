%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | (~p4 | (~p5 | ~p0))))) & ((~p0 | (~p4 | (p3 | (p4 | (~p7 | p6))))) & (~p4 | (~p3 | (p2 | (~p4 | (p4 | ~p8))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom37,axiom,(~f13 | p2 | f14)) .
cnf(l_axiom38,axiom,(~p2 | f13_p)) .
cnf(l_axiom39,axiom,(~f14_p | f13_p)) .
cnf(l_axiom40,axiom,(~f12 | p3 | f13)) .
cnf(l_axiom41,axiom,(~p3 | f12_p)) .
cnf(l_axiom42,axiom,(~f13_p | f12_p)) .
cnf(l_axiom43,axiom,(~f11 | p4 | f12)) .
cnf(l_axiom44,axiom,(~p4 | f11_p)) .
...
cnf(r_axiom24,axiom,(~acc_f10 | acc_p7 | acc_p6)) .
cnf(r_axiom25,axiom,(~acc_p7 | acc_f10_p)) .
cnf(r_axiom26,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom27,axiom,(~acc_f9 | acc_p4 | acc_f10)) .
cnf(r_axiom28,axiom,(~acc_p4 | acc_f9_p)) .
cnf(r_axiom29,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom30,axiom,(~acc_f8 | acc_p3 | acc_f9)) .
cnf(r_axiom31,axiom,(~acc_p3 | acc_f8_p)) .
...
cnf(r_axiom39,axiom,(~acc_f15 | acc_p4 | acc_p8)) .
cnf(r_axiom40,axiom,(~acc_p4 | acc_f15_p)) .
cnf(r_axiom41,axiom,(~acc_p8 | acc_f15_p)) .
cnf(r_axiom42,axiom,(~acc_f14 | acc_p4 | acc_f15)) .
cnf(r_axiom43,axiom,(~acc_p4 | acc_f14_p)) .
cnf(r_axiom44,axiom,(~acc_f15_p | acc_f14_p)) .
cnf(r_axiom45,axiom,(~acc_f13 | acc_p2 | acc_f14)) .
cnf(r_axiom46,axiom,(~acc_p2 | acc_f13_p)) .
cnf(r_axiom47,axiom,(~acc_f14_p | acc_f13_p)) .
cnf(r_axiom48,axiom,(~acc_f12 | acc_p3 | acc_f13)) .
cnf(r_axiom49,axiom,(~acc_p3 | acc_f12_p)) .
cnf(r_axiom50,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom51,axiom,(~acc_f11 | acc_p4 | acc_f12)) .
cnf(r_axiom52,axiom,(~acc_p4 | acc_f11_p)) .
