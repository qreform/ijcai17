...
cnf(r_axiom12,axiom,(~acc_f3 | acc_p5 | acc_p4)) .
cnf(r_axiom13,axiom,(~acc_p5 | acc_f3_p)) .
cnf(r_axiom14,axiom,(~acc_p4 | acc_f3_p)) .
cnf(r_axiom15,axiom,(~acc_zcl_4 | acc_f2)) .
cnf(r_axiom16,axiom,(~acc_zcl_4 | acc_f3)) .
cnf(r_axiom17,axiom,(~acc_f2 | ~acc_f3 | acc_zcl_4)) .
cnf(r_axiom18,axiom,(~acc_f1 | acc_zcl_4)) .
cnf(r_axiom19,axiom,(~acc_f2_p | ~acc_f3_p | acc_f1_p)) .
cnf(r_axiom20,axiom,(~acc_zcl_5 | acc_f0)) .
cnf(r_axiom21,axiom,(~acc_zcl_5 | acc_f1)) .
cnf(r_axiom22,axiom,(~acc_f0 | ~acc_f1 | acc_zcl_5)) .
cnf(r_axiom23,axiom,(~acc_q | acc_zcl_5)) .
cnf(r_axiom24,axiom,(~acc_f0_p | ~acc_f1_p | acc_q)) .
