...
;%~f10 | p2 | f11
(assert (or (not l_f10) l_p2 l_f11))
...
;%~f18 | p4 | p10
(assert (or (not l_f18) l_p4 l_p10))
...
;%~f23 | p4 | p11
(assert (or (not l_f23) l_p4 l_p11))
...
;%~p4 | f23_p
(assert (or (not l_p4) l_f23_p))

;%~p11 | f23_p
(assert (or (not l_p11) l_f23_p))
...
;%~f22 | p2 | f23
(assert (or (not l_f22) l_p2 l_f23))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p2 | f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p2 | f22_p
(assert (or (not l_p2) l_f22_p))
...
;%~f20 | p7 | f21
(assert (or (not l_f20) l_p7 l_f21))
...
;%~f27 | p6 | p13
(assert (or (not l_f27) l_p6 l_p13))
...
;%~f26 | p8 | f27
(assert (or (not l_f26) l_p8 l_f27))
...
;%~f24 | p8 | f25
(assert (or (not l_f24) l_p8 l_f25))
...
(assert (or (not r_f10) r_p2 r_f11))
...
(assert (or (not r_f18) r_p4 r_p10))
...
(assert (or (not r_f23) r_p4 r_p11))


;%~r_p4 | r_f23_p
(declare-fun r_f23_p () Bool)
(assert (or (not r_p4) r_f23_p))


;%~r_p11 | r_f23_p
(assert (or (not r_p11) r_f23_p))


;%~r_f22 | r_p2 | r_f23
(declare-fun r_f22 () Bool)
(assert (or (not r_f22) r_p2 r_f23))


;%~r_p2 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p2) r_f22_p))
...
(assert (or (not r_f20) r_p7 r_f21))


;%~r_p7 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p7) r_f20_p))
...
(assert (or (not r_f27) r_p6 r_p13))
...
(assert (or (not r_f26) r_p8 r_f27))


;%~r_p8 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p8) r_f26_p))
...
(assert (or (not r_f24) r_p8 r_f25))


;%~r_p8 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p8) r_f24_p))
