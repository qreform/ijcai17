%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & (p4 | (p3 | (p4 | (p1 | p5))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom25,axiom,(~zcl_2 | f0)) .
cnf(l_axiom26,axiom,(~zcl_2 | f4)) .
cnf(l_axiom27,axiom,(~f0 | ~f4 | zcl_2)) .
cnf(l_axiom28,axiom,(~q | zcl_2)) .
...
cnf(r_axiom6,axiom,(~acc_f3 | acc_p4 | acc_p0)) .
cnf(r_axiom7,axiom,(~acc_p4 | acc_f3_p)) .
cnf(r_axiom8,axiom,(~acc_p0 | acc_f3_p)) .
cnf(r_axiom9,axiom,(~acc_f2 | acc_p3 | acc_f3)) .
cnf(r_axiom10,axiom,(~acc_p3 | acc_f2_p)) .
cnf(r_axiom11,axiom,(~acc_f3_p | acc_f2_p)) .
...
cnf(r_axiom21,axiom,(~acc_f6 | acc_p4 | acc_f7)) .
...
cnf(r_axiom27,axiom,(~acc_f4 | acc_p4 | acc_f5)) .
cnf(r_axiom28,axiom,(~acc_p4 | acc_f4_p)) .
cnf(r_axiom29,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom30,axiom,(~acc_zcl_2 | acc_f0)) .
cnf(r_axiom31,axiom,(~acc_zcl_2 | acc_f4)) .
cnf(r_axiom32,axiom,(~acc_f0 | ~acc_f4 | acc_zcl_2)) .
cnf(r_axiom33,axiom,(~acc_q | acc_zcl_2)) .
cnf(r_axiom34,axiom,(~acc_f0_p | ~acc_f4_p | acc_q)) .
