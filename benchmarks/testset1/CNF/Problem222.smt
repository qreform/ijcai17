...
;%~f14 | p10 | p8
(assert (or (not l_f14) l_p10 l_p8))
...
;%~f18 | p4 | p11
(assert (or (not l_f18) l_p4 l_p11))
...
;%~f21 | p14 | p12
(assert (or (not l_f21) l_p14 l_p12))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p14 | p12) --> f21_p))
;%------------------------Clausification start------------------------%
...
(assert (or (not r_f14) r_p10 r_p8))
...
(assert (or (not r_f18) r_p4 r_p11))
...
(assert (or (not r_f21) r_p14 r_p12))
