%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | ~p0) & ((~p0 | ~p2) & ((~p4 | ~p3) & ((p1 | p5) & (~p5 | p6))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom16,axiom,(~acc_f6 | acc_p1 | acc_p5)) .
cnf(r_axiom17,axiom,(~acc_p1 | acc_f6_p)) .
cnf(r_axiom18,axiom,(~acc_p5 | acc_f6_p)) .
cnf(r_axiom19,axiom,(~acc_f7 | acc_p5 | acc_p6)) .
