...
;%~f19 | p5 | f20
(assert (or (not l_f19) l_p5 l_f20))
...
;%~f27 | p11 | p10
(assert (or (not l_f27) l_p11 l_p10))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p11 | p10) --> f27_p))
;%------------------------Clausification start------------------------%
...
;%~f24 | p6 | f25
(assert (or (not l_f24) l_p6 l_f25))
...
(assert (or (not r_f19) r_p5 r_f20))


;%~r_p5 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p5) r_f19_p))
...
(assert (or (not r_f27) r_p11 r_p10))
...
(assert (or (not r_f24) r_p6 r_f25))


;%~r_p6 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p6) r_f24_p))
