%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (~p3 | (~p4 | (p5 | ~p0))))) & ((p7 | (~p8 | (~p9 | (p10 | (p11 | ~p6))))) & (~p13 | (p14 | (~p15 | (p16 | (p17 | ~p12))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom31,axiom,(~f15 | p17 | p12)) .
cnf(l_axiom32,axiom,(~p17 | f15_p)) .
cnf(l_axiom33,axiom,(~p12 | f15_p)) .
cnf(l_axiom34,axiom,(~f14 | p16 | f15)) .
cnf(l_axiom35,axiom,(~p16 | f14_p)) .
cnf(l_axiom36,axiom,(~f15_p | f14_p)) .
cnf(l_axiom37,axiom,(~f13 | p15 | f14)) .
cnf(l_axiom38,axiom,(~p15 | f13_p)) .
cnf(l_axiom39,axiom,(~f14_p | f13_p)) .
cnf(l_axiom40,axiom,(~f12 | p14 | f13)) .
cnf(l_axiom41,axiom,(~p14 | f12_p)) .
cnf(l_axiom42,axiom,(~f13_p | f12_p)) .
cnf(l_axiom43,axiom,(~f11 | p13 | f12)) .
cnf(l_axiom44,axiom,(~p13 | f11_p)) .
...
cnf(r_axiom33,axiom,(~acc_f10 | acc_p11 | acc_p6)) .
cnf(r_axiom34,axiom,(~acc_p11 | acc_f10_p)) .
cnf(r_axiom35,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom36,axiom,(~acc_f9 | acc_p10 | acc_f10)) .
cnf(r_axiom37,axiom,(~acc_p10 | acc_f9_p)) .
cnf(r_axiom38,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom39,axiom,(~acc_f8 | acc_p9 | acc_f9)) .
cnf(r_axiom40,axiom,(~acc_p9 | acc_f8_p)) .
cnf(r_axiom41,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom42,axiom,(~acc_f7 | acc_p8 | acc_f8)) .
cnf(r_axiom43,axiom,(~acc_p8 | acc_f7_p)) .
...
cnf(r_axiom48,axiom,(~acc_f15 | acc_p17 | acc_p12)) .
cnf(r_axiom49,axiom,(~acc_p17 | acc_f15_p)) .
cnf(r_axiom50,axiom,(~acc_p12 | acc_f15_p)) .
cnf(r_axiom51,axiom,(~acc_f14 | acc_p16 | acc_f15)) .
cnf(r_axiom52,axiom,(~acc_p16 | acc_f14_p)) .
cnf(r_axiom53,axiom,(~acc_f15_p | acc_f14_p)) .
cnf(r_axiom54,axiom,(~acc_f13 | acc_p15 | acc_f14)) .
cnf(r_axiom55,axiom,(~acc_p15 | acc_f13_p)) .
cnf(r_axiom56,axiom,(~acc_f14_p | acc_f13_p)) .
cnf(r_axiom57,axiom,(~acc_f12 | acc_p14 | acc_f13)) .
cnf(r_axiom58,axiom,(~acc_p14 | acc_f12_p)) .
cnf(r_axiom59,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom60,axiom,(~acc_f11 | acc_p13 | acc_f12)) .
cnf(r_axiom61,axiom,(~acc_p13 | acc_f11_p)) .
cnf(r_axiom62,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom63,axiom,(~acc_zcl_4 | acc_f6)) .
cnf(r_axiom64,axiom,(~acc_zcl_4 | acc_f11)) .
cnf(r_axiom65,axiom,(~acc_f6 | ~acc_f11 | acc_zcl_4)) .
cnf(r_axiom66,axiom,(~acc_f5 | acc_zcl_4)) .
cnf(r_axiom67,axiom,(~acc_f6_p | ~acc_f11_p | acc_f5_p)) .
cnf(r_axiom68,axiom,(~acc_zcl_5 | acc_f0)) .
cnf(r_axiom69,axiom,(~acc_zcl_5 | acc_f5)) .
cnf(r_axiom70,axiom,(~acc_f0 | ~acc_f5 | acc_zcl_5)) .
cnf(r_axiom71,axiom,(~acc_q | acc_zcl_5)) .
cnf(r_axiom72,axiom,(~acc_f0_p | ~acc_f5_p | acc_q)) .
