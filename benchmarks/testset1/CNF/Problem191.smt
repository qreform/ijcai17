...
;%~f22 | p12 | p11
(assert (or (not l_f22) l_p12 l_p11))
...
;%~f21 | p9 | f22
(assert (or (not l_f21) l_p9 l_f22))
...
;%~f18 | p4 | f19
(assert (or (not l_f18) l_p4 l_f19))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p4 | f19_p) --> f18_p))
;%------------------------Clausification start------------------------%
...
;%~f27 | p10 | p13
(assert (or (not l_f27) l_p10 l_p13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p10 | p13) --> f27_p))
;%------------------------Clausification start------------------------%
...
;%~f26 | p16 | f27
(assert (or (not l_f26) l_p16 l_f27))
...
;%~f23 | p14 | f24
(assert (or (not l_f23) l_p14 l_f24))
...
(assert (or (not r_f22) r_p12 r_p11))
...
(assert (or (not r_f21) r_p9 r_f22))


;%~r_p9 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p9) r_f21_p))
...
(assert (or (not r_f18) r_p4 r_f19))
...
(assert (or (not r_f27) r_p10 r_p13))
...
(assert (or (not r_f26) r_p16 r_f27))


;%~r_p16 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p16) r_f26_p))
...
(assert (or (not r_f23) r_p14 r_f24))
