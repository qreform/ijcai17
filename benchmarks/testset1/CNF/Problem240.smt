...
;%~f22 | p23 | p18
(assert (or (not l_f22) l_p23 l_p18))
...
;%~p23 | f22_p
(assert (or (not l_p23) l_f22_p))

;%~p18 | f22_p
(assert (or (not l_p18) l_f22_p))
...
;%~f21 | p22 | f22
(assert (or (not l_f21) l_p22 l_f22))
...
;%~f20 | p21 | f21
(assert (or (not l_f20) l_p21 l_f21))
...
;%~f19 | p20 | f20
(assert (or (not l_f19) l_p20 l_f20))
...
;%~f28 | p29 | p24
(assert (or (not l_f28) l_p29 l_p24))
...
;%~p29 | f28_p
(assert (or (not l_p29) l_f28_p))

;%~p24 | f28_p
(assert (or (not l_p24) l_f28_p))
...
;%~f27 | p28 | f28
(assert (or (not l_f27) l_p28 l_f28))
...
;%~f26 | p27 | f27
(assert (or (not l_f26) l_p27 l_f27))
...
;%~f25 | p26 | f26
(assert (or (not l_f25) l_p26 l_f26))
...
;%~f24 | p25 | f25
(assert (or (not l_f24) l_p25 l_f25))
...
;%~f33 | p35 | p30
(assert (or (not l_f33) l_p35 l_p30))
...
;%~p35 | f33_p
(assert (or (not l_p35) l_f33_p))

;%~p30 | f33_p
(assert (or (not l_p30) l_f33_p))
...
;%~f32 | p34 | f33
(assert (or (not l_f32) l_p34 l_f33))
...
;%~f31 | p33 | f32
(assert (or (not l_f31) l_p33 l_f32))
...
;%~f30 | p32 | f31
(assert (or (not l_f30) l_p32 l_f31))
...
;%~f29 | p31 | f30
(assert (or (not l_f29) l_p31 l_f30))
...
(assert (or (not r_f22) r_p23 r_p18))


;%~r_p23 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p23) r_f22_p))


;%~r_p18 | r_f22_p
(assert (or (not r_p18) r_f22_p))


;%~r_f21 | r_p22 | r_f22
(declare-fun r_f21 () Bool)
(assert (or (not r_f21) r_p22 r_f22))


;%~r_p22 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p22) r_f21_p))
...
(assert (or (not r_f20) r_p21 r_f21))


;%~r_p21 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p21) r_f20_p))
...
(assert (or (not r_f19) r_p20 r_f20))
...
(assert (or (not r_f28) r_p29 r_p24))


;%~r_p29 | r_f28_p
(declare-fun r_f28_p () Bool)
(assert (or (not r_p29) r_f28_p))


;%~r_p24 | r_f28_p
(assert (or (not r_p24) r_f28_p))


;%~r_f27 | r_p28 | r_f28
(declare-fun r_f27 () Bool)
(assert (or (not r_f27) r_p28 r_f28))


;%~r_p28 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p28) r_f27_p))
...
(assert (or (not r_f26) r_p27 r_f27))


;%~r_p27 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p27) r_f26_p))
...
(assert (or (not r_f25) r_p26 r_f26))


;%~r_p26 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p26) r_f25_p))
...
(assert (or (not r_f24) r_p25 r_f25))


;%~r_p25 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p25) r_f24_p))
...
(assert (or (not r_f33) r_p35 r_p30))


;%~r_p35 | r_f33_p
(declare-fun r_f33_p () Bool)
(assert (or (not r_p35) r_f33_p))


;%~r_p30 | r_f33_p
(assert (or (not r_p30) r_f33_p))


;%~r_f32 | r_p34 | r_f33
(declare-fun r_f32 () Bool)
(assert (or (not r_f32) r_p34 r_f33))


;%~r_p34 | r_f32_p
(declare-fun r_f32_p () Bool)
(assert (or (not r_p34) r_f32_p))
...
(assert (or (not r_f31) r_p33 r_f32))


;%~r_p33 | r_f31_p
(declare-fun r_f31_p () Bool)
(assert (or (not r_p33) r_f31_p))
...
(assert (or (not r_f30) r_p32 r_f31))


;%~r_p32 | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p32) r_f30_p))
...
(assert (or (not r_f29) r_p31 r_f30))


;%~r_p31 | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p31) r_f29_p))
