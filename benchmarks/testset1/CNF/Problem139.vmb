%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | (p4 | p0)))) & ((p1 | (p1 | (p3 | (p1 | ~p5)))) & ((~p3 | (~p7 | (p0 | (p8 | p6)))) & (p10 | (p0 | (p8 | (p11 | ~p9))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom22,axiom,(~f5 | p1 | f6)) .
cnf(l_axiom23,axiom,(~p1 | f5_p)) .
cnf(l_axiom24,axiom,(~f6_p | f5_p)) .
cnf(l_axiom25,axiom,(~f13 | p8 | p6)) .
...
cnf(r_axiom24,axiom,(~acc_f8 | acc_p1 | acc_p5)) .
cnf(r_axiom25,axiom,(~acc_p1 | acc_f8_p)) .
cnf(r_axiom26,axiom,(~acc_p5 | acc_f8_p)) .
cnf(r_axiom27,axiom,(~acc_f7 | acc_p3 | acc_f8)) .
cnf(r_axiom28,axiom,(~acc_p3 | acc_f7_p)) .
cnf(r_axiom29,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom30,axiom,(~acc_f6 | acc_p1 | acc_f7)) .
cnf(r_axiom31,axiom,(~acc_p1 | acc_f6_p)) .
cnf(r_axiom32,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom33,axiom,(~acc_f5 | acc_p1 | acc_f6)) .
cnf(r_axiom34,axiom,(~acc_p1 | acc_f5_p)) .
cnf(r_axiom35,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom36,axiom,(~acc_f13 | acc_p8 | acc_p6)) .
cnf(r_axiom37,axiom,(~acc_p8 | acc_f13_p)) .
cnf(r_axiom38,axiom,(~acc_p6 | acc_f13_p)) .
cnf(r_axiom39,axiom,(~acc_f12 | acc_p0 | acc_f13)) .
cnf(r_axiom40,axiom,(~acc_p0 | acc_f12_p)) .
cnf(r_axiom41,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom42,axiom,(~acc_f11 | acc_p7 | acc_f12)) .
cnf(r_axiom43,axiom,(~acc_p7 | acc_f11_p)) .
cnf(r_axiom44,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom45,axiom,(~acc_f10 | acc_p3 | acc_f11)) .
cnf(r_axiom46,axiom,(~acc_p3 | acc_f10_p)) .
cnf(r_axiom47,axiom,(~acc_f11_p | acc_f10_p)) .
cnf(r_axiom48,axiom,(~acc_f17 | acc_p11 | acc_p9)) .
cnf(r_axiom49,axiom,(~acc_p11 | acc_f17_p)) .
cnf(r_axiom50,axiom,(~acc_p9 | acc_f17_p)) .
cnf(r_axiom51,axiom,(~acc_f16 | acc_p8 | acc_f17)) .
cnf(r_axiom52,axiom,(~acc_p8 | acc_f16_p)) .
...
cnf(r_axiom57,axiom,(~acc_f14 | acc_p10 | acc_f15)) .
cnf(r_axiom58,axiom,(~acc_p10 | acc_f14_p)) .
cnf(r_axiom59,axiom,(~acc_f15_p | acc_f14_p)) .
cnf(r_axiom60,axiom,(~acc_zcl_6 | acc_f10)) .
cnf(r_axiom61,axiom,(~acc_zcl_6 | acc_f14)) .
cnf(r_axiom62,axiom,(~acc_f10 | ~acc_f14 | acc_zcl_6)) .
cnf(r_axiom63,axiom,(~acc_f9 | acc_zcl_6)) .
cnf(r_axiom64,axiom,(~acc_f10_p | ~acc_f14_p | acc_f9_p)) .
cnf(r_axiom65,axiom,(~acc_zcl_7 | acc_f5)) .
cnf(r_axiom66,axiom,(~acc_zcl_7 | acc_f9)) .
cnf(r_axiom67,axiom,(~acc_f5 | ~acc_f9 | acc_zcl_7)) .
cnf(r_axiom68,axiom,(~acc_f4 | acc_zcl_7)) .
cnf(r_axiom69,axiom,(~acc_f5_p | ~acc_f9_p | acc_f4_p)) .
cnf(r_axiom70,axiom,(~acc_zcl_8 | acc_f0)) .
cnf(r_axiom71,axiom,(~acc_zcl_8 | acc_f4)) .
cnf(r_axiom72,axiom,(~acc_f0 | ~acc_f4 | acc_zcl_8)) .
cnf(r_axiom73,axiom,(~acc_q | acc_zcl_8)) .
