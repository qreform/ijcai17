%%%%%%%%%%%%%%%% Target reformulation: ((p1 | p0) & ((p0 | p2) & ((p4 | p3) & ((p3 | p5) & ((p3 | p6) & (p2 | p7)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~f8 | p3 | p6)) .
cnf(l_axiom14,axiom,(~p3 | f8_p)) .
cnf(l_axiom15,axiom,(~p6 | f8_p)) .
cnf(l_axiom16,axiom,(~f9 | p2 | p7)) .
cnf(l_axiom17,axiom,(~p2 | f9_p)) .
cnf(l_axiom18,axiom,(~p7 | f9_p)) .
...
cnf(r_axiom11,axiom,(~acc_f2 | acc_p0 | acc_p2)) .
cnf(r_axiom12,axiom,(~acc_p0 | acc_f2_p)) .
cnf(r_axiom13,axiom,(~acc_p2 | acc_f2_p)) .
cnf(r_axiom14,axiom,(~acc_f4 | acc_p4 | acc_p3)) .
cnf(r_axiom15,axiom,(~acc_p4 | acc_f4_p)) .
cnf(r_axiom16,axiom,(~acc_p3 | acc_f4_p)) .
cnf(r_axiom17,axiom,(~acc_f6 | acc_p3 | acc_p5)) .
cnf(r_axiom18,axiom,(~acc_p3 | acc_f6_p)) .
cnf(r_axiom19,axiom,(~acc_p5 | acc_f6_p)) .
cnf(r_axiom20,axiom,(~acc_f8 | acc_p3 | acc_p6)) .
cnf(r_axiom21,axiom,(~acc_p3 | acc_f8_p)) .
cnf(r_axiom22,axiom,(~acc_p6 | acc_f8_p)) .
cnf(r_axiom23,axiom,(~acc_f9 | acc_p2 | acc_p7)) .
cnf(r_axiom24,axiom,(~acc_p2 | acc_f9_p)) .
cnf(r_axiom25,axiom,(~acc_p7 | acc_f9_p)) .
cnf(r_axiom26,axiom,(~acc_zcl_10 | acc_f8)) .
cnf(r_axiom27,axiom,(~acc_zcl_10 | acc_f9)) .
cnf(r_axiom28,axiom,(~acc_f8 | ~acc_f9 | acc_zcl_10)) .
cnf(r_axiom29,axiom,(~acc_f7 | acc_zcl_10)) .
cnf(r_axiom30,axiom,(~acc_f8_p | ~acc_f9_p | acc_f7_p)) .
cnf(r_axiom31,axiom,(~acc_zcl_11 | acc_f6)) .
cnf(r_axiom32,axiom,(~acc_zcl_11 | acc_f7)) .
cnf(r_axiom33,axiom,(~acc_f6 | ~acc_f7 | acc_zcl_11)) .
cnf(r_axiom34,axiom,(~acc_f5 | acc_zcl_11)) .
cnf(r_axiom35,axiom,(~acc_f6_p | ~acc_f7_p | acc_f5_p)) .
cnf(r_axiom36,axiom,(~acc_zcl_12 | acc_f4)) .
cnf(r_axiom37,axiom,(~acc_zcl_12 | acc_f5)) .
cnf(r_axiom38,axiom,(~acc_f4 | ~acc_f5 | acc_zcl_12)) .
cnf(r_axiom39,axiom,(~acc_f3 | acc_zcl_12)) .
cnf(r_axiom40,axiom,(~acc_f4_p | ~acc_f5_p | acc_f3_p)) .
cnf(r_axiom41,axiom,(~acc_zcl_13 | acc_f2)) .
cnf(r_axiom42,axiom,(~acc_zcl_13 | acc_f3)) .
cnf(r_axiom43,axiom,(~acc_f2 | ~acc_f3 | acc_zcl_13)) .
cnf(r_axiom44,axiom,(~acc_f1 | acc_zcl_13)) .
cnf(r_axiom45,axiom,(~acc_f2_p | ~acc_f3_p | acc_f1_p)) .
