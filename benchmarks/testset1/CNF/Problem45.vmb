%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (~p3 | (~p4 | (p5 | p0))))) & (p7 | (~p8 | (p9 | (p10 | (~p11 | p6)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom16,axiom,(~f9 | p11 | p6)) .
cnf(l_axiom17,axiom,(~p11 | f9_p)) .
cnf(l_axiom18,axiom,(~p6 | f9_p)) .
cnf(l_axiom19,axiom,(~f8 | p10 | f9)) .
cnf(l_axiom20,axiom,(~p10 | f8_p)) .
cnf(l_axiom21,axiom,(~f9_p | f8_p)) .
cnf(l_axiom22,axiom,(~f7 | p9 | f8)) .
cnf(l_axiom23,axiom,(~p9 | f7_p)) .
cnf(l_axiom24,axiom,(~f8_p | f7_p)) .
cnf(l_axiom25,axiom,(~f6 | p8 | f7)) .
cnf(l_axiom26,axiom,(~p8 | f6_p)) .
cnf(l_axiom27,axiom,(~f7_p | f6_p)) .
cnf(l_axiom28,axiom,(~f5 | p7 | f6)) .
cnf(l_axiom29,axiom,(~p7 | f5_p)) .
cnf(l_axiom30,axiom,(~f6_p | f5_p)) .
cnf(l_axiom31,axiom,(~zcl_2 | f0)) .
cnf(l_axiom32,axiom,(~zcl_2 | f5)) .
cnf(l_axiom33,axiom,(~f0 | ~f5 | zcl_2)) .
cnf(l_axiom34,axiom,(~q | zcl_2)) .
cnf(l_axiom35,axiom,(~f0_p | ~f5_p | q)) .
vampire(end_formula).
...
cnf(r_axiom27,axiom,(~acc_f9 | acc_p11 | acc_p6)) .
cnf(r_axiom28,axiom,(~acc_p11 | acc_f9_p)) .
cnf(r_axiom29,axiom,(~acc_p6 | acc_f9_p)) .
cnf(r_axiom30,axiom,(~acc_f8 | acc_p10 | acc_f9)) .
cnf(r_axiom31,axiom,(~acc_p10 | acc_f8_p)) .
cnf(r_axiom32,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom33,axiom,(~acc_f7 | acc_p9 | acc_f8)) .
cnf(r_axiom34,axiom,(~acc_p9 | acc_f7_p)) .
cnf(r_axiom35,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom36,axiom,(~acc_f6 | acc_p8 | acc_f7)) .
cnf(r_axiom37,axiom,(~acc_p8 | acc_f6_p)) .
cnf(r_axiom38,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom39,axiom,(~acc_f5 | acc_p7 | acc_f6)) .
cnf(r_axiom40,axiom,(~acc_p7 | acc_f5_p)) .
cnf(r_axiom41,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom42,axiom,(~acc_zcl_2 | acc_f0)) .
cnf(r_axiom43,axiom,(~acc_zcl_2 | acc_f5)) .
cnf(r_axiom44,axiom,(~acc_f0 | ~acc_f5 | acc_zcl_2)) .
cnf(r_axiom45,axiom,(~acc_q | acc_zcl_2)) .
cnf(r_axiom46,axiom,(~acc_f0_p | ~acc_f5_p | acc_q)) .
