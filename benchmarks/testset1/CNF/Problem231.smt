...
;%~f23 | p5 | p11
(assert (or (not l_f23) l_p5 l_p11))
...
;%~f27 | p8 | p14
(assert (or (not l_f27) l_p8 l_p14))
...
(assert (or (not r_f23) r_p5 r_p11))
...
(assert (or (not r_f27) r_p8 r_p14))
