...
;%~f16 | p12 | p9
(assert (or (not l_f16) l_p12 l_p9))
...
;%~f14 | p11 | f15
(assert (or (not l_f14) l_p11 l_f15))
...
;%~f22 | p14 | p13
(assert (or (not l_f22) l_p14 l_p13))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p14 | ~p13) --> f22_p))
;%------------------------Clausification start------------------------%
...
;%~f20 | p1 | f21
(assert (or (not l_f20) l_p1 l_f21))
...
;%~f19 | p10 | f20
(assert (or (not l_f19) l_p10 l_f20))
...
;%~f18 | p10 | f19
(assert (or (not l_f18) l_p10 l_f19))
...
;%~f27 | p17 | p15
(assert (or (not l_f27) l_p17 l_p15))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p17 | p15) --> f27_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f27_p () Bool)
;%~p17 | f27_p
(assert (or (not l_p17) l_f27_p))
...
;%~f24 | p9 | f25
(assert (or (not l_f24) l_p9 l_f25))
...
(assert (or (not r_f16) r_p12 r_p9))
...
(assert (or (not r_f14) r_p11 r_f15))
...
(assert (or (not r_f22) r_p14 r_p13))
...
(assert (or (not r_f20) r_p1 r_f21))


;%~r_p1 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p1) r_f20_p))
...
(assert (or (not r_f19) r_p10 r_f20))
...
(assert (or (not r_f18) r_p10 r_f19))
...
(assert (or (not r_f27) r_p17 r_p15))


;%~r_p17 | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p17) r_f27_p))
...
(assert (or (not r_f24) r_p9 r_f25))


;%~r_p9 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p9) r_f24_p))
