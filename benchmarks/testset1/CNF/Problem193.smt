...
;%~f22 | p3 | p10
(assert (or (not l_f22) l_p3 l_p10))
...
;%~f21 | p4 | f22
(assert (or (not l_f21) l_p4 l_f22))
...
;%~f27 | p13 | p11
(assert (or (not l_f27) l_p13 l_p11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p13 | p11) --> f27_p))
;%------------------------Clausification start------------------------%
...
;%~f25 | p12 | f26
(assert (or (not l_f25) l_p12 l_f26))
...
;%~f24 | p3 | f25
(assert (or (not l_f24) l_p3 l_f25))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p3 | f25_p) --> f24_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f24_p () Bool)
;%~p3 | f24_p
(assert (or (not l_p3) l_f24_p))
...
(assert (or (not r_f22) r_p3 r_p10))


;%~r_p3 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p3) r_f22_p))
...
(assert (or (not r_f21) r_p4 r_f22))


;%~r_p4 | r_f21_p
(declare-fun r_f21_p () Bool)
(assert (or (not r_p4) r_f21_p))
...
(assert (or (not r_f27) r_p13 r_p11))
...
(assert (or (not r_f25) r_p12 r_f26))


;%~r_p12 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p12) r_f25_p))
...
(assert (or (not r_f24) r_p3 r_f25))


;%~r_p3 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p3) r_f24_p))
