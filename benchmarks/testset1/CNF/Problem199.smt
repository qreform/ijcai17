...
;%~f16 | p9 | p10
(assert (or (not l_f16) l_p9 l_p10))
...
;%~f22 | p6 | p12
(assert (or (not l_f22) l_p6 l_p12))
...
;%~f18 | p8 | f19
(assert (or (not l_f18) l_p8 l_f19))
...
(assert (or (not r_f9) r_p8 r_f10))


;%~r_p8 | r_f9_p
(declare-fun r_f9_p () Bool)
(assert (or (not r_p8) r_f9_p))
...
(assert (or (not r_f16) r_p9 r_p10))
...
(assert (or (not r_f22) r_p6 r_p12))
...
(assert (or (not r_f18) r_p8 r_f19))
