%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (p3 | (p4 | ~p0)))) & (p6 | (p1 | (~p7 | (~p1 | ~p5))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom20,axiom,(~acc_f7 | acc_p1 | acc_p5)) .
cnf(r_axiom21,axiom,(~acc_p1 | acc_f7_p)) .
cnf(r_axiom22,axiom,(~acc_p5 | acc_f7_p)) .
cnf(r_axiom23,axiom,(~acc_f6 | acc_p7 | acc_f7)) .
cnf(r_axiom24,axiom,(~acc_p7 | acc_f6_p)) .
...
cnf(r_axiom29,axiom,(~acc_f4 | acc_p6 | acc_f5)) .
cnf(r_axiom30,axiom,(~acc_p6 | acc_f4_p)) .
