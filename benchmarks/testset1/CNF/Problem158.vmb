%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | p0) & ((p1 | ~p2) & ((p2 | ~p3) & ((~p5 | p4) & (~p0 | ~p6))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom19,axiom,(~acc_f7 | acc_p0 | acc_p6)) .
cnf(r_axiom20,axiom,(~acc_p0 | acc_f7_p)) .
