%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p5 | (p6 | (p3 | p4))) & ((p8 | (p2 | (p2 | p7))) & ((p10 | (p6 | (p3 | p9))) & (p2 | (p12 | (p6 | p11))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom34,axiom,(~f12 | p10 | f13)) .
cnf(l_axiom35,axiom,(~p10 | f12_p)) .
cnf(l_axiom36,axiom,(~f13_p | f12_p)) .
cnf(l_axiom37,axiom,(~f17 | p6 | p11)) .
cnf(l_axiom38,axiom,(~p6 | f17_p)) .
cnf(l_axiom39,axiom,(~p11 | f17_p)) .
cnf(l_axiom40,axiom,(~f16 | p12 | f17)) .
cnf(l_axiom41,axiom,(~p12 | f16_p)) .
...
cnf(r_axiom22,axiom,(~acc_f6 | acc_p3 | acc_p4)) .
cnf(r_axiom23,axiom,(~acc_p3 | acc_f6_p)) .
cnf(r_axiom24,axiom,(~acc_p4 | acc_f6_p)) .
cnf(r_axiom25,axiom,(~acc_f5 | acc_p6 | acc_f6)) .
cnf(r_axiom26,axiom,(~acc_p6 | acc_f5_p)) .
...
cnf(r_axiom31,axiom,(~acc_f10 | acc_p2 | acc_p7)) .
cnf(r_axiom32,axiom,(~acc_p2 | acc_f10_p)) .
cnf(r_axiom33,axiom,(~acc_p7 | acc_f10_p)) .
cnf(r_axiom34,axiom,(~acc_f9 | acc_p2 | acc_f10)) .
cnf(r_axiom35,axiom,(~acc_p2 | acc_f9_p)) .
cnf(r_axiom36,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom37,axiom,(~acc_f8 | acc_p8 | acc_f9)) .
cnf(r_axiom38,axiom,(~acc_p8 | acc_f8_p)) .
cnf(r_axiom39,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom40,axiom,(~acc_f14 | acc_p3 | acc_p9)) .
cnf(r_axiom41,axiom,(~acc_p3 | acc_f14_p)) .
cnf(r_axiom42,axiom,(~acc_p9 | acc_f14_p)) .
cnf(r_axiom43,axiom,(~acc_f13 | acc_p6 | acc_f14)) .
cnf(r_axiom44,axiom,(~acc_p6 | acc_f13_p)) .
cnf(r_axiom45,axiom,(~acc_f14_p | acc_f13_p)) .
cnf(r_axiom46,axiom,(~acc_f12 | acc_p10 | acc_f13)) .
cnf(r_axiom47,axiom,(~acc_p10 | acc_f12_p)) .
cnf(r_axiom48,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom49,axiom,(~acc_f17 | acc_p6 | acc_p11)) .
cnf(r_axiom50,axiom,(~acc_p6 | acc_f17_p)) .
cnf(r_axiom51,axiom,(~acc_p11 | acc_f17_p)) .
cnf(r_axiom52,axiom,(~acc_f16 | acc_p12 | acc_f17)) .
cnf(r_axiom53,axiom,(~acc_p12 | acc_f16_p)) .
