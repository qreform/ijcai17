%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | ~p0))) & ((~p0 | (~p2 | (~p2 | p4))) & (~p0 | (~p6 | (~p4 | p5))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom19,axiom,(~f9 | p4 | p5)) .
cnf(l_axiom20,axiom,(~p4 | f9_p)) .
cnf(l_axiom21,axiom,(~p5 | f9_p)) .
cnf(l_axiom22,axiom,(~f8 | p6 | f9)) .
...
cnf(r_axiom16,axiom,(~acc_f6 | acc_p2 | acc_p4)) .
...
cnf(r_axiom22,axiom,(~acc_f4 | acc_p0 | acc_f5)) .
cnf(r_axiom23,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom24,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom25,axiom,(~acc_f9 | acc_p4 | acc_p5)) .
cnf(r_axiom26,axiom,(~acc_p4 | acc_f9_p)) .
cnf(r_axiom27,axiom,(~acc_p5 | acc_f9_p)) .
cnf(r_axiom28,axiom,(~acc_f8 | acc_p6 | acc_f9)) .
cnf(r_axiom29,axiom,(~acc_p6 | acc_f8_p)) .
