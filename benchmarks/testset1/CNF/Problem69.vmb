%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | ~p0)) & ((p2 | (~p0 | ~p3)) & (~p3 | (p5 | ~p4)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~f6 | p5 | p4)) .
cnf(l_axiom14,axiom,(~p5 | f6_p)) .
cnf(l_axiom15,axiom,(~p4 | f6_p)) .
cnf(l_axiom16,axiom,(~f5 | p3 | f6)) .
cnf(l_axiom17,axiom,(~p3 | f5_p)) .
