...
;%~f27 | p8 | p10
(assert (or (not l_f27) l_p8 l_p10))
...
;%~f26 | p12 | f27
(assert (or (not l_f26) l_p12 l_f27))
...
;%~f25 | p11 | f26
(assert (or (not l_f25) l_p11 l_f26))
...
(assert (or (not r_f27) r_p8 r_p10))
...
(assert (or (not r_f26) r_p12 r_f27))
...
(assert (or (not r_f25) r_p11 r_f26))


;%~r_p11 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p11) r_f25_p))
