...
;%~f23 | p3 | p10
(assert (or (not l_f23) l_p3 l_p10))
...
;%~f20 | p8 | f21
(assert (or (not l_f20) l_p8 l_f21))
...
;%~f27 | p4 | p12
(assert (or (not l_f27) l_p4 l_p12))
...
;%~f26 | p6 | f27
(assert (or (not l_f26) l_p6 l_f27))
...
;%~f25 | p1 | f26
(assert (or (not l_f25) l_p1 l_f26))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p1 | f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p1 | f25_p
(assert (or (not l_p1) l_f25_p))
...
;%~f24 | p4 | f25
(assert (or (not l_f24) l_p4 l_f25))
...
(assert (or (not r_f23) r_p3 r_p10))
...
(assert (or (not r_f20) r_p8 r_f21))


;%~r_p8 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p8) r_f20_p))
...
(assert (or (not r_f27) r_p4 r_p12))
...
;%~r_p12 | r_f27_p
(assert (or (not r_p12) r_f27_p))


;%~r_f26 | r_p6 | r_f27
(declare-fun r_f26 () Bool)
(assert (or (not r_f26) r_p6 r_f27))


;%~r_p6 | r_f26_p
(declare-fun r_f26_p () Bool)
(assert (or (not r_p6) r_f26_p))
...
(assert (or (not r_f25) r_p1 r_f26))


;%~r_p1 | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p1) r_f25_p))
...
(assert (or (not r_f24) r_p4 r_f25))


;%~r_p4 | r_f24_p
(declare-fun r_f24_p () Bool)
(assert (or (not r_p4) r_f24_p))
