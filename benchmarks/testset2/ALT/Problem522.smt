...
;%~p9 | ~p11 | zcl_0
(assert (or (not l_p9) (not l_p11) l_zcl_0))
...
;%~p9 | ~p11 | f3_p
(assert (or (not l_p9) (not l_p11) l_f3_p))
...
;%~p13 | ~f2 | zcl_2
(assert (or (not l_p13) (not l_f2) l_zcl_2))
...
;%~p13 | ~f2_p | f1_p
(assert (or (not l_p13) (not l_f2_p) l_f1_p))
...
;%~p3 | ~p6 | zcl_4
(assert (or (not l_p3) (not l_p6) l_zcl_4))
...
;%~p3 | ~p6 | f13_p
(assert (or (not l_p3) (not l_p6) l_f13_p))
...
;%~p7 | ~f13 | zcl_5
(assert (or (not l_p7) (not l_f13) l_zcl_5))
...
;%~p5 | ~f11 | zcl_7
(assert (or (not l_p5) (not l_f11) l_zcl_7))
...
;%~r_p9 | ~r_p11 | r_zcl_0
(assert (or (not r_p9) (not r_p11) r_zcl_0))
...
(assert (or (not r_p9) (not r_p11) r_f3_p))
...
;%~r_p13 | ~r_f2 | r_zcl_2
(assert (or (not r_p13) (not r_f2) r_zcl_2))
...
(assert (or (not r_p13) (not r_f2_p) r_f1_p))
...
;%~r_p3 | ~r_p6 | r_zcl_4
(assert (or (not r_p3) (not r_p6) r_zcl_4))
...
(assert (or (not r_p3) (not r_p6) r_f13_p))
...
;%~r_p7 | ~r_f13 | r_zcl_5
(assert (or (not r_p7) (not r_f13) r_zcl_5))
...
;%~r_p5 | ~r_f11 | r_zcl_7
(assert (or (not r_p5) (not r_f11) r_zcl_7))
