...
;%~p5 | ~f1 | zcl_3
(assert (or (not l_p5) (not l_f1) l_zcl_3))
...
;%~p7 | ~f11 | zcl_7
(assert (or (not l_p7) (not l_f11) l_zcl_7))
...
;%~r_p5 | ~r_f1 | r_zcl_3
(assert (or (not r_p5) (not r_f1) r_zcl_3))
...
(assert (or (not r_f6) r_p9 r_f7))


;%~r_p9 | r_f6_p
(declare-fun r_f6_p () Bool)
(assert (or (not r_p9) r_f6_p))
...
;%~r_p7 | ~r_f11 | r_zcl_7
(assert (or (not r_p7) (not r_f11) r_zcl_7))
