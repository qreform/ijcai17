%%%%%%%%%%%%%%%% Target reformulation: ((p9 | (p6 | (~p4 | ~p8))) & ((~p2 & (~p7 & (~p4 & ~p6))) | ((~p2 | (p2 | (~p5 | p4))) & (~p1 | (~p2 | (~p3 | ~p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom15,axiom,(~zcl_11 | p7)) .
cnf(l_axiom16,axiom,(~zcl_11 | f6)) .
cnf(l_axiom17,axiom,(~p7 | ~f6 | zcl_11)) .
cnf(l_axiom18,axiom,(~f5 | zcl_11)) .
cnf(l_axiom19,axiom,(~p7 | ~f6_p | f5_p)) .
cnf(l_axiom20,axiom,(~zcl_12 | p2)) .
cnf(l_axiom21,axiom,(~zcl_12 | f5)) .
cnf(l_axiom22,axiom,(~p2 | ~f5 | zcl_12)) .
cnf(l_axiom23,axiom,(~f4 | zcl_12)) .
cnf(l_axiom24,axiom,(~p2 | ~f5_p | f4_p)) .
...
cnf(r_axiom19,axiom,(~acc_zcl_10 | acc_p4)) .
cnf(r_axiom20,axiom,(~acc_zcl_10 | acc_p6)) .
cnf(r_axiom21,axiom,(~acc_p4 | ~acc_p6 | acc_zcl_10)) .
cnf(r_axiom22,axiom,(~acc_f6 | acc_zcl_10)) .
cnf(r_axiom23,axiom,(~acc_p4 | ~acc_p6 | acc_f6_p)) .
cnf(r_axiom24,axiom,(~acc_zcl_11 | acc_p7)) .
cnf(r_axiom25,axiom,(~acc_zcl_11 | acc_f6)) .
cnf(r_axiom26,axiom,(~acc_p7 | ~acc_f6 | acc_zcl_11)) .
cnf(r_axiom27,axiom,(~acc_f5 | acc_zcl_11)) .
cnf(r_axiom28,axiom,(~acc_p7 | ~acc_f6_p | acc_f5_p)) .
cnf(r_axiom29,axiom,(~acc_zcl_12 | acc_p2)) .
cnf(r_axiom30,axiom,(~acc_zcl_12 | acc_f5)) .
cnf(r_axiom31,axiom,(~acc_p2 | ~acc_f5 | acc_zcl_12)) .
cnf(r_axiom32,axiom,(~acc_f4 | acc_zcl_12)) .
cnf(r_axiom33,axiom,(~acc_p2 | ~acc_f5_p | acc_f4_p)) .
cnf(r_axiom34,axiom,(~acc_f10 | acc_p5 | acc_p4)) .
...
cnf(r_axiom40,axiom,(~acc_f8 | acc_p2 | acc_f9)) .
cnf(r_axiom41,axiom,(~acc_p2 | acc_f8_p)) .
