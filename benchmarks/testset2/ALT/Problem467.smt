...
;%~p3 | ~p4 | zcl_0
(assert (or (not l_p3) (not l_p4) l_zcl_0))
...
;%~p3 | ~p4 | f4_p
(assert (or (not l_p3) (not l_p4) l_f4_p))
...
;%~r_p3 | ~r_p4 | r_zcl_0
(assert (or (not r_p3) (not r_p4) r_zcl_0))
...
(assert (or (not r_p3) (not r_p4) r_f4_p))
