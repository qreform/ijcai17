%%%%%%%%%%%%%%%% Target reformulation: ((p3 & ~p6) | ((p3 | ~p5) & ((p0 & ~p4) | ((p3 | p2) & (~p1 | ~p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom11,axiom,(~p0 | ~p4 | zcl_9)) .
...
cnf(r_axiom17,axiom,(~acc_p0 | ~acc_p4 | acc_zcl_9)) .
cnf(r_axiom18,axiom,(~acc_f4 | acc_zcl_9)) .
cnf(r_axiom19,axiom,(~acc_p0 | ~acc_p4 | acc_f4_p)) .
