%%%%%%%%%%%%%%%% Target reformulation: ((p0 | (p0 | (p0 | (p0 | p10)))) & ((p0 & (p0 & (p9 & (p7 & p8)))) | ((p7 | (p0 | (p0 | (p0 | p6)))) & ((p0 & (p0 & (p0 & (p0 & p5)))) | (p1 & (p2 & (p3 & (p4 & p0)))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom14,axiom,(~zcl_28 | p8)) .
cnf(l_axiom15,axiom,(~p7 | ~p8 | zcl_28)) .
cnf(l_axiom16,axiom,(~f8 | zcl_28)) .
cnf(l_axiom17,axiom,(~p7 | ~p8 | f8_p)) .
...
cnf(r_axiom11,axiom,(~acc_f3 | acc_p0 | acc_p10)) .
cnf(r_axiom12,axiom,(~acc_p0 | acc_f3_p)) .
cnf(r_axiom13,axiom,(~acc_p10 | acc_f3_p)) .
cnf(r_axiom14,axiom,(~acc_f2 | acc_p0 | acc_f3)) .
...
cnf(r_axiom20,axiom,(~acc_f0 | acc_p0 | acc_f1)) .
cnf(r_axiom21,axiom,(~acc_p0 | acc_f0_p)) .
cnf(r_axiom22,axiom,(~acc_f1_p | acc_f0_p)) .
cnf(r_axiom23,axiom,(~acc_zcl_28 | acc_p7)) .
cnf(r_axiom24,axiom,(~acc_zcl_28 | acc_p8)) .
cnf(r_axiom25,axiom,(~acc_p7 | ~acc_p8 | acc_zcl_28)) .
cnf(r_axiom26,axiom,(~acc_f8 | acc_zcl_28)) .
cnf(r_axiom27,axiom,(~acc_p7 | ~acc_p8 | acc_f8_p)) .
cnf(r_axiom28,axiom,(~acc_zcl_29 | acc_p9)) .
cnf(r_axiom29,axiom,(~acc_zcl_29 | acc_f8)) .
cnf(r_axiom30,axiom,(~acc_p9 | ~acc_f8 | acc_zcl_29)) .
cnf(r_axiom31,axiom,(~acc_f7 | acc_zcl_29)) .
cnf(r_axiom32,axiom,(~acc_p9 | ~acc_f8_p | acc_f7_p)) .
cnf(r_axiom33,axiom,(~acc_zcl_30 | acc_p0)) .
cnf(r_axiom34,axiom,(~acc_zcl_30 | acc_f7)) .
cnf(r_axiom35,axiom,(~acc_p0 | ~acc_f7 | acc_zcl_30)) .
cnf(r_axiom36,axiom,(~acc_f6 | acc_zcl_30)) .
cnf(r_axiom37,axiom,(~acc_p0 | ~acc_f7_p | acc_f6_p)) .
cnf(r_axiom38,axiom,(~acc_zcl_31 | acc_p0)) .
cnf(r_axiom39,axiom,(~acc_zcl_31 | acc_f6)) .
cnf(r_axiom40,axiom,(~acc_p0 | ~acc_f6 | acc_zcl_31)) .
cnf(r_axiom41,axiom,(~acc_f5 | acc_zcl_31)) .
cnf(r_axiom42,axiom,(~acc_p0 | ~acc_f6_p | acc_f5_p)) .
cnf(r_axiom43,axiom,(~acc_f13 | acc_p0 | acc_p6)) .
cnf(r_axiom44,axiom,(~acc_p0 | acc_f13_p)) .
cnf(r_axiom45,axiom,(~acc_p6 | acc_f13_p)) .
cnf(r_axiom46,axiom,(~acc_f12 | acc_p0 | acc_f13)) .
cnf(r_axiom47,axiom,(~acc_p0 | acc_f12_p)) .
cnf(r_axiom48,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom49,axiom,(~acc_f11 | acc_p0 | acc_f12)) .
cnf(r_axiom50,axiom,(~acc_p0 | acc_f11_p)) .
