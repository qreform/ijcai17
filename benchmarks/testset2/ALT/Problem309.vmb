%%%%%%%%%%%%%%%% Target reformulation: ((~p0 | (~p3 | p5)) & ((~p4 & (~p0 & p3)) | (p1 & (~p2 & ~p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~f1 | p3 | p5)) .
cnf(l_axiom2,axiom,(~p3 | f1_p)) .
cnf(l_axiom3,axiom,(~p5 | f1_p)) .
...
cnf(l_axiom14,axiom,(~p4 | ~f4 | zcl_11)) .
...
cnf(r_axiom6,axiom,(~acc_f1 | acc_p3 | acc_p5)) .
cnf(r_axiom7,axiom,(~acc_p3 | acc_f1_p)) .
cnf(r_axiom8,axiom,(~acc_p5 | acc_f1_p)) .
cnf(r_axiom9,axiom,(~acc_f0 | acc_p0 | acc_f1)) .
...
cnf(r_axiom17,axiom,(~acc_zcl_11 | acc_p4)) .
cnf(r_axiom18,axiom,(~acc_zcl_11 | acc_f4)) .
cnf(r_axiom19,axiom,(~acc_p4 | ~acc_f4 | acc_zcl_11)) .
