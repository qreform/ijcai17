...
cnf(r_axiom9,axiom,(~acc_zcl_6 | acc_p4)) .
cnf(r_axiom10,axiom,(~acc_zcl_6 | acc_p3)) .
cnf(r_axiom11,axiom,(~acc_p4 | ~acc_p3 | acc_zcl_6)) .
cnf(r_axiom12,axiom,(~acc_f2 | acc_zcl_6)) .
cnf(r_axiom13,axiom,(~acc_p4 | ~acc_p3 | acc_f2_p)) .
cnf(r_axiom14,axiom,(~acc_f4 | acc_p0 | acc_p2)) .
cnf(r_axiom15,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom16,axiom,(~acc_p2 | acc_f4_p)) .
cnf(r_axiom17,axiom,(~acc_f5 | acc_p1 | acc_p0)) .
cnf(r_axiom18,axiom,(~acc_p1 | acc_f5_p)) .
cnf(r_axiom19,axiom,(~acc_p0 | acc_f5_p)) .
cnf(r_axiom20,axiom,(~acc_zcl_7 | acc_f4)) .
cnf(r_axiom21,axiom,(~acc_zcl_7 | acc_f5)) .
cnf(r_axiom22,axiom,(~acc_f4 | ~acc_f5 | acc_zcl_7)) .
cnf(r_axiom23,axiom,(~acc_f3 | acc_zcl_7)) .
cnf(r_axiom24,axiom,(~acc_f4_p | ~acc_f5_p | acc_f3_p)) .
cnf(r_axiom25,axiom,(~acc_f1 | acc_f2 | acc_f3)) .
cnf(r_axiom26,axiom,(~acc_f2_p | acc_f1_p)) .
cnf(r_axiom27,axiom,(~acc_f3_p | acc_f1_p)) .
