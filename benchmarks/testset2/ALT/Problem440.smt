...
;%~p14 | ~p10 | f3_p
(assert (or (not l_p14) (not l_p10) l_f3_p))
...
;%~p13 | ~f3 | zcl_1
(assert (or (not l_p13) (not l_f3) l_zcl_1))
...
;%~p12 | ~f2 | zcl_2
(assert (or (not l_p12) (not l_f2) l_zcl_2))
...
;%~p11 | ~f1 | zcl_3
(assert (or (not l_p11) (not l_f1) l_zcl_3))
...
(assert (or (not r_p14) (not r_p10) r_f3_p))
...
;%~r_p13 | ~r_f3 | r_zcl_1
(assert (or (not r_p13) (not r_f3) r_zcl_1))
...
;%~r_p12 | ~r_f2 | r_zcl_2
(assert (or (not r_p12) (not r_f2) r_zcl_2))
...
;%~r_p11 | ~r_f1 | r_zcl_3
(assert (or (not r_p11) (not r_f1) r_zcl_3))
