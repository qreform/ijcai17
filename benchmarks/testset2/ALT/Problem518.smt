...
;%~p10 | ~p9 | zcl_0
(assert (or (not l_p10) (not l_p9) l_zcl_0))
...
;%~p10 | ~p9 | f2_p
(assert (or (not l_p10) (not l_p9) l_f2_p))
...
;%~p5 | ~f2 | zcl_1
(assert (or (not l_p5) (not l_f2) l_zcl_1))
...
;%~p0 | ~f1 | zcl_2
(assert (or (not l_p0) (not l_f1) l_zcl_2))
...
;%~p7 | ~p5 | zcl_3
(assert (or (not l_p7) (not l_p5) l_zcl_3))
...
;%~p6 | ~f9 | zcl_5
(assert (or (not l_p6) (not l_f9) l_zcl_5))
...
;%~r_p10 | ~r_p9 | r_zcl_0
(assert (or (not r_p10) (not r_p9) r_zcl_0))
...
(assert (or (not r_p10) (not r_p9) r_f2_p))
...
;%~r_p5 | ~r_f2 | r_zcl_1
(assert (or (not r_p5) (not r_f2) r_zcl_1))
...
;%~r_p0 | ~r_f1 | r_zcl_2
(assert (or (not r_p0) (not r_f1) r_zcl_2))
...
;%~r_p7 | ~r_p5 | r_zcl_3
(assert (or (not r_p7) (not r_p5) r_zcl_3))
...
;%~r_p6 | ~r_f9 | r_zcl_5
(assert (or (not r_p6) (not r_f9) r_zcl_5))
