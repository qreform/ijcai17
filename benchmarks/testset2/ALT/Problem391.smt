...
;%~p7 | ~p9 | f6_p
(assert (or (not l_p7) (not l_p9) l_f6_p))
...
;%~p4 | ~f5 | zcl_2
(assert (or (not l_p4) (not l_f5) l_zcl_2))
...
;%~p4 | ~f5_p | f4_p
(assert (or (not l_p4) (not l_f5_p) l_f4_p))
...
;%~p6 | ~p4 | f14_p
(assert (or (not l_p6) (not l_p4) l_f14_p))
...
(assert (or (not r_p7) (not r_p9) r_f6_p))
...
;%~r_p4 | ~r_f5 | r_zcl_2
(assert (or (not r_p4) (not r_f5) r_zcl_2))
...
(assert (or (not r_p4) (not r_f5_p) r_f4_p))
...
(assert (or (not r_p6) (not r_p4) r_f14_p))
