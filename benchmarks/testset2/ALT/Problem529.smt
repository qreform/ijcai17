...
;%~p6 | ~p11 | f3_p
(assert (or (not l_p6) (not l_p11) l_f3_p))
...
;%~p6 | ~f3 | zcl_1
(assert (or (not l_p6) (not l_f3) l_zcl_1))
...
;%~p6 | ~f3_p | f2_p
(assert (or (not l_p6) (not l_f3_p) l_f2_p))
...
;%~p6 | ~f2 | zcl_2
(assert (or (not l_p6) (not l_f2) l_zcl_2))
...
;%~p6 | ~f2_p | f1_p
(assert (or (not l_p6) (not l_f2_p) l_f1_p))
...
;%~p10 | ~f1 | zcl_3
(assert (or (not l_p10) (not l_f1) l_zcl_3))
...
;%~p10 | ~f1_p | f0_p
(assert (or (not l_p10) (not l_f1_p) l_f0_p))
...
;%~f5 | p10 | f6
(assert (or (not l_f5) l_p10 l_f6))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((~p10 | f6_p) --> f5_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f5_p () Bool)
;%~p10 | f5_p
(assert (or (not l_p10) l_f5_p))
...
;%~p4 | ~p8 | zcl_4
(assert (or (not l_p4) (not l_p8) l_zcl_4))
...
;%~p4 | ~p8 | f13_p
(assert (or (not l_p4) (not l_p8) l_f13_p))
...
;%~p2 | ~f13 | zcl_5
(assert (or (not l_p2) (not l_f13) l_zcl_5))
...
;%~p5 | ~f12 | zcl_6
(assert (or (not l_p5) (not l_f12) l_zcl_6))
...
;%~p6 | ~f11 | zcl_7
(assert (or (not l_p6) (not l_f11) l_zcl_7))
...
;%~p6 | ~f11_p | f10_p
(assert (or (not l_p6) (not l_f11_p) l_f10_p))
...
;%~f15 | p3 | f16
(assert (or (not l_f15) l_p3 l_f16))
...
;%~f20 | p2 | f21
(assert (or (not l_f20) l_p2 l_f21))
...
;%~f19 | p1 | f20
(assert (or (not l_f19) l_p1 l_f20))
...
;%~zcl_8 | f15
(assert (or (not l_zcl_8) l_f15))

;%~zcl_8 | f19
(assert (or (not l_zcl_8) l_f19))

;%~f15 | ~f19 | zcl_8
(assert (or (not l_f15) (not l_f19) l_zcl_8))

(declare-fun l_f14 () Bool)
;%~f14 | zcl_8
(assert (or (not l_f14) l_zcl_8))
...
;%~zcl_9 | f5
(assert (or (not l_zcl_9) l_f5))

;%~zcl_9 | f9
(assert (or (not l_zcl_9) l_f9))

;%~f5 | ~f9 | zcl_9
(assert (or (not l_f5) (not l_f9) l_zcl_9))

(declare-fun l_f4 () Bool)
;%~f4 | zcl_9
(assert (or (not l_f4) l_zcl_9))
...
(assert (or (not r_p6) (not r_p11) r_f3_p))
...
;%~r_p6 | ~r_f3 | r_zcl_1
(assert (or (not r_p6) (not r_f3) r_zcl_1))
...
(assert (or (not r_p6) (not r_f3_p) r_f2_p))
...
;%~r_p6 | ~r_f2 | r_zcl_2
(assert (or (not r_p6) (not r_f2) r_zcl_2))
...
(assert (or (not r_p6) (not r_f2_p) r_f1_p))
...
;%~r_p10 | ~r_f1 | r_zcl_3
(assert (or (not r_p10) (not r_f1) r_zcl_3))
...
(assert (or (not r_p10) (not r_f1_p) r_f0_p))


;%~r_f8 | r_p1 | r_p9
(declare-fun r_f8 () Bool)
(assert (or (not r_f8) r_p1 r_p9))
...
(assert (or (not r_f7) r_p2 r_f8))


;%~r_p2 | r_f7_p
(declare-fun r_f7_p () Bool)
(assert (or (not r_p2) r_f7_p))
...
(assert (or (not r_f5) r_p10 r_f6))


;%~r_p10 | r_f5_p
(declare-fun r_f5_p () Bool)
(assert (or (not r_p10) r_f5_p))
...
;%~r_p4 | ~r_p8 | r_zcl_4
(assert (or (not r_p4) (not r_p8) r_zcl_4))
...
(assert (or (not r_p4) (not r_p8) r_f13_p))
...
;%~r_p2 | ~r_f13 | r_zcl_5
(assert (or (not r_p2) (not r_f13) r_zcl_5))
...
;%~r_p5 | ~r_f12 | r_zcl_6
(assert (or (not r_p5) (not r_f12) r_zcl_6))
...
;%~r_p6 | ~r_f11 | r_zcl_7
(assert (or (not r_p6) (not r_f11) r_zcl_7))
...
;%~r_p6 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p6) (not r_f11_p) r_f10_p))


;%~r_f18 | r_p7 | r_p5
(declare-fun r_f18 () Bool)
(assert (or (not r_f18) r_p7 r_p5))
...
(assert (or (not r_f15) r_p3 r_f16))


;%~r_p3 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p3) r_f15_p))
...
(assert (or (not r_f22) r_p4 r_p0))


;%~r_p4 | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p4) r_f22_p))
...
(assert (or (not r_f20) r_p2 r_f21))


;%~r_p2 | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p2) r_f20_p))
...
(assert (or (not r_f19) r_p1 r_f20))


;%~r_p1 | r_f19_p
(declare-fun r_f19_p () Bool)
(assert (or (not r_p1) r_f19_p))
...
(assert (or (not r_zcl_8) r_f15))


;%~r_zcl_8 | r_f19
(assert (or (not r_zcl_8) r_f19))


;%~r_f15 | ~r_f19 | r_zcl_8
(assert (or (not r_f15) (not r_f19) r_zcl_8))


;%~r_f14 | r_zcl_8
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_zcl_8))
...
(assert (or (not r_zcl_9) r_f5))


;%~r_zcl_9 | r_f9
(assert (or (not r_zcl_9) r_f9))


;%~r_f5 | ~r_f9 | r_zcl_9
(assert (or (not r_f5) (not r_f9) r_zcl_9))


;%~r_f4 | r_zcl_9
(declare-fun r_f4 () Bool)
(assert (or (not r_f4) r_zcl_9))
