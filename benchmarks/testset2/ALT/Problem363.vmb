%%%%%%%%%%%%%%%% Target reformulation: ((p0 & (p7 & (p0 & (p0 & p8)))) | ((p0 | (p7 | (p0 | (p0 | p6)))) & ((p0 & (p0 & (p0 & (p0 & p5)))) | (p1 & (p2 & (p3 & (p4 & p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom11,axiom,(~zcl_28 | p7)) .
cnf(l_axiom12,axiom,(~zcl_28 | f2)) .
cnf(l_axiom13,axiom,(~p7 | ~f2 | zcl_28)) .
...
cnf(r_axiom14,axiom,(~acc_zcl_27 | acc_p0)) .
cnf(r_axiom15,axiom,(~acc_zcl_27 | acc_f3)) .
cnf(r_axiom16,axiom,(~acc_p0 | ~acc_f3 | acc_zcl_27)) .
cnf(r_axiom17,axiom,(~acc_f2 | acc_zcl_27)) .
cnf(r_axiom18,axiom,(~acc_p0 | ~acc_f3_p | acc_f2_p)) .
cnf(r_axiom19,axiom,(~acc_zcl_28 | acc_p7)) .
cnf(r_axiom20,axiom,(~acc_zcl_28 | acc_f2)) .
cnf(r_axiom21,axiom,(~acc_p7 | ~acc_f2 | acc_zcl_28)) .
cnf(r_axiom22,axiom,(~acc_f1 | acc_zcl_28)) .
cnf(r_axiom23,axiom,(~acc_p7 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom24,axiom,(~acc_zcl_29 | acc_p0)) .
cnf(r_axiom25,axiom,(~acc_zcl_29 | acc_f1)) .
cnf(r_axiom26,axiom,(~acc_p0 | ~acc_f1 | acc_zcl_29)) .
cnf(r_axiom27,axiom,(~acc_f0 | acc_zcl_29)) .
cnf(r_axiom28,axiom,(~acc_p0 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom29,axiom,(~acc_f8 | acc_p0 | acc_p6)) .
cnf(r_axiom30,axiom,(~acc_p0 | acc_f8_p)) .
cnf(r_axiom31,axiom,(~acc_p6 | acc_f8_p)) .
cnf(r_axiom32,axiom,(~acc_f7 | acc_p0 | acc_f8)) .
cnf(r_axiom33,axiom,(~acc_p0 | acc_f7_p)) .
cnf(r_axiom34,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom35,axiom,(~acc_f6 | acc_p7 | acc_f7)) .
cnf(r_axiom36,axiom,(~acc_p7 | acc_f6_p)) .
...
cnf(r_axiom48,axiom,(~acc_p0 | ~acc_f13 | acc_zcl_31)) .
