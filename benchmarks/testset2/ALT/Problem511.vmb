%%%%%%%%%%%%%%%% Target reformulation: ((p3 & (p3 & (p9 & p8))) | ((p2 | (p2 | (p3 | p7))) & ((p6 & (p3 & (p2 & p5))) | ((p3 | (p2 | (p2 | p4))) & (p1 | (p2 | (p3 | p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p9 | ~p8 | zcl_16)) .
cnf(l_axiom4,axiom,(~f2 | zcl_16)) .
cnf(l_axiom5,axiom,(~p9 | ~p8 | f2_p)) .
cnf(l_axiom6,axiom,(~zcl_17 | p3)) .
cnf(l_axiom7,axiom,(~zcl_17 | f2)) .
cnf(l_axiom8,axiom,(~p3 | ~f2 | zcl_17)) .
...
cnf(l_axiom30,axiom,(~zcl_20 | p3)) .
cnf(l_axiom31,axiom,(~zcl_20 | f10)) .
cnf(l_axiom32,axiom,(~p3 | ~f10 | zcl_20)) .
cnf(l_axiom33,axiom,(~f9 | zcl_20)) .
cnf(l_axiom34,axiom,(~p3 | ~f10_p | f9_p)) .
...
cnf(l_axiom40,axiom,(~f14 | p2 | p4)) .
cnf(l_axiom41,axiom,(~p2 | f14_p)) .
cnf(l_axiom42,axiom,(~p4 | f14_p)) .
cnf(l_axiom43,axiom,(~f13 | p2 | f14)) .
cnf(l_axiom44,axiom,(~p2 | f13_p)) .
...
cnf(r_axiom10,axiom,(~acc_zcl_16 | acc_p9)) .
cnf(r_axiom11,axiom,(~acc_zcl_16 | acc_p8)) .
cnf(r_axiom12,axiom,(~acc_p9 | ~acc_p8 | acc_zcl_16)) .
cnf(r_axiom13,axiom,(~acc_f2 | acc_zcl_16)) .
cnf(r_axiom14,axiom,(~acc_p9 | ~acc_p8 | acc_f2_p)) .
cnf(r_axiom15,axiom,(~acc_zcl_17 | acc_p3)) .
cnf(r_axiom16,axiom,(~acc_zcl_17 | acc_f2)) .
cnf(r_axiom17,axiom,(~acc_p3 | ~acc_f2 | acc_zcl_17)) .
cnf(r_axiom18,axiom,(~acc_f1 | acc_zcl_17)) .
cnf(r_axiom19,axiom,(~acc_p3 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom20,axiom,(~acc_zcl_18 | acc_p3)) .
cnf(r_axiom21,axiom,(~acc_zcl_18 | acc_f1)) .
cnf(r_axiom22,axiom,(~acc_p3 | ~acc_f1 | acc_zcl_18)) .
cnf(r_axiom23,axiom,(~acc_f0 | acc_zcl_18)) .
cnf(r_axiom24,axiom,(~acc_p3 | ~acc_f1_p | acc_f0_p)) .
...
cnf(r_axiom31,axiom,(~acc_f4 | acc_p2 | acc_f5)) .
cnf(r_axiom32,axiom,(~acc_p2 | acc_f4_p)) .
cnf(r_axiom33,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom34,axiom,(~acc_zcl_19 | acc_p2)) .
cnf(r_axiom35,axiom,(~acc_zcl_19 | acc_p5)) .
cnf(r_axiom36,axiom,(~acc_p2 | ~acc_p5 | acc_zcl_19)) .
cnf(r_axiom37,axiom,(~acc_f10 | acc_zcl_19)) .
cnf(r_axiom38,axiom,(~acc_p2 | ~acc_p5 | acc_f10_p)) .
cnf(r_axiom39,axiom,(~acc_zcl_20 | acc_p3)) .
cnf(r_axiom40,axiom,(~acc_zcl_20 | acc_f10)) .
cnf(r_axiom41,axiom,(~acc_p3 | ~acc_f10 | acc_zcl_20)) .
cnf(r_axiom42,axiom,(~acc_f9 | acc_zcl_20)) .
cnf(r_axiom43,axiom,(~acc_p3 | ~acc_f10_p | acc_f9_p)) .
cnf(r_axiom44,axiom,(~acc_zcl_21 | acc_p6)) .
cnf(r_axiom45,axiom,(~acc_zcl_21 | acc_f9)) .
cnf(r_axiom46,axiom,(~acc_p6 | ~acc_f9 | acc_zcl_21)) .
cnf(r_axiom47,axiom,(~acc_f8 | acc_zcl_21)) .
cnf(r_axiom48,axiom,(~acc_p6 | ~acc_f9_p | acc_f8_p)) .
cnf(r_axiom49,axiom,(~acc_f14 | acc_p2 | acc_p4)) .
cnf(r_axiom50,axiom,(~acc_p2 | acc_f14_p)) .
cnf(r_axiom51,axiom,(~acc_p4 | acc_f14_p)) .
cnf(r_axiom52,axiom,(~acc_f13 | acc_p2 | acc_f14)) .
cnf(r_axiom53,axiom,(~acc_p2 | acc_f13_p)) .
cnf(r_axiom54,axiom,(~acc_f14_p | acc_f13_p)) .
cnf(r_axiom55,axiom,(~acc_f12 | acc_p3 | acc_f13)) .
cnf(r_axiom56,axiom,(~acc_p3 | acc_f12_p)) .
