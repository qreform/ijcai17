%%%%%%%%%%%%%%%% Target reformulation: ((p1 & p3) | ((p0 | p2) & (p1 | p0))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_4 | p1)) .
cnf(l_axiom2,axiom,(~zcl_4 | p3)) .
cnf(l_axiom3,axiom,(~p1 | ~p3 | zcl_4)) .
cnf(l_axiom4,axiom,(~f0 | zcl_4)) .
cnf(l_axiom5,axiom,(~p1 | ~p3 | f0_p)) .
...
cnf(r_axiom4,axiom,(~acc_zcl_4 | acc_p1)) .
cnf(r_axiom5,axiom,(~acc_zcl_4 | acc_p3)) .
cnf(r_axiom6,axiom,(~acc_p1 | ~acc_p3 | acc_zcl_4)) .
cnf(r_axiom7,axiom,(~acc_f0 | acc_zcl_4)) .
cnf(r_axiom8,axiom,(~acc_p1 | ~acc_p3 | acc_f0_p)) .
cnf(r_axiom9,axiom,(~acc_f2 | acc_p0 | acc_p2)) .
cnf(r_axiom10,axiom,(~acc_p0 | acc_f2_p)) .
cnf(r_axiom11,axiom,(~acc_p2 | acc_f2_p)) .
cnf(r_axiom12,axiom,(~acc_f3 | acc_p1 | acc_p0)) .
cnf(r_axiom13,axiom,(~acc_p1 | acc_f3_p)) .
cnf(r_axiom14,axiom,(~acc_p0 | acc_f3_p)) .
cnf(r_axiom15,axiom,(~acc_zcl_5 | acc_f2)) .
cnf(r_axiom16,axiom,(~acc_zcl_5 | acc_f3)) .
cnf(r_axiom17,axiom,(~acc_f2 | ~acc_f3 | acc_zcl_5)) .
cnf(r_axiom18,axiom,(~acc_f1 | acc_zcl_5)) .
cnf(r_axiom19,axiom,(~acc_f2_p | ~acc_f3_p | acc_f1_p)) .
cnf(r_axiom20,axiom,(~acc_q | acc_f0 | acc_f1)) .
cnf(r_axiom21,axiom,(~acc_f0_p | acc_q)) .
cnf(r_axiom22,axiom,(~acc_f1_p | acc_q)) .
