...
;%~p10 | ~p7 | zcl_0
(assert (or (not l_p10) (not l_p7) l_zcl_0))
...
;%~p10 | ~p7 | f8_p
(assert (or (not l_p10) (not l_p7) l_f8_p))
...
;%~p8 | ~f7 | zcl_2
(assert (or (not l_p8) (not l_f7) l_zcl_2))
...
;%~p8 | ~f7_p | f6_p
(assert (or (not l_p8) (not l_f7_p) l_f6_p))
...
;%~p4 | ~f6 | zcl_3
(assert (or (not l_p4) (not l_f6) l_zcl_3))
...
(assert (or (not r_f3) r_p3 r_p11))


;%~r_p3 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p3) r_f3_p))
...
;%~r_p10 | ~r_p7 | r_zcl_0
(assert (or (not r_p10) (not r_p7) r_zcl_0))
...
(assert (or (not r_p10) (not r_p7) r_f8_p))
...
;%~r_p8 | ~r_f7 | r_zcl_2
(assert (or (not r_p8) (not r_f7) r_zcl_2))
...
(assert (or (not r_p8) (not r_f7_p) r_f6_p))
...
;%~r_p4 | ~r_f6 | r_zcl_3
(assert (or (not r_p4) (not r_f6) r_zcl_3))
