...
;%~p3 | ~p6 | zcl_0
(assert (or (not l_p3) (not l_p6) l_zcl_0))
...
;%~p3 | ~p6 | f8_p
(assert (or (not l_p3) (not l_p6) l_f8_p))
...
;%~p5 | ~f7 | zcl_2
(assert (or (not l_p5) (not l_f7) l_zcl_2))
...
;%~r_p3 | ~r_p6 | r_zcl_0
(assert (or (not r_p3) (not r_p6) r_zcl_0))
...
(assert (or (not r_p3) (not r_p6) r_f8_p))
...
;%~r_p5 | ~r_f7 | r_zcl_2
(assert (or (not r_p5) (not r_f7) r_zcl_2))
