...
;%~f3 | p10 | p12
(assert (or (not l_f3) l_p10 l_p12))
...
;%~p10 | ~f8 | zcl_1
(assert (or (not l_p10) (not l_f8) l_zcl_1))
...
;%~p10 | ~f8_p | f7_p
(assert (or (not l_p10) (not l_f8_p) l_f7_p))
...
;%~f13 | p10 | p7
(assert (or (not l_f13) l_p10 l_p7))
...
;%~f11 | p9 | f12
(assert (or (not l_f11) l_p9 l_f12))
...
;%~p0 | ~p5 | f18_p
(assert (or (not l_p0) (not l_p5) l_f18_p))
...
;%~p6 | ~f17 | zcl_6
(assert (or (not l_p6) (not l_f17) l_zcl_6))
...
(assert (or (not r_f3) r_p10 r_p12))
...
;%~r_p10 | ~r_f8 | r_zcl_1
(assert (or (not r_p10) (not r_f8) r_zcl_1))
...
(assert (or (not r_p10) (not r_f8_p) r_f7_p))
...
(assert (or (not r_f13) r_p10 r_p7))
...
(assert (or (not r_f11) r_p9 r_f12))


;%~r_p9 | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p9) r_f11_p))
...
(assert (or (not r_p0) (not r_p5) r_f18_p))
...
;%~r_p6 | ~r_f17 | r_zcl_6
(assert (or (not r_p6) (not r_f17) r_zcl_6))
