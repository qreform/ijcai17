%%%%%%%%%%%%%%%% Target reformulation: ((~p5 | (p0 | (~p0 | (p9 | ~p8)))) & ((~p6 & (~p7 & (p0 & (p0 & ~p5)))) | (~p1 & (~p2 & (~p3 & (~p4 & ~p0)))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom10,axiom,(~acc_f3 | acc_p9 | acc_p8)) .
...
cnf(r_axiom32,axiom,(~acc_zcl_20 | acc_p7)) .
cnf(r_axiom33,axiom,(~acc_zcl_20 | acc_f7)) .
cnf(r_axiom34,axiom,(~acc_p7 | ~acc_f7 | acc_zcl_20)) .
