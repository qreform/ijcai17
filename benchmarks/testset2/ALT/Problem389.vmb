%%%%%%%%%%%%%%%% Target reformulation: ((p0 | (p3 | ~p7)) & ((p5 & (p3 & p6)) | ((~p0 | (~p5 | ~p4)) & ((~p0 & (p0 & ~p3)) | (~p1 & (p2 & ~p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~f1 | p3 | p7)) .
cnf(l_axiom2,axiom,(~p3 | f1_p)) .
cnf(l_axiom3,axiom,(~p7 | f1_p)) .
cnf(l_axiom4,axiom,(~f0 | p0 | f1)) .
cnf(l_axiom5,axiom,(~p0 | f0_p)) .
cnf(l_axiom6,axiom,(~f1_p | f0_p)) .
cnf(l_axiom7,axiom,(~zcl_16 | p3)) .
cnf(l_axiom8,axiom,(~zcl_16 | p6)) .
cnf(l_axiom9,axiom,(~p3 | ~p6 | zcl_16)) .
cnf(l_axiom10,axiom,(~f4 | zcl_16)) .
cnf(l_axiom11,axiom,(~p3 | ~p6 | f4_p)) .
cnf(l_axiom12,axiom,(~zcl_17 | p5)) .
cnf(l_axiom13,axiom,(~zcl_17 | f4)) .
cnf(l_axiom14,axiom,(~p5 | ~f4 | zcl_17)) .
...
cnf(r_axiom8,axiom,(~acc_f1 | acc_p3 | acc_p7)) .
cnf(r_axiom9,axiom,(~acc_p3 | acc_f1_p)) .
cnf(r_axiom10,axiom,(~acc_p7 | acc_f1_p)) .
cnf(r_axiom11,axiom,(~acc_f0 | acc_p0 | acc_f1)) .
cnf(r_axiom12,axiom,(~acc_p0 | acc_f0_p)) .
cnf(r_axiom13,axiom,(~acc_f1_p | acc_f0_p)) .
cnf(r_axiom14,axiom,(~acc_zcl_16 | acc_p3)) .
cnf(r_axiom15,axiom,(~acc_zcl_16 | acc_p6)) .
cnf(r_axiom16,axiom,(~acc_p3 | ~acc_p6 | acc_zcl_16)) .
cnf(r_axiom17,axiom,(~acc_f4 | acc_zcl_16)) .
cnf(r_axiom18,axiom,(~acc_p3 | ~acc_p6 | acc_f4_p)) .
cnf(r_axiom19,axiom,(~acc_zcl_17 | acc_p5)) .
cnf(r_axiom20,axiom,(~acc_zcl_17 | acc_f4)) .
cnf(r_axiom21,axiom,(~acc_p5 | ~acc_f4 | acc_zcl_17)) .
cnf(r_axiom22,axiom,(~acc_f3 | acc_zcl_17)) .
cnf(r_axiom23,axiom,(~acc_p5 | ~acc_f4_p | acc_f3_p)) .
cnf(r_axiom24,axiom,(~acc_f7 | acc_p5 | acc_p4)) .
cnf(r_axiom25,axiom,(~acc_p5 | acc_f7_p)) .
