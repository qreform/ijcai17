%%%%%%%%%%%%%%%% Target reformulation: ((p2 & p5) | ((p0 | p4) & ((p3 & p2) | (p1 & p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p2 | ~p5 | zcl_8)) .
cnf(l_axiom4,axiom,(~f0 | zcl_8)) .
cnf(l_axiom5,axiom,(~p2 | ~p5 | f0_p)) .
cnf(l_axiom6,axiom,(~f2 | p0 | p4)) .
cnf(l_axiom7,axiom,(~p0 | f2_p)) .
cnf(l_axiom8,axiom,(~p4 | f2_p)) .
cnf(l_axiom9,axiom,(~zcl_9 | p3)) .
cnf(l_axiom10,axiom,(~zcl_9 | p2)) .
cnf(l_axiom11,axiom,(~p3 | ~p2 | zcl_9)) .
cnf(l_axiom12,axiom,(~f4 | zcl_9)) .
cnf(l_axiom13,axiom,(~p3 | ~p2 | f4_p)) .
cnf(l_axiom14,axiom,(~zcl_10 | p1)) .
cnf(l_axiom15,axiom,(~zcl_10 | p0)) .
cnf(l_axiom16,axiom,(~p1 | ~p0 | zcl_10)) .
cnf(l_axiom17,axiom,(~f5 | zcl_10)) .
cnf(l_axiom18,axiom,(~p1 | ~p0 | f5_p)) .
cnf(l_axiom19,axiom,(~f3 | f4 | f5)) .
cnf(l_axiom20,axiom,(~f4_p | f3_p)) .
cnf(l_axiom21,axiom,(~f5_p | f3_p)) .
cnf(l_axiom22,axiom,(~zcl_11 | f2)) .
cnf(l_axiom23,axiom,(~zcl_11 | f3)) .
cnf(l_axiom24,axiom,(~f2 | ~f3 | zcl_11)) .
cnf(l_axiom25,axiom,(~f1 | zcl_11)) .
cnf(l_axiom26,axiom,(~f2_p | ~f3_p | f1_p)) .
...
cnf(r_axiom6,axiom,(~acc_zcl_8 | acc_p2)) .
cnf(r_axiom7,axiom,(~acc_zcl_8 | acc_p5)) .
cnf(r_axiom8,axiom,(~acc_p2 | ~acc_p5 | acc_zcl_8)) .
cnf(r_axiom9,axiom,(~acc_f0 | acc_zcl_8)) .
cnf(r_axiom10,axiom,(~acc_p2 | ~acc_p5 | acc_f0_p)) .
cnf(r_axiom11,axiom,(~acc_f2 | acc_p0 | acc_p4)) .
cnf(r_axiom12,axiom,(~acc_p0 | acc_f2_p)) .
cnf(r_axiom13,axiom,(~acc_p4 | acc_f2_p)) .
cnf(r_axiom14,axiom,(~acc_zcl_9 | acc_p3)) .
cnf(r_axiom15,axiom,(~acc_zcl_9 | acc_p2)) .
cnf(r_axiom16,axiom,(~acc_p3 | ~acc_p2 | acc_zcl_9)) .
cnf(r_axiom17,axiom,(~acc_f4 | acc_zcl_9)) .
cnf(r_axiom18,axiom,(~acc_p3 | ~acc_p2 | acc_f4_p)) .
cnf(r_axiom19,axiom,(~acc_zcl_10 | acc_p1)) .
cnf(r_axiom20,axiom,(~acc_zcl_10 | acc_p0)) .
cnf(r_axiom21,axiom,(~acc_p1 | ~acc_p0 | acc_zcl_10)) .
cnf(r_axiom22,axiom,(~acc_f5 | acc_zcl_10)) .
cnf(r_axiom23,axiom,(~acc_p1 | ~acc_p0 | acc_f5_p)) .
cnf(r_axiom24,axiom,(~acc_f3 | acc_f4 | acc_f5)) .
cnf(r_axiom25,axiom,(~acc_f4_p | acc_f3_p)) .
cnf(r_axiom26,axiom,(~acc_f5_p | acc_f3_p)) .
cnf(r_axiom27,axiom,(~acc_zcl_11 | acc_f2)) .
cnf(r_axiom28,axiom,(~acc_zcl_11 | acc_f3)) .
cnf(r_axiom29,axiom,(~acc_f2 | ~acc_f3 | acc_zcl_11)) .
cnf(r_axiom30,axiom,(~acc_f1 | acc_zcl_11)) .
cnf(r_axiom31,axiom,(~acc_f2_p | ~acc_f3_p | acc_f1_p)) .
cnf(r_axiom32,axiom,(~acc_q | acc_f0 | acc_f1)) .
cnf(r_axiom33,axiom,(~acc_f0_p | acc_q)) .
cnf(r_axiom34,axiom,(~acc_f1_p | acc_q)) .
