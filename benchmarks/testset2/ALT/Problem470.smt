...
;%~f2 | p15 | p12
(assert (or (not l_f2) l_p15 l_p12))
...
;%~p11 | ~p8 | f6_p
(assert (or (not l_p11) (not l_p8) l_f6_p))
...
(assert (or (not r_f2) r_p15 r_p12))
...
(assert (or (not r_p11) (not r_p8) r_f6_p))
