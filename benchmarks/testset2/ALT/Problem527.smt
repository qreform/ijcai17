...
;%~p0 | ~p10 | f3_p
(assert (or (not l_p0) (not l_p10) l_f3_p))
...
;%~p2 | ~f3 | zcl_1
(assert (or (not l_p2) (not l_f3) l_zcl_1))
...
;%~p2 | ~f3_p | f2_p
(assert (or (not l_p2) (not l_f3_p) l_f2_p))
...
;%~p1 | ~f2 | zcl_2
(assert (or (not l_p1) (not l_f2) l_zcl_2))
...
;%~p1 | ~f2_p | f1_p
(assert (or (not l_p1) (not l_f2_p) l_f1_p))
...
;%~p3 | ~p7 | zcl_4
(assert (or (not l_p3) (not l_p7) l_zcl_4))
...
;%~p3 | ~p7 | f13_p
(assert (or (not l_p3) (not l_p7) l_f13_p))
...
(assert (or (not r_p0) (not r_p10) r_f3_p))
...
;%~r_p2 | ~r_f3 | r_zcl_1
(assert (or (not r_p2) (not r_f3) r_zcl_1))
...
(assert (or (not r_p2) (not r_f3_p) r_f2_p))
...
;%~r_p1 | ~r_f2 | r_zcl_2
(assert (or (not r_p1) (not r_f2) r_zcl_2))
...
(assert (or (not r_p1) (not r_f2_p) r_f1_p))
...
;%~r_p3 | ~r_p7 | r_zcl_4
(assert (or (not r_p3) (not r_p7) r_zcl_4))
...
(assert (or (not r_p3) (not r_p7) r_f13_p))
