...
;%~f3 | p11 | p10
(assert (or (not l_f3) l_p11 l_p10))
...
;%~p1 | ~f7 | zcl_2
(assert (or (not l_p1) (not l_f7) l_zcl_2))
...
;%~p1 | ~f7_p | f6_p
(assert (or (not l_p1) (not l_f7_p) l_f6_p))
...
(assert (or (not r_f3) r_p11 r_p10))


;%~r_p11 | r_f3_p
(declare-fun r_f3_p () Bool)
(assert (or (not r_p11) r_f3_p))
...
;%~r_p1 | ~r_f7 | r_zcl_2
(assert (or (not r_p1) (not r_f7) r_zcl_2))
...
(assert (or (not r_p1) (not r_f7_p) r_f6_p))
