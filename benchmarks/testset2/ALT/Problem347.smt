...
;%~p6 | ~p5 | zcl_0
(assert (or (not l_p6) (not l_p5) l_zcl_0))
...
;%~p6 | ~p5 | f1_p
(assert (or (not l_p6) (not l_p5) l_f1_p))
...
;%~p3 | ~f1 | zcl_1
(assert (or (not l_p3) (not l_f1) l_zcl_1))
...
;%~r_p6 | ~r_p5 | r_zcl_0
(assert (or (not r_p6) (not r_p5) r_zcl_0))
...
(assert (or (not r_p6) (not r_p5) r_f1_p))
...
;%~r_p3 | ~r_f1 | r_zcl_1
(assert (or (not r_p3) (not r_f1) r_zcl_1))
