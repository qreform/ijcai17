;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p0 & (~p8 & (p7 & (~p7 & ~p9)))) | ((~p8 | (p5 | (~p0 | (p5 | ~p7)))) & ((~p0 & (p6 & (~p0 & (~p0 & p5)))) | (~p1 & (p2 & (~p3 & (~p4 & ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p7 | ~p9 | zcl_0
(assert (or (not l_p7) (not l_p9) l_zcl_0))
...
;%~p7 | ~p9 | f3_p
(assert (or (not l_p7) (not l_p9) l_f3_p))
...
;%~r_p7 | ~r_p9 | r_zcl_0
(assert (or (not r_p7) (not r_p9) r_zcl_0))
...
(assert (or (not r_p7) (not r_p9) r_f3_p))
