%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p3 | (p3 | p8))) & ((p3 & (p6 & (p7 & p5))) | ((p1 | (p0 | (p2 | p4))) & (p1 | (p2 | (p3 | p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom10,axiom,(~zcl_10 | p7)) .
cnf(l_axiom11,axiom,(~zcl_10 | p5)) .
cnf(l_axiom12,axiom,(~p7 | ~p5 | zcl_10)) .
cnf(l_axiom13,axiom,(~f6 | zcl_10)) .
cnf(l_axiom14,axiom,(~p7 | ~p5 | f6_p)) .
cnf(l_axiom15,axiom,(~zcl_11 | p6)) .
cnf(l_axiom16,axiom,(~zcl_11 | f6)) .
cnf(l_axiom17,axiom,(~p6 | ~f6 | zcl_11)) .
...
cnf(r_axiom9,axiom,(~acc_f2 | acc_p3 | acc_p8)) .
cnf(r_axiom10,axiom,(~acc_p3 | acc_f2_p)) .
cnf(r_axiom11,axiom,(~acc_p8 | acc_f2_p)) .
cnf(r_axiom12,axiom,(~acc_f1 | acc_p3 | acc_f2)) .
cnf(r_axiom13,axiom,(~acc_p3 | acc_f1_p)) .
...
cnf(r_axiom18,axiom,(~acc_zcl_10 | acc_p7)) .
cnf(r_axiom19,axiom,(~acc_zcl_10 | acc_p5)) .
cnf(r_axiom20,axiom,(~acc_p7 | ~acc_p5 | acc_zcl_10)) .
cnf(r_axiom21,axiom,(~acc_f6 | acc_zcl_10)) .
cnf(r_axiom22,axiom,(~acc_p7 | ~acc_p5 | acc_f6_p)) .
cnf(r_axiom23,axiom,(~acc_zcl_11 | acc_p6)) .
cnf(r_axiom24,axiom,(~acc_zcl_11 | acc_f6)) .
cnf(r_axiom25,axiom,(~acc_p6 | ~acc_f6 | acc_zcl_11)) .
cnf(r_axiom26,axiom,(~acc_f5 | acc_zcl_11)) .
cnf(r_axiom27,axiom,(~acc_p6 | ~acc_f6_p | acc_f5_p)) .
cnf(r_axiom28,axiom,(~acc_zcl_12 | acc_p3)) .
cnf(r_axiom29,axiom,(~acc_zcl_12 | acc_f5)) .
cnf(r_axiom30,axiom,(~acc_p3 | ~acc_f5 | acc_zcl_12)) .
cnf(r_axiom31,axiom,(~acc_f4 | acc_zcl_12)) .
cnf(r_axiom32,axiom,(~acc_p3 | ~acc_f5_p | acc_f4_p)) .
cnf(r_axiom33,axiom,(~acc_f10 | acc_p2 | acc_p4)) .
...
cnf(r_axiom39,axiom,(~acc_f8 | acc_p1 | acc_f9)) .
cnf(r_axiom40,axiom,(~acc_p1 | acc_f8_p)) .
cnf(r_axiom41,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom42,axiom,(~acc_f13 | acc_p3 | acc_p0)) .
...
cnf(r_axiom48,axiom,(~acc_f11 | acc_p1 | acc_f12)) .
cnf(r_axiom49,axiom,(~acc_p1 | acc_f11_p)) .
cnf(r_axiom50,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom51,axiom,(~acc_zcl_13 | acc_f8)) .
cnf(r_axiom52,axiom,(~acc_zcl_13 | acc_f11)) .
cnf(r_axiom53,axiom,(~acc_f8 | ~acc_f11 | acc_zcl_13)) .
cnf(r_axiom54,axiom,(~acc_f7 | acc_zcl_13)) .
cnf(r_axiom55,axiom,(~acc_f8_p | ~acc_f11_p | acc_f7_p)) .
cnf(r_axiom56,axiom,(~acc_f3 | acc_f4 | acc_f7)) .
cnf(r_axiom57,axiom,(~acc_f4_p | acc_f3_p)) .
cnf(r_axiom58,axiom,(~acc_f7_p | acc_f3_p)) .
cnf(r_axiom59,axiom,(~acc_zcl_14 | acc_f0)) .
cnf(r_axiom60,axiom,(~acc_zcl_14 | acc_f3)) .
cnf(r_axiom61,axiom,(~acc_f0 | ~acc_f3 | acc_zcl_14)) .
cnf(r_axiom62,axiom,(~acc_q | acc_zcl_14)) .
cnf(r_axiom63,axiom,(~acc_f0_p | ~acc_f3_p | acc_q)) .
