;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p8 | (p0 | p7)) & ((p6 & (p4 & p5)) | ((p0 | (p0 | p4)) & ((p0 & (p0 & p3)) | (p1 & (p2 & p0)))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p4 | ~p5 | zcl_0
(assert (or (not l_p4) (not l_p5) l_zcl_0))
...
;%~p4 | ~p5 | f4_p
(assert (or (not l_p4) (not l_p5) l_f4_p))
...
;%~r_p4 | ~r_p5 | r_zcl_0
(assert (or (not r_p4) (not r_p5) r_zcl_0))
...
(assert (or (not r_p4) (not r_p5) r_f4_p))
