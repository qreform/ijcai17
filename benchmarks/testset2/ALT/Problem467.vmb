%%%%%%%%%%%%%%%% Target reformulation: ((~p3 | (p1 | ~p5)) & ((~p1 & (~p3 & ~p4)) | ((~p2 | (p2 | p3)) & (~p1 | (~p2 | ~p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom12,axiom,(~zcl_9 | p1)) .
cnf(l_axiom13,axiom,(~zcl_9 | f4)) .
cnf(l_axiom14,axiom,(~p1 | ~f4 | zcl_9)) .
...
cnf(r_axiom6,axiom,(~acc_f1 | acc_p1 | acc_p5)) .
cnf(r_axiom7,axiom,(~acc_p1 | acc_f1_p)) .
...
cnf(r_axiom17,axiom,(~acc_zcl_9 | acc_p1)) .
cnf(r_axiom18,axiom,(~acc_zcl_9 | acc_f4)) .
cnf(r_axiom19,axiom,(~acc_p1 | ~acc_f4 | acc_zcl_9)) .
cnf(r_axiom20,axiom,(~acc_f3 | acc_zcl_9)) .
cnf(r_axiom21,axiom,(~acc_p1 | ~acc_f4_p | acc_f3_p)) .
cnf(r_axiom22,axiom,(~acc_f7 | acc_p2 | acc_p3)) .
cnf(r_axiom23,axiom,(~acc_p2 | acc_f7_p)) .
cnf(r_axiom24,axiom,(~acc_p3 | acc_f7_p)) .
cnf(r_axiom25,axiom,(~acc_f6 | acc_p2 | acc_f7)) .
cnf(r_axiom26,axiom,(~acc_p2 | acc_f6_p)) .
