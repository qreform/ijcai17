...
;%~p0 | ~p8 | zcl_0
(assert (or (not l_p0) (not l_p8) l_zcl_0))
...
;%~p0 | ~p8 | f3_p
(assert (or (not l_p0) (not l_p8) l_f3_p))
...
;%~p7 | ~f3 | zcl_1
(assert (or (not l_p7) (not l_f3) l_zcl_1))
...
;%~p7 | ~f3_p | f2_p
(assert (or (not l_p7) (not l_f3_p) l_f2_p))
...
;%~p6 | ~f13 | zcl_5
(assert (or (not l_p6) (not l_f13) l_zcl_5))
...
;%~r_p0 | ~r_p8 | r_zcl_0
(assert (or (not r_p0) (not r_p8) r_zcl_0))
...
(assert (or (not r_p0) (not r_p8) r_f3_p))
...
;%~r_p7 | ~r_f3 | r_zcl_1
(assert (or (not r_p7) (not r_f3) r_zcl_1))
...
(assert (or (not r_p7) (not r_f3_p) r_f2_p))
...
;%~r_p6 | ~r_f13 | r_zcl_5
(assert (or (not r_p6) (not r_f13) r_zcl_5))
