...
;%~p0 | ~p6 | zcl_0
(assert (or (not l_p0) (not l_p6) l_zcl_0))
...
;%~p0 | ~p6 | f8_p
(assert (or (not l_p0) (not l_p6) l_f8_p))
...
;%~r_p0 | ~r_p6 | r_zcl_0
(assert (or (not r_p0) (not r_p6) r_zcl_0))
...
(assert (or (not r_p0) (not r_p6) r_f8_p))
