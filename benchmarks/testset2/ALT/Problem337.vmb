%%%%%%%%%%%%%%%% Target reformulation: ((~p0 & ~p4) | ((~p0 | p3) & ((p0 & p2) | (~p1 & p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom3,axiom,(~p0 | ~p4 | zcl_8)) .
cnf(l_axiom4,axiom,(~f0 | zcl_8)) .
cnf(l_axiom5,axiom,(~p0 | ~p4 | f0_p)) .
...
cnf(r_axiom5,axiom,(~acc_zcl_8 | acc_p0)) .
cnf(r_axiom6,axiom,(~acc_zcl_8 | acc_p4)) .
cnf(r_axiom7,axiom,(~acc_p0 | ~acc_p4 | acc_zcl_8)) .
cnf(r_axiom8,axiom,(~acc_f0 | acc_zcl_8)) .
cnf(r_axiom9,axiom,(~acc_p0 | ~acc_p4 | acc_f0_p)) .
