...
;%~p4 | ~p6 | f6_p
(assert (or (not l_p4) (not l_p6) l_f6_p))
...
;%~p2 | ~f5 | zcl_2
(assert (or (not l_p2) (not l_f5) l_zcl_2))
...
;%~p2 | ~f5_p | f4_p
(assert (or (not l_p2) (not l_f5_p) l_f4_p))
...
(assert (or (not r_p4) (not r_p6) r_f6_p))
...
;%~r_p2 | ~r_f5 | r_zcl_2
(assert (or (not r_p2) (not r_f5) r_zcl_2))
...
(assert (or (not r_p2) (not r_f5_p) r_f4_p))
