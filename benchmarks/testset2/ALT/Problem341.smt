;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p4 & (p0 & p5)) | ((p3 | (p0 | p4)) & ((p0 & (p0 & p3)) | (p1 & (p2 & p0))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p0 | ~p5 | f1_p
(assert (or (not l_p0) (not l_p5) l_f1_p))
...
;%~p4 | ~f1 | zcl_1
(assert (or (not l_p4) (not l_f1) l_zcl_1))
...
(assert (or (not r_p0) (not r_p5) r_f1_p))
...
;%~r_p4 | ~r_f1 | r_zcl_1
(assert (or (not r_p4) (not r_f1) r_zcl_1))
