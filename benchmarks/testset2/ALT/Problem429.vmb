%%%%%%%%%%%%%%%% Target reformulation: ((~p0 & (~p5 & ~p4)) | ((~p0 | (~p1 | ~p3)) & (~p1 | (~p2 | p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom6,axiom,(~zcl_7 | p0)) .
cnf(l_axiom7,axiom,(~zcl_7 | f1)) .
cnf(l_axiom8,axiom,(~p0 | ~f1 | zcl_7)) .
...
cnf(r_axiom11,axiom,(~acc_zcl_7 | acc_p0)) .
cnf(r_axiom12,axiom,(~acc_zcl_7 | acc_f1)) .
cnf(r_axiom13,axiom,(~acc_p0 | ~acc_f1 | acc_zcl_7)) .
cnf(r_axiom14,axiom,(~acc_f0 | acc_zcl_7)) .
cnf(r_axiom15,axiom,(~acc_p0 | ~acc_f1_p | acc_f0_p)) .
