...
;%~p4 | ~p5 | f0_p
(assert (or (not l_p4) (not l_p5) l_f0_p))
...
(assert (or (not r_p4) (not r_p5) r_f0_p))


;%~r_f2 | r_p2 | r_p4
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p2 r_p4))
