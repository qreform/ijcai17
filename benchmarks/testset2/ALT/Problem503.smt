...
;%~p1 | ~p8 | f1_p
(assert (or (not l_p1) (not l_p8) l_f1_p))
...
;%~p3 | ~p4 | zcl_2
(assert (or (not l_p3) (not l_p4) l_zcl_2))
...
(assert (or (not r_p1) (not r_p8) r_f1_p))
...
;%~r_p3 | ~r_p4 | r_zcl_2
(assert (or (not r_p3) (not r_p4) r_zcl_2))
