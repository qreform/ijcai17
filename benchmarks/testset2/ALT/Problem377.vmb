%%%%%%%%%%%%%%%% Target reformulation: ((~p0 | ~p5) & ((~p3 & ~p4) | ((~p0 | p3) & ((~p0 & ~p2) | (~p1 & ~p0))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom6,axiom,(~acc_f0 | acc_p0 | acc_p5)) .
cnf(r_axiom7,axiom,(~acc_p0 | acc_f0_p)) .
...
cnf(r_axiom14,axiom,(~acc_f4 | acc_p0 | acc_p3)) .
