...
;%~p5 | ~p6 | f4_p
(assert (or (not l_p5) (not l_p6) l_f4_p))
...
;%~p0 | ~p3 | f10_p
(assert (or (not l_p0) (not l_p3) l_f10_p))
...
;%~p2 | ~p0 | zcl_4
(assert (or (not l_p2) (not l_p0) l_zcl_4))
...
;%~p2 | ~p0 | f12_p
(assert (or (not l_p2) (not l_p0) l_f12_p))
...
;%~p1 | ~f12 | zcl_5
(assert (or (not l_p1) (not l_f12) l_zcl_5))
...
;%~zcl_6 | f6
(assert (or (not l_zcl_6) l_f6))

;%~zcl_6 | f8
(assert (or (not l_zcl_6) l_f8))

;%~f6 | ~f8 | zcl_6
(assert (or (not l_f6) (not l_f8) l_zcl_6))

(declare-fun l_f5 () Bool)
;%~f5 | zcl_6
(assert (or (not l_f5) l_zcl_6))
...
;%~zcl_7 | f0
(assert (or (not l_zcl_7) l_f0))

;%~zcl_7 | f2
(assert (or (not l_zcl_7) l_f2))

;%~f0 | ~f2 | zcl_7
(assert (or (not l_f0) (not l_f2) l_zcl_7))

;%~Q | zcl_7
(assert (or (not l_q) l_zcl_7))
...
(assert (or (not r_p5) (not r_p6) r_f4_p))
...
(assert (or (not r_p0) (not r_p3) r_f10_p))
...
;%~r_p2 | ~r_p0 | r_zcl_4
(assert (or (not r_p2) (not r_p0) r_zcl_4))
...
(assert (or (not r_p2) (not r_p0) r_f12_p))
...
;%~r_p1 | ~r_f12 | r_zcl_5
(assert (or (not r_p1) (not r_f12) r_zcl_5))
...
(assert (or (not r_zcl_6) r_f6))


;%~r_zcl_6 | r_f8
(assert (or (not r_zcl_6) r_f8))


;%~r_f6 | ~r_f8 | r_zcl_6
(assert (or (not r_f6) (not r_f8) r_zcl_6))


;%~r_f5 | r_zcl_6
(declare-fun r_f5 () Bool)
(assert (or (not r_f5) r_zcl_6))
...
(assert (or (not r_zcl_7) r_f0))


;%~r_zcl_7 | r_f2
(assert (or (not r_zcl_7) r_f2))


;%~r_f0 | ~r_f2 | r_zcl_7
(assert (or (not r_f0) (not r_f2) r_zcl_7))


;%~r_Q | r_zcl_7
(declare-fun r_q () Bool)
(assert (or (not r_q) r_zcl_7))
