...
;%~p6 | ~p8 | zcl_0
(assert (or (not l_p6) (not l_p8) l_zcl_0))
...
;%~p6 | ~p8 | f2_p
(assert (or (not l_p6) (not l_p8) l_f2_p))
...
;%~r_p6 | ~r_p8 | r_zcl_0
(assert (or (not r_p6) (not r_p8) r_zcl_0))
...
(assert (or (not r_p6) (not r_p8) r_f2_p))
