%%%%%%%%%%%%%%%% Target reformulation: ((p7 & (~p1 & (~p3 & (~p4 & p6)))) | ((~p1 | (p3 | (~p2 | (~p1 | p5)))) & (p1 | (~p2 | (p3 | (~p4 | ~p0)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_10 | p4)) .
cnf(l_axiom2,axiom,(~zcl_10 | p6)) .
cnf(l_axiom3,axiom,(~p4 | ~p6 | zcl_10)) .
cnf(l_axiom4,axiom,(~f3 | zcl_10)) .
cnf(l_axiom5,axiom,(~p4 | ~p6 | f3_p)) .
...
cnf(r_axiom8,axiom,(~acc_zcl_10 | acc_p4)) .
cnf(r_axiom9,axiom,(~acc_zcl_10 | acc_p6)) .
cnf(r_axiom10,axiom,(~acc_p4 | ~acc_p6 | acc_zcl_10)) .
cnf(r_axiom11,axiom,(~acc_f3 | acc_zcl_10)) .
cnf(r_axiom12,axiom,(~acc_p4 | ~acc_p6 | acc_f3_p)) .
...
cnf(r_axiom18,axiom,(~acc_zcl_12 | acc_p1)) .
cnf(r_axiom19,axiom,(~acc_zcl_12 | acc_f2)) .
cnf(r_axiom20,axiom,(~acc_p1 | ~acc_f2 | acc_zcl_12)) .
cnf(r_axiom21,axiom,(~acc_f1 | acc_zcl_12)) .
cnf(r_axiom22,axiom,(~acc_p1 | ~acc_f2_p | acc_f1_p)) .
cnf(r_axiom23,axiom,(~acc_zcl_13 | acc_p7)) .
cnf(r_axiom24,axiom,(~acc_zcl_13 | acc_f1)) .
cnf(r_axiom25,axiom,(~acc_p7 | ~acc_f1 | acc_zcl_13)) .
cnf(r_axiom26,axiom,(~acc_f0 | acc_zcl_13)) .
cnf(r_axiom27,axiom,(~acc_p7 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom28,axiom,(~acc_f8 | acc_p1 | acc_p5)) .
cnf(r_axiom29,axiom,(~acc_p1 | acc_f8_p)) .
cnf(r_axiom30,axiom,(~acc_p5 | acc_f8_p)) .
cnf(r_axiom31,axiom,(~acc_f7 | acc_p2 | acc_f8)) .
cnf(r_axiom32,axiom,(~acc_p2 | acc_f7_p)) .
cnf(r_axiom33,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom34,axiom,(~acc_f6 | acc_p3 | acc_f7)) .
cnf(r_axiom35,axiom,(~acc_p3 | acc_f6_p)) .
cnf(r_axiom36,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom37,axiom,(~acc_f5 | acc_p1 | acc_f6)) .
cnf(r_axiom38,axiom,(~acc_p1 | acc_f5_p)) .
