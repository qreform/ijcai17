...
;%~p4 | ~p10 | zcl_0
(assert (or (not l_p4) (not l_p10) l_zcl_0))
...
;%~p4 | ~p10 | f2_p
(assert (or (not l_p4) (not l_p10) l_f2_p))
...
;%~r_p4 | ~r_p10 | r_zcl_0
(assert (or (not r_p4) (not r_p10) r_zcl_0))
...
(assert (or (not r_p4) (not r_p10) r_f2_p))
