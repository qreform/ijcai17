%%%%%%%%%%%%%%%% Target reformulation: ((p4 | (p7 | (p1 | (p11 | p10)))) & ((p8 & (p1 & (p9 & (p2 & p7)))) | ((p6 | (p3 | (p3 | (p2 | p5)))) & (p1 | (p2 | (p3 | (p4 | p0))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom7,axiom,(~f1 | p7 | f2)) .
cnf(l_axiom8,axiom,(~p7 | f1_p)) .
cnf(l_axiom9,axiom,(~f2_p | f1_p)) .
cnf(l_axiom10,axiom,(~f0 | p4 | f1)) .
cnf(l_axiom11,axiom,(~p4 | f0_p)) .
cnf(l_axiom12,axiom,(~f1_p | f0_p)) .
cnf(l_axiom13,axiom,(~zcl_12 | p2)) .
cnf(l_axiom14,axiom,(~zcl_12 | p7)) .
cnf(l_axiom15,axiom,(~p2 | ~p7 | zcl_12)) .
cnf(l_axiom16,axiom,(~f8 | zcl_12)) .
cnf(l_axiom17,axiom,(~p2 | ~p7 | f8_p)) .
...
cnf(l_axiom23,axiom,(~zcl_14 | p1)) .
cnf(l_axiom24,axiom,(~zcl_14 | f7)) .
cnf(l_axiom25,axiom,(~p1 | ~f7 | zcl_14)) .
cnf(l_axiom26,axiom,(~f6 | zcl_14)) .
cnf(l_axiom27,axiom,(~p1 | ~f7_p | f6_p)) .
cnf(l_axiom28,axiom,(~zcl_15 | p8)) .
cnf(l_axiom29,axiom,(~zcl_15 | f6)) .
cnf(l_axiom30,axiom,(~p8 | ~f6 | zcl_15)) .
...
cnf(r_axiom15,axiom,(~acc_f2 | acc_p1 | acc_f3)) .
cnf(r_axiom16,axiom,(~acc_p1 | acc_f2_p)) .
cnf(r_axiom17,axiom,(~acc_f3_p | acc_f2_p)) .
cnf(r_axiom18,axiom,(~acc_f1 | acc_p7 | acc_f2)) .
cnf(r_axiom19,axiom,(~acc_p7 | acc_f1_p)) .
...
cnf(r_axiom24,axiom,(~acc_zcl_12 | acc_p2)) .
cnf(r_axiom25,axiom,(~acc_zcl_12 | acc_p7)) .
cnf(r_axiom26,axiom,(~acc_p2 | ~acc_p7 | acc_zcl_12)) .
cnf(r_axiom27,axiom,(~acc_f8 | acc_zcl_12)) .
cnf(r_axiom28,axiom,(~acc_p2 | ~acc_p7 | acc_f8_p)) .
cnf(r_axiom29,axiom,(~acc_zcl_13 | acc_p9)) .
cnf(r_axiom30,axiom,(~acc_zcl_13 | acc_f8)) .
cnf(r_axiom31,axiom,(~acc_p9 | ~acc_f8 | acc_zcl_13)) .
cnf(r_axiom32,axiom,(~acc_f7 | acc_zcl_13)) .
cnf(r_axiom33,axiom,(~acc_p9 | ~acc_f8_p | acc_f7_p)) .
cnf(r_axiom34,axiom,(~acc_zcl_14 | acc_p1)) .
cnf(r_axiom35,axiom,(~acc_zcl_14 | acc_f7)) .
cnf(r_axiom36,axiom,(~acc_p1 | ~acc_f7 | acc_zcl_14)) .
cnf(r_axiom37,axiom,(~acc_f6 | acc_zcl_14)) .
cnf(r_axiom38,axiom,(~acc_p1 | ~acc_f7_p | acc_f6_p)) .
cnf(r_axiom39,axiom,(~acc_zcl_15 | acc_p8)) .
cnf(r_axiom40,axiom,(~acc_zcl_15 | acc_f6)) .
cnf(r_axiom41,axiom,(~acc_p8 | ~acc_f6 | acc_zcl_15)) .
cnf(r_axiom42,axiom,(~acc_f5 | acc_zcl_15)) .
cnf(r_axiom43,axiom,(~acc_p8 | ~acc_f6_p | acc_f5_p)) .
cnf(r_axiom44,axiom,(~acc_f13 | acc_p2 | acc_p5)) .
cnf(r_axiom45,axiom,(~acc_p2 | acc_f13_p)) .
cnf(r_axiom46,axiom,(~acc_p5 | acc_f13_p)) .
cnf(r_axiom47,axiom,(~acc_f12 | acc_p3 | acc_f13)) .
cnf(r_axiom48,axiom,(~acc_p3 | acc_f12_p)) .
cnf(r_axiom49,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom50,axiom,(~acc_f11 | acc_p3 | acc_f12)) .
cnf(r_axiom51,axiom,(~acc_p3 | acc_f11_p)) .
