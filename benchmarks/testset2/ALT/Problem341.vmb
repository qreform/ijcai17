...
cnf(l_axiom6,axiom,(~zcl_15 | p4)) .
cnf(l_axiom7,axiom,(~zcl_15 | f1)) .
cnf(l_axiom8,axiom,(~p4 | ~f1 | zcl_15)) .
cnf(l_axiom9,axiom,(~f0 | zcl_15)) .
cnf(l_axiom10,axiom,(~p4 | ~f1_p | f0_p)) .
...
cnf(r_axiom11,axiom,(~acc_zcl_15 | acc_p4)) .
cnf(r_axiom12,axiom,(~acc_zcl_15 | acc_f1)) .
cnf(r_axiom13,axiom,(~acc_p4 | ~acc_f1 | acc_zcl_15)) .
cnf(r_axiom14,axiom,(~acc_f0 | acc_zcl_15)) .
cnf(r_axiom15,axiom,(~acc_p4 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom16,axiom,(~acc_f4 | acc_p0 | acc_p4)) .
cnf(r_axiom17,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom18,axiom,(~acc_p4 | acc_f4_p)) .
cnf(r_axiom19,axiom,(~acc_f3 | acc_p3 | acc_f4)) .
cnf(r_axiom20,axiom,(~acc_p3 | acc_f3_p)) .
