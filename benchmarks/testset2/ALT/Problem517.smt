;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((~p7 & (~p9 & (p1 & p8))) | ((p7 | (~p1 | (~p1 | ~p6))) & ((~p1 & (p3 & (~p1 & ~p5))) | ((~p3 | (p3 | (p3 | ~p4))) & (p1 | (~p2 | (p3 | ~p0))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~p1 | ~p8 | zcl_0
(assert (or (not l_p1) (not l_p8) l_zcl_0))
...
;%~p1 | ~p8 | f2_p
(assert (or (not l_p1) (not l_p8) l_f2_p))
...
;%~p9 | ~f2 | zcl_1
(assert (or (not l_p9) (not l_f2) l_zcl_1))
...
;%~p1 | ~p5 | zcl_3
(assert (or (not l_p1) (not l_p5) l_zcl_3))
...
;%~p1 | ~p5 | f10_p
(assert (or (not l_p1) (not l_p5) l_f10_p))
...
;%~p3 | ~f10 | zcl_4
(assert (or (not l_p3) (not l_f10) l_zcl_4))
...
;%~p3 | ~f10_p | f9_p
(assert (or (not l_p3) (not l_f10_p) l_f9_p))
...
;%~r_p1 | ~r_p8 | r_zcl_0
(assert (or (not r_p1) (not r_p8) r_zcl_0))
...
(assert (or (not r_p1) (not r_p8) r_f2_p))
...
;%~r_p9 | ~r_f2 | r_zcl_1
(assert (or (not r_p9) (not r_f2) r_zcl_1))
...
;%~r_p1 | ~r_p5 | r_zcl_3
(assert (or (not r_p1) (not r_p5) r_zcl_3))
...
(assert (or (not r_p1) (not r_p5) r_f10_p))
...
;%~r_p3 | ~r_f10 | r_zcl_4
(assert (or (not r_p3) (not r_f10) r_zcl_4))
...
(assert (or (not r_p3) (not r_f10_p) r_f9_p))
...
(assert (or (not r_f14) r_p3 r_p4))


;%~r_p3 | r_f14_p
(declare-fun r_f14_p () Bool)
(assert (or (not r_p3) r_f14_p))
