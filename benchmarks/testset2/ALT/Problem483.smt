...
;%~p5 | ~p6 | zcl_0
(assert (or (not l_p5) (not l_p6) l_zcl_0))
...
;%~p5 | ~p6 | f8_p
(assert (or (not l_p5) (not l_p6) l_f8_p))
...
;%~p7 | ~f8 | zcl_1
(assert (or (not l_p7) (not l_f8) l_zcl_1))
...
;%~r_p5 | ~r_p6 | r_zcl_0
(assert (or (not r_p5) (not r_p6) r_zcl_0))
...
(assert (or (not r_p5) (not r_p6) r_f8_p))
...
;%~r_p7 | ~r_f8 | r_zcl_1
(assert (or (not r_p7) (not r_f8) r_zcl_1))
