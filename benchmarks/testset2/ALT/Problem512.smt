...
;%~p3 | ~p7 | zcl_0
(assert (or (not l_p3) (not l_p7) l_zcl_0))
...
;%~p3 | ~p7 | f2_p
(assert (or (not l_p3) (not l_p7) l_f2_p))
...
;%~p2 | ~p5 | zcl_3
(assert (or (not l_p2) (not l_p5) l_zcl_3))
...
;%~p2 | ~p5 | f10_p
(assert (or (not l_p2) (not l_p5) l_f10_p))
...
;%~r_p3 | ~r_p7 | r_zcl_0
(assert (or (not r_p3) (not r_p7) r_zcl_0))
...
(assert (or (not r_p3) (not r_p7) r_f2_p))
...
;%~r_p2 | ~r_p5 | r_zcl_3
(assert (or (not r_p2) (not r_p5) r_zcl_3))
...
(assert (or (not r_p2) (not r_p5) r_f10_p))
