...
;%~p6 | ~p5 | f0_p
(assert (or (not l_p6) (not l_p5) l_f0_p))
...
;%~p0 | ~p2 | f4_p
(assert (or (not l_p0) (not l_p2) l_f4_p))
...
(assert (or (not r_p6) (not r_p5) r_f0_p))


;%~r_f2 | r_p4 | r_p3
(declare-fun r_f2 () Bool)
(assert (or (not r_f2) r_p4 r_p3))
...
(assert (or (not r_p0) (not r_p2) r_f4_p))
