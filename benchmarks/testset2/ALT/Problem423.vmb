%%%%%%%%%%%%%%%% Target reformulation: ((p1 & (p2 & p5)) | ((p2 | (p4 | p3)) & (p1 | (p2 | p0)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom2,axiom,(~zcl_6 | p5)) .
cnf(l_axiom3,axiom,(~p2 | ~p5 | zcl_6)) .
cnf(l_axiom4,axiom,(~f1 | zcl_6)) .
cnf(l_axiom5,axiom,(~p2 | ~p5 | f1_p)) .
...
cnf(r_axiom6,axiom,(~acc_zcl_6 | acc_p2)) .
cnf(r_axiom7,axiom,(~acc_zcl_6 | acc_p5)) .
cnf(r_axiom8,axiom,(~acc_p2 | ~acc_p5 | acc_zcl_6)) .
cnf(r_axiom9,axiom,(~acc_f1 | acc_zcl_6)) .
cnf(r_axiom10,axiom,(~acc_p2 | ~acc_p5 | acc_f1_p)) .
