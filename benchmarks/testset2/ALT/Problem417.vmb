%%%%%%%%%%%%%%%% Target reformulation: ((~p3 & ~p4) | ((~p3 | ~p2) & (p1 | p0))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_4 | p3)) .
cnf(l_axiom2,axiom,(~zcl_4 | p4)) .
cnf(l_axiom3,axiom,(~p3 | ~p4 | zcl_4)) .
...
cnf(r_axiom6,axiom,(~acc_zcl_4 | acc_p4)) .
cnf(r_axiom7,axiom,(~acc_p3 | ~acc_p4 | acc_zcl_4)) .
