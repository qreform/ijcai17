...
;%~p11 | ~p10 | f3_p
(assert (or (not l_p11) (not l_p10) l_f3_p))
...
;%~p5 | ~f3 | zcl_1
(assert (or (not l_p5) (not l_f3) l_zcl_1))
...
;%~p5 | ~f3_p | f2_p
(assert (or (not l_p5) (not l_f3_p) l_f2_p))
...
;%~p4 | ~f2 | zcl_2
(assert (or (not l_p4) (not l_f2) l_zcl_2))
...
;%~p4 | ~f2_p | f1_p
(assert (or (not l_p4) (not l_f2_p) l_f1_p))
...
;%~p2 | ~p7 | zcl_4
(assert (or (not l_p2) (not l_p7) l_zcl_4))
...
;%~p2 | ~p7 | f13_p
(assert (or (not l_p2) (not l_p7) l_f13_p))
...
;%~p3 | ~f11 | zcl_7
(assert (or (not l_p3) (not l_f11) l_zcl_7))
...
;%Non-clausified dependency
;%(forall[]((p3 & f11_p) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p3 | ~f11_p | f10_p
(assert (or (not l_p3) (not l_f11_p) l_f10_p))
...
(assert (or (not r_p11) (not r_p10) r_f3_p))
...
;%~r_p5 | ~r_f3 | r_zcl_1
(assert (or (not r_p5) (not r_f3) r_zcl_1))
...
(assert (or (not r_p5) (not r_f3_p) r_f2_p))
...
;%~r_p4 | ~r_f2 | r_zcl_2
(assert (or (not r_p4) (not r_f2) r_zcl_2))
...
(assert (or (not r_p4) (not r_f2_p) r_f1_p))
...
;%~r_p2 | ~r_p7 | r_zcl_4
(assert (or (not r_p2) (not r_p7) r_zcl_4))
...
(assert (or (not r_p2) (not r_p7) r_f13_p))
...
;%~r_p3 | ~r_f11 | r_zcl_7
(assert (or (not r_p3) (not r_f11) r_zcl_7))
...
;%~r_p3 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p3) (not r_f11_p) r_f10_p))
