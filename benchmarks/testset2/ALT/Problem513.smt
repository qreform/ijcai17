...
;%~p2 | ~p9 | zcl_0
(assert (or (not l_p2) (not l_p9) l_zcl_0))
...
;%~p2 | ~p9 | f2_p
(assert (or (not l_p2) (not l_p9) l_f2_p))
...
;%~r_p2 | ~r_p9 | r_zcl_0
(assert (or (not r_p2) (not r_p9) r_zcl_0))
...
(assert (or (not r_p2) (not r_p9) r_f2_p))
