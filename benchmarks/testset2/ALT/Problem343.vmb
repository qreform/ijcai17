%%%%%%%%%%%%%%%% Target reformulation: ((p6 & (p5 & p7)) | ((p0 | (p6 | p5)) & ((p4 & (p0 & p3)) | (p1 & (p2 & p0))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom1,axiom,(~zcl_14 | p5)) .
cnf(l_axiom2,axiom,(~zcl_14 | p7)) .
cnf(l_axiom3,axiom,(~p5 | ~p7 | zcl_14)) .
cnf(l_axiom4,axiom,(~f1 | zcl_14)) .
cnf(l_axiom5,axiom,(~p5 | ~p7 | f1_p)) .
cnf(l_axiom6,axiom,(~zcl_15 | p6)) .
cnf(l_axiom7,axiom,(~zcl_15 | f1)) .
cnf(l_axiom8,axiom,(~p6 | ~f1 | zcl_15)) .
cnf(l_axiom9,axiom,(~f0 | zcl_15)) .
cnf(l_axiom10,axiom,(~p6 | ~f1_p | f0_p)) .
cnf(l_axiom11,axiom,(~f4 | p6 | p5)) .
...
cnf(r_axiom8,axiom,(~acc_zcl_14 | acc_p5)) .
cnf(r_axiom9,axiom,(~acc_zcl_14 | acc_p7)) .
cnf(r_axiom10,axiom,(~acc_p5 | ~acc_p7 | acc_zcl_14)) .
cnf(r_axiom11,axiom,(~acc_f1 | acc_zcl_14)) .
cnf(r_axiom12,axiom,(~acc_p5 | ~acc_p7 | acc_f1_p)) .
cnf(r_axiom13,axiom,(~acc_zcl_15 | acc_p6)) .
cnf(r_axiom14,axiom,(~acc_zcl_15 | acc_f1)) .
cnf(r_axiom15,axiom,(~acc_p6 | ~acc_f1 | acc_zcl_15)) .
cnf(r_axiom16,axiom,(~acc_f0 | acc_zcl_15)) .
cnf(r_axiom17,axiom,(~acc_p6 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom18,axiom,(~acc_f4 | acc_p6 | acc_p5)) .
cnf(r_axiom19,axiom,(~acc_p6 | acc_f4_p)) .
...
cnf(r_axiom24,axiom,(~acc_zcl_16 | acc_p0)) .
cnf(r_axiom25,axiom,(~acc_zcl_16 | acc_p3)) .
cnf(r_axiom26,axiom,(~acc_p0 | ~acc_p3 | acc_zcl_16)) .
cnf(r_axiom27,axiom,(~acc_f7 | acc_zcl_16)) .
cnf(r_axiom28,axiom,(~acc_p0 | ~acc_p3 | acc_f7_p)) .
cnf(r_axiom29,axiom,(~acc_zcl_17 | acc_p4)) .
cnf(r_axiom30,axiom,(~acc_zcl_17 | acc_f7)) .
cnf(r_axiom31,axiom,(~acc_p4 | ~acc_f7 | acc_zcl_17)) .
cnf(r_axiom32,axiom,(~acc_f6 | acc_zcl_17)) .
cnf(r_axiom33,axiom,(~acc_p4 | ~acc_f7_p | acc_f6_p)) .
cnf(r_axiom34,axiom,(~acc_zcl_18 | acc_p2)) .
cnf(r_axiom35,axiom,(~acc_zcl_18 | acc_p0)) .
cnf(r_axiom36,axiom,(~acc_p2 | ~acc_p0 | acc_zcl_18)) .
cnf(r_axiom37,axiom,(~acc_f9 | acc_zcl_18)) .
cnf(r_axiom38,axiom,(~acc_p2 | ~acc_p0 | acc_f9_p)) .
cnf(r_axiom39,axiom,(~acc_zcl_19 | acc_p1)) .
cnf(r_axiom40,axiom,(~acc_zcl_19 | acc_f9)) .
cnf(r_axiom41,axiom,(~acc_p1 | ~acc_f9 | acc_zcl_19)) .
cnf(r_axiom42,axiom,(~acc_f8 | acc_zcl_19)) .
cnf(r_axiom43,axiom,(~acc_p1 | ~acc_f9_p | acc_f8_p)) .
cnf(r_axiom44,axiom,(~acc_f5 | acc_f6 | acc_f8)) .
cnf(r_axiom45,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom46,axiom,(~acc_f8_p | acc_f5_p)) .
cnf(r_axiom47,axiom,(~acc_zcl_20 | acc_f3)) .
cnf(r_axiom48,axiom,(~acc_zcl_20 | acc_f5)) .
cnf(r_axiom49,axiom,(~acc_f3 | ~acc_f5 | acc_zcl_20)) .
cnf(r_axiom50,axiom,(~acc_f2 | acc_zcl_20)) .
cnf(r_axiom51,axiom,(~acc_f3_p | ~acc_f5_p | acc_f2_p)) .
cnf(r_axiom52,axiom,(~acc_q | acc_f0 | acc_f2)) .
cnf(r_axiom53,axiom,(~acc_f0_p | acc_q)) .
cnf(r_axiom54,axiom,(~acc_f2_p | acc_q)) .
