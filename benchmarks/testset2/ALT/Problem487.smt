...
;%~p4 | ~p7 | f8_p
(assert (or (not l_p4) (not l_p7) l_f8_p))
...
;%~f12 | p6 | f13
(assert (or (not l_f12) l_p6 l_f13))
...
;%~f10 | p4 | f11
(assert (or (not l_f10) l_p4 l_f11))
...
(assert (or (not r_f0) r_p5 r_f1))


;%~r_p5 | r_f0_p
(declare-fun r_f0_p () Bool)
(assert (or (not r_p5) r_f0_p))
...
(assert (or (not r_p4) (not r_p7) r_f8_p))
...
(assert (or (not r_f12) r_p6 r_f13))


;%~r_p6 | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p6) r_f12_p))
...
(assert (or (not r_f10) r_p4 r_f11))
