...
;%~p5 | ~p11 | zcl_0
(assert (or (not l_p5) (not l_p11) l_zcl_0))
...
;%~p5 | ~p11 | f3_p
(assert (or (not l_p5) (not l_p11) l_f3_p))
...
;%~p6 | ~p7 | f13_p
(assert (or (not l_p6) (not l_p7) l_f13_p))
...
;%~p3 | ~f13 | zcl_5
(assert (or (not l_p3) (not l_f13) l_zcl_5))
...
;%~p3 | ~f13_p | f12_p
(assert (or (not l_p3) (not l_f13_p) l_f12_p))
...
;%~p6 | ~f12 | zcl_6
(assert (or (not l_p6) (not l_f12) l_zcl_6))
...
;%~p6 | ~f12_p | f11_p
(assert (or (not l_p6) (not l_f12_p) l_f11_p))
...
;%~f17 | p6 | f18
(assert (or (not l_f17) l_p6 l_f18))
...
;%~r_p5 | ~r_p11 | r_zcl_0
(assert (or (not r_p5) (not r_p11) r_zcl_0))
...
(assert (or (not r_p5) (not r_p11) r_f3_p))
...
(assert (or (not r_p6) (not r_p7) r_f13_p))
...
;%~r_p3 | ~r_f13 | r_zcl_5
(assert (or (not r_p3) (not r_f13) r_zcl_5))
...
;%~r_p3 | ~r_f13_p | r_f12_p
(declare-fun r_f12_p () Bool)
(assert (or (not r_p3) (not r_f13_p) r_f12_p))
...
;%~r_p6 | ~r_f12 | r_zcl_6
(assert (or (not r_p6) (not r_f12) r_zcl_6))
...
;%~r_p6 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p6) (not r_f12_p) r_f11_p))
...
(assert (or (not r_f17) r_p6 r_f18))


;%~r_p6 | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p6) r_f17_p))
