;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (p3 | ~p0))) & ((~p1 | (~p5 | (~p6 | ~p4))) & ((p8 | (~p0 | (~p1 | ~p7))) & ((p10 | (~p11 | (p6 | p9))) & (p7 | (p5 | (~p1 | ~p12))))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f17 | p1 | p12
(assert (or (not l_f17) l_p1 l_p12))
...
;%~f12 | ~f15 | zcl_0
(assert (or (not l_f12) (not l_f15) l_zcl_0))
...
;%~f8 | ~f11 | zcl_1
(assert (or (not l_f8) (not l_f11) l_zcl_1))
...
;%~f4 | ~f7 | zcl_2
(assert (or (not l_f4) (not l_f7) l_zcl_2))
...
;%~f0 | ~f3 | zcl_3
(assert (or (not l_f0) (not l_f3) l_zcl_3))
...
(assert (or (not r_f17) r_p1 r_p12))
...
;%~r_f12 | ~r_f15 | r_zcl_0
(assert (or (not r_f12) (not r_f15) r_zcl_0))
...
;%~r_f8 | ~r_f11 | r_zcl_1
(assert (or (not r_f8) (not r_f11) r_zcl_1))
...
;%~r_f4 | ~r_f7 | r_zcl_2
(assert (or (not r_f4) (not r_f7) r_zcl_2))
...
;%~r_f0 | ~r_f3 | r_zcl_3
(assert (or (not r_f0) (not r_f3) r_zcl_3))
