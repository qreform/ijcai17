%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (p3 | (~p4 | p0)))) & ((p4 | (p6 | (p4 | (p0 | p5)))) & ((~p1 | (p6 | (p5 | (p3 | ~p7)))) & ((~p9 | (p10 | (~p3 | (p11 | ~p8)))) & (~p6 | (p4 | (~p13 | (~p7 | ~p12)))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom16,axiom,(~f7 | p4 | f8)) .
cnf(l_axiom17,axiom,(~p4 | f7_p)) .
...
cnf(l_axiom49,axiom,(~f22 | p7 | p12)) .
cnf(l_axiom50,axiom,(~p7 | f22_p)) .
cnf(l_axiom51,axiom,(~p12 | f22_p)) .
cnf(l_axiom52,axiom,(~f21 | p13 | f22)) .
cnf(l_axiom53,axiom,(~p13 | f21_p)) .
cnf(l_axiom54,axiom,(~f22_p | f21_p)) .
cnf(l_axiom55,axiom,(~f20 | p4 | f21)) .
cnf(l_axiom56,axiom,(~p4 | f20_p)) .
...
cnf(r_axiom29,axiom,(~acc_f7 | acc_p4 | acc_f8)) .
cnf(r_axiom30,axiom,(~acc_p4 | acc_f7_p)) .
cnf(r_axiom31,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom32,axiom,(~acc_f6 | acc_p6 | acc_f7)) .
cnf(r_axiom33,axiom,(~acc_p6 | acc_f6_p)) .
cnf(r_axiom34,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom35,axiom,(~acc_f5 | acc_p4 | acc_f6)) .
cnf(r_axiom36,axiom,(~acc_p4 | acc_f5_p)) .
cnf(r_axiom37,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom38,axiom,(~acc_f13 | acc_p3 | acc_p7)) .
cnf(r_axiom39,axiom,(~acc_p3 | acc_f13_p)) .
cnf(r_axiom40,axiom,(~acc_p7 | acc_f13_p)) .
cnf(r_axiom41,axiom,(~acc_f12 | acc_p5 | acc_f13)) .
cnf(r_axiom42,axiom,(~acc_p5 | acc_f12_p)) .
cnf(r_axiom43,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom44,axiom,(~acc_f11 | acc_p6 | acc_f12)) .
cnf(r_axiom45,axiom,(~acc_p6 | acc_f11_p)) .
cnf(r_axiom46,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom47,axiom,(~acc_f10 | acc_p1 | acc_f11)) .
cnf(r_axiom48,axiom,(~acc_p1 | acc_f10_p)) .
cnf(r_axiom49,axiom,(~acc_f11_p | acc_f10_p)) .
cnf(r_axiom50,axiom,(~acc_f18 | acc_p11 | acc_p8)) .
cnf(r_axiom51,axiom,(~acc_p11 | acc_f18_p)) .
cnf(r_axiom52,axiom,(~acc_p8 | acc_f18_p)) .
cnf(r_axiom53,axiom,(~acc_f17 | acc_p3 | acc_f18)) .
cnf(r_axiom54,axiom,(~acc_p3 | acc_f17_p)) .
cnf(r_axiom55,axiom,(~acc_f18_p | acc_f17_p)) .
cnf(r_axiom56,axiom,(~acc_f16 | acc_p10 | acc_f17)) .
cnf(r_axiom57,axiom,(~acc_p10 | acc_f16_p)) .
cnf(r_axiom58,axiom,(~acc_f17_p | acc_f16_p)) .
cnf(r_axiom59,axiom,(~acc_f15 | acc_p9 | acc_f16)) .
cnf(r_axiom60,axiom,(~acc_p9 | acc_f15_p)) .
cnf(r_axiom61,axiom,(~acc_f16_p | acc_f15_p)) .
cnf(r_axiom62,axiom,(~acc_f22 | acc_p7 | acc_p12)) .
cnf(r_axiom63,axiom,(~acc_p7 | acc_f22_p)) .
cnf(r_axiom64,axiom,(~acc_p12 | acc_f22_p)) .
cnf(r_axiom65,axiom,(~acc_f21 | acc_p13 | acc_f22)) .
cnf(r_axiom66,axiom,(~acc_p13 | acc_f21_p)) .
cnf(r_axiom67,axiom,(~acc_f22_p | acc_f21_p)) .
cnf(r_axiom68,axiom,(~acc_f20 | acc_p4 | acc_f21)) .
cnf(r_axiom69,axiom,(~acc_p4 | acc_f20_p)) .
cnf(r_axiom70,axiom,(~acc_f21_p | acc_f20_p)) .
cnf(r_axiom71,axiom,(~acc_f19 | acc_p6 | acc_f20)) .
cnf(r_axiom72,axiom,(~acc_p6 | acc_f19_p)) .
