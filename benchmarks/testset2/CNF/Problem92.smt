;%%%%%%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | p0)) & ((p2 | (p1 | p3)) & ((p1 | (p2 | p4)) & (p1 | (p6 | p5))))) %%%%%%%%%%%%%%%%%%%%%
...
;%~f6 | ~f8 | zcl_0
(assert (or (not l_f6) (not l_f8) l_zcl_0))
...
;%~f3 | ~f5 | zcl_1
(assert (or (not l_f3) (not l_f5) l_zcl_1))
...
;%~f0 | ~f2 | zcl_2
(assert (or (not l_f0) (not l_f2) l_zcl_2))
...
;%~r_f6 | ~r_f8 | r_zcl_0
(assert (or (not r_f6) (not r_f8) r_zcl_0))
...
;%~r_f3 | ~r_f5 | r_zcl_1
(assert (or (not r_f3) (not r_f5) r_zcl_1))
...
;%~r_f0 | ~r_f2 | r_zcl_2
(assert (or (not r_f0) (not r_f2) r_zcl_2))
