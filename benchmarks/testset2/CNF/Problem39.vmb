%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (~p3 | (p4 | ~p0)))) & (~p4 | (~p6 | (p3 | (p1 | ~p5))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom19,axiom,(~acc_f7 | acc_p1 | acc_p5)) .
...
cnf(r_axiom28,axiom,(~acc_f4 | acc_p4 | acc_f5)) .
cnf(r_axiom29,axiom,(~acc_p4 | acc_f4_p)) .
cnf(r_axiom30,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom31,axiom,(~acc_zcl_2 | acc_f0)) .
cnf(r_axiom32,axiom,(~acc_zcl_2 | acc_f4)) .
cnf(r_axiom33,axiom,(~acc_f0 | ~acc_f4 | acc_zcl_2)) .
cnf(r_axiom34,axiom,(~acc_q | acc_zcl_2)) .
cnf(r_axiom35,axiom,(~acc_f0_p | ~acc_f4_p | acc_q)) .
