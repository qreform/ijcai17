%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | ~p0)) & ((p1 | (~p0 | p3)) & (~p2 | (~p0 | ~p4)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~f6 | p0 | p4)) .
cnf(l_axiom14,axiom,(~p0 | f6_p)) .
...
cnf(r_axiom14,axiom,(~acc_f3 | acc_p1 | acc_f4)) .
cnf(r_axiom15,axiom,(~acc_p1 | acc_f3_p)) .
...
cnf(r_axiom23,axiom,(~acc_zcl_4 | acc_f3)) .
cnf(r_axiom24,axiom,(~acc_zcl_4 | acc_f5)) .
cnf(r_axiom25,axiom,(~acc_f3 | ~acc_f5 | acc_zcl_4)) .
cnf(r_axiom26,axiom,(~acc_f2 | acc_zcl_4)) .
cnf(r_axiom27,axiom,(~acc_f3_p | ~acc_f5_p | acc_f2_p)) .
cnf(r_axiom28,axiom,(~acc_zcl_5 | acc_f0)) .
cnf(r_axiom29,axiom,(~acc_zcl_5 | acc_f2)) .
cnf(r_axiom30,axiom,(~acc_f0 | ~acc_f2 | acc_zcl_5)) .
cnf(r_axiom31,axiom,(~acc_q | acc_zcl_5)) .
cnf(r_axiom32,axiom,(~acc_f0_p | ~acc_f2_p | acc_q)) .
