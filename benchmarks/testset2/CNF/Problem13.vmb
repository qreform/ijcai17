%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | p0)) & (p1 | (p2 | p3))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom10,axiom,(~f2 | p1 | f3)) .
cnf(l_axiom11,axiom,(~p1 | f2_p)) .
...
cnf(r_axiom4,axiom,(~acc_f1 | acc_p2 | acc_p0)) .
cnf(r_axiom5,axiom,(~acc_p2 | acc_f1_p)) .
cnf(r_axiom6,axiom,(~acc_p0 | acc_f1_p)) .
cnf(r_axiom7,axiom,(~acc_f0 | acc_p1 | acc_f1)) .
cnf(r_axiom8,axiom,(~acc_p1 | acc_f0_p)) .
cnf(r_axiom9,axiom,(~acc_f1_p | acc_f0_p)) .
...
cnf(r_axiom16,axiom,(~acc_zcl_2 | acc_f0)) .
cnf(r_axiom17,axiom,(~acc_zcl_2 | acc_f2)) .
cnf(r_axiom18,axiom,(~acc_f0 | ~acc_f2 | acc_zcl_2)) .
cnf(r_axiom19,axiom,(~acc_q | acc_zcl_2)) .
cnf(r_axiom20,axiom,(~acc_f0_p | ~acc_f2_p | acc_q)) .
