...
;%~f14 | p15 | p12
(assert (or (not l_f14) l_p15 l_p12))
...
;%~f17 | p19 | p16
(assert (or (not l_f17) l_p19 l_p16))
...
;%~f16 | p18 | f17
(assert (or (not l_f16) l_p18 l_f17))
...
;%~f15 | p17 | f16
(assert (or (not l_f15) l_p17 l_f16))
...
(assert (or (not r_f14) r_p15 r_p12))
...
(assert (or (not r_f17) r_p19 r_p16))
...
;%~r_p16 | r_f17_p
(assert (or (not r_p16) r_f17_p))


;%~r_f16 | r_p18 | r_f17
(declare-fun r_f16 () Bool)
(assert (or (not r_f16) r_p18 r_f17))


;%~r_p18 | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p18) r_f16_p))
...
(assert (or (not r_f15) r_p17 r_f16))


;%~r_p17 | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p17) r_f15_p))
