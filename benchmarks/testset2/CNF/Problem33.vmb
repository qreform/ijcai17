%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & (p6 | (p7 | (p1 | (p0 | p5))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom20,axiom,(~acc_f7 | acc_p0 | acc_p5)) .
cnf(r_axiom21,axiom,(~acc_p0 | acc_f7_p)) .
cnf(r_axiom22,axiom,(~acc_p5 | acc_f7_p)) .
cnf(r_axiom23,axiom,(~acc_f6 | acc_p1 | acc_f7)) .
cnf(r_axiom24,axiom,(~acc_p1 | acc_f6_p)) .
cnf(r_axiom25,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom26,axiom,(~acc_f5 | acc_p7 | acc_f6)) .
cnf(r_axiom27,axiom,(~acc_p7 | acc_f5_p)) .
