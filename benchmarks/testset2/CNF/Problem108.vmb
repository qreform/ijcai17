%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (p3 | ~p0))) & ((~p0 | (~p5 | (~p3 | p4))) & ((p3 | (~p0 | (p3 | ~p6))) & (p2 | (~p1 | (~p3 | ~p7)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom28,axiom,(~f13 | p3 | p7)) .
cnf(l_axiom29,axiom,(~p3 | f13_p)) .
cnf(l_axiom30,axiom,(~p7 | f13_p)) .
cnf(l_axiom31,axiom,(~f12 | p1 | f13)) .
cnf(l_axiom32,axiom,(~p1 | f12_p)) .
cnf(l_axiom33,axiom,(~f13_p | f12_p)) .
cnf(l_axiom34,axiom,(~f11 | p2 | f12)) .
cnf(l_axiom35,axiom,(~p2 | f11_p)) .
...
cnf(r_axiom8,axiom,(~acc_f2 | acc_p3 | acc_p0)) .
cnf(r_axiom9,axiom,(~acc_p3 | acc_f2_p)) .
cnf(r_axiom10,axiom,(~acc_p0 | acc_f2_p)) .
cnf(r_axiom11,axiom,(~acc_f1 | acc_p2 | acc_f2)) .
...
cnf(r_axiom17,axiom,(~acc_f6 | acc_p3 | acc_p4)) .
cnf(r_axiom18,axiom,(~acc_p3 | acc_f6_p)) .
cnf(r_axiom19,axiom,(~acc_p4 | acc_f6_p)) .
cnf(r_axiom20,axiom,(~acc_f5 | acc_p5 | acc_f6)) .
cnf(r_axiom21,axiom,(~acc_p5 | acc_f5_p)) .
cnf(r_axiom22,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom23,axiom,(~acc_f4 | acc_p0 | acc_f5)) .
cnf(r_axiom24,axiom,(~acc_p0 | acc_f4_p)) .
cnf(r_axiom25,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom26,axiom,(~acc_f10 | acc_p3 | acc_p6)) .
cnf(r_axiom27,axiom,(~acc_p3 | acc_f10_p)) .
cnf(r_axiom28,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom29,axiom,(~acc_f9 | acc_p0 | acc_f10)) .
cnf(r_axiom30,axiom,(~acc_p0 | acc_f9_p)) .
cnf(r_axiom31,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom32,axiom,(~acc_f8 | acc_p3 | acc_f9)) .
cnf(r_axiom33,axiom,(~acc_p3 | acc_f8_p)) .
...
cnf(r_axiom38,axiom,(~acc_f12 | acc_p1 | acc_f13)) .
cnf(r_axiom39,axiom,(~acc_p1 | acc_f12_p)) .
cnf(r_axiom40,axiom,(~acc_f13_p | acc_f12_p)) .
cnf(r_axiom41,axiom,(~acc_f11 | acc_p2 | acc_f12)) .
cnf(r_axiom42,axiom,(~acc_p2 | acc_f11_p)) .
cnf(r_axiom43,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom44,axiom,(~acc_zcl_6 | acc_f8)) .
cnf(r_axiom45,axiom,(~acc_zcl_6 | acc_f11)) .
cnf(r_axiom46,axiom,(~acc_f8 | ~acc_f11 | acc_zcl_6)) .
cnf(r_axiom47,axiom,(~acc_f7 | acc_zcl_6)) .
cnf(r_axiom48,axiom,(~acc_f8_p | ~acc_f11_p | acc_f7_p)) .
cnf(r_axiom49,axiom,(~acc_zcl_7 | acc_f4)) .
cnf(r_axiom50,axiom,(~acc_zcl_7 | acc_f7)) .
cnf(r_axiom51,axiom,(~acc_f4 | ~acc_f7 | acc_zcl_7)) .
cnf(r_axiom52,axiom,(~acc_f3 | acc_zcl_7)) .
cnf(r_axiom53,axiom,(~acc_f4_p | ~acc_f7_p | acc_f3_p)) .
cnf(r_axiom54,axiom,(~acc_zcl_8 | acc_f0)) .
cnf(r_axiom55,axiom,(~acc_zcl_8 | acc_f3)) .
cnf(r_axiom56,axiom,(~acc_f0 | ~acc_f3 | acc_zcl_8)) .
cnf(r_axiom57,axiom,(~acc_q | acc_zcl_8)) .
