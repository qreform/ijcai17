%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p6 | (p1 | (p2 | (p7 | p5)))) & ((p9 | (p3 | (p10 | (p11 | p8)))) & (p0 | (p8 | (p13 | (p11 | p12))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom25,axiom,(~f13 | p11 | p8)) .
cnf(l_axiom26,axiom,(~p11 | f13_p)) .
cnf(l_axiom27,axiom,(~p8 | f13_p)) .
cnf(l_axiom28,axiom,(~f12 | p10 | f13)) .
cnf(l_axiom29,axiom,(~p10 | f12_p)) .
cnf(l_axiom30,axiom,(~f13_p | f12_p)) .
cnf(l_axiom31,axiom,(~f11 | p3 | f12)) .
cnf(l_axiom32,axiom,(~p3 | f11_p)) .
cnf(l_axiom33,axiom,(~f12_p | f11_p)) .
cnf(l_axiom34,axiom,(~f10 | p9 | f11)) .
cnf(l_axiom35,axiom,(~p9 | f10_p)) .
cnf(l_axiom36,axiom,(~f11_p | f10_p)) .
cnf(l_axiom37,axiom,(~f17 | p11 | p12)) .
cnf(l_axiom38,axiom,(~p11 | f17_p)) .
cnf(l_axiom39,axiom,(~p12 | f17_p)) .
cnf(l_axiom40,axiom,(~f16 | p13 | f17)) .
cnf(l_axiom41,axiom,(~p13 | f16_p)) .
cnf(l_axiom42,axiom,(~f17_p | f16_p)) .
cnf(l_axiom43,axiom,(~f15 | p8 | f16)) .
cnf(l_axiom44,axiom,(~p8 | f15_p)) .
cnf(l_axiom45,axiom,(~f16_p | f15_p)) .
cnf(l_axiom46,axiom,(~f14 | p0 | f15)) .
cnf(l_axiom47,axiom,(~p0 | f14_p)) .
...
cnf(r_axiom26,axiom,(~acc_f8 | acc_p7 | acc_p5)) .
cnf(r_axiom27,axiom,(~acc_p7 | acc_f8_p)) .
cnf(r_axiom28,axiom,(~acc_p5 | acc_f8_p)) .
cnf(r_axiom29,axiom,(~acc_f7 | acc_p2 | acc_f8)) .
cnf(r_axiom30,axiom,(~acc_p2 | acc_f7_p)) .
cnf(r_axiom31,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom32,axiom,(~acc_f6 | acc_p1 | acc_f7)) .
cnf(r_axiom33,axiom,(~acc_p1 | acc_f6_p)) .
cnf(r_axiom34,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom35,axiom,(~acc_f5 | acc_p6 | acc_f6)) .
cnf(r_axiom36,axiom,(~acc_p6 | acc_f5_p)) .
cnf(r_axiom37,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom38,axiom,(~acc_f13 | acc_p11 | acc_p8)) .
cnf(r_axiom39,axiom,(~acc_p11 | acc_f13_p)) .
...
cnf(r_axiom47,axiom,(~acc_f10 | acc_p9 | acc_f11)) .
cnf(r_axiom48,axiom,(~acc_p9 | acc_f10_p)) .
cnf(r_axiom49,axiom,(~acc_f11_p | acc_f10_p)) .
cnf(r_axiom50,axiom,(~acc_f17 | acc_p11 | acc_p12)) .
cnf(r_axiom51,axiom,(~acc_p11 | acc_f17_p)) .
cnf(r_axiom52,axiom,(~acc_p12 | acc_f17_p)) .
cnf(r_axiom53,axiom,(~acc_f16 | acc_p13 | acc_f17)) .
cnf(r_axiom54,axiom,(~acc_p13 | acc_f16_p)) .
cnf(r_axiom55,axiom,(~acc_f17_p | acc_f16_p)) .
cnf(r_axiom56,axiom,(~acc_f15 | acc_p8 | acc_f16)) .
cnf(r_axiom57,axiom,(~acc_p8 | acc_f15_p)) .
...
cnf(r_axiom62,axiom,(~acc_zcl_6 | acc_f10)) .
cnf(r_axiom63,axiom,(~acc_zcl_6 | acc_f14)) .
cnf(r_axiom64,axiom,(~acc_f10 | ~acc_f14 | acc_zcl_6)) .
cnf(r_axiom65,axiom,(~acc_f9 | acc_zcl_6)) .
cnf(r_axiom66,axiom,(~acc_f10_p | ~acc_f14_p | acc_f9_p)) .
cnf(r_axiom67,axiom,(~acc_zcl_7 | acc_f5)) .
cnf(r_axiom68,axiom,(~acc_zcl_7 | acc_f9)) .
cnf(r_axiom69,axiom,(~acc_f5 | ~acc_f9 | acc_zcl_7)) .
cnf(r_axiom70,axiom,(~acc_f4 | acc_zcl_7)) .
cnf(r_axiom71,axiom,(~acc_f5_p | ~acc_f9_p | acc_f4_p)) .
cnf(r_axiom72,axiom,(~acc_zcl_8 | acc_f0)) .
cnf(r_axiom73,axiom,(~acc_zcl_8 | acc_f4)) .
cnf(r_axiom74,axiom,(~acc_f0 | ~acc_f4 | acc_zcl_8)) .
cnf(r_axiom75,axiom,(~acc_q | acc_zcl_8)) .
cnf(r_axiom76,axiom,(~acc_f0_p | ~acc_f4_p | acc_q)) .
