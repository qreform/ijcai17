%%%%%%%%%%%%%%%% Target reformulation: ((p1 | ~p0) & ((~p3 | ~p2) & (p1 | p4))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom7,axiom,(~f3 | p1 | p4)) .
cnf(l_axiom8,axiom,(~p1 | f3_p)) .
cnf(l_axiom9,axiom,(~p4 | f3_p)) .
cnf(l_axiom10,axiom,(~zcl_4 | f2)) .
cnf(l_axiom11,axiom,(~zcl_4 | f3)) .
cnf(l_axiom12,axiom,(~f2 | ~f3 | zcl_4)) .
cnf(l_axiom13,axiom,(~f1 | zcl_4)) .
cnf(l_axiom14,axiom,(~f2_p | ~f3_p | f1_p)) .
cnf(l_axiom15,axiom,(~zcl_5 | f0)) .
cnf(l_axiom16,axiom,(~zcl_5 | f1)) .
cnf(l_axiom17,axiom,(~f0 | ~f1 | zcl_5)) .
cnf(l_axiom18,axiom,(~q | zcl_5)) .
...
cnf(r_axiom8,axiom,(~acc_f2 | acc_p3 | acc_p2)) .
cnf(r_axiom9,axiom,(~acc_p3 | acc_f2_p)) .
cnf(r_axiom10,axiom,(~acc_p2 | acc_f2_p)) .
cnf(r_axiom11,axiom,(~acc_f3 | acc_p1 | acc_p4)) .
cnf(r_axiom12,axiom,(~acc_p1 | acc_f3_p)) .
cnf(r_axiom13,axiom,(~acc_p4 | acc_f3_p)) .
cnf(r_axiom14,axiom,(~acc_zcl_4 | acc_f2)) .
cnf(r_axiom15,axiom,(~acc_zcl_4 | acc_f3)) .
cnf(r_axiom16,axiom,(~acc_f2 | ~acc_f3 | acc_zcl_4)) .
cnf(r_axiom17,axiom,(~acc_f1 | acc_zcl_4)) .
cnf(r_axiom18,axiom,(~acc_f2_p | ~acc_f3_p | acc_f1_p)) .
cnf(r_axiom19,axiom,(~acc_zcl_5 | acc_f0)) .
cnf(r_axiom20,axiom,(~acc_zcl_5 | acc_f1)) .
cnf(r_axiom21,axiom,(~acc_f0 | ~acc_f1 | acc_zcl_5)) .
cnf(r_axiom22,axiom,(~acc_q | acc_zcl_5)) .
cnf(r_axiom23,axiom,(~acc_f0_p | ~acc_f1_p | acc_q)) .
