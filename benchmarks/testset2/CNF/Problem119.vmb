%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (~p2 | (p3 | (~p4 | ~p0)))) & ((p1 | (~p2 | (p4 | (~p3 | ~p5)))) & ((~p7 | (~p8 | (~p9 | (~p3 | ~p6)))) & (p5 | (p6 | (~p1 | (~p5 | ~p10))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom40,axiom,(~f16 | p1 | f17)) .
cnf(l_axiom41,axiom,(~p1 | f16_p)) .
...
cnf(r_axiom26,axiom,(~acc_f7 | acc_p4 | acc_f8)) .
cnf(r_axiom27,axiom,(~acc_p4 | acc_f7_p)) .
cnf(r_axiom28,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom29,axiom,(~acc_f6 | acc_p2 | acc_f7)) .
cnf(r_axiom30,axiom,(~acc_p2 | acc_f6_p)) .
cnf(r_axiom31,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom32,axiom,(~acc_f5 | acc_p1 | acc_f6)) .
cnf(r_axiom33,axiom,(~acc_p1 | acc_f5_p)) .
cnf(r_axiom34,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom35,axiom,(~acc_f13 | acc_p3 | acc_p6)) .
...
cnf(r_axiom41,axiom,(~acc_f11 | acc_p8 | acc_f12)) .
cnf(r_axiom42,axiom,(~acc_p8 | acc_f11_p)) .
cnf(r_axiom43,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom44,axiom,(~acc_f10 | acc_p7 | acc_f11)) .
cnf(r_axiom45,axiom,(~acc_p7 | acc_f10_p)) .
...
cnf(r_axiom50,axiom,(~acc_f16 | acc_p1 | acc_f17)) .
cnf(r_axiom51,axiom,(~acc_p1 | acc_f16_p)) .
