%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p5 | (p1 | (p0 | p4))) & ((p7 | (p1 | (p8 | p6))) & (p8 | (p0 | (p10 | p9)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom19,axiom,(~f10 | p8 | p6)) .
cnf(l_axiom20,axiom,(~p8 | f10_p)) .
cnf(l_axiom21,axiom,(~p6 | f10_p)) .
cnf(l_axiom22,axiom,(~f9 | p1 | f10)) .
cnf(l_axiom23,axiom,(~p1 | f9_p)) .
cnf(l_axiom24,axiom,(~f10_p | f9_p)) .
cnf(l_axiom25,axiom,(~f8 | p7 | f9)) .
cnf(l_axiom26,axiom,(~p7 | f8_p)) .
cnf(l_axiom27,axiom,(~f9_p | f8_p)) .
cnf(l_axiom28,axiom,(~f13 | p10 | p9)) .
cnf(l_axiom29,axiom,(~p10 | f13_p)) .
cnf(l_axiom30,axiom,(~p9 | f13_p)) .
cnf(l_axiom31,axiom,(~f12 | p0 | f13)) .
cnf(l_axiom32,axiom,(~p0 | f12_p)) .
cnf(l_axiom33,axiom,(~f13_p | f12_p)) .
cnf(l_axiom34,axiom,(~f11 | p8 | f12)) .
cnf(l_axiom35,axiom,(~p8 | f11_p)) .
cnf(l_axiom36,axiom,(~f12_p | f11_p)) .
cnf(l_axiom37,axiom,(~zcl_6 | f8)) .
cnf(l_axiom38,axiom,(~zcl_6 | f11)) .
cnf(l_axiom39,axiom,(~f8 | ~f11 | zcl_6)) .
cnf(l_axiom40,axiom,(~f7 | zcl_6)) .
cnf(l_axiom41,axiom,(~f8_p | ~f11_p | f7_p)) .
cnf(l_axiom42,axiom,(~zcl_7 | f4)) .
cnf(l_axiom43,axiom,(~zcl_7 | f7)) .
cnf(l_axiom44,axiom,(~f4 | ~f7 | zcl_7)) .
cnf(l_axiom45,axiom,(~f3 | zcl_7)) .
cnf(l_axiom46,axiom,(~f4_p | ~f7_p | f3_p)) .
cnf(l_axiom47,axiom,(~zcl_8 | f0)) .
cnf(l_axiom48,axiom,(~zcl_8 | f3)) .
cnf(l_axiom49,axiom,(~f0 | ~f3 | zcl_8)) .
cnf(l_axiom50,axiom,(~q | zcl_8)) .
cnf(l_axiom51,axiom,(~f0_p | ~f3_p | q)) .
vampire(end_formula).
...
cnf(r_axiom20,axiom,(~acc_f6 | acc_p0 | acc_p4)) .
...
cnf(r_axiom26,axiom,(~acc_f4 | acc_p5 | acc_f5)) .
cnf(r_axiom27,axiom,(~acc_p5 | acc_f4_p)) .
cnf(r_axiom28,axiom,(~acc_f5_p | acc_f4_p)) .
cnf(r_axiom29,axiom,(~acc_f10 | acc_p8 | acc_p6)) .
cnf(r_axiom30,axiom,(~acc_p8 | acc_f10_p)) .
cnf(r_axiom31,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom32,axiom,(~acc_f9 | acc_p1 | acc_f10)) .
cnf(r_axiom33,axiom,(~acc_p1 | acc_f9_p)) .
cnf(r_axiom34,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom35,axiom,(~acc_f8 | acc_p7 | acc_f9)) .
cnf(r_axiom36,axiom,(~acc_p7 | acc_f8_p)) .
cnf(r_axiom37,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom38,axiom,(~acc_f13 | acc_p10 | acc_p9)) .
cnf(r_axiom39,axiom,(~acc_p10 | acc_f13_p)) .
cnf(r_axiom40,axiom,(~acc_p9 | acc_f13_p)) .
cnf(r_axiom41,axiom,(~acc_f12 | acc_p0 | acc_f13)) .
...
cnf(r_axiom47,axiom,(~acc_zcl_6 | acc_f8)) .
cnf(r_axiom48,axiom,(~acc_zcl_6 | acc_f11)) .
cnf(r_axiom49,axiom,(~acc_f8 | ~acc_f11 | acc_zcl_6)) .
cnf(r_axiom50,axiom,(~acc_f7 | acc_zcl_6)) .
cnf(r_axiom51,axiom,(~acc_f8_p | ~acc_f11_p | acc_f7_p)) .
cnf(r_axiom52,axiom,(~acc_zcl_7 | acc_f4)) .
cnf(r_axiom53,axiom,(~acc_zcl_7 | acc_f7)) .
cnf(r_axiom54,axiom,(~acc_f4 | ~acc_f7 | acc_zcl_7)) .
cnf(r_axiom55,axiom,(~acc_f3 | acc_zcl_7)) .
cnf(r_axiom56,axiom,(~acc_f4_p | ~acc_f7_p | acc_f3_p)) .
cnf(r_axiom57,axiom,(~acc_zcl_8 | acc_f0)) .
cnf(r_axiom58,axiom,(~acc_zcl_8 | acc_f3)) .
cnf(r_axiom59,axiom,(~acc_f0 | ~acc_f3 | acc_zcl_8)) .
cnf(r_axiom60,axiom,(~acc_q | acc_zcl_8)) .
cnf(r_axiom61,axiom,(~acc_f0_p | ~acc_f3_p | acc_q)) .
