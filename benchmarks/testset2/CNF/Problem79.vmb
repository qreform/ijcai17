%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (~p3 | (~p4 | ~p0)))) & ((~p3 | (p2 | (~p4 | (~p6 | ~p5)))) & (~p8 | (~p6 | (p2 | (~p9 | ~p7)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom25,axiom,(~f12 | p9 | p7)) .
cnf(l_axiom26,axiom,(~p9 | f12_p)) .
...
cnf(l_axiom34,axiom,(~f9 | p8 | f10)) .
cnf(l_axiom35,axiom,(~p8 | f9_p)) .
...
cnf(r_axiom22,axiom,(~acc_f8 | acc_p6 | acc_p5)) .
cnf(r_axiom23,axiom,(~acc_p6 | acc_f8_p)) .
cnf(r_axiom24,axiom,(~acc_p5 | acc_f8_p)) .
cnf(r_axiom25,axiom,(~acc_f7 | acc_p4 | acc_f8)) .
...
cnf(r_axiom31,axiom,(~acc_f5 | acc_p3 | acc_f6)) .
cnf(r_axiom32,axiom,(~acc_p3 | acc_f5_p)) .
cnf(r_axiom33,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom34,axiom,(~acc_f12 | acc_p9 | acc_p7)) .
cnf(r_axiom35,axiom,(~acc_p9 | acc_f12_p)) .
cnf(r_axiom36,axiom,(~acc_p7 | acc_f12_p)) .
cnf(r_axiom37,axiom,(~acc_f11 | acc_p2 | acc_f12)) .
cnf(r_axiom38,axiom,(~acc_p2 | acc_f11_p)) .
cnf(r_axiom39,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom40,axiom,(~acc_f10 | acc_p6 | acc_f11)) .
cnf(r_axiom41,axiom,(~acc_p6 | acc_f10_p)) .
cnf(r_axiom42,axiom,(~acc_f11_p | acc_f10_p)) .
cnf(r_axiom43,axiom,(~acc_f9 | acc_p8 | acc_f10)) .
cnf(r_axiom44,axiom,(~acc_p8 | acc_f9_p)) .
cnf(r_axiom45,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom46,axiom,(~acc_zcl_4 | acc_f5)) .
cnf(r_axiom47,axiom,(~acc_zcl_4 | acc_f9)) .
cnf(r_axiom48,axiom,(~acc_f5 | ~acc_f9 | acc_zcl_4)) .
cnf(r_axiom49,axiom,(~acc_f4 | acc_zcl_4)) .
cnf(r_axiom50,axiom,(~acc_f5_p | ~acc_f9_p | acc_f4_p)) .
cnf(r_axiom51,axiom,(~acc_zcl_5 | acc_f0)) .
cnf(r_axiom52,axiom,(~acc_zcl_5 | acc_f4)) .
cnf(r_axiom53,axiom,(~acc_f0 | ~acc_f4 | acc_zcl_5)) .
cnf(r_axiom54,axiom,(~acc_q | acc_zcl_5)) .
cnf(r_axiom55,axiom,(~acc_f0_p | ~acc_f4_p | acc_q)) .
