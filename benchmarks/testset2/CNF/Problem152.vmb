%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p2 | (p6 | (p0 | (p4 | p5)))) & ((p3 | (p6 | (p8 | (p3 | p7)))) & ((p7 | (p6 | (p1 | (p3 | p9)))) & (p0 | (p11 | (p2 | (p2 | p10)))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom46,axiom,(~f15 | p7 | f16)) .
cnf(l_axiom47,axiom,(~p7 | f15_p)) .
cnf(l_axiom48,axiom,(~f16_p | f15_p)) .
cnf(l_axiom49,axiom,(~f22 | p2 | p10)) .
cnf(l_axiom50,axiom,(~p2 | f22_p)) .
cnf(l_axiom51,axiom,(~p10 | f22_p)) .
cnf(l_axiom52,axiom,(~f21 | p2 | f22)) .
cnf(l_axiom53,axiom,(~p2 | f21_p)) .
cnf(l_axiom54,axiom,(~f22_p | f21_p)) .
cnf(l_axiom55,axiom,(~f20 | p11 | f21)) .
cnf(l_axiom56,axiom,(~p11 | f20_p)) .
cnf(l_axiom57,axiom,(~f21_p | f20_p)) .
cnf(l_axiom58,axiom,(~f19 | p0 | f20)) .
cnf(l_axiom59,axiom,(~p0 | f19_p)) .
...
cnf(r_axiom24,axiom,(~acc_f8 | acc_p4 | acc_p5)) .
cnf(r_axiom25,axiom,(~acc_p4 | acc_f8_p)) .
...
cnf(r_axiom30,axiom,(~acc_f6 | acc_p6 | acc_f7)) .
cnf(r_axiom31,axiom,(~acc_p6 | acc_f6_p)) .
cnf(r_axiom32,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom33,axiom,(~acc_f5 | acc_p2 | acc_f6)) .
cnf(r_axiom34,axiom,(~acc_p2 | acc_f5_p)) .
cnf(r_axiom35,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom36,axiom,(~acc_f13 | acc_p3 | acc_p7)) .
cnf(r_axiom37,axiom,(~acc_p3 | acc_f13_p)) .
...
cnf(r_axiom42,axiom,(~acc_f11 | acc_p6 | acc_f12)) .
cnf(r_axiom43,axiom,(~acc_p6 | acc_f11_p)) .
...
cnf(r_axiom48,axiom,(~acc_f18 | acc_p3 | acc_p9)) .
cnf(r_axiom49,axiom,(~acc_p3 | acc_f18_p)) .
cnf(r_axiom50,axiom,(~acc_p9 | acc_f18_p)) .
cnf(r_axiom51,axiom,(~acc_f17 | acc_p1 | acc_f18)) .
cnf(r_axiom52,axiom,(~acc_p1 | acc_f17_p)) .
cnf(r_axiom53,axiom,(~acc_f18_p | acc_f17_p)) .
cnf(r_axiom54,axiom,(~acc_f16 | acc_p6 | acc_f17)) .
cnf(r_axiom55,axiom,(~acc_p6 | acc_f16_p)) .
cnf(r_axiom56,axiom,(~acc_f17_p | acc_f16_p)) .
cnf(r_axiom57,axiom,(~acc_f15 | acc_p7 | acc_f16)) .
cnf(r_axiom58,axiom,(~acc_p7 | acc_f15_p)) .
cnf(r_axiom59,axiom,(~acc_f16_p | acc_f15_p)) .
cnf(r_axiom60,axiom,(~acc_f22 | acc_p2 | acc_p10)) .
cnf(r_axiom61,axiom,(~acc_p2 | acc_f22_p)) .
cnf(r_axiom62,axiom,(~acc_p10 | acc_f22_p)) .
cnf(r_axiom63,axiom,(~acc_f21 | acc_p2 | acc_f22)) .
cnf(r_axiom64,axiom,(~acc_p2 | acc_f21_p)) .
cnf(r_axiom65,axiom,(~acc_f22_p | acc_f21_p)) .
cnf(r_axiom66,axiom,(~acc_f20 | acc_p11 | acc_f21)) .
cnf(r_axiom67,axiom,(~acc_p11 | acc_f20_p)) .
cnf(r_axiom68,axiom,(~acc_f21_p | acc_f20_p)) .
cnf(r_axiom69,axiom,(~acc_f19 | acc_p0 | acc_f20)) .
cnf(r_axiom70,axiom,(~acc_p0 | acc_f19_p)) .
