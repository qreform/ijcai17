%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & ((p5 | (p2 | (p2 | p4))) & ((p2 | (p0 | (p2 | p6))) & (p3 | (p8 | (p4 | p7)))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom34,axiom,(~f11 | p3 | f12)) .
cnf(l_axiom35,axiom,(~p3 | f11_p)) .
...
cnf(r_axiom30,axiom,(~acc_f9 | acc_p0 | acc_f10)) .
cnf(r_axiom31,axiom,(~acc_p0 | acc_f9_p)) .
cnf(r_axiom32,axiom,(~acc_f10_p | acc_f9_p)) .
cnf(r_axiom33,axiom,(~acc_f8 | acc_p2 | acc_f9)) .
...
cnf(r_axiom42,axiom,(~acc_f11 | acc_p3 | acc_f12)) .
cnf(r_axiom43,axiom,(~acc_p3 | acc_f11_p)) .
