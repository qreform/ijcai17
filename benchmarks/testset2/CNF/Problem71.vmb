%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p4 | (p4 | (p0 | (p6 | p5)))) & (p8 | (p3 | (p2 | (p0 | p7)))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom21,axiom,(~acc_f8 | acc_p6 | acc_p5)) .
...
cnf(r_axiom30,axiom,(~acc_f5 | acc_p4 | acc_f6)) .
cnf(r_axiom31,axiom,(~acc_p4 | acc_f5_p)) .
...
cnf(r_axiom42,axiom,(~acc_f9 | acc_p8 | acc_f10)) .
cnf(r_axiom43,axiom,(~acc_p8 | acc_f9_p)) .
