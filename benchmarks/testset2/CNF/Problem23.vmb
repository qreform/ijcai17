%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | p0))) & (p0 | (p0 | (p2 | p4)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~f4 | p0 | f5)) .
cnf(l_axiom14,axiom,(~p0 | f4_p)) .
cnf(l_axiom15,axiom,(~f5_p | f4_p)) .
cnf(l_axiom16,axiom,(~f3 | p0 | f4)) .
cnf(l_axiom17,axiom,(~p0 | f3_p)) .
...
cnf(r_axiom5,axiom,(~acc_f2 | acc_p3 | acc_p0)) .
cnf(r_axiom6,axiom,(~acc_p3 | acc_f2_p)) .
cnf(r_axiom7,axiom,(~acc_p0 | acc_f2_p)) .
cnf(r_axiom8,axiom,(~acc_f1 | acc_p2 | acc_f2)) .
cnf(r_axiom9,axiom,(~acc_p2 | acc_f1_p)) .
cnf(r_axiom10,axiom,(~acc_f2_p | acc_f1_p)) .
...
cnf(r_axiom23,axiom,(~acc_zcl_2 | acc_f0)) .
cnf(r_axiom24,axiom,(~acc_zcl_2 | acc_f3)) .
cnf(r_axiom25,axiom,(~acc_f0 | ~acc_f3 | acc_zcl_2)) .
cnf(r_axiom26,axiom,(~acc_q | acc_zcl_2)) .
cnf(r_axiom27,axiom,(~acc_f0_p | ~acc_f3_p | acc_q)) .
