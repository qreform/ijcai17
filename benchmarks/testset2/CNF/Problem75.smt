...
;%~f12 | p14 | p10
(assert (or (not l_f12) l_p14 l_p10))
...
;%~f10 | p12 | f11
(assert (or (not l_f10) l_p12 l_f11))
...
;%~f9 | p11 | f10
(assert (or (not l_f9) l_p11 l_f10))
...
(assert (or (not r_f12) r_p14 r_p10))
...
(assert (or (not r_f10) r_p12 r_f11))
...
(assert (or (not r_f9) r_p11 r_f10))
