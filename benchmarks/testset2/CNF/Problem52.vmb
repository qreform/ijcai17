%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | p0)) & ((p0 | (p0 | p3)) & (p0 | (p1 | p4)))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~f6 | p1 | p4)) .
cnf(l_axiom14,axiom,(~p1 | f6_p)) .
cnf(l_axiom15,axiom,(~p4 | f6_p)) .
cnf(l_axiom16,axiom,(~f5 | p0 | f6)) .
cnf(l_axiom17,axiom,(~p0 | f5_p)) .
...
cnf(r_axiom14,axiom,(~acc_f3 | acc_p0 | acc_f4)) .
cnf(r_axiom15,axiom,(~acc_p0 | acc_f3_p)) .
cnf(r_axiom16,axiom,(~acc_f4_p | acc_f3_p)) .
cnf(r_axiom17,axiom,(~acc_f6 | acc_p1 | acc_p4)) .
cnf(r_axiom18,axiom,(~acc_p1 | acc_f6_p)) .
cnf(r_axiom19,axiom,(~acc_p4 | acc_f6_p)) .
cnf(r_axiom20,axiom,(~acc_f5 | acc_p0 | acc_f6)) .
cnf(r_axiom21,axiom,(~acc_p0 | acc_f5_p)) .
