%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (p2 | (p3 | (p4 | p0)))) & ((p6 | (p7 | (p3 | (p0 | p5)))) & (p1 | (p0 | (p9 | (p6 | p8)))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom22,axiom,(~acc_f8 | acc_p0 | acc_p5)) .
cnf(r_axiom23,axiom,(~acc_p0 | acc_f8_p)) .
cnf(r_axiom24,axiom,(~acc_p5 | acc_f8_p)) .
cnf(r_axiom25,axiom,(~acc_f7 | acc_p3 | acc_f8)) .
cnf(r_axiom26,axiom,(~acc_p3 | acc_f7_p)) .
cnf(r_axiom27,axiom,(~acc_f8_p | acc_f7_p)) .
cnf(r_axiom28,axiom,(~acc_f6 | acc_p7 | acc_f7)) .
cnf(r_axiom29,axiom,(~acc_p7 | acc_f6_p)) .
cnf(r_axiom30,axiom,(~acc_f7_p | acc_f6_p)) .
cnf(r_axiom31,axiom,(~acc_f5 | acc_p6 | acc_f6)) .
cnf(r_axiom32,axiom,(~acc_p6 | acc_f5_p)) .
cnf(r_axiom33,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom34,axiom,(~acc_f12 | acc_p6 | acc_p8)) .
...
cnf(r_axiom40,axiom,(~acc_f10 | acc_p0 | acc_f11)) .
cnf(r_axiom41,axiom,(~acc_p0 | acc_f10_p)) .
cnf(r_axiom42,axiom,(~acc_f11_p | acc_f10_p)) .
cnf(r_axiom43,axiom,(~acc_f9 | acc_p1 | acc_f10)) .
cnf(r_axiom44,axiom,(~acc_p1 | acc_f9_p)) .
