%%%%%%%%%%%%%%%% Target reformulation: ((p1 | (~p2 | (p3 | ~p0))) & (p5 | (p0 | (~p1 | ~p4)))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom15,axiom,(~acc_f5 | acc_p1 | acc_p4)) .
cnf(r_axiom16,axiom,(~acc_p1 | acc_f5_p)) .
cnf(r_axiom17,axiom,(~acc_p4 | acc_f5_p)) .
cnf(r_axiom18,axiom,(~acc_f4 | acc_p0 | acc_f5)) .
