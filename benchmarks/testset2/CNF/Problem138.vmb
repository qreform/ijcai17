%%%%%%%%%%%%%%%% Target reformulation: ((~p1 | (p2 | p0)) & ((~p1 | (~p4 | ~p3)) & ((~p0 | (~p1 | ~p5)) & ((p5 | (p2 | ~p6)) & (~p3 | (~p5 | ~p7)))))) %%%%%%%%%%%%%%%%
...
cnf(r_axiom26,axiom,(~acc_f10 | acc_p2 | acc_p6)) .
cnf(r_axiom27,axiom,(~acc_p2 | acc_f10_p)) .
...
cnf(r_axiom35,axiom,(~acc_f11 | acc_p3 | acc_f12)) .
cnf(r_axiom36,axiom,(~acc_p3 | acc_f11_p)) .
