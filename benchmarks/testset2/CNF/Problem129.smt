...
;%~f6 | ~f7 | zcl_0
(assert (or (not l_f6) (not l_f7) l_zcl_0))
...
;%~f2 | ~f3 | zcl_2
(assert (or (not l_f2) (not l_f3) l_zcl_2))
...
;%~f0 | ~f1 | zcl_3
(assert (or (not l_f0) (not l_f1) l_zcl_3))
...
;%~r_f6 | ~r_f7 | r_zcl_0
(assert (or (not r_f6) (not r_f7) r_zcl_0))
...
;%~r_f2 | ~r_f3 | r_zcl_2
(assert (or (not r_f2) (not r_f3) r_zcl_2))
...
;%~r_f0 | ~r_f1 | r_zcl_3
(assert (or (not r_f0) (not r_f1) r_zcl_3))
