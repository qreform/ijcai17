...
;%~f17 | p10 | p11
(assert (or (not l_f17) l_p10 l_p11))

;%------------------------Clausification end ------------------------%


;%Non-clausified dependency
;%(forall[]((p10 | ~p11) --> f17_p))
;%------------------------Clausification start------------------------%
...
;%~f14 | p12 | f15
(assert (or (not l_f14) l_p12 l_f15))
...
(assert (or (not r_f17) r_p10 r_p11))
...
(assert (or (not r_f14) r_p12 r_f15))
