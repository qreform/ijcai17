...
;%~p5 | ~p7 | zcl_8
(assert (or (not l_p5) (not l_p7) l_zcl_8))
...
;%~p5 | ~p7 | f13_p
(assert (or (not l_p5) (not l_p7) l_f13_p))
...
;%~p12 | ~f18 | zcl_13
(assert (or (not l_p12) (not l_f18) l_zcl_13))
...
;%~p7 | ~f17 | zcl_14
(assert (or (not l_p7) (not l_f17) l_zcl_14))
...
;%~p5 | ~p14 | f27_p
(assert (or (not l_p5) (not l_p14) l_f27_p))
...
;%~r_p5 | ~r_p7 | r_zcl_8
(assert (or (not r_p5) (not r_p7) r_zcl_8))
...
(assert (or (not r_p5) (not r_p7) r_f13_p))
...
;%~r_p12 | ~r_f18 | r_zcl_13
(assert (or (not r_p12) (not r_f18) r_zcl_13))
...
;%~r_p7 | ~r_f17 | r_zcl_14
(assert (or (not r_p7) (not r_f17) r_zcl_14))
...
(assert (or (not r_p5) (not r_p14) r_f27_p))
