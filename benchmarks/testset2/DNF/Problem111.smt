...
;%~p6 | ~f22 | zcl_18
(assert (or (not l_p6) (not l_f22) l_zcl_18))
...
;%~p11 | ~f21 | zcl_19
(assert (or (not l_p11) (not l_f21) l_zcl_19))
...
;%~p5 | ~p12 | zcl_20
(assert (or (not l_p5) (not l_p12) l_zcl_20))
...
;%~p5 | ~p12 | f27_p
(assert (or (not l_p5) (not l_p12) l_f27_p))
...
;%~r_p6 | ~r_f22 | r_zcl_18
(assert (or (not r_p6) (not r_f22) r_zcl_18))
...
;%~r_p11 | ~r_f21 | r_zcl_19
(assert (or (not r_p11) (not r_f21) r_zcl_19))
...
;%~r_p5 | ~r_p12 | r_zcl_20
(assert (or (not r_p5) (not r_p12) r_zcl_20))
...
(assert (or (not r_p5) (not r_p12) r_f27_p))
