...
;%~p4 | ~p7 | zcl_6
(assert (or (not l_p4) (not l_p7) l_zcl_6))
...
;%~p4 | ~p7 | f10_p
(assert (or (not l_p4) (not l_p7) l_f10_p))
...
;%~p7 | ~p8 | zcl_9
(assert (or (not l_p7) (not l_p8) l_zcl_9))
...
;%~p7 | ~p8 | f14_p
(assert (or (not l_p7) (not l_p8) l_f14_p))
...
;%~p8 | ~f21 | zcl_16
(assert (or (not l_p8) (not l_f21) l_zcl_16))
...
;%~r_p4 | ~r_p7 | r_zcl_6
(assert (or (not r_p4) (not r_p7) r_zcl_6))
...
(assert (or (not r_p4) (not r_p7) r_f10_p))
...
;%~r_p7 | ~r_p8 | r_zcl_9
(assert (or (not r_p7) (not r_p8) r_zcl_9))
...
(assert (or (not r_p7) (not r_p8) r_f14_p))
...
;%~r_p8 | ~r_f21 | r_zcl_16
(assert (or (not r_p8) (not r_f21) r_zcl_16))
