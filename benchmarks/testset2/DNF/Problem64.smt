...
;%Non-clausified dependency
;%(forall[]((~p19 & p16) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p19 | ~p16 | f17_p
(assert (or (not l_p19) (not l_p16) l_f17_p))
...
;%~p18 | ~f17 | zcl_13
(assert (or (not l_p18) (not l_f17) l_zcl_13))
...
;%Non-clausified dependency
;%(forall[]((~p18 & f17_p) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p18 | ~f17_p | f16_p
(assert (or (not l_p18) (not l_f17_p) l_f16_p))
...
;%~p17 | ~f16 | zcl_14
(assert (or (not l_p17) (not l_f16) l_zcl_14))
...
;%Non-clausified dependency
;%(forall[]((~p17 & f16_p) --> f15_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f15_p () Bool)
;%~p17 | ~f16_p | f15_p
(assert (or (not l_p17) (not l_f16_p) l_f15_p))
...
(assert (or (not r_p19) (not r_p16) r_f17_p))
...
;%~r_p18 | ~r_f17 | r_zcl_13
(assert (or (not r_p18) (not r_f17) r_zcl_13))
...
;%~r_p18 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p18) (not r_f17_p) r_f16_p))
...
;%~r_p17 | ~r_f16 | r_zcl_14
(assert (or (not r_p17) (not r_f16) r_zcl_14))
...
;%~r_p17 | ~r_f16_p | r_f15_p
(declare-fun r_f15_p () Bool)
(assert (or (not r_p17) (not r_f16_p) r_f15_p))
