...
;%~p10 | ~f18 | zcl_13
(assert (or (not l_p10) (not l_f18) l_zcl_13))
...
;%~p10 | ~f18_p | f17_p
(assert (or (not l_p10) (not l_f18_p) l_f17_p))
...
;%~p8 | ~f16 | zcl_15
(assert (or (not l_p8) (not l_f16) l_zcl_15))
...
;%~zcl_17 | p9
(assert (or (not l_zcl_17) l_p9))

;%~zcl_17 | f23
(assert (or (not l_zcl_17) l_f23))

;%~p9 | ~f23 | zcl_17
(assert (or (not l_p9) (not l_f23) l_zcl_17))
...
;%~zcl_27 | p8
(assert (or (not l_zcl_27) l_p8))

;%~zcl_27 | f30
(assert (or (not l_zcl_27) l_f30))

;%~p8 | ~f30 | zcl_27
(assert (or (not l_p8) (not l_f30) l_zcl_27))
...
;%~r_p10 | ~r_f18 | r_zcl_13
(assert (or (not r_p10) (not r_f18) r_zcl_13))
...
;%~r_p10 | ~r_f18_p | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p10) (not r_f18_p) r_f17_p))
...
;%~r_p8 | ~r_f16 | r_zcl_15
(assert (or (not r_p8) (not r_f16) r_zcl_15))
...
;%~r_p9 | ~r_f23 | r_zcl_17
(assert (or (not r_p9) (not r_f23) r_zcl_17))
...
;%~r_p8 | ~r_f30 | r_zcl_27
(assert (or (not r_p8) (not r_f30) r_zcl_27))
