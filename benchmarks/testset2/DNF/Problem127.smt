...
;%~p8 | ~p7 | zcl_4
(assert (or (not l_p8) (not l_p7) l_zcl_4))
...
;%~p10 | ~p9 | f10_p
(assert (or (not l_p10) (not l_p9) l_f10_p))
...
;%~p3 | ~p11 | zcl_6
(assert (or (not l_p3) (not l_p11) l_zcl_6))
...
;%~p3 | ~p11 | f11_p
(assert (or (not l_p3) (not l_p11) l_f11_p))
...
;%~r_p8 | ~r_p7 | r_zcl_4
(assert (or (not r_p8) (not r_p7) r_zcl_4))
...
(assert (or (not r_p10) (not r_p9) r_f10_p))
...
;%~r_p3 | ~r_p11 | r_zcl_6
(assert (or (not r_p3) (not r_p11) r_zcl_6))
...
(assert (or (not r_p3) (not r_p11) r_f11_p))
