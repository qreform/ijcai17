...
;%~p13 | ~f23 | zcl_17
(assert (or (not l_p13) (not l_f23) l_zcl_17))
...
;%~p13 | ~f23_p | f22_p
(assert (or (not l_p13) (not l_f23_p) l_f22_p))
...
;%~p5 | ~p14 | zcl_20
(assert (or (not l_p5) (not l_p14) l_zcl_20))
...
;%~p5 | ~p14 | f28_p
(assert (or (not l_p5) (not l_p14) l_f28_p))
...
;%~p17 | ~p15 | zcl_24
(assert (or (not l_p17) (not l_p15) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p17 & p15) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p17 | ~p15 | f32_p
(assert (or (not l_p17) (not l_p15) l_f32_p))
...
;%~r_p13 | ~r_f23 | r_zcl_17
(assert (or (not r_p13) (not r_f23) r_zcl_17))
...
;%~r_p13 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p13) (not r_f23_p) r_f22_p))
...
;%~r_p5 | ~r_p14 | r_zcl_20
(assert (or (not r_p5) (not r_p14) r_zcl_20))
...
(assert (or (not r_p5) (not r_p14) r_f28_p))
...
;%~r_p17 | ~r_p15 | r_zcl_24
(assert (or (not r_p17) (not r_p15) r_zcl_24))
...
(assert (or (not r_p17) (not r_p15) r_f32_p))
