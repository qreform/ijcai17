...
;%~p5 | ~p10 | f17_p
(assert (or (not l_p5) (not l_p10) l_f17_p))
...
;%~p5 | ~f17 | zcl_13
(assert (or (not l_p5) (not l_f17) l_zcl_13))
...
;%~zcl_15 | f15
(assert (or (not l_zcl_15) l_f15))

;%~p0 | ~f15 | zcl_15
(assert (or (not l_p0) (not l_f15) l_zcl_15))

(declare-fun l_f14 () Bool)
;%~f14 | zcl_15
(assert (or (not l_f14) l_zcl_15))
...
(assert (or (not r_p5) (not r_p10) r_f17_p))
...
;%~r_p5 | ~r_f17 | r_zcl_13
(assert (or (not r_p5) (not r_f17) r_zcl_13))
...
;%~r_zcl_15 | r_f15
(assert (or (not r_zcl_15) r_f15))


;%~r_p0 | ~r_f15 | r_zcl_15
(assert (or (not r_p0) (not r_f15) r_zcl_15))


;%~r_f14 | r_zcl_15
(declare-fun r_f14 () Bool)
(assert (or (not r_f14) r_zcl_15))
