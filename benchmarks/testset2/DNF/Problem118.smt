...
;%~p9 | ~p6 | zcl_8
(assert (or (not l_p9) (not l_p6) l_zcl_8))
...
;%~p9 | ~p6 | f13_p
(assert (or (not l_p9) (not l_p6) l_f13_p))
...
;%~p7 | ~f12 | zcl_10
(assert (or (not l_p7) (not l_f12) l_zcl_10))
...
;%~p6 | ~f17 | zcl_14
(assert (or (not l_p6) (not l_f17) l_zcl_14))
...
;%~p6 | ~f17_p | f16_p
(assert (or (not l_p6) (not l_f17_p) l_f16_p))
...
;%~p11 | ~f16 | zcl_15
(assert (or (not l_p11) (not l_f16) l_zcl_15))
...
;%~p10 | ~f22 | zcl_18
(assert (or (not l_p10) (not l_f22) l_zcl_18))
...
;%~p0 | ~p14 | f27_p
(assert (or (not l_p0) (not l_p14) l_f27_p))
...
;%~zcl_23 | p10
(assert (or (not l_zcl_23) l_p10))

;%~zcl_23 | f25
(assert (or (not l_zcl_23) l_f25))

;%~p10 | ~f25 | zcl_23
(assert (or (not l_p10) (not l_f25) l_zcl_23))
...
;%~r_p9 | ~r_p6 | r_zcl_8
(assert (or (not r_p9) (not r_p6) r_zcl_8))
...
(assert (or (not r_p9) (not r_p6) r_f13_p))
...
;%~r_p7 | ~r_f12 | r_zcl_10
(assert (or (not r_p7) (not r_f12) r_zcl_10))
...
;%~r_p6 | ~r_f17 | r_zcl_14
(assert (or (not r_p6) (not r_f17) r_zcl_14))
...
;%~r_p6 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p6) (not r_f17_p) r_f16_p))
...
;%~r_p11 | ~r_f16 | r_zcl_15
(assert (or (not r_p11) (not r_f16) r_zcl_15))
...
;%~r_p10 | ~r_f22 | r_zcl_18
(assert (or (not r_p10) (not r_f22) r_zcl_18))
...
(assert (or (not r_p0) (not r_p14) r_f27_p))
...
;%~r_p10 | ~r_f25 | r_zcl_23
(assert (or (not r_p10) (not r_f25) r_zcl_23))
