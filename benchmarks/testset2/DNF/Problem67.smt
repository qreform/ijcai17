...
;%~p10 | ~p8 | zcl_9
(assert (or (not l_p10) (not l_p8) l_zcl_9))
...
;%~p10 | ~p8 | f14_p
(assert (or (not l_p10) (not l_p8) l_f14_p))
...
;%Non-clausified dependency
;%(forall[]((p13 & ~p11) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p13 | ~p11 | f17_p
(assert (or (not l_p13) (not l_p11) l_f17_p))
...
;%~p0 | ~f17 | zcl_13
(assert (or (not l_p0) (not l_f17) l_zcl_13))
...
;%~p12 | ~f16 | zcl_14
(assert (or (not l_p12) (not l_f16) l_zcl_14))
...
;%~r_p10 | ~r_p8 | r_zcl_9
(assert (or (not r_p10) (not r_p8) r_zcl_9))
...
(assert (or (not r_p10) (not r_p8) r_f14_p))
...
(assert (or (not r_p13) (not r_p11) r_f17_p))
...
;%~r_p0 | ~r_f17 | r_zcl_13
(assert (or (not r_p0) (not r_f17) r_zcl_13))
...
;%~r_p12 | ~r_f16 | r_zcl_14
(assert (or (not r_p12) (not r_f16) r_zcl_14))
