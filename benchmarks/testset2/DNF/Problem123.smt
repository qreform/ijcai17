...
;%~p3 | ~p5 | f6_p
(assert (or (not l_p3) (not l_p5) l_f6_p))
...
;%~p3 | ~p7 | zcl_5
(assert (or (not l_p3) (not l_p7) l_zcl_5))
...
;%~p7 | ~p8 | zcl_6
(assert (or (not l_p7) (not l_p8) l_zcl_6))
...
;%~p7 | ~p8 | f11_p
(assert (or (not l_p7) (not l_p8) l_f11_p))
...
(assert (or (not r_p3) (not r_p5) r_f6_p))
...
;%~r_p3 | ~r_p7 | r_zcl_5
(assert (or (not r_p3) (not r_p7) r_zcl_5))
...
;%~r_p7 | ~r_p8 | r_zcl_6
(assert (or (not r_p7) (not r_p8) r_zcl_6))
...
(assert (or (not r_p7) (not r_p8) r_f11_p))
