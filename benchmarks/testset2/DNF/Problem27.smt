...
;%~p10 | ~p9 | f13_p
(assert (or (not l_p10) (not l_p9) l_f13_p))
...
;%~p0 | ~f13 | zcl_10
(assert (or (not l_p0) (not l_f13) l_zcl_10))
...
;%~p0 | ~f12 | zcl_11
(assert (or (not l_p0) (not l_f12) l_zcl_11))
...
(assert (or (not r_p10) (not r_p9) r_f13_p))
...
;%~r_p0 | ~r_f13 | r_zcl_10
(assert (or (not r_p0) (not r_f13) r_zcl_10))
...
;%~r_p0 | ~r_f12 | r_zcl_11
(assert (or (not r_p0) (not r_f12) r_zcl_11))
