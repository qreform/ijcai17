%%%%%%%%%%%%%%%% Target reformulation: ((~p1 & (~p2 & ~p0)) | ((p4 & (~p0 & ~p3)) | ((~p3 & (~p3 & ~p5)) | ((~p3 & (~p3 & p6)) | ((p6 & (~p3 & p7)) | ((~p5 & (~p3 & ~p8)) | (p3 & (~p3 & ~p9)))))))) %%%%%%%%%%%%%%%%
...
cnf(l_axiom13,axiom,(~p0 | ~p3 | zcl_30)) .
cnf(l_axiom14,axiom,(~f4 | zcl_30)) .
cnf(l_axiom15,axiom,(~p0 | ~p3 | f4_p)) .
...
cnf(l_axiom21,axiom,(~zcl_32 | p3)) .
cnf(l_axiom22,axiom,(~zcl_32 | p5)) .
cnf(l_axiom23,axiom,(~p3 | ~p5 | zcl_32)) .
cnf(l_axiom24,axiom,(~f7 | zcl_32)) .
cnf(l_axiom25,axiom,(~p3 | ~p5 | f7_p)) .
cnf(l_axiom26,axiom,(~zcl_33 | p3)) .
cnf(l_axiom27,axiom,(~zcl_33 | f7)) .
cnf(l_axiom28,axiom,(~p3 | ~f7 | zcl_33)) .
cnf(l_axiom29,axiom,(~f6 | zcl_33)) .
cnf(l_axiom30,axiom,(~p3 | ~f7_p | f6_p)) .
cnf(l_axiom31,axiom,(~zcl_34 | p3)) .
cnf(l_axiom32,axiom,(~zcl_34 | p6)) .
cnf(l_axiom33,axiom,(~p3 | ~p6 | zcl_34)) .
cnf(l_axiom34,axiom,(~f10 | zcl_34)) .
cnf(l_axiom35,axiom,(~p3 | ~p6 | f10_p)) .
cnf(l_axiom36,axiom,(~zcl_35 | p3)) .
cnf(l_axiom37,axiom,(~zcl_35 | f10)) .
cnf(l_axiom38,axiom,(~p3 | ~f10 | zcl_35)) .
cnf(l_axiom39,axiom,(~f9 | zcl_35)) .
cnf(l_axiom40,axiom,(~p3 | ~f10_p | f9_p)) .
cnf(l_axiom41,axiom,(~zcl_36 | p3)) .
cnf(l_axiom42,axiom,(~zcl_36 | p7)) .
cnf(l_axiom43,axiom,(~p3 | ~p7 | zcl_36)) .
cnf(l_axiom44,axiom,(~f13 | zcl_36)) .
cnf(l_axiom45,axiom,(~p3 | ~p7 | f13_p)) .
cnf(l_axiom46,axiom,(~zcl_37 | p6)) .
cnf(l_axiom47,axiom,(~zcl_37 | f13)) .
cnf(l_axiom48,axiom,(~p6 | ~f13 | zcl_37)) .
cnf(l_axiom49,axiom,(~f12 | zcl_37)) .
cnf(l_axiom50,axiom,(~p6 | ~f13_p | f12_p)) .
cnf(l_axiom51,axiom,(~zcl_38 | p3)) .
cnf(l_axiom52,axiom,(~zcl_38 | p8)) .
cnf(l_axiom53,axiom,(~p3 | ~p8 | zcl_38)) .
cnf(l_axiom54,axiom,(~f16 | zcl_38)) .
cnf(l_axiom55,axiom,(~p3 | ~p8 | f16_p)) .
cnf(l_axiom56,axiom,(~zcl_39 | p5)) .
cnf(l_axiom57,axiom,(~zcl_39 | f16)) .
cnf(l_axiom58,axiom,(~p5 | ~f16 | zcl_39)) .
cnf(l_axiom59,axiom,(~f15 | zcl_39)) .
cnf(l_axiom60,axiom,(~p5 | ~f16_p | f15_p)) .
cnf(l_axiom61,axiom,(~zcl_40 | p3)) .
cnf(l_axiom62,axiom,(~zcl_40 | p9)) .
cnf(l_axiom63,axiom,(~p3 | ~p9 | zcl_40)) .
cnf(l_axiom64,axiom,(~f18 | zcl_40)) .
cnf(l_axiom65,axiom,(~p3 | ~p9 | f18_p)) .
cnf(l_axiom66,axiom,(~zcl_41 | p3)) .
cnf(l_axiom67,axiom,(~zcl_41 | f18)) .
cnf(l_axiom68,axiom,(~p3 | ~f18 | zcl_41)) .
cnf(l_axiom69,axiom,(~f17 | zcl_41)) .
cnf(l_axiom70,axiom,(~p3 | ~f18_p | f17_p)) .
...
cnf(r_axiom10,axiom,(~acc_zcl_28 | acc_p2)) .
cnf(r_axiom11,axiom,(~acc_zcl_28 | acc_p0)) .
cnf(r_axiom12,axiom,(~acc_p2 | ~acc_p0 | acc_zcl_28)) .
cnf(r_axiom13,axiom,(~acc_f1 | acc_zcl_28)) .
cnf(r_axiom14,axiom,(~acc_p2 | ~acc_p0 | acc_f1_p)) .
cnf(r_axiom15,axiom,(~acc_zcl_29 | acc_p1)) .
cnf(r_axiom16,axiom,(~acc_zcl_29 | acc_f1)) .
cnf(r_axiom17,axiom,(~acc_p1 | ~acc_f1 | acc_zcl_29)) .
cnf(r_axiom18,axiom,(~acc_f0 | acc_zcl_29)) .
cnf(r_axiom19,axiom,(~acc_p1 | ~acc_f1_p | acc_f0_p)) .
cnf(r_axiom20,axiom,(~acc_zcl_30 | acc_p0)) .
cnf(r_axiom21,axiom,(~acc_zcl_30 | acc_p3)) .
cnf(r_axiom22,axiom,(~acc_p0 | ~acc_p3 | acc_zcl_30)) .
cnf(r_axiom23,axiom,(~acc_f4 | acc_zcl_30)) .
cnf(r_axiom24,axiom,(~acc_p0 | ~acc_p3 | acc_f4_p)) .
cnf(r_axiom25,axiom,(~acc_zcl_31 | acc_p4)) .
cnf(r_axiom26,axiom,(~acc_zcl_31 | acc_f4)) .
cnf(r_axiom27,axiom,(~acc_p4 | ~acc_f4 | acc_zcl_31)) .
cnf(r_axiom28,axiom,(~acc_f3 | acc_zcl_31)) .
cnf(r_axiom29,axiom,(~acc_p4 | ~acc_f4_p | acc_f3_p)) .
cnf(r_axiom30,axiom,(~acc_zcl_32 | acc_p3)) .
cnf(r_axiom31,axiom,(~acc_zcl_32 | acc_p5)) .
cnf(r_axiom32,axiom,(~acc_p3 | ~acc_p5 | acc_zcl_32)) .
cnf(r_axiom33,axiom,(~acc_f7 | acc_zcl_32)) .
cnf(r_axiom34,axiom,(~acc_p3 | ~acc_p5 | acc_f7_p)) .
cnf(r_axiom35,axiom,(~acc_zcl_33 | acc_p3)) .
cnf(r_axiom36,axiom,(~acc_zcl_33 | acc_f7)) .
cnf(r_axiom37,axiom,(~acc_p3 | ~acc_f7 | acc_zcl_33)) .
cnf(r_axiom38,axiom,(~acc_f6 | acc_zcl_33)) .
cnf(r_axiom39,axiom,(~acc_p3 | ~acc_f7_p | acc_f6_p)) .
cnf(r_axiom40,axiom,(~acc_zcl_34 | acc_p3)) .
cnf(r_axiom41,axiom,(~acc_zcl_34 | acc_p6)) .
cnf(r_axiom42,axiom,(~acc_p3 | ~acc_p6 | acc_zcl_34)) .
cnf(r_axiom43,axiom,(~acc_f10 | acc_zcl_34)) .
cnf(r_axiom44,axiom,(~acc_p3 | ~acc_p6 | acc_f10_p)) .
cnf(r_axiom45,axiom,(~acc_zcl_35 | acc_p3)) .
cnf(r_axiom46,axiom,(~acc_zcl_35 | acc_f10)) .
cnf(r_axiom47,axiom,(~acc_p3 | ~acc_f10 | acc_zcl_35)) .
cnf(r_axiom48,axiom,(~acc_f9 | acc_zcl_35)) .
cnf(r_axiom49,axiom,(~acc_p3 | ~acc_f10_p | acc_f9_p)) .
cnf(r_axiom50,axiom,(~acc_zcl_36 | acc_p3)) .
cnf(r_axiom51,axiom,(~acc_zcl_36 | acc_p7)) .
cnf(r_axiom52,axiom,(~acc_p3 | ~acc_p7 | acc_zcl_36)) .
cnf(r_axiom53,axiom,(~acc_f13 | acc_zcl_36)) .
cnf(r_axiom54,axiom,(~acc_p3 | ~acc_p7 | acc_f13_p)) .
cnf(r_axiom55,axiom,(~acc_zcl_37 | acc_p6)) .
cnf(r_axiom56,axiom,(~acc_zcl_37 | acc_f13)) .
cnf(r_axiom57,axiom,(~acc_p6 | ~acc_f13 | acc_zcl_37)) .
cnf(r_axiom58,axiom,(~acc_f12 | acc_zcl_37)) .
cnf(r_axiom59,axiom,(~acc_p6 | ~acc_f13_p | acc_f12_p)) .
cnf(r_axiom60,axiom,(~acc_zcl_38 | acc_p3)) .
cnf(r_axiom61,axiom,(~acc_zcl_38 | acc_p8)) .
cnf(r_axiom62,axiom,(~acc_p3 | ~acc_p8 | acc_zcl_38)) .
cnf(r_axiom63,axiom,(~acc_f16 | acc_zcl_38)) .
cnf(r_axiom64,axiom,(~acc_p3 | ~acc_p8 | acc_f16_p)) .
cnf(r_axiom65,axiom,(~acc_zcl_39 | acc_p5)) .
cnf(r_axiom66,axiom,(~acc_zcl_39 | acc_f16)) .
cnf(r_axiom67,axiom,(~acc_p5 | ~acc_f16 | acc_zcl_39)) .
cnf(r_axiom68,axiom,(~acc_f15 | acc_zcl_39)) .
cnf(r_axiom69,axiom,(~acc_p5 | ~acc_f16_p | acc_f15_p)) .
cnf(r_axiom70,axiom,(~acc_zcl_40 | acc_p3)) .
cnf(r_axiom71,axiom,(~acc_zcl_40 | acc_p9)) .
cnf(r_axiom72,axiom,(~acc_p3 | ~acc_p9 | acc_zcl_40)) .
cnf(r_axiom73,axiom,(~acc_f18 | acc_zcl_40)) .
cnf(r_axiom74,axiom,(~acc_p3 | ~acc_p9 | acc_f18_p)) .
cnf(r_axiom75,axiom,(~acc_zcl_41 | acc_p3)) .
cnf(r_axiom76,axiom,(~acc_zcl_41 | acc_f18)) .
cnf(r_axiom77,axiom,(~acc_p3 | ~acc_f18 | acc_zcl_41)) .
cnf(r_axiom78,axiom,(~acc_f17 | acc_zcl_41)) .
cnf(r_axiom79,axiom,(~acc_p3 | ~acc_f18_p | acc_f17_p)) .
cnf(r_axiom80,axiom,(~acc_f14 | acc_f15 | acc_f17)) .
cnf(r_axiom81,axiom,(~acc_f15_p | acc_f14_p)) .
cnf(r_axiom82,axiom,(~acc_f17_p | acc_f14_p)) .
cnf(r_axiom83,axiom,(~acc_f11 | acc_f12 | acc_f14)) .
cnf(r_axiom84,axiom,(~acc_f12_p | acc_f11_p)) .
cnf(r_axiom85,axiom,(~acc_f14_p | acc_f11_p)) .
cnf(r_axiom86,axiom,(~acc_f8 | acc_f9 | acc_f11)) .
cnf(r_axiom87,axiom,(~acc_f9_p | acc_f8_p)) .
cnf(r_axiom88,axiom,(~acc_f11_p | acc_f8_p)) .
cnf(r_axiom89,axiom,(~acc_f5 | acc_f6 | acc_f8)) .
cnf(r_axiom90,axiom,(~acc_f6_p | acc_f5_p)) .
cnf(r_axiom91,axiom,(~acc_f8_p | acc_f5_p)) .
cnf(r_axiom92,axiom,(~acc_f2 | acc_f3 | acc_f5)) .
cnf(r_axiom93,axiom,(~acc_f3_p | acc_f2_p)) .
cnf(r_axiom94,axiom,(~acc_f5_p | acc_f2_p)) .
cnf(r_axiom95,axiom,(~acc_q | acc_f0 | acc_f2)) .
cnf(r_axiom96,axiom,(~acc_f0_p | acc_q)) .
cnf(r_axiom97,axiom,(~acc_f2_p | acc_q)) .
