...
;%~p5 | ~p9 | zcl_12
(assert (or (not l_p5) (not l_p9) l_zcl_12))
...
;%~p5 | ~p9 | f18_p
(assert (or (not l_p5) (not l_p9) l_f18_p))
...
;%~p7 | ~p10 | zcl_16
(assert (or (not l_p7) (not l_p10) l_zcl_16))
...
;%~p7 | ~p10 | f23_p
(assert (or (not l_p7) (not l_p10) l_f23_p))
...
;%~p5 | ~p13 | f27_p
(assert (or (not l_p5) (not l_p13) l_f27_p))
...
;%~r_p5 | ~r_p9 | r_zcl_12
(assert (or (not r_p5) (not r_p9) r_zcl_12))
...
(assert (or (not r_p5) (not r_p9) r_f18_p))
...
;%~r_p7 | ~r_p10 | r_zcl_16
(assert (or (not r_p7) (not r_p10) r_zcl_16))
...
(assert (or (not r_p7) (not r_p10) r_f23_p))
...
(assert (or (not r_p5) (not r_p13) r_f27_p))
