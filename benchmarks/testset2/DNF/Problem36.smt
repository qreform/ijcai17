...
;%Non-clausified dependency
;%(forall[]((p19 & p15) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p19 | ~p15 | f17_p
(assert (or (not l_p19) (not l_p15) l_f17_p))
...
;%~p16 | ~f15 | zcl_15
(assert (or (not l_p16) (not l_f15) l_zcl_15))
...
(assert (or (not r_p19) (not r_p15) r_f17_p))
...
;%~r_p16 | ~r_f15 | r_zcl_15
(assert (or (not r_p16) (not r_f15) r_zcl_15))
