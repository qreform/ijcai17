...
;%~p8 | ~f10 | zcl_7
(assert (or (not l_p8) (not l_f10) l_zcl_7))
...
;%~p11 | ~p9 | zcl_9
(assert (or (not l_p11) (not l_p9) l_zcl_9))
...
;%~p11 | ~p9 | f14_p
(assert (or (not l_p11) (not l_p9) l_f14_p))
...
;%~p10 | ~f14 | zcl_10
(assert (or (not l_p10) (not l_f14) l_zcl_10))
...
;%Non-clausified dependency
;%(forall[]((p13 & p12) --> f17_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f17_p () Bool)
;%~p13 | ~p12 | f17_p
(assert (or (not l_p13) (not l_p12) l_f17_p))
...
;%~p6 | ~f17 | zcl_13
(assert (or (not l_p6) (not l_f17) l_zcl_13))
...
;%~r_p8 | ~r_f10 | r_zcl_7
(assert (or (not r_p8) (not r_f10) r_zcl_7))
...
;%~r_p11 | ~r_p9 | r_zcl_9
(assert (or (not r_p11) (not r_p9) r_zcl_9))
...
(assert (or (not r_p11) (not r_p9) r_f14_p))
...
;%~r_p10 | ~r_f14 | r_zcl_10
(assert (or (not r_p10) (not r_f14) r_zcl_10))
...
(assert (or (not r_p13) (not r_p12) r_f17_p))
...
;%~r_p6 | ~r_f17 | r_zcl_13
(assert (or (not r_p6) (not r_f17) r_zcl_13))
