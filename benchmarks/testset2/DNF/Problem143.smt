...
;%~p4 | ~p10 | zcl_15
(assert (or (not l_p4) (not l_p10) l_zcl_15))
...
;%~p4 | ~p10 | f22_p
(assert (or (not l_p4) (not l_p10) l_f22_p))
...
;%~p0 | ~p11 | f25_p
(assert (or (not l_p0) (not l_p11) l_f25_p))
...
;%~p12 | ~f25 | zcl_19
(assert (or (not l_p12) (not l_f25) l_zcl_19))
...
;%~r_p4 | ~r_p10 | r_zcl_15
(assert (or (not r_p4) (not r_p10) r_zcl_15))
...
(assert (or (not r_p4) (not r_p10) r_f22_p))
...
(assert (or (not r_p0) (not r_p11) r_f25_p))
...
;%~r_p12 | ~r_f25 | r_zcl_19
(assert (or (not r_p12) (not r_f25) r_zcl_19))
