...
;%~p3 | ~p5 | zcl_4
(assert (or (not l_p3) (not l_p5) l_zcl_4))
...
;%~p3 | ~p5 | f7_p
(assert (or (not l_p3) (not l_p5) l_f7_p))
...
;%~p3 | ~p6 | zcl_6
(assert (or (not l_p3) (not l_p6) l_zcl_6))
...
;%~p3 | ~f10 | zcl_7
(assert (or (not l_p3) (not l_f10) l_zcl_7))
...
;%~p3 | ~p7 | zcl_8
(assert (or (not l_p3) (not l_p7) l_zcl_8))
...
;%~p3 | ~p8 | zcl_10
(assert (or (not l_p3) (not l_p8) l_zcl_10))
...
;%~p3 | ~p8 | f16_p
(assert (or (not l_p3) (not l_p8) l_f16_p))
...
;%~p5 | ~f16 | zcl_11
(assert (or (not l_p5) (not l_f16) l_zcl_11))
...
;%~p3 | ~p9 | zcl_12
(assert (or (not l_p3) (not l_p9) l_zcl_12))
...
;%~p3 | ~p9 | f18_p
(assert (or (not l_p3) (not l_p9) l_f18_p))
...
;%~p3 | ~f18 | zcl_13
(assert (or (not l_p3) (not l_f18) l_zcl_13))
...
;%~p3 | ~f18_p | f17_p
(assert (or (not l_p3) (not l_f18_p) l_f17_p))
...
;%~r_p3 | ~r_p5 | r_zcl_4
(assert (or (not r_p3) (not r_p5) r_zcl_4))
...
(assert (or (not r_p3) (not r_p5) r_f7_p))
...
;%~r_p3 | ~r_p6 | r_zcl_6
(assert (or (not r_p3) (not r_p6) r_zcl_6))
...
;%~r_p3 | ~r_f10 | r_zcl_7
(assert (or (not r_p3) (not r_f10) r_zcl_7))
...
;%~r_p3 | ~r_p7 | r_zcl_8
(assert (or (not r_p3) (not r_p7) r_zcl_8))
...
;%~r_p3 | ~r_p8 | r_zcl_10
(assert (or (not r_p3) (not r_p8) r_zcl_10))
...
(assert (or (not r_p3) (not r_p8) r_f16_p))
...
;%~r_p5 | ~r_f16 | r_zcl_11
(assert (or (not r_p5) (not r_f16) r_zcl_11))
...
;%~r_p3 | ~r_p9 | r_zcl_12
(assert (or (not r_p3) (not r_p9) r_zcl_12))
...
(assert (or (not r_p3) (not r_p9) r_f18_p))
...
;%~r_p3 | ~r_f18 | r_zcl_13
(assert (or (not r_p3) (not r_f18) r_zcl_13))
...
;%~r_p3 | ~r_f18_p | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p3) (not r_f18_p) r_f17_p))
