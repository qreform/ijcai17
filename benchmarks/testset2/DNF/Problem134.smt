...
;%~p5 | ~p3 | zcl_2
(assert (or (not l_p5) (not l_p3) l_zcl_2))
...
;%~p5 | ~p3 | f4_p
(assert (or (not l_p5) (not l_p3) l_f4_p))
...
;%~p8 | ~p6 | zcl_4
(assert (or (not l_p8) (not l_p6) l_zcl_4))
...
;%~p8 | ~p6 | f7_p
(assert (or (not l_p8) (not l_p6) l_f7_p))
...
;%~p7 | ~f7 | zcl_5
(assert (or (not l_p7) (not l_f7) l_zcl_5))
...
;%~p11 | ~p9 | zcl_6
(assert (or (not l_p11) (not l_p9) l_zcl_6))
...
;%~p14 | ~p12 | zcl_8
(assert (or (not l_p14) (not l_p12) l_zcl_8))
...
;%Non-clausified dependency
;%(forall[]((~p14 & ~p12) --> f13_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f13_p () Bool)
;%~p14 | ~p12 | f13_p
(assert (or (not l_p14) (not l_p12) l_f13_p))
...
;%~p17 | ~p15 | zcl_10
(assert (or (not l_p17) (not l_p15) l_zcl_10))
...
;%Non-clausified dependency
;%(forall[]((~p17 & ~p15) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p17 | ~p15 | f16_p
(assert (or (not l_p17) (not l_p15) l_f16_p))
...
;%~zcl_12 | p18
(assert (or (not l_zcl_12) l_p18))

;%~p20 | ~p18 | zcl_12
(assert (or (not l_p20) (not l_p18) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((~p20 & ~p18) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p20 | ~p18 | f18_p
(assert (or (not l_p20) (not l_p18) l_f18_p))
...
;%~p19 | ~f18 | zcl_13
(assert (or (not l_p19) (not l_f18) l_zcl_13))
...
;%~r_p5 | ~r_p3 | r_zcl_2
(assert (or (not r_p5) (not r_p3) r_zcl_2))
...
(assert (or (not r_p5) (not r_p3) r_f4_p))
...
;%~r_p8 | ~r_p6 | r_zcl_4
(assert (or (not r_p8) (not r_p6) r_zcl_4))
...
(assert (or (not r_p8) (not r_p6) r_f7_p))
...
;%~r_p7 | ~r_f7 | r_zcl_5
(assert (or (not r_p7) (not r_f7) r_zcl_5))
...
;%~r_p11 | ~r_p9 | r_zcl_6
(assert (or (not r_p11) (not r_p9) r_zcl_6))
...
;%~r_p14 | ~r_p12 | r_zcl_8
(assert (or (not r_p14) (not r_p12) r_zcl_8))
...
(assert (or (not r_p14) (not r_p12) r_f13_p))
...
;%~r_p17 | ~r_p15 | r_zcl_10
(assert (or (not r_p17) (not r_p15) r_zcl_10))
...
(assert (or (not r_p17) (not r_p15) r_f16_p))
...
;%~r_zcl_12 | r_p18
(assert (or (not r_zcl_12) r_p18))


;%~r_p20 | ~r_p18 | r_zcl_12
(assert (or (not r_p20) (not r_p18) r_zcl_12))
...
(assert (or (not r_p20) (not r_p18) r_f18_p))
...
;%~r_p19 | ~r_f18 | r_zcl_13
(assert (or (not r_p19) (not r_f18) r_zcl_13))
