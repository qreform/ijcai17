...
;%~p7 | ~p6 | zcl_9
(assert (or (not l_p7) (not l_p6) l_zcl_9))
...
;%~p7 | ~p6 | f14_p
(assert (or (not l_p7) (not l_p6) l_f14_p))
...
;%~p9 | ~f17 | zcl_14
(assert (or (not l_p9) (not l_f17) l_zcl_14))
...
;%~p6 | ~p11 | f21_p
(assert (or (not l_p6) (not l_p11) l_f21_p))
...
;%~r_p7 | ~r_p6 | r_zcl_9
(assert (or (not r_p7) (not r_p6) r_zcl_9))
...
(assert (or (not r_p7) (not r_p6) r_f14_p))
...
;%~r_p9 | ~r_f17 | r_zcl_14
(assert (or (not r_p9) (not r_f17) r_zcl_14))
...
(assert (or (not r_p6) (not r_p11) r_f21_p))
