...
;%~p9 | ~p7 | f10_p
(assert (or (not l_p9) (not l_p7) l_f10_p))
...
;%~p3 | ~p10 | zcl_8
(assert (or (not l_p3) (not l_p10) l_zcl_8))
...
;%~p3 | ~p10 | f12_p
(assert (or (not l_p3) (not l_p10) l_f12_p))
...
;%~p11 | ~f12 | zcl_9
(assert (or (not l_p11) (not l_f12) l_zcl_9))
...
;%~p11 | ~f12_p | f11_p
(assert (or (not l_p11) (not l_f12_p) l_f11_p))
...
(assert (or (not r_p9) (not r_p7) r_f10_p))
...
;%~r_p3 | ~r_p10 | r_zcl_8
(assert (or (not r_p3) (not r_p10) r_zcl_8))
...
(assert (or (not r_p3) (not r_p10) r_f12_p))
...
;%~r_p11 | ~r_f12 | r_zcl_9
(assert (or (not r_p11) (not r_f12) r_zcl_9))
...
;%~r_p11 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p11) (not r_f12_p) r_f11_p))
