...
;%~p0 | ~p9 | zcl_8
(assert (or (not l_p0) (not l_p9) l_zcl_8))
...
;%~p0 | ~p9 | f12_p
(assert (or (not l_p0) (not l_p9) l_f12_p))
...
;%~p10 | ~f12 | zcl_9
(assert (or (not l_p10) (not l_f12) l_zcl_9))
...
;%~r_p0 | ~r_p9 | r_zcl_8
(assert (or (not r_p0) (not r_p9) r_zcl_8))
...
(assert (or (not r_p0) (not r_p9) r_f12_p))
...
;%~r_p10 | ~r_f12 | r_zcl_9
(assert (or (not r_p10) (not r_f12) r_zcl_9))
