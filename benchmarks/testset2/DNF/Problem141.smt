...
;%~p4 | ~p8 | zcl_12
(assert (or (not l_p4) (not l_p8) l_zcl_12))
...
;%~p4 | ~p8 | f18_p
(assert (or (not l_p4) (not l_p8) l_f18_p))
...
;%~p7 | ~p9 | f22_p
(assert (or (not l_p7) (not l_p9) l_f22_p))
...
;%~p10 | ~f22 | zcl_16
(assert (or (not l_p10) (not l_f22) l_zcl_16))
...
;%~p8 | ~p11 | zcl_18
(assert (or (not l_p8) (not l_p11) l_zcl_18))
...
;%~p8 | ~p11 | f25_p
(assert (or (not l_p8) (not l_p11) l_f25_p))
...
;%~r_p4 | ~r_p8 | r_zcl_12
(assert (or (not r_p4) (not r_p8) r_zcl_12))
...
(assert (or (not r_p4) (not r_p8) r_f18_p))
...
(assert (or (not r_p7) (not r_p9) r_f22_p))
...
;%~r_p10 | ~r_f22 | r_zcl_16
(assert (or (not r_p10) (not r_f22) r_zcl_16))
...
;%~r_p8 | ~r_p11 | r_zcl_18
(assert (or (not r_p8) (not r_p11) r_zcl_18))
...
(assert (or (not r_p8) (not r_p11) r_f25_p))
