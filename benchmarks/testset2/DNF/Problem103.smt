...
;%~p7 | ~p8 | zcl_12
(assert (or (not l_p7) (not l_p8) l_zcl_12))
...
;%~p7 | ~p8 | f18_p
(assert (or (not l_p7) (not l_p8) l_f18_p))
...
;%~p10 | ~p9 | zcl_15
(assert (or (not l_p10) (not l_p9) l_zcl_15))
...
;%~p10 | ~p9 | f21_p
(assert (or (not l_p10) (not l_p9) l_f21_p))
...
;%~r_p7 | ~r_p8 | r_zcl_12
(assert (or (not r_p7) (not r_p8) r_zcl_12))
...
(assert (or (not r_p7) (not r_p8) r_f18_p))
...
;%~r_p10 | ~r_p9 | r_zcl_15
(assert (or (not r_p10) (not r_p9) r_zcl_15))
...
(assert (or (not r_p10) (not r_p9) r_f21_p))
