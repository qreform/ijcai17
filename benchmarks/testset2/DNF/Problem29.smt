...
;%~p6 | ~f13 | zcl_10
(assert (or (not l_p6) (not l_f13) l_zcl_10))
...
;%~p4 | ~f12 | zcl_11
(assert (or (not l_p4) (not l_f12) l_zcl_11))
...
;%~p4 | ~f12_p | f11_p
(assert (or (not l_p4) (not l_f12_p) l_f11_p))
...
;%~r_p6 | ~r_f13 | r_zcl_10
(assert (or (not r_p6) (not r_f13) r_zcl_10))
...
;%~r_p4 | ~r_f12 | r_zcl_11
(assert (or (not r_p4) (not r_f12) r_zcl_11))
...
;%~r_p4 | ~r_f12_p | r_f11_p
(declare-fun r_f11_p () Bool)
(assert (or (not r_p4) (not r_f12_p) r_f11_p))
