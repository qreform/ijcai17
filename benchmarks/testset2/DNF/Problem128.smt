...
;%~p2 | ~p6 | f8_p
(assert (or (not l_p2) (not l_p6) l_f8_p))
...
;%~p5 | ~p7 | zcl_5
(assert (or (not l_p5) (not l_p7) l_zcl_5))
...
;%~p2 | ~p8 | zcl_6
(assert (or (not l_p2) (not l_p8) l_zcl_6))
...
;%~p2 | ~p8 | f11_p
(assert (or (not l_p2) (not l_p8) l_f11_p))
...
(assert (or (not r_p2) (not r_p6) r_f8_p))
...
;%~r_p5 | ~r_p7 | r_zcl_5
(assert (or (not r_p5) (not r_p7) r_zcl_5))
...
;%~r_p2 | ~r_p8 | r_zcl_6
(assert (or (not r_p2) (not r_p8) r_zcl_6))
...
(assert (or (not r_p2) (not r_p8) r_f11_p))
