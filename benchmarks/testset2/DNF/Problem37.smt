...
;%~p7 | ~p9 | f17_p
(assert (or (not l_p7) (not l_p9) l_f17_p))
...
;%~p10 | ~f16 | zcl_14
(assert (or (not l_p10) (not l_f16) l_zcl_14))
...
(assert (or (not r_p7) (not r_p9) r_f17_p))
...
;%~r_p10 | ~r_f16 | r_zcl_14
(assert (or (not r_p10) (not r_f16) r_zcl_14))
