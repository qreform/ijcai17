...
;%~p14 | ~p12 | zcl_12
(assert (or (not l_p14) (not l_p12) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((p14 & p12) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p14 | ~p12 | f18_p
(assert (or (not l_p14) (not l_p12) l_f18_p))
...
;%~r_p14 | ~r_p12 | r_zcl_12
(assert (or (not r_p14) (not r_p12) r_zcl_12))
...
(assert (or (not r_p14) (not r_p12) r_f18_p))
