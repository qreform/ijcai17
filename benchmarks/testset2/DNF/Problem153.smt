...
;%~p7 | ~p5 | zcl_4
(assert (or (not l_p7) (not l_p5) l_zcl_4))
...
;%~p7 | ~p5 | f8_p
(assert (or (not l_p7) (not l_p5) l_f8_p))
...
;%~p6 | ~f7 | zcl_6
(assert (or (not l_p6) (not l_f7) l_zcl_6))
...
;%~p0 | ~p10 | f18_p
(assert (or (not l_p0) (not l_p10) l_f18_p))
...
;%~p11 | ~f17 | zcl_14
(assert (or (not l_p11) (not l_f17) l_zcl_14))
...
;%Non-clausified dependency
;%(forall[]((p11 & f17_p) --> f16_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f16_p () Bool)
;%~p11 | ~f17_p | f16_p
(assert (or (not l_p11) (not l_f17_p) l_f16_p))
...
;%~p13 | ~p12 | zcl_16
(assert (or (not l_p13) (not l_p12) l_zcl_16))
...
;%Non-clausified dependency
;%(forall[]((p13 & p12) --> f23_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f23_p () Bool)
;%~p13 | ~p12 | f23_p
(assert (or (not l_p13) (not l_p12) l_f23_p))
...
;%~r_p7 | ~r_p5 | r_zcl_4
(assert (or (not r_p7) (not r_p5) r_zcl_4))
...
(assert (or (not r_p7) (not r_p5) r_f8_p))
...
;%~r_p6 | ~r_f7 | r_zcl_6
(assert (or (not r_p6) (not r_f7) r_zcl_6))
...
(assert (or (not r_p0) (not r_p10) r_f18_p))
...
;%~r_p11 | ~r_f17 | r_zcl_14
(assert (or (not r_p11) (not r_f17) r_zcl_14))
...
;%~r_p11 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p11) (not r_f17_p) r_f16_p))
...
;%~r_p13 | ~r_p12 | r_zcl_16
(assert (or (not r_p13) (not r_p12) r_zcl_16))
...
(assert (or (not r_p13) (not r_p12) r_f23_p))
