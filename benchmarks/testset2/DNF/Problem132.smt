...
;%~p4 | ~p3 | f4_p
(assert (or (not l_p4) (not l_p3) l_f4_p))
...
;%~p5 | ~p9 | zcl_10
(assert (or (not l_p5) (not l_p9) l_zcl_10))
...
;%~p9 | ~p10 | zcl_12
(assert (or (not l_p9) (not l_p10) l_zcl_12))
...
(assert (or (not r_p4) (not r_p3) r_f4_p))
...
;%~r_p5 | ~r_p9 | r_zcl_10
(assert (or (not r_p5) (not r_p9) r_zcl_10))
...
;%~r_p9 | ~r_p10 | r_zcl_12
(assert (or (not r_p9) (not r_p10) r_zcl_12))
