...
;%~p14 | ~f14 | zcl_10
(assert (or (not l_p14) (not l_f14) l_zcl_10))
...
;%~p13 | ~f13 | zcl_11
(assert (or (not l_p13) (not l_f13) l_zcl_11))
...
;%~zcl_12 | p16
(assert (or (not l_zcl_12) l_p16))

;%~p19 | ~p16 | zcl_12
(assert (or (not l_p19) (not l_p16) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((p19 & ~p16) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p19 | ~p16 | f18_p
(assert (or (not l_p19) (not l_p16) l_f18_p))
...
;%~zcl_15 | p20
(assert (or (not l_zcl_15) l_p20))

;%~p23 | ~p20 | zcl_15
(assert (or (not l_p23) (not l_p20) l_zcl_15))
...
;%Non-clausified dependency
;%(forall[]((p23 & ~p20) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p23 | ~p20 | f22_p
(assert (or (not l_p23) (not l_p20) l_f22_p))
...
;%~zcl_18 | p24
(assert (or (not l_zcl_18) l_p24))

;%~p27 | ~p24 | zcl_18
(assert (or (not l_p27) (not l_p24) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p27 & ~p24) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p27 | ~p24 | f25_p
(assert (or (not l_p27) (not l_p24) l_f25_p))
...
;%~p26 | ~f25 | zcl_19
(assert (or (not l_p26) (not l_f25) l_zcl_19))
...
;%~p25 | ~f24 | zcl_20
(assert (or (not l_p25) (not l_f24) l_zcl_20))
...
;%~r_p14 | ~r_f14 | r_zcl_10
(assert (or (not r_p14) (not r_f14) r_zcl_10))
...
;%~r_p13 | ~r_f13 | r_zcl_11
(assert (or (not r_p13) (not r_f13) r_zcl_11))
...
;%~r_zcl_12 | r_p16
(assert (or (not r_zcl_12) r_p16))


;%~r_p19 | ~r_p16 | r_zcl_12
(assert (or (not r_p19) (not r_p16) r_zcl_12))
...
(assert (or (not r_p19) (not r_p16) r_f18_p))
...
;%~r_zcl_15 | r_p20
(assert (or (not r_zcl_15) r_p20))


;%~r_p23 | ~r_p20 | r_zcl_15
(assert (or (not r_p23) (not r_p20) r_zcl_15))
...
(assert (or (not r_p23) (not r_p20) r_f22_p))
...
;%~r_zcl_18 | r_p24
(assert (or (not r_zcl_18) r_p24))


;%~r_p27 | ~r_p24 | r_zcl_18
(assert (or (not r_p27) (not r_p24) r_zcl_18))
...
(assert (or (not r_p27) (not r_p24) r_f25_p))
...
;%~r_p26 | ~r_f25 | r_zcl_19
(assert (or (not r_p26) (not r_f25) r_zcl_19))
...
;%~r_p25 | ~r_f24 | r_zcl_20
(assert (or (not r_p25) (not r_f24) r_zcl_20))
