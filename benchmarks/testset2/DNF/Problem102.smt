...
;%~p6 | ~p8 | zcl_9
(assert (or (not l_p6) (not l_p8) l_zcl_9))
...
;%~p6 | ~p8 | f14_p
(assert (or (not l_p6) (not l_p8) l_f14_p))
...
;%~p8 | ~f20 | zcl_17
(assert (or (not l_p8) (not l_f20) l_zcl_17))
...
;%~r_p6 | ~r_p8 | r_zcl_9
(assert (or (not r_p6) (not r_p8) r_zcl_9))
...
(assert (or (not r_p6) (not r_p8) r_f14_p))
...
;%~r_p8 | ~r_f20 | r_zcl_17
(assert (or (not r_p8) (not r_f20) r_zcl_17))
