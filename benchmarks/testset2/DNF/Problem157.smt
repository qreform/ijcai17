...
;%~p7 | ~f8 | zcl_5
(assert (or (not l_p7) (not l_f8) l_zcl_5))
...
;%~p10 | ~f13 | zcl_9
(assert (or (not l_p10) (not l_f13) l_zcl_9))
...
;%~p9 | ~f12 | zcl_10
(assert (or (not l_p9) (not l_f12) l_zcl_10))
...
;%~zcl_11 | p5
(assert (or (not l_zcl_11) l_p5))

;%~zcl_11 | f11
(assert (or (not l_zcl_11) l_f11))

;%~p5 | ~f11 | zcl_11
(assert (or (not l_p5) (not l_f11) l_zcl_11))
...
;%Non-clausified dependency
;%(forall[]((~p5 & f11_p) --> f10_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f10_p () Bool)
;%~p5 | ~f11_p | f10_p
(assert (or (not l_p5) (not l_f11_p) l_f10_p))
...
;%~p12 | ~p11 | zcl_12
(assert (or (not l_p12) (not l_p11) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((~p12 & ~p11) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p12 | ~p11 | f18_p
(assert (or (not l_p12) (not l_p11) l_f18_p))
...
;%~p0 | ~f18 | zcl_13
(assert (or (not l_p0) (not l_f18) l_zcl_13))
...
;%~zcl_14 | p5
(assert (or (not l_zcl_14) l_p5))

;%~zcl_14 | f17
(assert (or (not l_zcl_14) l_f17))

;%~p5 | ~f17 | zcl_14
(assert (or (not l_p5) (not l_f17) l_zcl_14))
...
;%~p5 | ~f17_p | f16_p
(assert (or (not l_p5) (not l_f17_p) l_f16_p))
...
;%~p0 | ~f16 | zcl_15
(assert (or (not l_p0) (not l_f16) l_zcl_15))
...
;%~zcl_16 | p13
(assert (or (not l_zcl_16) l_p13))

;%~p0 | ~p13 | zcl_16
(assert (or (not l_p0) (not l_p13) l_zcl_16))
...
;%~p0 | ~p13 | f23_p
(assert (or (not l_p0) (not l_p13) l_f23_p))
...
;%~p14 | ~f23 | zcl_17
(assert (or (not l_p14) (not l_f23) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((~p14 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p14 | ~f23_p | f22_p
(assert (or (not l_p14) (not l_f23_p) l_f22_p))
...
;%~p0 | ~f22 | zcl_18
(assert (or (not l_p0) (not l_f22) l_zcl_18))
...
;%~p5 | ~f21 | zcl_19
(assert (or (not l_p5) (not l_f21) l_zcl_19))
...
;%~p5 | ~f21_p | f20_p
(assert (or (not l_p5) (not l_f21_p) l_f20_p))
...
;%~p16 | ~f28 | zcl_21
(assert (or (not l_p16) (not l_f28) l_zcl_21))
...
;%~p16 | ~f28_p | f27_p
(assert (or (not l_p16) (not l_f28_p) l_f27_p))
...
;%~p5 | ~f26 | zcl_23
(assert (or (not l_p5) (not l_f26) l_zcl_23))
...
;%Non-clausified dependency
;%(forall[]((~p5 & f26_p) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p5 | ~f26_p | f25_p
(assert (or (not l_p5) (not l_f26_p) l_f25_p))
...
;%~zcl_24 | p17
(assert (or (not l_zcl_24) l_p17))

;%~p13 | ~p17 | zcl_24
(assert (or (not l_p13) (not l_p17) l_zcl_24))
...
;%Non-clausified dependency
;%(forall[]((p13 & ~p17) --> f32_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f32_p () Bool)
;%~p13 | ~p17 | f32_p
(assert (or (not l_p13) (not l_p17) l_f32_p))
...
;%~zcl_25 | p5
(assert (or (not l_zcl_25) l_p5))

;%~zcl_25 | f32
(assert (or (not l_zcl_25) l_f32))

;%~p5 | ~f32 | zcl_25
(assert (or (not l_p5) (not l_f32) l_zcl_25))
...
;%~zcl_26 | p5
(assert (or (not l_zcl_26) l_p5))

;%~zcl_26 | f31
(assert (or (not l_zcl_26) l_f31))

;%~p5 | ~f31 | zcl_26
(assert (or (not l_p5) (not l_f31) l_zcl_26))
...
;%Non-clausified dependency
;%(forall[]((p5 & f31_p) --> f30_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f30_p () Bool)
;%~p5 | ~f31_p | f30_p
(assert (or (not l_p5) (not l_f31_p) l_f30_p))
...
;%~p15 | ~f30 | zcl_27
(assert (or (not l_p15) (not l_f30) l_zcl_27))
...
;%~r_p7 | ~r_f8 | r_zcl_5
(assert (or (not r_p7) (not r_f8) r_zcl_5))
...
;%~r_p10 | ~r_f13 | r_zcl_9
(assert (or (not r_p10) (not r_f13) r_zcl_9))
...
;%~r_p9 | ~r_f12 | r_zcl_10
(assert (or (not r_p9) (not r_f12) r_zcl_10))
...
;%~r_p5 | ~r_f11 | r_zcl_11
(assert (or (not r_p5) (not r_f11) r_zcl_11))
...
;%~r_p5 | ~r_f11_p | r_f10_p
(declare-fun r_f10_p () Bool)
(assert (or (not r_p5) (not r_f11_p) r_f10_p))


;%~r_zcl_12 | r_p12
(declare-fun r_zcl_12 () Bool)
(assert (or (not r_zcl_12) r_p12))
...
;%~r_p12 | ~r_p11 | r_zcl_12
(assert (or (not r_p12) (not r_p11) r_zcl_12))
...
(assert (or (not r_p12) (not r_p11) r_f18_p))
...
;%~r_p0 | ~r_f18 | r_zcl_13
(assert (or (not r_p0) (not r_f18) r_zcl_13))
...
;%~r_p5 | ~r_f17 | r_zcl_14
(assert (or (not r_p5) (not r_f17) r_zcl_14))
...
;%~r_p5 | ~r_f17_p | r_f16_p
(declare-fun r_f16_p () Bool)
(assert (or (not r_p5) (not r_f17_p) r_f16_p))
...
;%~r_p0 | ~r_f16 | r_zcl_15
(assert (or (not r_p0) (not r_f16) r_zcl_15))
...
;%~r_zcl_16 | r_p13
(assert (or (not r_zcl_16) r_p13))


;%~r_p0 | ~r_p13 | r_zcl_16
(assert (or (not r_p0) (not r_p13) r_zcl_16))
...
(assert (or (not r_p0) (not r_p13) r_f23_p))
...
;%~r_p14 | ~r_f23 | r_zcl_17
(assert (or (not r_p14) (not r_f23) r_zcl_17))
...
;%~r_p14 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p14) (not r_f23_p) r_f22_p))
...
;%~r_p0 | ~r_f22 | r_zcl_18
(assert (or (not r_p0) (not r_f22) r_zcl_18))
...
;%~r_p5 | ~r_f21 | r_zcl_19
(assert (or (not r_p5) (not r_f21) r_zcl_19))
...
;%~r_p5 | ~r_f21_p | r_f20_p
(declare-fun r_f20_p () Bool)
(assert (or (not r_p5) (not r_f21_p) r_f20_p))
...
;%~r_p16 | ~r_f28 | r_zcl_21
(assert (or (not r_p16) (not r_f28) r_zcl_21))
...
;%~r_p16 | ~r_f28_p | r_f27_p
(declare-fun r_f27_p () Bool)
(assert (or (not r_p16) (not r_f28_p) r_f27_p))
...
;%~r_p5 | ~r_f26 | r_zcl_23
(assert (or (not r_p5) (not r_f26) r_zcl_23))
...
;%~r_p5 | ~r_f26_p | r_f25_p
(declare-fun r_f25_p () Bool)
(assert (or (not r_p5) (not r_f26_p) r_f25_p))
...
;%~r_zcl_24 | r_p17
(assert (or (not r_zcl_24) r_p17))


;%~r_p13 | ~r_p17 | r_zcl_24
(assert (or (not r_p13) (not r_p17) r_zcl_24))
...
(assert (or (not r_p13) (not r_p17) r_f32_p))


;%~r_zcl_25 | r_p5
(declare-fun r_zcl_25 () Bool)
(assert (or (not r_zcl_25) r_p5))
...
;%~r_p5 | ~r_f32 | r_zcl_25
(assert (or (not r_p5) (not r_f32) r_zcl_25))
...
;%~r_p5 | ~r_f31 | r_zcl_26
(assert (or (not r_p5) (not r_f31) r_zcl_26))
...
;%~r_p5 | ~r_f31_p | r_f30_p
(declare-fun r_f30_p () Bool)
(assert (or (not r_p5) (not r_f31_p) r_f30_p))
...
;%~r_p15 | ~r_f30 | r_zcl_27
(assert (or (not r_p15) (not r_f30) r_zcl_27))
