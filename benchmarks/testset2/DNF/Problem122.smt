...
;%~p2 | ~p6 | f6_p
(assert (or (not l_p2) (not l_p6) l_f6_p))
...
;%~p0 | ~p7 | zcl_4
(assert (or (not l_p0) (not l_p7) l_zcl_4))
...
;%~p0 | ~p7 | f8_p
(assert (or (not l_p0) (not l_p7) l_f8_p))
...
(assert (or (not r_p2) (not r_p6) r_f6_p))
...
;%~r_p0 | ~r_p7 | r_zcl_4
(assert (or (not r_p0) (not r_p7) r_zcl_4))
...
(assert (or (not r_p0) (not r_p7) r_f8_p))
