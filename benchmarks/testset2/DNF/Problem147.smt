...
;%~p4 | ~p6 | zcl_6
(assert (or (not l_p4) (not l_p6) l_zcl_6))
...
;%~p4 | ~p6 | f10_p
(assert (or (not l_p4) (not l_p6) l_f10_p))
...
;%~p7 | ~f10 | zcl_7
(assert (or (not l_p7) (not l_f10) l_zcl_7))
...
;%~p0 | ~p8 | zcl_9
(assert (or (not l_p0) (not l_p8) l_zcl_9))
...
;%~p0 | ~f14 | zcl_10
(assert (or (not l_p0) (not l_f14) l_zcl_10))
...
;%~p9 | ~f13 | zcl_11
(assert (or (not l_p9) (not l_f13) l_zcl_11))
...
;%~p8 | ~p10 | zcl_12
(assert (or (not l_p8) (not l_p10) l_zcl_12))
...
;%~p8 | ~p10 | f18_p
(assert (or (not l_p8) (not l_p10) l_f18_p))
...
;%~zcl_13 | p4
(assert (or (not l_zcl_13) l_p4))

;%~zcl_13 | f18
(assert (or (not l_zcl_13) l_f18))

;%~p4 | ~f18 | zcl_13
(assert (or (not l_p4) (not l_f18) l_zcl_13))
...
;%~p4 | ~f18_p | f17_p
(assert (or (not l_p4) (not l_f18_p) l_f17_p))
...
;%~p15 | ~p13 | zcl_18
(assert (or (not l_p15) (not l_p13) l_zcl_18))
...
;%Non-clausified dependency
;%(forall[]((p15 & ~p13) --> f25_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f25_p () Bool)
;%~p15 | ~p13 | f25_p
(assert (or (not l_p15) (not l_p13) l_f25_p))
...
;%~p14 | ~f25 | zcl_19
(assert (or (not l_p14) (not l_f25) l_zcl_19))
...
;%~p0 | ~f24 | zcl_20
(assert (or (not l_p0) (not l_f24) l_zcl_20))
...
;%~r_p4 | ~r_p6 | r_zcl_6
(assert (or (not r_p4) (not r_p6) r_zcl_6))
...
(assert (or (not r_p4) (not r_p6) r_f10_p))
...
;%~r_p7 | ~r_f10 | r_zcl_7
(assert (or (not r_p7) (not r_f10) r_zcl_7))
...
;%~r_p0 | ~r_p8 | r_zcl_9
(assert (or (not r_p0) (not r_p8) r_zcl_9))
...
;%~r_p0 | ~r_f14 | r_zcl_10
(assert (or (not r_p0) (not r_f14) r_zcl_10))
...
;%~r_p9 | ~r_f13 | r_zcl_11
(assert (or (not r_p9) (not r_f13) r_zcl_11))
...
;%~r_p8 | ~r_p10 | r_zcl_12
(assert (or (not r_p8) (not r_p10) r_zcl_12))
...
(assert (or (not r_p8) (not r_p10) r_f18_p))


;%~r_zcl_13 | r_p4
(declare-fun r_zcl_13 () Bool)
(assert (or (not r_zcl_13) r_p4))
...
;%~r_p4 | ~r_f18 | r_zcl_13
(assert (or (not r_p4) (not r_f18) r_zcl_13))
...
;%~r_p4 | ~r_f18_p | r_f17_p
(declare-fun r_f17_p () Bool)
(assert (or (not r_p4) (not r_f18_p) r_f17_p))
...
;%~r_p15 | ~r_p13 | r_zcl_18
(assert (or (not r_p15) (not r_p13) r_zcl_18))
...
(assert (or (not r_p15) (not r_p13) r_f25_p))
...
;%~r_p14 | ~r_f25 | r_zcl_19
(assert (or (not r_p14) (not r_f25) r_zcl_19))
...
;%~r_p0 | ~r_f24 | r_zcl_20
(assert (or (not r_p0) (not r_f24) r_zcl_20))
