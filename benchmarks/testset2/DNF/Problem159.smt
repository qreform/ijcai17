...
;%~p7 | ~f18 | zcl_13
(assert (or (not l_p7) (not l_f18) l_zcl_13))
...
;%~p10 | ~f16 | zcl_15
(assert (or (not l_p10) (not l_f16) l_zcl_15))
...
;%~p0 | ~p12 | zcl_16
(assert (or (not l_p0) (not l_p12) l_zcl_16))
...
;%~p0 | ~p12 | f23_p
(assert (or (not l_p0) (not l_p12) l_f23_p))
...
;%~zcl_17 | p5
(assert (or (not l_zcl_17) l_p5))

;%~zcl_17 | f23
(assert (or (not l_zcl_17) l_f23))

;%~p5 | ~f23 | zcl_17
(assert (or (not l_p5) (not l_f23) l_zcl_17))
...
;%Non-clausified dependency
;%(forall[]((~p5 & f23_p) --> f22_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f22_p () Bool)
;%~p5 | ~f23_p | f22_p
(assert (or (not l_p5) (not l_f23_p) l_f22_p))
...
;%~p15 | ~f32 | zcl_25
(assert (or (not l_p15) (not l_f32) l_zcl_25))
...
;%~p13 | ~f30 | zcl_27
(assert (or (not l_p13) (not l_f30) l_zcl_27))
...
;%Non-clausified dependency
;%(forall[]((~p13 & f30_p) --> f29_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f29_p () Bool)
;%~p13 | ~f30_p | f29_p
(assert (or (not l_p13) (not l_f30_p) l_f29_p))
...
;%~r_p7 | ~r_f18 | r_zcl_13
(assert (or (not r_p7) (not r_f18) r_zcl_13))
...
;%~r_p10 | ~r_f16 | r_zcl_15
(assert (or (not r_p10) (not r_f16) r_zcl_15))
...
;%~r_p0 | ~r_p12 | r_zcl_16
(assert (or (not r_p0) (not r_p12) r_zcl_16))
...
(assert (or (not r_p0) (not r_p12) r_f23_p))


;%~r_zcl_17 | r_p5
(declare-fun r_zcl_17 () Bool)
(assert (or (not r_zcl_17) r_p5))
...
;%~r_p5 | ~r_f23 | r_zcl_17
(assert (or (not r_p5) (not r_f23) r_zcl_17))
...
;%~r_p5 | ~r_f23_p | r_f22_p
(declare-fun r_f22_p () Bool)
(assert (or (not r_p5) (not r_f23_p) r_f22_p))
...
;%~r_p15 | ~r_f32 | r_zcl_25
(assert (or (not r_p15) (not r_f32) r_zcl_25))
...
;%~r_p13 | ~r_f30 | r_zcl_27
(assert (or (not r_p13) (not r_f30) r_zcl_27))
...
;%~r_p13 | ~r_f30_p | r_f29_p
(declare-fun r_f29_p () Bool)
(assert (or (not r_p13) (not r_f30_p) r_f29_p))
