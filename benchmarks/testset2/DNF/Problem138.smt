...
;%~p7 | ~p6 | zcl_4
(assert (or (not l_p7) (not l_p6) l_zcl_4))
...
;%~p7 | ~p6 | f7_p
(assert (or (not l_p7) (not l_p6) l_f7_p))
...
;%~p3 | ~p8 | zcl_6
(assert (or (not l_p3) (not l_p8) l_zcl_6))
...
;%~p3 | ~p8 | f10_p
(assert (or (not l_p3) (not l_p8) l_f10_p))
...
;%~p9 | ~f10 | zcl_7
(assert (or (not l_p9) (not l_f10) l_zcl_7))
...
;%~p8 | ~p10 | zcl_8
(assert (or (not l_p8) (not l_p10) l_zcl_8))
...
;%~p8 | ~p10 | f13_p
(assert (or (not l_p8) (not l_p10) l_f13_p))
...
;%~p0 | ~p11 | zcl_10
(assert (or (not l_p0) (not l_p11) l_zcl_10))
...
;%~p13 | ~p12 | zcl_12
(assert (or (not l_p13) (not l_p12) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((~p13 & p12) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p13 | ~p12 | f18_p
(assert (or (not l_p13) (not l_p12) l_f18_p))
...
;%~r_p7 | ~r_p6 | r_zcl_4
(assert (or (not r_p7) (not r_p6) r_zcl_4))
...
(assert (or (not r_p7) (not r_p6) r_f7_p))
...
;%~r_p3 | ~r_p8 | r_zcl_6
(assert (or (not r_p3) (not r_p8) r_zcl_6))
...
(assert (or (not r_p3) (not r_p8) r_f10_p))
...
;%~r_p9 | ~r_f10 | r_zcl_7
(assert (or (not r_p9) (not r_f10) r_zcl_7))
...
;%~r_p8 | ~r_p10 | r_zcl_8
(assert (or (not r_p8) (not r_p10) r_zcl_8))
...
(assert (or (not r_p8) (not r_p10) r_f13_p))
...
;%~r_p0 | ~r_p11 | r_zcl_10
(assert (or (not r_p0) (not r_p11) r_zcl_10))
...
;%~r_p13 | ~r_p12 | r_zcl_12
(assert (or (not r_p13) (not r_p12) r_zcl_12))
...
(assert (or (not r_p13) (not r_p12) r_f18_p))
