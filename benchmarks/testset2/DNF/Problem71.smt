...
;%~p0 | ~p9 | zcl_16
(assert (or (not l_p0) (not l_p9) l_zcl_16))
...
;%~p10 | ~f20 | zcl_19
(assert (or (not l_p10) (not l_f20) l_zcl_19))
...
;%~r_p0 | ~r_p9 | r_zcl_16
(assert (or (not r_p0) (not r_p9) r_zcl_16))
...
;%~r_p10 | ~r_f20 | r_zcl_19
(assert (or (not r_p10) (not r_f20) r_zcl_19))
