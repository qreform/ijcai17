...
;%~p6 | ~f7 | zcl_5
(assert (or (not l_p6) (not l_f7) l_zcl_5))
...
;%~p7 | ~f16 | zcl_11
(assert (or (not l_p7) (not l_f16) l_zcl_11))
...
;%~p12 | ~p10 | zcl_12
(assert (or (not l_p12) (not l_p10) l_zcl_12))
...
;%Non-clausified dependency
;%(forall[]((p12 & p10) --> f18_p))
;%------------------------Clausification start------------------------%
(declare-fun l_f18_p () Bool)
;%~p12 | ~p10 | f18_p
(assert (or (not l_p12) (not l_p10) l_f18_p))
...
;%~r_p6 | ~r_f7 | r_zcl_5
(assert (or (not r_p6) (not r_f7) r_zcl_5))
...
;%~r_p7 | ~r_f16 | r_zcl_11
(assert (or (not r_p7) (not r_f16) r_zcl_11))
...
;%~r_p12 | ~r_p10 | r_zcl_12
(assert (or (not r_p12) (not r_p10) r_zcl_12))
...
(assert (or (not r_p12) (not r_p10) r_f18_p))
